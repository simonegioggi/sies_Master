...
function contextCreateContainer( containerName ){
  ...
  switch( jsrsBrowser ) {
    ...
    case 'IE':
      ...
      var html = '<iframe name="' + containerName + '" src="\Common\Includes\Blank.htm"></iframe>';
      span.innerHTML = html;
...
function jsrsExecute( rspage, callback, func, parms, visibility ){
  ...
  //
  // rspage      - href to jsp/servlet resource
  ...
  {
    //alert("jsrsExecute: doPOST !");
    contextObj.POST( rspage, func, parms );
  } 
  else 
  {
    //alert("jsrsExecute: doGET !");
