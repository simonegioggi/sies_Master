...
<%
Collection lTipoUfficio = DecodificheManager.getInstance().getUfficioLogin();
Iterator lIter = lTipoUfficio.iterator();
        	...
        	<table border=1 bordercolor="#ffffff" cellpadding="0" cellspacing="0" width="800" align="center">
		  		<tr>
            		<td width="700" valign="top" class="rNoBord" background="/images/login.gif">
            			<br>
            			<form onkeyup="javascript:if(window.event.keyCode==13){ExLogin();}" action="<%=IWebConstants.PG_MAIN%>" method="post" name="FormLogin" target="_blank">
            				<div align=left style="position:relative;left=490px">
              					<strong>
<!--                 					<font color="#FFFFFF"> -->
<%-- 										Server di&nbsp;:&nbsp;&nbsp;&nbsp;<%=Server%><br> --%>
<%-- 										Versione &nbsp;:&nbsp;&nbsp;&nbsp;<%=VersionFS%>&nbsp;(DB:&nbsp;<%=VersionDB%>)<br> --%>
<!-- 										Prototipo&nbsp;:&nbsp;&nbsp;&nbsp;VERSIONE_SIES_11.3&nbsp;(DB:&nbsp;siesto) -->
<!-- 									</font> -->
            				...
            				<strong><font color="#FFFFFF">Utente :</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
