...
%>
        <CENTER>
        	<STRONG>RemoteException:<BR>Errore di comunicazione con l'application Server:<BR><BR></STRONG>
        </CENTER>
		<%="" + rex%>
<%
} else {
...
%>
		<STRONG>F3BException --> Eccezione di sistema:<BR><%= exception.getMessage() %>
<%
