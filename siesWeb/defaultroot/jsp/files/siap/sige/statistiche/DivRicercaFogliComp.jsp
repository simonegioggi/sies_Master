...
<%@ page import="siap.sige.statistiche.action.ICostantiStatistiche"%>
 ...
 boolean isFoglioComplementare = false;
  	...
  	{
  		// Ricerca x Estremi Foglio Complementare
  ...
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="RicercaAvanzata" >
    ...
    <div id="EstremiOrdinanza" style="position:relative;  top: 0; left: 0; " >  
      ...
      <tr>
        ...
        <td class="l">
          <input type="text" title="Anno Foglio Complementare Iniziale" name="<%=ICostantiStatistiche.CAMPO_ANNO_INI %>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">/
          <input type="text" title="Numero Foglio Complementare Iniziale" name="<%=ICostantiStatistiche.CAMPO_NUM_INI %>" maxlength="6" size="6" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
        </td>
        <td class="c" >
          <font class="label">Anno/Numero Finale (*) </font>
        </td>
        <td class="l">
          <input type="text" title="Anno Foglio Complementare Finale" name="<%=ICostantiStatistiche.CAMPO_ANNO_FINE %>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">/
          <input type="text" title="Numero Foglio Complementare Finale" name="<%=ICostantiStatistiche.CAMPO_NUM_FINE %>" maxlength="6" size="6" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
        </td>
        </tr>      
         </table>
   </div>     
      <div id="DateDeposito" style="position: absolute; top: 0; left: 0; visibility:hidden; ">      
       <table width=96%>
        ...
        <tr>
          ...
          <td class="l" width="30%" >
            <input type="text" title="Giorno Iniziale" name="<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_INIZIO %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">-
            <input type="text" title="Mese Iniziale" name="<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_INIZIO %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">-
            <input type="text" title="Anno Iniziale" name="<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_INIZIO %>"  maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)">
          </td>
          <td class="c" width="10%"  >
            <font class="label">Data Finale </font>
          </td>
          <td class="l" width="30%" >
            <input type="text" title="Giorno Finale" name="<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_FINE %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">-
            <input type="text" title="Mese Finale" name="<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_FINE %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">-
            <input type="text" title="Anno Finale" name="<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_FINE %>"  maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)">
          </td>
        </tr>
      </table>
   ...
   <script language="JavaScript" type="text/javascript">
	...
	// Viene usata questa funzione per definire i campi da controllare che cambiano dalle opzioni scelte.
     function Validazione()
     {
     	...
     	{	
     		frmvalidator.clearAllValidations();
	    	frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_INIZIO %>","req","Il campo Giorno è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_INIZIO%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_INIZIO%>","minlen=2","La lunghezza del campo giorno deve essere di 2 caratteri");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_FINE%>","req","Il campo Giorno è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_FINE%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_FINE%>","minlen=2","La lunghezza del campo giorno deve essere di 2 caratteri");
	
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_INIZIO%>","req","Il campo Mese è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_INIZIO%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_INIZIO%>","minlen=2","La lunghezza del campo mese deve essere di 2 caratteri");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_FINE%>","req","Il campo Mese è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_FINE%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_FINE%>","minlen=2","La lunghezza del campo mese deve essere di 2 caratteri");
	
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_INIZIO%>","req","Il campo Anno è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_INIZIO%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_INIZIO%>","minlen=4","La lunghezza del campo Anno deve essere di 4 caratteri");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_FINE%>","req","Il campo Anno è obbligatorio");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_FINE%>","numeric");
	   		frmvalidator.addValidation("<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_FINE%>","minlen=4","La lunghezza del campo Anno deve essere di 4 caratteri");
	     	
     		frmvalidator.setAddnlValidationFunction("VerificaDateEmissione");
     	
     	}
     }
  </script>
   <script language="JavaScript" type="text/javascript">
     function VerificaDateEmissione()
  	 {
	     var ritorno = true;
		 var data_iniziale = document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_INIZIO%>.value + '/' + document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_INIZIO%>.value + '/'+ document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_INIZIO%>.value;
				
		 var data_finale = document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_GIORNO_DATA_EMISSIONE_FINE%>.value + '/' + document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_MESE_DATA_EMISSIONE_FINE%>.value + '/'+ document.RicercaAvanzata.<%=ICostantiStatistiche.CAMPO_ANNO_DATA_EMISSIONE_FINE%>.value;
