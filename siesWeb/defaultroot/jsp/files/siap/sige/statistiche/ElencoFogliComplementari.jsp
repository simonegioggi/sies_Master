...
%>    
     ...
     <tr>
 		<td class="lNoBord"><font class="label"> <%=FiltoRicerca.getDescCalcoli() %></font></td>
 	 </tr>	 
  </table>
...
<%
    ...
    while ( itx.hasNext())
    {
    	...
    	String lNumProv = "";
    	String lIdProv = "";
    	String lDataEmissioneFC = "";
    	String lDataEmissioneProvv = "";
    	...
    	String lIdEve = "";
       	...
       	//dati del Foglio Complementare
		if (isFoglioComplementare && provvedimento.getDocumentoAllegato() != null)
    	{
       		lIdProv = StringUtils.toStringJSP(provvedimento.getDocumentoAllegato().getIdDocumentoAllegato(), "-");
       		lDataEmissioneFC = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getDocumentoAllegato().getDataEmissione(), "dd-MM-yyyy"), "-");
    		...
    		{	
    			lNumProv = provvedimento.getDocumentoAllegato().getAnnoFoglioComplementare().toString() + "/" + provvedimento.getDocumentoAllegato().getProgrFoglioComplementare();
      			hrefProv = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.sige.fogliocomplementare.action.ActRicercaFoglioComplementareByAnnoNumUff";
		...
		// Dati dal Provvedimento Sige
     	if (provvedimento.getProvvedimentoSigeEvento() != null && provvedimento.getProvvedimentoSigeEvento().getProvvedimento() != null )
    	{
     		lDataEmissioneProvv = StringUtils.toStringJSP( DateUtils.getDateToString(provvedimento.getProvvedimentoSigeEvento().getProvvedimento().getDataEmissione(), "dd-MM-yyyy"), "-");
    	}   	
		// Dati dell'Evento
      ...
      <tr>
        <td class="c"><font class="label">
      	...
      	<%=lNumFascicolo%></a></font></td>
           ...
           <td class="c"><font class="label"><%=lDataEmissioneProvv%></font></td>	
           <td class="c"><font class="label"><%=lDataEmissioneFC%></font></td>
