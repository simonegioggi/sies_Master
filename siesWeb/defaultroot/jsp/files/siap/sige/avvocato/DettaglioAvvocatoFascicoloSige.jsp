...
AvvocatoFascicoloSigeModel lAvvFascSige = new AvvocatoFascicoloSigeModel(avvocato.getAvvocatoFascicoloSigeModel());
%>
...
<table>
      <tr>
        ...
        <td class="LBG">
          <a href="/jsp/Main.jsp?Action=siap.sige.avvocato.action.ActStampaAvvocato&<%=ICostantiAvvocato.CAMPO_ID_AVVOCATO%>=<%=lAvvocato.getIdAvvocato()%>" >
...
<%}%>
<%if( lAvvocato.getDescrTipo().equalsIgnoreCase("D'UFFICIO")){%>
<%if(!lAvvFascSige.getDescrMotivoDesignazione().equals("-")){%>
...
<%if(!lAvvFascSige.getDescrTipoAutorita().equals("-")){%>

<tr>
				<td class="l"><font class="label">Autorità per la notifica al Condannato </font></td>
				<td class="l"><font class="campo"><%=StringUtils.toStringJSP(lAvvFascSige.getDescrTipoAutorita()) %> di <%=StringUtils.toStringJSP(lAvvFascSige.getComuneTipoAutorita()) %>  </font>
				<font class="campo"><%=StringUtils.toStringJSP(lAvvFascSige.getIndirizzoTipoAutorita()) %>  </font></td>
</tr>
<%}%>
...
<tr>
				...
				<td class="l"><font class="campo"><%=StringUtils.toStringJSP(lAvvFascSige.getDescrTipoAutoritaDif()) %> di <%=StringUtils.toStringJSP(lAvvFascSige.getComuneTipoAutoritaDif()) %>  </font></td>
