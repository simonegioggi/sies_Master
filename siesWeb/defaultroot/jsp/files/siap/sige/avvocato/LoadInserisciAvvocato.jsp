...
if (sentenze==null) sentenze=new Vector <SentenzaSigeModel>();
...
<script language="JavaScript">
 ...
 function calendario(a_formname,a_field_year,a_field_month,a_field_day)
 {
  ...
  //{
  //  desktop = window.open("/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=siap.sige.avvocato.action.ActLoadRicercaAvvocatoSiep&formname="+a_formname, "Ricerca_Avvocato","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=450,height=500");
  //}
...
<table>
	<tr>
    	...
    	<td>&nbsp;&nbsp;&nbsp;</td>
    	<!-- td class="label">
      		<a href="Javascript:ListaAvvocati2('LoadInserisciAvvocato');">
