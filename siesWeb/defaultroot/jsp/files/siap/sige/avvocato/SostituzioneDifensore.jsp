...
<table>
	<tr>
    	...
    	<td class="l">
    		...
    		<input type="text" size=35 maxlength=35 readonly title="Campo Cognome" value="<%=avvocato.getAvvocato().getCognome()%>" name="<%=ICostantiAvvocato.CAMPO_COGNOME%>">
    	</td>
	</tr>
  	<tr>
		<td class="l">Nome</td>
...
if (Utils.isPresent(avvocato.getAvvocato().getDescStatoNascita())) {
	if ("ITALIA".equalsIgnoreCase(avvocato.getAvvocato().getDescStatoNascita()))
		comuneNascita = avvocato.getAvvocato().getDescLuogoNascita();
	else
		comuneNascitaEstero = avvocato.getAvvocato().getDescLuogoNasRegInde();
...
%>
	...
	<tr>
  	...
  	<tr>
		...
		<td class="l"><input type="text" readonly size=80 maxlength=200 title="Indirizzo" value="<%=StringUtils.toStringJSP(avvocato.getAvvocato().getIndirizzo())%>" name="<%=ICostantiAvvocato.CAMPO_INDIRIZZO%>"></td>
  	</tr>
  	<tr>
...
<%--           	<input title="Comune di Residenza" value="<%=StringUtils.toStringJSP(avvocato.getAvvocato().getDescComuneResidenza())%>" type="text" name="<%=ICostantiAvvocato.CAMPO_COD_COMUNE_RESIDENZA%>" maxlength="35" size="35"> --%>
			<input type="text" readonly title="Comune Sede dello Studio" value="<%=StringUtils.toStringJSP(avvocato.getAvvocato().getDescrComuneStudio())%>" name="<%=ICostantiAvvocato.CAMPO_DESC_COMUNE_STUDIO%>" maxlength="35" size="35">
        </td>
    </tr>
    <tr>
...
<table cellspacing=2 cellpadding=2>
	<tr>
		<td colspan=2>
       	...
       	<%-- MEV_21: nascondo la funzione di inserimento --%>
