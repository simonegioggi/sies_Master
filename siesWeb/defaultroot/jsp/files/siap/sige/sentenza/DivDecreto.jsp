...
<title>[S.I.E.S.] - Gestione Decreto Penale</title>
...
<script language="JavaScript">
    function VerifyD()
    {
      ...
      if (document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_GIORNO_DATA_IRREVOCABILITA%>.value.length==1)
        document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_GIORNO_DATA_IRREVOCABILITA%>.value='0'+document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_GIORNO_DATA_IRREVOCABILITA%>.value;
      if (document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_MESE_DATA_IRREVOCABILITA%>.value.length==1)
        document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_MESE_DATA_IRREVOCABILITA%>.value='0'+document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_MESE_DATA_IRREVOCABILITA%>.value;

   //   var d1=document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_GIORNO_DATA_ARRIVO_ATTO%>.value+'/'+document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_MESE_DATA_ARRIVO_ATTO%>.value+'/'+document.LoadInserisciDecreto.<%=ICostantiSentenza.CAMPO_ANNO_DATA_ARRIVO_ATTO%>.value;
      //if (! ControllaData(d1))
...
<%
	...
	<tr>
		...
		<td class="L"><input Title="Anno Decreto" value="<%=StringUtils.toStringJSP( lSentenza.getAnnoSentenza()) %>"
			type="text" name="<%= ICostantiSentenza.CAMPO_ANNO_SENTENZA %>" maxlength="4" size="4"> /<input Title="Numero Decreto"
			value="<%=StringUtils.toStringJSP(lSentenza.getNumeroSentenza())%>" type="text" name="<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA %>" maxlength="6" size="6">
		</td>
	</tr>
	<tr>
		...
		<td class="L" colspan=3>
          ...
          <%= (modalita.equals("M")) ? autoritaEmiDecretoPenale : autoritaEmiDecretoPenale%>
			</select>
		</td>
	</tr>
	<tr>
		...
		<td class="L" colspan=3>
			...
			<%-- a href="Javascript:ListaComuni('LoadInserisciDecreto','<%= ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE %>');">  --%>
	...
	<tr>
		...
		<td class="L" colspan=3>
			<input Title="Anno Sentenza Cassazione" name="<%= ICostantiSentenza.CAMPO_ANNO_SENTENZA_CASSAZIONE %>" value="<%=StringUtils.toStringJSP( lSentenza.getAnnoSentenzaCassazione())%>" type="text" maxlength="4" size="4"> /
			<input Title="Numero Sentenza Cassazione" name="<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA_CASSAZIONE%>" value="<%=StringUtils.toStringJSP(lSentenza.getNumeroSentenzaCassazione()) %>" type="text" maxlength="6" size="6">
		</td>
	</tr>
	...
	<tr>
		...
		<td class="L" colspan=3>
			<input Title="Anno Raccolta Generale" value="<%=StringUtils.toStringJSP( lSentenza.getAnnoRaccoltaGenerale())%>" name="<%= ICostantiSentenza.CAMPO_ANNO_RACCOLTA_GENERALE %>" type="text" maxlength="4" size="4"> /
			<input Title="Numero Raccolta Generale" value="<%=StringUtils.toStringJSP(lSentenza.getNumeroRaccoltaGenerale())%>" name="<%= ICostantiSentenza.CAMPO_NUMERO_RACCOLTA_GENERALE %>" type="text" maxlength="6" size="6">
		</td>
	</tr>
...
<script language="JavaScript" type="text/javascript">
  ...
  frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_GIORNO_DATA_PROVVEDIMENTO %>","req","Il campo Giorno della data Decreto è obbligatorio");
  ...
  frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_MESE_DATA_PROVVEDIMENTO %>","req","Il campo Mese della data Decreto è obbligatorio");
  ...
  frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_ANNO_DATA_PROVVEDIMENTO %>","req","Il campo Anno della data Decreto è obbligatorio");
  ...
  // frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA %>","req","Il campo Giorno Decreto è obbligatorio");
...
<%--   frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE%>","alphabetic"); --%>
	...
	frmvalidator.setAddnlValidationFunction("VerifyD");
</script>