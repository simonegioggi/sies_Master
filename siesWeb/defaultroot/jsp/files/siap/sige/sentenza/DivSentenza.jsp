...
<table cellspacing=2 cellpadding=2>
	<tr>
		<td class="l" colspan="2">Data Inserimento&nbsp;&nbsp;
			<font class="campo"> 
<%
...
%> 
	...
	<tr>
		...
		<td class="L">
			...
			/<input Title="Numero R.G.N.R." value="<%=StringUtils.toStringJSP(lSentenza.getNumeroRegePm())%>" type="text" name="<%=ICostantiSentenza.CAMPO_NUMERO_REGE_PM %>" maxlength="6" size="6">
		</td>
<%
String ARG = "";
String NRG = "";
...
%>
	...
	<tr>
		...
		<td class="L">
			<select Title="Autorità Sentenza Riferimento" onChange="ctrl_autorita('<%=ICostantiSentenza.CAMPO_COD_TIPO_AUTORITA_PROVV_RIF%>', '<%=ICostantiSentenza.CAMPO_COD_TIPO_AUTORITA_EMITTENTE%>', 'D2', '<%=ICostantiSentenza.CAMPO_COD_TIPO_RITO_RIF%>');" name="<%=ICostantiSentenza.CAMPO_COD_TIPO_AUTORITA_PROVV_RIF%>">
				<%=autoritaProvRif%>
			</select>
		</td>
		<td colspan=2>
...
if (modalita.equals("M")
		&& (lSentenza.getCodTipoAutoritaProvvRif().equals("DIB") || lSentenza.getCodTipoAutoritaProvvRif().equals("TRIBSD"))) {
	visib2 = "visible";
}
%>
...
-------------------------------------------------------------------------- --%>
	...
	<tr>
		<td class="l">Note</td>
		<td class="L" colspan=3>
			<textarea cols=80 rows=5 Title="Note Aggiuntive" name="<%=ICostantiSentenza.CAMPO_NOTE%>"><%=StringUtils.toStringJSP(lSentenza.getNote())%></textarea>
		</td>
	</tr>
</table>
<%
