...
<script language="JavaScript">
  ...
  // Inizializza la jsp LoadRicercaTitoloEsecutivo
  function Init()
  {
  ...
  */
  ...
  /* 
  	Visualizza all'interno della jsp LoadRicercaTitoloEsecutivo
...
<head>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Ricerca Titolo Esecutivo da assegnare a Procedimento SIGE</font>
      </td>
    </tr>
  </table>
  ...
  <div id="comune" style="position: relative; top: 0; left: 0;   visibility:visible; " >     
    <div id="RicercaProcedimentoDiv" style="position:relative;  top: 0; left: 0; visibility:hidden;   " >  
       <jsp:include page="<%=ICostantiFasSigeSentenza.PG_INCLUDE_RICERCA_FASCICOLO_SIEP%>"/>   
    </div>
    <div id="RicercaSentenzaDiv" style="position: absolute; top: 0; left: 0; visibility:visible; ">      
        <jsp:include page="<%=ICostantiFasSigeSentenza.PG_INCLUDE_RICERCA_SENTENZA%>"/>   
     </div>
  </div>
</html>