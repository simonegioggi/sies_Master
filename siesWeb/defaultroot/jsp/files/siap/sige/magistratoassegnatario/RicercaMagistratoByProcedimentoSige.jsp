...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Magistrati per Procedimento SIGE </title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
       ...
       <!-- BOTTONE DI INSERIMENTO MAGISTRATO -->
       <td class="LBG">
         <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sige.magistratoassegnatario.action.ActLoadInserisciMagistratoAssegnatario&IdFascicoloSige=<%=FascicoloSigeEsteso.getFascicoloSige().getIdFascicoloSige()%>&TornaQui=<%=TornaQui%>" >
           <img  align="middle" src="/images/new24.gif" alt="Assegna Magistrato " width="24" height="24" border="0">
         </a>
       </td>
