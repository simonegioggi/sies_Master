...
%> 
			<font class="label"><%=StringUtils.toStringJSP(lTenore.getDescrEsitoSige())%></font>
<%
				} else {
%>
			-
...
%>
	<tr>
    	...
    	<td class="c">
    		<font class="label">
<%
				if (lTenore.getTenoreSige().getCodEsitoSige() != null
						&& lTenore.getTenoreSige().getCodEsitoSige().length() > 1) {
%> 
			<font class="label"><%=StringUtils.toStringJSP(lTenore.getTenoreSige().getDescrEsitoSige())%></font>
<%
				} else {
%>
			-
