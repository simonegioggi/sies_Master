...
<head>
  ...
  function Verify()
  {
    ...
    var numero_da_unif=document.LoadVerificaDecretoUnificazioneSige.<%=ICostantiDecretoUnificazioneSige.CAMPO_NUMERO_DA_UNIF%>.value;
...
<body class="corpo">
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadVerificaDecretoUnificazioneSige'>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.decretounificazione.action.ActLoadConfermaInserisciDecretoUnificazioneSige">
