...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Accertamenti Anagrafici - </title>
...
if (Stampabile == null || Stampabile.trim().length() < 1)
  ...
  if(lEve != null &&  lEve.getEvento().getFlagDocumentoRegistrato()!= null)
  {
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Accertamenti Anagrafici</font>
        </td>
<%
        if ( (lEve != null && lEve.getEvento().getFlagDocumentoRegistrato()==null ) || (lEve.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0))
				{%>   
...
%>
 ...
 <tr>
   <td class="l">Tipo Accertamento</td>
<%if("0054".equals(lEve.getEvento().getCodMotivo())) {%>
   <td class="l"><font class="campo">Rituale</font></td>
<%}else if("0579".equals(lEve.getEvento().getCodMotivo())) {%>
   <td class="l"><font class="campo">Accertamento Residenza</font></td>
<%}else if("0580".equals(lEve.getEvento().getCodMotivo())) {%>
   <td class="l"><font class="campo">Richiesta Informazioni</font></td>
<%} %>
</tr>
<% if("0580".equals(lEve.getEvento().getCodMotivo())) {%>
  <tr>
       <td class="l">Destinatario</td>
       <td class="l">
        <font class="campo">
      		<%=StringUtils.toStringJSP(lEve.getNotifiche()[0].getAutoritaEsterna().getDescrTipoAutorita())%>
        di
       		<%=StringUtils.toStringJSP(lEve.getNotifiche()[0].getAutoritaEsterna().getDescrSede())%>     		
        </font> 
       </td>
  ...
  <tr>
     ...
     <td class="L">
         <font class="campo"><%=lEve.getNotifiche()[0].getNote()%>&nbsp;</font>
     </td>
   </tr>
<%  }
}else{ %> 
<tr>
  ...
  <td class="l">
     <font class="campo"> Ufficio Anagrafe di&nbsp;
     <%if(lEve.getNotifiche()!= null && lEve.getNotifiche().length>0)
  	 {%>
     		<%=StringUtils.toStringJSP(lEve.getNotifiche()[0].getAutoritaEsterna().getDescrSede())%>
     <%} %>
...
<%
   // Preleva le note
    ...
    %>
      ...
      for(int count = 1;count < lSizeNotifiche; count++)
      {
		// Gestione Note
         ...
         <FORM name="comandi" enctype="multipart/form-data" method="post">
          ...
          <jsp:include page="<%=ISIAPCostantiWeb.CAMPI_VALIDA_UPLOAD%>" />
             <tr><td class="L">
                 ...
                 <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.richiestaatti.action.ActDettaglioRicSIntegrale">
