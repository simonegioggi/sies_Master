...
<%
	...
	String note="";
	String noteNotifiche="";
	
	int lSizeCampoNote = lEve.getCampoNote().length;
    for(int count = 0;count < lSizeCampoNote; count++) {
    	note += StringUtils.toStringJSP( lEve.getCampoNote()[count].getDescr()) +" ";
    }
    
    int lSizeNotifiche = lEve.getNotifiche().length;
    for(int i = 0;i < lSizeNotifiche; i++) {
    	noteNotifiche += StringUtils.toStringJSP( lEve.getNotifiche()[i].getNote()) +" ";
    }
%>
<html>

  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Estratto/Copia Provvedimento - </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Estratto/Copia Provvedimento</font>
        </td>
<%
...
%>
    ...
    <tr>
     ...
     <tr>
		...
		<tr>
        <td class="L">Ulteriori Informazioni</td>
        <td class="L" colspan="5">
          <font class="campo"><%=noteNotifiche%></font>&nbsp;
        </td>
      </tr>
