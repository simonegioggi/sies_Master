...
<jsp:useBean id="fascicoloSigeGP" scope="request" class="siap.sige.fascicolo.model.FascicoloSigeModel"/>
...
source4.style.borderStyle=state
  ...
  <title>[S.I.E.S.] - Richiesta Documenti Istruttori </title>
 ...
 <table>
  <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
    <td class="LBG">
      ...
      <font class="campo">Richiesta Documenti Istruttori</font>
    </td>
   </tr>
 </table>
</FORM>
...
%>	    
      <tr>
        <td width="6%" >        	
        <td width="22%" class="menulines" >
          <a href="/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=<%=lFunModel.getNameAction()%><%=retParam%>"><%=lFunModel.getLabelFunction()%></a>
        </td>
        <td width="22%" class="menulines" >
          <%if (itx.hasNext()) {i++;lFunModel = (FunctionModel)itx.next();%><a href="/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=<%=lFunModel.getNameAction()%><%=retParam%>"><%=lFunModel.getLabelFunction()%></a><%}else{%><td width="18%"></td> <% }%>
        </td>
        <%if(i==7){%></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><%}%>
        <td width="22%" class="menulines" >
          <%if (itx.hasNext()) {i++;lFunModel = (FunctionModel)itx.next();%>  <a href="/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=<%=lFunModel.getNameAction()%><%=retParam%>"><%=lFunModel.getLabelFunction()%></a><%}else{%><td width="18%"></td> <% }%>
        </td>
        <%if(i==7){%></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><%}%>
