...
%>
  ...
  <%
    ...
    if (actRet.compareTo("")!= 0 )
    {
      ...
      lAzione = "siap.sige.richiestaatti.action.ActLoadFSPEsitoParereInamm";
    }
  %>
  ...
  {
    if( evento.getTemIdTemplate() == null )
    {
    %>
      <form name="dettaglio">
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.richiestaatti.action.ActLoadDettaglioEsitoParereInamm">
