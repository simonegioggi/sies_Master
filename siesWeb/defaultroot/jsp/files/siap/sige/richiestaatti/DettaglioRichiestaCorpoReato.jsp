...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Corpo Reato - </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Corpo Reato</font>
        </td>
...
%>
    ...
    <tr>
       <td class="l">Autorità Giudicante</td>
      <td class="L">
         ...
         <FORM name="comandi" enctype="multipart/form-data" method="post">
          ...
          <jsp:include page="<%=ISIAPCostantiWeb.CAMPI_VALIDA_UPLOAD%>" />
             <tr><td class="L">
                 ...
                 <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.richiestaatti.action.ActDettaglioRichiestaCorpoReato">
