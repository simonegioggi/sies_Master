...
<jsp:useBean id="FiltriPareri" scope="request" class="siap.sige.richiestaatti.model.ParereModel" />
<jsp:useBean id="provvedimenti"     scope="request" class="java.util.Vector"/>

<html>
  <head>
    <link rel="STYLESHEET" type="text/css" href="<%=IWebConstants.PG_STYLE%>">
    <title>[S.I.E.S.] - Elenco dei pareri richiesti</title>
 ...
 <script language="JavaScript" src="<%=ISIAPCostantiWeb.JS_CONTROL_UPLOAD_NEW%>"></script>
  ...
  <table >
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
     ...
     <td class="LBG">
      <a href="Javascript:stampaSius('siap.sige.richiestaatti.action.ActStampaPareri')" >
...
%>
      <tr>
      	<td class="c"><font class="label"><%=parere.getAnnoFascicoloSige()%>/<%=parere.getProgrFascicoloSige()%></font></td>
          ...
          <jsp:include page="<%=IWebConstants.PG_BUTTONS%>">
            ...
            <jsp:param name="ValoreIdEntita" value="<%=parere.getIdProvvedimentoSige()%>" />
            <jsp:param name="CampoIdEntitaProvv" value="<%=ICostantiFascicoloSige.CAMPO_ID_FASCICOLO_SIGE%>" />
            <jsp:param name="ValoreIdEntitaProvv" value="<%=parere.getIdFascicoloSige()%>" />
         </jsp:include>
        </td>
      </tr>
