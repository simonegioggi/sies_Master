...
<html>
  <head>
    <title>[S.I.E.S.] - Gestione Richiesta Delega Indagini</title>
 ...
 <body class="corpo" >
   <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
      <font class="label">Funzione :</font> &nbsp;&nbsp;<font class="campo">Richiesta Delega Indagini</font>
      ...
      <%
        ...
        if( modalita.equals("I") )
        {
          ...
          lAzione = "siap.sige.richiestaatti.action.ActInserisciRichiestaDelegaIndagini";
      %>
      ...
      <%}
        else if( modalita.equals("M") )
        {
          lProvvedimento = new EventoModel(evento);
          lAzione = "siap.sige.richiestaatti.action.ActInserisciRichiestaDelegaIndagini";
      %>  <font class="campo">Modifica Richiesta Delega Indagini</font>
      <%}
      %>
      </td>
      <!-- BOTTONE DI RITORNO -->
...
<br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.richiestaatti.action.ActInserisciRichiestaDelegaIndagini">
    <table>
		<tr>
