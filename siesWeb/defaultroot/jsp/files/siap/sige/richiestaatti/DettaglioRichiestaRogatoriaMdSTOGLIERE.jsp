...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Rogatoria MdS - </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Rogatoria MdS</font>
        </td>
...
%>
	...
	<tr>
      ...
      <td class="L" colspan=5>
        <font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lEve.getEvento().getDataRichiesta(),"dd-MM-yyyy"))%></font>&nbsp;
      </td>
    </tr>
    <tr>
       <td class="l">Magistrato di Sorveglianza</td>
      <td class="L">
        <font class="campo"><%=StringUtils.toStringJSP( lEve.getMagistrato().getCognome() )%></font>&nbsp;    
      </td>
      <td class="L">
        <font class="campo"><%=StringUtils.toStringJSP( lEve.getMagistrato().getNome() )%></font>&nbsp;    
      </td>
     </tr>
     <tr>
         ...
         <FORM name="comandi" enctype="multipart/form-data" method="post">
          ...
          <jsp:include page="<%=ISIAPCostantiWeb.CAMPI_VALIDA_UPLOAD%>" />
             <tr><td class="L">
                 ...
                 <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.richiestaatti.action.ActDettaglioRichiestaRogatoriaMdS">
