...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Posizione Giuridica Ad Autorità Penitenziaria - </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Posizione Giuridica Ad Autorità Penitenziaria</font>
        </td>
<%
...
%>
    ...
    <tr>
      ...
      <td class="L">
        <font class="campo"><%= (lEve != null &&  lEve.getNotifiche()[0] != null && lEve.getNotifiche()[0].getAutoritaEsterna() != null) ? lEve.getNotifiche()[0].getAutoritaEsterna().getDescrTipoAutorita() : ""%></font>&nbsp;
      </td>
      </tr>
      <tr>
      	 <td class="l">Luogo</td>
         <td class="L">
        <font class="campo"><%=StringUtils.toStringJSP( (lEve != null &&  lEve.getNotifiche()[0] != null && lEve.getNotifiche()[0].getAutoritaEsterna() != null) ?lEve.getNotifiche()[0].getAutoritaEsterna().getDescrSede(): "")%></font>&nbsp;
      </td>
     </tr>
     <tr>
      <td class="l">Indirizzo</td>
         <td class="L">
        <font class="campo"><%=lEve.getNotifiche()[0].getNote()!= null ?lEve.getNotifiche()[0].getNote():"" %></font>&nbsp;
      </td>
	 </tr>
