...
<html>
	<head>
  	<title> [S.I.E.S.] - Elenco Pareri - </title>
	...
	<body class="corpo" >
  	...
  	<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.richiestaatti.action.ActRicercaElencoPareri">
      ...
      <table width=80%>
        ...
        <tr>
          ...
          <td class="l" width="30%" >
			...
			<a href="javascript:calendario('LoadRicercaPareri','<%=ICostantiProduzioneAtti.CAMPO_ANNO_DATA_EMISSIONE%>','<%=ICostantiProduzioneAtti.CAMPO_MESE_DATA_EMISSIONE%>','<%=ICostantiProduzioneAtti.CAMPO_GIORNO_DATA_EMISSIONE%>');">
          ...
          <td class="l" width="30%" >
			...
			<!-- MEV 15 - Revisione SIGE -->
			<a href="javascript:calendario('LoadRicercaPareri','<%=ICostantiProduzioneAtti.CAMPO_ANNO_DATA_EMISSIONE2%>','<%=ICostantiProduzioneAtti.CAMPO_MESE_DATA_EMISSIONE2%>','<%=ICostantiProduzioneAtti.CAMPO_GIORNO_DATA_EMISSIONE2%>');">
       			<img src="/images/calendario.gif" border=0>
        	</a>
          </td>
        </tr>
