...
<html>
    ...
    <br>
  	<FORM method="POST" name="LoadInserisciRichiestaCodiceCui" action="<%= IWebConstants.PG_MAIN%>">
  		<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.richiestaatti.action.ActInserisciRichiestaCui">
		<table>
	...
	<% }%>
			...
			<tr>
				...
				<td class="L">
					...
					<a href="javascript:calendario('LoadInserisciRichiestaCodiceCui','<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>','<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>','<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>');">
