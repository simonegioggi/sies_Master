...
<%
	...
	String lConsigliere1 ="";
	if (collegio != null && collegio.getCollegioMagistrati()!=null && collegio.getCollegioMagistrati().length > 1 )
		lConsigliere1 = collegio.getCollegioMagistrati()[1].getMagistrato().getCognome()+" "+collegio.getCollegioMagistrati()[1].getMagistrato().getNome();
	
	String lConsigliere2 ="";
	if (collegio != null && collegio.getCollegioMagistrati()!=null && collegio.getCollegioMagistrati().length > 2 )
		lConsigliere2 = collegio.getCollegioMagistrati()[2].getMagistrato().getCognome()+" "+collegio.getCollegioMagistrati()[2].getMagistrato().getNome();
%>
    <tr>
      <td class="l">Presidente
			<font class="l">
        <input type="text" maxlength="28" size="26"
							 value="<%=lPresidente%>"		
               name="Magistrato" readonly >
      <font class="l">&nbsp;&nbsp;Consigliere</font>
			<font class="l">
