...
<jsp:useBean id="elencoAssistenti" scope="request" class="java.lang.String"/><!-- intervento per 11.1.2 -->
...
<html>
<head>
  <title>[S.I.E.S.] Gestione Udienza Collegiale DIBM</title>
...
<%
	String lEsperti = new String();

	if( lUdienzaSige.getCollegio().getCollegioEsperti()!= null && 
	    lUdienzaSige.getCollegio().getCollegioEsperti().length > 0 )
	{	
	  for( int i=0; i<lUdienzaSige.getCollegio().getCollegioEsperti().length; i++ ){
	 		lEsperti+= lUdienzaSige.getCollegio().getCollegioEsperti()[i].getEsperto().getCognome() + " "; 
	 		lEsperti+= lUdienzaSige.getCollegio().getCollegioEsperti()[i].getEsperto().getNome() + "; ";
	 	}
	}
%>
    <tr>
