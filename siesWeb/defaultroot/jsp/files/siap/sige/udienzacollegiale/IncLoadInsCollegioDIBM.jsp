...
<%
	...
	if (collegio != null && collegio.getCollegioMagistrati()!=null && collegio.getCollegioMagistrati().length > 1 )
		lGiudice1 = collegio.getCollegioMagistrati()[1].getMagistrato().getCognome()+" "+collegio.getCollegioMagistrati()[1].getMagistrato().getNome();

	String lGiudice2 ="";
	if (collegio != null && collegio.getCollegioMagistrati()!=null && collegio.getCollegioMagistrati().length > 2 )
		lGiudice2 = collegio.getCollegioMagistrati()[2].getMagistrato().getCognome()+" "+collegio.getCollegioMagistrati()[2].getMagistrato().getNome();
%>
    <tr>
