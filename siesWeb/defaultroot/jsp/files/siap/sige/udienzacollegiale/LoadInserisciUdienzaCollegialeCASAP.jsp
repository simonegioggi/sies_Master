...
<html>
<head>
  <title>[S.I.E.S.] Gestione Udienza Collegiale CASAP</title>
...
<%
	String lGiudiciPopolari = new String();

	if( lUdienzaSige.getCollegio().getCollegioGiudiciPopolari()!= null && 
	    lUdienzaSige.getCollegio().getCollegioGiudiciPopolari().length > 0 )
	{	
	  for( int i=0; i<lUdienzaSige.getCollegio().getCollegioGiudiciPopolari().length; i++ ){
	 		lGiudiciPopolari+= lUdienzaSige.getCollegio().getCollegioGiudiciPopolari()[i].getGiudicePopolare().getCognome() + " "; 
	 		lGiudiciPopolari+= lUdienzaSige.getCollegio().getCollegioGiudiciPopolari()[i].getGiudicePopolare().getNome() + "; ";
	 	}
	}
%>
    <tr>
      <td class="l">Giudici Popolari</td>
			<td class="l">
				<TEXTAREA title="Giudici Popolari" name="<%="GiudiciPopolari"%>" cols=100 rows=4><%=lGiudiciPopolari%></TEXTAREA>
      </td>
    </tr>
