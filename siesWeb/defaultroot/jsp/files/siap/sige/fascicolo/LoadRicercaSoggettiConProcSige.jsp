...
<body class="corpo">
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadRicercaSoggettiConProcSige">
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Ricerca Soggetti con Procedimenti SIGE</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaComuni('LoadRicercaSoggettiConProcSige','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
      ...
      <tr>
        ...
        <td class="l">
		  ...
		  <a href="javascript:calendario('LoadRicercaSoggettiConProcSige','<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>');">
      ...
      <tr>
        ...
        <td class="L">
          <input title="Codice CUI" type="text" name="<%=ICostantiSoggetto.CAMPO_COD_CS%>" maxlength="7" size="7">
        </td>
      </tr>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="label" >
          <input type=radio name="<%=ICostantiFascicoloSige.CAMPO_UFFICIO_DISTRETTO%>" value=0 CHECKED ></td>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="label">
          <input type=radio name="<%=ICostantiFascicoloSige.CAMPO_UFFICIO_DISTRETTO%>" value=1 ></td>
        </td>
      </tr>
