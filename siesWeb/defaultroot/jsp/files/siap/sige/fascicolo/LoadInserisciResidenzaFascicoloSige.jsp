...
<html>
<head>
<title>[S.I.E.S.] - Gestione Residenza Procedimento SIGE </title>
...
<script language="JavaScript">
  ...
  function init()
  {
    document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_INDIRIZZO%>.focus();
  }
...
<%
     ...
     {
%>
    	document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_ID_RESIDENZA%>.value = '0';
<%    } %>
    modificato = true;
    return;
  }
  ...
  function Verify()
  {
    ...
    if (document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_COD_STATO%>[document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_COD_STATO%>.selectedIndex].value=='039')
    {
      document.LoadInserisciResidenzaFascicoloSige.<%= ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO %>.value="";
      if (document.LoadInserisciResidenzaFascicoloSige.<%= ICostantiResidenza.CAMPO_DESCR_COMUNE %>.value.length==0)
      {
    ...
    if ( (document.LoadInserisciResidenzaFascicoloSige.value=='039')
    &&( document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO%>.value!=""))
    {
      document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO%>.value="";
      document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO%>.focus();
      alert('Per Italia specificare solo il Luogo, non il Comune Estero.');
      ritorno =  false;
    }
    else if ( (document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_COD_STATO%>.value!='039')
    &&( document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>.value != ""))
    {
      document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>.value = "";
      document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO%>.focus();
    ...
    if (document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_COD_STATO%>.value!='039')
    {
	  pulisciIdResidenza();
      document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>.value='';
  ...
  function cancellaCodComuneReale() {
  	document.LoadInserisciResidenzaFascicoloSige.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
  }
...
<%
		...
		lAction = "siap.sige.fascicolo.action.ActInserisciResidenzaFascicoloSige";
        if( modalita.equals("I") )
        {%>
           <font class="campo">Inserimento Residenza Fascicolo SIGE </font>
	  <%}
        else if( modalita.equals("M") )
        {%>
           <font class="campo">Modifica Residenza Fascicolo SIGE </font>
	  <%}%>
      <!-- BOTTONE DI RITORNO -->
  ...
  <br>
<form method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciResidenzaFascicoloSige" >
<%
if( modalita.equals("I") )
{
%>
  <table cellspacing=2 cellpadding=2>
    <tr>
      <td class="l">
        <a href="Javascript:ListaResidenze('LoadInserisciResidenzaFascicoloSige');">
...
<% } %>
  <table cellspacing=2 cellpadding=2>
      ...
      <td class="l">
        ...
        <a href="Javascript:ListaComuni('LoadInserisciResidenzaFascicoloSige','<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>');">
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciResidenzaFascicoloSige");
