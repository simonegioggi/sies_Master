...
// da attivare sono passate nella request
	...
	String lTitolo = "Ricerca Procedimento Siep";
...
<html>
<head>
  <title>[S.I.E.S.] - Ricerca Procedimento SIEP</title>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadRicercaFascicolo'>
    ...
    <table width=68% >
      ...
      <tr>
        ...
        <td class="l">
          <select title="tipoUfficioSiep" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_UFFICIO%>" onchange="Javascript:ResetField();">
			  <%=ufficioSIEP%>          
		  </select>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="l">
           <input Title="Sede Procura" name="<%=ICostantiFascicoloSiep.CAMPO_DESCR_COMUNE_UFFICIO%>"
              value="<%=ComuneUfficioConnesso%>" type="text" maxlength="35" size="35" readonly="readonly">
		        <a href="Javascript:ListaUfficiComuni('LoadRicercaFascicolo','<%=ICostantiFascicoloSiep.CAMPO_DESCR_COMUNE_UFFICIO%>',document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_UFFICIO%>[document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_UFFICIO%>.options.selectedIndex].value);">
