...
<html>
<head>
  <title>[S.I.E.S.] - Ricerca Procedimenti SIGE per Titolo Esecutivo</title>
  ...
  <script language="JavaScript">
    ...
    function VerifySingolo()
    {
      ...
      if (document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_UFFICIO%>.value=="-" )
      {
        alert("Il campo Tipo Ufficio è obbligatorio");
        document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_UFFICIO%>.focus();
        return false;
      }
      if (document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_DESCR_COMUNE_UFFICIO%>.value=="" )
      {
        alert("Il campo Sede Procura è obbligatorio");
        document.LoadRicercaFascicolo.<%=ICostantiFascicoloSiep.CAMPO_DESCR_COMUNE_UFFICIO%>.focus();
        return false;
      }
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadRicercaFascicolo'>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.fascicolo.action.ActRicercaProcSigePerTitoloEsecutivo">
...
%>
		<table width="39%">
		   ...
		   <tr>
		     <td class="L">
		       Solo Ufficio <input type="radio" name="CampoAmbitoRicerca" value="U"  checked>&nbsp;&nbsp;&nbsp;&nbsp; 
					 Intero Distretto <input type="radio" name="CampoAmbitoRicerca" value="D" >&nbsp;
				 </td>
		   </tr>
			<tr><td>&nbsp;</td></tr>
		 </table>
    ...
    <table width=68% >
      ...
      <tr>
        <td class="l" width=24%>Anno/Numero <font class=ob>(*)</font></td>
        <td class="l">
    ...
    <%--table width=68%>
      <tr>
        ...
        <td class="Titolo">Dati del Procedimento SIEP&nbsp;
  ...
  <div id="singolo" style="position:absolute;  top: 0; left: 0;   visibility:visible; " >  
    <table width=82%>
 			<tr><td>
    			...
    			<div id="divNascondeCheck" style="position:relative; top: 0; left: 0; visibility:hidden; ">      
          	<input type="radio" name="tipo" value="Singolo" checked onClick="radioBase();">
          	<input type="hidden" name="tipo" value="Intervallo"  onClick="radioBase();">
          </div>
    </table>
 </div>
</div>
