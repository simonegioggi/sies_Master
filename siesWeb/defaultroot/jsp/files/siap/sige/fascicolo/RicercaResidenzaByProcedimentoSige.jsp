...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Residenze per Procedimento SIGE </title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class=campo>Gestione Residenze per Procedimento SIGE </font>
      </td>

<% if (modificabile) { %>
       <!-- BOTTONE DI INSERIMENTO RESIDENZA -->
       <td class="LBG">
         <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sige.fascicolo.action.ActLoadInserisciResidenzaFascicoloSige&IdFascicoloSige=<%=FascicoloSigeEsteso.getFascicoloSige().getIdFascicoloSige()%>&TornaQui=<%=TornaQui%>" >
           <img  align="middle" src="/images/new24.gif" alt="Assegna nuova Residenza" width="24" height="24" border="0">
         </a>
       </td>
<%} %>
      <!-- BOTTONE DI RITORNO -->
...
<%
  ...
  {%>
    <tr>
      <td class="l">Nessuna Residenza assegnata</td>
	</tr>
<%}else{%>
   	<tr>
