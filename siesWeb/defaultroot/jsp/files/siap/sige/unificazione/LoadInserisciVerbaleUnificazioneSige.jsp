...
<html>
  <head>
  <title>[S.I.E.S.] - Inserimento Verbale di Unificazione Sige</title>
    ...
    function Verify()
    {
      ...
      var data_unificazione=document.LoadInserisciVerbaleUnificazioneSige.<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>.value+'/'+document.LoadInserisciVerbaleUnificazioneSige.<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>.value+'/'+document.LoadInserisciVerbaleUnificazioneSige.<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>.value;
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadInserisciVerbaleUnificazioneSige'>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.unificazione.action.ActInserisciVerbaleUnificazioneSige">
    <input type="HIDDEN" name="<%=ICostantiVerbaleUnificazioneSige.CAMPO_ID_FASCICOLO_UNIFICANTE%>" value="<%=fasUnificante.getFascicoloSige().getIdFascicoloSige()%>">
...
<%
    ...
    <table cellspacing=2 cellpadding=2>
      <tr>
        ...
        <td class="l">
          <input value="<%=DateUtils.getSysDate("dd")%>" type="text" size="2" maxlength="2" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" > /
          <input value="<%=DateUtils.getSysDate("MM")%>" type="text" size="2" maxlength="2" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" > /
          <input value="<%=DateUtils.getSysDate("yyyy")%>" type="text" size="4" maxlength="4" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)" >
		  
		  <!-- MEV 15 - Revisione SIGE -->
		  <a href="javascript:calendario('LoadInserisciVerbaleUnificazioneSige','<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>','<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>','<%=ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>');">
    ...
    <input type="HIDDEN" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_ANNO_DA_UNIF %>" value="<%=fasDaUnificare.getFascicoloSige().getChiaveAnno()%>">
    <input type="HIDDEN" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_NUMERO_DA_UNIF %>" value="<%=fasDaUnificare.getFascicoloSige().getChiaveProgr()%>">
    <input type="HIDDEN" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_ANNO_UNIFICANTE %>" value="<%=fasUnificante.getFascicoloSige().getChiaveAnno()%>">
    <input type="HIDDEN" name="<%= ICostantiVerbaleUnificazioneSige.CAMPO_NUMERO_UNIFICANTE %>" value="<%=fasUnificante.getFascicoloSige().getChiaveProgr()%>">

  </form>
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadInserisciVerbaleUnificazioneSige");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>","req","Il campo Giorno della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>","gt=1");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_GG_UNIFICAZIONE%>","lt=31");

    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>","req","Il campo Mese della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>","gt=1");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_MM_UNIFICAZIONE%>","lt=12");

    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>","req","Il campo Anno della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>","gt=1900");
    frmvalidator.addValidation("<%= ICostantiVerbaleUnificazioneSige.CAMPO_DATA_AAAA_UNIFICAZIONE%>","lt=2999");
  </script>
  </body>
</html>