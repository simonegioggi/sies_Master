...
//MagistratoAssegnatarioModel magistratoassegnatario = FascicoloSigeEsteso.getMagAssegnatario();
  ...
  String titolo = "Dettaglio Ordinanza Conflitto di Competenza";
  if (modificaOrdinanza)
	  titolo = "Modifica Ordinanza Conflitto di Competenza";
   ...
   <tr>
    ...
    <table>
        ...
        <tr> 
      		...
      		<td class="L"><font class="campo"> <%=StringUtils.toStringJSP(ProvvedimentoEvento.getProvvedimento().getDescrUffCompCorteSuprema())%></font></td>
        </tr>
        <tr>
       		<td class="l">G.E. coinvolto </td>
      		<td class="L"><font class="campo"> <%=StringUtils.toStringJSP(ProvvedimentoEvento.getProvvedimento().getDescrUfficioDestinatario())%></font></td>
        </tr>
	</table>
