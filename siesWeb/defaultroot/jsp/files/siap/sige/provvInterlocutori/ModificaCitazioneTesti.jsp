  ...
  <body class="corpo" onLoad="Init();" >
   <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
      <font class="label">Funzione :</font> &nbsp;&nbsp;<font class="campo">Modifica Citazione Testi</font>
...
%>
              <a href="Javascript:ListaUNEP('LoadCitazioneTesti','<%=ICostantiRichiestaAtti.CAMPO_SEDE%><% if (num_sede > 0) { %> [<%=num_sede%>]<%}%>');">
