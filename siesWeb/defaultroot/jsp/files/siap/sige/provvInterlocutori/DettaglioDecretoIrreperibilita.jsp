...
<%
  ...
  String titolo = "Dettaglio Decreto Irreperibilità";
  if (modificaOrdinanza)
	  titolo = "Modifica Decreto Irreperibilità";
...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Decreto Irreperibilità</title>
...
%>
    		...
    		<td class="LBG">
      		<a href="Javascript:conferma('siap.sige.provvedimento.action.ActCancellaProvvedimento','<%=ICostantiProvvedimentoSige.CAMPO_ID_PROVVEDIMENTO_SIGE%>','<%=provvedimento.getIdProvvedimentoSige()%>');">
...
<%
 ...
 %>
    ...
    <tr>
       <td class="Titolo" colspan="2">Ulteriori Informazioni</td>
    </tr>
    <tr>
    	<td class="l">Descrizione</td>
        <td class="L"><font class="campo"> <%=StringUtils.toStringJSP(ProvvedimentoEvento.getProvvedimento().getNote())%></font></td>
    </tr>      
<%
  ...
  <div align=left style="visibility:hidden" id="upld">
    ...
    <table>
        ...
        <tr>
          ...
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.provvInterlocutori.action.ActDettaglioDecretoIrreperibilita">
