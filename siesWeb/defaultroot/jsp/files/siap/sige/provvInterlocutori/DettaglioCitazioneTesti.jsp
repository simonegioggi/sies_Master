...
<%
  ...
  String titolo = "Dettaglio Citazione Testi";
  if (modificaOrdinanza)
	  titolo = "Modifica Citazione Testi";
...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Citazione Testi</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione :  </font>&nbsp;
          <font class="campo">Dettaglio Citazione Testi</font>
      </td>
...
<tr>
    ...
    <tr>
      <td class="Titolo">Soggetti Citati Come Testi </td>
    </tr>
  ...
  <div align=left style="visibility:hidden" id="upld">
    ...
    <table>
        ...
        <tr>
          ...
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.provvInterlocutori.action.ActDettaglioCitazioneTesti">
