...
<%
  ...
  String titolo = "Dettaglio Decreto Latitanza";
  if (modificaOrdinanza)
	  titolo = "Modifica Decreto Latitanza";
...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Decreto Latitanza</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione :  </font>&nbsp;
          <font class="campo">Dettaglio Decreto Latitanza</font>
      </td>
  ...
  <div align=left style="visibility:hidden" id="upld">
    ...
    <table>
        ...
        <tr>
          ...
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.provvInterlocutori.action.ActDettaglioDecretoLatitanza">
