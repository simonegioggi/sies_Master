...
<jsp:useBean id="avvocato"           scope="request" class="siap.sige.udienzaparti.model.PartiUdienzaDifensoreModel"/>
...
<jsp:useBean id="idSoggetto"         scope="request" class="java.lang.Object"/>

<html>
<head>
<title>[S.I.E.S.] - Sostituzione Difensore </title>
...
<script language="JavaScript">
  ...
  function Inserisci()
  {
   	document.LoadModificaAvvocato.<%=IWebConstants.ACTION_FIELD%>.value="siap.sige.udienzaparti.action.ActLoadInserisciDifensore";
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadModificaAvvocato">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sige.udienzaparti.action.ActSostituzioneDifensore">
  <input type="HIDDEN" name="<%=ICostantiPartiUdienza.CAMPO_ID_SOGGETTO%>" value="<%=idSoggetto%>">
...
<input type="hidden" name="idAvvVecchio" value="<%=avvocato.getAvvocato().getIdAvvocato()%>">
 ...
 <div id="ufficio"  style="visibility:hidden; position:relative;  top:-90px; left:320px  ">
   ...
   <tr>
       ...
       <td>
            <input type="text"  title="Giorno Data di Designazione" name="<%=ICostantiAvvocatoFascicoloSige.CAMPO_GIORNO_DATA_DESIGNAZIONE%>" value="<%=DateUtils.getDayToString(avvocato.getDataInizioValidita())%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
            -
            <input type="text" title="Mese Data di Designazione" name="<%= ICostantiAvvocatoFascicoloSige.CAMPO_MESE_DATA_DESIGNAZIONE %>" value="<%=DateUtils.getMonthToString(avvocato.getDataInizioValidita())%>" maxlength="2" size="2"onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" >
            -
            <input type="text"  title="Anno Data di Designazione" name="<%= ICostantiAvvocatoFascicoloSige.CAMPO_ANNO_DATA_DESIGNAZIONE %>" value="<%=DateUtils.getYearToString(avvocato.getDataInizioValidita())%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)">
       </td>
	   <!-- MEV 15 - Revisione SIGE -->
	   <td>
