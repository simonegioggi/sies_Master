...
<table cellspacing=2 cellpadding=2>
	...
	<tr>
		...
		<td class="L"><input title="Denominazione" value="<%=anagraficaParteUdienza.getDenominazione() %>" type="text"
                       name="<%= ICostantiPartiUdienza.CAMPO_DENOMINAZIONE %>"  maxlength="200" size="50"></td>
		<td class="l">Ragione Sociale</td>
		<td class="L"><select title="Ragione Sociale" name="<%=ICostantiPartiUdienza.CAMPO_RAG_SOCIALE%>">
          				<%= ragioneSociale %></select>
        </td>
	</tr>
	
	<tr>
		<td class="l">Provincia</td>
		<td class="L"><select title="Provincia" name="<%=ICostantiPartiUdienza.CAMPO_COD_PROVINCIA%>">
          				<%= province %></select>
        </td>
	...
	<tr>
		...
		<td class="L"><input title="Sede Legale" value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getIndSedeLegale())%>" type="text"
                       name="<%= ICostantiPartiUdienza.CAMPO_IND_SEDE_LEGALE %>"  maxlength="200" size="50"></td>
		<td class="l">Sede Operativa/Indirizzo Attività</td>
		<td class="L"><input title="Sede Operativa" value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getIndSedeOperativa())%>" type="text"
                       name="<%= ICostantiPartiUdienza.CAMPO_IND_SEDE_OPERATIVA %>"  maxlength="200" size="50"></td>
	</tr>
...
%>
			<a href="javascript:calendario('LoadInserisciPersonaGiuridica','<%=ICostantiPartiUdienza.CAMPO_ANNO_DATA_NASCITA%>','<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>','<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>');">
        ...
        <td class="L">
          	...
          	<a href="Javascript:ListaComuni('LoadInserisciPersonaGiuridica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>');">
	...
	<tr>
        ...
        <td class="l"><input title="Codice Fiscale" id=<%= ICostantiPartiUdienza.CAMPO_COD_FISCALE_RAP %>
        	value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getCodFiscaleRap()) %>" type="text"
        	name="<%= ICostantiPartiUdienza.CAMPO_COD_FISCALE_RAP %>"  maxlength="16" size="18">
        </td>
        <td class="l" colspan="2">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td class="l"><input size=50 maxlength=200  title="Indirizzo" value="<%if(anagraficaParteUdienza.getResidenza()!= null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getIndirizzo())%>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_INDIRIZZO %>"  >
        ...
        <td class="L">
          ...
          <a href="Javascript:ListaComuni('LoadInserisciPersonaGiuridica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_RESIDENZA %>');">
            <img src="/images/filefolder.gif" border=0>
          </a>
        </td>
    </tr>
	...
	<tr>
		...
		<td class="l"><input size=50 maxlength=200  title="ComuneEstero" value="<%if(anagraficaParteUdienza.getResidenza()!= null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getDescComuneEstero())%>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_DESC_COMUNE_ESTERO_RESIDENZA %>"  ></td>
	</tr>
