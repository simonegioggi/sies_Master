...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
	name="LoadInserisciPersonaFisica">
...
%> <input title="Giorno Data di nascita"
		...
		<%} %> 
			...
			<td class="L"><input title="Comune di Nascita"
				...
				<a href="Javascript:ListaComuniNascita('LoadInserisciPersonaFisica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>');">
		...
		<tr>
			...
			<td class="l"><input size=50 maxlength=200
				...
				title="Indirizzo" type="text"
				name="<%= ICostantiPartiUdienza.CAMPO_INDIRIZZO %>"> <input
				type="HIDDEN" name="<%=ICostantiPartiUdienza.CAMPO_ID_RESIDENZA %>"
			...
			<td class="L"><input title="Comune di Residenza"
				...
				href="Javascript:ListaComuni('LoadInserisciPersonaFisica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_RESIDENZA %>');">
					<img src="/images/filefolder.gif" border=0>
			</a></td>
		</tr>
