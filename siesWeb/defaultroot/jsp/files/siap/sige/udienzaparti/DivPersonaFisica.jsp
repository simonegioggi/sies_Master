...
<script language="JavaScript">
    ...
    function Verify()
    {
      ...
      if (document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_COD_STATO_NASCITA%>[document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_COD_STATO_NASCITA%>.selectedIndex].value=='039')
      {
        if (document.LoadInserisciPersonaFisica.<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>.value.length==0)
        {
          	alert('Il Comune di Nascita è obbligatorio se lo Stato di Nascita è Italia');
          	document.LoadInserisciPersonaFisica.<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>.focus;
          	return false;
        }
      } else {
        document.LoadInserisciPersonaFisica.<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>.value='';
        cancellaCodComuneReale();
	  }
      
      if (document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>.value.length==1)
        document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>.value='0'+document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>.value;
      if (document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>.value.length==1)
        document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>.value='0'+document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>.value;

      var data_to_verify = document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>.value+'/'+document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>.value+'/'+document.LoadInserisciPersonaFisica.<%=ICostantiPartiUdienza.CAMPO_ANNO_DATA_NASCITA%>.value;
...
<table cellspacing=2 cellpadding=2>
	...
	<tr>
		...
		<td class="L"><input title="Cognome" value="<%=anagraficaParteUdienza.getCognome() %>" type="text"
                       name="<%= ICostantiPartiUdienza.CAMPO_COGNOME %>"  maxlength="100" size="35"></td>
		<td class="l">Nome <font class=ob>(*)</font></td>
		<td class="L"><input title="Nome" value="<%=anagraficaParteUdienza.getNome() %>" type="text"
                       name="<%= ICostantiPartiUdienza.CAMPO_NOME %>"  maxlength="100" size="35"></td>
	</tr>
	
	<tr>
		<td class="l">Sesso <font class=ob>(*)</font></td>
		<td class="L"><select title="Sesso" name="<%=ICostantiPartiUdienza.CAMPO_SESSO%>">
          				<%= sesso %></select>
        </td>
...
<%
          if(modalita.equals("I")) {
%>
            <input type="text" title="Giorno Data di nascita" name="<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
            /
            <input type="text" title="Mese Data di nascita" name="<%= ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
            /
            <input type="text" title="Anno Data di nascita" name="<%= ICostantiPartiUdienza.CAMPO_ANNO_DATA_NASCITA %>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
<%
          } else {
%>
              <input title="Giorno Data di nascita" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(anagraficaParteUdienza.getDataNascita(),"dd")) %>" type="text" name="<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
              /
              <input title="Mese Data di nascita" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(anagraficaParteUdienza.getDataNascita(),"MM")) %>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA %>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
              /
              <input title="Anno Data di nascita" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(anagraficaParteUdienza.getDataNascita(),"yyyy")) %>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_ANNO_DATA_NASCITA %>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
<%
          }
%>
			<a href="javascript:calendario('LoadInserisciPersonaFisica','<%=ICostantiPartiUdienza.CAMPO_ANNO_DATA_NASCITA%>','<%=ICostantiPartiUdienza.CAMPO_MESE_DATA_NASCITA%>','<%=ICostantiPartiUdienza.CAMPO_GIORNO_DATA_NASCITA%>');">
        ...
        <td class="L">
          	<input title="Comune di Nascita" value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getDescComuneNascita()) %>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>"  maxlength="35" size="35" onChange="cancellaCodComuneReale();">
          	<a href="Javascript:ListaComuni('LoadInserisciPersonaFisica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_NASCITA %>');">
	...
	<tr>
		...
		<td class="L">
       		<select  title="Stato di Nascita" name="<%=ICostantiPartiUdienza.CAMPO_COD_STATO_NASCITA%>">
   				<%= nazioni %>
       		</select>
        </td>
		<td class="l">Comune di Nascita Estero</td>
		<td class="L"><input title="Comune di Nascita Estero" value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getDescComuneNascitaEstero()) %>" type="text"
	...
	<tr>
        ...
        <td class="l"><input title="Codice Fiscale" id=<%= ICostantiPartiUdienza.CAMPO_COD_FISCALE %>
        	value="<%=StringUtils.toStringJSP(anagraficaParteUdienza.getCodFiscale()) %>" type="text"
        	name="<%= ICostantiPartiUdienza.CAMPO_COD_FISCALE %>"  maxlength="16" size="18">
        </td>
        <td class="l" colspan="2">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td class="l"><input size=50 maxlength=200 value="<%if(anagraficaParteUdienza.getResidenza()!= null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getIndirizzo())%>" title="Indirizzo" type="text" name="<%= ICostantiPartiUdienza.CAMPO_INDIRIZZO %>"  >
			<input type="HIDDEN" name="<%=ICostantiPartiUdienza.CAMPO_ID_RESIDENZA %>" value="<%if(anagraficaParteUdienza.getResidenza()!= null)%><%=anagraficaParteUdienza.getResidenza().getIdResidenza()%>">
		</td>
        <td class="l">Luogo</td>
        <td class="L">
          <input title="Comune di Residenza"  value="<%if(anagraficaParteUdienza.getResidenza()!= null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getDescrComune())%>" type="text" name="<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_RESIDENZA %>"  maxlength="35" size="35">
          <a href="Javascript:ListaComuni('LoadInserisciPersonaFisica','<%= ICostantiPartiUdienza.CAMPO_COD_COMUNE_RESIDENZA %>');">
            <img src="/images/filefolder.gif" border=0>
          </a>
        </td>
    </tr>
	...
	<tr>
		<td class="l">CAP</td>
		<td class="l"><input size=5 maxlength=5 value="<%if(anagraficaParteUdienza.getResidenza() != null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getCap())%>" title="Cap" type="text" name="<%= ICostantiPartiUdienza.CAMPO_CAP_RESIDENZA %>"  ></td>
		<td class="l">Comune Estero</td>
		<td class="l"><input size=50 maxlength=200 value="<%if(anagraficaParteUdienza.getResidenza() != null)%><%=StringUtils.toStringJSP(anagraficaParteUdienza.getResidenza().getDescComuneEstero())%>" title="ComuneEstero" type="text" name="<%= ICostantiPartiUdienza.CAMPO_DESC_COMUNE_ESTERO_RESIDENZA %>"  ></td>
	</tr>

	<tr>
		<td class="l">Stato</td>
		<td class="L">
       		<select title="Stato di Residenza" name="<%=ICostantiPartiUdienza.CAMPO_COD_STATO_RESIDENZA%>">
   				<%= nazioniResidenza %>
       		</select>
        </td>
		<td class="l" colspan="2">&nbsp;</td>
