...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadInserisciParteUdienza">
  <table>
    <tr>
    	<td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Inserimento Parte <%=tipoParte%></font></td>
  ...
  <table width="87%">
    <tr>
      <td class="c" >
           Persona Fisica <input type="radio" name="<%=ICostantiPartiUdienza.RADIO_COD_PARTE%>" value="F"   onClick="VisualizzaPersonaFisica();" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		   Persona Giuridica <input type="radio" name="<%=ICostantiPartiUdienza.RADIO_COD_PARTE%>" value="G"   onClick="VisualizzaPersonaGiuridica();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
    </tr>
  </table>
  ...
  <div id="parteUdienza" style="position: relative; top: 0; left: 0;   visibility:visible; " >     
  	...
  	<div id="PersonaGiuridicaDiv" style="position: absolute; top: 0; left: 0; visibility:hidden; ">      
