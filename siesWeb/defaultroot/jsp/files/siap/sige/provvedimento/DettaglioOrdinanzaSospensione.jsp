...
<%
  ...
  String titolo = "Dettaglio Ordinanza Sospensione precedente Ordinanza";
  if (modificaOrdinanza)
	  titolo = "Modifica Ordinanza Sospensione precedente Ordinanza";
...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Ordinanza Sospensione precedente Ordinanza</title>
...
<%  if (Modificabile.compareTo("SI")==0) { %> 
  ...
  <table style="width: 95%;">
    <tr>
      <td class="Titolo">Oggetti Ordinanza Sospesa</td>
  ...
  <table  width="95%">
<% 
   if( ProvvedimentoEvento != null && ProvvedimentoEvento.getProvvedimento() != null  && ProvvedimentoEvento.getProvvedimento().getNote() != null)
  { %>  		
	  <tr>
	    <td class="Titolo" colspan="2">Motivazioni Ordinanza Sospensione </td>
	  </tr>
	  
	  <tr>
    	<td class="l" colspan=2><%=ProvvedimentoEvento.getProvvedimento().getNote()%></td>
	  </tr>
<%} %>

      <tr> 
      	<td class="l" width="60">Ufficio Competente </td>
      	<td class="L"><font class="campo"> <%=StringUtils.toStringJSP(provvedimento.getDescrUffCompCorteSuprema())%></font></td>
      </tr>
<% if (provvedimento.getDescrUfficioDestinatario()!= null  && provvedimento.getDescrUfficioDestinatario().length() > 2) { %>
      <tr>
      	...
      	<td class="L"><font class="campo"> <%=StringUtils.toStringJSP(provvedimento.getDescrUfficioDestinatario())%></font></td>
      </tr>
<% } %>

  </table>
  
    <jsp:include page="<%=ICostantiProvvedimentoSige.PG_LOAD_DESTINATARI_ORDINANZA_SOSPENSIONE%>"/>
    ...
    <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.provvedimento.action.ActDettaglioOrdinanzaSospensione">
          </td>
        </tr>
        </table>
        </FORM>
