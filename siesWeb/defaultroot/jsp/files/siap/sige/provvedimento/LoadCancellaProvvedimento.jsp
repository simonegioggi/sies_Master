  ...
  <%}%>
    ...
    <script language="JavaScript">
      function verify()
      {
        ...
        window.opener.top.frames['centrale'].frames['body'].location.href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sige.provvedimento.action.ActAnnullaProvvedimento&IdEvento="+<%=IdEvento%>+"&motivazioni="+lmotivazioni+"<%=nAction%>&TornaQui=10";
