...
%>
    ...
    <tr>
      ...
      <td class="l">
        ...
        &nbsp;
        <a class="cliccabile" href="Javascript:InserisciUdienza(document.LoadEmissioneOrdinanzaIncompetenza.<%=ICostantiFascicoloSige.CAMPO_COD_TIPO_GIUDIZIO%>.value);">Inserimento Udienza - Visualizza Collegio </a>
