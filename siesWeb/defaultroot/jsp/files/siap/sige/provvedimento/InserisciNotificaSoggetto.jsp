    ...
    <tr>
        ...
        <td class="l">
           <input Title="Sede " name="<%=ICostantiUdienzaSige.CAMPO_COD_LUOGO_DETENZIONE%>"
              ...
              <a href="Javascript:ListaComuniUNEP('<%=NomeForm%>','<%=ICostantiUdienzaSige.CAMPO_COD_LUOGO_DETENZIONE%>', document.<%=NomeForm%>.<%=ICostantiUdienzaSige.CAMPO_COD_IST_DETENZIONE%>.value );">
