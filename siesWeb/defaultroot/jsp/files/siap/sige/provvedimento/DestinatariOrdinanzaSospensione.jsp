...
<table cellspacing=2 cellpadding=2  width="95%">
  <tr>
    <td class="Titolo" colspan=2>Destinatari Ordinanza Sospensione</td>
  </tr>
<%
...
<%
      ...
      else if(notifica.getAvvIdAvvocatoFascicoloSige()!=null) // Avvocato SIGE
      {
        ...
        {%>
          <td class="l"> Per la notifica all' Avvocato &nbsp;<%=notifica.getAvvSige().getAvvocato().getDescrTipo()%>&nbsp;:&nbsp;
          	<font class="campo">
          		<%=StringUtils.toStringJSP(notifica.getAvvSige().getAvvocato().getCognome() +" "+notifica.getAvvSige().getAvvocato().getNome())%>
          	</font>&nbsp; 
          </td>
<%      	}
