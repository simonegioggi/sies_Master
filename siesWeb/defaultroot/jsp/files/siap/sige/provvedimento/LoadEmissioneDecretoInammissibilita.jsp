...
<%  	} %>
	...
	function setUdienza (idUdienza, dataUdienza, idCollegio, idSezione, codMagistrato) {
	 	if (dataUdienza != "null") {
			...
			if (idUdienza != null) {
				document.LoadEmissioneDecretoInammissibilita.idUdiSig.value = idUdienza;
	 	} 
	}
	}
	...
	function gestioneOggetti() {
    	var lLink;
		var idUdienza = document.LoadEmissioneDecretoInammissibilita.idUdiSig.value;
...
<%
		...
		String lAction = "siap.sige.provvedimento.action.ActInserisciDecretoInammissibilita";
		String lNomeFunzione = "Emissione Decreto di Inammissibilità";
        ...
        if (modalita.equalsIgnoreCase("M"))
		{
	        ...
	        lNomeFunzione = "Modifica Decreto di Inammissibilità";
  ...
  <table width="90%">
    ...
    <tr>
  			<div id="elenco1" style="width: 100%; display:block">
  				<jsp:include page="/jsp/files/siap/sige/tenore/ElencoDettaglioTenori.jsp"/>  			</div>
	</tr>
  </table>
<%} %>
