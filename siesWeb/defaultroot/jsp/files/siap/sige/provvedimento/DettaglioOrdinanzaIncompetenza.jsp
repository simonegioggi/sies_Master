...
<%
  ...
  String titolo = "Dettaglio Ordinanza Incompetenza";
  if (modificaOrdinanza)
	  titolo = "Modifica Ordinanza Incompetenza";
...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Ordinanza Incompetenza</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione :  </font>&nbsp;
          <font class="campo">Dettaglio Ordinanza Incompetenza</font>
      </td>
...
<%  if (Modificabile.compareTo("SI")==0) {%> 
  ...
  <table width="90%">
    <tr>
      ...
      <td class="Titolo">Esito</td>
       <%-- [EC] - 20171031 : intervento per risoluzione anomalia segnalata da SIGE - TRIBUNALE TERAMO 
		    emissione ordinzanza di incompetenza(email Maffucci del 27102017).	Aggiungo la colonna azioni
       --%>
    ...
    <tr>
	       ...
	       <%-- [EC] - 20171031 : intervento per risoluzione anomalia segnalata da SIGE - TRIBUNALE TERAMO 
		    emissione ordinzanza di incompetenza(email Maffucci del 27102017).	Includo la jsp ElencoGestioneTenori.jsp (prima includeva erroneamente ElencoDettaglioTenori)
       	    --%>
...
%>
 ...
 <%
  ...
  // E se non esiste il template predefinito.
     if(ProvvedimentoEvento.getEventoNotifica().getEvento().getTemIdTemplate() == null || 
    		ProvvedimentoEvento.getEventoNotifica().getEvento().getTemIdTemplate().trim().length() < 2 )
     {
 %>
    ...
    <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sige.provvedimento.action.ActDettaglioOrdinanzaIncompetenza">
          </td>
        </tr>
        </table>
        </FORM>
