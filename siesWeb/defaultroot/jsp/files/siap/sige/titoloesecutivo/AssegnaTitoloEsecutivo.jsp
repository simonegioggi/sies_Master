...
<%@ page import="siap.sige.titoloesecutivo.action.ICostantiTitoloEsecutivo" %>
  ...
  <head>
    ...
    <script language="JavaScript">
      ...
      function VerifyRicerca()
      {
        ...
        document.AssegnaTitoloEsecutivo.<%=IWebConstants.ACTION_FIELD%>.value="siap.sige.titoloesecutivo.action.ActRicercaTitoloEsecutivo"
      ...
      function Verify(aModalita)
      {
        ...
        if(aModalita=="I")
          document.AssegnaTitoloEsecutivo.<%=IWebConstants.ACTION_FIELD%>.value="siap.sige.titoloesecutivo.action.ActInserisciTitoloEsecutivo";

        if(aModalita=="M")
          document.AssegnaTitoloEsecutivo.<%=IWebConstants.ACTION_FIELD%>.value="siap.sige.titoloesecutivo.action.ActModificaTitoloEsecutivo";
        ...
        // Controllo soggetti.
	     if (<%=FascSiepTrovato.getIdFascicoloSiep()%> != null  )
	     {
	       ...
	       {
	         if(! confirm("Soggetto del Titolo Esecutivo differente dal soggetto del procedimento SIGE! Si vuole continuare ?" ) )
	         return false;
	       }
	     }
       if(aModalita=="I")
...
%>
  ...
  <table>
    <tr>
      <jsp:include page="<%=ICostantiFascicoloSige.PG_LOAD_SINTESISIGESIEP%>"/>
    </tr>
  </table>
  <br>
  <table>
...
%>
   ...
   <%}%>
    ...
    <table>
      <tr>
        <td class="lVerdeNB">N.B. Confermando l'operazione si associa il procedimento SIGE al Titolo Esecutivo selezionato </td>
      </tr>
    </table>
    ...
    <input type="HIDDEN" name="<%=ICostantiTitoloEsecutivo.CAMPO_FAS_SIGE_ID_FASCICOLO_SIGE%>" value="<%=FascicoloSigeEsteso.getFascicoloSige().getIdFascicoloSige() %>">
