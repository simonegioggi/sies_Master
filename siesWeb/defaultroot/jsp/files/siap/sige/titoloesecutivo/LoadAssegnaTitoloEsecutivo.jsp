  ...
  <head>
    ...
    <script language="JavaScript">
      ...
      function Verify()
      {
        ...
        document.LoadAssegnaTitoloEsecutivo.<%=IWebConstants.ACTION_FIELD%>.value="siap.sige.titoloesecutivo.action.ActRicercaTitoloEsecutivo"
...
<%
          ...
          lAction = "siap.sige.titoloesecutivo.action.ActAssegnaTitoloEsecutivo";
...
<%
          ...
          {
            lAction = "siap.sige.titoloesecutivo.action.ActModificaTitoloEsecutivo";
%>
