...
<html>
<head>
  <title>[S.I.E.S.] - Gestione Ordinanza Verbale Rinvio Udienza </title>
  	...
  	function Verify()
  	{
  	  ...
  	  // controlloMagistrato.	
			...
			if( !controlloTipoRito() )
	      	...
	      	if (!document.LoadInserisciVerbaleRinvioUdienza.<%=ICostantiUdienzaProcedimentoSige.CAMPO_CHECK_NUOVO_RUOLO%>.checked
	      			&& document.LoadInserisciVerbaleRinvioUdienza.<%=ICostantiUdienzaSige.CAMPO_ID_UDIENZA_SIGE%>.value == ""
	      			&& dataUdienza != "//"
	      			&& document.LoadInserisciVerbaleRinvioUdienza.<%=ICostantiFascicoloSige.CAMPO_COD_TIPO_GIUDIZIO%>.value == 'C'
	      			&& <%=ufficioConSezioni%>) {	
  ...
  <script language="JavaScript">
    ...
    function setUdienza (idUdienza, dataUdienza, idCollegio, idSezione, codMagistrato) {
		...
		if (idUdienza != null) {
			document.LoadInserisciVerbaleRinvioUdienza.idUdiSig.value = idUdienza;
    }
    }
	...
	function gestioneOggetti() {
    	var lLink;
		var idUdienza = document.LoadInserisciVerbaleRinvioUdienza.idUdiSig.value;
...
<%
    			String lAzione = new String();
					...
					lAzione = "siap.sige.udienzaprocedimento.action.ActInserisciVerbaleRinvioUdienza";
%>
       	<font class="campo">Inserimento Ordinanza Rinvio Udienza da Verbale</font>
      </td>
	  ...
	  <table cellspacing="2" cellpadding="2" width="100%">
  	  <tr>
	  	  <jsp:include page="<%=ICostantiMagistratoAssegnatario.PG_SINTESIMAGISTRATOASSEGNATARIO%>">
      		<jsp:param name="MagAssRitorno" value="siap.sige.udienzaprocedimento.action.ActLoadInserisciVerbaleRinvioUdienza"/>
    		</jsp:include>
    	</tr>
    	
      <jsp:include page="<%=ICostantiAvvocatoFascicoloSige.PG_INCLUDE_AVVOCATI%>">
      	<jsp:param name="AvvRitorno" value="siap.sige.udienzaprocedimento.action.ActLoadInserisciVerbaleRinvioUdienza"/>
      </jsp:include>
  	</table>
	<br>
