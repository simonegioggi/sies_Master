...
<%
	...
	String lAction = "siap.sius.depositosentenza.action.ActModificaRimessioneAtti";
	String lIdEvento = "";
	String lIdOrdinanza = "";
	String lIdDecreto = "";
	String lIdSentenza = "";
	...
	// Modifica Sentenza Rimessione Atti
 ...
 <html>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ModificaRimessioneAtti">
   ...
   for (int i=0; i< lTenori.length;i++)
    ...
    if (datiSentenza.getSentenza().getCodNaturaProvvedimento() != null)
    	textMotivazioni = datiSentenza.getSentenza().getCodNaturaProvvedimento();
    %>
    <tr>
  ...
  <table cellspacing="1" cellpadding="1" > 
   ...
   if (datiSentenza.getSentenza().getOggettoProcedimento() != null) {
	   if (datiSentenza.getSentenza().getOggettoProcedimento().compareTo("alla Corte Costituzionale per giudizio di legittimità costituzionale") == 0)
		   checkCorteCostituzionale = "checked";
	   else if (datiSentenza.getSentenza().getOggettoProcedimento().compareTo("alla Corte Giustizia Europea per giudizio di legittimità in materia di interpretazione trattati internazionali") == 0)
		   checkCorteEuropea = "checked";
	   else {
		   checkAltro = "checked";
		   filtroRemissioneAttiAltro = datiSentenza.getSentenza().getOggettoProcedimento().replaceFirst("a ", "");
	   }
    ...
    <tr>
        ...
        <td class="l" colspan=2>Sede  
             <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <a href="Javascript:ListaComuni('ModificaRimessioneAtti','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>');">
