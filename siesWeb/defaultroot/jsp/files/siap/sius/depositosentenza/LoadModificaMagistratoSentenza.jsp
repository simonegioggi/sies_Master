...
<html>
  ...
  <script language="JavaScript">
    ...
    function Verifica() {
      	if (document.LoadModificaMagistratoSentenza.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value == "") {
          alert('Scegliere il Magistrato Relatore selezionando un magistrato!');
          return false;
      	}
      	if (document.LoadModificaMagistratoSentenza.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value != CodMag
          	&& document.LoadModificaMagistratoSentenza.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value != "") {
          document.LoadModificaMagistratoSentenza.magistratoMod.value='YES';
        }
      	if (document.LoadModificaMagistratoSentenza.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value == CodMag){
          if (document.LoadModificaMagistratoSentenza.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value != ""){
	  ...
	  <table>
	    <tr> 
	      <td class="LBG">
	        ...
	        <font class="campo">Modifica Magistrato Sentenza </font>
	      </td>
	      <!-- BOTTONE DI RITORNO -->
    ...
    <% 
    	...
    	String lIdEventoGenerato = (String)request.getParameter("IdEvento");
     	...
     	if( modalita.equals("M") ) {
       	lAzione = "siap.sius.depositosentenza.action.ActModificaMagistratoSentenza";      
    %>
    <%
      }
    %>
  ...
  <br>
  <FORM method="POST" name="LoadModificaMagistratoSentenza" action="<%= IWebConstants.PG_MAIN%>">
...
<% if(utente.getUfficioUtente().getCodTipoUfficio().compareTo("TDS") == 0 ) 
   {%>
    <tr>
      <td class="L" >
        <a href="Javascript:chiamaLista('LoadModificaMagistratoSentenza');">
...
<% }else{%>
    <tr>
      <td class="L" >
        <a href="Javascript:chiamaListaSingola('LoadModificaMagistratoSentenza');">
					Seleziona dalla lista <img src="/images/filefolder.gif" border="0">
        </a>
      </td>
    </tr>
