...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Sentenza Generica</title>
  ...
  <script language="JavaScript">
    ...
    function Verify()
    {
      var lEsiti=document.InserisciSentenzaGenerica.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
 ...
 <%
  ...
  lAction = "siap.sius.depositosentenza.action.ActInserisciSentenzaTDS";
 %>
  ...
  <body class="corpo" >
    ...
    <tr>
      ...
      <td class=LBG><font class="label">Funzione : </font> <font class="campo">Emissione Sentenza Generica</font>&nbsp;
      </td>
    </tr>
    <tr>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciSentenzaGenerica">
    <table width=35%>
   <tr>
...
<br>
 ...
 <table cellspacing="2" cellpadding="2" width="90%">
    ...
    <input type="HIDDEN" name="<%=ICostantiDepositoSentenza.CAMPO_COD_TIPO_SENTENZA%>" value="<%=tipo_decreto%>" >
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciSentenzaGenerica");
