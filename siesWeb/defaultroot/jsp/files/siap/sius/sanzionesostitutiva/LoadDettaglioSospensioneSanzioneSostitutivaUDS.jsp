...
<FORM name="comandi" >
  <table>
    <tr>
      ...
      <%  if( modalita.equals("D") )  {%>
        <font class="campo">Dettaglio Sospensione Sanzione Sostitutiva</font>
      <%} else if( modalita.equals("C") ) { %>
        <font class="campo">Cancellazione Sospensione Sanzione Sostitutiva</font>
      <%}%>
      </td>
...
<table>
	...
	<tr>
		<td class="l">Autorità</td>
		<td class="l"><font class="campo"> <%=StringUtils.toStringJSP(PeriodoAltraSanzione
								.getDescrTipoUfficio())%> di <%=StringUtils.toStringJSP(PeriodoAltraSanzione
								.getDescrLuogoAutorita())%> </font></td>
	</tr>
	<%
		}
