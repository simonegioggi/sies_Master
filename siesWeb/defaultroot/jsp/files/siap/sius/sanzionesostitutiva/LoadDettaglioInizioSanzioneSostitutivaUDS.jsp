...
<head>
  ...
  <title> Dettaglio PeriodoAltraSanzione </title>
  <%} else if( modalita.equals("C") ) { %> 
  <title> Cancellazione PeriodoAltraSanzione </title>
  <%}%> 
...
<FORM name="comandi" >
  <table>
    <tr>
      ...
      <%  if( modalita.equals("D") )  {%> 
        <font class="campo">Dettaglio Inizio Sanzione Sostitutiva</font>
      <%} else if( modalita.equals("C") ) { %> 
        <font class="campo">Cancellazione Inizio Sanzione Sostitutiva</font>
      <%}%> 
      </td>
...
<table>
	...
	<tr>
		...
		<td class="l"><font class="campo"> <%=StringUtils.toStringJSP(DateUtils.getDateToString(
							PeriodoAltraSanzione.getDataScadenza(),
							"dd/MM/yyyy"))%></font></td>
	</tr>
