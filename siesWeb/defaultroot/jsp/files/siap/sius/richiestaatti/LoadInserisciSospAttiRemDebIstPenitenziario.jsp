...
<%
	...
	String lFormName = "LoadInserisciSospAttiRemDebIstPenitenziario";
  	String lAzione = "siap.sius.richiestaatti.action.ActInserisciSospAttiRemDebIstPenitenziario";
%>
...
<script language="JavaScript">
  ...
  function ListaIstitutoDetenzione(a_formname,a_fieldname,a_field2)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Sospensione Atti per Remissione Debito Istituto Penitenziario</title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Rapporto su Periodo Detenzione</font>
      </td>
      <td class="LBG">
      ...
      <!-- Start new impl -->
       	...
       	<tr>
        	...
        	<td class="l">
              	...
              	<a href="Javascript:ListaIstitutoDetenzione('LoadInserisciSospAttiRemDebIstPenitenziario','<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO %>','Comune');">
        ...
        <tr>
        	<td class="l">Periodo Detenzione</td>
          <td class="L" colspan=3>
             <input title="Periodo Detenzione" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO %>" type="text" maxlength="80" size="80">
          </td>
        </tr>
        <tr>
        	<td class="l">Somma per spese mantenimento</td>
          <td class="L" colspan=3>
             <input title="Somma per spese mantenimento" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO %>" type="text" maxlength="80" size="80">
          </td>
        </tr>
