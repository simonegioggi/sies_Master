...
<%
  ...
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciCarteggioDAP41bis";
%>
...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta Carteggio DAP 41 bis</title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function Verify()
    {
      if (document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      if (document.LoadInserisciCarteggioDAP41bis.<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>[0].value == '')
          {
              alert('Data emissione provvedimento 41 bis è un campo obbligatorio');
              return false;
          }
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta Carteggio DAP 41 bis</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciCarteggioDAP41bis">
      ...
      <tr>
        ...
        <td class="l">
           <input Title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <a href="Javascript:ListaUffici('LoadInserisciCarteggioDAP41bis','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>');">
              <img src="/images/filefolder.gif" border=0> </a>
        </td>
      </tr>

      <tr>
        <td class="l">Data emissione provvedimento 41 bis <font class=ob>(*)</font></td>
        <td class="l"><input type="text" Title="Data emissione provvedimento 41 bis" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>" size="40"></td>
      </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciCarteggioDAP41bis");
