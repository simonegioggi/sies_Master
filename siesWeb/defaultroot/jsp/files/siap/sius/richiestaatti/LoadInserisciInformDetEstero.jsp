...
<jsp:useBean id="lSedeIstituto1"    scope="request" class="java.lang.String"/>
<jsp:useBean id="TipiIstituti2"     scope="request" class="java.lang.String"/>

<%
  // Azione da chiamare per l'inserimento dei dati.
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciInformDetEstero";
%>
...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta stampa Inform. Detenzione Estero </title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function Verify()
    {
      if (document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      if (document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
        alert('La Sede del destinatario 1 è obbligatoria');
        return false;
      }
      if (document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
      {
      ...
      if (document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
       && document.LoadInserisciInformDetEstero.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-')
      {
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta stampa Informativa Detenzione Estero</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciInformDetEstero">
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <tr>
          ...
          <td class="L" colspan=3>
           <table>
             ...
             <td class="l">
               <select title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>">
                 <%= lSedeIstituto1 %>
               </select>
          </td>
          </tr>
          <tr>
            ...
            <td class="L" colspan=3>
             <input title="Indirizzo" name="<%=ICostantiRichiestaAtti.CAMPO_NOTE%>" type="text" maxlength="80" size="80">
            </td>
          </tr>
          </table>
        </tr>
           ...
           <table>
             ...
             <td class="l">
               <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                ...
                <a href="Javascript:ListaComuni('LoadInserisciInformDetEstero','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
        ...
        <!-- Campo Note + campo hidden -->
        <tr>
            <td class="l">Periodi Detenzione</td>
            <td class="L" colspan=3>
             <input title="Note" name="<%= ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO %>"   value="" type="text" maxlength="80" size="80">
            </td>
            <input name="<%=ICostantiRichiestaAtti.CAMPO_NOTE%>" value="" type="hidden" >
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciInformDetEstero");
