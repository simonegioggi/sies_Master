...
<%
	...
	String lFormName = "LoadInserisciLavoroSostitutivo";
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciLavoroSostitutivo";
%>
...
<script language="JavaScript">
  ...
  function ListaComuniCompleta(a_formname,a_fieldname)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Invito Per Accordi Preliminari A Lavoro Sostitutivo </title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Invito Per Accordi Preliminari A Lavoro Sostitutivo</font>
      </td>
      <td class="LBG">
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
       ...
       <!-- End Destinatario 2 -->
        ...
        <tr>
        	<td class="l">Ufficio Da Contattare</td>
          <td class="L" colspan=3>
