...
<%
  ...
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciInformazioniAttivitaLavorativa";
...
<script language="JavaScript">
	...
	function abilitaCampiDataRestituzione() {
		if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CHECK_DATA_RESTITUZIONE%>.checked){
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.disabled = false;
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = false;
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.disabled = false;
		}
		else {
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.disabled = true;
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = true;
	   		document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.disabled = true;
		}    	
	}
 	...
 	function Verify()
    {
      ...
      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
      	alert('La Sede del destinatario n°1 è obbligatoria');
        return false;
      }
      
      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
      {
      ...
      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
          && document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-')
      {
      	alert('Inserire almeno un Destinatario con la relativa Sede.');
        return false;
      }

      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione.
      var data_emissione=document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>[0].value == '')
      {
      	alert('Descrizione offerta di lavoro è un campo obbligatorio');
        return false;
      }

      <%-- INIZIO: MEV_2019-09 (D.lgs. 123/2018) --%>
      if (document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CHECK_DATA_RESTITUZIONE%>.checked){
	      var data_restituzione = document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.value
	                        +'/'+ document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.value
	                        +'/'+ document.LoadInserisciInformazioniAttivitaLavorativa.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.value;
...
<html>
  ...
  <body onLoad="document.forms[0].elements[0].focus()" class="corpo">
    <table>
      <tr>
        ...
        <td class="LBG">
          ...
          <font class="campo">Informazioni su attività lavorativa</font>
        </td>
      	<td class="LBG">
    ...
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciInformazioniAttivitaLavorativa">
      <table cellspacing=2 cellpadding=2>
          ...
          <table>
          	...
          	<tr>
          		...
          		<td class="l">
                	...
                	<a href="Javascript:ListaComuni('LoadInserisciInformazioniAttivitaLavorativa','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
          ...
          <table>
          	...
          	<tr>
          		...
          		<td class="l">
            		<input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                	value="" type="text" maxlength="35" size="35">
                	<a href="Javascript:ListaComuni('LoadInserisciInformazioniAttivitaLavorativa','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
                	<img src="/images/filefolder.gif" border=0> </a>
          		</td>
          	</tr>
          	<tr>
        ...
        <tr>
          <td class="l">Descrizione offerta di lavoro <font class=ob>(*)</font></td>
          <td class="L">
          	<TEXTAREA title="Descrizione offerta di lavoro" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>"  cols=40 rows=5 ></textarea>
          </td>
        </tr>
    ...
    <script language="JavaScript" type="text/javascript">
      var frmvalidator = new Validator("LoadInserisciInformazioniAttivitaLavorativa");
