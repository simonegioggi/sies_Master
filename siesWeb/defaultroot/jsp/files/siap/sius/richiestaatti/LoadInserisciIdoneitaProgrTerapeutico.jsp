...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta Idoneita Programma Terapeutico</title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function abilitaCampiDataRestituzione() {
    	if (document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CHECK_DATA_RESTITUZIONE%>.checked){
	   		...
	   		document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = false;
	   		document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.disabled = false;
    	}
    	else {
	   		document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.disabled = true;
	   		document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = true;
    ...
    function Verify()
    {
      if (document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      var data_restituzione = document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.value
                        ...
                        +'/'+ document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.value;
      ...
      if (document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == null ||
          document.LoadInserisciIdoneitaProgrTerapeutico.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
          {
              alert('Il destinatario n°1 è obbligatorio! Specificare la sede.');
              return false;
          }
      return true;
    }
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta Idoneita Programma Terapeutico</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciIdoneitaProgrTerapeutico">
    <table cellspacing=2 cellpadding=2>
      ...
      <!-- Primo destinatario + luogo -->
        ...
        <td class="l"><input type="text" Title="Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_DES_DESTINATARIO%>" value="<%=descTipoUfficioS2%>" size="40" readonly ></td>
        <td><input type="hidden" Title="Codice Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>" value="<%=codTipoUfficioS2%>" size="5"></td>
          ...
          <td class="l">
           ...
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <a href="Javascript:ListaComuni('LoadInserisciIdoneitaProgrTerapeutico','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
      ...
      <!-- secondo destinatario + luogo -->
        ...
        <td class="l"><input type="text" Title="Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_DES_DESTINATARIO%>" value="<%=descTipoUfficioS%>" size="40" readonly ></td>
        <td><input type="hidden" Title="Codice Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>" value="<%=codTipoUfficioS%>" size="5"></td>
          ...
          <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              value="" type="text" maxlength="35" size="35">
              <a href="Javascript:ListaComuni('LoadInserisciIdoneitaProgrTerapeutico','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
              <img src="/images/filefolder.gif" border=0> </a>
          ...
          <tr>
            <td class="l">Desc. Comunità</td>
            <td class="l" colspan=4><input type="text" Title="Desc. Comunità" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>" size="40"></td>
          </tr>
          </table>
        </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciIdoneitaProgrTerapeutico");
