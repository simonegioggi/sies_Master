...
<%
	...
	String lFormName = "LoadInserisciSospAttiRemDebAgenziaEntrate";
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciSospAttiRemDebAgenziaEntrate";
%>
...
<script language="JavaScript">
  ...
  function ListaComuniCompleta(a_formname,a_fieldname)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Sospensione Atti per Remissione Debito Agenzia Entrate </title>
    ...
    function Verify()
    {
      ...
      if (document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
        alert('La Sede del destinatario 1 è obbligatoria');
        return false;
      }
      // Destinatario 2
      if (document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Richiesta Certificazione Remissione Debito</font>
      </td>
      <td class="LBG">
          ...
          <tr>
            ...
            <td class="l">
            	<input Title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>" value="" type="text" maxlength="35" size="35">
                	<a href="Javascript:ListaComuniRicercaUfficio('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
      ...
      <tr>
        ...
        <table>
          ...
          <tr>
            ...
            <td class="l">
            	<input Title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>" value="" type="text" maxlength="35" size="35">
                	<a href="Javascript:ListaComuniRicercaUfficio('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
               		<img src="/images/filefolder.gif" border=0> </a>
            </td>
          </tr>
          <tr>
