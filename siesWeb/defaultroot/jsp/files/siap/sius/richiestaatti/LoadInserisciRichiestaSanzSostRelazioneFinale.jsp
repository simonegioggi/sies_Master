...
<%
	...
	String lFormName = "LoadInserisciRichiestaSanzSostRelazioneFinale";
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciSanzSostRelazioneFinale";
%>
...
<script language="JavaScript">
  ...
  function ListaComuniCompleta(a_formname,a_fieldname)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Richiesta Relazione Finale Sanzioni Sostitutive </title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Relazione Finale</font>
      </td>
      <td class="LBG">
