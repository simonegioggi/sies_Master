...
<%
  ...
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciInformDiffEsPenaArt146c2";
%>
...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta stampa Inform.Diff.Esecuzione Pena art. 146 c2 </title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function Verify()
    {
      if (document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      if (document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
        alert('La Sede del destinatario 1 è obbligatoria');
        return false;
      }
      if (document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
      {
      ...
      if (document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
       && document.LoadInserisciInformDiffEsPenaArt146c2.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-')
      {
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta stampa Inform.Diff.Esecuzione Pena art. 146 c2</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciInformDiffEsPenaArt146c2">
      ...
      <tr>
        ...
        <tr>
           ...
           <table>
             ...
             <td class="l">
               <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                ...
                <a href="Javascript:ListaComuni('LoadInserisciInformDiffEsPenaArt146c2','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
          ...
          <tr>
            ...
            <td class="L" colspan=3>
             <input title="Indirizzo" name="<%=ICostantiRichiestaAtti.CAMPO_NOTE%>" value="DIREZIONE SANITARIA" type="text" maxlength="80" size="80">
            </td>
          </tr>
          </table>
        </tr>
          ...
          <td class="L" colspan=3>
           <table>
             ...
             <td class="l">
               <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                value="" type="text" maxlength="35" size="35">
                <a href="Javascript:ListaComuni('LoadInserisciInformDiffEsPenaArt146c2','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
                <img src="/images/filefolder.gif" border=0> </a>
          </td>
          </tr>
          <tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciInformDiffEsPenaArt146c2");
