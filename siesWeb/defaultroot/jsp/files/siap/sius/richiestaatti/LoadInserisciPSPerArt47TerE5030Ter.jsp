...
<script language="JavaScript">
    ...
    function Verify()
    {
      ...
      if (document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
      ...
      if (document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
      {
      ...
      if (document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
          && document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-')
      {
      	alert('Inserire almeno un Destinatario con la relativa Sede.');
        return false;
      }

      if (document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciPSPerArt47TerE5030Ter.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
...
<html>
  ...
  <body onLoad="document.forms[0].elements[0].focus()" class="corpo">
    <table>
      <tr>
        ...
        <td class="LBG">
          ...
          <font class="campo">Richiesta P.S. per art. 47-47 Ter-50- 30 Ter</font>
        </td>
      	<td class="LBG">
    ...
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciPSPerArt47TerE5030Ter">
          	...
          	<tr>
          		...
          		<td class="l">
             		<input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                		...
                		<a href="Javascript:ListaComuni('LoadInserisciPSPerArt47TerE5030Ter','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
          ...
          <table>
          	<tr>
          		...
          		<td class="l">
            		<input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                		value="" type="text" maxlength="35" size="35">
                		<a href="Javascript:ListaComuni('LoadInserisciPSPerArt47TerE5030Ter','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
                		<img src="/images/filefolder.gif" border=0> </a>
          		</td>
          	</tr>
          	<tr>
    ...
    <script language="JavaScript" type="text/javascript">
      var frmvalidator = new Validator("LoadInserisciPSPerArt47TerE5030Ter");
