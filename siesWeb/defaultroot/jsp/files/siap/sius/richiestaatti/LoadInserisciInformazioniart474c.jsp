...
<%
  ...
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciInformazioniart474c";
...
<script language="JavaScript">
    ...
    function scegliTipo() {
    	var tipo = document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value;
    	if ("B5" == tipo)
    		ListaUSSM('LoadInserisciInformazioniart474c','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');
    	else
    		ListaUfficiCSSA('LoadInserisciInformazioniart474c','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');
    }
...
<script language="JavaScript">
	...
	function abilitaCampiDataRestituzione() {
		if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CHECK_DATA_RESTITUZIONE%>.checked){
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.disabled = false;
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = false;
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.disabled = false;
		}
		else {
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.disabled = true;
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.disabled = true;
	   		document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.disabled = true;
		}    	
		}
    ...
    function Verify()
    {
      ...
      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
          {
              alert('La Sede del destinatario n°1 è obbligatoria');
              return false;
          }
      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
          {
              alert('La Sede del destinatario n°2 è obbligatoria');
              return false;
          }
      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[2].value != '-'
          && document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[2].value == '')
          {
      ...
      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
          && document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-'
          && document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[2].value == '-')
          {
              alert('Inserire almeno un Destinatario con la relativa Sede.');
              return false;
          }

      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      <%-- INIZIO: MEV_9 (D.lgs. 123/2018) --%>
      if (document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CHECK_DATA_RESTITUZIONE%>.checked){
	      var data_restituzione = document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_RESTITUZIONE%>.value
	                        +'/'+ document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_RESTITUZIONE%>.value
	                        +'/'+ document.LoadInserisciInformazioniart474c.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_RESTITUZIONE%>.value;
...
<html>
  <head>
      <title>[S.I.E.S.] - Richiesta Informazioni 47 - 4c</title>
  ...
  <body onLoad="document.forms[0].elements[0].focus()" class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Richiesta Informazioni 47 - 4c</font>
        </td>
      <td class="LBG">
    ...
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciInformazioniart474c">
      <table cellspacing=2 cellpadding=2>
        ...
        <tr>
          ...
          <td class="l">
            <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                value="" type="text" maxlength="35" size="35">
                <a href="Javascript:ListaComuni('LoadInserisciInformazioniart474c','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
                <img src="/images/filefolder.gif" border=0> </a>
          </td>
          </tr>
          <tr>
        ...
        <tr>
          ...
          <td class="l">
            <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                value="" type="text" maxlength="35" size="35">
                <a href="Javascript:ListaComuni('LoadInserisciInformazioniart474c','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[2]');">
                <img src="/images/filefolder.gif" border=0> </a>
          </td>
          </tr>
          <tr>
    ...
    <script language="JavaScript" type="text/javascript">
      var frmvalidator = new Validator("LoadInserisciInformazioniart474c");
