...
<jsp:useBean id="ElencoTipiUfficio" 							scope="request" class="java.lang.String"/>
<jsp:useBean id="EstremiProvvedimento" 							scope="request" class="java.lang.String"/>

<%
	//Azione da chiamare per l'inserimento dei dati.
	String lFormName = "LoadInserisciSospAttiRemDebUffRecuperoCrediti";
  String lAzione = "siap.sius.richiestaatti.action.ActInserisciSospAttiRemDebUffRecuperoCrediti";
%>

<script language="JavaScript">
  var desktop;

  // Chiamata lista Comuni Sede del tipo ufficio selezionato.
  function ListaComuniRicercaUfficioSelezionato(a_formname,a_fieldname,codTipoUfficio)
  {
  ...
  function ListaComuniCompleta(a_formname,a_fieldname)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Sospensione Atti per Remissione Debito Ufficio Recupero Crediti</title>
    ...
    function Verify()
    {
      ...
      if (document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
       && document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-'
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Sospensione Atti per Remissione Debito Ufficio Recupero Crediti</font>
      </td>
      <td class="LBG">
      ...
      <!-- Start new impl -->
		...
		<tr>
          <tr>
            ...
            <td class="l">
            	<input type="hidden" Title="Tipo" name="tipoDest" value="UFF_REC_CRED" size="50">
          ...
          <tr>
            ...
            <td class="l">
            	<input Title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>" value="" type="text" maxlength="35" size="35">
                	<a href="Javascript:ListaComuniRicercaUfficioSelezionato('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>', document.<%=lFormName%>.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>.value);">
        ...
        <tr>
          ...
          <td class="L" colspan=3>
             <input title="Estremi Provvedimento" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO %>" value="<%=EstremiProvvedimento%>" type="text" maxlength="80" size="80">
          </td>
        </tr>
        <tr>
        	<td class="l">Numero Campione Penale</td>
          <td class="L" colspan=3>
             <input title="Campione Penale" name="<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO %>" type="text" maxlength="80" size="80">
          </td>
        </tr>
