...
<%
	...
	String lFormName = "LoadInserisciInfINPS";
  String lAzione = "siap.sius.misuresicurezzarichiestaatti.action.ActInserisciInformazioniINPS";
%>
...
<script language="JavaScript">
  var desktop;
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Richiesta Informazioni INPS</title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Richiesta Informazioni INPS</font>
      </td>
      <td class="LBG">
      ...
      <tr>
        ...
        <td class="l">
           <input Title="Sede" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <a href="Javascript:ListaComuni('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>');">
