...
<%
  ...
  String lAzione = "siap.sius.misuresicurezzarichiestaatti.action.ActInserisciRichiestaRelazioneSocioFam";
%>
...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta Relazione Socio Familiare</title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function Verify()
    {
      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      // Destinatario 1
      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value != '-'
          && document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0].value == '')
      {
        alert('La Sede del destinatario 1 è obbligatoria');
        return false;
      }
      // Destinatario 2
      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value != '-'
          && document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1].value == '')
      {
        alert('La Sede del destinatario 2 è obbligatoria');
        return false;
      }
      // Destinatario 3
      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[2].value != '-'
          && document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[2].value == '')
      {
      ...
      if (document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[0].value == '-'
       && document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[1].value == '-'
       && document.LoadInserisciRichiestaSocioFam.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[2].value == '-' )
      {
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta Relazione Socio Familiare</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciRichiestaSocioFam">
...
<!-- Primo destinatario + luogo -->
      <tr>
        <td class="l">Destinatario n°1 <font class=ob></font></td>
        <td class="l" >
      ...
      <tr>
        ...
        <td class="l">
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <a href="Javascript:ListaUffici('LoadInserisciRichiestaSocioFam','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
      ...
      <tr>
        <td class="l">Destinatario n°2 <font class=ob></font></td>
        <td class="l" >
        <input type="hidden" Title="Tipo" name="tipoDest" value="AUT_EXT" size="50">
        <select title="Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>">
          <%= descTipoUfficioS %>
      ...
      <tr>
        ...
        <td class="l">
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              value="" type="text" maxlength="35" size="35">
              <a href="Javascript:ListaUffici('LoadInserisciRichiestaSocioFam','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
              <img src="/images/filefolder.gif" border=0> </a>
        </td>
      </tr>
      ...
      <!-- Terzo destinatario + luogo -->
        <tr>
          ...
          <td class="l"> Tipo</td>
          <td class="l" >
          <input type="hidden" Title="Tipo" name="tipoDest" value="terzo" size="50">
        <select title="Destinatario" name="<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>">
          <%= TipiIstituti1 %>
        </select>
          </td>
          ...
          <td class="l">
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              value="" type="text" maxlength="35" size="35">
              <a href="Javascript:ListaComuni('LoadInserisciRichiestaSocioFam','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[2]');">
              <img src="/images/filefolder.gif" border=0> </a>
          </td>
          </tr>
          <tr>
            ...
            <td class="L" colspan=3>
             <input title="Indirizzo" name="<%=ICostantiIstruttoria.TIPO_DOCUMENTO %>" value="" type="text" maxlength="80" size="80">
            </td>
          </tr>
          </table>
        </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciRichiestaSocioFam");
