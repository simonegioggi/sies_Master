...
<jsp:useBean id="ElencoTipo1"    	scope="request" class="java.lang.String"/>
...
<%
	...
	String lFormName = "LoadInserisciRicCondEconomiche";
  String lAzione = "siap.sius.misuresicurezzarichiestaatti.action.ActInserisciInfCondottaLFE";
%>
...
<script language="JavaScript">
  ...
  function ListaComuniCompleta(a_formname,a_fieldname)
  {
	...
	<html>
	<head>
  	<title>[S.I.E.S.] - Richiesta Informazioni Condotta LFE</title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Richiesta Informazioni Condotta LFE</font>
      </td>
      <td class="LBG">
    ...
    <table cellspacing=2 cellpadding=2>
	 ...
	 <!-- Start Destinatario 1 -->
          	...
          	<tr>
          		...
          		<td class="l">
             		<input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                		...
                		<a href="Javascript:ListaComuni('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[0]');">
      ...
      <tr>
        <td class="l">Sede <font class=ob></font></td>
        <td class="l">
        <input type="hidden" Title="Tipo" name="<%=ICostantiRichiestaAtti.CAMPO_NOTE%>" value=""  maxlength="80" size="80">
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              value="" type="text" maxlength="35" size="35">
              <a href="Javascript:ListaUffici('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[1]');">
              <img src="/images/filefolder.gif" border=0> </a>
        </td>
      </tr>
          ...
          <table>
          	<tr>
          		...
          		<td class="l">
             		<input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
                		value="" type="text" maxlength="35" size="35">
                		<a href="Javascript:ListaComuni('<%=lFormName%>','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>[3]');">
                		<img src="/images/filefolder.gif" border=0> </a>
          		</td>
          	</tr>
          	<tr>
