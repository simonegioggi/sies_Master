...
<%
  ...
  String lAzione = "siap.sius.misuresicurezzarichiestaatti.action.ActInserisciPeriziaPsichiatrica";
%>
...
<html>
<head>
  <title>[S.I.E.S.] - Richiesta Perizia Psichiatrica</title>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
    ...
    function Verify()
    {
      if (document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value;

      if (document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
          document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value;

      // Controllo validita' della data emissione
      var data_emissione=document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      ...
      if (document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_AGGIUNTIVO%>[0].value == '')
          {
...
<body onLoad="document.forms[0].elements[0].focus()" class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Richiesta Perizia Psichiatrica</font>
      </td>
      <td class="LBG">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciPeriziaPsichiatrica">
      ...
      <td class="l">Sede <font class=ob>(*)</font></td>
        <td class="l">
           <input Title="Sede " name="<%=ICostantiRichiestaAtti.CAMPO_SEDE%>"
              ...
              <%--a href="Javascript:ListaUffici('LoadInserisciPeriziaPsichiatrica','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>');"--%>
              <a href="Javascript:ListaUfficiPerTipo('LoadInserisciPeriziaPsichiatrica','<%=ICostantiRichiestaAtti.CAMPO_SEDE%>',document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>[document.LoadInserisciPeriziaPsichiatrica.<%=ICostantiRichiestaAtti.CAMPO_COD_DESTINATARIO%>.selectedIndex].value);">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadInserisciPeriziaPsichiatrica");
