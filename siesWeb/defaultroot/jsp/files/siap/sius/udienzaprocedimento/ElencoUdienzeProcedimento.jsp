...
if (modalita.compareTo("action") == 0) {
	String lRifFas = "";
	if (fascicoloSiusGP.getFascicoloSiusModel() != null
			&& fascicoloSiusGP.getFascicoloSiusModel().getChiaveAnno() != null
			&& fascicoloSiusGP.getFascicoloSiusModel().getChiaveProgr() != null) {
...
%>
	<tr><td class="int" align="left"> Non ci sono udienze fissate per il procedimento.</td></tr>
<%
} else {
%>
	<tr>
...
%>
	<tr>
      	<td class="L">
      		<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(udipro.getDataUdienza() , "dd-MM-yyyy"), "-")%></font>
      	</td>
      	<td class="L">
      		<font class="campo"><%=StringUtils.toStringJSP(tipoOp, "-")%></font>
      	</td>
      	<td class="L">
      		<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(udipro.getUdienzaProcedimento().getDataInserimento(), "dd-MM-yyyy"), "-")%></font>
      	</td>
      	<td class="L">
      		<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(udipro.getUdienzaProcedimento().getDataAggiornamento(), "dd-MM-yyyy"), "-")%></font>
      	</td>
	</tr>
<%
	} // endwhile
