...
function Verify() {
	if (document.LoadInserisciPreFissazioneUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%>.value.length == 1)
		document.LoadInserisciPreFissazioneUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%>.value = '0' + 
		document.LoadInserisciPreFissazioneUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%>.value;
	if (document.LoadInserisciPreFissazioneUdienza.<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA%>.value.length==1)
		document.LoadInserisciPreFissazioneUdienza.<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA%>.value = '0' +
