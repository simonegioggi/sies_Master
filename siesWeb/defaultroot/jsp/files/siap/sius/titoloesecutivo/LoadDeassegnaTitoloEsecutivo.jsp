...
<%
  SoggettoModel lSoggetto = fascicoloSiusGP.getFascicoloSiusModel().getSoggetto();
%>


<html>
  <head>
    <title>[S.I.E.S.] - Deassegnazione Titolo Esecutivo Principale</title>
    ...
    var desktop;
      ...
      function Verify()
      {
        ...
        if(! confirm("Si conferma la Deassegnazione del Titolo Esecutivo?" ) )
        	{
        	    document.LoadDeassegnaTitoloEsecutivo.<%=ICostantiTitoloEsecutivo.CHECK_DEASSEGNA_TITOLO_ESECUTIVO%>.checked = false;  
        		return true;
        	}
...
<%
          ...
          lAction = "siap.sius.titoloesecutivo.action.ActDeassegnaTitoloEsecutivo";
          
%>
            <font class="campo">Deassegnazione Titolo Esecutivo Principale</font>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadDeassegnaTitoloEsecutivo'>
   ...
   <table cellspacing=0 cellpadding=0 width=95%>
    <tr>
      <td class="l" width=50%>Per confermare la deassegnazione del Titolo Esecutivo</td>
      <td class="lRosso">  
