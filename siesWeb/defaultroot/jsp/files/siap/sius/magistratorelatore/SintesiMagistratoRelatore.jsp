...
<table cellspacing=0 cellpadding=0 style="width: 95%;">
    ...
    <%         	
            		   ...
            		   if( lCodTipoDecreto!=null && !lCodTipoDecreto.equals(ICostantiDepositoDecreto.IRREPERIBILITA) && !lCodTipoDecreto.equals(ICostantiDepositoDecreto.CITAZIONE) ) { 
    %>
										&nbsp; - &nbsp;
										<a class="cliccabile" 
