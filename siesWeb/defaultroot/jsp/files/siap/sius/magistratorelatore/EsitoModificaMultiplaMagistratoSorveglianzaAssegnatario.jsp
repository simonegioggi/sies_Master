...
<html>
  <head>
    ...
    <script>
      ...
      {
        document.EsitoModificaProcedimentiMagistratoRelatore.submit();
      }
    </script>
...
<body class="corpo">
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Esito Cambio Magistrato Relatore</font>
      </td>
  ...
  //============================================================================
  %>
  <form method="POST" name="EsitoModificaProcedimentiMagistratoRelatore" action="<%= IWebConstants.PG_MAIN%>">
