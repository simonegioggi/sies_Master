...
<html>
  <head>
    ...
    <script language="JavaScript">
      function Verify()
      {
        if(document.LoadRicercaProcedimentiMagistratoRelatore.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="")
        {
          alert("Il Cognome del Magistrato è obbligatorio");
          return false;
        }

        if(document.LoadRicercaProcedimentiMagistratoRelatore.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
        {
...
<body class="corpo">
  ...
  <FORM method="POST" name="LoadRicercaProcedimentiMagistratoRelatore" action="<%= IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.magistratorelatore.action.ActRicercaProcedimentiSorveglianzaAssegnati">
    ...
    <table>
      ...
      <tr>
        ...
        <td class="L">
          ...
          <a href="Javascript:ListaMagistrati('LoadRicercaProcedimentiMagistratoRelatore');">
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator = new Validator("LoadRicercaProcedimentiMagistratoRelatore");
