...
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadRicercaSoggettoFascicoloSiep">
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l"><input  title="Comune di nascita" type="text" name="<%=ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA%>" value="" size="30" maxlength="30">
          <a href="Javascript:ListaComuni('LoadRicercaSoggettoFascicoloSiep','<%=ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
...
%>
			<a href="javascript:calendario('LoadRicercaSoggettoFascicoloSiep','<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>');">
