...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Procedimenti di Esecuzione Sanzioni Sostitutive</title>
...
%>
        <tr>
          <td class="lVerdeNB">Visualizzazione di tutti i procedimenti di Esecuzione Sanzioni Sostitutive, compresi quelli pervenuti da altri Distretti</td>
        </tr>
<%    }
      if(codDistretto.length()> 1 )
      {
%>
        <tr>
          <td class="lVerdeNB">Visualizzazione dei procedimenti di Esecuzione S. S. dell'intero Distretto</td>
        </tr>
<%    }
...
%>
      <tr>
        ...
        <td class="c">
          ...
          <jsp:include page="<%=ICostantiFascicoloSius.PG_BUTTONS_PROC_DI_ESS%>">
