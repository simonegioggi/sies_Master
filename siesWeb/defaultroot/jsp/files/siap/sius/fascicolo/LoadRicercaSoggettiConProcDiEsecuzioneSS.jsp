...
<script language="JavaScript">
    ...
    function cancellaCodComuneReale() {
      	document.LoadRicercaSoggettiConProcDiEsecuzioneSS.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
    }    
  </script>
		...
		<table cellspacing=2 cellpadding=2>
			...
			<tr>
				...
				<td class="l"><input Title="Comune di nascita"
					...
					<a href="Javascript:ListaComuniNascita('LoadRicercaSoggettiConProcDiEsecuzioneSS','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
