...
<html>
<head>
<title>[S.I.E.S.] - Gestione Domicili Procedimento </title>
...
<%
     ...
     {
%>
    document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_ID_RESIDENZA%>.value = '0';
<%    } %>
    modificato = true;
    return;
  }
  ...
  function Verify()
  {
    if (document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_COD_STATO%>[document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_COD_STATO%>.selectedIndex].value=='039')
    {
      document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO %>.value="";
      if (document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESCR_COMUNE %>.value.length==0)
      {
    ...
    {
      document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO %>.value="";
      document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESCR_COMUNE%>.focus();
      alert('Per Italia specificare solo il Luogo, non il Comune Estero.');
      return false;
    }
    if ( (document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_COD_STATO%>[document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_COD_STATO%>.selectedIndex].value!='039')
    &&( document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESCR_COMUNE %>.value!=""))
    {
      document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESCR_COMUNE %>.value="";
      document.LoadInserisciDomicilioFascicoloSius.<%= ICostantiResidenza.CAMPO_DESC_COMUNE_ESTERO %>.focus();
    ...
    else if (document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>.value=="")
    {
  ...
  function cancellaCodComuneReale() {
  	document.LoadInserisciDomicilioFascicoloSius.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
  }
...
<%
        ...
        if( modalita.equals("I") )
        {
         lAction = "siap.sius.fascicolo.action.ActInserisciDomicilioFascicoloSius";
%>
           <font class="campo">Inserimento Domicilio Procedimento</font>
<%
        }
         else if( modalita.equals("M") )
        {
          lAction = "siap.sius.fascicolo.action.ActInserisciDomicilioFascicoloSius";
%>
           <font class="campo">Modifica Domicilio Fascicolo</font>
<%
       }
%>
      </td>
  ...
  <br>
<form method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciDomicilioFascicoloSius">
 <%
if( modalita.equals("I") )
{
%>
 <table cellspacing=2 cellpadding=2>
    <tr>
      <td class="l">
        <a href="Javascript:ListaDomicili('LoadInserisciDomicilioFascicoloSius');">
...
<% } %>
  <table cellspacing=2 cellpadding=2>
      ...
      <td class="l">
        ...
        <a href="Javascript:ListaComuni('LoadInserisciDomicilioFascicoloSius','<%=ICostantiResidenza.CAMPO_DESCR_COMUNE%>');">
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciDomicilioFascicoloSius");
