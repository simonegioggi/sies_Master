...
function Verify() {
    ...
    function cancellaCodComuneReale() {
      	document.LoadRicercaSoggettiConProcedimenti.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
    }    
  </script>
...
<body class="corpo">
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
		name="LoadRicercaSoggettiConProcedimenti">
		<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>"
			value="siap.sius.fascicolo.action.ActRicercaSoggettiConProcedimenti">
		...
		<table cellspacing="2" cellpadding="2">
			...
			<tr>
				...
				<td class="l"><input Title="Comune di nascita"
					...
					<a href="Javascript:ListaComuniNascita('LoadRicercaSoggettiConProcedimenti','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
...
%>
			<tr>
				<td class="label">Visualizza i procedimenti dell' intero
					Distretto</td>
				<td class="label"><input type=radio
					name="<%=ICostantiFascicoloSius.CAMPO_INCLUDE_UFFICIO%>" value="2"
					<%=lCheck%>></td>
			</tr>

			<tr>
				<td class="label">Visualizza anche i procedimenti pervenuti da
					altri Distretti</td>
				<td class="label"><input type=radio
					name="<%=ICostantiFascicoloSius.CAMPO_INCLUDE_UFFICIO%>" value="3">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="label"><input type=checkbox
					name="<%=ICostantiFascicoloSius.CAMPO_INCLUDE_ARCHIVIATI%>"
					value="1"
					onclick="javascript:document.LoadRicercaSoggettiConProcedimenti.<%=ICostantiFascicoloSius.CAMPO_SOLO_ARCHIVIATI%>.checked=false">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="label"><input type=checkbox
					name="<%=ICostantiFascicoloSius.CAMPO_SOLO_ARCHIVIATI%>" value="1"
					onclick="javascript:document.LoadRicercaSoggettiConProcedimenti.<%=ICostantiFascicoloSius.CAMPO_INCLUDE_ARCHIVIATI%>.checked=false">
				</td>
			</tr>
