...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Sportello</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class=label>Funzione :</font>&nbsp;<font class="campo">Elenco Soggetti con Procedimenti di Sorveglianza - Attività di Sportello</font></td>
...
<%
      ...
      {%>
       <tr>
          <td class="lVerdeNB">Solo i procedimenti dell' Ufficio</td>
       </tr>
		<%}
...
<%      if ((fascicolo.getFascicoloSiusModel().getSoggetto().getDataNascita())==null)
      ...
      <td class="c">
          ...
          <jsp:include page="<%=ICostantiFascicoloSius.PG_BUTTONS_PROVV_SOGG_SPORTELLO%>">
