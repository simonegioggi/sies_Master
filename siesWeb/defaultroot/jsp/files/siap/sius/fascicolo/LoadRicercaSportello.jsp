...
<html>
<head>
<title> [S.I.E.S.] - Ricerca Soggetti con Procedimenti - Attività di Sportello </title>
...
<body class="corpo">
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadRicercaSportello">
    ...
    <table>
		<tr>
        	...
        	<td class="LBG">
        		<font class="label">Funzione:</font>&nbsp;<font class="campo">Ricerca Soggetti con Procedimenti di Sorveglianza - Attività di Sportello</font>
        	</td>
		</tr>
    </table>
...
<table cellspacing="2" cellpadding="2">
      ...
      <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaComuni('LoadRicercaSportello','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
...
%>
        ...
        <td class="label" >
          	<input type=radio name="<%=ICostantiFascicoloSius.CAMPO_INCLUDE_UFFICIO%>" value="1" CHECKED>
        </td>
      </tr>
    	</table>
<%
...
%>
<input type="HIDDEN" name="<%=ICostantiFascicoloSius.CAMPO_INCLUDE_UFFICIO%>" value="0">
<%
}
%>
    <br>
