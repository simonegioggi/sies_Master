...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Procedimenti di Esecuzione</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class=label>Funzione :</font>&nbsp;<font class="campo"> Elenco Procedimenti di Esecuzione per Soggetto </font></td>
...
%>
        <tr>
          <td class="lVerdeNB">Visualizzazione di tutti i procedimenti di Esecuzione, compresi quelli pervenuti da altri Distretti</td>
        </tr>
<%    }
      if(codDistretto.length()> 1 )
      {
%>
        <tr>
          <td class="lVerdeNB">Visualizzazione dei procedimenti di Esecuzione dell'intero Distretto</td>
        </tr>
<%    }
...
%>
        <tr>
          <td class="lVerdeNB">Procedimenti di Esecuzione con Data arrivo in cancelleria :&nbsp;&nbsp;
<%
...
%>
      <tr>
        ...
        <td class="c">
          ...
          <jsp:include page="<%=ICostantiFascicoloSius.PG_BUTTONS_PROC_DI_EMA%>">
...
%>
  ...
  <table cellspacing=2 cellpadding=2>
    ...
    <tr>
      <td class="lVerdeNB" >
        N.B.: Per richiedere l'elenco di tutti i procedimenti relativi all'esecuzione di una misura alternativa, selezionare l'icona : </td>
