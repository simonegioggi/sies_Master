...
function Verify() {
	if (document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value.length == 1)
		document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value = '0'
		+ document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value;
	if (document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value.length == 1)
		document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value = '0'
		+ document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value;

	if (document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value.length == 1)
		document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value = '0'
		+ document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value;
	if (document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value.length == 1)
		document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value = '0'
		+ document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value;
	...
	var data_atto = document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ATTO%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ATTO%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_DATA_ATTO%>.value;
	...
	var data_finepena = document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_FINE_PENA%>.value;
	if (data_finepena != '//') {
	...
	var data_arrivo = document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value
		+ '/' + document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_DATA_ARRIVO%>.value;
  	if ( data_arrivo != '//') {
...
<table cellspacing="2" cellpadding="2">
	...
	<tr>
	    ...
	    <td class="l">
      		<input Title="Sede Mittente" name="<%=ICostantiFascicoloSius.CAMPO_DESCR_SEDE_MITTENTE%>" value="<%=StringUtils.toStringJSP(fascicoloSiusGP.getGeneraleProcedimentoModel().getDescrSedeMittente())%>" type="text" maxlength="35" size="35" <%=lDisable%>>
<%
...
%>
	...
	<tr>
	    ...
	    <td class="L">
			<select title="contenuto" class=small name="<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>" onchange="Javascript:TestS22(document.LoadModificaFascicoloUDS.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.value );"
<%
...
if (fascicoloSiusGP.getTenori().length > 0) {
	...
	if ("2422".equals(fascicoloSiusGP.getTenori()[0].getCodOggettoTenore()))
		lCodDettagli = fascicoloSiusGP.getTenori()[0].getCodOggettoTenore() + fascicoloSiusGP.getTenori()[0].getCodDettaglioOggetto() + "|";
