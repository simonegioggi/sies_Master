...
<title>[S.I.E.S.] - Ricerca Soggetti con Procedimenti di
	Esecuzione Misure Sicurezza -</title>
...
<script language="JavaScript">
    ...
    function cancellaCodComuneReale() {
      	document.LoadRicercaSoggettiConProcDiEsecuzioneMS.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
    }    
  </script>
...
<body class="corpo">
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
		name="LoadRicercaSoggettiConProcDiEsecuzioneMS">
		<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>"
			value="siap.sius.fascicolo.action.ActRicercaSoggettiConProcDiEsecuzioneMS">
			...
			<tr>
				...
				<td class="LBG"><font class="label">Funzione :</font> <font
					class="campo">Ricerca Soggetti con Procedimenti di
						Esecuzione Misure Sicurezza</font></td>
			</tr>
		</table>
		...
		<table cellspacing=2 cellpadding=2>
			...
			<tr>
				...
				<td class="l"><input Title="Comune di nascita"
					...
					<a href="Javascript:ListaComuniNascita('LoadRicercaSoggettiConProcDiEsecuzioneMS','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
