...
<html>
<head>
  <title> [S.I.E.S.] - Ricerca Fascicolo Sius Per  Soggetto  - </title>
...
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.fascicolo.action.ActRicercaSoggettoFascicoloSius">
