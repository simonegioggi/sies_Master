...
<html>
<head>
  <title> [S.I.E.S.] - Ricerca Soggetti con Procedimenti di Esecuzione - </title>
  ...
  <script language="JavaScript">
    function Verify()
    {
      var data_to_verify=document.LoadRicercaSoggettiConProcDiEsecuzione.<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>.value+'/'+document.LoadRicercaSoggettiConProcDiEsecuzione.<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>.value+'/'+document.LoadRicercaSoggettiConProcDiEsecuzione.<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>.value;
...
<body class="corpo">
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadRicercaSoggettiConProcDiEsecuzione">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.fascicolo.action.ActRicercaSoggettiConProcDiEsecuzione">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Ricerca Soggetti con Procedimenti di Esecuzione</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaComuni('LoadRicercaSoggettiConProcDiEsecuzione','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    var frmvalidator  = new Validator("LoadRicercaSoggettiConProcDiEsecuzione");
