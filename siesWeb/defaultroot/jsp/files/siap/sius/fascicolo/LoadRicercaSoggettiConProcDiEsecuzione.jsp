...
<script language="JavaScript">
    ...
    function cancellaCodComuneReale() {
      	document.LoadRicercaSoggettiConProcDiEsecuzione.<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>.value = "";      	
    }    
  </script>
...
<body class="corpo">
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
		name="LoadRicercaSoggettiConProcDiEsecuzione">
		...
		<table>
			<tr>
				...
				<td class="LBG"><font class="label">Funzione :</font> <font
					class="campo">Ricerca Soggetti con Procedimenti di Esecuzione</font></td>
			</tr>
		</table>
		...
		<table cellspacing=2 cellpadding=2>
			...
			<tr>
				...
				<td class="l"><input Title="Comune di nascita"
					...
					<a href="Javascript:ListaComuniNascita('LoadRicercaSoggettiConProcDiEsecuzione','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
