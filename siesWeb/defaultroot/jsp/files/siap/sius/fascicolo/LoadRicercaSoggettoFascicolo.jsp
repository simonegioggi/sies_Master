...
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.soggetto.action.ActRicercaSoggettoFascicolo">
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l"><input  title="Comune di nascita" type="text" name="<%=ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA%>" value="" size="30" maxlength="30"></td>
      </tr>
