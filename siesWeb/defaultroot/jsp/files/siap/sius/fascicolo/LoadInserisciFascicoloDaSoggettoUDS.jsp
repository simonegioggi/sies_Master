...
function TestS22(Code) {
	...
	<%--         STUB 21/04/2004 document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value=''; --%>
	<%--         STUB 21/04/2004 document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO%>.value=''; --%>
	<%--         document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_CHIAVE_PROGR_S22%>.value=''; --%>
	<%--         document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_CHIAVE_ANNO_S22%>.value=''; --%>
	// Se Code = LowValue[i]!='U004' && document.FormTestS22.HighValue[i]='S22' Occorre far visualizzare i Campi nascosti.
	if (typeof (Code) == "undefined")
		...
		for (i = 0; i < document.FormTestS22.LowValue.length ; i++) {
    		if (Code == document.FormTestS22.LowValue[i].value) {
				...
				document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_TIPO_REGISTRO%>.value=document.FormTestS22.HighValue[i].value;
...
function Verify() {
	if (document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value.length == 1)
		document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value = '0' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value;
	if (document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value.length == 1)
		document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value = '0' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value;
	if (document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value.length == 1)
		document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value = '0' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value;
	if (document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value.length == 1)
		document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value = '0' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value;
	// Controllo obbligatorietà campi S22.
	var progrS22 = document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_CHIAVE_PROGR_S22%>.value;
	var annoS22 = document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_CHIAVE_ANNO_S22%>.value;
	...
	var tipoAtto = document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_COD_TIPO_ATTO%>[document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_COD_TIPO_ATTO%>.selectedIndex].value;
	...
	var data_atto = document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ATTO%>.value
		+ '/' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ATTO%>.value
		+ '/' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_DATA_ATTO%>.value;
	...
	var data_finepena = document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_FINE_PENA%>.value
		+ '/' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_FINE_PENA%>.value
		+ '/' + document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_FINE_PENA%>.value;
	if (data_finepena != '//') {
	...
	var contenuto = document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>[document.LoadInserisciFascicoloDaSoggettoUDS.<%= ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.selectedIndex].value;
	if (contenuto == "-") {
	...
	var data_arrivo = document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>.value+'/'+document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>.value+'/'+document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_ANNO_DATA_ARRIVO%>.value;
  	if (data_arrivo != '//') {
...
<body class="corpo" onload="Javascript:TestS22(document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.value );">
<table>
...
%>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadInserisciFascicoloDaSoggettoUDS" >
...
<%
    // STUB 17/03/2010 Gestione del luogo detenzione.
...
<%		if( lDisable.compareTo("DISABLED")!=0 )
      {%>
      	<a href="Javascript:ListaComuni('LoadInserisciFascicoloDaSoggettoUDS','<%= ICostantiFascicoloSius.CAMPO_DESCR_SEDE_MITTENTE %>');">
  ...
  <tr>
    ...
    <td class="L">
      <select title="contenuto" class=small name="<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>" onchange="Javascript:TestS22(document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.value);" <%=lDisable%>>
        <%=contenuto%>
      </select>
    </td>
  </tr>
...
<%		if( lDisable.compareTo("DISABLED")!=0 )
      {%>
	      <a href="Javascript:ListaOggetti('LoadInserisciFascicoloDaSoggettoUDS',document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>[document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.selectedIndex].value, '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
	      <img src="/images/fileselected.gif" title="Oggetti per il Contenuto selezionato" border=0></a>
	      &nbsp;
	      <a href="Javascript:ListaOggetti('LoadInserisciFascicoloDaSoggettoUDS','-', '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciFascicoloDaSoggettoUDS.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
  ...
  <tr>
    ...
    <td class="label">
      <div id=S22_b style="visibility='visible';">
        <input Title="Anno"  type="text" name="<%=ICostantiFascicoloSius.CAMPO_CHIAVE_ANNO_S22 %>" maxlength="4" size="4" <%=lDisable%>>/
        <input Title="Numero" type="text" name="<%=ICostantiFascicoloSius.CAMPO_CHIAVE_PROGR_S22 %>" maxlength="6" size="6" <%=lDisable%>>
      </div>
    </td>
  </tr>
...
%>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadInserisciFascicoloDaSoggettoUDS");
