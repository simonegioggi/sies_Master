	...
	<table>
		<tr>
			...
			<td class="LBG"><font class="label">Funzione :</font>&nbsp; <font
				class="campo">Dettaglio Foglio Complementare</font></td>
			<td class="LBG"><a
			...
			<%
				...
				else if (depositoDecreto != null
						&& depositoDecreto.getIdDepositoDecreto() != null
						&& depositoDecreto.getIdEventoGenerato() != null)
			...
			<% 
				...
				if (!("TDSM".equalsIgnoreCase(codTipoUfficio) || "UDSM".equalsIgnoreCase(codTipoUfficio))) { %>
					...
					<td class="LBG"><a
						href="Javascript:confermaAnnullamento('siap.sius.provvedimento.action.ActLoadAnnullaCFC&amp;tipoOperazione=ANNULLANSC','IdEvento','<%=idEventoInterconnessione%>','CampoFill','fill');">
	...
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
		...
		<table cellspacing="2" cellpadding="2">
			...
			<tr>
				<td class="l">DECRETO n° <font class="campo"><%=StringUtils.toStringJSP(depositoDecreto.getAnnoS72())%></font>
					...
					<font class="l">del</font> <font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(depositoDecreto.getDataEmissione(), "dd-MM-yyyy"))%></font>
				</td>
				<td class="campo"><a
					href="Javascript:stampa2( '<%=ISIAPCostantiWeb.PG_STAMPA%>', '<%=IWebConstants.ACTION_FIELD%>=siap.sico.evento.action.ActLoadDocumento&amp;<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoDecreto.getIdEventoGenerato()%>')">
						<img src="/images/print.gif" alt="Stampa Decreto" width="12"
						height="12" border="0">
				</a></td>
			</tr>
			<%
			...
			%>
			<tr>
				<td class="l" colspan="2">ORDINANZA n° <font class="campo"><%=depositoordinanzapc.getAnnoS3()%></font>
					<font class="l">/</font> <font class="campo"><%=depositoordinanzapc.getNumS3()%></font>
					<font class="l">del</font> <font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(depositoordinanzapc.getDataDeposito(), "dd-MM-yyyy"))%></font>
				</td>
				<td class="campo"><a
					href="Javascript:stampa2( '<%=ISIAPCostantiWeb.PG_STAMPA%>', '<%=IWebConstants.ACTION_FIELD%>=siap.sico.evento.action.ActLoadDocumento&amp;<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoordinanzapc.getIdEventoGenerato()%>')">
						<img src="/images/print.gif" alt="Stampa Ordinanza" width="12"
						height="12" border="0">
				</a></td>
			</tr>
			<%
			...
			<tr>
				...
				<td class="l"><%=(documentoAllegato.getMotivoAnnullamento() == null)
						? "-" : documentoAllegato.getMotivoAnnullamento()%>
				</td>
			</tr>
			<%
				}
			...
			<tr>
				...
				<td class="L"><input
					value='<%=StringUtils.toStringJSP(DateUtils.getDateToString(documentoAllegato.getDataEmissione(), "dd"))%>'
					...
					value='<%=StringUtils.toStringJSP(DateUtils.getDateToString(documentoAllegato.getDataEmissione(), "MM"))%>'
					type="text" size="2" maxlength="2"
					name="<%=ICostantiProvvedimento.CAMPO_MESE_DATA_TRASMISSIONE%>"
					onFocus="javascript:textboxSelect(this)"
					onkeypress="return TicTabNumField(this,event)"
					onBlur="javascript:value=FillDM(value)"> / <input
					value='<%=StringUtils.toStringJSP(DateUtils.getDateToString(documentoAllegato.getDataEmissione(), "yyyy"))%>'
		...
		<table cellspacing="2" cellpadding="2">
			<tr>
				...
				<td class="L"><input value="" type="text" size="30"
					maxlength="250"
			...
			<tr>
				...
				<td class="L"><input value="" type="text" size="2"
					maxlength="2"
					name="<%=ICostantiProvvedimento.CAMPO_GIORNO_DATA_INS_MANUALE%>"
					onFocus="javascript:textboxSelect(this)"
					onkeypress="return TicTabNumField(this,event)"
					onBlur="javascript:value=FillDM(value)"> / <input value=""
					type="text" size="2" maxlength="2"
			...
			<tr>
				<td colspan="2"><font class="L"> </font>&nbsp;</td>
			</tr>

			<tr>
				<td colspan="2"><input class="bottone" type="submit"
					value="Conferma Inserimento Manuale"
			...
			<tr>
				...
				<td class="L"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(documentoAllegato.getDataTrasmissione(), "dd-MM-yyyy"))%></font>&nbsp;
				</td>
			</tr>

			<tr>
				<td class="l">Motivazione non Inviato</td>
				<td class="L"><font class="campo"><%=StringUtils.toStringJSP(documentoAllegato.getDescrMotivazioneNonInvio())%></font>&nbsp;
				</td>
				<td class="l">Descrizione</td>
				<td class="L"><font class="campo"><%=StringUtils.toStringJSP(documentoAllegato.getDescrizioneNonInvio())%></font>&nbsp;
				</td>
			</tr>

			<tr>
				<td class="l">Data Inserimento Manuale</td>
				<td class="L"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(documentoAllegato.getDataInsMan(), "dd-MM-yyyy"))%></font>&nbsp;
				</td>
			</tr>
		...
		<input type="HIDDEN"
			value="<%=documentoAllegato.getCodMotivazioneNonInvio()%>"
