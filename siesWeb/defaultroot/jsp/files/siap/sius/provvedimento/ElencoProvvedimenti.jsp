...
<%
      ...
      {%>
        ...
        <% if ((lProv.getFlagDocumentoRegistrato()!=null) && (lProv.getFlagDocumentoRegistrato().compareTo("S")==0) )
        {
           ...
           if  ( lProv.getNumAllValidati() < 1 && lFunAnnullaValidaProvvedimento.length() > 1 && (modificabile  || (lProv.getCodEsito().compareToIgnoreCase("0600") == 0) ))
           {
        %>
...
/*
    ...
    provv. validato; (lProv.getFlagDocumentoRegistrato()!=null && lProv.getFlagDocumentoRegistrato().compareTo("S")==0) 
	provv. depositato ma con deposito non validato;  (isDepositato.equalsIgnoreCase("NO") && lProv.getDataDeposito() != null)
...
*/
	...
	if (modificabile  && (lProv.getFlagDocumentoRegistrato()!=null && lProv.getFlagDocumentoRegistrato().equalsIgnoreCase("S")) &&  isDepositato.equalsIgnoreCase("NO") && lProv.getDataDeposito() != null)
	{
    	if ( lProv.getCodEsito().compareTo("0600")!=0 && lProv.getCodEsito().compareTo("0601")!=0 && lProv.getCodEsito().compareTo("0602")!=0 && lProv.getCodEsito().compareTo("0603")!=0)
