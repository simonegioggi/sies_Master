...
<%@ page import="siap.sius.esecuzionemisurasicurezza.model.EMSFascGPModel" %>
...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Elenco Procedimenti di Esecuzione Misure Sicurezza</title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class=label>Funzione :</font>&nbsp;<font class="campo">Elenco Procedimenti di Esecuzione Misure Sicurezza</font></td>
   </tr>
  </table>
...
<%
    ...
    while ( itx.hasNext())
    {
      EMSFascGPModel esecuzione = (EMSFascGPModel)itx.next();
%>
      ...
      <tr>
        ...
        <td class="c">
          <font class="label"><%=esecuzione.getEsecuzioneMSModel().getAnnoS07()%>/<%=esecuzione.getEsecuzioneMSModel().getProgrS07()%> </font>
        </td>
        <td class="c">
          <font class="label"><%=esecuzione.getEsecuzioneMSModel().getDescrLuogoAutoritaEmittOrd()%> </font>
        </td>
        <td class="c"><font class="label"><%=StringUtils.toStringJSP(DateUtils.getDateToString(esecuzione.getEsecuzioneMSModel().getDataOrdinanza(),"dd-MM-yyyy"),"-")%></font></td>
        ...
        <td class="c">
          <jsp:include page="<%=ICostantiEsecuzioneMS.PG_BUTTONS_EMS%>">
             <jsp:param name="CampoIdEntita" value="<%=ICostantiEsecuzioneMS.CAMPO_ID_ESECUZIONE_MS%>" />
             <jsp:param name="ValoreIdEntita" value="<%=esecuzione.getEsecuzioneMSModel().getIdEsecuzioneMisuraSicurezza()%>" />
