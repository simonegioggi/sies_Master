...
<%        if (prCorrelato.getFascicoloSiusModel().getNumeroFascicoliUnificati() != null &&
          ...
          {%>
          <a href="#1" onClick="return effettoTree(<%=jEMS%>)"><img name="image<%=jEMS%>" src="<%=IWebConstants.IMAGES_DIR%>expand.gif"  alt="" border="0" Title="Elenco Procedimenti del Tribunale Correlati" ></a>
        <%}%>
        </font></td>
