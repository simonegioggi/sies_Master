...
<FORM name="comandi" >
  <table>
    <tr>
      ...
      <%  if( modalita.equals("D") )  {%>
        <font class="campo">Dettaglio Sospensione Misura Sicurezza</font>
      <%} else if( modalita.equals("C") ) { %>
        <font class="campo">Cancellazione Sospensione Misura Sicurezza</font>
      <%}%>
      </td>
...
<table>
	...
	if (!PeriodoAltraMisura.getCodTipoUfficioSosp().equals("-")) {
	%>
	<tr>
		<td class="l">Autorità</td>
		<td class="l"><font class="campo"> <%=StringUtils.toStringJSP(PeriodoAltraMisura
								.getDescrTipoUfficio())%> di <%=StringUtils.toStringJSP(PeriodoAltraMisura
								.getDescrLuogoAutorita())%> </font></td>
	</tr>
	<%
		}
	...
	<%  if( PeriodoAltraMisura.getDaRecuperare().equals("1"))  {%>
 	<tr>
 		<td class="l">Da Recuperare</td>
		<td class="c">
	              <font class="label">Anni</font>
	              <font class="campo"><%=StringUtils.toStringJSP(PeriodoAltraMisura.getDaRecuperareAA(), "-")%></font>
	              <font class="label">Mesi</font>
	              <font class="campo"> <%=StringUtils.toStringJSP(PeriodoAltraMisura.getDaRecuperareMM(), "-")%></font>
	              <font class="label">Giorni</font>
	              <font class="campo"> <%=StringUtils.toStringJSP(PeriodoAltraMisura.getDaRecuperareGG(), "-")%></font>&nbsp;
	          </td>

  	</tr>
 	<%}%>
	<%  if(PeriodoAltraMisura.getDataScadenza() != null)  {%>
	<tr>
	...
	<tr>
     ...
     <tr>
		<td class="l">Misura Sicurezza Espiata</td>
		<td class="c">
	              <font class="label">Anni</font>
	...
	<tr>
		<td class="l">Misura Sicurezza residua da Espiare</td>
		<td class="c">
	              <font class="label">Anni</font>
