    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Udienza</font>
        </td>
...
%>
  ...
  <tr>
    <td class="l">Orario Fine Camera Consiglio</td>
    <td class="l">
    	<font class="campo"><%=StringUtils.toStringJSP(udienza.getOraFineCC(),"--")%> : <%=StringUtils.toStringJSP(udienza.getMinFineCC(),"--")%></font>
    </td>
  </tr>
