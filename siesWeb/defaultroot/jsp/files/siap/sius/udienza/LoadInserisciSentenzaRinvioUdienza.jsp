...
%>
  ...
  function Verify()
  {
    ...
    var dataUdienza	= document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%>.value +'/'+
                      document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA%>.value +'/'+
                      document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_ANNO_DATA_UDIENZA%>.value;
                     
    var data_emissione=	document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value +'/'+
                      	document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value +'/'+
                      	document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value;

    // Set di Controlli di validità data Udienza.
    // 1) Controllo se il campo data Udienza sia stata compilato
    if (dataUdienza == '//' &&
        (!document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_CHECK_RUOLO%>.checked)  )
    {
  ...
  <script language="JavaScript">
    ...
    {
      if (document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_CHECK_RUOLO%>.checked )
      {
        if (document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%> !=null)
          document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA%>.value = "";
        if (document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA%> !=null)
          document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA%>.value = "";
        if (document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_ANNO_DATA_UDIENZA%> !=null)
          document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_ANNO_DATA_UDIENZA%>.value = "";
        if (document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_NUM_COLLEGIO %> !=null)
          document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_NUM_COLLEGIO%>.value = "";
      }
    }

    function Uncheck()
    {
      document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_CHECK_RUOLO%>.value = "1";
      document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiUdienza.CAMPO_CHECK_RUOLO%>.checked = false;
    }
    ...
    function ControlloSospensione()
    {
     <% if (fascSospeso.compareTo("SI") == 0)	{ %>
          if (! confirm("Attenzione: per questo procedimento è presente una sentenza di rimessione atti. Procedere con l'emissione di un nuovo provvedimento ?" ))
          {
              //str = "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActCancellaProvvedimento&" +a_parameter +"=" + a_entityname;
              	str = "/jsp/Main.jsp?Action=siap.sius.udienza.action.ActLoadFSPSentenzaRinvioUdienza&";
...
<%
    	...
    	lAzione = "siap.sius.udienza.action.ActInserisciSentenzaRinvioUdienza";
    	String lActRet = new String("siap.sius.udienza.action.ActLoadInserisciSentenzaRinvioUdienza");
%>


<body class="corpo" 
	onLoad="javascript:document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.focus();Javascript:return ControlloSospensione();">
  ...
  <table>
    <tr>
      ...
      <font class="label"> Funzione :</font>&nbsp;
        <font class="campo">Sentenza Rinvio Udienza</font>
      </td>
    </tr>
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciSentenzaRinvioUdienza">
    ...
    <tr>
      ...
      <td class="l" >
        ...
        <input name="<%=ICostantiUdienza.CAMPO_NUM_COLLEGIO%>" 
        			 ...
        			 readonly 
        			 onBlur="javascript:Uncheck()">
        <a href="Javascript:ElencoNuoveUdienze('LoadInserisciSentenzaRinvioUdienza',
        ...
        <a  href="Javascript:ListaUdienze('LoadInserisciSentenzaRinvioUdienza',
                                          '<%=ICostantiUdienza.CAMPO_GIORNO_DATA_UDIENZA %>',
                                          '<%=ICostantiUdienza.CAMPO_MESE_DATA_UDIENZA %>',
                                          '<%=ICostantiUdienza.CAMPO_ANNO_DATA_UDIENZA %>',
    ...
    <tr>
      <td class="l">Oggetto<font class="ob">(*)</font></td>
        <td class="l">
          ...
          <a href="Javascript:ListaOggetti('LoadInserisciSentenzaRinvioUdienza','<%=codContenuto%>', '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
          <img src="/images/fileselected.gif" title="Oggetti per il Contenuto selezionato" border=0></a>
          &nbsp;
          <a href="Javascript:ListaOggetti('LoadInserisciSentenzaRinvioUdienza','-', '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciSentenzaRinvioUdienza.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
  ...
  <script language="JavaScript" type="text/javascript">
     ...
     var frmvalidator = new Validator("LoadInserisciSentenzaRinvioUdienza");
