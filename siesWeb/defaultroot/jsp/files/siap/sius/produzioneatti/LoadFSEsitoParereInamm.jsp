...
%>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadFSEsitoParereInamm'>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        <td class="l">Indicare il Numero SIUS (Anno/Progressivo) <font class=ob>(*): </font></td>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadFSEsitoParereInamm");
