...
%>
	<tr>
		<td class=l><%=StringUtils.toStringJSP(lEventoPerLic.getDescrTipoEvento())%></td>
		<td class=l><%=StringUtils.toStringJSP(lEventoPerLic.getDescrEvento())%></td>
		<td class=l><%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoPerLic.getDataSegnalazione(), "dd-MM-yyyy"))%></td>
		<td class=l><%=StringUtils.toStringJSP(lEventoPerLic.getMittenteSegnalazione())%></td>
		<td class=c>
<% 
...
%>
			<a href="<%=lRedir%>"><img src="/images/dettagli.gif" alt="Dettaglio Evento" width="12" height="12" border="0"></a>
		</td>
	</tr>
<%
}
