...
<html>
	...
	<body class="corpo" 
		onLoad="javascript:document.LoadRelazioneTrimestralePermessoLicenza.<%=ICostantiDepositoDecreto.CAMPO_GIORNO_DATA_DEPOSITO_INIZIALE%>.focus()">

  	<FORM method="POST" name="LoadRelazioneTrimestralePermessoLicenza" 
  				action="<%=IWebConstants.PG_MAIN%>">
  	<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" 
  				 value="siap.sius.permesso.action.ActRelazioneTrimestralePermessoLicenza">
	...
	<table cellspacing=2 cellpadding=2 width="95%">
		<tr>
  		<td class="Titolo" colspan=6>
  			Intervallo date di deposito dei provvedimenti di concessione permessi/licenze :
  		</td>
  	</tr>    
    <tr>    	
    	<td class="L" width="20%">
    ...
    <tr>
  	...
  	<tr>
			...
			<td class="l">
				...
				<input type="radio" name="tipoRicerca" value="LI">Internati 
			</td>
  	</tr>
