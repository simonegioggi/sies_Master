...
<html>
	...
	<body class="corpo" 
				onLoad="javascript:document.LoadModificaEsitoPermessoLicenza.<%=ICostantiLicenzaLibanticipata.CAMPO_COD_ESITO%>.focus()">
	<table>
  	<tr>
  ...
  <br>	
	...
	<FORM method=post action="<%= IWebConstants.PG_MAIN %>" name ="LoadModificaEsitoPermessoLicenza" >
 		<table>  		
      		...
      		<td class="L">
        		<select title="esito" name="<%=ICostantiLicenzaLibanticipata.CAMPO_COD_ESITO%>">
          		<%=esiti%>
         		</select>
      		</td>
    		</tr>
      		...
      		<td class="L">
      			<input class="bottone" type="submit" value="Conferma">
       			<input type="HIDDEN" name="<%=ISIAPCostantiWeb.ACTION_FIELD%>"
       						 value="siap.sius.permesso.action.ActModificaEsitoPermessoLicenza">
       			<input type="HIDDEN" name="<%=ICostantiLicenzaLibanticipata.CAMPO_ID_LICENZA_LIBANTICIPATA%>"  
