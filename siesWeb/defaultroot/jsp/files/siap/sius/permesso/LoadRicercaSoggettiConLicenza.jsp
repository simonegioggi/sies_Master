...
<body class="corpo">
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>"
		name="LoadRicercaSoggettiConLicenza">
			...
			<tr>
				...
				<td class="LBG"><font class="label">Funzione :</font> <font
					class="campo">Ricerca Soggetti con Procedimenti di
						Sorveglianza relativi a licenze</font></td>
			</tr>
		</table>
		...
		<table cellspacing=2 cellpadding=2>
			<tr>
				<td class="lVerdeNB">N.B.: Di norma vengono visualizzati i
					soggetti con provvedimenti di licenza di competenza dell'ufficio
		...
		<table cellspacing=2 cellpadding=2>
			...
			<tr>
				<td class="Cliccabile">Modifica competenza territoriale dei
					procedimenti di licenza visualizzati</td>
			</tr>
			...
			<tr>
				<td class="label">Visualizza le licenze dell'intero Distretto
					&nbsp;&nbsp;&nbsp;</td>
				<td class="label"><input type=radio
			...
			<tr>
				<td class="label">Visualizza anche le licenze di altri
		...
		<table cellspacing=2 cellpadding=2>
			...
			<tr>
				<td class="label">Visualizza solo i provvedimenti relativi a
					...
					name="<%=ICostantiPermesso.CAMPO_COD_LICENZA%>">
						<%= licenza %>
				</select>
				</td>
			</tr>
			...
			<tr>
				<td class="Cliccabile">Seleziona il Periodo di decisione delle
					licenze visualizzate&nbsp;&nbsp;</td>
			</tr>
		...
		<input type="HIDDEN" name="<%=ICostantiPermesso.CAMPO_COD_LICENZA%>"
			value="LC">
