...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Elenco Soggetti con Licenze </title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class=label>Funzione :</font>&nbsp;<font class="campo">Elenco Soggetti con Procedimenti di Sorveglianza relativi a Licenze</font></td>
...
%>
     <tr>
        <td class="lVerdeNB">Visualizzazione di tutti le Licenze, comprese quelle pervenute da altri Distretti</td>
     </tr>
<%  }
...
%>
     <tr>
        <td class="lVerdeNB">Visualizzazione delle Licenze dell'intero Distretto</td>
     </tr>
<%  }
...
%>
       <tr>
          <td class="lVerdeNB">Anche le Licenze del Tribunale</td>
       </tr>
<%
      }
...
%>
       <tr>
          <td class="lVerdeNB">Anche le Licenze dell' Ufficio (Sede)</td>
       </tr>
<%    }
    }
...
%>
      <tr>
        <td class="lVerdeNB">Licenze con Data emissione :&nbsp;&nbsp;
<%
...
<%      if ((fascicolo.getFascicoloSiusModel().getSoggetto().getDataNascita())==null)
      ...
      <td class="c">
          ...
          <jsp:include page="<%=ICostantiPermesso.PG_BUTTONS_LICENZE%>">
            ...
            <jsp:param name="hcodLicenza" value="<%=codLicenza%>" />
            <jsp:param name="hdescrLicenza" value="<%=descrLicenza%>" />
