...
<html>
  <head>
  <title>[S.I.E.S.] - Inserimento Unificazione </title>
    ...
    function Verify()
    {
      // Controllo Oggetto procedimento da unificare
      ...
      var data_unificazione=document.LoadInserisciUnificazione.<%=ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE%>.value+'/'+document.LoadInserisciUnificazione.<%=ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE%>.value+'/'+document.LoadInserisciUnificazione.<%=ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE%>.value;
      ...
      if ( data_arrivo!='//' && ControllaData(data_arrivo))
      {
  ...
  <body class="corpo" onload="Javascript:return ControlloSospensione()">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Inserimento Unificazione</font>
        </td>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadInserisciUnificazione'>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.unificazione.action.ActInserisciUnificazione">
...
<%
    ...
    <table cellspacing=2 cellpadding=2>
      <tr>
        ...
        <td class="l">
          <input value="<%=DateUtils.getSysDate("dd")%>" type="text" size="2" maxlength="2" name="<%= ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" > /
          <input value="<%=DateUtils.getSysDate("MM")%>" type="text" size="2" maxlength="2" name="<%= ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" > /
          <input value="<%=DateUtils.getSysDate("yyyy")%>" type="text" size="4" maxlength="4" name="<%= ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE %>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)" >
        </td>
      </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadInserisciUnificazione");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE%>","req","Il campo Giorno della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE%>","gt=1");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_GG_UNIFICAZIONE%>","lt=31");

    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE%>","req","Il campo Mese della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE%>","gt=1");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_MM_UNIFICAZIONE%>","lt=12");

    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE%>","req","Il campo Anno della Data Unificazione è obbligatorio");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE%>","numeric");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE%>","gt=1900");
    frmvalidator.addValidation("<%= ICostantiUnificazione.CAMPO_DATA_AAAA_UNIFICAZIONE%>","lt=2999");
  </script>
  </body>
</html>