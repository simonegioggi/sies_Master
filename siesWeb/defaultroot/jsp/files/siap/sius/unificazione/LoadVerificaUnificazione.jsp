...
<head>
  ...
  function Verify()
  {
    ...
    var anno_da_unif=document.LoadVerificaUnificazione.<%=ICostantiUnificazione.CAMPO_ANNO_DA_UNIF%>.value;
    var anno_unificante=document.LoadVerificaUnificazione.<%=ICostantiUnificazione.CAMPO_ANNO_UNIFICANTE%>.value;
    var numero_da_unif=document.LoadVerificaUnificazione.<%=ICostantiUnificazione.CAMPO_NUMERO_DA_UNIF%>.value;
    var numero_unificante=document.LoadVerificaUnificazione.<%=ICostantiUnificazione.CAMPO_NUMERO_UNIFICANTE%>.value;
...
<body class="corpo">
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadVerificaUnificazione'>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.unificazione.action.ActLoadInserisciUnificazione">
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l">
          <input Title="AnnoDaUnif" type="text" name="<%= ICostantiUnificazione.CAMPO_ANNO_DA_UNIF %>" maxlength="4" size="4">
      ...
      <tr>
        ...
        <td class="l">
          <input Title="AnnoUnificante" type="text" name="<%= ICostantiUnificazione.CAMPO_ANNO_UNIFICANTE %>" maxlength="4" size="4">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadVerificaUnificazione");
    frmvalidator.addValidation("<%=ICostantiUnificazione.CAMPO_ANNO_DA_UNIF%>","req","Il campo Anno da Unificare è obbligatorio");
    ...
    frmvalidator.addValidation("<%=ICostantiUnificazione.CAMPO_NUMERO_DA_UNIF%>","req","Il campo Numero da Unificare è obbligatorio");
    ...
    frmvalidator.addValidation("<%=ICostantiUnificazione.CAMPO_ANNO_UNIFICANTE%>","req","Il campo Anno Unificante è obbligatorio");
    ...
    frmvalidator.addValidation("<%=ICostantiUnificazione.CAMPO_NUMERO_UNIFICANTE%>","req","Il campo Numero Unificante è obbligatorio");
