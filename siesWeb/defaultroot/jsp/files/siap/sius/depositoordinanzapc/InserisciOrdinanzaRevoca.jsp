...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Ordinanza/Decreto Revoca Provvedimento</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciOrdinanzaRevoca.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
    ...
    <script language="JavaScript">
			...
			// Elenco Provvedimenti del Procedimento Collegato
    	function ElencoProvvedimenti(a_formname, a_fieldname1,  a_value1, a_fieldname2,  a_value2)
    	{
        var desktop;
        var link = "<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sius.provvedimento.action.ActRicercaProvvedimentiDepositati";
         link = link + "&formname=" + a_formname ;
         link = link + "&" + a_fieldname1 ;
         link = link + "=" + a_value1;
         link = link + "&" + a_fieldname2 ;
         link = link + "=" + a_value2;

          desktop = window.open(link, "Ricerca","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=550,height=400");
      ...
      <%
        ...
        {
           lAction = Action;
           lFunctionName = "Emissione Decreto Revoca Provvedimento";
           lCodTipoProv = ICostantiProvvedimento.COD_DECRETO;
        }
        else
        {
           lAction = "siap.sius.depositoordinanzapc.action.ActInserisciOrdinanzaUDS";
           lFunctionName = "Emissione Ordinanza Revoca Provvedimento";
           lCodTipoProv = ICostantiProvvedimento.COD_ORDINANZA;
        }
      %>
...
<br>
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
    <tr>
        <td class="Titolo" colspan=6 > Provvedimento da revocare </td>
    </tr>
 ...
 <tr>
    ...
    <input  name="RifProvRev" value="" readonly>
			<a href="JavaScript:ElencoProvvedimenti('InserisciOrdinanzaRevoca','<%=ICostantiFascicoloSius.CAMPO_ID_FASCICOLO_SIUS%>', '<%=idFascicoloOrigine%>', '<%=ICostantiProvvedimento.CAMPO_TIPO_PROVVEDIMENTO%>','<%=lCodTipoProv%>' )    ;">
...
<br>
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <tr> <td>&nbsp;</td> </tr>
    ...
    <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_EVE_ID_EVENTO%>" value="" >

  </form>
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciOrdinanzaRevoca");
