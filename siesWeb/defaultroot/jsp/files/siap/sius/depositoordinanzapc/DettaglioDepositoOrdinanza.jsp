...
<table>
	<tr>
        ...
        <td class="LBG">
        	<font class="label">Funzione : </font><font class="campo">Dettaglio Deposito Ordinanza</font>
        </td>
...
<!-- La variabile lVisualizzaBottone è stata inserita in quanto tale bottone non deve essere visibile nel Rilascio della Release 5.0 -->
<%
