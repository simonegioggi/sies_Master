...
<html>
  ...
  <script language="JavaScript">
    ...
    function Verify()
    {
			...
			if (lTenori[jTenori].value in {'0001':1, '0002':1, '0003':1, '0005':1, '0010':1, '0012':1, '0013':1, '0195':1, '0362':1, '0610':1}) {
        	  for (jEsiti = 0; jEsiti < lEsiti[jTenori].length ; jEsiti++ )
              {
                ...
                if ( (lEsiti[jTenori][jEsiti].selected) && (lEsiti[jTenori][jEsiti].value == '0001' ) )
                {
                  if (document.InserisciOrdinanzaMA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_LUOGO_SVOLGIMENTO_PROVA%>.value == "") {
                	alert ('Luogo di svolgimento della prova obbligatorio!');
                	//alert('Tenore ' + lTenori[jTenori].value + '; Esito ' + lEsiti[jTenori][jEsiti].value);
                  	return false;
                  }
                }
              }
     ...
     var data_termine = document.InserisciOrdinanzaMA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_FINE_MISURA%>.value+'/'+document.InserisciOrdinanzaMA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_MESE_DATA_FINE_MISURA%>.value+'/'+document.InserisciOrdinanzaMA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_ANNO_DATA_FINE_MISURA%>.value;
