...
<html>
<head>
<title>[S.I.E.S.] - Emissione Ordinanza di Misura Alternativa DL 123/2018</title>
...
function Verify() {
	if (document.InserisciOrdinanzaMA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_CK_ATTI_AL_PRESIDENTE%>.checked) {
  	...
  	<%-- Se presenti più oggetti, solo uno può essere "Applica ex art. 678 comma 1 ter cpp" --%>
	var listComboEsiti = document.getElementsByName("<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>"); 
...
%>
<body class="corpo" onload="javascript:checkEsiti();">
<table>
  	<tr>
      	<td class="LBG">
    	...
    	<td class=LBG>
			...
			<font class="campo">Emissione Ordinanza Applicazione Misura Alternativa DL 123/2018</font>
    	</td>
  	</tr>
	  <tr>
...
<table cellspacing="2" cellpadding="2" style="width: 95%;">
	<tr>
		...
		<td class="l">
	  		<table>
	  			<tr>
	    			<td class="l" style="border:0px;">Ulteriore Descrizione&nbsp;&nbsp;&nbsp;</td>
