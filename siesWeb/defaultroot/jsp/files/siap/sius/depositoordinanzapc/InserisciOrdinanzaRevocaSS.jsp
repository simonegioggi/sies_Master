...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Ordinanza Revoca Ordinanza Sanzione Sostitutiva</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciOrdinanzaRevocaSS.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
      ...
      <%
        ...
        lFunctionName = " Emissione Ordinanza Revoca Ordinanza Sanzione Sostitutiva";  
      %>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciOrdinanzaRevocaSS">
    <table width=35%>
   <tr>
...
<br>
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
    	<tr>
      <td class="l" colspan="2">Ulteriore descrizione delle Motivazioni</td>
      <td class="l" colspan="2"><TEXTAREA title="Ulteriore descrizione delle Motivazioni" name="<%= ICostantiDepositoOrdinanzaPc.CAMPO_ULTERIORE_DESCRIZIONE %>" cols="70" rows="4" ></textarea></td>
      </tr>
    </table>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciOrdinanzaRevocaSS");
