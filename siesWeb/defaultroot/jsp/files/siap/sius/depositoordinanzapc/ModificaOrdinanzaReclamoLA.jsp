...
// Nuova Ordinanza L.A. - Decreto Legge 2013/46
	int TotggLA	= 0;			/* totali concessi per Accoglie Reclamo L.A. NORMALE  */ 
	int TotggLS	= 0;			/* totali concessi per Accoglie Reclamo L.A. SPECIALE  */
	int TotggLI	= 0;			/* totali concessi per Accoglie Reclamo L.A. INTEGRAZIONE  */
	int TotggLAold = 0;	 	/* totali concessi per Accoglie Reclamo della Vecchia L.A.	*/
//	
	int TotggScompLA	= 0;			/* totali somputati per Accoglie Reclamo L.A. NORMALE  */ 
	int TotggScompLS	= 0;			/* totali somputati per Accoglie Reclamo L.A. SPECIALE  */
	int TotggScompLI	= 0;			/* totali somputati per Accoglie Reclamo L.A. INTEGRAZIONE  */
	int TotggScompLAold = 0;	 	/* totali somputati per Accoglie Reclamo della Vecchia L.A.	*/
// accoglie L.A.	
...
<html>
  ...
  <head>
    ...
    <title>[S.I.E.S.] - Modifica Ordinanza di Liberazione Anticipata</title>
	...
	function init()
	{
		...
		{				// Presenza di più oggetti
			...
			{
				var save_gg = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value = save_gg;
			}
		
			if(document.getElementById("giorni_SPE"))
			{
				var save_gg_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value = save_gg_spe;
			}
			
			if(document.getElementById("giorni_INT"))
			{
				var save_gg_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value = save_gg_int;
			}
			
			document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[0].checked=true;
			document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO%>.value = "0";
			if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[0].value == "0113")
			{
				abilitainizioLA();
				DisabilitainizioLA_SPE();
				DisabilitainizioLA_INT();
			}	
			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[0].value == "1013")
			{	
				DisabilitainizioLA();
				abilitainizioLA_SPE();
				DisabilitainizioLA_INT();
			}	
			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[0].value == "1014")
			{
				DisabilitainizioLA();
				DisabilitainizioLA_SPE();
				abilitainizioLA_INT();
		...
		{				// Presenza di un solo oggetto
			document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>.checked=true;
			if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "0113")
			{	
				var save_gg = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value = save_gg;
				abilitainizioLA();
			}	
			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "1013")
			{
				var save_gg_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value = save_gg_spe;
				abilitainizioLA_SPE();
			}	
			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "1014")
			{	
				var save_gg_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value;
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value = save_gg_int;
				abilitainizioLA_INT();
	      ...
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_PM_ACCOLTO%>.value = "C";
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_SPE_PM_ACCOLTO%>.value = "C";
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_INT_PM_ACCOLTO%>.value = "C";
	}
//	
...
//					vengono presentati per primi nella form i periodi relativi a questo oggetto, 
	function abilitainizioLA()
	{
        ...
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_SELEZIONATO%>.value = "0113";
        
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[1].checked)
        	AbilitaPeriodo();

        var valoreLA = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA%>.value;
        if(valoreLA=="")
        	valoreLA="0";

        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value = valoreLA;
       
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[1].checked)
        	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.readOnly = false;
        else
        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.readOnly = true;
	}
...
//					vengono presentati per primi nella form i periodi relativi a questo oggetto, 
	...
	//	alert("C  - AbilitainizioLA_SPE");
        ...
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_SELEZIONATO%>.value = "1013";
        
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[1].checked)
        	AbilitaPeriodo_SPE();
		
        var valoreLS = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value;
        if(valoreLS=="")
        	valoreLS="0";
        
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value = valoreLS;
       
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[1].checked)
        	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.readOnly = false;
        else
        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.readOnly = true;
	}
...
//					vengono presentati per primi nella form i periodi relativi a questo oggetto, 
	...
	//	alert("C  - AbilitainizioLA_INT");
        ...
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_SELEZIONATO%>.value = "1014";
        
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[1].checked)
        	AbilitaPeriodo_INT();
		
        var valoreLI = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value;
        if(valoreLI=="")
        	valoreLI="0";
        
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value = valoreLI;
       
        if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[1].checked)
        	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.readOnly = false;
        else
        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.readOnly = true;
	}
...
// Decreto Legge 2013/146
    ...
    {
    	var lungh = <%=lTenori.length%>;
    	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO%>.value = indd;
		...
		if(cod == 0113)
		{
			...
			if(document.getElementById("giorni_SPE"))
			{
					for(j = 0; j < lungh; j++)
		    		{
		          		if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[j].value == "1013")
		          		{
		          			if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0150" || 
		          				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0148" ||
		        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0149" ||
		        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0147"	)
		          			{
		          					var totLA_SPE = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.value;
		        		        	if (totLA_SPE!=0)
		        		        	{
			        		          	 alert("Azzerare totale Giorni Concessi! ");
			        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE%>.value == "0";
			        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.focus();
			        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = true;
			        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value = j;
			        		          	 return false;
		        		        	}
		        		        	else
		        		        	{
		          			...
		          			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0146" ||
		    						document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0284" )	
		    				{	
		          				if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value == "0")
		        		        {
		          			...
		          			else if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0301")
		          			{
		          				if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_SPE_PM_ACCOLTO %>.value == "C"	)
		    					{
		    			            ...
		    			            {
		    							document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_SPE_PM_ACCOLTO%>.value = "S";
		          			...
		          			}	// chiude else if document.ModificaOrdinanzaReclamoLibAnt.< %= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == ...	
		          		}
			        ...
			        if (totLA_SPE!=0 && totLA_SPE%75 != 0)
			        {
			          	...
			          	for(j = 0; j < lungh; j++)
			    		{
			          		if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[j].value == "1013")
			          			...
			          			document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = false;	
			    		}
			          	document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value = j;
			            return false;
			        }
			...
			if(document.getElementById("giorni_INT"))
			{
				...
				for(j = 0; j < lungh; j++)
	    		{
	          		if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[j].value == "1014")
	          		{
	          			if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0150" || 
	          				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0148" ||
	        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0149" ||
	        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0147"	)
	          			{
	          					var totLA_INT = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value;
	        		        	if (totLA_INT!=0)
	        		        	{
		        		          	 alert("Azzerare totale Giorni Concessi! ");
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value == "0";
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.focus();
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = true;
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value = j;
		        		          	 return false;
	        		        	}
	    						...
	    						document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0284" )	
	    				{	
	          				if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value == "0")
	        		        {
		        		          	alert("Inserire totale Giorni Concessi! ");
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.focus();
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = true;
	          			...
	          			{
	          				if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_INT_PM_ACCOLTO %>.value == "C"	)
	    					{					
	    			            ...
	    			            {
	    							document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_INT_PM_ACCOLTO%>.value = "S";
		...
		if(cod == 1013)
		{
			...
			if(document.getElementById("giornidiLA"))
			{
				for(j = 0; j < lungh; j++)
	    		{
	          		if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[j].value == "0113")
	          		{	
	          		//	alert("1 -- Ind = "+j);
	          			if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0150" || 
	          				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0148" ||
	        				...
	        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0147"	)
	          			{
	          					var totLA = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value;
	        		        	if (totLA != 0)
	        		        	{
		        		          	 alert("Azzerare totale Giorni Concessi! ");
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA %>.value == "0";
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.focus();
		        		          	 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = true;
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value = j;
		        		          	 return false;
	        		        	}
	    						...
	    						document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0284" )	
	    				{	
	          				if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value == "0")
	        		        {
		        		          	alert("Inserire totale Giorni Concessi! ");
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.focus();
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_QUALE_LA_CONCEDE%>[j].checked = true;
	          			...
	          			{
	          				//alert("2 -- Ind = "+j+"  -- Flag = "+document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_PM_ACCOLTO %>.value);
	          				//alert("2.1 -- SalvaGG = "+document.ModificaOrdinanzaReclamoLibAnt.< %= ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA %>.value);
	          				if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_PM_ACCOLTO %>.value == "C"	)
	    					{
	    			            ...
	    			            {
	    							document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_FLAG_ESITO_RECLAMO_LA_PM_ACCOLTO%>.value = "S";
				...
				for(j = 0; j < lungh; j++)
	    		{
	          		if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[j].value == "1014")
	          		{
	        				...
	        				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[j].value == "0147"	)
	          			{
	    						...
	    						document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[j].value == "0284" )	
	    				{	
	          				//alert("1 - salva gg = "+document.ModificaOrdinanzaReclamoLibAnt.< %= ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value);
	          				if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value == "0")
	        		        {
		        		          	alert("Inserire totale Giorni Concessi! ");
		        		          	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.focus();
...
// Oggetto : L.A.(Liberazione Anticipata)
	...
	//	alert("DisabilitaLA - inizio");
		if(document.getElementById("giornidiLA"))
		{
			var valLA = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value;
	//		if(valLA != 0)
	//		{	
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA%>.value = valLA;
	//			document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value="0";
	//		}	
...
// Oggetto : L.A.S.(Liberazione Anticipata Speciale)
	function AbilitaLA_SPE()
	{
        ...
        var valoreSPE=document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE%>.value;
        if(valoreSPE=="")
        	valoreSPE="0";
        

        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.value = valoreSPE;
...
//		alert("DisabilitaLA_SPE - inizio");
		...
		if(document.getElementById("giorni_SPE"))
		{
			var valSPE = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.value;
	//		if(valSPE != 0)
	//		{	
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE%>.value = valSPE;
	//			document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.value="0";
	//		}	
  ...
  //      alert("DisabilitaLA_SPE - fine");
	...
	//	alert("AbilitaLA_INT - inizio");
        ...
        var valoreLA_INT = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT%>.value;
        if(valoreLA_INT=="")
        	valoreLA_INT="0";
        
        document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value = valoreLA_INT;
...
//		alert("DisabilitaLA_INT - inizio");
		if(document.getElementById("giorni_INT"))
		{
			var valLA_INT = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value;
		//	if(valLA_INT != 0)
		//	{	
				document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT%>.value = valLA_INT;
		//		document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.value="0";
		//	}	
...
//		alert("DisabilitaLA_INT - fine");
	...
	// Chiusura dell'eventuale blocco aperto di L.A.
    function Chiusura()
    {
    	//	alert("Chiusura: inizio - NumCheck = "+NumCheck);
	      ...
	      for (var i=0; i < NumCheck; i++)
	      {
	    	    if(document.getElementById("giornidiLA"))
				{ 
			        if (document.ModificaOrdinanzaReclamoLibAnt.gg[i].checked)
			        {
			              document.ModificaOrdinanzaReclamoLibAnt.gg[i].checked = false;
	    	    ...
	    	    if(document.getElementById("giorni_SPE"))
				{
			        if (document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].checked)
			        {
			              document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].checked = false;
	    	    ...
	    	    if(document.getElementById("giorni_INT"))
				{
			        if (document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].checked)
			        {
			              document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].checked = false;
    ...
    function DisabilitaDate()
    {
     //   alert("DisabilitaDate: inizio");
	      ...
	      if(!document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[0].checked)
	      {
		        for (i=0; i < NumTotale; i++)
		        {
		             node=document.getElementById('L'+i);
    ...
    function conteggioDate (id)
    {
        ...
        {
        	if (id < NumTotale)
        		document.ModificaOrdinanzaReclamoLibAnt.gg[id].value = 1; 
        }          
    ...
    {
       var ret = true;
       var gg0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO%>[elem].value);
       var mm0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO%>[elem].value);
       var aa0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO%>[elem].value;
       var dataIni = gg0 + "/" + mm0 + "/" + aa0;
       var gg1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE%>[elem].value);
       var mm1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE%>[elem].value);
       var aa1 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE%>[elem].value;
    ...
    function aggiornaTotGiorni()
    {
     	//  alert("aggiornaTotGiorni(): modalita = "+modalita);
	      if (modalita == 'S')
	      {
		        ...
		        {  
		            if (document.ModificaOrdinanzaReclamoLibAnt.gg[i].value == 2)
		                giorni[i] = 45;
		            totale += giorni[i];
		            
		        }
	        // alert ("Totale giorni concessi: " +totale);
	        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value = totale;
	       }
    ...
    function checkDate(id)
    {
       //alert("check id : " + id);
      if (id < NumTotale) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI%>[id].checked = true;
      } else if (id == IndPer) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO%>.checked = true;
      } else if (id == IndRig) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI%>.checked = true;
      } else if (id == IndIna) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI%>.checked = true;
      } else if (id == IndNlp) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP%>.checked = true;
      }
      //alert("check id : " + id);
    }
    ...
    function uncheckDate(id)
    {
      ...
      if (id < NumTotale) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI%>[id].checked = false;
      } else if (id == IndPer) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO%>.checked = false;
      } else if (id == IndRig) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI%>.checked = false;
      } else if (id == IndIna) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI%>.checked = false;
      } else if (id == IndNlp) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP%>.checked = false;
      }
       //alert ("uncheck " + id);
	}
    ...
    function IsCheckedDate(id)
    {
      ...
      if (id < NumTotale) {
       if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI%>[id].checked)
          retValue = true;
      }else if (id == IndPer) {
        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO%>.checked)
          retValue = true;
      }else if (id == IndRig) {
        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI%>.checked)
          retValue = true;
      }else if (id == IndIna) {
        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI%>.checked)
          retValue = true;
      }else if (id == IndNlp) {
        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP%>.checked)
          retValue = true;
      }
    ...
    {
    	if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[0].checked)
    		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.blur();
      ...
      //  alert("AbilitaSemestri: inizio - modalita = "+modalita);
 	      ...
 	      if (modalita != 'S')
	      {
		         ...
		         if (retValue)
		         {
		           ...
		           GiorniConcessi = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value;
		         ...
		         {
		           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[1].checked = true;
		           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[0].checked = false;
		         }
	      }
  //       alert("AbilitaSemestri: fine");
         ...
         var retValue = true;
 	      if (modalita != "C")
	      {
	         ...
	         if (retValue)
	         {
		           ...
		           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value = GiorniConcessi;
	         }
	         else
	         {
	           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[0].checked = true;
	           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE%>[1].checked = false;
	         }
	      }
    ...
    function ViewLayer(id)
    {
       ...
       for (var i=0; i<NumCheck; i++)
       {
	         if (i != id && document.ModificaOrdinanzaReclamoLibAnt.gg[id].checked)
	         { document.ModificaOrdinanzaReclamoLibAnt.gg[i].disabled=true;}
	         else
	         { document.ModificaOrdinanzaReclamoLibAnt.gg[i].disabled=false;}
       }
       ...
       for (var i=0; i<NumCheck; i++)
       {
      					...
      					for (var i=0; i<NumCheck; i++)
 			    	  	{
 			        		if (i == id)
 			        		{
 								document.ModificaOrdinanzaReclamoLibAnt.gg[id].checked = true;
 			        		}
 			        		else
 			        		{
 								document.ModificaOrdinanzaReclamoLibAnt.gg[i].disabled=true;
          ...
          } // chiude la else di if (i == id && document.ModificaOrdinanzaReclamoLibAnt.gg[id].checked)
     ...
     //   alert ("node getElementById SLid - i = SL" + i);
     ...
     //   alert ("elem  = " +elem);
        for (var j=0; j<NumDate; j++, elem++)
        {
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO%>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO%>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO%>[elem].value=="");
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE%>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE%>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE%>[elem].value=="");
        }
        if (blue)
        {
    //      alert ("blue");
  ...
  //CONTROLLO DATE CONTIGUE
	function chkDateContigue(id)
	{
		...
		for (var j=0; j<NumDate; j++, elem++)
		{
			if(j==0)
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO%>[elem].value;
			...
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO%>[elem].value;
				var gg0rigaprima = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO%>[elem-1].value;
				if(gg0 != '')
				{
					riga = true;
				}
...
// -------------------- > 	JAVASCRIPT L.A.S	LIBERAZIONE ANTICIPATA SPECIALE
      ...
      //  alert("DisabilitaDate_SPE: inizio");
        ...
        for (i=0; i < NumCheck; i++)
        {
         // Vengono disabilitati tutti i blocchi periodi vuoti
	      ...
	      if(!document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[0].checked)
	      {
		        for (i=0; i < NumTotale; i++)
		        {
		             node=document.getElementById('L_SPE'+i);
    ...
    //	alert ("conteggioDate_SPE - inizio - id = "+id);
        ...
        var periodo = 0;
        var data;
     //   alert ("conteggioDate_SPE - NumTotale = "+NumTotale+"  - NumDate = "+NumDate);
        ...
        {
        	if (id < NumTotale)
        		document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[id].value = 1; 
        }          
        //alert("conteggioDate fine ");
        return retValue;
   ...
   // 	alert ("leggiDate_SPE - inizio - elem = "+elem);
       var ret = true;
       var gg0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_SPE %>[elem].value);
       var mm0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO_SPE %>[elem].value);
       var aa0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO_SPE %>[elem].value;
       var dataIni = gg0 + "/" + mm0 + "/" + aa0;
       var gg1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE_SPE %>[elem].value);
       var mm1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE_SPE %>[elem].value);
       var aa1 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE_SPE %>[elem].value;
       var dataFine = gg1 + "/" + mm1 + "/" + aa1;
    ...
    function aggiornaTotGiorni_SPE()
    {
     	//  alert("aggiornaTotGiorni_SPE(): modalita = "+modalita);
	      if (modalita == 'S')
	      {
		        ...
		        for (var i=0; i<NumTotale; i++)
		        {  
		            if (document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].value == 2)
		                giorni_spe[i] = 75;
		            totale += giorni_spe[i];
		            
		        }
	        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value = totale;
	       }
   }
    ...
    function checkDate_SPE(id)
    {
       //alert("check_SPE id : " + id);
	      if (id < NumTotale) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_SPE %>[id].checked = true;
	      } else if (id == IndPer) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_SPE %>.checked = true;
	      } else if (id == IndRig) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_SPE %>.checked = true;
	      } else if (id == IndIna) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_SPE %>.checked = true;
	      } else if (id == IndNlp) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_SPE %>.checked = true;
	      }
      //alert("check id : " + id);
    }
    ...
    function uncheckDate_SPE(id)
    {
       //alert ("uncheck_SPE " + id);
	      ...
	      if (id < NumTotale) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_SPE %>[id].checked = false;
	      } else if (id == IndPer) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_SPE %>.checked = false;
	      } else if (id == IndRig) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_SPE %>.checked = false;
	      } else if (id == IndIna) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_SPE %>.checked = false;
	      } else if (id == IndNlp) {
	      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_SPE %>.checked = false;
	      }
       //alert ("uncheck " + id);
	}
    ...
    function IsCheckedDate_SPE(id)
    {
       ...
       //alert ("IsCheckedDate " + id);
	      ...
	      if (id < NumTotale) {
	       if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_SPE %>[id].checked)
	          retValue = true;
	      }else if (id == IndPer) {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_SPE %>.checked)
	          retValue = true;
	      }else if (id == IndRig) {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_SPE %>.checked)
	          retValue = true;
	      }else if (id == IndIna) {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_SPE %>.checked)
	          retValue = true;
	      }else if (id == IndNlp) {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_SPE %>.checked)
	          retValue = true;
	      }
      //alert ("IsCheckedDate " + retValue);
    ...
    {
    	if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[0].checked)
    		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.blur();
   ...
   // 	alert("C inizio - AbilitaSemestri_SPE");
	       ...
	       if (modalita != 'S')
	       {
		         ...
		         if (retValue)
		         {
			           ...
			           // Salvataggio dei giorni concessi per il periodo unico
			           GiorniConcessi_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value;
		         ...
		         {
		           		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[1].checked = true;
		           		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[0].checked = false;
		         }
	       }
	      ...
	      if (modalita != 'C')
	      {
		         ...
		         if (retValue)
		         {
			          ...
			          node.style.display='block';
			           ...
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value = GiorniConcessi_spe;
		         }
		         else
		         {

			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[0].checked = true;
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_SPE %>[1].checked = false;
		         }
	      }
   ...
   //   alert ("C ViewLayer_SPE id: " + id);
       ...
       for (var i=0; i<NumCheck; i++)
       {
	         if (i != id && document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[id].checked)
	         { document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].disabled=true;}
	         else
	         { document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].disabled=false;}
       }
          ...
          else
          {
             ...
             { // chiusura
              //  alert ("ViewLayer_SPE Sto chiudendo - i =" +i+"  id = "+id);
	      					...
	      					for (var i=0; i<NumCheck; i++)
	 			      		{
		 			        	if (i == id)
		 			        	{
		 							document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[id].checked = true;
		 			        	}
		 			        	else
		 			        	{
		 							document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[i].disabled=true;
	 				...
	 				{
	 				//	alert ("ViewLayer_SPE else data contigue- i =" +i+"  id = "+id);
	 					if (conteggioDate_SPE(i) == false)
	                 	{
	                  		/* Riposizionamento del check  */
	                  	//	alert ("ViewLayer_SPE Riposizionamento del check - i =" +i+"  id = "+id);
	                     	document.ModificaOrdinanzaReclamoLibAnt.gg_SPE[id].checked = true;
	 				...
	 				//	alert ("ViewLayer_SPE NON Riposizionamento del check - i =" +i+"  id = "+id);
	 				}
             }
     ...
     //   alert ("elem  = " +elem);
        for (var j=0; j<NumDate; j++, elem++)
        {
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_SPE %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO_SPE %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO_SPE %>[elem].value=="");
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE_SPE %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE_SPE %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE_SPE %>[elem].value=="");
        }
        if (blue)
        {
    //      alert ("blue");
  ...
  //CONTROLLO DATE CONTIGUE
	function chkDateContigue_SPE(id)
	{
		...
		for (var j=0; j<NumDate; j++, elem++)
		{
			if(j==0)
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_SPE %>[elem].value;
			...
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_SPE %>[elem].value;
				var gg0rigaprima = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_SPE %>[elem-1].value;
				if(gg0 != '')
				{
					riga = true;
				}
...
// -------------------- > 	JAVASCRIPT L.A.I	LIBERAZIONE ANTICIPATA INTEGRAZIONE
    ...
    function DisabilitaDate_INT()
    {
	      ...
	      if(!document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[0].checked)
	      {
		        for (i=0; i < NumTotale; i++)
		        {
		             node=document.getElementById('L_INT'+i);
    ...
    //	alert ("conteggioDate_INT - inizio - id = "+id);
        ...
        {
        	if (id < NumTotale)
        		document.ModificaOrdinanzaReclamoLibAnt.gg_INT[id].value = 1; 
        }          
//        alert("conteggioDate_INT fine ");
    ...
    //	alert ("leggiDate_INT - inizio - elem = "+elem);
	       var ret = true;
	       var gg0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_INT %>[elem].value);
	       var mm0 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO_INT %>[elem].value);
	       var aa0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO_INT %>[elem].value;
	       var dataIni = gg0 + "/" + mm0 + "/" + aa0;
	       var gg1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE_INT %>[elem].value);
	       var mm1 = FillDM(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE_INT %>[elem].value);
	       var aa1 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE_INT %>[elem].value;
	       var dataFine = gg1 + "/" + mm1 + "/" + aa1;
	       ...
	       else
	       {
	               ...
	               DataIni = new Date(aa0, mm0-1, gg0);
	               DataFine  = new Date(aa1, mm1-1, gg1);
//	               alert("L.A. INT Data iniziale : " + DataIni.toString());
//	               alert("L.A. INT Data finale : " + DataFine.toString());
	       }
    ...
    function aggiornaTotGiorni_INT()
    {
     	//  alert("aggiornaTotGiorni_INT(): modalita = "+modalita);
	      if (modalita == 'S')
	      {
		        ...
		        for (var i=0; i<NumTotale; i++)
		        {  
		            if (document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].value == 2)
		                giorni_int[i] = 30;
		            
		            totale += giorni_int[i];
		            
		        }
	        	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value = totale;
	       }
   }
    ...
    function checkDate_INT(id)
    {
      ...
      if (id < NumTotale) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_INT %>[id].checked = true;
      } else if (id == IndPer) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_INT %>.checked = true;
      } else if (id == IndRig) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_INT %>.checked = true;
      } else if (id == IndIna) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_INT %>.checked = true;
      } else if (id == IndNlp) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_INT %>.checked = true;
      }
      //alert("check_INT id : " + id);
    }
    ...
    function uncheckDate_INT(id)
    {
      ...
      if (id < NumTotale) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_INT %>[id].checked = false;
      } else if (id == IndPer) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_INT %>.checked = false;
      } else if (id == IndRig) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_INT %>.checked = false;
      } else if (id == IndIna) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_INT %>.checked = false;
      } else if (id == IndNlp) {
      document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_INT %>.checked = false;
      }
    ...
    function IsCheckedDate_INT(id)
    {
       ...
       //alert ("inizio IsCheckedDate_INT - id = " + id);
	      ...
	      if (id < NumTotale) 
	      {
	       		if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_CONCESSI_INT %>[id].checked)
	          		retValue = true;
	      }
	      else if (id == IndPer) 
	      {
	        	if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_PERIODO_INT %>.checked)
	          	retValue = true;
	      }
	      else if (id == IndRig) 
	      {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_RIGETTATI_INT %>.checked)
	          retValue = true;
	      }
	      else if (id == IndIna) 
	      {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_INAMMISSIBILI_INT %>.checked)
	          retValue = true;
	      }
	      else if (id == IndNlp) 
	      {
	        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_CHECK_NLP_INT %>.checked)
	          retValue = true;
	      }
    ...
    {
    	if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[0].checked)
    		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.blur();
    ...
    //	alert("C inizio - AbilitaSemestri_INT - modalita = " +modalita);
       	...
       	if (modalita != 'S')
      	{
	         ...
	         if (retValue)
	         {
		           ...
		           // Salvataggio dei giorni concessi per il periodo unico
		           GiorniConcessi_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value;
	         ...
	         {
	           		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[1].checked = true;
	           		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[0].checked = false;
	         }
      	}
	      ...
	      if (modalita != 'C')
	      {
		         ...
		         if (retValue)
		         {
			          ...
			          node.style.display='block';
			           ...
			           // Nell'inserimento per unico periodo il numero dei giorni concessi deve essere inputato a mano
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.readOnly = false;
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value = GiorniConcessi_int;
		         }
		         else
		         {
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[0].checked = true;
			           document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_RADIO_TIPO_CONCESSIONE_INT %>[1].checked = false;
		         }
	      }
  ...
  //    alert ("C ViewLayer_INT id: " + id);
       ...
       for (var i=0; i<NumCheck; i++)
       {
	         if (i != id && document.ModificaOrdinanzaReclamoLibAnt.gg_INT[id].checked)
	         { 
	        	 document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].disabled=true;
	         }
	         else
	         { 
	        	 document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].disabled=false;
	          }
       }
...
//	            	 alert('INT chiudo  - i = '+i);
	      					...
	      					for (var i=0; i<NumCheck; i++)
		 			      	{
		 			        	if (i == id)
		 			        	{
		 							document.ModificaOrdinanzaReclamoLibAnt.gg_INT[id].checked = true;
		 			        	}
		 			        	else
		 			        	{
		 							document.ModificaOrdinanzaReclamoLibAnt.gg_INT[i].disabled=true;
	 				...
	 				{
//	 					alert ("ViewLayer_INT else- data contigue= vero - i =" +i+"  id = "+id);
...
//	 				
          ...
          } // chiude la else di if (i == id && document.ModificaOrdinanzaReclamoLibAnt.gg_INT[id].checked)
        ...
        for (var j=0; j<NumDate; j++, elem++)
        {
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_INT %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_INIZIO_INT %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_INIZIO_INT %>[elem].value=="");
	          blue=blue && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_FINE_INT %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_MESE_DATA_FINE_INT %>[elem].value=="")  && (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_ANNO_DATA_FINE_INT %>[elem].value=="");
        }
        if (blue)
        {
//	          alert ("blue");
  ...
  //CONTROLLO DATE CONTIGUE
	...
	//	alert('INT - chkDateContigue_INT. - id ='+id);
		...
		for (var j=0; j<NumDate; j++, elem++)
		{
			if(j==0)
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_INT %>[elem].value;
			...
			{
				var gg0 = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_INT %>[elem].value;
				var gg0rigaprima = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_GIORNO_DATA_INIZIO_INT %>[elem-1].value;
				if(gg0 != '')
				{
					riga = true;
				}
...
//  ---------------------- FINE -----------------------
    ...
    function Verify()
    {
    	//alert("Verify: inizio");
	      var retValue = false;
	      var lEsiti=document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
	        ...
	        if (retValue)
	     	...
	     	{								// In caso di ALMENO 1 CONCESSIONE ENTRA QUI' e vengono controllati i gg concessi
	     		...
	     		if (ComboConcede())
		        {
	     			 var codOgg = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_SELEZIONATO%>.value;	

			        if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
			        {	// Un Solo Oggetto L.A. presente
			        	
			        	var lperiod = false;
			        	lperiod = InseritoPeriodo();
			        	if(!lperiod)
			        	{
			        		if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0146")
			        		{	
			      		...
			      		if(document.getElementById("giornidiLA"))
						{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0301" && codOgg == "0113" )
				         	{
								if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di L.A. saranno ricomputati sulla pena da espiare.\n Si vuole continuare?" ) )
					       		{
					       			return false;
					       		}
					       		else
						...
						if(document.getElementById("giorni_SPE"))
					 	{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0301" && codOgg == "1013" )
			        	 	{
									if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di L.A. Speciale saranno ricomputati sulla pena da espiare.\n Si vuole continuare?" ) )
				            		{
				              			return false;
				            		}
				            		else
						...
						if(document.getElementById("giorni_INT"))
					 	{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0301" && codOgg == "1014" )
			        	 	{
									if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di Integrazione L.A. saranno ricomputati sulla pena da espiare. Si vuole continuare?" ) )
				            		{
				              			return false;
			        ...
			        }	// CHIUDE  if (typeof (document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
			        else
			        {	// più Oggetti L.A. Presenti
			        	
			        	var indsel = document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value;
			        	var lperiod = false;
			        	
			        	// MsgBox di giorni scomputati : Solo per ACCOGLIE RECLAMO L.A.(cod esito = 0301)
			        	if(document.getElementById("giornidiLA"))
						{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0301" && codOgg == "0113" )
				         	{
								if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di L.A. saranno ricomputati sulla pena da espiare.\n Si vuole continuare?" ) )
					       		{
					       			return false;
				        	...
				        	lperiod = InseritoPeriodoLA();
				        	if(!lperiod)
				        	{
				        		if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0146" && codOgg == "0113")
				        		{	
				        			alert("Nessun periodo inserito! Indicare i periodi di L.A. di Riferimento" ); 
									return false;
				        		}	
				        	}
						...
						if(document.getElementById("giorni_SPE"))
					 	{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0301" && codOgg == "1013" )
			        	 	{
									if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di L.A. Speciale saranno ricomputati sulla pena da espiare.\n Si vuole continuare?" ) )
				            		{
				              			return false;
							...
							lperiod = InseritoPeriodoLS();
				        	if(!lperiod)
				        	{
				        		if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0146" && codOgg == "1013")
				        		{	
				        			alert("Nessun periodo inserito! Indicare i periodi di L.A.Speciale di Riferimento" ); 
									return false;
				        		}	
				        	}
					 	}
						...
						if(document.getElementById("giorni_INT"))
					 	{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0301" && codOgg == "1014" )
			        	 	{
									if (! confirm("Attenzione: confermando l'esito 'Accoglie reclamo del PM' il n.ro giorni di Integrazione L.A. saranno ricomputati sulla pena da espiare. Si vuole continuare?" ) )
				            		{
				              			return false;
							...
							lperiod = InseritoPeriodoLI();
				        	if(!lperiod)
				        	{
				        		if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indsel].value == "0146" && codOgg == "1014")
				        		{	
				        			alert("Nessun periodo inserito! Indicare i periodi di Integrazione L.A. di Riferimento" ); 
									return false;
				        		}	
				        	}
					 	}
					 	
			        }	// Chiude la Else di if Undefined	
			        
					 if(document.getElementById("giornidiLA"))
					 {
						 
						 GiorniConcessi = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value;
						 SalvaGiorniConcessi = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA %>.value;
					 }
					 
					 if( (codOgg == "0113" && GiorniConcessi%45 != 0) || 
						 (codOgg == "0113" && GiorniConcessi == 0) )
			         {
			         ...
			         // concessione L.A. SPECIALE
					 if(document.getElementById("giorni_SPE"))
					 {
						 GiorniConcessi_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value;
						 SalvaGiorniConcessi_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value;
					 }
					 
			         if( (codOgg == "1013" && GiorniConcessi_spe%75 != 0) ||
			        	 (codOgg == "1013" && GiorniConcessi_spe == 0) )
			         {
					 ...
					 {
						 GiorniConcessi_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value;
						 SalvaGiorniConcessi_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value;
					 }
					 
			         if( (codOgg == "1014" && GiorniConcessi_int%30 != 0) ||
			        	 (codOgg == "1014" && GiorniConcessi_int == 0) )	 
			         {
			...
			//	alert("Verify: inizio 3");
		        ...
		        {
	        		// 10/04/2014 se entra qui dentro vuol dire che esiste solo un oggetto ORDINANZA e NON E' CONCESSIONE
	        	//	alert("Verify: inizio 4");
	            		...
	            		{	// Più Oggetti L.A. presenti
                			...
                			if(document.getElementById("giornidiLA"))
							{
				          		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA%>.value = "0";
								GiorniConcessi = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value;
				          		if (document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "0113" && GiorniConcessi != "0" )
					          	{
						              alert("Azzerare i giorni da concedere! ");
						              document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.focus();
						              return false;
							 ...
							 if(document.getElementById("giorni_SPE"))
							 {
								 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value = "0";
								 GiorniConcessi_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value;
					          	 if (document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "1013" && GiorniConcessi_spe != "0" )
						         {
							              alert("Azzerare i giorni da concedere! ");
							              document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.focus();
							              return false;
							 ...
							 if(document.getElementById("giorni_INT"))
							 {
								 document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT%>.value = "0";
								 GiorniConcessi_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value;
					          	 if (document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "1014" && GiorniConcessi_int != "0" )
						         {
							              alert("Azzerare i giorni da concedere! ");
							              document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.focus();
							              return false;
	        ...
	        // viene inserito il Magistrato Competente
		        if (ComboIncompetenza())
		        {
		         	...
		         	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>.value = "";
        
	        	retValue = Chiusura();

				// 10/04/2014	CONTROLLO il caso di Presenza di NON CONCESSIONE e PIU' Oggetti ORDINANZA:
				...
				{	
					var indiceSelezionato = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO%>.value;
					if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0150" ||
						document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0148" ||
						document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0149" ||
						document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0147"  )
					{
							if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indiceSelezionato].value == "0113")
							{
								document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA%>.value = "0";
								GiorniConcessi = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA %>.value;
				          		if (GiorniConcessi != '0' )
					          	{
						            alert("Azzerare i periodi e giorni da concedere! ");
						              return false;
					          	}						
							}
							
							if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indiceSelezionato].value == "1013")
							{
								document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_SPE %>.value = "0";
								GiorniConcessi_spe = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE %>.value;
				          		if (GiorniConcessi_spe != '0' )
							...
							if(document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indiceSelezionato].value == "1014")
							{
								document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_SALVA_GIORNI_LA_INT %>.value = "0";
								GiorniConcessi_int = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT %>.value;
				          		if (GiorniConcessi_int != '0' )
					...
					}	// chiude if (document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0150" ||....
				
				}	// chiude else di if (typeof (document.ModificaOrdinanzaReclamoLibAnt.< %=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
 ...
 // Il confronto viene fatto con la descrizione e non con il codice perchè i codici sono molti.
    function ComboIncompetenza()
    {
      ...
      //alert("ComboIncompetenza : inizio");
	      ...
	      if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
	      {
	    	  	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value != "0149")
	       	 	{	
	       			ritorno = false;
	       	 	}
	      }
	      ...
	      {
	    	  	var indj = document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value;
	       	 	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indj].value != "0149")
	       	 	{	
	       			ritorno = false;
	       	 	}
	      }
 ...
 // STUB 09/03/2007 Controllo Giorni concessi.
    ...
    {
    	// alert ("ComboConcede - inizio");
	      var ritorno = false;
	      
	      if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
	      {	
		       // alert ("ComboConcede - Presente un solo oggetto");
	    	  	if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0146" || 
	    	  		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0284" || 
	    	  		document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value == "0301"  )
		      	{ 
		          	ritorno = true;
		        }
	      }
	      ...
	      {		
	    		//alert ("ComboConcede - Presenti più oggetti ");
		        var indiceSelezionato = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO%>.value;
		        if (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0146" || 
			    	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0284" || 
			    	document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indiceSelezionato].value == "0301"  )
				{ 
				      ritorno = true;
				}
	      }
    ...
    function ComboRigetta()
    {
	      ...
	      if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
	      {
	    	  if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value != "0147")
	     	  {	
	     			ritorno = false;
	     	  } 
	      }
	      ...
	      {
	    	  	var indj = document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value;
	       	 	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indj].value != "0147")
	       	 	{	
	       			ritorno = false;
	       	 	}
	      }
    ...
    function ComboNDPNLP()
    {
	      ...
	      if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
	      {
	    	  	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value != "0148")
	     	 	{	
	     			ritorno = false;
	     	 	}
	      }
	      ...
	      {
	    	  	var indj = document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value;
	     	 	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indj].value != "0148")
	     	 	{	
	     			ritorno = false;
	     	 	}
	      }
    ...
    function ComboInammissibile()
    {
	      ...
	      if (typeof (document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
	      {
	    	  	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.value != "0150")
		 	 	{	
		 			ritorno = false;
		 	 	}
	      }
	      ...
	      {
	    	  	var indj = document.ModificaOrdinanzaReclamoLibAnt.<%= ICostantiLibertaAnticipata.CAMPO_QUALE_IND_SELEZIONATO %>.value;
		   	 	if(document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[indj].value != "0150")
		   	 	{	
		   			ritorno = false;
		   	 	}
	      }
...
//  19-11-2015 : Periodi Obbligatori per tipo concessione = 0146
//  Funzione di controllo per determinare se è stato inserito almeno un periodo. Specifica per Ogni Tipo di Oggetto L.A.
    function InseritoPeriodoLA()
    {
        var i=0;
        var ok=0;
        for (i=0; i < NumCheck; i++)
...
%>
    ...
    function VerificaDate()
    {
        ...
        var data_emissione = document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.ModificaOrdinanzaReclamoLibAnt.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value;
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ModificaOrdinanzaReclamoLibAnt">
		...
		<%
			      			...
			      			if(lLicPerConcDT1.getLicenza().getDescrStatoPermesso() != null)
			      			{
				      				if(lLicPerConcDT1.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LS") )
					        				tipoDT = "Reclamo Liberazione Anticipata Speciale";
					        		else if(lLicPerConcDT1.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LI") )
					        					tipoDT = "Reclamo Integrazione Liberazione Anticipata";	
					        		else 
					        					tipoDT = "Reclamo Liberazione Anticipata";
			      			}
			      			...
			      			if( lLicPerConcCDT != null && lLicPerConcCDT.getPeriodi() != null )
			      			{
					      			...
					      			if(lLicPerConcCDT.getLicenza().getDescrStatoPermesso() != null)
					      			{
						      				if(lLicPerConcCDT.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LS") )
							        				tipoCDT = "Reclamo Liberazione Anticipata Speciale";
							        		else if(lLicPerConcCDT.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LI") )
							        					tipoCDT = "Reclamo Integrazione Liberazione Anticipata";	
							        		else 
							        					tipoCDT = "Reclamo Liberazione Anticipata";
					      			}        			
...
// Aggiunta per modifica Ordinanza RECLAMO LA - 19/10/2009 :
//		in mezzo ci sono le aggiunte per la Nuova Ordinanza L.A. del Decreto Legge 2013/46	- 20/03/2014  
  ...
  { %>
	...
	<%	  
		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
		siesLogger.debug("--> C Modifica RECLAMO - numDT[5] > 0 =  "+numDT[5] ); 
	    ...
	    while (itxC5.hasNext())
        {
	       ...
	       {
	    	   // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
	    	   siesLogger.debug("--> C Modifica RECLAMO - FlagConcesso = S"); 
	    	    if(lLicPerConc5 != null && lLicPerConc5.getPeriodi() != null )
	        	{ %>
						<table cellspacing="2" cellpadding="2">
<%	
						// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
						siesLogger.debug("--> C Modifica RECLAMO - Periodi presenti"); 
						String tipoRe="";
						if(lLicPerConc5.getLicenza().getDescrStatoPermesso() != null)
						{
								if(lLicPerConc5.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LS") )
									tipoRe = "Reclamo Liberazione Anticipata Speciale";
							else if(lLicPerConc5.getLicenza().getDescrStatoPermesso().substring(0,2).equals("LI") )
									tipoRe = "Reclamo Integrazione Liberazione Anticipata";	
							else 
									tipoRe = "Reclamo Liberazione Anticipata";
						}
			          	nDT[5]++;
...
<%
//
//		OGNI OGGETTO RECLAMO L.A. VIENE ESAMINATO
//
%> 
<!-- 	INIZIO PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A. -->  
<% 	      
  		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  		siesLogger.debug("--> C Inizio Modifica - LA "); 
...
// Fine Aggiunta	-	-	-	-	-	>	Fine nuova parte introdotta 20/4/2009         %>
 ...
 <!-- 	FINE PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A. -->  
 
 <!-- -	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	- -->
 
 <!-- 	INIZIO PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A. SPECIALE ( L.A.S.) -->  
<% 	      
  		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  		siesLogger.debug("-------> C Inizio Modifica RECLAMO  - TotggLS = "+TotggLS ); 
      ...
      if(lLicPer.getLicenza().getDescrStatoPermesso() != null)
      {
    	  ...
    	  {	  
		      ...
		      else if ( lLicPer.getLicenza().getFlagConcesso().compareTo("S") == 0) 
		      {
		          numLS[5]++;
		          // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
		          siesLogger.debug("-------> C  RECLAMO sco ls  - numLS[5] = "+numLS[5] ); 
		          if (lLicPer.getLicenza().getFlagScorta() != null && lLicPer.getLicenza().getFlagScorta().compareTo("C") == 0)
		          {
		               plamLS_i = NumTotaleSemestri;
		               sceltaSemestriLS = 0;
		               // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
		               siesLogger.debug("-------> C  RECLAMO sco ls  fLAGsCORTA = C - plamLS_i = "+plamLS_i ); 
		          }
		      }
    	  }     
      }
...
// Aggiunta per modifica Ordinanza RECLAMO LS - 19/10/2009 :
//		in mezzo ci sono le aggiunte per la Nuova Ordinanza L.A. del Decreto Legge 2013/46	- 20/03/2014  
  
  if (numLS[5] > 0) 
  { 
	   // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
	   siesLogger.debug("--> MODIFICA RECLAMO LA - scomputo LAS - numLS[5] > 0 = "+numLS[5]); 
...
// Fine Aggiunta	-	-	-	-	-	>	Fine nuova parte introdotta 20/4/2009         %>
 ...
 <!-- 	FINE PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A. SPECIALE (L.A.S) -->  	  

 <!-- 	INIZIO PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A.INTEGRAZIONE (L.A.I.) -->  
<% 	      
  		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
...
// Fine Aggiunta	-	-	-	-	-	>	Fine nuova parte introdotta 20/4/2009         %>
 ...
 <!-- 	FINE PARTE CONTEGGI SPECIFICI DI RECLAMO ORDINANZA L.A. INTEGRAZIONE (L.A.I) -->  	  
...
<%  // Nuova Ordinanza L.A. del Decreto Legge 2013/46	- 20/03/2014 
	...
	while (itxGG.hasNext())
	{
		...
		if( lLicConc.getLicenza().getFlagConcesso().compareTo("C") == 0)	// accoglimento Reclamo	*/
		{	    
		...
		else if(lLicConc.getLicenza().getFlagConcesso().compareTo("S") == 0)	// Accoglie Reclamo con SCOMPUTO 
		{
			if(lLicConc.getLicenza().getDescrStatoPermesso() != null)
			{
		    	if( lLicConc.getLicenza().getDescrStatoPermesso().substring(0,2).compareTo("LA") == 0)	/* L.A. NORMALE	*/
...
//	  siesLogger.debug("--> C periodoSemestriLS = "+semestriLS ); 
	  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
	  siesLogger.debug("--> C RECLAMO perUnicoConcLS_dalal = "+perUnicoConcLS_dalal );
	  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
	  siesLogger.debug("--> C RECLAMO perUnicoConcLS_sologg = "+perUnicoConcLS_sologg ); 
// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
...
<!-- 																																			 -->					 
   ...
   for (int indTeno = 0; indTeno < lTenori.length; indTeno++)
   {
	  ...
	  // siesLogger.debug(" ------------------------------------------------> INIZIO GIRO - indTeno = " + indTeno);
		if(lTenori[indTeno].getCodOggettoTenore().compareTo("0113") == 0)
		{ 
				// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
				siesLogger.debug("tenore oggetto 0113 L.A. normale " );
		%>
...
<%		}
		else if(lTenori[indTeno].getCodOggettoTenore().compareTo("1013") == 0)
		{				
            // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
            siesLogger.debug("tenore oggetto 1013 L.A. Speciale = " ); 	
%>
	<!--  	> > >  		INIZIO PARTE CON LE DIV PER 	LIBERAZIONE ANTICIPATA SPECIALE ( L.A.S.)		  	< < < 	-->	
			...
			<div id="comune_SPE" style="position: relative; top: 0; left: 0;" >
			  ...
			  <%if( semestriLS > 0) 
			  	{
				  		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
				  		siesLogger.debug("--> C RECLAMOsemestri_SPE - display_block  " );
			  		%>
			  ...
			  <%}
			    ...
			    { 
			    		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
			    		siesLogger.debug("--> C RECLAMOsemestri_SPE - display_none " );
			    	%>
  ...
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE Period num[0] = "+numLS[0] ); 
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE semest num[1] = "+numLS[1] );
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE Rigett num[2] = "+numLS[2] );
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE Inammi num[3] = "+numLS[3] );
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE NLP    num[4] = "+numLS[4] );
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("--> C RECLAMO_SPE Scompu num[5] = "+numLS[5] ); 
  	...
  	<%
	     ...
	     <%		}		%>
			  ...
			  <%if( semestriLS > 0) 
			  	{
				  		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
				  		siesLogger.debug("--> CRECLAMO periodo_SPE - display_none " );
			  		%>
			  ...
			  <%}
			    ...
			    { 
			    		// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
			    		siesLogger.debug("--> C RECLAMOperiodo_SPE  - display -  " );
			    	%>
 ...
 <%			    }	%>
			...
			for ( int in=0; in<NumCheck; in++)
			{
				...
				{
					// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
					siesLogger.debug("--> C RECLAMO_SPE - Plam_arrayLS[in] NON nullo  - ichecked = in = "+in ); 
					iChecked = "checked";
				}	
			...
			<div id="L_SPE<%=in%>" style="position: relative; top: -120; left: 500; display:none;" >
			  <table>
			   ...
			   // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
			   siesLogger.debug("--> CRECLAMO_SPE Prima del ciclo for per le date Dal Al - NumDate = "+NumDate+" in = "+in ); 
			    for (int k=0; k<NumDate; k++)
				{
				   %>
			    <tr>
...
<%            
		...
		else if(lTenori[indTeno].getCodOggettoTenore().compareTo("1014") == 0)
		{
				// [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
				siesLogger.debug("tenore oggetto 1014 L.A. Integrazione " );
%>
...
<%			
		}	// chiude else if(lTenori[i].getCodOggettoTenore().compareTo("1014") == 0)
    ...
    <% if(CodUff != null && CodUff.equals("TDSM")){ %>
	    <tr>
	      ...
	      <td class="L"><%=MinorMask.comboMagistratoTrattino()%> 
      		...
      		<a href="Javascript:ListaUDSMIN('ModificaOrdinanzaReclamoLibAnt','<%=ICostantiDepositoOrdinanzaPc.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>');">
    ...
    <% } else { %>
	    <tr>
	      ...
	      <td class="l">
	        ...
	        <a href="Javascript:ListaUDS('ModificaOrdinanzaReclamoLibAnt','<%=ICostantiDepositoOrdinanzaPc.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>');">
...
<%			siesLogger.debug("--> C Fine Modifica - totggLA = "+TotggLA );    %>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("ModificaOrdinanzaReclamoLibAnt");
