...
<%
//==============================================================================
// MEV_2023-35 jsp copia della InserisciOrdinanzaApplicazioneSS.jsp
...
<html>
  ...
  // Flag per l'obbligatorietà di campi in funzione di esito selezionato
    ...
    { 
      ...
      if (aCodEsito == "3084"  || aCodEsito == "1146" )
        restituisce = true;
    }
   </script >    
  ...
  <script language="JavaScript">     
    ...
    { 
      ...
      {
        ritorno = false;
        alert ("Inserire la durata della Pena Sostitutiva ! ");
      }
      return ritorno;
    }
  </script>    
 ...
 %>
  ...
  <body class="corpo" >
    ...
    <tr>
      ...
      <td class=LBG><font class="label">Funzione : </font> <font class="campo">Emissione Ordinanza Applicazione Pene Sostitutive</font>&nbsp;
      </td>
    </tr>
    <tr>
  ...
  if (   sanzione_residua != null 
      && (   (sanzione_residua.getNumAnni() != null) 
  ...
  else if (   sanzione_sostitutiva != null 
           && (   (sanzione_sostitutiva.getNumAnni() != null) 
  ...
  %>
    ...
    <tr>
      <td class="l">Durata Pena Sostitutiva da espiare: </td>      
      <td class="L">
