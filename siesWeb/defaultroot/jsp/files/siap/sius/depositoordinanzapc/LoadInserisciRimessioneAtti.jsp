  ...
  <head>
    ...
    <script language="JavaScript">
     ...
     // Chiamata funzione lista dei comuni.
      ...
      function Verify() {
    	  //var sel="";
    	  //var lNotificaFax=document.LoadInserisciRimessioneAtti.<//%=ICostantiRichiestaAtti.CAMPO_NOTIFICA_VIA_FAX %>;
    	  ...
    	  //document.LoadInserisciRimessioneAtti.<//%=ICostantiRichiestaAtti.CAMPO_NOTIFICHE_VIA_FAX %>.value=sel;
...
<%
    ...
    String lActRet = null;
            ...
            lAction = new String("siap.sius.depositoordinanzapc.action.ActInserisciRimessioneAtti");
            lDocumento = new String("ordinanza");
            lTitolo = new String("Emissione Ordinanza Rimessione Atti");
            lActRet = new String("siap.sius.depositoordinanzapc.action.ActLoadRimessioneAtti");
    ...
    <tr>
        ...
        <td class="l" colspan=2>Sede  
             <input Title="Sede Procura" name="<%=ICostantiRichiestaAtti.CAMPO_SEDE_AVVOCATO%>"
              ...
              <a href="Javascript:ListaUffici('LoadInserisciRimessioneAtti','<%=ICostantiRichiestaAtti.CAMPO_SEDE_AVVOCATO%>[<%=num_sede%>]');">
              <img src="/images/filefolder.gif" border=0> </a>
        </td>
     </tr>
     <tr>
