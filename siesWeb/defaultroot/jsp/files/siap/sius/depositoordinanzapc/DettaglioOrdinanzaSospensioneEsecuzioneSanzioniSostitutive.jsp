...
<table cellspacing="2" cellpadding="2">
    <tr> <td> <br></td></tr>
    <tr>
        <td class="Titolo" colspan=6> Sospensione Esecuzione Sanzione Sostitutiva <td>
    </tr>
  <tr>
  ...
  if(datiOrdinanza.getOrdinanza().getFlagRecuperoSS()!= null && datiOrdinanza.getOrdinanza().getFlagRecuperoSS().equals("S"))
  {%>
  <tr>
