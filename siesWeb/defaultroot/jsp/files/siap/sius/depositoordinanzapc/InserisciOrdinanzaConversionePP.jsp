...
<html>
<head>
<title>[S.I.E.S.] - Emissione Ordinanza Conversione PP<%=descrContenuto%></title>
...
function Verify() {
	...
	if ((document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.selectedIndex].value in { '1770':1, '1771':1 }
			...
			|| (document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>.selectedIndex].value == '3210'
					&& (document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_OGGETTO_TENORE%>.value == 3180
							|| document.InserisciOrdinanzaConversionePP.<%=ICostantiTenore.CAMPO_COD_OGGETTO_TENORE%>.value == 3181))) {
...
<table>
	<tr>
		<td class="LBG">
      	...
      	<td class=LBG>
      		<font class="label">Funzione : </font> <font class="campo">Emissione Ordinanza Conversione Pene Pecuniarie<%=descrContenuto%></font>
      	</td>
	</tr>
    <tr>
