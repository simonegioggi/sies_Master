...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Ordinanza Ricovero OPG</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciOrdinanzaRicoveroOPG.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
      ...
      <%
        ...
        {
           lAction = Action;
           lFunctionName = "Emissione Decreto Ricoveri OPG per espiazione della pena";
        }
        else
        {
           lAction = "siap.sius.depositoordinanzapc.action.ActInserisciOrdinanzaUDS";
           lFunctionName = "Emissione Ordinanza Ricovero OPG per espiazione della pena";
        }
      %>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciOrdinanzaRicoveroOPG">
    <table width=35%>
   <tr>
...
<br>
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
     <tr>
      <td class="l">Descrizione diagnosi</td>
     </tr>
    <tr>
    <td class="l">
     <input Title="Descrizione diagnosi psichiatrica" name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_COD_NATURA_PROVVEDIMENTO %>" value="" size=70 >
    </td>
  </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciOrdinanzaRicoveroOPG");
