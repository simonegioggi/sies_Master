...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Ordinanza Revoca Liberazione Condizionale</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciOrdinanzaEPLC.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
    ...
    {
     var ritorno = true;
     var data_inizio_periodo = document.InserisciOrdinanzaRevocaLA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_INIZIO_PERIODO%>.value+'/'+document.InserisciOrdinanzaRevocaLA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_MESE_DATA_INIZIO_PERIODO%>.value+'/'+document.InserisciOrdinanzaRevocaLA.<%=ICostantiDepositoOrdinanzaPc.CAMPO_ANNO_DATA_INIZIO_PERIODO%>.value;

     if (data_inizio_periodo.length > 2 )
     {
       ritorno = ConfrontaConDataEmissione(data_inizio_periodo, "data inizio ");
     }
     return ritorno;
    }
  </script>
 ...
 %>
  ...
  <body class="corpo" >
    ...
    <tr>
      ...
      <td class=LBG><font class="label">Funzione : </font> <font class="campo">Emissione Ordinanza Revoca Liberazione Condizionale</font>&nbsp;
      </td>
    </tr>
    <tr>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciOrdinanzaRevocaLA">
    <table width=35%>
   <tr>
...
<br>
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <tr>
    <td class="Titolo" colspan=6> In caso di 'Revoca con efficacia dal...' indicare: <td>
  </tr>
    <tr>
      <td class="l">Data Inizio <br> (gg-mm-aaaa)</td>
      <td class="L">
  ...
  <tr> </tr>
    <tr>
      <td class="l">Pena residua rideterminata in <br> (AA-MM-GG)</td>
      <td class="L">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciOrdinanzaRevocaLA");
