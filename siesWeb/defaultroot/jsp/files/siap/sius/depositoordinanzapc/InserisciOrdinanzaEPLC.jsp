...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Ordinanza Estinzione Pena Liberazione Condizionale</title>
  ...
  <script language="JavaScript">
    ...
    {
     var ritorno = true;
     var data_inizio_periodo = document.InserisciOrdinanzaEPLC.<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_INIZIO_PERIODO%>.value+'/'+document.InserisciOrdinanzaEPLC.<%=ICostantiDepositoOrdinanzaPc.CAMPO_MESE_DATA_INIZIO_PERIODO%>.value+'/'+document.InserisciOrdinanzaEPLC.<%=ICostantiDepositoOrdinanzaPc.CAMPO_ANNO_DATA_INIZIO_PERIODO%>.value;

     if (data_inizio_periodo.length > 2 )
     {
       ritorno = ConfrontaConDataEmissione(data_inizio_periodo, "data Decorrenza ");
     }
     return ritorno;
    }
  </script>
 ...
 %>
  ...
  <body class="corpo" >
    ...
    <tr>
      ...
      <td class=LBG><font class="label">Funzione : </font> <font class="campo">Emissione Ordinanza Dichiarazione Estinzione Pena Liberazione Condizionale</font>&nbsp;
      </td>
    </tr>
    <tr>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciOrdinanzaEPLC">
    <table width=35%>
   <tr>
...
<br>
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <tr>
    ...
    <tr>
      <td class="l">Data Decorrenza <br> (gg-mm-aaaa)</td>
      <td class="L">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciOrdinanzaEPLC");
