         ...
         if (retValue)
         {
            	...
            	if (ComboRigetta() || ComboIncompetenza() || ComboNDPNLP() || ComboInammissibile() )
            	{
            		...
            		if (typeof (document.InserisciOrdinanzaLiberazioneAnticipata.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>[0][0]) =="undefined" )
					{
                			...
                			{
            					if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "2130" && GiorniConcessi != 0)
          			          	{
          			              	// L.A. Normale
          			          	...
          			          	if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "2131" && GiorniConcessi_spe != 0)
          			          	{
          			          		// L.A. Speciale
          			          	...
          			          	if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>.value == "2132" && GiorniConcessi_int != 0)
          			          	{
          			          		// L.A. Integrazione
            		...
            		{	
            				...
            				{
            					if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "2130" && GiorniConcessi != 0)
          			          	{
          			              	// L.A. Normale
          			               alert("Azzerare i Giorni di L.A.! ");
          			               document.InserisciOrdinanzaLiberazioneAnticipata.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.focus();
          			          	...
          			          	if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "2131" && GiorniConcessi_spe != 0)
          			          	{
          			          		// L.A. Speciale
          			                alert("Azzerare i Giorni di L.A. SPECIALE! ");
          			                document.InserisciOrdinanzaLiberazioneAnticipata.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE%>.focus();
          			          	...
          			          	if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_OGGETTO_TENORE %>[indsel].value == "2132" && GiorniConcessi_int != 0)
          			          	{
          			          		// L.A. Integrazione
          			                alert("Azzerare i Giorni di INTEGRAZIONE L.A.! ");
          			                document.InserisciOrdinanzaLiberazioneAnticipata.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT%>.focus();
...
// >>>>>>>>>		
		...
		if(cod == 2132)
		{
			...
			var totLA = document.InserisciOrdinanzaLiberazioneAnticipata.<%=ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA%>.value;
		//	alert(" totLA = "+totLA+ " - ind_per_LA = "+ind_per_LA);
			if(ind_per_LA != 9)
			{
				if(document.InserisciOrdinanzaLiberazioneAnticipata.<%= ICostantiTenore.CAMPO_COD_ESITO_TENORE %>[ind_per_LA].value == "1230")	
				{	// concessione
