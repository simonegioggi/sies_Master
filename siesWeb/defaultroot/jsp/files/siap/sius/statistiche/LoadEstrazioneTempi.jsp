...
<html>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="c">
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font  class="label">Funzione :&nbsp;</font><font class="campo">STATISTICHE - NUMERO PROVVEDIMENTI PER PRINCIPALI INTERVALLI</font>
        </td>
      </tr>
    </table>
    <br>
  ...
  <%if(SecondoGiro !=null && SecondoGiro.equals("SI")) {%>
    ...
    <tr>
      <td>
        ...
        <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.statistiche.action.ActCreaStatisticheTempi">
      </td>
		</tr>
    <tr>
      <td>
...
<table>
    ...
    <tr>
      <td>
        ...
        <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.statistiche.action.ActLoadStatisticheTempi">
      </td>
		</tr>
    <tr>
      <td>
