...
<%@ page import="siap.sius.statistiche.model.RicercaOrdinanzaModel" %>
...
<jsp:useBean id="FiltoRicerca" scope="request" class="siap.sius.statistiche.model.RicercaOrdinanzaModel" />
...
%>
  ...
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Fogli Complementari Da Trasmettere</title>
  ...
  <table >
	...
	<td class=l>
	<a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sius.statistiche.action.ActStampaElencoProcInExcel&modalitaRicerca=FCNT"><img src="<%=IWebConstants.IMAGES_DIR%>printexcel.gif" alt="Stampa Excel" width="24" height="24" border="0">
	</a></td>
