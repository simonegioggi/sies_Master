...
<%
	...
	String lNomeFunzione = "Ricerca Ordinanze Prive di Foglio Complementare";

%>
<html>
<head>
  <title>[S.I.E.S.] - Statistiche Ricerca Ordinanze Prive di Foglio Complementare</title>
  ...
  <div id="comune" style="position: relative; top: 0; left: 0;   visibility:visible; " >     
     <div id="RicercaAvanzataDiv" style="position: absolute; top: 0; left: 0; visibility:visible; ">      
        <jsp:include page="<%=ICostantiStatistiche.DIV_RICERCA_ORD_PRIVE_DI_FC%>"/>
     </div>
  </div>
