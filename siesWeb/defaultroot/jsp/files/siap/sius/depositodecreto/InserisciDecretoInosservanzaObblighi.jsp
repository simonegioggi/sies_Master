...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Inosservanza Prescrizioni</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDecretoInosservanzaObblighi.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
    ...
    <script language="JavaScript">
      ...
      function ListaUDS(a_formname,a_fieldname)
      {
        ...
        {
          desktop = window.open("<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sico.ufficio.action.ActLoadListaDistretti&formname="+a_formname+"&fieldname="+a_fieldname, "Ricerca_Ufficio","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=370,height=500");
        }
    </script>
  </head>
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Inosservanza Obblighi/Prescrizioni</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoInosservanzaObblighi">
 ...
 <tr> <td>&nbsp;</td> </tr>
    <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaProcure('InserisciDecretoInosservanzaObblighi','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>');">
    ...
    <tr>
        ...
        <td class="l">
          ...
          <input type="hidden"  Title="Istituto" name="<%=ICostantiDepositoDecreto.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" value="" size=50>
          <a href="Javascript:ListaIstitutoDetenzione('InserisciDecretoInosservanzaObblighi','<%=ICostantiDepositoDecreto.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>','Comune');">
        <img src="/images/filefolder.gif" border=0></a></td>
    </tr>
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoInosservanzaObblighi");
