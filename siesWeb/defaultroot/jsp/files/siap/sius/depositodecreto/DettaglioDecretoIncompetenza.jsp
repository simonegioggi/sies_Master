...
<jsp:useBean id="depositodecretomodel" scope="request" class="siap.sius.depositodecreto.model.DepositoDecretoModel"/>
<jsp:useBean id="TornaQui"     scope="request" class="java.lang.String"/>

<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Incompetenza </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione : </font>
          <font class="campo">Dettaglio Decreto Incompetenza</font>&nbsp;
        </td>
...
<%
  if ( depositoDecretoMotivazioni.getDepositoDecreto().getUfficioCompetente() != null)
  {
  %>
   <tr>
     <td class="l">Ufficio Competente: </td>
     <td class="l"> <font class="campo"><%=depositoDecretoMotivazioni.getDepositoDecreto().getUfficioCompetente().getDescrTipoUfficio()%> di <%=depositoDecretoMotivazioni.getDepositoDecreto().getUfficioCompetente().getDescrComune()%> </font></td>
  </tr>
 <%}%>
  <tr>
 ...
 <%
    if (depositoDecretoMotivazioni.getDepositoDecreto().getNote() != null)
     {
 %>
        <td class="l"><font class="campo"><%=depositoDecretoMotivazioni.getDepositoDecreto().getNote()%></font></td>
      </tr>
   <%
     }
   %>
...
<%
    if( depositoDecretoMotivazioni.getMotivazioniDecreto() != null )
    {
...
<%
        ...
        if( depositoDecretoMotivazioni.getMotivazioniDecreto()[x].getAltraMotivazione() != null )
        {
%>
          <tr>
  ...
  <table>
    ...
    <tr>
      <td class="L">
       	...
       	<input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sius.depositodecreto.action.ActLoadDettaglioDecretoIncompetenza">
