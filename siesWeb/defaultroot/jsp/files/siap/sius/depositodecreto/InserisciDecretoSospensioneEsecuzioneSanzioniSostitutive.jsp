...
if (Action.trim().length() > 1)
   {
   		lAction = Action;
        lFlagOrdinanza = true;
        lFunctionName = "Emissione Ordinanza Sospensione Sanzione Sostitutiva";
   }
   else
   {
   		lAction = "siap.sius.depositodecreto.action.ActInserisciEmissioneDecretoDeposito";
        lFunctionName = "Emissione Decreto Sospensione Sanzione Sostitutiva";
   }
%>
...
<html>
  <head>
    ...
    <script language="JavaScript">
    	...
    	function Verify()
    	{
			...
			var data_inizio = document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_GIORNO_SOSPENSIONE_SS%>.value+'/'+document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_MESE_SOSPENSIONE_SS%>.value+'/'+document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_ANNO_SOSPENSIONE_SS%>.value;      		
      		var data_fine = document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_GIORNO_SCADENZA_SOSPENSIONE_SS%>.value+'/'+document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_MESE_SCADENZA_SOSPENSIONE_SS%>.value+'/'+document.InserisciDecretoSospensioneSS.<%=ICostantiDepositoDecreto.CAMPO_ANNO_SCADENZA_SOSPENSIONE_SS%>.value;
 ...
 <%
	...
	boolean chkContenuto = true;
 	...
 	if( contenuto.equalsIgnoreCase("U060") ) // Sopensione Esecuzione Sanzioni Sostitutive
 		chkContenuto = false;
