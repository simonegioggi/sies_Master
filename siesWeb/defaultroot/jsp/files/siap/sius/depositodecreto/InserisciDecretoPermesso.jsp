...
function Verify() {
    ...
    <%-- MEV_2025-48: aggiunta nuova sezione - motivo detenzione --%>
    var test = false;
    for (var i = 0; i < 2; i ++) {
	    if (document.InserisciDecretoPermesso.<%=ICostantiLicenzaLibanticipata.CAMPO_CK_COD_MOTIVO_DETENZIONE%>[i].checked) {
	    	if (i < 1)
				test = true;
	    } else
	    	test = false;
    ...
    if (test) {
    	alert("Attenzione! Scegliere 'Condannato per Delitti' oppure 'Detenuto in Regime di 41 bis'.");
		return false;
    }
  	return true;
}
...
<table>
  	<tr>
		...
		<td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Permesso</font></td>
	</tr>
	<tr>
...
<table cellspacing="2" cellpadding="2" style="width: 90%;">
	<tr>
  		<td class="l">
  			Condannato per Delitti art. 51, commi 3 bis e 3 quater c.p.p.
    		&nbsp;&nbsp;&nbsp;<input type="checkbox" name="<%=ICostantiLicenzaLibanticipata.CAMPO_CK_COD_MOTIVO_DETENZIONE%>" value="01">
    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Detenuto in Regime di 41 bis O.P.
    		&nbsp;&nbsp;&nbsp;<input type="checkbox" name="<%=ICostantiLicenzaLibanticipata.CAMPO_CK_COD_MOTIVO_DETENZIONE%>" value="02">
     	</td>
   	</tr>
</table>
<br>
