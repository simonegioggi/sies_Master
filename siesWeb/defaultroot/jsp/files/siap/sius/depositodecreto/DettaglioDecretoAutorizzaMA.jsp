...
String codOggettoProcedimento = "", tipoContenuto = "Autorizzazione su M. A.";
// recupero info sul fascicolo per oggetto procedimento
...
if ("U133".equals(codOggettoProcedimento))
	tipoContenuto = "Diffida al Puntuale Rispetto delle Prescrizioni - Pene Sostitutive";
%>

<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto <%=tipoContenuto%></title>
	...
	<tr>
        ...
        <td class="LBG">
        	<font class="label">Funzione : </font>
          	<font class="campo">Dettaglio Decreto <%=tipoContenuto%></font>&nbsp;
        </td>
