...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Sospensione Esecuzione Pena</title>
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Sospensione Esecuzione Pena</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciEmissioneDecretoSosp">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr>
      ...
      <td class="l">
        <input Title="Procura" name="<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_PROCURA_COMP%>" value="" size=35 >
