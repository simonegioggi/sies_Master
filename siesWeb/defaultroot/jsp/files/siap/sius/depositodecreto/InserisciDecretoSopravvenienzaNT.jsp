...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Sopravvenienza Nuovo Titolo</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciSopravvenienzaNT.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciSopravvenienzaNT">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr>
      ...
      <td class="l">
        ...
        <a href="Javascript:ListaProcure('InserisciSopravvenienzaNT','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>');">
    ...
    <tr>
      ...
      <td class="l">
        <input Title="<%=labelUfficioProc%>" name="<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_PROCURA_COMP%>" value="" size=35 >
            <a href="Javascript:ListaDistrettiProcure('InserisciSopravvenienzaNT','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_PROCURA_COMP%>');">
            <img src="/images/filefolder.gif" border=0> </a>
      </td>
    </tr>
    <tr>
        <td class="l">In caso di sospensione della misura indicare:</td>
    </tr>
    <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaIstitutoDetenzione('InserisciSopravvenienzaNT','<%=ICostantiDepositoDecreto.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>','Comune');">
        <img src="/images/filefolder.gif" border=0></a></td>
    </tr>
 </table>
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciSopravvenienzaNT");
