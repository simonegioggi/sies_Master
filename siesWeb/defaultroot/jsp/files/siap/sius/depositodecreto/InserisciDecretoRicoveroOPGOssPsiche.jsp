...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Ricovero OPG per Osservazione Psichiatrica</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDecretoRicoveroOPG.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
      ...
      <%
        ...
        if (Action.trim().length() > 1)
        {
           lAction = Action;
           lFlagOrdinanza = true;
           lFunctionName = "Emissione Ordinanza Ricovero OPG per Osservazione Psichiatrica";
        }
        else
        {
           lAction = "siap.sius.depositodecreto.action.ActInserisciEmissioneDecretoDeposito";
           lFunctionName = "Emissione Decreto Ricovero OPG per Osservazione Psichiatrica";
        }
      %>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoRicoveroOPG">
 ...
 <tr> <td>&nbsp;</td> </tr>
    <tr>
      <td class="l">Struttura Ospedaliera designata (OPG o altra)</td>
      <td class="l">
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoRicoveroOPG");
