...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto di Espulsione </title>
...
<script language="JavaScript" src="/html/gestisciUploadStampa.js"></script>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione : </font>
          <font class="campo">Dettaglio Decreto Espulsione</font>&nbsp;
        </td>
  ...
  <tr>
    ...
    <td class="l"><font class="campo"> <%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getAltriDestinatari(),"-")%></font></td>
  </tr>
