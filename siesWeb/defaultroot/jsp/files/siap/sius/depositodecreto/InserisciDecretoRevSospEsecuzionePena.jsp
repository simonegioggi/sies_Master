...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Revoca Sospensione Esecuzione Pena</title>
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Revoca Sospensione Esecuzione Pena</font>&nbsp;
      <%
...
<%          } %>            
        ...
        <input Title="SedeRevoca" name="<%=ICostantiDepositoDecreto.CAMPO_UFFICIO_PROC_REVOCATO%>" value="" size=35 >
            <a href="Javascript:ListaSediRevoca('InserisciEmissioneDecretoSosp','<%=ICostantiDepositoDecreto.CAMPO_UFFICIO_PROC_REVOCATO%>','<%=CodUff%>');">
            <img src="/images/filefolder.gif" border=0> </a>
      </td>
    </tr>
 </table>
