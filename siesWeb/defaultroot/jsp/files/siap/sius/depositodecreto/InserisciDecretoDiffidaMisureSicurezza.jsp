...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Diffida su Misura Sicurezza</title>
    ...
    function Verify()
    {
    	// Controllo obbligatorietà esiti
      	var lEsiti=document.InserisciDecretoDiffidaMisureSicurezza.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Diffida su Misura Sicurezza</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoDiffidaMisureSicurezza">
   ...
   <tr>
     ...
     <td class="l" width="70%"><%=DateUtils.getDateToString(data_emissione,"dd/MM/yyyy")%></td>
      ...
      <tr>
        ...
        <td class="l"><Textarea title="Note" name="<%=ICostantiDepositoDecreto.CAMPO_LUOGO_SVOLGIMENTO_PROVA%>" cols=88 rows=3></Textarea></td>
      </tr>
    </table>
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr>
      ...
      <td class="l">
        <Textarea title="Motivazioni" name="<%=ICostantiDepositoDecreto.CAMPO_NOTE%>" cols=68 rows=3></Textarea></td>
      </td>
    </tr>
    <tr>
      ...
      <td class="l">
        ...
        <a href="Javascript:ListaUDS('InserisciDecretoDiffidaMisureSicurezza','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>');">
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoDiffidaMisureSicurezza");
