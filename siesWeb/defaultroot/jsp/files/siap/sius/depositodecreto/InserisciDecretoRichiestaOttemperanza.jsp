...
<html>
  <head>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDecretoOttemperanza.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
...
<body class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Richiesta Ottemperanza</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoOttemperanza">
    ...
    <table cellspacing="2" cellpadding="2">
      ...
      <tr>
        ...
        <td class="l">
          <input Title="Tribunale" name="<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>" value="" size=35 >
          <a href="Javascript:ListaProcure('InserisciDecretoOttemperanza','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>');">
      ...
      <tr>
        ...
        <td class="l">
          <input Title="Magistrato" name="<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>" value="" size=35 >
          <a href="Javascript:ListaUDS('InserisciDecretoOttemperanza','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>');">
          <img src="/images/filefolder.gif" border=0></a>
        </td>
      </tr>
    </table>
    ...
    <table cellspacing="2" cellpadding="2">
      <tr> <td>&nbsp;</td> </tr>
      <tr>
        <td class="l">Nomina Commissario ad Acta <input type="checkbox" value="S" name="<%=ICostantiDepositoDecreto.CAMPO_FLAG_NOMINA_COMM_ACTA%>"></td>
        <td class="l">Descrizione <input type="text" name="<%=ICostantiDepositoDecreto.CAMPO_DESCR_COMM_ACTA%>" maxlength="500" size="70"></td>
      </tr>
    </table>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoOttemperanza");
