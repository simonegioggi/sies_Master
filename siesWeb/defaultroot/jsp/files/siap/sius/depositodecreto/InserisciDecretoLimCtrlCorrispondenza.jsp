...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Limitazioni e controlli della corrispondenza</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDecretoLimCrtlCorrispondenza.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
      var lDurataProroga = document.InserisciDecretoLimCrtlCorrispondenza.<%=ICostantiDepositoDecreto.CAMPO_DURATA_PROROGA%>.value;
      var ritorno = VerifyCombo(lEsiti,"Esito");

			// Verifica se l'esito è PROROGA, al fine di obbligare la comnpilazione
			// del campo Durata della Proroga.
			if( lEsiti.value == "1222" && lDurataProroga.length == 0 )
			{
				alert('Il campo durata proroga è obbligatorio !');
				return false;
			}
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione : </font><font class="campo">Emissione Decreto Limitazioni e controlli della corrispondenza</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoLimCrtlCorrispondenza">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <table cellspacing="2" cellpadding="2">
    	...
    	<tr>
				<td>In caso di proroga, indicare :</td>
			</tr>

			<tr>
      	<td class="l">Durata della proroga(*) </td>
      	<td class="l">
        	<input Title="Durata proroga" name="<%=ICostantiDepositoDecreto.CAMPO_DURATA_PROROGA%>" value="" size="35" >
      	</td>
			</tr>

			<tr>
				<td class="l">Nuova scadenza limitazioni/controllo </td>
      	<td class="l">
      		<input Title="Nuova scadenza limitazione/controlli" name="<%=ICostantiDepositoDecreto.CAMPO_NUOVA_SCADENZA_LIM_CTRL%>" value="" size="35" >
      	</td>
			</tr>
    	...
    	<tr>
			...
			<tr>
  			...
  			<td class="l">
    			...
    			<a href="Javascript:ListaProcure('InserisciDecretoLimCrtlCorrispondenza','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>');">
    	...
    	<tr>
      	...
      	<td class="l">
        	...
        	<a href="Javascript:ListaUDS('InserisciDecretoLimCrtlCorrispondenza','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_MAGISTRATO_COMP%>','<%=CodUff%>');">
        	<img src="/images/filefolder.gif" border=0></a></td>
      	</td>
    	</tr>
 		</table>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoLimCrtlCorrispondenza");
