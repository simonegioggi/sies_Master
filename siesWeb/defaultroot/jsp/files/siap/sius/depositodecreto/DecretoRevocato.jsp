...
<jsp:include page="<%=ICostantiFascicoloSius.PG_SINTESIPROCEDIMENTOORIGINESIUS%>">
 <jsp:param name="Titolo" value="Dati del Decreto Revocato" />
 </jsp:include>
<table>
    <td class="l"> Tipo di Decreto</td>
    <td class="l"> <font class="campo"><%=StringUtils.toStringJSP(decretoRevocato.getDescrTipoDecreto())%>
</font></td>
  </tr>
  <tr>
...
<%            if (lLic.getFlagScorta().toUpperCase().compareTo( "N") == 0)
                {%><td class="l"><font class="campo"> No</td></font><%}
              else{%><td class="l"><font class="campo"> Si</td></font><%}%>
          </tr>
          <tr>
            <td class="l">Motivazione provvedimento</td>
            <td class="l"><font class="campo">  <%=StringUtils.toStringJSP(decretoRevocato.getNote(),"-")%></font></td>
          </tr>
<%
        }
%>
