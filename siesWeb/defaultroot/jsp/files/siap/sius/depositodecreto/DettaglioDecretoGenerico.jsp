...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Generico </title>
...
<%
if (depositoDecretoMotivazioni.getDepositoDecreto().getCodTipoDecreto().compareTo(ICostantiDepositoOrdinanzaPc.RICHIESTA_OTTEMPERANZA) == 0) {
%>
    		<font class="campo">Dettaglio Decreto Richiesta Ottemperanza</font>
<%
} else {
%>
   			<font class="campo">Dettaglio Decreto Generico</font>
<%
}
%>
		</td>
...
<table cellspacing=4 cellpadding=4 width=95%>
    ...
    <tr>
<%
// MEV_66: per questi motivi minorili 
if (depositoDecretoMotivazioni.getEvento() != null
		&& ("2782".equals(depositoDecretoMotivazioni.getEvento().getCodMotivo())
				|| "2783".equals(depositoDecretoMotivazioni.getEvento().getCodMotivo())
				|| "2784".equals(depositoDecretoMotivazioni.getEvento().getCodMotivo()))) {
	String descrTipoUff = labelUfficioSorv;
	if (depositoDecretoMotivazioni.getDepositoDecreto() != null
			&& depositoDecretoMotivazioni.getDepositoDecreto().getCodUfficioCompetente() != null) {
		UfficioModel um = UfficioUtils.getUfficioByCodUfficio(depositoDecretoMotivazioni.getDepositoDecreto().getCodUfficioCompetente());
		descrTipoUff = um.getDescrTipoUfficio();
	}
%>
      	<td class="l"><%=descrTipoUff%> Competente</td>
<%
} else {
%>
...
<%
	if ("S".equals(depositoDecretoMotivazioni.getDepositoDecreto().getFlagNominaComActa())) {
%>
...
%>      
    ...
    <tr>
      	...
      	<td class="l"><font class="campo"><%=StringUtils.toStringJSP( depositoDecretoMotivazioni.getDepositoDecreto().getDescrCommActa(), "-")%></font></td>
    </tr>
<%
}
%>
