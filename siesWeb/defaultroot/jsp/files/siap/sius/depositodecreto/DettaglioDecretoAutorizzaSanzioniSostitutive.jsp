...
String descrContenuto = "pene sostitutive"; // U128
String contenuto = fascicoloSiusGP.getGeneraleProcedimentoModel().getCodOggettoProcedimento();
if ("U059".equals(contenuto)) {
	descrContenuto = "sanzioni sostitutive"; // U059
}
%>

<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Autorizzazione su <%=descrContenuto%></title>
...
<table>
	<tr>
		...
		<td class="LBG"><font class="label">Funzione : </font>
			<font class="campo">Dettaglio Decreto Autorizzazione su <%=descrContenuto%></font>
		</td>
...
<table cellspacing="4" cellpadding="4" width="95%">
	<tr>
  	...
  	<tr>
	    ...
	    <td class="l">
	    	<font class="campo"><%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getLuogoSvolgimentoProva(), "-")%></font>
	    </td>
  	</tr>
  	<tr>
	    <td class="l"><%=labelUfficio%> Competente</td>
	    <td class="l">
	    	<font class="campo"><%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getDescrUfficioCompetente(), "-")%></font>
	    </td>
  	</tr>
  	<tr>
    	<td colspan="2">&nbsp;</td>
...
<jsp:include page="<%=ICostantiPrescrizione.PG_INCLUDE_PRESCRIZIONI%>">
	...
	<jsp:param name="SanzioneSostitutiva" value="pippo"/>
</jsp:include>
