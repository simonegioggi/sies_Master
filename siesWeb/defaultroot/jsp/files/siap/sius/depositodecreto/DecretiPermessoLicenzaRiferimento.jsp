...
<% if (decreti.size() > 0 )
   {
     DepositoDecretoFascicoloLicenzeModel primoElemento = 
    	 (DepositoDecretoFascicoloLicenzeModel) decreti.get(0);
%>
...
<table>
    <tr>
      <td class="Titolo" colspan=6>Dettaglio Del Decreto Permesso/Licenza di Riferimento</td>
    </tr>
...
%>
          ...
          <tr>
            <td class="l">Luogo fruizione / Oggetto </td>
