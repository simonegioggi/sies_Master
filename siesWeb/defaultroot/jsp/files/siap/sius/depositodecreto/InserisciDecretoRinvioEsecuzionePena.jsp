...
<html>
<head>
<title>[S.I.E.S.] - Emissione Decreto per Rinvio Esecuzione Pena<%=tipoContenuto%></title>
...
<table>
	<tr>
	    ...
	    <td class=LBG>
	    	<font class="label">Funzione : </font><font class="campo">Emissione Decreto per Rinvio Esecuzione Pena<%=tipoContenuto%></font>
	    </td>
    </tr>
    <tr>
...
if ("U139".equals(contenuto)) {
%>
<table cellspacing="2" cellpadding="2" style="width: 90%;">
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td class="l">Pena Pecuniaria Convertita:&nbsp;&nbsp;&nbsp;
	        <input type="text" size="10" maxlength="7" Title="Pena Pecuniaria Convertita" value=""
	        	name="<%=ICostantiDepositoDecreto.CAMPO_INTERO_PENA_PECUNIARIA_CONVERTITA%>"
	        ...
	        <input type="text" size="2" maxlength="2" Title="Pena Pecuniaria Convertita" value=""
	        	name="<%=ICostantiDepositoDecreto.CAMPO_DECIMALE_PENA_PECUNIARIA_CONVERTITA%>"
	        	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
	        &euro;
    	</td>
    </tr>
...
<table cellspacing="2" cellpadding="2" style="width: 90%;">
    ...
    <tr><td>&nbsp;</td></tr>
    <tr>
		<td class="l" colspan="2">Controllo tramite mezzi elettronici&nbsp;<input value="E" type="checkbox" name="<%=ICostantiDepositoDecreto.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>" onClick="javascript:updateCkCtrlE()"/> 
			&nbsp;&nbsp;&nbsp;Controllo tramite altri strumenti tecnici&nbsp;<input value="T" type="checkbox" name="<%=ICostantiDepositoDecreto.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>" onClick="javascript:updateCkCtrlT()"/> 
		</td>
    </tr>
</table>
<table cellspacing="2" cellpadding="2" style="width: 90%;">
