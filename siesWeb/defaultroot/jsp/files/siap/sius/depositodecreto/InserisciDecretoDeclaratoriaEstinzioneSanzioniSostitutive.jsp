...
<%
	...
	if (Action.trim().length() > 1)
  {
  	lAction = Action;
    lFlagOrdinanza = true;
    lFunctionName = "Emissione Ordinanza Declaratoria Estinzione Sanzioni Sostitutive";
  }
  else
  {
  	lAction = "siap.sius.depositodecreto.action.ActInserisciEmissioneDecretoDeposito";
    lFunctionName = "Emissione Decreto Declaratoria Estinzione Sanzioni Sostitutive";
  }
%>
