...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Modifica Attività Lavorativa / Luogo Detenzione </title>
...
%>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione : </font>
          <font class="campo">Dettaglio Decreto Modifica Attività Lavorativa / Luogo Detenzione</font>&nbsp;
        </td>
  ...
  <tr>
    <td class="l">Attività lavorativa / Luogo Detenzione</td>
  ...
  <tr>
    <td class="l">Status Libertà Personale raggiungimento detenzione domiciliare</td>
