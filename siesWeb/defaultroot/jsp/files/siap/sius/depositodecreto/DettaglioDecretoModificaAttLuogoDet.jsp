...
if ("U129".equals(codOggettoProcedimento)) {
	tipoDecreto = "Modifica Modalit&agrave; di Esecuzione / Luogo Esecuzione Pene Sostitutive";
	tipoAttivita = "Modalit&agrave; esecuzione";
	tipoDetenzione += " sostitutiva";
}
%>

<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto <%=tipoDecreto%></title>
	...
	<tr>
        ...
        <td class="LBG">
        	<font class="label">Funzione : </font>
          	<font class="campo">Dettaglio Decreto <%=tipoDecreto%></font>
        </td>
...
<table cellspacing=4 cellpadding=4 width=95%>
	...
	<tr>
		<td class="l"><%=tipoAttivita%> / Luogo Detenzione</td>
	...
	<tr>
		<td class="l">Status Libert&agrave; Personale raggiungimento <%=tipoDetenzione%></td>
	...
	<tr>
		<td class="l">Numero massimo ore per raggiungimento luogo esecuzione</td>
		<td class="l"><font class="campo"><%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getTotOreRaggiungimento())%></font></td>
	</tr>
