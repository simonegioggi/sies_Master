...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Proposta Declaratoria Esito Pena</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDeclarProposta.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Proposta Declaratoria Esito Pena</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDeclarProposta">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr>
      ...
      <td class="l">
        ...
        <a href="Javascript:ListaProcure('InserisciDeclarProposta','<%=ICostantiDepositoDecreto.CAMPO_COD_UFFICIO_TDS_COMP%>');">
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDeclarProposta");
