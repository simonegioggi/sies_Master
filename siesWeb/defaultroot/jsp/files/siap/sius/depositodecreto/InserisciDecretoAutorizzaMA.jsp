...
String tipoContenuto = "Autorizzazione su M. A.";
if ("U133".equals(contenuto))
	tipoContenuto = "Diffida al Puntuale Rispetto delle Prescrizioni - Pene Sostitutive";
...
<html>
<head>
<title>[S.I.E.S.] - Emissione Decreto <%=tipoContenuto%></title>
...
<table>
	<tr>
		<td class="LBG">
      	...
      	<td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto <%=tipoContenuto%></font>
      </td>
    </tr>
    <tr>
...
<table cellspacing="2" cellpadding="2">
    ...
    <tr>
      	...
      	<td class="l">
        	<Textarea title="Motivazioni" name="<%=ICostantiDepositoDecreto.CAMPO_LUOGO_SVOLGIMENTO_PROVA%>" cols="68" rows="3"></Textarea>
      	</td>
    </tr>
<%
// MEV_2023-35: aggiunto controllo preventivo di esclusione sezioni
if (!"U133".equals(contenuto)) {
%>
    <tr>
