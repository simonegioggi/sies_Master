...
<html>
<head>
<title>[S.I.E.S.] - Emissione Decreto Autorizzazione su <%=descrContenuto%></title>
...
function Verify() {
	// Controllo obbligatorieta' esiti
...
<table>
	<tr>
		<td class="LBG">
      	...
      	<td class=LBG>
      		<font class="label">Funzione : </font><font class="campo">Emissione Decreto Autorizzazione su <%=descrContenuto%></font>&nbsp;
		</td>
	</tr>
    <tr>
