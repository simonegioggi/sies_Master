...
// Flag che indica la presenza del fascicolo origine;
  boolean isFascicoloOrigine = (fascicolo_origine.getFascicoloSiusModel().getIdFascicoloSius() != null) ? true : false;
...
<%
  // Imposta varibabili 
  String lAction = "siap.sius.depositodecreto.action.ActInserisciEmissioneDecretoDeposito";
  String lFunctionName = "Emissione Decreto Revoca Autorizzazione / Modifica Prescrizioni Pena Sostitutiva";
%>
...
<html>
  <head>
    ...
    function updateCkCtrlE() {
      if ( document.InserisciRevoAutorizSS.<%=ICostantiDepositoOrdinanzaPc.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>[0].checked==true ) {
        document.InserisciRevoAutorizSS.<%=ICostantiDepositoOrdinanzaPc.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>[1].checked=false;
      } 
    }
      
    function updateCkCtrlT() {
      if ( document.InserisciRevoAutorizSS.<%=ICostantiDepositoOrdinanzaPc.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>[1].checked==true ) {
        document.InserisciRevoAutorizSS.<%=ICostantiDepositoOrdinanzaPc.CAMPO_CK_TIPO_CONTROLLO_ESECUZIONE%>[0].checked=false;
      } 
    }
    </script>
  </head>
...
<body class="corpo">
  <table>
    <tr>
      ...
      <td class=LBG><font class="label">Funzione : </font><font class="campo"><%=lFunctionName%></font>&nbsp;</td>
    </tr>
    <tr>
