...
String nomeFunzione = "Dettaglio Decreto di Revoca Decreto";
String nomeCampoGiorni = "Periodo revocato";
String pgDecretoRif = ICostantiDepositoDecreto.PG_SINTESI_DECRETO_REVOCATO;
%>

<html>
<head>
<title>[S.I.A.P.] - Dettaglio Decreto Revoca Decreto </title>
...
<table>
<tr>
 <td class="l" > <font color="red"> Mancano i dati relativi al Decreto Revocato !</font> </td>
</tr>
<% }%>
<br>
