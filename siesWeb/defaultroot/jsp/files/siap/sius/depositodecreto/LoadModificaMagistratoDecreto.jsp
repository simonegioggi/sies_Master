...
<html>
  ...
  <script language="JavaScript">
    ...
    function Verifica() {
      	if (document.LoadModificaMagistratoDecreto.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value == "") {
          alert('Scegliere il Magistrato Relatore selezionando un magistrato!');
          return false;
      	}
      	if (document.LoadModificaMagistratoDecreto.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value != CodMag
          	&& document.LoadModificaMagistratoDecreto.<%=ICostantiMagistrato.CAMPO_COD_MAGISTRATO %>.value != "") {
          document.LoadModificaMagistratoDecreto.magistratoMod.value='YES';
        }
  ...
  <body class="corpo">  
	  <table>
	    <tr> 
	      <td class="LBG">
	        ...
	        <font class="campo">Modifica Magistrato Decreto </font>
	      </td>
	      <!-- BOTTONE DI RITORNO -->
    ...
    <% 
    	// preleva l'id evento da riportare in avanti nella action chiamata.
    	String lIdEventoGenerato = (String)request.getParameter("IdEvento");
   		String lAzione = new String();
     	if( modalita.equals("M") ) {
       	lAzione = "siap.sius.depositodecreto.action.ActModificaMagistratoDecreto";      
    %>
    <%
      }
    %>
  ...
  <br>
  <FORM method="POST" name="LoadModificaMagistratoDecreto" action="<%= IWebConstants.PG_MAIN%>">
...
<% if(utente.getUfficioUtente().getCodTipoUfficio().compareTo("TDS") == 0 )
   {%>
    <tr>
      <td class="L" >
        <a href="Javascript:chiamaLista('LoadModificaMagistratoDecreto');">
...
<% }else{%>
    <tr>
      <td class="L" >
        <a href="Javascript:chiamaListaSingola('LoadModificaMagistratoDecreto');">
					Seleziona dalla lista <img src="/images/filefolder.gif" border="0">
        </a>
      </td>
    </tr>
<% }%>
    ...
    <input type="HIDDEN" name="<%=ICostantiDepositoDecreto.CAMPO_ID_EVENTO_GENERATO%>" value="<%=lIdEventoGenerato%>" >
