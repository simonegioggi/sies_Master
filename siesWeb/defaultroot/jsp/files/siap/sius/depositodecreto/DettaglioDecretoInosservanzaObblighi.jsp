...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Ricovero OPG per Osservazione Psichiatrica </title>
...
%>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione : </font>
          <font class="campo">Dettaglio Decreto Inosservanza Prescrizioni</font>&nbsp;
        </td>
  ...
  <tr>
    ...
    <td class="l">
    <%if (depositoDecretoMotivazioni.getDepositoDecreto().getDescrTdsComp().trim().length() > 1) {%>
       <%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getDescrTdsComp(),"-")%>
    <%}else { %> -
    <%}%>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="l">
    <%if (istitutodetenzione.getIdIstitutoDetenzione().trim().length() > 1) {%>
