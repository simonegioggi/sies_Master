...
if ("U135".equals(codOggettoProcedimento))
	tipoContenuto = " Pene Sostitutive";
%>

<html>
<head>
<title>[S.I.A.P.] - Dettaglio Decreto Licenza<%=tipoContenuto%></title>
...
<table>
	<tr>
        ...
        <td class="LBG">
			...
			<font class="campo">Dettaglio Decreto Licenza<%=tipoContenuto%></font>
        </td>
