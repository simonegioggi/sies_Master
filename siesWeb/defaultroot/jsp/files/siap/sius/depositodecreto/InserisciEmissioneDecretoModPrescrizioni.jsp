...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto per Modifica Prescrizioni </title>
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto di Modifica Prescrizioni</font>&nbsp;
      <%
