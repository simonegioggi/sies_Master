...
<html>
<head>
  <title>[S.I.E.S.] - Dettaglio Deposito Decreto </title>
  ...
  <body class="corpo">
    <table>
      <tr>
        ...
        <td class=LBG><font class="label">Funzione : </font><font class="campo">Dettaglio Deposito Decreto</font>&nbsp;
<%
...
%>    
		<td class="LBG">
    	<a href="/jsp/Main.jsp?Action=siap.sius.depositodecreto.action.ActLoadInserisciDataDepositoDecreto&Aggiungi=yes&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoDecreto.getIdEventoGenerato()%><%=retParam%>">
      	<img  align="middle" src="/images/new24.gif" alt="Iscrizione Altri Destinatari" width="24" height="24" border="0">
      </a>
    </td>

    <td class="LBG">
    	<a href="/jsp/Main.jsp?Action=siap.sius.depositodecreto.action.ActLoadModificaDataDepositoDecreto&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoDecreto.getIdEventoGenerato()%>&Aggiungi=yes<%=retParam%>">
      	<img  align="middle" src="/images/modifica24.gif" alt="Modifica Deposito Decreto" width="24" height="24" border="0">
      </a>
    </td>
<%
	}
...
%>
    ...
    <td class="LBG">
    	<a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sius.depositodecreto.action.ActLoadTrasferisciDecreto&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoDecreto.getIdEventoGenerato()%>">
...
%>
			...
			<td class="LBG">
					<a href="/jsp/Main.jsp?Action=siap.sico.webservice.action.ActUDSTrasferimentoEsecuzione&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=depositoDecreto.getIdEventoGenerato()%>&IdDocumentoAllegato=<%=documentoAllegato.getIdDocumentoAllegato()%>">
...
<table cellspacing=4 cellpadding=4>
  <tr>
    <td>&nbsp;</td>
    <input Title="Id Evento" type="hidden" name="<%= ICostantiEvento.CAMPO_ID_EVENTO %>" value="<%=depositoDecreto.getIdEventoGenerato()%>" >
  </tr>

  <tr>
    <td class="l"> Anno / Numero del Decreto</td>
    <td class="l"> <font class="campo"> <%=StringUtils.toStringJSP(depositoDecreto.getAnnoS72())%> / <%=StringUtils.toStringJSP(depositoDecreto.getNumS72())%></font></td>
  </tr>
  <tr>
    <td class="l"> Data Emissione</td>
    <td class="l"> <font class="campo"> <%=DateUtils.getDateToString(depositoDecreto.getDataEmissione(),"dd/MM/yyyy")%></font></td>
  </tr>
  <tr>
 ...
 <div align=left style="visibility:hidden" id="upld">
 	<FORM name="comandi" enctype="multipart/form-data" method="post">
      ...
      <td class="L">
          ...
          <input type="HIDDEN" name="<%=ICostantiDocumentoAllegato.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.sius.depositodecreto.action.ActLoadDettaglioDataDepositoDecreto">
          <input type="HIDDEN" name="FlagAvvocatura" value="<%=ICostantiAvvisiAvvocato.DEPOSITO_DECRETO%>">
          <input type="HIDDEN" name="<%= ICostantiEvento.CAMPO_ID_EVENTO %>" value="<%=depositoDecreto.getIdEventoGenerato()%>" >
