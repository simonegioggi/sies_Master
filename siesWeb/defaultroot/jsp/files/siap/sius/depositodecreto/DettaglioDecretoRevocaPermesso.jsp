...
{
  nomeFunzione = "Dettaglio Decreto Esclusione Computo Licenza";
  nomeCampoGiorni = "Periodo scomputato";
...
%>
    ...
    <tr>
      ...
      <td class="l"> giorni:  &nbsp; <font class="campo"> <%=StringUtils.toStringJSP(revoca.getNumeroGiorni(), "-")%></font>
                     ore:  &nbsp; <font class="campo"> <%=StringUtils.toStringJSP(revoca.getNumeroOre(), "-")%></font>
      </td>
    </tr>
    <tr>
      <td class="l"><%=labelUfficioProc%></td>
      <td class="l"> <font class="campo"> <%=depositoDecretoMotivazioni.getDepositoDecreto().getDescrProcuraEsecuzione()%> </font>
      </td>
    </tr>
