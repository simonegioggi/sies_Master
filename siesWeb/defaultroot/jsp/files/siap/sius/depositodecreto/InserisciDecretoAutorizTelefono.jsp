...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto Autorizzazione Corrispondenza Telefonica</title>
    ...
    function Verify()
    {
      var lEsiti=document.InserisciDecretoAutorizTelefono.<%=ICostantiTenore.CAMPO_COD_ESITO_TENORE%>;
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto Autorizzazione Corrispondenza Telefonica</font>&nbsp;
<%
...
%>
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciDecretoAutorizTelefono">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr><td>&nbsp;</td></tr>
      <tr>
        <td class="l">Oggetto autorizzazione:</td>
 ...
 <table cellspacing="2" cellpadding="2" style="width: 90%;">
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("InserisciDecretoAutorizTelefono");
