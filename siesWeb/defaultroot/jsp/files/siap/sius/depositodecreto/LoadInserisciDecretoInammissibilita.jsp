...
<html>
<head>
  <title>[S.I.E.S.] - Emissione Decreto Inammissibilità</title>
...
/*    var contenuto=document.LoadInserisciDecretoInammissibilita.<%= ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>[document.LoadInserisciDecretoInammissibilita.<%= ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.selectedIndex].value;
    if(contenuto =="-")
    {
...
*/
    ...
    var dataEmissione=document.LoadInserisciDecretoInammissibilita.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value +'/'+
                      document.LoadInserisciDecretoInammissibilita.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value +'/'+
                      document.LoadInserisciDecretoInammissibilita.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value;
...
<%
        ...
        lAzione = "siap.sius.depositodecreto.action.ActInserisciDecretoInammissibilita";
%>
        <font class="campo">Emissione Decreto Inammissibilità</font>
      </td>
    ...
    <jsp:include page="<%=ICostantiMagistratoRelatore.PG_SINTESIMAGISTRATORELATORE%>">
          <jsp:param name="MagRelRitorno" value="siap.sius.depositodecreto.action.ActLoadInserisciDecretoInammissibilita"/>
    </jsp:include>
    </tr>

  </table>

  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadInserisciDecretoInammissibilita">
    ...
    <tr>
      <td class="l">Oggetto<font class="ob">(*)</font></td>
        <td class="l">
          ...
          <a href="Javascript:ListaOggetti('LoadInserisciDecretoInammissibilita',document.LoadInserisciDecretoInammissibilita.<%=ICostantiFascicoloSius.CAMPO_COD_CONTENUTO%>.value, '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciDecretoInammissibilita.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciDecretoInammissibilita.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
         <img src="/images/fileselected.gif" title="Oggetti per il Contenuto selezionato" border=0></a>
          &nbsp;
          <a href="Javascript:ListaOggetti('LoadInserisciDecretoInammissibilita','-', '<%= ICostantiFascicoloSius.CAMPO_DESCR_OGGETTO %>', '<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>', '<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>', document.LoadInserisciDecretoInammissibilita.<%=ICostantiFascicoloSius.CAMPO_COD_OGGETTO%>.value, document.LoadInserisciDecretoInammissibilita.<%=ICostantiFascicoloSius.CAMPO_COD_DETTAGLIO_OGGETTO%>.value );">
          <img src="/images/filefolder.gif" title="Elenco di tutti gli Oggetti Selezionabili" border=0></a>
        </td>
    </tr>

    <tr>
      <td class="l">Indicare eventuali sentenze di riferimento</td>
      <td class="L">
        <TEXTAREA title="sentenze" name="<%= ICostantiDepositoDecreto.CAMPO_SENTENZA_RIFERIMENTO%>" cols=90 rows=5 ></textarea>
     </td>
    </tr>

    <tr>
      <td width=24% class="l">Indicare eventuali destinatari oltre l'interessato</td>
      <td class="L">
        <TEXTAREA title="destinatari" name="<%= ICostantiDepositoDecreto.CAMPO_ALTRI_DESTINATARI%>" cols=90 rows=5 ></textarea>
     </td>
    </tr>
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    var frmvalidator = new Validator("LoadInserisciDecretoInammissibilita");
