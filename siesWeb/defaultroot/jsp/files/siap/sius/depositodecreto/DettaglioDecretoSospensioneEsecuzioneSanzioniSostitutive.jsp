...
else if ("U137".equals(codOggettoProcedimento))
	tipoSostituzione = "Lavoro Pubblica Utilit&agrave; Sostitutivo";
%>

<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Sospensione Esecuzione <%=tipoSostituzione%></title>
...
<table>
	<tr>
        ...
        <td class="LBG">
        	...
        	<font class="campo">Dettaglio Decreto Sospensione Esecuzione <%=tipoSostituzione%></font>
        </td>
...
if (depositoDecretoMotivazioni.getDepositoDecreto().getFlagRecuperoSS() != null
		&& depositoDecretoMotivazioni.getDepositoDecreto().getFlagRecuperoSS().equals("S")) {
%>
   	<tr>
...
if (PeriodoAltraSanzione != null && PeriodoAltraSanzione.getIdPeriodoAltraSanzione() != null) {
	// MEV_2023-35: diversifico per contenuto = codice Oggetto Procedimento
	String finale = "a";
	if ("U137".equals(codOggettoProcedimento))
		finale = "o";
%>
	<tr>
		<td colspan="2">&nbsp;</td>
	...
	<tr>
		<td class="l"><%=tipoSostituzione%> Espiat<%=finale%></td>
	...
	<tr>
		<td class="l"><%=tipoSostituzione%> Residu<%=finale%> da Espiare</td>
