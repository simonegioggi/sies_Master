...
<html>
<head>
<title>[S.I.E.S.] - Emissione Decreto <%=tipoDecreto%></title>
...
// STUB 21/07/2004 Controllo obbligatorieta' esiti.
function Verify() {
...
<table>
	<tr>
		<td class="LBG">
      	...
      	<td class=LBG>
      		<font class="label">Funzione : </font><font class="campo">Emissione Decreto <%=tipoDecreto%></font>
      	</td>
	</tr>
    <tr>
...
<table cellspacing="2" cellpadding="2" style="width: 90%;">
	<tr><td>&nbsp;</td></tr>
    <tr>
      	<td class="l"><%=tipoAttivita%> / Luogo esecuzione </td>
      	<td class="l">
    ...
    <tr>
      	<td class="l">Stato Libert&agrave; Personale raggiungimento <%=tipoDetenzione%></td>
		<td class="l" colspan="2">
