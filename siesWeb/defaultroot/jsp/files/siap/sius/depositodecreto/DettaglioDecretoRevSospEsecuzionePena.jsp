...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Decreto Revoca Sospensione Esecuzione Pena </title>
...
%>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione : </font>
          <font class="campo">Dettaglio Decreto Revoca Sospensione Esecuzione Pena</font>&nbsp;
        </td>
 ...
 <td class="l"> Rif. procedimento revocato </td>
    <td class="l"><font class="campo"> <%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getAnnoProcRevocato(),"-")%>/<%=StringUtils.toStringJSP(depositoDecretoMotivazioni.getDepositoDecreto().getProgrProcRevocato(),"-")%> </font></td>
  </tr>
 <tr>
 <td class="l"> Sede procedimento revocato</td>
