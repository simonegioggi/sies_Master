...
<html>
  ...
  <body class="corpo">
    <FORM name="comandi" >
      ...
      <!-- TOOLBAR HEADER -->
      <td class="LBG">
          <jsp:include page="<%=ICostantiDepositoDecreto.PG_TOOLBAR_HEADER%>">
...
%>
  ...
  <br>
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ConfermaPresaInCaricoDecreto">
  <table cellspacing=2 cellpadding=2 width="70%">
<!--------------------- EVENTO ---------------------->
...
%>
  <table cellspacing=2 cellpadding=2 width=95%>
      ...
      <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.depositodecreto.action.ActConfermaPresaInCarico">
