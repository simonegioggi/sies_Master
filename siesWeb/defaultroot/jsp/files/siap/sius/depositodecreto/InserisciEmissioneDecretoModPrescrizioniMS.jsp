...
<html>
  <head>
    <title>[S.I.E.S.] - Emissione Decreto per Modifica Prescrizioni Misura Sicurezza</title>
  ...
  <body class="corpo">
    ...
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class=LBG><font class="label">Funzione : </font><font class="campo">Emissione Decreto di Modifica Prescrizioni Misura Sicurezza</font>&nbsp;
      <%
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="InserisciEmissioneDecretoSosp">
   ...
   for (int i=0; i< tenori.length;i++)
    ...
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td class="l">Nuova Prescrizione</td>
        <td class="l"><Textarea name="<%=ICostantiPrescrizione.CAMPO_DESCR_ALTRA_PRESCRIZIONE%>" cols=88 rows=3></Textarea></td>
    </tr>
 </table>
