...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Richiesta Ricevuta</title>
    ...
    <FORM name="comandi" >
      <table>
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          ...
          <!-- BOTTONE DI STAMPA -->
     			<td class="LBG">
      			<a href="Javascript:stampaSius('siap.sius.presaincarico.action.ActVisualizzaRichiestaSiepeRicevuta&IdMessaggio=<%=Messaggio.getIdMessaggio()%>')" >
        			<img  align="middle" src="/images/print24.gif" alt="Stampa Attività ricevuta" width="24" height="24" border="0">
      			</a>
     			</td>
...
%>
  <table cellspacing=2 cellpadding=2 width=85%>
    ...
    <tr><td class="Titolo" colspan=4>Richiesta</td></tr>
 		<tr>
   		<td class="L">
				<font class="l">Data Richiesta</font>
				<font class="campo">
					<%=DateUtils.getDateToString(richiesta.getDataRichiesta(),"dd-MM-yyyy")%> 
				</font>
    	</td>
    </tr>
		<tr>
			<td class="L">
      	<font class="l">Tipo Richiesta</font>
        <font class="campo"><%=richiesta.getDescrTipoRichiesta()%></font>
      </td>
		</tr>
		<tr>
  		<td class="L">
				<font class="l">Presentata da</font>
				<font class="campo"><%=StringUtils.toStringJSP( richiesta.getDescrTipoRichiedente())%></font>
    	</td>
		</tr>
		<!-- Sezione dati del Fascicolo SIUS -->
...
<%  if ((FascicoloSiepeEsteso.getFascicoloSius().getFascicoloSiusModel().getChiaveAnnoSIEP())!=null)
  ...
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ConfermaPresaInCaricoAttivita">  
  	...
  	<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.presaincarico.action.ActConfermaPresaInCaricoRichiestaSiepe">
