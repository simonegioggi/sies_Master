...
// jps SIES!! di presa in carico atti ricevuti per competenza (CUMULO)
      ...
      <table>
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          <td class="LBG">
            ...
            <font class="campo">Presa in carico Atto Ricevuti per Competenza</font>
          </td>
...
%>
  ...
  <form name="confermaSubmit">
    <table> 
      <tr>
        <td> 
            <input class="bottone"  value="salva" type="submit">
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="<%=actionConferma%>">
