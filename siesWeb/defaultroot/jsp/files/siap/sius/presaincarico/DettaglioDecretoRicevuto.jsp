...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Decreto Ricevuto </title>
      ...
      <table>
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Decreto Ricevuto</font>
          </td>
         </tr>
      </table>
    </FORM>
...
%>
  ...
  <br>
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ConfermaPresaInCaricoDecreto" onSubmit="document.ConfermaPresaInCaricoDecreto.but.disabled=true;">
  <table cellspacing=2 cellpadding=2 width="85%">

    <tr><td class="Titolo" colspan=4>Decreto</td></tr>
    <tr>
  ...
  <table cellspacing=2 cellpadding=2 width=95%>
      ...
      <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.presaincarico.action.ActConfermaPresaInCaricoDecreto">
