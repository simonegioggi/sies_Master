    ...
    <FORM name="comandi" >
      <table>
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          ...
          <!-- BOTTONE DI STAMPA -->
     			<td class="LBG">
      			<a href="Javascript:stampaSius('siap.sius.presaincarico.action.ActVisualizzaAttivitaRicevuta&IdMessaggio=<%=Messaggio.getIdMessaggio()%>')" >
...
%>
  <table cellspacing=2 cellpadding=2 width=85%>
    ...
    <!-- 02/07/2007 prevista assenza Dati SIUS -->
...
<%	if(FascicoloSiepeEsteso.getFascicoloSius() != null)
  ...
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ConfermaPresaInCaricoAttivita">
  	...
  	<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.presaincarico.action.ActConfermaPresaInCaricoAttivitaSiepe">
