...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Relazione di Richiesta Ricevuta</title>
      ...
      <table>
        <tr>
          ...
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Relazione di Richiesta Siepe Ricevuta</font>
          </td>
...
<%  if ((FascicoloSiepeEsteso.getFascicoloSius().getFascicoloSiusModel().getChiaveAnnoSIEP())!=null)
  ...
  <br>
  <form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="ConfermaPresaInCaricoRelazioneRichiesta"> 
  	<br>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.presaincarico.action.ActConfermaPresaInCaricoRelazioneRichiestaSiepe">
