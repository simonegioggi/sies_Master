  ...
  <head>
    ...
    <script language="JavaScript">
      function  Verify()
      {
        ...
        /*if (document.f.<%=ICostantiEsperto.CAMPO_COGNOME%>.value.length < 3)
        {
    ...
    <title>[S.I.E.S.] - Filtro Esperti</title>
  </head>

  <body class="corpo">
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f" target=listaEsperti>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.esperto.action.ActRicercaEspertoLista">
   ...
   <table>
    ...
    <tr>
      ...
      <td class="l">
      	<input value="" type="text" name="<%=ICostantiEsperto.CAMPO_COGNOME%>" >
      </td>
      <td>
