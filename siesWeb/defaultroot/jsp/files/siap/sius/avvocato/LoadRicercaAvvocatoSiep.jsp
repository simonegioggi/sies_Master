...
<frameset rows="100%,*">
    ...
    <frame name="filtro" src="/jsp/files/siap/sius/avvocato/FiltraAvvSiep.jsp?formname=<%=request.getParameter("formname")%>" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" noresize>
</frameset>
