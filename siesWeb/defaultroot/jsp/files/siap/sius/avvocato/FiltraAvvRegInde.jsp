...
function Verify(id) {
  ...
  if (id.id == "sies") {
    document.f.<%=IWebConstants.ACTION_FIELD%>.value = "siap.sius.avvocato.action.ActRicercaAvvocato";
  } else {
    document.f.<%=IWebConstants.ACTION_FIELD%>.value = "siap.sius.avvocato.action.ActRicercaAvvocatoRegInde";
  }
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f" target="listaAvvocatiRegInde">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sius.avvocato.action.ActRicercaAvvocatoRegInde">
