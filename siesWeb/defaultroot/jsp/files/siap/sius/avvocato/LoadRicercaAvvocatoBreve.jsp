...
<frameset rows="85%,*">
    ...
    <frame name="filtro" src="/jsp/files/siap/sius/avvocato/FiltraAvvBreve.jsp?formname=<%=request.getParameter("formname")%>" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" noresize>
</frameset>
