...
<script language="JavaScript">
  ...
  function ListaAvvocati2(a_formname)
  {
...
<table >
  ...
  <td>&nbsp;&nbsp;&nbsp;</td>
    <td class="label">
      <a href="Javascript:ListaAvvocati2('LoadModificaAvvocato');">
...
<%if(avvocato.getAvvocato().getDataNascita() != null){%>
            <input type="text" readonly title="Giorno Data di nascita" name="<%=ICostantiAvvocato.CAMPO_GIORNO_DATA_NASCITA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDayToString(avvocato.getAvvocato().getDataNascita()))%>" maxlength="2" size="2">
            -
            <input type="text" readonly title="Mese Data di nascita" name="<%= ICostantiAvvocato.CAMPO_MESE_DATA_NASCITA %>" value="<%=StringUtils.toStringJSP(DateUtils.getMonthToString(avvocato.getAvvocato().getDataNascita()))%>"maxlength="2" size="2">
            -
            <input type="text" readonly  title="Anno Data di nascita" name="<%= ICostantiAvvocato.CAMPO_ANNO_DATA_NASCITA %>" value="<%=StringUtils.toStringJSP(DateUtils.getYearToString(avvocato.getAvvocato().getDataNascita()))%>" maxlength="4" size="4">
<%}else{%>

            <input type="text" readonly title="Giorno Data di nascita" name="<%=ICostantiAvvocato.CAMPO_GIORNO_DATA_NASCITA%>" value="" maxlength="2" size="2">
            -
            <input type="text" readonly title="Mese Data di nascita" name="<%= ICostantiAvvocato.CAMPO_MESE_DATA_NASCITA %>" value="" maxlength="2" size="2">
            -
            <input type="text" readonly  title="Anno Data di nascita" name="<%= ICostantiAvvocato.CAMPO_ANNO_DATA_NASCITA %>" value="" maxlength="4" size="4">
<%}%>
&nbsp;</td>
</tr>
  ...
  <tr>
   ...
   <tr>
           ...
           <td>
            <input type="text"  title="Giorno Data di Nomina" name="<%=ICostantiAvvocatoFascicoloSius.CAMPO_GIORNO_DATA_NOMINA%>" value="<%=DateUtils.getDayToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" >
            -
            <input type="text" title="Mese Data di Nomina" name="<%= ICostantiAvvocatoFascicoloSius.CAMPO_MESE_DATA_NOMINA %>" value="<%=DateUtils.getMonthToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" >
            -
            <input type="text"  title="Anno Data di Nomina" name="<%= ICostantiAvvocatoFascicoloSius.CAMPO_ANNO_DATA_NOMINA %>" value="<%=DateUtils.getYearToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)" >
            </td>
   </tr>
</table>
</div>
  ...
  <table cellspacing=2 cellpadding=2>
    <tr>
      <td class="label"> Designato in Data   </td>
        <td>
          <input type="text"  title="Giorno Data di Designazione" name="<%=ICostantiAvvocatoFascicoloSius.CAMPO_GIORNO_DATA_DESIGNAZIONE%>" value="<%=DateUtils.getDayToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
          -
          <input type="text" title="Mese Data di Designazione" name="<%= ICostantiAvvocatoFascicoloSius.CAMPO_MESE_DATA_DESIGNAZIONE %>" value="<%=DateUtils.getMonthToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="2" size="2"onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)" >
          -
          <input type="text"  title="Anno Data di Designazione" name="<%= ICostantiAvvocatoFascicoloSius.CAMPO_ANNO_DATA_DESIGNAZIONE %>" value="<%=DateUtils.getYearToString(avvocato.getAvvocatoFascicoloSiusModel().getDataInizioValidita())%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)">
        </td>
    </tr>
  </table>
</div>
