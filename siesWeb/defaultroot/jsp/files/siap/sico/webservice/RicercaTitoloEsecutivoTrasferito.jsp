...
<body class="corpo">
		<table>
    		<tr>
        		...
        		<td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Visualizzazione Titoli Esecutivi Trasferiti</font></td>
      	</tr>
    </table>
    
		<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadListaEsitiRicercaTrasmissioni'>
    		<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.webservice.action.ActListaTitoloEsecutivoTrasferito">

				<table cellspacing=2 cellpadding=2>
						<tr>
	  						<td class="Titolo" colspan="6">Selezione Data Trasferimento</td>
						</tr>
        		...
        		<tr>
	  						<td class="Titolo" colspan="6">Selezione Destinazione del Trasferimento</td>
						</tr>
						...
						<tr>
            				...
            				<table cellspacing=2 cellpadding=2>
	      								<tr>
														<td class="label">Destinazione Trasferimento &nbsp;</td>
														<td class="label">
          											<select  title="Destinazione Trasferimento" name="cmbDestinazione">
            												<option value = '1'>Da NSC a SIES
																		<option value = '2'>Da SIES a NSC
          											</select>
         										</td>
												</tr>
										</table>
						...
						<tr>
	  						<td class="Titolo" colspan="6">Selezione Stato Fascicolo</td>
						</tr>
						...
						<tr>
            				...
            				<table cellspacing=2 cellpadding=2>
	      								<tr>
														<td class="label">Stato Fascicolo &nbsp;</td>
														<td class="label">
          											<select  title="Stato Fascicolo" name="cmbStatoFascicolo">
          													<option value = '-'>-
            												<option value = '02'>Iscritto
																		<option value = '03'>Validato
          											</select>
         										</td>
												</tr>
										</table>
