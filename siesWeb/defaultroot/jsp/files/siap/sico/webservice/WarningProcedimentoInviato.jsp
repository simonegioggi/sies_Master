			...
			<table width="300"  cellspacing="0" align="center" class="tab" >
				...
				<tr align="center" valign="middle">
					<td align="center"  class="tab2" width="50%">
	      				<a href="javascript:document.warning.submit();" onMouseOver="hiLite('img01','clickme2')" 
	      					onMouseOut="hiLite('img01','clickme1')">
	      					<IMG SRC="<%=IWebConstants.IMAGES_DIR %>/bottoni/ok_01.gif" BORDER="0" ALT="" NAME="img01">
	      				</a>
					</td>
					<td align="center"  class="tab2" width="50%">
      					<a href="javascript:vai();" onMouseOver="hiLite('img02','clickme4')" 
      						onMouseOut="hiLite('img02','clickme3')">
