...
<html>
  ...
  <body class="corpo" onload="document.f.submit();">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.magistrato.action.ActRicercaMag">
   ...
   <table>
    ...
    <tr>
      ...
      <td class="l"> <input value="" type="text" name="<%=ICostantiMagistrato.CAMPO_COGNOME%>" onFocus="javascript:document.f.go.disabled=false;"> </td>
