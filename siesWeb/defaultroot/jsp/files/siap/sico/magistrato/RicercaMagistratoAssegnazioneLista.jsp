...
<!-- A8RR084 la data di nascita non viene più visualizzata per default ma solo se richiesto -->
<jsp:useBean id="viewDataNascita" scope="request" class="java.lang.String" />
  
<!-- 
n.b. Use bean commentato per evitare che, in assenza del fascicolo in sessione,
     venga istanziato un model vuoto e messo in sessione (A8RR084 popup richiamata
     anche dalle funzioni amministrative).
  ...
  <body class=corpo>
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <% if (viewDataNascita.equals("SI")) { %>
        <td class=l nowrap><%=DateUtils.getDateToString(lMag.getDataNascita(),"dd-MM-yyyy")%> </td>
        <% } %>
