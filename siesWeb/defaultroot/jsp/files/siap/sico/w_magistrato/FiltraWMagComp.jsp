...
<html>
  <head>
    ...
    <script language="JavaScript">
      function  Verify()
      {
        ...
        /*if (document.f.<%=ICostantiWMagistrato.CAMPO_COGNOME%>.value.length < 3)
        {
  ...
  <body class="corpo">
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f" target=listaWMagistratiComp>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.w_magistrato.action.ActRicercaWMagistratoComp">
