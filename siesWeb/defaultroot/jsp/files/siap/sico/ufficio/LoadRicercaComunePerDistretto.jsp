...
<frameset rows="70%,15%,*">
    ...
    <frame name="listadistretti" src="/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=siap.sico.ufficio.action.ActLoadListaDistrettiCombo&formname=<%=request.getParameter("formname")%>&fieldname=<%=request.getParameter("fieldname") %>&fieldname2=<%=request.getParameter("fieldname2") %>&codTipoUff=<%=codTipoUff%> " marginwidth="0" marginheight="0" scrolling="no" frameborder="0" noresize>
