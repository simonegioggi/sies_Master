...
<html>
<head>
  <title>[S.I.E.S.] - Dettaglio Documento </title>
...
<body class="corpo">
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.sico.evento.action.ActStampaVuoto&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%}%>
...
<%
    for (Iterator lIter = ListaAnnotazioni.iterator(); lIter.hasNext(); )
    {
      ...
      if(eventonotifica.getEvento().getCodMotivo().equals("0284"))
      {
%>
        <tr>
...
<%
    ...
    if(eventonotifica.getEvento().getCodMotivo().equals("0286"))
    {
%>
      <tr>
...
<%
    ...
    if(eventonotifica.getEvento().getCodMotivo().equals("0285"))
    {
%>
      <tr>
...
if (lAvvocatoSiep.getAvvSiep()!=null && lAvvocatoSiep.getAvvSiep().getAvvocato()!=null)
{%>
    <tr>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.sico.evento.action.ActDettaglioDocumento">
          </td>
        </tr>
      </table>
</form>
