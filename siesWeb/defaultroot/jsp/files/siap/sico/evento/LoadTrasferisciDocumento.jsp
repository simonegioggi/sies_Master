...
<html>
<head>
	<title>[S.I.E.S.] - Gestione Documento </title>
    ...
    function ListaComuniTds(formname,fieldname) {
    	var codTipoSede = document.LoadTrasferisciDocumento.<%=ICostantiEvento.CAMPO_COD_TIPO_UFFICIO_DESTINATARIO%>[0].value;
...
<%
        ...
        lAction = "siap.sico.evento.action.ActTrasferisciDocumento";
%>
        <font class="campo">Trasferimento Documento</font>
    </tr>
  </table>
  <br>
    <jsp:include page="/jsp/files/siap/siep/fascicolo/DettaglioSoggettoSentenza.jsp"/>
  <br>
  <form method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadTrasferisciDocumento" onsubmit="document.forms[0].go.disabled=true">
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        <td class="l">Sede Destinatario </td><td class="L">
          <input title="Sede Destinatario"  type="text" name="<%= ICostantiEvento.CAMPO_COD_LUOGO_DESTINATARIO%>"  maxlength="35" size="35">
            <a href="Javascript:ListaComuniTds('LoadTrasferisciDocumento','<%= ICostantiEvento.CAMPO_COD_LUOGO_DESTINATARIO%>[0]');">
      ...
      <tr>
        <td class="l">UEPE/USSM Destinatario</td>
        <td class="L">
      ...
      <tr>
        <td class="l">Sede UEPE/USSM Destinatario </td>
        <td class="L">
          <input title="Sede UEPE Destinatario"  type="text" name="<%=ICostantiEvento.CAMPO_COD_LUOGO_DESTINATARIO%>"  maxlength="35" size="35">
            <a href="Javascript:ListaUfficiPerTipo('LoadTrasferisciDocumento','<%=ICostantiEvento.CAMPO_COD_LUOGO_DESTINATARIO%>[1]',document.LoadTrasferisciDocumento.<%=ICostantiEvento.CAMPO_COD_TIPO_UFFICIO_DESTINATARIO%>[1][document.LoadTrasferisciDocumento.<%=ICostantiEvento.CAMPO_COD_TIPO_UFFICIO_DESTINATARIO%>[1].selectedIndex].value);">
              <img src="/images/filefolder.gif" border=0>
            </a>
        </td>
      </tr>
