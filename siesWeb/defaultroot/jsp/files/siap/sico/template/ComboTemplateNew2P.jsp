...
<script language="JavaScript">
    function stampaT(lAzione)
    {
       ...
       var  link = "<%=IWebConstants.ACTION_FIELD%>="+lAzione+"&<%=request.getParameter(ICostantiSecurity.CAMPO_ID_ENTITA)%>=<%=request.getParameter(ICostantiSecurity.VALORE_ID_ENTITA)%>&<%=request.getParameter(ICostantiSecurity.CAMPO_ID_ENTITAPP)%>=<%=request.getParameter(ICostantiSecurity.VALORE_ID_ENTITAPP)%>&<%=ICostantiTemplate.CAMPO_ID_TEMPLATE%>=";
...
<%
   ...
   {
%>
       <td> <font color="red"> Modelli di stampa non disponibili !</font> </td>
