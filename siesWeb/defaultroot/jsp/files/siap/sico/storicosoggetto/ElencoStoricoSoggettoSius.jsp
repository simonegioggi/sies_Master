...
<tr> <td class ="Titolo" colspan =8>Modifiche apportate al soggetto </td></tr>
<%}%>
<%
...
if(lSoggStoricoMod.getStoricoSoggetto()!= null)
{
 ...
 // fascicoli = new Vector(lSoggStoricoMod.getFascicoloSius());
}
...
<tr> <td class ="Titolo" colspan =7>Procedimenti dell' ufficio associati  al Soggetto </td></tr>
<tr><td>&nbsp;</td></tr>
   <tr>
...
<%
    ...
    while ( itxf.hasNext())
    {
     FascicoloGPModel FascSiusGP = (FascicoloGPModel) itxf.next();
...
<tr> <td class ="Titolo" colspan =7>Procedimenti di altri uffici associati  al Soggetto </td></tr>
<tr><td>&nbsp;</td></tr>
   <tr>
     <td class="int">Numero SIUS</td>
      <td class="int">Descr.Ufficio</td>
...
<%
    ...
    {
      FascicoloGPModel FascSiusGP = (FascicoloGPModel) itxfaltri.next();
...
<%if(fascicoliNuovi != null && fascicoliNuovi.size()>0)
{
    ...
    while ( itxFasc.hasNext())
    {
      ...
      FascicoloGPModel FascSiusGP = (FascicoloGPModel) itxFasc.next();
      FascicoloSiusModel fascicoloNew = (FascicoloSiusModel)FascSiusGP.getFascicoloSiusModel();

%>
      <tr>
      <td class="c"><font class="label"><%=StringUtils.toStringJSP(fascicoloNew.getChiaveAnno(),"")%>/<%=StringUtils.toStringJSP(fascicoloNew.getChiaveProgr(),"")%></font></td>
      <td class="c"><font class="label"><%=StringUtils.toStringJSP(fascicoloNew.getDescrTipoUfficio(),"")%>/<%=StringUtils.toStringJSP(fascicoloNew.getDescrComuneUfficio(),"")%></font></td>
      <td class="c"><font class="label"><%=StringUtils.toStringJSP(DateUtils.getDateToString(FascSiusGP.getGeneraleProcedimentoModel().getDataRichiesta(),"dd-MM-yyyy"),"-")%></font></td>
      <td class="c"><font class="label"><%=StringUtils.toStringJSP(FascSiusGP.getGeneraleProcedimentoModel().getDescrOggettoProcedimento())%></font></td>
      ...
      <td class="c"><font class="label"><%=StringUtils.toStringJSP(fascicoloNew.getDescrStatoFascicolo(),"")%>&nbsp;</font></td>
    </tr>
