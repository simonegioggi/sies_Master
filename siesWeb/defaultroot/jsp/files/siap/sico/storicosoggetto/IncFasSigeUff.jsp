...
<% 
// parametro passato per eliminare i checkbox
boolean checkboxSI = true;
if (request.getParameter("checkbox_no") != null) {
	checkboxSI = false;
}
%>
...
<%
    ...
    while ( itx.hasNext())
    {
    	FascicoloSigeModel fascicolo = (FascicoloSigeModel) itx.next();
 ...
 <%if (checkboxSI) { %>
      <td class="c">
        <input type="checkbox" name="<%="fascicolo"+i%>" value="<%=fascicolo.getIdFascicoloSige()%>" />
  	 </td>
 <%} %>
    </tr>
<%
