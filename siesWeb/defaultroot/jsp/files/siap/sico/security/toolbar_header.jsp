...
<%
  ...
  if (request.getParameter("Modificabile") != null)
  {
    ...
    //   if (request.getParameter("tipo_posizione_materiale").equalsIgnoreCase("SIUS"))
		//		{
    //    	//System.out.print( ">>> Cambio boolean di proprietà (tipo_posizione_materiale) <<< " );
    //      lDiProprieta = false;
		//		}
    //}
  }
  else
  {
         		...
         		lUtenteMod.getUfficioUtente().getCodTipoUfficio().equals("UEPESS") ))
   {
      ...
      if (lFas != null)
      {
        	...
        	//System.out.print( ">>> Cambio boolena di proprietà (lUffUtente) <<< : " + lUffUtente );
	  			//System.out.print( ">>> Cambio boolena di proprietà (CodUfficioInserimento) <<< : " + lFas.getCodUfficioInserimento() );
					lDiProprieta = false;
        }
      }
