...
// di concessione dei "Rimedi Risarcitori" DL 92/2014
//==============================================================================
%>
  ...
  <head>
    ...
    <script language="JavaScript">
      ...
      function Verify(idEvento, elaborato)
      {
        ...
        {
          window.parent.opener.document.<%=request.getParameter("formname")%>.<%=IWebConstants.ACTION_FIELD%>.value = "siap.sico.libertaanticipata.action.ActDettaglioRimediRisarcitori";
