...
<html>
  <head>
    <title>[S.I.E.S.] - Ufficio Servizio Sociale per i Minorenni (USSM)</title>
...
<%      if (request.getParameter("fieldcode")!= null )
  ...
  <body onload="focus();">
   <table>
      <tr>
        <td class=LBG>Ufficio Servizio Sociale per i Minorenni (USSM)</td>
      </tr>
   </table>
   <Table width="100%">
<%
      ...
      while ( itx.hasNext())
      {
        ...
        String tipoSede = (cssa.getTipo().indexOf("USSMSS")>=0 ? " (Sede di Servizio) " : "");
%>
        <tr>
