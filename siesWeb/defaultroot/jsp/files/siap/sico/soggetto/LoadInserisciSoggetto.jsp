...
<html>
  ...
  <form  method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadInserisciSoggetto" id="LoadInserisciSoggetto">
...
%>
            ...
            /
            <input type="text" title="Mese Data di nascita" 
            	name="<%= ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA %>" 
            	maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
            /
            <input type="text" title="Anno Data di nascita" 
...
%>
			<a href="javascript:calendario('LoadInserisciSoggetto','<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>','<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>');">
...
<%-- MERGE v10 COLLAUDO: modifica alla gestione del codice --%>
	<%	    
		...
		<tr>
			...
			<td class="l">
				<input type="text" name="<%= ICostantiSoggetto.CAMPO_ETA_PRESUNTA_ANNI %>" value="<%=StringUtils.toStringJSP(lSoggetto.getEtaPresuntaAnni()) %>" title="Età Presunta - Anni"
					onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
					maxlength="2" size="2"> anni
					&nbsp;&nbsp;/&nbsp;&nbsp;        
				<input type="text" name="<%= ICostantiSoggetto.CAMPO_ETA_PRESUNTA_MESI %>" value="<%=StringUtils.toStringJSP(lSoggetto.getEtaPresuntaMesi()) %>" title="Età Presunta - Mesi"
					onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
					maxlength="2" size="2"> mesi        
			</td>
		</tr>
	<%  } %>
...
%> 
	...
	%>
			<td class="L">
			            <input type="text" title="Giorno Data commesso reato" 
			            	name="<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_COMMESSO_REATO%>" 
			            	maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
			            /
			            <input type="text" title="Mese Data commesso reato" 
			            	name="<%= ICostantiSoggetto.CAMPO_MESE_DATA_COMMESSO_REATO %>" 
			            	maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillDM(value)">
			            /
			            <input type="text" title="Anno Data commesso reato" 
	...
	%>
      ...
      <tr>
        ...
        <td class="L">
          ...
          <a href="Javascript:ListaComuni('LoadInserisciSoggetto','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
