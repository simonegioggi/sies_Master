...
<html>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class=label>Funzione :</font> <font class=campo>Elenco Soggetti RICERCA CODICE CUI</font></td>   
       <td class="LBG"><jsp:include page="<%=IWebConstants.PG_RETURN_BUTTON%>"/></td>       
    </tr>
  </table>
...
%>
      ...
      <td class=c><%=StringUtils.toStringJSP(lSogFas.getSoggetto().getCodAfis())%>&nbsp;</td>       
...
%>
	<input type="HIDDEN" name="CampoAzioneChiamante" value="prova">
    </table>
