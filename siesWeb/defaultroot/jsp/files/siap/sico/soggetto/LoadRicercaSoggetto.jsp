...
<script language="JavaScript">
    function Verify()
    {
		...
		var data_to_verify=document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>.value+'/'+document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>.value+'/'+document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>.value;
	 	...
	 	if (document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COGNOME%>.value.length<2 && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_NOME%>.value==""
	 	         ...
	 	         && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA%>.value=="" && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COD_STATO_NASCITA%>.value =="-" && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_PATERNITA%>.value ==""
	 	         && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_DESC_COMUNE_NASCITA_ESTERO%>.value==""
	 	         && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COGNOME_MADRE%>.value=="" && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_NOME_MADRE%>.value==""
	 	        	&& document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_ATTO_NASCITA%>.value=="" && document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COD_AFIS%>.value=="")
	 	      {
	 	        alert("Inserire il Cognome del Soggetto (almeno 2 lettere)");
	 	        document.LoadRicercaSoggetto.<%=ICostantiSoggetto.CAMPO_COGNOME%>.focus();
