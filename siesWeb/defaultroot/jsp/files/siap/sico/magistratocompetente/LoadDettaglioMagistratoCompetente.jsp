...
<jsp:useBean id="magistrato" scope="request" class="siap.sico.magistratocompetente.model.MagistratoCompetenteModel"/>
 ...
 <FORM name="DettaglioMagistratoAss">
   ...
   <table cellspacing=2 cellpadding=2>
    <tr>
     ...
     <td class="l">Cognome :
        <font class="campo"><%=magistratocompetente.getCognome() %></font></td>
        <td class="l">Nome :
        <font class="campo"><%=magistratocompetente.getNome() %></font></td>
     </tr>
...
%>
       <tr>
        <td class="l">
         ...
         al Magistrato <font class="campo"><%=magistratocompetente.getNome()%>
         &nbsp;<%=magistratocompetente.getCognome()%> </font>
