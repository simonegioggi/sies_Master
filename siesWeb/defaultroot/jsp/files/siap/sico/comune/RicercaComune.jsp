...
%>
        ...
        <td class=c><a href="Javascript:insertIT('<%=StringUtils.cStrForJS(lComune.getDescrizione())%>', '<%=StringUtils.cStrForJS(lComune.getCodComune())%>')"><img align="middle" src="/images/fileselected.gif" border=0></a></td></tr>
        <%
      }
%>
    </table>
