...
<body class="corpo" onload="Javascript:focus();document.f.submit();">
	<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f"
		...
		<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>"
			value="siap.sico.decodifiche.action.ActVisualizzaComuniNascita">
		<input type="HIDDEN" name="codProv"
			value="<%=request.getParameter("provincia")%>"> <input
			type="HIDDEN" name="formname"
			value="<%=request.getParameter("formname")%>"> <input
			type="HIDDEN" name="fieldname"
			value="<%=request.getParameter("fieldname")%>"> <br>
		<table>
			<tr>
				<td class=LBG>o Filtra i Comuni per</td>
				<td><input type="text" name="comune" value=""
