...
<frameset rows="70%,15%,*">
    ...
    <frame name="listaprovince" src="/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=siap.sico.decodifiche.action.ActLoadListaProvPerTipoUfficio&formname=<%=request.getParameter("formname")%>&fieldname=<%=request.getParameter("fieldname") %> " marginwidth="0" marginheight="0" scrolling="no" frameborder="0" noresize>
