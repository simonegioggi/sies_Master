...
<jsp:useBean id="codicedistretto" scope="request" class="java.lang.String" />
...
<html>
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f" target=listacomuni>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.decodifiche.action.ActVisualizzaUffSorvPerDistretto">
    <input type="HIDDEN" name="codicedistretto" value="<%=codicedistretto%>">
