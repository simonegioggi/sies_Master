...
<head>
  <title>[S.I.E.S.] - Conversione Numeri Fascicoli RES</title>
...
function trim(inputString) {
  ...
  function Verify()
  {
    if (document.f.anno.value=="" || document.f.numero.value=="" || document.f.lettera.value=="")
      alert("I campi Anno, Numero e Lettera sono obbligatori");
    else Converti();
  }

  //=======================================================
  // Effettua la conversione delle Lettere in RES
  //=======================================================
  function Converti(){
    var tmp='';
    var new_prog;
...
<table>
      <tr>
        ...
        <font class="campo">Conversione Numeri Fascicoli RES</font>
      </td>
   </tr>
 </table>
<form name="f" method="post">
  <table>
  <tr><td class=Titolo colspan=2>Fascicolo Res</td></tr>
