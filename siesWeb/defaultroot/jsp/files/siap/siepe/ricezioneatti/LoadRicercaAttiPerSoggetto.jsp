...
<html>
<head>
  <title> [S.I.E.S.] - Ricerca Atti per Soggetto - </title>
  ...
  <script language="JavaScript">
    function init()
    {
      document.LoadRicercaAttiPerSoggetto.<%=ICostantiSoggetto.CAMPO_COGNOME%>.focus();
    }
    function Verify()
    {
      var data_to_verify=document.LoadRicercaAttiPerSoggetto.<%=ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA%>.value+'/'+document.LoadRicercaAttiPerSoggetto.<%=ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA%>.value+'/'+document.LoadRicercaAttiPerSoggetto.<%=ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA%>.value;
...
<body class="corpo" onload="Javascript:init();">
    <table>
  	...
  	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadRicercaAttiPerSoggetto" >
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siepe.ricezioneatti.action.ActRicercaAttiPerSoggetto">
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaComuni('LoadRicercaAttiPerSoggetto','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    var frmvalidator  = new Validator("LoadRicercaAttiPerSoggetto");
