...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Attività Ricevuta</title>
        ...
        <tr>
        	<td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          	<td class="LBG">
            	...
            	<font class="campo">Dettaglio Attività Ricevuta</font>
          	</td>

      		<!-- TOOLBAR HEADER -->
      		<td class="LBG">
          	<jsp:include page="<%=ICostantiRicezioneAtti.PG_TOOLBAR_HEADER_ATTIVITA_RICEVUTA%>">
...
%>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <!--  Sezione Dati dell'Attivita SIEPE -->
    	...
    	<tr>
      	<td class="L"><font class="l">Data Inizio</font></td>
				<td class="l">
					<font class="campo">
