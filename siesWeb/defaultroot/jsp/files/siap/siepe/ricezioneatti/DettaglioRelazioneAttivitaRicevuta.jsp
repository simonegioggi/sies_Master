...
<!-- 
		...
		alla Relazione dell'Attivita UEPE Ricevuta.
-->

<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Relazione di Attivita UEPE Ricevuta</title>
      ...
      <table>
        <tr>
          ...
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Relazione di Attivita UEPE Ricevuta</font>
          </td>

      		<!-- TOOLBAR HEADER -->
      		<td class="LBG">
          	<jsp:include page="<%=ICostantiRicezioneAtti.PG_TOOLBAR_HEADER_RELAZIONE_ATTIVITA_RICEVUTA%>">
...
%>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <!--  Sezione Dati dell'Attivita SIEPE -->
    	
    	<tr>
    		<td class="Titolo" colspan=4>Attività</td>
    	</tr>
    	<tr>
          ...
          %>
						...
						<font class="l"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(attivita.getDataChiusura(),"dd-MM-yyyy"),"-")%> </font>
					<%
					}
					%>
        </td>
			...
			<tr>
				<td class="L"><font class="l">Tipo Attività</font></td>
				<td class="l">
...
%>
			...
			<tr>
    		<td class="L"><font class="l">Nota di Chiusura</font></td>
    		<td class="l">
...
%>
			...
			<!-- Fine Sezione Dati dell'Attivita SIEPE/UEPE -->
