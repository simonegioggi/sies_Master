...
<!-- 
		Descrizione della funzionalità della JSP :
		Maschera di Dettaglio deputata alla visualizzazione dei dati afferenti 
		alla Richiesta UEPE Ricevuta.
-->

<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Richiesta UEPE Ricevuta</title>
      ...
      <table>
        <tr>
          ...
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Richiesta UEPE Ricevuta</font>
          </td>

      		<!-- TOOLBAR HEADER -->
      		<td class="LBG">
          	<jsp:include page="<%=ICostantiRicezioneAtti.PG_TOOLBAR_HEADER_RICHIESTA_RICEVUTA%>">
...
<%
					// Gestione dello stato del Messaggio
...
%>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <!--  Sezione dati dell'Oggetto Procvvedimento -->
      <tr>
      ...
      <!--  Fine Sezione dati Oggetto del Provvedimento -->
 
      <tr>
      	<td>&nbsp;</td>
      </tr>
 
      <!--  Sezione Dati della Richiesta SIEPE/UEPE --> 	
    	<tr>
...
%>
    ...
    <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="DettaglioRichiestaRicevuta">
