      ...
      <table>
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Provvedimento Ricevuto</font>
          </td>

      <!-- TOOLBAR HEADER -->
      <td class="LBG">
          <jsp:include page="<%=ICostantiRicezioneAtti.PG_TOOLBAR_HEADER_PROVVEDIMENTO%>">
...
%>
     <td class="LBG">
      ...
      <jsp:include page="/jsp/files/siap/siepe/ricezioneatti/SintesiSoggettoSentenzaRicevuti.jsp"/>
    <br>
