...
<body class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
      <font class="label">Funzione : Controllo Esito Messaggi Spediti</font>&nbsp;&nbsp;
     </td>
    </tr>
  </table>
...
<%
    ...
    {
      if ((lMess.getMessaggioCorrelato().getCodEsito().equals("00000"))||
      (lMess.getMessaggioCorrelato().getCodEsito().equals("10000")))
      {
%>
        <td class="cVerde"><%= StringUtils.toStringJSP(lMess.getDescrTipoOperazione())%></td>
...
<%
      ...
      {
%>
        <td class="cRosso"><%= StringUtils.toStringJSP(lMess.getDescrTipoOperazione())%></td>
