...
<%
    	...
    	else
    	{
      		...
      		if (lMess.getMessaggioCorrelato().getCodEsito().compareTo("00000") == 0 ||   // Positivo
          	lMess.getMessaggioCorrelato().getCodEsito().compareTo("01001") == 0 ||   // Preso in Carico
          	lMess.getMessaggioCorrelato().getCodEsito().compareTo("01002") == 0    ) // Preso in Visione
      		{
%>
...
<%
                   ...
                   && (   lMess.getMessaggioCorrelato().getCodTipoOperazione().equals("00067") 	// Esito trasferimento Competenza
               		     || lMess.getMessaggioCorrelato().getCodTipoOperazione().equals("00072")  // Esito trasferimento Competenza Misure di Sicurezza
                      )
                  )
          		{
        			// Atti trasmessi per competenzza per assorbimento in cumulo e Restituito
					String lTitle = "";
					if (lMess.getMessaggioCorrelato().getNote()!=null)
					{
	    				lTitle = "Motivo : "+lMess.getMessaggioCorrelato().getNote();
					}
        %>
