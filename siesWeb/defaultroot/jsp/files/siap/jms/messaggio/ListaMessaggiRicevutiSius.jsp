...
<jsp:useBean id="annoSius" scope="request" class="java.lang.String"/>
<jsp:useBean id="progrSius" scope="request" class="java.lang.String"/>
...
<%
  if(codUfficio.length()>1 || annoSiep.length()>1 || annoSius.length()>1 || flagIncludeInCarico.equals("S") || (data1.length()>0 && data2.length()>0))
  {%>
...
<%    }
      if(annoSius.length()>1)
      {
%>
        <tr>
          <td class="lVerdeNB">Numero SIUS : <%=annoSius%>/<%=progrSius%></td>
        </tr>
<%    }
