...
<table cellspacing=4 cellpadding=4>
  ...
  <tr>
    ...
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbperipren.getCodiSedeInst()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Anno Fasc Bdmc</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbperipren.getAnnoFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Nume Fasc Bdmc</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbperipren.getNumeFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Cod Stat Pren Peri</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbperipren.getCodStatPrenPeri()) %></font>&nbsp;</td>
  </tr>

  <tr>
    <td class="l">Data Pren Peri</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(sbperipren.getDataPrenPeri(),"dd-MM-yyyy"))%> </font>&nbsp;</td>
  </tr>
