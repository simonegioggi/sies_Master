  ...
  <table>
    <tr>
      ...
      <td class="LBG">
       ...
       <a href="Main.jsp?Action=siap.bdmc.sbviewreat.action.ActLoadModificaSbViewReat&IdSbViewReat=<%=sbviewreat.getIdPren()%>&TornaQui=10">
         <img align="middle" src="/images/modifica24.gif" alt="Modifica" width="24" height="24" border="0">
        </a>
 
         <a href="Javascript:conferma('siap.bdmc.sbviewreat.action.ActLoadCancellaSbViewReat','IdSbViewReat','<%=sbviewreat.getIdPren()%>');">
...
<FORM method="POST" action="Main.jsp" name="CancellaSbViewReat">
  ...
  <input type="HIDDEN" name="<%=ICostantiSbViewReat.CAMPO_ID_PREN%>" value="<%=StringUtils.toStringJSP(sbviewreat.getIdPren()) %>">
  <input type="HIDDEN" name="<%=ICostantiSbViewReat.CAMPO_NUME_PROG_CAPO_IMPU%>" value="<%=StringUtils.toStringJSP(sbviewreat.getNumeProgCapoImpu()) %>">
...
<table cellspacing=4 cellpadding=4>
  ...
  <tr>
    ...
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewreat.getAnnoFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Nume Fasc Bdmc</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewreat.getNumeFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Codi Sede Inst</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewreat.getCodiSedeInst()) %></font>&nbsp;</td>
  </tr>
