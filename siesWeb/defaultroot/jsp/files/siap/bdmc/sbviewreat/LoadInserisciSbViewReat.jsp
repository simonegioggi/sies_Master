...
<html>
<head>
  <title> Gestione SbViewReat </title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <%
        SbViewReatModel lSbViewReat = new SbViewReatModel(); 
        String lAzione = new String();
        if( modalita.equals("I") ) {
          lAzione = "siap.bdmc.sbviewreat.action.ActInserisciSbViewReat"; 
        %>
        <font class="campo">Inserimento SbViewReat</font>
        <%
        }
        else if( modalita.equals("M") ) {
          lAzione = "siap.bdmc.sbviewreat.action.ActModificaSbViewReat";
          lSbViewReat = sbviewreat;
        %>
        <font class="campo">Modifica SbViewReat</font>
        <%}%>
      </td>
    </tr>
  </table>

<FORM method="POST" action="Main.jsp" name="LoadInserisciSbViewReat">
  ...
  <table>
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="10" size="12" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getNumeProgCapoImpu()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="15" size="17" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getNumeProgReat()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="15" size="15" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getCodiFontGiur()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getAnnoFontGiur()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getNumeFontGiur()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getArtiFontGiur()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="50" size="50" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getCommiArtiFont()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="50" size="50" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getLettArtiFont()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="3" size="3" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getNumeArtiFont()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="3" size="3" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getArtiQualFont()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="0" size="2" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getIdPren()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getAnnoFascBdmc()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getNumeFascBdmc()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="15" size="15" 
               value="<%=StringUtils.toStringJSP(lSbViewReat.getCodiSedeInst()) %>"
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciSbViewReat");

  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_NUME_PROG_CAPO_IMPU %>","req","Il campo Nume Prog Capo Impu è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_NUME_PROG_REAT %>","req","Il campo Nume Prog Reat è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_CODI_FONT_GIUR %>","req","Il campo Codi Font Giur è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_ARTI_FONT_GIUR %>","req","Il campo Arti Font Giur è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_ID_PREN %>","req","Il campo Id Pren è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_ANNO_FASC_BDMC %>","req","Il campo Anno Fasc Bdmc è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_NUME_FASC_BDMC %>","req","Il campo Nume Fasc Bdmc è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiSbViewReat.CAMPO_CODI_SEDE_INST %>","req","Il campo Codi Sede Inst è obbligatorio");
