...
<table>
	<tr>
      	...
      	<td class="l"> 
        	<input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" value="<%=StringUtils.toStringJSP(lFascicoloSiepBdmc.getChiaveAnnoBdmc())%>" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_CHIAVE_ANNO_BDMC%>" <%=readonly%>> 
			<font class="campo">/</font>
        	<input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" value="<%=StringUtils.toStringJSP(lFascicoloSiepBdmc.getChiaveProgrBdmc())%>" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_CHIAVE_PROGR_BDMC%>" <%=readonly%>> 
      	</td> 
    </tr>
	<tr>
	...
	<tr>
      	...
      	<td class="L">
         	<input Title="Luogo Ufficio Bdmc" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_COD_LUOGO_EMITTENTE%>" value="<%=descrLuogoEmittente%>" type="text" maxlength="35" size="35">
    ...
    <tr>
      	...
      	<td class="L"> 
        	...
        	<input type="hidden" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_CHIAVE_UFFICIO_SIEP%>" value="<%=codUfficio%>">
      	</td> 
    </tr>
    <tr>
      	<td class="l">Anno / Numero Siep (*)</td>
      	<td class="l"> 
        	<input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" value="<%=StringUtils.toStringJSP(lFascicoloSiepBdmc.getChiaveAnnoSiep())%>" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_CHIAVE_ANNO_SIEP%>" <%=readonly%>> 
			<font class="campo">/</font>
	        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" value="<%=StringUtils.toStringJSP(lFascicoloSiepBdmc.getChiaveProgrSiep())%>" name="<%=ICostantiFascicoloSiepBdmc.CAMPO_CHIAVE_PROGR_SIEP%>" <%=readonly%>> 
      	</td> 
    </tr>
<%   
if (modalita.equals("M")) {
