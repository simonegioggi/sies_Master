  ...
  <table>
    <tr>
      ...
      <td class="LBG">
       ...
       <a href="Main.jsp?Action=siap.bdmc.sbviewcapoimpu.action.ActLoadModificaSbViewCapoimpu&IdSbViewCapoimpu=<%=sbviewcapoimpu.getIdPren()%>&TornaQui=10">
         <img align="middle" src="/images/modifica24.gif" alt="Modifica" width="24" height="24" border="0">
        </a>
 
         <a href="Javascript:conferma('siap.bdmc.sbviewcapoimpu.action.ActLoadCancellaSbViewCapoimpu','IdSbViewCapoimpu','<%=sbviewcapoimpu.getIdPren()%>');">
...
<FORM method="POST" action="Main.jsp" name="CancellaSbViewCapoimpu">
  ...
  <input type="HIDDEN" name="<%=ICostantiSbViewCapoimpu.CAMPO_ID_PREN%>" value="<%=StringUtils.toStringJSP(sbviewcapoimpu.getIdPren()) %>">
...
<table cellspacing=4 cellpadding=4>
  ...
  <tr>
    ...
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewcapoimpu.getAnnoFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Nume Fasc Bdmc</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewcapoimpu.getNumeFascBdmc()) %></font>&nbsp;</td>
  </tr>
  <tr>
    <td class="l">Codi Sede Inst</td>
    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(sbviewcapoimpu.getCodiSedeInst()) %></font>&nbsp;</td>
  </tr>
