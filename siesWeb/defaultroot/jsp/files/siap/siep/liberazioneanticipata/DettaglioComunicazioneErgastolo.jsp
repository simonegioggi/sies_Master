...
%>
     <font class="campo">Dettaglio Comunicazione Concessione Liberazione Anticipata per Condannato in Ergastolo</font>
</td>
<%
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.sico.libertaanticipata.action.ActStampaComunicazioneLAErgastolo&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%
    }
...
%>
   <tr>
     ...
     <td class="L"> <font class="campo"><%=StringUtils.toStringJSP(tiposorveglianza)%></font>
   <tr>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.libertaanticipata.action.ActUploadComunicazioneLAErgastolo">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.sico.libertaanticipata.action.ActDettaglioComunicazioneLAErgastolo">
          </td>
        </tr>
      </table>
</form>
