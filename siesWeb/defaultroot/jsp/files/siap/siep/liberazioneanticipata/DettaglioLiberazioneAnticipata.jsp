...
%>
    ...
    <tr>
      	...
      	<td class="L">
        	<font class="campo"><%=StringUtils.toStringJSP(DepositoOrdinanzaPc.getNumGiorniLibanticipata())%></font>
      	</td>
	</tr>
<%
...
<%
				...
				// Soltanto per ogni riga dei semestri concessi
				if (k == 0) {
%>
		<td class="L">
	  		<font class="l">giorni concessi: <%=lLicPerConc.getLicenza().getNumeroGiorni()%></font>
	   	</td>
	</tr>
<%
				}
...
<table cellspacing="2" cellpadding="2">
	<tr>
    	<td><input class="bottone" name="CALCOLO" type="submit" value="Calcolo data fine pena"></td>
		<td class="l" colspan="3">
  			<font class="label">Data Eventuale Scarcerazione</font>
  			&nbsp;&nbsp;
  			<input type="text" maxlength="2" size="2" name="<%=ICostantiAnnotazioneManuale.CAMPO_GIORNO_DATA_SCARCERAZIONE%>"
				value="" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
			/
			<input type="text" maxlength="2" size="2" name="<%=ICostantiAnnotazioneManuale.CAMPO_MESE_DATA_SCARCERAZIONE%>"
				value="" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
			/
			<input type="text" maxlength="4" size="4" name="<%=ICostantiAnnotazioneManuale.CAMPO_ANNO_DATA_SCARCERAZIONE%>"
				value="" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
    	</td>
  	</tr>
</table>
<%
