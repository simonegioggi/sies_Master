   ...
   function Verify()
    {
     ...
     if(document.LoadInserisciComunicazioneErgastolo.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="")
      {
        alert("Il Cognome del Magistrato è obbligatorio");
        return false;
      }
      if(document.LoadInserisciComunicazioneErgastolo.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
      {
        alert("Il Nome del Magistrato è obbligatorio");
        return false;
      }

      if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>.value == "")
      {
...
<%
      ...
      {
%>
        if(document.LoadInserisciComunicazioneErgastolo.<%=ICostantiOrdineScarcerazione.CAMPO_SEDE_TRIBUNALE%>.value=="")
        {
...
<%
      ...
      {
%>
        if(document.LoadInserisciComunicazioneErgastolo.<%=ICostantiOrdineScarcerazione.CAMPO_SEDE_UDS%>.value=="")
        {
          alert("La Sede dell'Ufficio di Sorveglianza è obbligatorio");
          return false;
        }
<%
      }
%>
     if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
       document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value;
     if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
       document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value;
     var data_to_verify = document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value;
     if (!ControllaData(data_to_verify) )
      ...
      if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value.length==1)
			  document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value='0'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value;
      if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value.length==1)
			  document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value='0'+document.LoadInserisciComunicazioneErgastoloLoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value;
      data_to_verify = document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value+'/'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value+'/'+document.LoadInserisciComunicazioneErgastolo.<%=ICostantiNotifica.CAMPO_ANNO_DATA_INVIO%>.value;
      if (!ControllaData(data_to_verify) )
        {
         alert('Data di trasmissione non valida');
	       return false;
       }
      var campo = document.LoadInserisciComunicazioneErgastolo.<%= ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA %>.value;
...
//Controllo se Data Provvedimento della maschera è diversa da data di sistema e uguale o superiore a DataIrrevocabilità(TAB_Sentenza)
 if(document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value != <%=DateUtils.getSysDate("dd")%> ||
     document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value != <%=DateUtils.getSysDate("MM")%> ||
     document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value != <%=DateUtils.getSysDate("yyyy")%>)
   {
    if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value  < document.LoadInserisciComunicazioneErgastolo.<%=ICostantiSentenza.CAMPO_ANNO_DATA_IRREVOCABILITA%>.value)
      {
      ...
      else  if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value  == document.LoadInserisciComunicazioneErgastolo.<%=ICostantiSentenza.CAMPO_ANNO_DATA_IRREVOCABILITA%>.value)
      if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value < document.LoadInserisciComunicazioneErgastolo.<%=ICostantiSentenza.CAMPO_MESE_DATA_IRREVOCABILITA%>.value)
       {
         alert("La data del Provvedimento può essere diversa dalla data di sistema solo se è uguale o superiore alla data Irrevocabilità");
         return false;
       }
      else if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value == document.LoadInserisciComunicazioneErgastolo.<%=ICostantiSentenza.CAMPO_MESE_DATA_IRREVOCABILITA%>.value)
        if (document.LoadInserisciComunicazioneErgastolo.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value < document.LoadInserisciComunicazioneErgastolo.<%=ICostantiSentenza.CAMPO_GIORNO_DATA_IRREVOCABILITA%>.value)
       {
        alert("La data del Provvedimento può essere diversa dalla data di sistema solo se è uguale o superiore alla data Irrevocabilità");
        return false;
       }
...
<body class="corpo">
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Comunicazione Concessione Liberazione Anticipata per Condannato in Ergastolo</font>
      </td>
    </tr>
  </table>
  <br>
  ...
  <br>
  <FORM method="POST" name="LoadInserisciComunicazioneErgastolo" action="<%= IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.libertaanticipata.action.ActInserisciComunicazioneLAErgastolo">
...
%>
 ...
 <table width="90%">    
    <tr>
      <td class="l" width="10%">Giorni Concessi</td>
      <td class="l" width="5%" colspan=3>
        <font class="campo">
...
<table style="width: 95%;">
     ...
     <td class="L" colspan="3">
       ...
       <input readonly title= "Nome Magistrato"    value="<%=StringUtils.toStringJSP(magistratocompetente.getMagistrato().getNome() )%>" type="text" name="<%= ICostantiMagistrato.CAMPO_NOME %>"        maxlength="35" size="25">
        <a href="Javascript:ListaMagistrati('LoadInserisciComunicazioneErgastolo');">
...
<%
  if(lLuogoDetenzione != null &&  lLuogoDetenzione.getIstitutoDetenzione()!= null && lLuogoDetenzione.getIstitutoDetenzione().getDescrTipoIstituto()!= null )
  {
%>
    <td class="l" colspan="2">
      ...
      <input type="hidden"  Title="Istituto" name="<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" value="<%=lLuogoDetenzione.getIstitutoDetenzione().getIdIstitutoDetenzione()%>" size=50>
      <a href="Javascript:ListaIstitutoDetenzione('LoadInserisciComunicazioneErgastolo','<%= ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>','Comune');">
        <img src="/images/filefolder.gif" border=0>
      </a>
    </td>
<%
...
%>
      ...
      <td class="L" colspan="3">
        ...
        <a href="Javascript:ListaComuniTds('LoadInserisciComunicazioneErgastolo','<%= ICostantiOrdineScarcerazione.CAMPO_SEDE_TRIBUNALE %>');">
          <img src="/images/filefolder.gif" border=0>
        </a>
      </td>
<%
...
%>
        ...
        <td class="L" colspan="3">
          ...
          <a href="Javascript:ListaUDS('LoadInserisciComunicazioneErgastolo','<%= ICostantiOrdineScarcerazione.CAMPO_SEDE_UDS %>');">
            <img src="/images/filefolder.gif" border=0>
          </a>
        </td>
<%
...
<tr>
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator  = new Validator("LoadInserisciComunicazioneErgastolo");
