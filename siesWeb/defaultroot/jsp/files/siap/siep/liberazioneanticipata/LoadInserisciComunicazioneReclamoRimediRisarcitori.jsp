...
<body class="corpo">
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Comunicazione A Seguito Provvedimento Reclamo Rimedi Risarcitori D.L. 92/2014 Per condannato <% if ("N".equals(flagErgastolo)) {%>Libero<% } else { %>in Ergastolo<% } %></font>
      </td>
    </tr>
  </table>
  ...
  <FORM method="POST" name="LoadInserisciComunicazioneLibero" action="<%= IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.libertaanticipata.action.ActInserisciComunicazioneReclamoRimediRisarcitori">
