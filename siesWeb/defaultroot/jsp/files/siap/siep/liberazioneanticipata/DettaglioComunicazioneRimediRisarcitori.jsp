...
<head>
  <title>[S.I.E.S.] - Dettaglio Rimedi Risarcitori </title>
  ...
  <table>
    <tr>
      ...
      <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
        <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.sico.libertaanticipata.action.ActStampaComunicazioneRimediRisarcitori&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
      </jsp:include>
      <% } %>
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.libertaanticipata.action.ActUploadComunicazioneRimediRisarcitori">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.sico.libertaanticipata.action.ActDettaglioComunicazioneRimediRisarcitori">
        </td>
      </tr>
    </table>
  </form>
