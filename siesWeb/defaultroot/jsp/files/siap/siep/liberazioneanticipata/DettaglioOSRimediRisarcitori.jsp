...
<head>
  <title>[S.I.E.S.] - Dettaglio Ordine Scarcerazione Rimedi Risarcitori </title>
...
<body class="corpo">
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;<%//ticket 20190805017%>
        <font class="campo">Dettaglio Ordine di Scarcerazione a seguito <%=("02".equals(EventoSIUS.getCodTipoProvvedimento()))?"Decreto":"Ordinanza" %> <% if (EventoSIUS.getCodMotivo()!= null && "9027".equals(EventoSIUS.getCodMotivo())) {%> Reclamo<%}%> Rimedi Risarcitori D.L. 92/2014 </font>
      </td>
      ...
      <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
        <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.sico.libertaanticipata.action.ActStampaOSRimediRisarcitori&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
      </jsp:include>
      <% } %>
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.sico.libertaanticipata.action.ActUploadOSRimediRisarcitori">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.sico.libertaanticipata.action.ActDettaglioOSRimediRisarcitori">
        </td>
      </tr>
    </table>
  </form>
