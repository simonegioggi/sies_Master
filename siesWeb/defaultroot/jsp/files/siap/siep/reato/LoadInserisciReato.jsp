...
<title>[S.I.E.S.] - Gestione Reato </title>
	...
	{
	  desktop = window.open("/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=siap.siep.reato.action.ActLoadRicercaReatiFascicoloFramset&formname="+a_formname, "Ricerca_Reati_Fascicolo","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,top=170,left=90,width=700,height=480");
	}      
	...
	function mettidata()
 	{
 		var valueSel = document.LoadInserisciReato.<%=ICostantiReato.CAMPO_COD_PERIODO_CONSUMAZIONE%>.value;
      	   ...
      	   valueSel == '19' || valueSel == '20' || valueSel == '22' || valueSel == '24' || valueSel == '25') 
      	{
			...
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_INIZIO%>.disabled = false;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_INIZIO%>.disabled = false;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_INIZIO%>.disabled = false;   
			
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_FINE%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_FINE%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_FINE%>.disabled = true;	
			
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_FINE%>.value = "";
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_FINE%>.value = "";
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_FINE%>.value = "";			        	
      	}
	  	   ...
	  	   valueSel == '17' || valueSel == '23')
		{
			...
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_FINE%>.disabled = false;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_FINE%>.disabled = false;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_FINE%>.disabled = false;	
        }
        ...
        if(valueSel == '-' || valueSel == '16' || valueSel == '21')
		{
			...
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_INIZIO%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_INIZIO%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_INIZIO%>.disabled = true;   
            
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_FINE%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_FINE%>.disabled = true;
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_FINE%>.disabled = true;	
			
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_GIORNO_DATA_INIZIO%>.value = "";
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_MESE_DATA_INIZIO%>.value = "";
			document.LoadInserisciReato.<%= ICostantiReato.CAMPO_ANNO_DATA_INIZIO%>.value = "";   
...
<%
        ...
        {
          lAzione = "siap.sige.reato.action.ActInserisciReatoSige";
  ...
  <tr>
    ...
    if (siap.util.SIESSwitch.isRegeSiesOn()) {
        ...
        <td class="L"><font class="campo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reati Predisposti</font>          
			<a href="Javascript:ListaReatiPredisposti('LoadInserisciReato');">
            <img src="/images/filefolder.gif" border="0">
          </a>
        </td>    
        <td class="L"><font class="campo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copia Reati</font>          
			<a href="Javascript:ListaCopiaReati('LoadInserisciReato');">
            <img src="/images/filefolder.gif" border="0">
          </a>
        </td>
        <%
...
%>
  ...
  <tr>
   ...
   <%    
  	//  <strong>N11 Bis</strong>&nbsp;<input type="checkbox" name="cablati61B" value="61 01 N11 BIS">
    %>  
    </td>
  </tr>
  </table>
  ...
  <%     
   //	  <strong>N8 Bis</strong>&nbsp;<input  type="checkbox" name="cablati625BtB" value="625 01 N8 BIS">
   //	  <strong>N8 Ter</strong>&nbsp;<input  type="checkbox" name="cablati625BtT" value="625 01 N8 TER">
  %>   
