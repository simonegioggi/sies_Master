...
<html>
<head>
  <title>[S.I.E.S.] - Continuazione Reati </title>
...
<body class="corpo">
        ...
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
         <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
           <font class="campo">Gestione Continuazione Reati</font>
         </td>
</tr>
</table>
<br>
...
<br>         
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadModificaContinuazioneReati">
<input type="hidden" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.reato.action.ActModificaContinuazioneReati">
<input value="" type="hidden" name="strtipocont">
<input value="" type="hidden" name="strreaticont">
<table width="40%"> 
<tr><td class="TitoloNoCap" colspan=2><b>Reati</b></td>
		...
		String lProgressivo = new String();
      	...
      	while ( itx.hasNext()) {
	        ...
	        %>
	            <tr>
	            	<td class="l" valign="top"><input type="checkbox" name="chkReati" value="<%=lReato.getProgrReato().toString()%>@!<%=lProgressivo%>"></td>
...
<tr>
	<td class="campo"><input type="radio" name="tipoContinuazione" value="C1">81 CP C1

	 <input type="radio" name="tipoContinuazione" value="C2">81 CP C2</td>
</tr>
<tr height=50 valign=bottom>
<td><input type="button" name="conferma" value="Conferma" style="width: 90" onClick="creaStringhe();">
...
<script>
f = document.LoadModificaContinuazioneReati;
