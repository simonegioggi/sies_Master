...
<jsp:useBean id="stringareato" scope="request" class="java.util.Vector"/>
...
function addNorme() {		
	...
	for (i=0; i < f.chkReati.length; i++) {
		...
		if (f.chkReati[i].checked) {
			...
			//if (!isNormaPresenteInLista(arrStrNorma[0])) {
				
				//if (!isNormaPresenteInArray(arrStrNorma[0])) {
...
<body class="corpo">
        ...
        <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
         <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
           <font class="campo">Organizzazione Reati</font>
         </td>
</tr>
</table>
<br>
...
<br>         
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="OrgReati">
<input type="hidden" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.reato.action.ActOrganizzaReati">
<input value="" type="hidden" name="strreatinorme">
<table width="40%"> 
		...
		String lProgressivo = new String();
      	...
      	while ( itx.hasNext()) {
	        ...
	        %>
		        ...
		        <%
		        	strReato = (String)stringareato.get(contReato);
		        %>
            ...
            %>
	            <tr>
	            	<td width="10%"><input type="checkbox" name="chkReati" value="<%=lReato.getIdReato().toString()%>@!<%=strNorma%>" DISABLED></td>
	            <td align="left">
...
<script language="Javascript">
		...
		<%
			ReatoModel lReato2 = new ReatoModel();
			String lProgressivo2 = new String();
			String strValue = new String();
			Iterator itx2 = reati.iterator();
			int ind1 = 0;
			int ind2 = 0;
			int contNorme2 = 0;
			...
			while (itx2.hasNext()) {
				...
				strValue = lReato2.getIdReato().toString() + "@!" + strNorma;
				%>
