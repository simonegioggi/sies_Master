...
%>   
	   ...
	   <%
		    	if(lReato.getDescrTipoReato() != null && !lReato.getDescrTipoReato().equals("") && !lReato.getDescrTipoReato().equals("-") &&
		    	   lReato.getDescLuogo() != null && !lReato.getDescLuogo().equals(""))
		    	{
	%>     
		        	<tr>
			...
			<%	} 
			    if(lReato.getCodPeriodoConsumazione() != null && !lReato.getCodPeriodoConsumazione().equals("") && !lReato.getCodPeriodoConsumazione().equals("-"))
			    {
	%>
						<tr>	
...
<% 			
	...
	else if (notFound.equals("F")) 
	{
	   ...
	   <p>&nbsp;</p>
	    <p>&nbsp;</p>
	    <p>
	      <CENTER><STRONG><font color="red">FASCICOLO NON TROVATO</font></STRONG></CENTER>
		</p>	
		<%
	}
	else if (notFound.equals("R")) 
	{
	   ...
	   <p>&nbsp;</p>
	    <p>&nbsp;</p>
	    <p>
	      <CENTER><STRONG><font color="red">NESSUN REATO TROVATO</font></STRONG></CENTER>
		</p>	
