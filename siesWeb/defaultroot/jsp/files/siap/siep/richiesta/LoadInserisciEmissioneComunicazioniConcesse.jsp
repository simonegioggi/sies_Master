...
// caso di Indulto e Amnistia. Viene utilizzata sia nel caso delle 'Richieste al GE' 
// che nel caso delle 'Decisioni del GE'
...
// codice:
// - 0301 Decisioni del GE
// - 0298 Richieste al GE
//==============================================================================
%>
<%
...
<html>
  <head>
    ...
    function Verify()
    {
	  ...
	  {
	        alert("Inserire Sede Autorità del primo Destinatario");
	  ...
	  if(document.f.<%=ICostantiRichiesta.AUTORITA_DESTINATARIO%>.value == "-" &&
		  document.f.<%=ICostantiRichiesta.AUTORITA_SEDE%>.value != "" )
	  {
	        alert("Inserire Tipo Ufficio Autorità del primo Destinatario");
	        document.f.<%=ICostantiRichiesta.AUTORITA_DESTINATARIO%>.focus();
	        return false;		  
	  }	
      
      if( document.f.<%=ICostantiRichiesta.AUTORITA_SEDE%>.value=="" && document.f.<%=ICostantiRichiesta.AUTORITA_DESTINATARIO%>.value == "-"
      	 && ( document.f.Autorita1.value=="-" || ( document.f.Sede1.value==""	|| document.f.Sede1.value=="-" ) )
   		 && ( document.f.Autorita2.value=="-" || ( document.f.Sede2.value==""   || document.f.Sede2.value=="-" ) )  )

      {
	        alert("Almeno un destinatario è obbligatorio");
	        return false;
      }
  ...
  <table>
    <tr>
      ...
      <td class=lbg>
        ...
        <%if(codice.equals("0301")){%>
        <font class="campo">Concessione Benefici ex. art. 672 cpp</font>
        <%}else if(codice.equals("0298")){%>
...
%>
  ...
  <%
  //============================================================================
  // Sezione con i dati della richiesta
  //============================================================================
  %>
  ...
  <%
    ...
    %>
    <%
    if(lAnn.getAnnoGe() != null || lAnn.getNumeroGe()!= null)
    {
    %>
      ...
      <td class="l">
        <font class="campo">
        	<%=StringUtils.toStringJSP(lAnn.getAnnoGe())%> / <%=StringUtils.toStringJSP(lAnn.getNumeroGe())%>
        </font>
      </td>
    <%
    }
...
%>
  ...
  <table style="width: 95%;">
	...
	<%-- MERGE v10: commentato campo nascosto
    ...
    <tr>
      <td class="l">Sede </td><td class="L">
        <input title="Sede Destinatatio 1" value="" type="text" name="Sede1"  maxlength="35" size="35">
    ...
    <tr>
      <td class="l">Sede </td><td class="L">
        <input title="Sede Destinatatio 2" value="" type="text" name="Sede2"  maxlength="35" size="35">
