...
<%
//==============================================================================
// Form per la visualizzazione del dettaglio della Cominicazione di Richiesta o
// Concessione di Indulto (Richieste del GE o Deccisioni del GE)
// La form consente di produrre la stampa e validare l'evento
// 0301 - Decisione del GE - Indulto
...
<%
      ...
      {
%>
        <font class="campo">Dettaglio Concessione Benefici ex. art. 672 cpp</font>
<%
      }
...
<%--td class="LBG">
  <a href="/jsp/Main.jsp?Action=siap.siep.richiesta.action.ActStampaEmissioneComunicazioni&IdEvento=<%= eventonotifica.getEvento().getIdEvento() %>&codice=<%=codice%>" onclick="javascript:lookUpload();">
