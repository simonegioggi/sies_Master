...
<%
        if (eventonotifica.getEvento().getCodMotivo().equals("0295"))
        {
%>
          <font class="campo">Restituzione Ordine Esecuzione ex art. 673 c.p.p.</font>
<%
        }
        else
        {
%>
          <font class="campo">Revoca sentenza ex art.673 c.p.p.- Depenalizzazione</font>
<%
        }
%>
      </td>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.richiesta.action.ActStampaRichiesteDepIncost&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%
  }
...
<table width="100%">
  ...
  <tr><td>&nbsp;</td></tr>
<%
  String codice= eventonotifica.getEvento().getCodMotivo();
%>
  </table>
  <table width="80%">
<%
...
/*
    ...
    {
*/
    if( "004".equals( lAnnManApp.getCodTipoAnnotazione() )  // DEPENALIZZAZIONE
       	// MEV 37 - Inizio	
...
<%
  ...
  if(codice.equals("0293") && eventonotifica.getEvento().getCodMotivo().equals("0211") && lAnnPrima.getDataCC()!= null )
  {
%>
...
%>
    <tr>
      ...
      <td class="l"><font class="campo">
          ...
          {%>
      		<%=eventonotifica.getNotifiche()[0].getAutoritaEsterna().getDescrTipoAutorita()%></font>
      	<%} %>
      </td>
    </tr>
    <tr>
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.richiesta.action.ActUploadRichiesteDepIncost">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.richiesta.action.ActDettaglioRichiesteDepenIncost">
        </td>
      </tr>
    </table>
  </form>
