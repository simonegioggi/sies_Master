...
function Verifica()
{
      ...
      if (document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
       document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_GIORNO_DATA_EMISSIONE%>.value;
      if (document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
       document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_MESE_DATA_EMISSIONE%>.value;
        var data_to_verify = document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciVerbaleArresto.<%=ICostantiVerbale.CAMPO_ANNO_DATA_EMISSIONE%>.value;
      if (! ControllaData(data_to_verify))
      {
 ...
 <%
       ...
       SoggettoModel lSoggetto = new SoggettoModel();
			 ...
			 String lAzione = new String();
			   lAzione = "siap.siep.verbale.action.ActInserisciVerbale";
			%><font class="campo">Inserimento Verbale di Arresto</font>
    ...
    <br>
     ...
     <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.verbale.action.ActInserisciVerbaleArresto">
    ...
    <tr>
      ...
      <tr>
        ...
        <tr>
            ...
            <a href="Javascript:ListaComuni('LoadInserisciVerbaleArresto','<%= ICostantiVerbale.CAMPO_COD_LUOGO_UFFICIO_FIRMATARIO %>');">
 ...
 <%//modifica relativa al tipo istituto%>
        ...
        <%--td class="l">
          <select title="TipoIstituto" name="<%=ICostantiLuogoDetenzione.CAMPO_COD_TIPO_ISTITUTO%>">
            <%=tipoIstituto%>
          </select>
        </td>
      </tr>
        <tr>
            <td class="l">Luogo di detenzione</td>
            <td class="L">
            <input title="Luogo Istituto" value="<%=StringUtils.toStringJSP(lSoggetto.getDescrComuneNascita()) %>" type="text" 
            	name="<%= ICostantiLuogoDetenzione.CAMPO_COD_LUOGO  %>"  maxlength="35" size="35">
            <a href="Javascript:ListaComuni('LoadInserisciVerbaleArresto','<%= ICostantiLuogoDetenzione.CAMPO_COD_LUOGO %>');">
            <img src="/images/filefolder.gif" border=0>
            </a>
            </td--%>
 <%//fine modifica relativa al tipo istituto%>
