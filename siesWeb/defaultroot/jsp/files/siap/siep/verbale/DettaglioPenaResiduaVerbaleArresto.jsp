...
<script language="JavaScript">
  function Verify()
	{
    if(document.DettaglioVerbaleArrestoFinePena.GPV.value!="" && document.DettaglioVerbaleArrestoFinePena.MPV.value!="" && document.DettaglioVerbaleArrestoFinePena.APV.value!="")
    {
      if (document.DettaglioVerbaleArrestoFinePena.GPV.value.length==1)
        document.DettaglioVerbaleArrestoFinePena.GPV.value='0'+document.DettaglioVerbaleArrestoFinePena.GPV.value;
      if (document.DettaglioVerbaleArrestoFinePena.MPV.value.length==1)
        document.DettaglioVerbaleArrestoFinePena.MPV.value='0'+document.DettaglioVerbaleArrestoFinePena.MPV.value;

      var data_to_verify = document.DettaglioVerbaleArrestoFinePena.GPV.value+'/'+document.DettaglioVerbaleArrestoFinePena.MPV.value+'/'+document.DettaglioVerbaleArrestoFinePena.APV.value;
...
<form name="DettaglioVerbaleArrestoFinePena" method="POST" action="/jsp/Main.jsp">
  ...
  <table cellspacing=4 cellpadding=4 >
      ...
      <td class="l">Istituto di Detenzione</td>
			<td class="l">
        <font class="campo">
          <%=StringUtils.toStringJSP(lIstitutoDetenzione.getDescrTipoIstituto())%>
        </font>&nbsp;
<%
...
<%
//==============================================================================
//                   Visualizzazione dettaglio della Pena
//==============================================================================
%>
  <table>
    <tr>
...
<table>
  <tr>
    ...
    if(penaresidua != null && (penaresidua.getFlagErgastolo() == null || penaresidua.getFlagErgastolo().equals("N")))
    {
      // Fine pena Automatica e fine pena manuale (solo se non provengo dal dettaglio)
    %>
      <% /* REWORK DETTAGLIO */
      ...
      <tr>
        <td class="l"colspan=4><font  class="label">Data Fine Pena Manuale : </font>
          <input type="text" name="GPV" maxlength="2" size="2" value="">
          /
          <input type="text" name="MPV" maxlength="2" size="2" value="">
          /
          <input  type="text" name="APV" maxlength="4" size="4" value="">
          &nbsp;&nbsp;&nbsp;
        </td>
      </tr>
      <%}%>
...
<script language="JavaScript" type="text/javascript">
  ...
  var frmvalidator  = new Validator("DettaglioVerbaleArrestoFinePena");
