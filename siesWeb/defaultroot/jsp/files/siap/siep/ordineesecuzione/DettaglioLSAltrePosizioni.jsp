...
<jsp:useBean id="datadecreto"       scope="request" class="java.lang.String"/>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Ordine Esecuzione Simeone - <%=lPosizione.getDescrPosizioneGiuridica()%></font>
</td>
<%
...
<%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
     <%--td class="LBG">
          <a href="/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaLSAltrePosizioni&finePena=<%=finePena%>&istanza=<%=flagIstanza%>&fc=<%=fogliocomplementare%>&IdEvento=<%= lEve.getEvento().getIdEvento() %>" onclick="javascript:lookUpload();">
            <img  align="middle" src="/images/print24.gif" alt="Generazione Stampa" width="24" height="24" border="0">
          </a>
        </td>--%>
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaLSAltrePosizioni&finePena="+finePena+"&istanza="+flagIstanza+"&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
 <%}%>
    ...
    <% if ((penaresidua.getNumAnniArresto().compareTo(new BigDecimal(0))==0) &&
      ...
      <%}
   	  ...
   	  %>
          ...
          <td class="L" colspan="1"><font class="campo"><%=StrdataFinePenaA%></font> </td--%>
<%--          <%//}%> --%>
<tr>
<%
...
<%//modifica relativa al tipo istituto%>
         ...
         <font class="campo">
          <-%=StringUtils.toStringJSP( lEve.getNotifiche()[0].getIstitutoDetenzione().getDescrTipoIstituto() )%>
        </font>&nbsp;
          di
        <font class="campo">
          <-%=StringUtils.toStringJSP( lEve.getNotifiche()[0].getIstitutoDetenzione().getDescrComune())%>
        </font>&nbsp;
<%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
        <%--font class="campo"><%=StringUtils.toStringJSP( lEve.getNotifiche()[0].getAutoritaEsterna().getDescrTipoAutorita() )%></font>&nbsp;
        di
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioLSAltrePosizioni">
          </td>
        </tr>
      </table>
    </FORM>
