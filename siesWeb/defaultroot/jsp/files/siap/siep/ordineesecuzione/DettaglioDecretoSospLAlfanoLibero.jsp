...
<%
 ...
 // Gestione Autorità Esterne sulla prima Notifica
  ...
  String lTitolo = "Decreto di Sospensione legge 199/2010 - condannato libero";    
%>
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font class="label">Funzione :</font>&nbsp;
            ...
            <font class="campo">Dettaglio Decreto Sospensione Legge 199/2010 Libero </font>
				  ...
				  if((lEve.getEvento().getFlagDocumentoRegistrato()==null) ||
				    ...
				    {%>
						...
						<jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
							<jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaDecretoSospLAlfanoLibero&autorita="+lCodTipoAutorita+"&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
						</jsp:include>
					<%}
						if((lEve.getEvento().getFlagDocumentoRegistrato()!=null) &&
...
<%if(lEve.getNotifiche()[count+1].getUfficio()!=null){%>
   <tr>
      <td class="l">Destinatario</td >
      <td class="L"><font class="campo">TRIBUNALE DI SORVEGLIANZA</font> di <font class="campo">
      <%=StringUtils.toStringJSP(lEve.getNotifiche()[count+1].getUfficio().getDescrComune())%>
      </font></td>
   </tr>
<%}%>
  ...
  for (int i = 0; i < lEve.getNotifiche().length; i++)
	{
		// La notifica corrispondente al Casellario Giudiziale corrisponde al tipo "C"
		if(lEve.getNotifiche()[i] != null &&
			 lEve.getNotifiche()[i].getCodTipoNotifica().equals("R") &&
			 lEve.getNotifiche()[i].getAutoritaEsterna() != null  &&
			 lEve.getNotifiche()[i].getAutoritaEsterna().getCodTipoAutorita()!= null &&
			 lEve.getNotifiche()[i].getAutoritaEsterna().getCodSede()!= null )
		{%>
      <tr>
      ...
      <%if(lEve.getNotifiche()[i].getNote()!= null && !lEve.getNotifiche()[i].getNote().equals("")) {%>
        <tr>
          <td class="l">Indirizzo</td>
          <td class="l">
            <font class="campo"><%=lEve.getNotifiche()[i].getNote()%>&nbsp;</font>
          <td>
        </tr>
      <%}%>
      <tr>
        ...
        <tr>
          <td class="L">
            <input  class=bottone type="submit" value="Conferma">
             <input type="hidden" name="autorita" value="<%=lCodTipoAutorita%>">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioDecretoSospLAlfanoLibero">
          </td>
        </tr>
      </table>
    </FORM>
