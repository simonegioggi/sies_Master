...
<%
  ...
  String lTitolo = "Ordine esecuzione legge 199/2010 - condannato libero";
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Ordine esecuzione legge 199/2010 - condannato libero  </font>
        </td>
        ...
        {%>
           <tr>
             ...
             <td class="L" colspan=3>
              <font class="campo">
                <%=lAltraCausa.getIstitutoDetenzione().getDescrTipoIstituto()%>
              </font> 
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioLAlfanoLibero">
          </td>
        </tr>
      </table>
    </FORM>
