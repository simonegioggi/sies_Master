...
if (lSoggettoAssociato != null && (!"039".equals(lSoggettoAssociato.getCodStatoNascita()))) {
	lCasellario = "ROMA";
}
if (lSoggettoAssociato != null && (lSoggettoAssociato.getCodStatoNascita() == null
		||  "".equals(lSoggettoAssociato.getCodStatoNascita()) || "-".equals(lSoggettoAssociato.getCodStatoNascita()))) {
	lCasellario = "-";
}
%>
...
%>
	if (document.LoadInserisciOrdineEsecuzione.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value==""
			&& document.LoadInserisciOrdineEsecuzione.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="") {
...
%>
			<font class="campo">Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO <%=lPosizione.getDescrPosizioneGiuridica()%></font>
<%
		}
  	}
...
%>
			<font class="campo">Modifica di Ordine di Esecuzione Sospensione Simeone - <%=lPosizione.getDescrPosizioneGiuridica()%></font>
<%
}
%>
		</td>
...
<input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordineesecuzione.action.ActInserisciOrdineEsecuzioneSimeoneSanSos">
...
<% 
	if (lAltraCausa.getDescrTipoPosGiuridica() != null
			&& !"".equals(lAltraCausa.getDescrTipoPosGiuridica())
			&& !"-".equals(lAltraCausa.getDescrTipoPosGiuridica())) {						    
%>
...
%>
          ...
          <%}
      					...
      					&& !"".equals(lLuogoDetenzione.getDescrTipoIstituto())
      					&& !"-".equals(lLuogoDetenzione.getDescrTipoIstituto())
      				)
   ...
   {%>
    <tr>
   	...
   	<tr>
		...
		<td class="l" colspan=3>UFFICIO DI ESECUZIONE PENALE ESTERNA<input type="hidden" value="SSPA"></td>
	</tr>
	<tr>
		<td class="l">Sede<font class=ob>(*)</font></td>
      	<td class="l">
	...
	<tr>
   	...
   	<tr>
		<td class="l">Destinatario</td>
        <td class="l" colspan=3>UFFICIO DI SORVEGLIANZA<input type="hidden" value="UDS"></td>
  	</tr>
  	<tr>
  		<td class="L">Sede <font class=ob>(*)</font></td>
  		<td class="L">
...
if (istanza != null && istanza.getIdEvento() != null) {
	FlagIstanza="S";
%>
	<tr><td><input type="hidden" name="IdIstanza" value="<%=istanza.getIdEvento()%>"></td></tr>
<%
} else {
	FlagIstanza="N";
}
%>
	<tr><td><input type="hidden" name="istanza" value="<%=FlagIstanza%>"></td></tr>
<%
if (((istanza != null) && (istanza.getIdEvento()!=null))
		|| (lPosizione.getCodPosizioneGiuridica().equals("04"))
