...
<%
  ...
  String lTitolo = "Ordine esecuzione legge 199/2010 - " + lPosizione.getDescrPosizioneGiuridica();
  ...
  if((lEve.getEvento().getFlagDocumentoRegistrato()==null) ||
    ...
    {%>
		...
		<jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
			<jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaLAlfanoNonLibero&autorita="+lCodTipoAutorita+"&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()+"&IdPosizioneGiuridica="+lPosizione.getCodPosizioneGiuridica()%>"/>
		</jsp:include>
	<%}
		if((lEve.getEvento().getFlagDocumentoRegistrato()!=null) &&
    ...
    <td class="LBG">
    	<a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.ordineesecuzione.action.ActLoadTrasferisciProvvedimentoLAlfano&autorita=<%=lCodTipoAutorita%>&fc=<%=fogliocomplementare%>&IdEvento=<%=lEve.getEvento().getIdEvento()%>&titolo=<%=lTitolo%>">
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordineesecuzione.action.ActUploadLAlfano">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioLAlfanoNonLibero">
          </td>
        </tr>
      </table>
    </FORM>
