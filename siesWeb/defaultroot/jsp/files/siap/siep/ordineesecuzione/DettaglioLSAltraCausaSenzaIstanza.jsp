      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font class="label">Funzione :</font>&nbsp;
            ...
            <font class="campo">Dettaglio Legge 165/98 Detenuto Altra Causa  </font>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaLSAltraCausa&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%}%>
  ...
  <br>
   ...
   <table>
      <tr>
	      ...
	      <%   	  
	      if (lFascicoloAssociato!=null && dettagliofascicolo!=null && dettagliofascicolo.getPosizioneGiuridica()!=null && 
	    	  lFascicoloAssociato.getFlagAltraCausa() != null && lFascicoloAssociato.getFlagAltraCausa().equals("S") &&
	    	  dettagliofascicolo.getAltraCausa()!=null && dettagliofascicolo.getAltraCausa().getDescrTipoPosGiuridica()!=null
	    	 )
	      {
	      %>
	      	<td class="L" colspan=3><font class="campo"><%=StringUtils.toStringJSP(dettagliofascicolo.getAltraCausa().getDescrTipoPosGiuridica())%></font> </td>      	
	      <% } else {%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioLSAltraCausa">
          </td>
        </tr>
      </table>
    </FORM>
