...
<%
if (lPosizione.getCodPosizioneGiuridica().equals("02") || lPosizione.getCodPosizioneGiuridica().equals("71")) {
%>
...
<!-- MEV 16 CUMULO: aggiunto onload su segnalazione Mic. Tes. -->
<body class="corpo" onload="toggleComuneCasellario();">
  <table>
        ...
        if( modalita.equals("I") )
          ...
          lProvvedimento = new EventoModel(evento);
               if (lPosizione.getCodPosizioneGiuridica().equals("01")) { %>
                <font class="campo">Ordine di Esecuzione con sospensione (LEGGE 199/2010) - CUST. CAUT. PER QUESTA CAUSA IN REGIME DI DETENZIONE</font>
            <% } else { %>
            ...
            <% if (lPosizione.getCodPosizioneGiuridica().equals("03")) { %>
                <font class="campo">Ordine di Esecuzione con sospensione (LEGGE 199/2010) - ESPIAZIONE IN REGIME CARCERARIO</font>
            <% } else {%>
...
%>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordineesecuzione.action.ActInserisciOrdineEsecuzioneLAlfanoNonLibero">
    <table>
      <tr>
...
<!--Notifica per l'Ente di Sorveglianza -->
  ...
  <tr>
      ...
      <a href="Javascript:ListaUDS('LoadInserisciOrdineEsecuzione','<%= ICostantiOrdineEsecuzione.CAMPO_COD_SEDE_UDS_NOTIFICA%>');">
        <img src="/images/filefolder.gif" border=0>
      </a>
    </td>
    <td class="l">Note</td>
