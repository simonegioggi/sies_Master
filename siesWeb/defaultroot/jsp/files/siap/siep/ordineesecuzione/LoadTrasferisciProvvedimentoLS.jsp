...
<head>
  ...
  <script language="JavaScript">
    ...
    {
    	var codTipoSede = document.TrasferisciProvvedimentoLS.<%=ICostantiIstanza.CAMPO_COD_TIPO_UFFICIO_DESTINATARIO%>.value
...
<%
        ...
        lAction = "siap.siep.ordineesecuzione.action.ActConfermaTrasmissioneProvvedimentoLS";
%>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        <td class="l">Sede Destinatario </td><td class="L">
          <input title="Sede Destinatario"  value="<%=sedetribunale%>" type="text" name="<%= ICostantiIstanza.CAMPO_COD_LUOGO_DESTINATARIO %>"  maxlength="35" size="35">
            <a href="Javascript:ListaComuniTds('TrasferisciProvvedimentoLS','<%= ICostantiIstanza.CAMPO_COD_LUOGO_DESTINATARIO %>');">
