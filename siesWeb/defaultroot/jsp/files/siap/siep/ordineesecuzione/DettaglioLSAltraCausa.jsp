      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font class="label">Funzione :</font>&nbsp;
            ...
            <font class="campo">Dettaglio Legge 165/98 Detenuto Altra Causa Istanza Prodotta </font>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaLSAltraCausaIstanza&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
...
<%if(lEve.getNotifiche() != null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[0].getIstitutoDetenzione() != null){%>
     ...
     <tr>
<%if(lEve.getNotifiche() != null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[0].getNote() != null){%>
...
<%}%>
<%if(lEve.getNotifiche() != null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[count].getNote() != null){%>
...
%>
<%
	if(lEve.getNotifiche() != null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[count+1].getUfficio()!=null)
	{
%>
    <tr>
...
%>
<%
	if(lEve.getNotifiche() != null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[count+1].getNote() != null)
	{
%>
    <tr>
      <td class="l">Note</td>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioLSAltraCausaIstanzaProdotta">
          </td>
        </tr>
      </table>
    </FORM>
