...
<jsp:useBean id="dataperv"       scope="request" class="java.util.Date"/>
...
<body class="corpo">
  ...
  <form method="POST" name="LoadInserisciOrdineEsecuzione" action="<%=IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordineesecuzione.action.ActInserisciVariazioneDecorrenzaScadenza">
    ...
    <input type="HIDDEN" value="<%=ggdataperv%>" name="<%= ICostantiOrdineEsecuzione.CAMPO_GIORNO_PERVENIMENTO_VARIAZIONE %>">
    <input type="HIDDEN" value="<%=mmdataperv%>" name="<%= ICostantiOrdineEsecuzione.CAMPO_MESE_PERVENIMENTO_VARIAZIONE %>">
    <input type="HIDDEN" value="<%=aadataperv%>" name="<%= ICostantiOrdineEsecuzione.CAMPO_ANNO_PERVENIMENTO_VARIAZIONE %>">
...
%>
       <tr>       
          <td class="l">Data pervenimento richiesta variazione</td>
			<td class="L" colspan="1"><font class="campo"><%=ggdataperv%>-<%=mmdataperv%>-<%=aadataperv%></font></td>
       </tr>
       <tr>       
