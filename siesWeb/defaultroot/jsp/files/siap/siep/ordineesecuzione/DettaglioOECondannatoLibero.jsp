    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Ordine Esecuzione Condannato Libero</font>
        </td>
...
{%>
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaOECondannatoLibero&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%}%>
...
<%}%>
  ...
  <table>
   ...
   //modifica relativa al tipo istituto
         ...
         if(lAltraCausa.getIstitutoDetenzione() != null)
           if(lLuogoDetenzione!=null && lLuogoDetenzione.getDescrTipoIstituto()!= null && !lLuogoDetenzione.getDescrTipoIstituto().equals("") && !lLuogoDetenzione.getDescrTipoIstituto().equals("-"))
	         {%>
	          <tr>
	           <td class="l">Detenuto presso </td>
...
%>
             <tr>
               ...
               <td class="L" colspan="2">
                <% if (lEve.getAvvocati()[lIndex]!=null && lEve.getAvvocati()[lIndex].getAvvocato()!=null)
                {%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.ordineesecuzione.action.ActLoadDettaglioOELibero">
          </td>
        </tr>
      </table>
    </FORM>
