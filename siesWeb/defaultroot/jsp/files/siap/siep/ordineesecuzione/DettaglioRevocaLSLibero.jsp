      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font class="label">Funzione :</font>&nbsp;
            ...
            <font class="campo">Dettaglio Revoca Decreto Sospensione e Ordine Esecuzione (legge 165/98) - condannato Libero  </font>
...
<%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
     <%--td class="LBG">
          <a href="/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaRevocaLSLibero&autorita=<%=lEve.getNotifiche()[0].getAutoritaEsterna().getCodTipoAutorita()%>&fc=<%=fogliocomplementare%>&IdEvento=<%= lEve.getEvento().getIdEvento() %>" onclick="javascript:lookUpload();">
            <img  align="middle" src="/images/print24.gif" alt="Generazione Stampa" width="24" height="24" border="0">
          </a>
        </td--%>
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaRevocaLSLibero&autorita"+lEve.getNotifiche()[0].getAutoritaEsterna().getCodTipoAutorita()+"&fc="+fogliocomplementare+"&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
 <%}%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActDettaglioRevocaLSLibero">
          </td>
        </tr>
      </table>
    </FORM>
