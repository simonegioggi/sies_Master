  ...
  <table>
    <tr>
     ...
     <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
       <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaVariazioneDecorrenzaScadenza&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
     </jsp:include>
      ...
      <td class="l" colspan=1><font class="campo"><%=StringUtils.toEuroFormat(penaresidua.getImportoAmmenda())%></font>&nbsp;<font class="l">Euro</font></td>
       ...
       <tr>       
          <td class="l">Data pervenimento richiesta variazione</td>
			<td class="L" colspan="1"><font class="campo"><%=DateUtils.getDateToString(lEve.getEvento().getDataRicezioneAtti(), "dd-MM-yyyy")%></font></td>
       </tr>
       <tr>       
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.ordineesecuzione.action.ActDettaglioVariazioneDecorrenzaScadenza">
          </td>
        </tr>
      </table>
    </FORM>
