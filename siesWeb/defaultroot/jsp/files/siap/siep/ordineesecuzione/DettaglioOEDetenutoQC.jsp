...
%>
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaOEDetenutoQC&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
...
%>
    ...
    <tr>
     ...
     <tr>
      ...
      <td class="L" colspan=2>
<%//modifica relativa al tipo istituto
if((lEve.getNotifiche()!= null) && (lEve.getNotifiche().length >0) &&(lEve.getNotifiche()[0]!= null) &&(lEve.getNotifiche()[0].getIstitutoDetenzione()!= null))
{%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActLoadDettaglioOEDetenutoQC">
          </td>
        </tr>
      </table>
    </FORM>
