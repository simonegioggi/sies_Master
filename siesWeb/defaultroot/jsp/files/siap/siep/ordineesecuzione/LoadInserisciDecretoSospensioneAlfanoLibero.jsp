...
<html>
  <head>
    <title>[S.I.E.S.] - Decreto di Sospensione Esecuzione presso il Domicilio - Condannato Libero</title>
      ...
      function ListaCSSA(a_formname,a_fieldname,a_field2)
      {
        desktop = window.open("<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sico.cssa.action.ActLoadListaCSSAFiltroComune&formname="+a_formname+"&fieldname="+a_fieldname+"&field2="+a_field2, "Ricerca_CSSA","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=500,height=500");
  		...
  		function Verify()
  		{
		  	...
		  	if( document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiOrdineEsecuzione.FOGLIO_COMPLEMENTARE%>.checked == true )
		  	{
       		if (   document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE_CAS %>.value == '-' 
       		    || document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE_CAS %>.value == '' 
       		   )
          {
            ...
            return false;
		  	...
		  	if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
			  	document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value;
		  	if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
			  	document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value;

		  	var data_to_verify = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE%>.value;
        ...
        if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value.length==1)
			  	document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value;
		  	if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value.length==1)
			  	document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value;

		  	var data_to_verify = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiNotifica.CAMPO_ANNO_DATA_INVIO%>.value;

      	var campo = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA %>.value;
...
<%
        ...
        {
%>
          if(document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>[document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.selectedIndex].value == '-' )
          {
            alert("Il campo Autorità Destinazione  è obbligatorio!");
            document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E %>.focus();
...
<%
				...
				{
%>
       		if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAltraCausa.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>.value == '-' )
          {
            alert("Il campo Autorità Destinazione è obbligatorio!");
            document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAltraCausa.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>.focus();
...
<%
      ...
      {
%>
      	if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[0][document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[0].selectedIndex].value == '-')
				{
          alert("Il campo Autorità per la Notifica  di un Condannato Libero è obbligatorio!");
          document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA %>[0].focus();
			    
			    return false;
		  	}
        
        if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[1][document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[1].selectedIndex].value == '-')
        {
	        alert("Il campo Autorità per la  Notifica di un Condannato Libero è obbligatorio!");
	        document.LoadInserisciDecretoSospensioneAlfanoLibero.<%= ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA %>[1].focus();
	        return false;
        }
<%
			}
			...
			{
%>
				if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex].value == '-')
				{
...
%>
    	...
    	if(document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="" && document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
      {
        alert("Il Magistrato è obbligatorio");
        return false;
      }

    	if( 	 document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '10'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '07'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '02'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '04'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '16'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '20'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '46'
     			&& document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>.value != '46')

     {
       if(document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>.value == "")
       {
			...
			if ( ((penaresidua.getFlagErgastolo() == null) || (penaresidua.getFlagErgastolo() != null && !penaresidua.getFlagErgastolo().equals("S") && !penaresidua.getFlagErgastolo().equals("D"))))
 			{
  			...
  			{
%>
			    if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value.length==1)
					  document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value;
				  if (document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value.length==1)
					  document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value='0'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value;
		
				  var data_to_verifica = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value+'/'+document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiPenaResidua.CAMPO_ANNO_DATA_FINE%>.value;
...
%>
    if(document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiOrdineEsecuzione.CAMPO_COD_SEDE_UDS%>.value == "")
    {
      alert("Sede dell'Ente di Sorveglianza obbligatorio");
	    document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiOrdineEsecuzione.CAMPO_COD_SEDE_UDS%>.focus();
      return false;
    }
  }
    ...
    {
      var codTipoSede = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiOrdineEsecuzione.CAMPO_TIPO_UFFICIO_UDS%>.value;
	  
      if(codTipoSede=="" || codTipoSede=='-')
	  {
	  	alert("Ufficio Destinatario in Notifica Ente di Sorveglianza è obbligatorio");       
	  } else {
		  <%-- var i = document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiOrdineEsecuzione.CAMPO_TIPO_UFFICIO_UDS%>.selectedIndex; --%>
	      //if ( i == 1 )
    ...
    function VisualizzaOE()
    {
      ...
      if(document.LoadInserisciDecretoSospensioneAlfanoLibero.<%=ICostantiSospensione.CAMPO_RESTITUZIONE_OE%>.checked == true)
      {
...
<%
        ...
        if(lFascicoloAssociato.getFlagAltraCausa()!=null && lFascicoloAssociato.getFlagAltraCausa().equals("S"))
			   {%>
            <font class="campo">Decreto di Sospensione Esecuzione presso il Domicilio (LEGGE 199/2010) - DETENUTO PER ALTRA CAUSA</font>
			   <%}else{%>
            <% if (lPosizione.getCodPosizioneGiuridica().equals("02")) { %>
                <font class="campo">Decreto di Sospensione Esecuzione presso il Domicilio (LEGGE 199/2010) - CUST. CAUT. PER QUESTA CAUSA IN REGIME DI ARRESTI DOMICILIARI</font>
            <% } else {%>
            <font class="campo">Decreto di Sospensione Esecuzione presso il Domicilio (LEGGE 199/2010) - CONDANNATO <%=lPosizione.getDescrPosizioneGiuridica()%></font>
         <%}
         }
        }%>
      </td>
  ...
  <br>
  <FORM method="POST" name="LoadInserisciDecretoSospensioneAlfanoLibero" action="<%= IWebConstants.PG_MAIN%>">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordineesecuzione.action.ActInserisciDecretoSospensioneAlfanoLibero">
    <table>
      <tr>
	...
	<table>
    	...
    	<td class="l" colspan="3">
     	...
     	<td class="l" id="inputCasellario" style="display:none;">
       	...
       	<a href="Javascript:ListaUfficiPerTipo('LoadInserisciDecretoSospensioneAlfanoLibero','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_CAS %>','DIB');">
     ...
     <td class="l">Magistrato</td>
        <td class="L" colspan="3">
         ...
         <input readonly title= "Nome Magistrato"    value="<%=StringUtils.toStringJSP(magistrato.getMagistrato().getNome() )%>" type="text" name="<%= ICostantiMagistrato.CAMPO_NOME %>"        maxlength="35" size="25">
           <a href="Javascript:ListaMagistrati('LoadInserisciDecretoSospensioneAlfanoLibero');">
            <img src="/images/filefolder.gif" border=0>
            </a>
      </td>
      <td>
    	...
    	<tr>
      	...
      	<td class="L">
        	...
        	<input title="Sede Autorita Esterna" value="" type="text" name="<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E %>"  maxlength="35" size="35">
					<!-- fine modifica relativa al tipo istituto-->
					<a href="Javascript:ListaComuni('LoadInserisciDecretoSospensioneAlfanoLibero','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E %>');">
          	<img src="/images/filefolder.gif" border=0>
        	</a>
      	</td>
		...
		<%}else{
				if(posizioneluogoaltra!= null && lAltraCausa!= null && lAltraCausa.getIstitutoDetenzione() != null)
 				{%>
					...
					<a href="Javascript:ListaIstitutoDetenzione('LoadInserisciDecretoSospensioneAlfanoLibero','<%= ICostantiAltraCausa.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>','Comune');">
...
<%}else{%>
	...
	<%}else{
		  ...
		  {%>
		     ...
		     <a href="Javascript:ListaIstitutoDetenzione('LoadInserisciDecretoSospensioneAlfanoLibero','<%= ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>','Comune');">
		     <img src="/images/filefolder.gif" border=0></a></td>
...
<!--Notifica per l'Ente di Sorveglianza -->
  ...
  <tr>
      ...
      <a href="Javascript:ListaTDS_UDS('LoadInserisciDecretoSospensioneAlfanoLibero','<%= ICostantiOrdineEsecuzione.CAMPO_COD_SEDE_UDS%>');">
        <img src="/images/filefolder.gif" border=0>
      </a>
    </td>
    <td class="l">Note</td>
	    ...
	    <tr>
	      <td colspan="4">
	        <table>
	          <tr>
	            <td class="l">
	              <a href="Javascript:ListaOrdiniEsecuzione('LoadInserisciDecretoSospensioneAlfanoLibero');">
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciDecretoSospensioneAlfanoLibero");
<%if(istanza!=null && istanza.getIdEvento()!=null)
{%>
