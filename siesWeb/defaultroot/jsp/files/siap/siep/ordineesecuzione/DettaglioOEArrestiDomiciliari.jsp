    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Ordine Esecuzione Arresti Domiciliari</font>
        </td>
...
{%>
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.ordineesecuzione.action.ActStampaOEArrestiDomiciliari&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%}%>
...
<%
        ...
        if(lAltraCausa.getIstitutoDetenzione() != null && lLuogoDetenzione!=null && lLuogoDetenzione.getIstitutoDetenzione()!=null )
...
%>
     ...
     <tr>
      ...
      <%if(lEve.getNotifiche()!= null && lEve.getNotifiche().length > 0)
        { %>
      		<%=StringUtils.toStringJSP(lEve.getNotifiche()[0].getNote())%></font>&nbsp;
      <%} %>
      </td>
     </tr>
      <% int count = 1;
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.ordineesecuzione.action.ActLoadDettaglioOEArrestiDomiciliari">
          </td>
        </tr>
      </table>
    </FORM>
