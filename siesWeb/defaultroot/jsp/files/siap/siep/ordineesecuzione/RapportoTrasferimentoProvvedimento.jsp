...
<html>
  <head>
    <title>[S.I.E.S.] - Rapporto Trasferimento Provvedimento</title>
    ...
    <table>
        ...
        <img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
          <td class="LBG">
            ...
            <font class="campo">Rapporto Trasferimento Provvedimento</font>
          </td>
         </tr>
      </table>
   ...
   <table width="300"  cellspacing="0" align="center" class="tab" border="1">
      ...
      <tr align="center" valign="middle">
        <td align="center" colspan="2" class="tab2">
             <input class=bottone name="I" type="submit" value="Conferma">
            </td>
        </tr>
