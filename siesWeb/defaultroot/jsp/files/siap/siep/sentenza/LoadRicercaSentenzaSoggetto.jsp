...
<head>
  <title> [S.I.E.S.] - Ricerca Titolo Esecutivo per Soggetto e Data - </title>
...
<table >
	...
	<tr>
	<td class="L" width="20%" ><font class="label">Data Iniziale</font>
	</td>
	<td class="l" >
 	...
 	<td class="L" ><font class="label">Data Finale</font>
	</td>
	<td class="l">
        <input type="text" title="Giorno Data Titolo Esecutivo" 
