...
<table width="100%">
	...
	<tr>
		...
		<td class="L" colspan=3>
			<input Title="Luogo Emittente" name="<%=ICostantiSentenza.CAMPO_SEDE_NOTIZIA_REATO_D%>" value="" type="text" maxlength="35" size="35"> 
			<a href="Javascript:ListaComuni('LoadInserisciNuovaIstanza','<%= ICostantiSentenza.CAMPO_SEDE_NOTIZIA_REATO_D %>');">
	...
	<tr>
		...
		<td class="L" colspan=3><input Title="Data Decreto" type="text"
			value=""
			name="<%= ICostantiSentenza.CAMPO_GIORNO_DATA_PROVVEDIMENTO_D %>"
			...
			value=""
			name="<%= ICostantiSentenza.CAMPO_MESE_DATA_PROVVEDIMENTO_D %>"
			maxlength="2" size="2" onFocus="javascript:textboxSelect(this)"
			onkeypress="return TicTabNumField(this,event)"
			onBlur="javascript:value=FillDM(value)"> - <input
			Title="Data Decreto" type="text"
			value=""
			name="<%= ICostantiSentenza.CAMPO_ANNO_DATA_PROVVEDIMENTO_D %>"
	...
	<tr>
		...
		<td class="L"><input Title="Anno Decreto" value=""
			type="text" name="<%= ICostantiSentenza.CAMPO_ANNO_SENTENZA_D %>" maxlength="4" size="4"> /<input Title="Numero Decreto"
			value="" type="text" name="<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA_D %>" maxlength="6" size="6">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="L" colspan=3>
			...
			<a href="Javascript:ListaComuni('LoadInserisciSentenza','<%= ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE_D %>');">
				<img src="/images/filefolder.gif" border=0> 
			</a>
		</td>
	</tr>
