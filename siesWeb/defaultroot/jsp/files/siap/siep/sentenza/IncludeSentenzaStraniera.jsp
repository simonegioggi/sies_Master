...
<table width="100%">
    ...
    <tr>
      ...
      <td class="L"  colspan=3>
         <input Title="Luogo Emittente" name="<%=ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE_SS%>"
            value="" type="text" maxlength="35" size="35">
         <a href="Javascript:ListaComuni('LoadInserisciSentenza','<%= ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE_SS %>');">
