...
// - Continuazione
//==============================================================================
PenaComplessivaModel pcm = penaComplessivaSanzioneSostitutiva.getPenaComplessiva();
SanzioneSostitutivaModel ssm = penaComplessivaSanzioneSostitutiva.getSanzioneSostitutiva();
boolean flagSanzioneSostitutiva = false;
boolean flagPenaSostitutiva = false; // MEV_2023-13
if (ssm == null) {
	ssm = new SanzioneSostitutivaModel();
	flagSanzioneSostitutiva = false;
  	flagPenaSostitutiva = false; // MEV_2023-13
} else if (ssm.isPenaSostitutiva()) {
	flagSanzioneSostitutiva = false;
...
boolean flagConfiscaEquivalente = false;
if (!Utils.isNullObj(pcm) && Utils.isPresent(pcm.getCodTipoRito()))
	flagConfiscaEquivalente = "E".equals(pcm.getCodTipoRito());
%>
...
//    		document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value = '0' 
//    		+ document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value;
...
//    		document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value = '0' 
//    		+ document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value;

// 	var d1 = document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value 
// 		+ '/' + document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value 
//		+ '/' + document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_ANNO_DATA_INIZIO_ISOLAMENTO_DIURNO%>.value;
...
//    		document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_FINE_ISOLAMENTO_DIURNO%>.value = '0' 
//    		+ document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_FINE_ISOLAMENTO_DIURNO%>.value;
//  	if (document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_FINE_ISOLAMENTO_DIURNO%>.value.length == 1)
//    		document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_FINE_ISOLAMENTO_DIURNO%>.value = '0' 
//    		+ document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_FINE_ISOLAMENTO_DIURNO%>.value;

// 	var d1 = document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_FINE_ISOLAMENTO_DIURNO%>.value 
// 		+ '/' + document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_FINE_ISOLAMENTO_DIURNO%>.value 
// 		+ '/' + document.LoadInserisciPenaComplessiva.<!%=ICostantiPenaComplessiva.CAMPO_ANNO_DATA_FINE_ISOLAMENTO_DIURNO%>.value;
//   	if (!ControllaData(d1) && d1.length > 2) {
...
//   	}
	...
	// Data Prescrizione
   	var d1 = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_PRESCRIZIONE%>.value 
   		+ '/' + document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_PRESCRIZIONE%>.value 
   		+ '/' + document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_ANNO_DATA_PRESCRIZIONE%>.value;
    	...
    	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_FLAG_PENA_IN_CONTINUAZIONE%>.checked == true) {
      		if (controlliobbligatorietacontinuazione('0') == false) {
        		return false;
          		...
          		if (controlliobbligatorietacontinuazione('1') == false)
          			return false;
        	}
    	}
  	}
...
function TipoSanzione(par) {
	...
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_FLAG_SANZIONE_SOSTITUTIVA%>.checked == true) {
		...
		if (document.LoadInserisciPenaComplessiva.<%=ICostantiSanzioneSostitutiva.CAMPO_COD_TIPO_SANZIONE%>[document.LoadInserisciPenaComplessiva.<%=ICostantiSanzioneSostitutiva.CAMPO_COD_TIPO_SANZIONE%>.selectedIndex].value == 'P') {
			...
			if (par == 'carica' && document.LoadInserisciPenaComplessiva.<%=ICostantiSanzioneSostitutiva.CAMPO_COD_TIPO_SANZIONE%>[document.LoadInserisciPenaComplessiva.<%=ICostantiSanzioneSostitutiva.CAMPO_COD_TIPO_SANZIONE%>.selectedIndex].value == 'E') {
				// Espulsione
...
function covertiPenaPrincipale() {
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_RECLUSIONE%>.value.length == 0) {
 		...
 		aaRec = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_RECLUSIONE%>.value;
 	}
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_RECLUSIONE%>.value.length == 0) {
  		mmRec = 0;
 	} else {
 		mmRec = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_RECLUSIONE%>.value;
 	}
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_RECLUSIONE%>.value.length == 0) {
   		ggRec = 0;
 	} else {
 		ggRec = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_RECLUSIONE%>.value;
 	}
	// Arresto
 	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_ARRESTO%>.value.length == 0) {
   		aaArr = 0;
 	} else {
 		aaArr = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_ARRESTO%>.value;
 	}
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_ARRESTO%>.value.length == 0) {
   		mmArr = 0;
 	} else {
 		mmArr = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_ARRESTO%>.value;
 	}
	if (document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_ARRESTO%>.value.length == 0) {
   		ggArr = 0;
 	} else {
 		ggArr = document.LoadInserisciPenaComplessiva.<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_ARRESTO%>.value;
 	}
...
function controlliobbligatorietacontinuazione(ind) { 
	...
	if ((document.LoadInserisciPenaComplessiva.<%=ICostantiContinuazione.CAMPO_COD_TIPO_CONTINUAZIONE%>[ind].value != "-")
		...
		if (document.LoadInserisciPenaComplessiva.<%=ICostantiContinuazione.CAMPO_NUM_SENTENZA%>[ind].value.length == 0) {
  	  	...
  	  	var d1 = document.LoadInserisciPenaComplessiva.<%=ICostantiContinuazione.CAMPO_GIORNO_DATA_SENTENZA%>[ind].value 
  	  		+ '/' + document.LoadInserisciPenaComplessiva.<%=ICostantiContinuazione.CAMPO_MESE_DATA_SENTENZA%>[ind].value 
  	  		+ '/' + document.LoadInserisciPenaComplessiva.<%=ICostantiContinuazione.CAMPO_ANNO_DATA_SENTENZA%>[ind].value;  	     
  	  	if (!ControllaData(d1)) {
...
<%
    ...
    lPenaComplessiva = pcm;
  	if (ssm.isPenaSostitutiva())
    	lPenaSostitutiva = ssm;    
  	else
    	lSanzioneSostitutiva = ssm;    
%>
...
<table cellspacing="2" cellpadding="2" width="80%">
	...
	<tr>
	    ...
	    <td class="l">
      		Anni&nbsp;<input Title="Anni Reclusione" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumAnniReclusione())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_RECLUSIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
    		Mesi&nbsp;<input Title="Mesi Reclusione" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumMesiReclusione())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_RECLUSIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
    		Giorni&nbsp;<input Title="Giorni Reclusione" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumGiorniReclusione())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_RECLUSIONE%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
  		</td>
		<td class="l">Multa</td>
		<td class="l" width="31%">
<%
...
%>
    		...
    		<input Title="Multa" size="2" maxlength="2" value="<%=lParteDecimaleMulta%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_DECIMALE_IMPORTO_MULTA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
    		<select name="<%=ICostantiPenaComplessiva.CAMPO_VALUTA_IMPORTO_MULTA%>"><%=valute%></select>
  		</td>
	</tr>
	<tr>
		<td class="l">Arresto</td>
		<td class="l">
		    Anni&nbsp;<input Title="Anni Arresto" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumAnniArresto())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_ARRESTO%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
		    Mesi&nbsp;<input Title="Mesi Arresto" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumMesiArresto())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_ARRESTO%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)"> 
		    Giorni&nbsp;<input Title="Giorni Arresto" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumGiorniArresto())%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_ARRESTO%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
		</td>
...
%>
    		...
    		<input Title="Ammenda" size="2" maxlength="2" value="<%=lParteDecimaleAmmenda%>" type="text" name="<%=ICostantiPenaComplessiva.CAMPO_DECIMALE_IMPORTO_AMMENDA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
			<select name="<%=ICostantiPenaComplessiva.CAMPO_VALUTA_IMPORTO_AMMENDA%>"><%=valute%></select>
		</td>
	</tr>
	<tr>
		<td class="l">Ergastolo</td>
		<td class="l" colspan="3">
			<select Title="Pena Detentiva" name="<%=ICostantiPenaComplessiva.CAMPO_COD_TIPO_PENA_DETENTIVA%>"><%=tipoPenaDetentiva%></select>
		</td>
		<td colspan="2">&nbsp;</td>
	</tr>
	<tr>
    	...
    	<td class="l">Anni
      		<input Title="Anni Isolamento Diurno" type="text" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumAnniIsolamentoDiurno()) %>" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_ANNI_ISOLAMENTO_DIURNO%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
      		Mesi
      		<input Title="Mesi Isolamento Diurno" type="text" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumMesiIsolamentoDiurno())%>" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_MESI_ISOLAMENTO_DIURNO%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
      		Giorni
      		<input Title="Giorni Isolamento Diurno" type="text" value="<%=StringUtils.toStringJSP(lPenaComplessiva.getNumGiorniIsolamentoDiurno())%>" name="<%=ICostantiPenaComplessiva.CAMPO_NUM_GIORNI_ISOLAMENTO_DIURNO%>"maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
    	</td>
    	<td class="l">Data Prescrizione</td>
    	<td class="l">
			<input Title="Data Prescrizione" type="text" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lPenaComplessiva.getDataPrescrizione(), "dd")) %>" name="<%=ICostantiPenaComplessiva.CAMPO_GIORNO_DATA_PRESCRIZIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
			-
			<input Title="Data Prescrizione" type="text" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lPenaComplessiva.getDataPrescrizione(), "MM"))%>" name="<%=ICostantiPenaComplessiva.CAMPO_MESE_DATA_PRESCRIZIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
			-
...
<table cellspacing="2" cellpadding="2">
	<tr><td class="Titolo" colspan="2">Sanzione Sostitutiva</td></tr>
	<tr>
    	<td class="l">Sanzione Sostitutiva</td>
    	<td class="l">
      		<input type="checkbox" name="<%=ICostantiPenaComplessiva.CAMPO_FLAG_SANZIONE_SOSTITUTIVA%>" value="S" <%=flagSanzioneSostitutiva ? "checked" : ""%> title="Check per selezionare la Sanzione Sostitutiva" onClick="Javascript:checkSanzione();">
  		</td>
	</tr>
	<tr>
		<td class="l">Tipo </td>
		<td class="l">
		  	<select Title="Tipo Sanzione Sostitutiva" name="<%=ICostantiSanzioneSostitutiva.CAMPO_COD_TIPO_SANZIONE%>" onChange="TipoSanzione('carica');"><%=tipoSanzioneSostitutiva%></select>
			&nbsp;&nbsp;&nbsp;&nbsp;Durata&nbsp;:&nbsp;&nbsp;&nbsp;
...
%>
    		...
    		<input Title="Pena Pecuniaria Sostitutiva" size="2" maxlength="2" value="<%=lParteDecimalePenaPecSost%>" type="text" name="<%=ICostantiSanzioneSostitutiva.CAMPO_DECIMALE_SANZIONE_PECUNIARIA_MULTA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
   			<select name="<%=ICostantiSanzioneSostitutiva.CAMPO_VALUTA_SANZIONE_PECUNIARIA%>"><%=valute%></select>
<%
//**********************************************************
// Federica - a9-rr-078
...
%>
<table cellspacing="2" cellpadding="2">
	<tr><td class="Titolo" colspan="2">Pene sostitutive Pene Detentive Brevi</td></tr>
  	<tr>
    	<td class="l">Pena Sostitutiva</td>
    	<td class="l">
      		<input type="checkbox" value="S" <%=flagPenaSostitutiva ? "checked" : ""%> name="<%=ICostantiPenaComplessiva.CAMPO_FLAG_PENA_SOSTITUTIVA%>" title="Check per selezionare la Pena Sostitutiva" onClick="Javascript:checkPenaSostitutiva();">
    	</td>
  	</tr>
  	<tr>
    	<td class="l">Tipo </td>
...
<%-- MEV_2025-48: aggiunta nuova sezione --%>
<table cellspacing="2" cellpadding="2">
 	<tr><td class="Titolo">Selezionare se Importo da Pagare Include</td></tr>
  	<tr>
    	<td class="l">
      		Confisca per equivalente&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      		<input type="checkbox" name="<%=ICostantiPenaComplessiva.CAMPO_FLAG_CONFISCA_PER_EQUIVALENTE%>" value="S" <%=flagConfiscaEquivalente ? "checked" : ""%>>
  		</td>
	</tr>
</table>
<br>
...
%>
<table cellspacing="2" cellpadding="2">
 	<tr><td class="Titolo">Continuazione con altre sentenze</td></tr>
  	<tr>
    	<td class="l">
...
<table cellspacing="2" cellpadding="2" width="100%">
  	<tr>
	    ...
	    <td class="l" colspan="3">
	      	<select Title="Tipo Continuazione" name="<%=ICostantiContinuazione.CAMPO_COD_TIPO_CONTINUAZIONE%>"><%=tipoContinuazione%></select>
	    </td>
  	</tr>
  	<tr>
	...
	<tr>
		...
		<td class="l" colspan="3">
	  		<select Title="Autorità Sentenza" name="<%=ICostantiContinuazione.CAMPO_COD_TIPO_AUTORITA%>"><%=autoritaSentenza%></select>
	  	</td>
	</tr>
	<tr>
...
<input type="HIDDEN" name="<%=ICostantiSanzioneSostitutiva.CAMPO_ID_SANZIONE_SOSTITUTIVA%>" value="<%=StringUtils.toStringJSP(ssm.getIdSanzioneSostitutiva())%>">
