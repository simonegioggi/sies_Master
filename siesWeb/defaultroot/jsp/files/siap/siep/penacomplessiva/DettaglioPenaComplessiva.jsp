...
<table cellspacing="2" cellpadding="2" width="80%">
    ...
    <tr>
<% 
	if ((lPenCom.getNumAnniReclusione() != null) || (lPenCom.getNumMesiReclusione() != null) || (lPenCom.getNumGiorniReclusione() != null)) {
%>
...
%>
    ...
    <tr>
<%
	if ((lPenCom.getNumAnniArresto() != null) || (lPenCom.getNumMesiArresto() != null) || (lPenCom.getNumGiorniArresto() != null)) {
%>
...
%>
		...
		<td class="l">
		  	<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lPenCom.getDataInizioIsolamentoDiurno(), "dd-MM-yyyy"))%></font>
		</td>
<% 
	}
...
%>
		...
		<td class="l">
		  	<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lPenCom.getDataFineIsolamentoDiurno(), "dd-MM-yyyy"))%></font>
		</td>
<% 
	}
%>
    ...
    <tr>
<% 
	if ((lPenCom.getNumAnniIsolamentoDiurno() != null) || (lPenCom.getNumMesiIsolamentoDiurno() != null) || (lPenCom.getNumGiorniIsolamentoDiurno() != null)) {
%>
...
%>
		...
		<td class="l">
			<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lPenCom.getDataPrescrizione(),"dd-MM-yyyy"))%></font>
		</td>
<% 
	}
%>
...
<%
	if ("E".equals(lPenCom.getCodTipoRito())) {
%>
<br>
<table cellspacing="2" cellpadding="2" width="60%">
 	<tr><td class="Titolo"><font color="red">Importo da Pagare Include Confisca per Equivalente</font></td></tr>
</table>
<br>
<%
	}
	  	...
	  	<td class="l">
	    	<table cellspacing=2 cellpadding=2 width=100%>
				...
				<tr>
					...
					<td class="l" colspan="3"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lContMod.getDataSentenza(),"dd-MM-yyyy"))%></font></td>
				</tr>
				<tr>
					<td class="l">Autorità Sentenza</td>
					<td class="l" colspan="3"><font class="campo"><%=StringUtils.toStringJSP(lContMod.getDescrTipoAutorita())%></font></td>
				</tr>
				<tr>
					<td class="l">Luogo Sentenza</td>
					<td class="l" colspan="3"><font class="campo"><%=StringUtils.toStringJSP(lContMod.getDescrLuogoAutorita())%></font></td>
				</tr>
				<tr>
<%
...
%>
					...
					<td class="L"><font class="campo"><%=anno_reg%>&nbsp;/&nbsp;<%=num_reg%>&nbsp;&nbsp;&nbsp;<%=reg%></font></td>
<%
		}
%>
				</tr>
