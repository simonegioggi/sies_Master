...
<table>
	<tr>
		...
		<td class="LBG"><font class="label">Funzione : </font>
        	<font class="campo">Modifica Pena Complessiva e Sentenze in Continuazione</font>
        </td>
	</tr>
</table>
<br>
...
<%-- MEV_2023-13 - FINE --%>
	...
	<tr>
		<td class="l"><%=StringUtils.toStringJSP(lPenCom.getDescrTipoPenaDetentivaDB())%></td>
		<td class="l">
...
%>
			<br>Multa <%=StringUtils.toEuroFormat(lPenCom.getImportoMulta())%>
<%
}
%>
		</td>
...
%>
			<br>Ammenda <%=StringUtils.toEuroFormat(lPenCom.getImportoAmmenda())%>
<%
}
%>
		</td>
		<td class="l"><%=StringUtils.toStringJSP(lSanSos.getDescrTipoSanzione(), "-")%></td>
<%
...
%>
			&nbsp;<%=StringUtils.toEuroFormat(lSanSos.getSanzionePecuniariaMulta())%>
			<br> 
<%
		}   
...
%>
	<tr>
		<td class="l"><%=StringUtils.toStringJSP(lContMod.getDescrTipoContinuazione())%></td>
		<td class="l"><%=StringUtils.toStringJSP(lContMod.getAnnoSentenza())%>/<%=StringUtils.toStringJSP(lContMod.getNumSentenza())%></td>
		<td class="l"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lContMod.getDataSentenza(),"dd-MM-yyyy"))%></td>
		<td class="l"><%=StringUtils.toStringJSP(lContMod.getDescrTipoAutorita())%></td>
		<td class="l"><%=StringUtils.toStringJSP(lContMod.getDescrLuogoAutorita())%></td>
		<td class="c">
