...
<html>
<head>
  <title>[S.I.E.S.] - Cancella Pena Complessiva </title>
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border="0"></a></td>
      <td class="LBG"><font class="label">Funzione: </font>
        <font class="campo">Cancella Pena Complessiva</font></td>
    </tr>
  </table>
	  <br>
   <%if(!modoSIGE)
  ...
  <%}%>
    ...
    <table style="width: 95%;">
      ...
      <tr>
        ...
        <%}%>
        <td class="c">
          <a href="Javascript:conferma('siap.siep.penacomplessiva.action.ActCancellaPenaComplessiva','<%=ICostantiPenaComplessiva.CAMPO_ID_PENA_COMPLESSIVA%>','<%=lPenCom.getIdPenaComplessiva()%>');">
