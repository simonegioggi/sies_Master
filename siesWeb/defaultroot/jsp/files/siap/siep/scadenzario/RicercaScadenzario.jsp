...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Scadenzario Simeone</title>
  ...
  <BODY class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        ...
        <font class="campo">Consultazione Scadenzario L.165/98 - <%=titolo%></font></td>
      </tr>
    </table>
    <br>
	  ...
	  <form  method="POST"  action="<%= IWebConstants.PG_MAIN%>" name="f">
	    ...
	    <input type="HIDDEN" name="<%=ICostantiScadenzario.CAMPO_ANNI_SCADENZA%>" value="<%=StringUtils.toStringJSP(AnniScadenza) %>">
...
%>
 	<table width="750" >
		<tr>
	    	<td colspan=63%>&nbsp;<td>
		    <td colspan=1%><img src="/images/QuadratinoVerde.gif"></td>
		    <td colspan=1% class="campo"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzario&tipo=sette&<%=ICostantiScadenzario.CAMPO_GIORNI_SCADENZA%>=<%=new BigDecimal(7) %>&<%=ICostantiScadenzario.CAMPO_MESI_SCADENZA%>=<%=new BigDecimal(0) %>">In Scadenza</a></td>
		   	<td colspan=1%>(7gg)</td>
		   	<td colspan=15%>&nbsp;<td>
		    <td colspan=1%><img src="/images/QuadratinoRosso.gif"></td>
		    <td colspan=1% class="campo"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzario&tipo=oggi">In Scadenza Oggi</a></td>
		    <td colspan=15%>&nbsp;<td>
		    <td colspan=1%><img src="/images/QuadratinoGrigio.gif"></td>
		    <td colspan=1%  class="campo"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzario&tipo=scaduto">Scaduto</a></td>
		</tr>
		<tr><td>&nbsp;<td></tr>
	</table>
<%
