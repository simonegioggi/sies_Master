...
//(In particolare per le Pene Sospese - Termine Sospensione Condizioanele) 
//==============================================================================
...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Ricerca Scadenzario Pene Sospese- Termini Sospensione Condizionale </title>
  ...
  <BODY class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        ...
        <font class="campo">Consultazione Scadenzario Termini Sospensione Condizionale - <%=titolo%></font></td>
      </tr>
    </table>
    <br>
...
%>
		   	<tr>
		    	...
		    	<td align="right"><img src="/images/QuadratinoVerde.gif"></td><td class="campo" width="15%"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzarioSospeCondizio&tipo=sette&<%=ICostantiScadenzario.CAMPO_GIORNI_SCADENZA%>=<%=new BigDecimal(7) %>&<%=ICostantiScadenzario.CAMPO_MESI_SCADENZA%>=<%=new BigDecimal(0) %>">In Scadenza</a></td>
		    	<td align="right"><img src="/images/QuadratinoRosso.gif"></td><td class="campo" width="15%"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzarioSospeCondizio&tipo=oggi">In Scadenza Oggi</a></td>
		    	<td align="right"><img src="/images/QuadratinoGrigio.gif"></td><td class="campo" width="15%"> <a class="cliccabile" href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzarioSospeCondizio&tipo=scaduto">Scaduto</a></td>
...
<%
       ...
       {
%>
	       <td class="int">Data Termine Sospensione</td>
