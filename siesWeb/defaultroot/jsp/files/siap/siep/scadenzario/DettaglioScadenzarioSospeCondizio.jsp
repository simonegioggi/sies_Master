...
//(In particolare per le Pene Sospese - Termine Sospensione Condizionale) 
//==============================================================================
%>

<html>
	<head>
		<title>[S.I.E.S.] - Dettaglio Stato Notifiche - Sospensione Condizionale </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
        	...
        	<font class="campo">Dettaglio Stato Notifiche - Sospensione Condizionale</font>
      	</td>
 				<td class="LBG">
