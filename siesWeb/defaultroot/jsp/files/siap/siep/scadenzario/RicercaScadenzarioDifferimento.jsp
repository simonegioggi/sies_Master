...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Consultazione Scadenzario Differimento</title>
  ...
  <FORM method="POST" name="elenco" action="<%=IWebConstants.PG_MAIN%>">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        ...
        <font class="campo">Consultazione Scadenzario Differimento - <%=titolo%></font></td>
      </tr>
    </table>
    <br>
    ...
    %>
      <tr>
        ...
        <td class="int">Data Inizio Differimento</td>
    <%
      if(!tipo.equals("oggi")) {
    %>
      <td class="int">Data Fine Differimento</td>
