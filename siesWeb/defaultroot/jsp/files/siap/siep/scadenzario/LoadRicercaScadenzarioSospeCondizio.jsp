...
<html>
<head>
  <title> [S.I.E.S.] - Scadenzario Pene Sospese: Termini di Sospensione Condizionale - </title>
...
<body class="corpo" onLoad="toggleDiv('divAAMMGG');">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadenzarioSospeCondizio">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario Termini Sospensione Condizionale</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Consultazione Scadenzario Termini Sospensione Condizionale</td>
      </tr>
      <tr>
