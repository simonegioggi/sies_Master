...
<head>
  ...
  <script language="JavaScript">
      ...
      if(document.f.tipo[1].checked)
      {
        ...
        {
          alert("Inserire periodo di ricerca dei decreti (scadenza entro nn giorni da oggi)");
...
<body class="corpo" onLoad="toggleDiv('divAAMMGG');">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadenzario">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario L.165/98</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Ordine di Esecuzione con Sospensione in Attesa di Istanza</td>
      </tr>
      <tr>
