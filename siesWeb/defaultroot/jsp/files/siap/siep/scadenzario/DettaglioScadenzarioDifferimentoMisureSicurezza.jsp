...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Scadenzario Differimento Misura Sicurezza</title>
	...
	<table>
		<tr>
        	...
        	<td class="LBG">
        		...
        		<font class="campo">Dettaglio Scadenzario Differimento Misure Sicurezza</font>
      		</td>
 			<td class="LBG">
...
<%-- 				<a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.scadenzario.action.ActRicercaScadenzarioDifferimentoMisureSicurezza&tipo=<%=tipo%>&GiorniScadenza=<%=giorniScadenza%>&MesiScadenza=<%=mesiScadenza%>&AnniScadenza=<%=anniScadenza%>"> --%>
...
<%
if (!lSentMod.getCodTipoProvvedimento().equals("02")) {
%>
...
<table cellspacing="4" cellpadding="4" width="60%">
	<tr>
		<td class="l">Data Inizio Differimento</td>
	...
	<tr>
		<td class="l">Data Fine Differimento</td>
		<td class="l">
			<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lSca.getDataFineScadenza(),"dd/MM/yyyy"))%></font>
		</td>
	</tr>
	<tr>
