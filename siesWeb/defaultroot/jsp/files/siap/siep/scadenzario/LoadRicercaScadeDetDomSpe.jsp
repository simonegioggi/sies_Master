...
<head>
  ...
  function verifica()
  {
      if(document.f.tipo[1].checked)
      {
        ...
        if(document.f.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.value == "" && document.f.<%= ICostantiScadenzario.CAMPO_GIORNI_SCADENZA %>.value == "" && document.f.<%= ICostantiScadenzario.CAMPO_MESI_SCADENZA %>.value == "")
         {
...
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="f">
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadeDetDomSpe">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario Detenzione Domiciliare Speciale</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Detenzione Domiciliare Speciale</td>
      </tr>
      <tr>
