...
<html>
<head>
  <title> [S.I.E.S.] - Scadenzario Vane Ricerche - Rinnovo Verbale - </title>
  ...
  function verifica()
  {
      	if(document.LoadRicercaScadenzarioRinnovoVaneRicerche.tipo[1].checked)
      	{

        		if(document.LoadRicercaScadenzarioRinnovoVaneRicerche.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.value == "" && document.LoadRicercaScadenzarioRinnovoVaneRicerche.<%= ICostantiScadenzario.CAMPO_GIORNI_SCADENZA %>.value == "" && document.LoadRicercaScadenzarioRinnovoVaneRicerche.<%= ICostantiScadenzario.CAMPO_MESI_SCADENZA %>.value == "")
         		{
         			document.LoadRicercaScadenzarioRinnovoVaneRicerche.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.focus();
         			alert("Inserire Periodo Istanze in Scadenza ");
         			return false;
         		}
      	}
      
    	if(!(document.LoadRicercaScadenzarioRinnovoVaneRicerche.tipo[0].checked || document.LoadRicercaScadenzarioRinnovoVaneRicerche.tipo[1].checked || document.LoadRicercaScadenzarioRinnovoVaneRicerche.tipo[2].checked|| document.LoadRicercaScadenzarioRinnovoVaneRicerche.tipo[3].checked) )
    	{
...
%>
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadRicercaScadenzarioRinnovoVaneRicerche">

    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadenzarioRinnovoVerbaleVaneRicerche">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario Rinnovo Verbale Vane Ricerche</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Consultazione Scadenzario Vane Ricerche - Verbale Pervenuto</td>
      </tr>
    </table>
...
<script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadRicercaScadenzarioRinnovoVaneRicerche");
