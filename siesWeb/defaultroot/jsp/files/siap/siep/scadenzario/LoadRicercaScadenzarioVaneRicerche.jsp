...
<head>
  ...
  function verifica()
  {
      	if(document.LoadRicercaScadenzarioVaneRicerche.tipo[1].checked)
      	{

        		if(document.LoadRicercaScadenzarioVaneRicerche.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.value == "" && document.LoadRicercaScadenzarioVaneRicerche.<%= ICostantiScadenzario.CAMPO_GIORNI_SCADENZA %>.value == "" && document.LoadRicercaScadenzarioVaneRicerche.<%= ICostantiScadenzario.CAMPO_MESI_SCADENZA %>.value == "")
         		{
         			document.LoadRicercaScadenzarioVaneRicerche.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.focus();
         			alert("Inserire Periodo Istanze in Scadenza ");
         			return false;
         		}
      	}
      
    	if(!(document.LoadRicercaScadenzarioVaneRicerche.tipo[0].checked || document.LoadRicercaScadenzarioVaneRicerche.tipo[1].checked || document.LoadRicercaScadenzarioVaneRicerche.tipo[2].checked|| document.LoadRicercaScadenzarioVaneRicerche.tipo[3].checked) )
    	{
...
%>
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadRicercaScadenzarioVaneRicerche">

    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadenzarioVaneRicerche">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario Vane Ricerche</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Consultazione Scadenzario Vane Ricerche</td>
      </tr>
    </table>
...
<script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadRicercaScadenzarioVaneRicerche");
