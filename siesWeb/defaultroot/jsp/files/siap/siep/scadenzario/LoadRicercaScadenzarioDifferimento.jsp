...
<html>
<head>
  <title> [S.I.E.S.] - Scadenzario Differimento - </title>
  ...
  function verifica() {
    if(document.LoadRicercaScadenzarioDifferimento.tipo[1].checked) {
      if(   document.LoadRicercaScadenzarioDifferimento.<%= ICostantiScadenzario.CAMPO_ANNI_SCADENZA %>.value == "" 
         && document.LoadRicercaScadenzarioDifferimento.<%= ICostantiScadenzario.CAMPO_GIORNI_SCADENZA %>.value == "" 
         && document.LoadRicercaScadenzarioDifferimento.<%= ICostantiScadenzario.CAMPO_MESI_SCADENZA %>.value == "")
      {
    ...
    if(!(   document.LoadRicercaScadenzarioDifferimento.tipo[0].checked 
         || document.LoadRicercaScadenzarioDifferimento.tipo[1].checked 
         || document.LoadRicercaScadenzarioDifferimento.tipo[2].checked
         || document.LoadRicercaScadenzarioDifferimento.tipo[3].checked) )
    {
...
<body class="corpo">
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadRicercaScadenzarioDifferimento">

    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.scadenzario.action.ActRicercaScadenzarioDifferimento">

    <table>
      <tr>
        <td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> <font class="campo">Consultazione Scadenzario Differimento</font></td>
      </tr>
    </table>
    ...
    <table cellspacing=2 cellpadding=2 width="100%">
      <tr>
        <td colspan="4" class="Titolo" width="100%">Consultazione Scadenzario Differimento</td>
      </tr>
      <tr>
...
<script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("LoadRicercaScadenzarioDifferimento");
