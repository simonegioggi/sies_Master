...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Consultazione Scadenzario Vane Ricerche - Rinnovo Verbale </title>
    <script language="JavaScript" src="<%=IWebConstants.JS_CONFIRM%>"></script>
  </head>

  <BODY class="corpo">
  <FORM method="POST" name="elencoVVR" action="<%=IWebConstants.PG_MAIN%>">

    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font>&nbsp;
        <font class="campo">Consultazione Scadenzario Vane Ricerche - Verbale Pervenuto  - <%=titolo%></font></td>
      </tr>
    </table>
    <br>
...
<br>
   ...
   <tr>
    ...
    <tr>
                ...
                <td class="int">Data Emissione OE</td>
				<td class="int">Data Emissione VVR</td>

               <%
       if(!tipo.equals("oggi"))
        {
          %>
                <td class="int">Data di Scadenza</td>
    ...
    if(tipo.equals("Tutti"))
    {
      ...
      if(lSca!= null && lSca.getGiorniResidui()!= null && lSca.getGiorniResidui().intValue()== 0)
      {
        %>
          ...
          <td class=crosso><%=StringUtils.toStringJSP(DateUtils.getDateToString(lSca.getDataEmissioneIniziale() ,"dd/MM/yyyy")) %>&nbsp;</td>
      ...
      else
      {
          if(lSca!= null && lSca.getGiorniResidui()!= null && lSca.getGiorniResidui().intValue()<= 7 && lSca.getGiorniResidui().intValue()> 0)
          {
            %>
              ...
              <td class=cverde><%=StringUtils.toStringJSP(DateUtils.getDateToString(lSca.getDataEmissioneIniziale() ,"dd/MM/yyyy")) %>&nbsp;</td>
          ...
          else
          {
            ...
            <td class=cgrigio>
              ...
              <td class=cgrigio><%=StringUtils.toStringJSP(DateUtils.getDateToString(lSca.getDataEmissioneIniziale() ,"dd/MM/yyyy")) %>&nbsp;</td>
            ...
            <td class=C><%=StringUtils.toStringJSP(DateUtils.getDateToString(lSca.getDataEmissioneIniziale() ,"dd/MM/yyyy")) %>&nbsp;</td>
