...
function Init() {
	if (document.LoadCivilmenteObbligato.<%=ICostantiPagoPA.RADIO_COD_PERSONA%>[0].checked) {
...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadCivilmenteObbligato">
<table>
	<tr>
