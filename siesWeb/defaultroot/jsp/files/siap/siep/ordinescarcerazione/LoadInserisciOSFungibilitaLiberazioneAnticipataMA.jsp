...
<%if(lFascicoloAssociato.getFlagAltraCausa()!=null && lFascicoloAssociato.getFlagAltraCausa().equals("S"))
        {%>
   <font class="campo">Emissione Ordine di Scarcerazione con Fungibilità a seguito di ordinanza Liberazione Anticipata in regime alternativo - DETENUTO PER ALTRA CAUSA</font>
        <%}else{%>
       <font class="campo">Emissione Ordine di Scarcerazione con Fungibilità a seguito di ordinanza Liberazione Anticipata in regime alternativo - <%=lPosizione.getDescrPosizioneGiuridica()%></font>
<%}%>
     </td>
    </tr>
  </table>
  ...
  <FORM method="POST" name="LoadInserisciOrdineScarcerazione" action="<%= IWebConstants.PG_MAIN%>">
   <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.ordinescarcerazione.action.ActInserisciOSFungibilitaLiberazioneAnticipataMA">
...
{%>
    ...
    <input type="HIDDEN"  value="<%=StringUtils.toStringJSP(misuraalternativa.getNumGiorniMisura())%>" name="<%= ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_MISURA %>">
     <input type="HIDDEN"  value="<%=ufficioemittente%>" name="ufficioemittente">
