...
%>
<html>
<!-- LoadInserisciMisuraCautelareCessateComputabili.jsp -->
<head>
...
<script language="JavaScript">
 ...
 function ControllaCheckBox(ddDa,mmDa,aaDa,ddA,mmA,aaA,cBox,dtIni,dtFine,idMC) { 		
  		...
  		if (!(cBox.checked)  ) {
  	      ...
  	      mmA.value=""; 
  	      aaA.value="";  
  	      document.LoadInserisciMisuraCautelareCessateComputabili.appoCheck.value =999999999;
  	      clearQuantum(idMC);
        }
        else {  
 	...
 	function radioBase()
 	{
 	  ...
 	  if(document.LoadInserisciMisuraCautelareCessateComputabili.EspiazionePenaIstDeteAltroLuogo[0].checked )
 	  { 		 
 		 ...
 		 nodetipoEspPenInAltroLuogoSezioneFDiv.style.display='none';
 	 	 ...
 	 	 document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA%>.value="-";
 	  } 
 	  else  if(document.LoadInserisciMisuraCautelareCessateComputabili.EspiazionePenaIstDeteAltroLuogo[1].checked )
 	  { 	
 		 ...
 		 nodetipoEspPenInAltroLuogoSezioneFDiv.style.display='block';
 	 	 ...
 	 	 document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA%>.value="-";
      } 	  
 	}
 	...
 	{	
 	    var codTipoUfficio = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_MISURA_CAUTELARE%>.value 	  
 	    if (codTipoUfficio == 'PM'){
 	    	ListaUffici('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PM%>');
 	    } else if (codTipoUfficio == 'PGCAP'){
 	    	ListaDistretti('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PM%>');
     ...
     function ControllaPeriodo(ddDa,mmDa,aaDa,ddA,mmA,aaA,cBox,dtIni,dtFine,flagCalcolo)
      {
		...
		function VerifyAltreBDI() {
			var DataInizio = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_INIZIO%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_INIZIO%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_INIZIO%>.value;
		  	var DataFine = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FINE%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FINE%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FINE%>.value;		
		  	var DataEmissioneOrdinanza = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_EMISSIONE_ORDINANZA%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_EMISSIONE_ORDINANZA%>.value+'/'+document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_EMISSIONE_ORDINANZA%>.value;
		  	...
		  	if (!CompareDate(DataInizio, DataFine)) {
 		  	...
 		  	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_MISURA_CAUTELARE%>.value == "") {
 		  		alert("Tipo Ufficio PM è obbligatorio");
				return false;
    	   	}	   
     	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PM%>.value == "") {
   		  		alert("Sede è obbligatorio");
    	   	  	return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.AUTORITA_EMITTENTE%>.value == "" ||
    			   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.AUTORITA_EMITTENTE%>.value == "-") {
    	      	alert("Autorità Emittente è obbligatorio");
				return false;
    	   	}
			if ((document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA%>.value == "" 			||
    			   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA%>.value == "-" 		||
    			   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA%>.value == null)		&&
    			   (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA%>.value == "" 			||
    					   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA%>.value == "-" 	||
    					   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA%>.value == null)) {
    		   	alert("Misura è obbligatorio");
				return false;
    	   	}   	       	       
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_INIZIO%>.value == "") {
    		   	alert("Data misura è obbligatorio");
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_INIZIO%>.value == "") {
    	   		alert("Data misura è obbligatorio");
  				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_INIZIO%>.value == "") {
    	      	alert("Data misura è obbligatorio");
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FINE%>.value == "") {
    	      	alert("Data misura è obbligatorio");
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FINE%>.value == "") {
    	   		alert("Data misura è obbligatorio");
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FINE%>.value == "") {
    	      	alert("Data misura è obbligatorio");
				return false;
    	  	}
    	   	// MERGE v10: aggiunti controlli preventivi
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_MOTIVO_NON_COMPUTABILE%> &&
    			   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_MOTIVO_NON_COMPUTABILE%>.value == "") {
    	      	alert("Motivo Non Computabilità è obbligatorio");
    	      	document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_MOTIVO_NON_COMPUTABILE%>.focus();
				return false;
    	   	}
           	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FUNGIBILITA%> &&
        		   document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FUNGIBILITA%>.value == "") {
    	      	alert("Data provvedimento di Fungibilita' è obbligatorio");
    	      	document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FUNGIBILITA%>.focus();
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FUNGIBILITA %> &&
    	   			document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FUNGIBILITA %>.value == "") {
    	      	alert("Data provvedimento di Fungibilita' è obbligatorio");
    	      	document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FUNGIBILITA %>.focus();
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FUNGIBILITA %> &&
    	   			document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FUNGIBILITA %>.value == "") {
    	      	alert("Data provvedimento di Fungibilita' è obbligatorio");
    	     	document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FUNGIBILITA %>.focus();
				return false;
    	   	}
    	   	if (document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_RIFER%> &&
    	   			document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_RIFER%>.value == "") {
    	      	alert("Ufficio è obbligatorio");
    	      	document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_RIFER%>.focus();
				return false;
    	   	}
           	return true;
		}
		...
		//============================================================================
  		...
  		function Verify() {
			var almenoUna = false;
	      	var misura = "-";
	      	var dataInizio = "";
	      	// MERGE v10: modifica al codice per dargli un senso
	 	  	if (document.LoadInserisciMisuraCautelareCessateComputabili.EspiazionePenaIstDeteAltroLuogo[0].checked)
	 	  		misura = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA%>[document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA %>.selectedIndex].value;
	 	  	else if (document.LoadInserisciMisuraCautelareCessateComputabili.EspiazionePenaIstDeteAltroLuogo[1].checked)
	 	  		misura = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA%>[document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA %>.selectedIndex].value;

	      	//==================================
	      	// Recupero la data Inizio misura
	      	//==================================
	      	var giornoDataInizio = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_INIZIO%>.value;
	      	var meseDataInizio   = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_INIZIO%>.value;
	      	var annoDataInizio   = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_INIZIO%>.value;
	      	...
	      	if (misura != "-") {
		        ...
		        // MERGE v10: aggiunta impostazione variabili
		        //==================================
		      	// Recupero la data Fine misura
		      	//==================================
		        var giornoDataFine = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_GIORNO_DATA_FINE%>.value;
		        var meseDataFine   = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_MESE_DATA_FINE%>.value;
		        var annoDataFine   = document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_ANNO_DATA_FINE%>.value;
		        var dataFine = "";
	      	...
	      	if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi != null && !almenoUna) {
		  		if (isNaN(parseInt(document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi.length))) {
		  			if (!document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi.checked)
			    		almenoUna = false;
		        	else
		        		almenoUna = true;
		    	} else {
					for (lSel = 0; lSel < document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi.length; lSel++) {
						if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi[lSel].checked)
							almenoUna = true;
					}
				}
	      	}
	      	if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodiNC != null && !almenoUna) {
		  		if (isNaN(parseInt(document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodiNC.length))) {
		  			if (!document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodiNC.checked)
						almenoUna = false;
					else 
						almenoUna = true;
			    } else {
			    	for (lSel = 0; lSel < document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodiNC.length; lSel++) {
						if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodiNC[lSel].checked)
							almenoUna = true;
					}
				}
			}
		  	if (!almenoUna) {
			    ...
			    return false;
	   	  	...
	   	  	if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi != null) {
	      		<%   
	      		if (lProvv != null) {
	            ...
	            %>
						         	if (document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi[0] != null) {
					          			var appo = ControllaPeriodo(document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_GIORNO_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_MESE_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_ANNO_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_GIORNO_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_MESE_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_ANNO_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%=campoCheckBox %>,document.LoadInserisciMisuraCautelareCessateComputabili.dtIni<%=lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.dtFine<%=lsel %>,'1');
						       			if (appo > 0)
						       		 		return false;
						       	 	} else {
								 		var appo = ControllaPeriodo(document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_GIORNO_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_MESE_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_ANNO_DALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_GIORNO_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_MESE_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiSbPren.CAMPO_ANNO_ALLA_DATA  + lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.CheckPeriodi,document.LoadInserisciMisuraCautelareCessateComputabili.dtIni<%=lsel %>,document.LoadInserisciMisuraCautelareCessateComputabili.dtFine<%=lsel %>,'1');
							       		if (appo > 0)
							       			return false;
								  	}				       	  
				<%
								...
								cambioPrenotazione = lPeriodo.getIdPren();
							}
		     			}
					}
	    		}
...
%>
         <font class="campo">Inserimento Misura Cautelare - COMPUTABILE</font>
<%
       }
...
%>
         <font class="campo">MODIFICA MISURA CAUTELARE - COMPUTABILE</font>
<%
       }
%>
        </td>
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciMisuraCautelareCessateComputabili">
  ...
  <input type="HIDDEN" name="flagComputabile" value="<%=flagComputabile%>" >
	...
	<table cellspacing=2 cellpadding=2  width="100%" >		   		
          ...
          <td class="L">
            ...
            /
            <input type="text" title="Numero Procedimento" value="<%=StringUtils.toStringJSP(misuracautelare.getNumeroRgnr()) %>" name="<%=ICostantiMisuraCautelare.NUMERO_RGNR%>" maxlength="6" size="4" <%=jsNumField%>>           
          </td>      
          ...
          <td class="l">
            ...
            <%--<a href="Javascript:ListaComuniPerTipoUfficio('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PM%>');">
            <a href="Javascript:ChoosePopup();">--%>
            <a href="Javascript:ListaUfficiComuni('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PM%>',document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_MISURA_CAUTELARE%>[document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.CAMPO_COD_TIPO_UFFICIO_MISURA_CAUTELARE%>.options.selectedIndex].value);">
		...
		<tr>
          ...
          <td class="L">
            ...
            /
            <input type="text" title="Numero Procedimento" value="<%=StringUtils.toStringJSP(misuracautelare.getNumeFascBdmc()) %>" name="<%=ICostantiMisuraCautelare.NUME_FASC_BDMC%>" maxlength="6" size="4" <%=jsNumField%>>           
          </td>
          ...
          <td class="L">
            ...
            /
            <input type="text" title="Numero Procedimento" value="<%=StringUtils.toStringJSP(misuracautelare.getNumeroRegGen()) %>" name="<%=ICostantiMisuraCautelare.NUMERO_REG_GEN%>" maxlength="6" size="4" <%=jsNumField%>>           
          </td>
        	...
        	<td class="l"> 
          	...
          	<td class="l">	            
	        	 <input value="<%=defaultLuogoAutoritaEmittente%>" type="text" name="<%=ICostantiMisuraCautelare.AUTORITA_EMITTENTE_LUOGO%>">                  	            	
	            	<a href="Javascript:ListaUfficiPerTipo('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.AUTORITA_EMITTENTE_LUOGO%>',document.LoadInserisciMisuraCautelareCessateComputabili.<%= ICostantiMisuraCautelare.AUTORITA_EMITTENTE %>[document.LoadInserisciMisuraCautelareCessateComputabili.<%=ICostantiMisuraCautelare.AUTORITA_EMITTENTE%>.selectedIndex].value);">
	             <img src="/images/filefolder.gif" border=0></a>
          	</td>    
         </tr> 
         <tr>    	
	...
	<div id="tipoEspPenInAltroLuogoDiv" style="display:none; width:100%;" >
			...
			<td class="l">
		      <table  cellspacing=1 cellpadding=1>
		        <tr>
		          ...
		          <td class="l">
		            <select Title="Tipo Misura Cautelare non Detentiva" name="<%= ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_NON_DETENTIVA %>" >
	...
	<div id="tipoEspPenIstDiDetenzioneDiv" style="display:none; width:100%;" >
		<table cellspacing=1 cellpadding=1 width=100%>
   		<tr>
			<td class="l">
		      <table  cellspacing=1 cellpadding=1>
		        <tr>
		          <td class="l">Misura<font class=ob>(*)</font></td> 	         
		          <td class="l">
		            <select Title="Tipo Misura Cautelare Detentiva" name="<%= ICostantiMisuraCautelare.CAMPO_COD_TIPO_MISURA_DETENTIVA %>" >
		              <%=tipoMisuraDetentive%>
		            </select>
		          </td>	         		          
		        </tr>
	...
	<table cellspacing=2 cellpadding=2  width="100%" >		   		
            ...
            <% } %>        
                  ...
                  <input type="HIDDEN" name="IstDetIdIstitutoDetenzione" value="<%=ICostantiMisuraCautelare.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" >
                  <a href="Javascript:ListaIstitutoDetenzione('LoadInserisciMisuraCautelareCessateComputabili','IstDetIdIstitutoDetenzione','<%=ICostantiMisuraCautelare.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE_COMUNE%>[0]');">
                  <img src="/images/filefolder.gif" border=0></a>
	...
	<table cellspacing=2 cellpadding=2  width="100%" >
		<tr>	
	        ...
	        <td class="l">
	        	<textarea rows=3 cols=35 style="color: blue" name="<%= ICostantiMisuraCautelare.CAMPO_COD_LUOGO_DI_ESPIAZIONE %>"><%=StringUtils.toStringJSP(misuracautelare.getAltroLuogoDetenzione()) %></textarea>
	        </td>
		</tr> 
        <tr>
        	...
        	<td class="l">Sede</td>
          	<td class="l">
	        	<input type="text" value="<%=StringUtils.toStringJSP(misuracautelare.getAutoritaCompetenteSedeDesc()) %>" name="<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PER_TERRITORIO%>">
	        	<input type="HIDDEN" name="<%=ICostantiMisuraCautelare.AUTORITA_COMPETENTE_SEDE%>" value="<%=ICostantiComune.CAMPO_COD_COMUNE_REALE%>" >     	
	            	<a href="Javascript:ListaComuni('LoadInserisciMisuraCautelareCessateComputabili','<%=ICostantiMisuraCautelare.CAMPO_COD_SEDE_UFFICIO_PER_TERRITORIO%>');">
	              	<img src="/images/filefolder.gif" border=0></a>	 
          	</td>
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciMisuraCautelareCessateComputabili");
