...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Lista Benefici Concessi</title>
...
%>
                         ...
                         )
      {
        ...
        // RE = REVOCA
        if(    natura!='-' && natura == 'RE'
            && (    oggetto == '0086' || oggetto == '0014' || oggetto == '0015' // AFFIDAMENTO IN PROVA
        ...
        //===============================================================
        if(natura!='-' && natura == 'CO'&& (oggetto == '2010' || oggetto == '2011' || oggetto == '0030' || oggetto == '0031' || oggetto == '0032' || oggetto == '0033' || oggetto == '0201' || oggetto == '0202'|| oggetto == '2140'))
        {
...
%>
  ...
  <table>
    <tr>
      <td class="int" width=25% colspan=4>Anno/Numero Siep</td>
      <td class="int" width=25% colspan=4>Autorità Emittente</td>
      <td class="int" width=25% colspan=4>Tipo Provv</td>
      <td class="int" width=25% colspan=4>Data Provv</td>
    </tr>
<%
    if( !documentiSius.isEmpty() )
    {
      ...
      for (int i = 0; itx.hasNext(); i++)
      {
        ...
        String lUfficio = StringUtils.cStrForJS(eventoModel.getDescrUfficioEmittente());
...
<%
            if(misuraModel != null  && misuraModel.getCodTipoMisura() != null
               &&(misuraModel.getCodTipoMisura().equals("2000") ||misuraModel.getCodTipoMisura().equals("2001") ||
