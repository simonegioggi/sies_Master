...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Revoca Sospensione/Non Menzione - Elenco dei Procedimenti Associati </title>
    	...
    	<tr>
        	...
        	<a href="Javascript:window.print();">
      		...
      		<td class="LBG">
        		...
        		<font class="campo">
          			ELENCO PROCEDIMENTI DI SOSPENSIONE CONDIZIONALE/NON MENZIONE
        		</font>
       		</td>   
		</tr>
	</table>
...
<%
	...
	while ( itx.hasNext())
    {
       ...
       if(lSenFasMod.getIdFascicoloSiep().intValue()!= fascicolo.getIdFascicoloSiep().intValue()
    		   &&
       		(lSenFasMod.getChiaveNumeroFascicolo().intValue()>30000 && lSenFasMod.getChiaveNumeroFascicolo().intValue()<40000))
       {	
