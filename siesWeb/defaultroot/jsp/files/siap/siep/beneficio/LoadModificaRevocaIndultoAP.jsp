...
<html>
	<head>
		<title>[S.I.E.S.] -Modifica Revoca Beneficio - Indulto Concesso in Altro Provvedimento- </title>
		...
		<script language="JavaScript">
  		...
  		function verify()
  		{
			var Tiprov=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_COD_TIPO_PROVVEDIMENTO%>.value;
			var CodAut=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_COD_TIPO_AUTORITA_EMITTENTE%>.value;
			var LuoAut=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_COD_LUOGO_EMITTENTE%>.value;

// Data Provvedimento   	
    		var AAprovv=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_ANNO_PROVVEDIMENTO%>.value;
    		var MMprovv=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_MESE_PROVVEDIMENTO%>.value;
    		var GGprovv=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_GIORNO_PROVVEDIMENTO%>.value;
    		var data_to_verify = GGprovv+'/'+MMprovv+'/'+AAprovv;
     		if (!ControllaData(data_to_verify) && data_to_verify.length>2)
      		{ 
        		...
        		document.LoadModificaRevocaIndultoAP.<%=ICostantiBeneficio.CAMPO_GIORNO_PROVVEDIMENTO%>.focus(); 
        		return false; 
      		}     	

// Data Irrevocabilità			
			var AAirr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_ANNO_IRREVOCABILITA%>.value;
    		var MMirr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_MESE_IRREVOCABILITA%>.value;
    		var GGirr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_GIORNO_IRREVOCABILITA%>.value;    	
    		var data_to_verify = GGirr+'/'+MMirr+'/'+AAirr;
     		if (!ControllaData(data_to_verify) && data_to_verify.length>2)
      		{ 
        		alert('Data Irrevocabilità NON corretta'); 
        		document.LoadModificaRevocaIndultoAP.<%=ICostantiBeneficio.CAMPO_GIORNO_IRREVOCABILITA%>.focus(); 
        		return false; 
      		}     	
	
			var Motivo=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NOTE %>.value;
			var Dpr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_COD_DPR %>.value;
		
			var AArecl=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_ANNI_RECLUSIONE %>.value;
			var MMrecl=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_MESI_RECLUSIONE %>.value;
			var GGrecl=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_GIORNI_RECLUSIONE %>.value;
			
			var AAarr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_ANNI_ARRESTO %>.value;
			var MMarr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_MESI_ARRESTO %>.value;
			var GGarr=document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_NUM_GIORNI_ARRESTO %>.value;

   			var Multa_INT = document.LoadModificaRevocaIndultoAP.<%=ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>INT.value;
    		var Multa_DEC = document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>DEC.value;
   			
   			var Ammenda_INT = document.LoadModificaRevocaIndultoAP.<%=ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>INT.value;
    		var Ammenda_DEC = document.LoadModificaRevocaIndultoAP.<%= ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>DEC.value;    		
  		...
  		function VerifyChiamate(id)
		{
   			if(id==1)
  			{
          		document.LoadModificaRevocaIndultoAP.<%=IWebConstants.ACTION_FIELD%>.value = "siap.siep.beneficio.action.ActModificaRevocaIndultoAP";
  			}
  			else if(id==2)
  			{
          		document.LoadModificaRevocaIndultoAP.<%=IWebConstants.ACTION_FIELD%>.value = "";
  			}
    ...
    function Dadef()
    {
    	var valueSel = document.LoadModificaRevocaIndultoAP.<%=ICostantiBeneficio.CAMPO_COD_TIPO_PROVVEDIMENTO%>.options.value;
...
%>
    	<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadModificaRevocaIndultoAP">
...
%>
		...
		<table>
	  		<tr>
        		...
        		<a href="Javascript:ListaProcAssociatiIndu('LoadModificaRevocaIndultoAP');">
     	...
     	<table cellspacing=1 cellpadding=1 width=90%>  
			<tr>
        		...
        		<td class="L" colspan="3">
          			...
          			<a href="Javascript:ListaComuni('LoadModificaRevocaIndultoAP','<%= ICostantiBeneficio.CAMPO_COD_LUOGO_EMITTENTE %>');">
...
%>
 ...
 <!--  - - - - - - -   // RECLUSIONE e MULTA   - - - - - - - - - - - -->	
  			<tr>
				...
				<% 	if(lBeneficio.getNumAnniReclusione().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_ANNI_RECLUSIONE %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>		
				...
				<% 	if(lBeneficio.getNumMesiReclusione().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_MESI_RECLUSIONE %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>		
				...
				<% 	if(lBeneficio.getNumGiorniReclusione().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_GIORNI_RECLUSIONE %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>		
				...
				<%  if(lBeneficio.getImportoMulta().intValue() == 0)
					{	%> 
				...
				<%	} 
					...
					{	%>				
						<input type="text" style="text-align:right" maxlength="8" size="8" name="<%= ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>INT"
							value="<%=StringUtils.getParteIntera(lBeneficio.getImportoMulta())%>"
							onkeypress="return TicTabNumField(this,event)"> , 
						<input type="text" style="text-align:left" maxlength="2" size="2" name="<%= ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>DEC"
							value="<%=StringUtils.getParteDecimale(lBeneficio.getImportoMulta())%>"
							onkeypress="return TicTabNumField(this,event)">
				<%	} %>			 
    			</td>	
...
<!--  - - - - - - -   // ARRESTO e AMMENDA   - - - - - - - - - - - -->						
				...
				<% 	if(lBeneficio.getNumAnniArresto().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_ANNI_ARRESTO %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>
				...
				<% 	if(lBeneficio.getNumMesiArresto().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_MESI_ARRESTO %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>		
				...
				<% 	if(lBeneficio.getNumGiorniArresto().intValue() == 0)
					{	%> 
						<input type="text" name="<%= ICostantiBeneficio.CAMPO_NUM_GIORNI_ARRESTO %>" maxlength="2" size="2" value="">&nbsp;
				<%	}
					else
					{ 	%>		
				...
				<% 	if(lBeneficio.getImportoAmmenda().intValue() == 0)
					{	%> 
				...
				<%	}
					...
					{ 	%>		
 						<input type="text" style="text-align:right" maxlength="8" size="8" name="<%= ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>INT"
							value="<%=StringUtils.getParteIntera(lBeneficio.getImportoAmmenda())%>"
							onkeypress="return TicTabNumField(this,event)"> , 
						<input type="text" style="text-align:left" maxlength="2" size="2" name="<%= ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>DEC"
							value="<%=StringUtils.getParteDecimale(lBeneficio.getImportoAmmenda())%>"
							onkeypress="return TicTabNumField(this,event)">
 				<% 	}%>					
				</td>
			</tr>
  ...
  %>
     ...
     var frmvalidator  = new Validator("LoadModificaRevocaIndultoAP");
  	...
  	frmvalidator.addValidation("<%= ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>INT","numeric","Il campo Multa  può contenere solo caratteri numerici");
  	frmvalidator.addValidation("<%= ICostantiBeneficio.CAMPO_IMPORTO_MULTA%>DEC","numeric","Il campo Multa  può contenere solo caratteri numerici");    		  
  	...
  	frmvalidator.addValidation("<%= ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>INT","numeric","Il campo Ammenda  può contenere solo caratteri numerici");
  	frmvalidator.addValidation("<%= ICostantiBeneficio.CAMPO_IMPORTO_AMMENDA%>DEC","numeric","Il campo Ammenda  può contenere solo caratteri numerici");
