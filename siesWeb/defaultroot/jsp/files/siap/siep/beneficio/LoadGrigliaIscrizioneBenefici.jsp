...
<body class="corpo">
  ...
  <br>
    ...
    <tr>
      <td colspan=3 class="Titolonocap">Iscrizione Benefici</td>
    </tr>
    <tr>
 <%  if (modoSIGE) { %>
 
      <td width="32%" class="menulines" nowrap>
        <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sige.beneficio.action.ActLoadInserisciBeneficioSige">Pena Sospesa - Non Menzione (Ex Artt 163 165 c.p.)</a>
      </td>
      <td width="32%" class="menulines" nowrap>
        <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.sige.beneficio.action.ActLoadInserisciBeneficioIndultoSige">Indulto</a>
      </td>
 <%}else { %>
       <td width="32%" class="menulines" nowrap>
        <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.beneficio.action.ActLoadInserisciBeneficio&lTipoFunzione=<%=lTipoFunzione%>">Pena Sospesa - Non Menzione (Ex Artt 163 165 c.p.)</a>
      </td>
      <td width="32%" class="menulines" nowrap>
        <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.beneficio.action.ActLoadInserisciBeneficioIndulto&lTipoFunzione=<%=lTipoFunzione%>">Indulto</a>
      </td>
 <%} %>
    </tr>
  </table>
