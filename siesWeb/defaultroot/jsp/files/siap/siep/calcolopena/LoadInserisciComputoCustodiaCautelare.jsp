...
<jsp:useBean id="lIstituto"             scope="request" class="siap.siep.istitutodetenzione.model.IstitutoDetenzioneModel"/>

<jsp:useBean id="lCssa"                scope="request" class="siap.sico.cssa.model.CSSAModel"/>
...
<%
//==============================================================================
// Form per l'inserimento/aggiornamento del provvedimento di computo custodia
// cautelare
//==============================================================================
...
<%
    ...
    if(posizioneGiuridica.isMisAlt())
    {
%>
      if(document.f.<%= ICostantiCSSA.CAMPO_ID_CSSA %>.value=="")
      {
        alert("L' UEPE è obbligatorio");
        document.f.<%=ICostantiCSSA.CAMPO_ID_CSSA %>.focus();
        return false;
      }

      if(document.f.<%= ICostantiAnnotazioneManuale.CAMPO_COD_UDS %>.value=="")
      {
        alert("L' Ufficio di Sorveglianza Preposto al Controllo è obbligatorio");
        document.f.<%=ICostantiAnnotazioneManuale.CAMPO_COD_UDS %>.focus();
        return false;
      }
<%
    }

    //if(Posizione.equals("11") || Posizione.equals("12") || Posizione.equals("13") || Posizione.equals("14") || Posizione.equals("19") || (Posizione.equals("10") || Posizione.equals("07") && (evento06 != null  && evento06.getIdEvento()!= null)))
...
<%
    ...
    //if(!Posizione.equals("11") && !Posizione.equals("12") && !Posizione.equals("13") && !Posizione.equals("14") && !Posizione.equals("19"))
    if(!posizioneGiuridica.isMisAlt() && !posizioneGiuridica.getCodPosizioneGiuridica().equals("03"))
    {
%>
...
%>
  ...
  <title>[S.I.E.S.] - Decreto Computo C.C. art. 657 c.p.p</title>
</head>
  <body class="corpo">
...
<form method="POST" name="f" action="<%=IWebConstants.PG_MAIN%>">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.calcolopena.action.ActInserisciComputoCustodiaCautelare">
...
<table style="width: 95%;">
  <tr>
    ...
    <td class="L">
      ...
      <input value="<%=DateUtils.getSysDate("yyyy")%>" type="text" size="4" maxlength="4" name="<%= ICostantiEvento.CAMPO_ANNO_DATA_TRASMISSIONE_ATTI %>" onBlur="javascript:value=FillYear(value)">
    </td>
  </tr>
</table>
...
<%
//==============================================================================
//              S E Z I O N E    CON    I    D E S T I N A T A R I
//==============================================================================
%>
...
%>
    <tr>
      <td class="Titolo" colspan=6>UEPE Competente</td>
    </tr>
    <tr>
      <td class="l" width="20%">UEPE </td>
      <td class="l">
        <input readonly Title="UEPE Competente" name="Indirizzo" value="<%=StringUtils.toStringJSP(lCssa.getComune())%>-<%=StringUtils.toStringJSP(lCssa.getIndirizzo())%>" size=60 >
        <input type="hidden" Title="UEPE Competente" name="<%=ICostantiCSSA.CAMPO_ID_CSSA %>" value="<%=StringUtils.toStringJSP(lCssa.getIdCSSA())%>" size=35 >
    ...
    <tr>
      <td class="l" width="20%">Ufficio di Sorveglianza</td>
      <td class="L">
        ...
        <input title="ufficio" value="" type="text" name="<%= ICostantiAnnotazioneManuale.CAMPO_COD_UDS %>" maxlength="35" size="25">
        <a href="Javascript:ListaUDS('f','<%=ICostantiAnnotazioneManuale.CAMPO_COD_UDS%>');">
          <img src="/images/filefolder.gif" border=0>
        </a>
      </td>
      <td rowspan=2 class="l">Note</td>
      <td rowspan=2 class="L">
        <TEXTAREA title="Note" name="<%=ICostantiAnnotazioneManuale.CAMPO_NOTE_UDS%>"  cols=20 rows=5 ></textarea>
      </td>
    </tr>
<%
  }
...
<%
    //if(Posizione.equals("11") || Posizione.equals("12") || Posizione.equals("13") || Posizione.equals("14") || Posizione.equals("19") || (Posizione.equals("10") || Posizione.equals("07") && (evento06 != null  && evento06.getIdEvento()!= null)))
//==============================================================================
// Se emesso ordine di esecuzione e Libero o in MisAlt
//==============================================================================
    if(   posizioneGiuridica.isMisAlt() || (Posizione.equals("10") || Posizione.equals("07") && (evento06 != null  && evento06.getIdEvento()!= null)))
    {
%>
...
<%
  ...
  {
%>
    <input title="Sede Autorita Esterna" value="<%=StringUtils.toStringJSP(lAutorita.getDescrSede()) %>" type="text" name="<%= ICostantiMisuraAlternativa.CAMPO_SEDE_POL_C %>"  maxlength="35" size="35">
<%
  }
  else
  {
...
//==============================================================================
// Se non libero aggiungo l'istituto di detenzione
//==============================================================================
...
<%
      ...
      if(posizioneGiuridica.isMisAlt())
      {
        if(lIstituto!= null && !lIstituto.getDescrTipoIstituto().equals(""))
        {
%>
          <td class="l">
            <input readonly Title="Istituto" name="Comune" value="<%=lIstituto.getDescrTipoIstituto()%> di <%=lIstituto.getDescrComune()%>" size=50>
            <input type="hidden"  Title="Istituto" name="<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" value="<%=lIstituto.getIdIstitutoDetenzione()%>" size=35>
...
%>
      ...
      <tr>
        <td class="l">Sede
 <%   if(!posizioneGiuridica.getCodPosizioneGiuridica().equals("03"))
    {
%>
<font class=ob>(*)</font>
<%}%>
...
%>
        ...
        <table style="width: 95%;">
          ...
          <tr>
            <td class="l">Sede </td>
            <td class="L">
              <input title="Sede Foro Avvocato" value="<%=StringUtils.toStringJSP(lAvv.getAvvocato().getForo())%>" type="text" name="<%=ICostantiAnnotazioneManuale.SEDE_AUTORITA_ESTERNA_ND%>" maxlength="35" size="35">
