    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Ordine di esecuzione per rideterminazione della pena</font>
        </td>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.calcolopena.action.ActStampaEmissioneProvvedimento&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
   </jsp:include>
<%}%>
...
<%}else{%>
 <td class="LBG">
          <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.calcolopena.action.ActLoadEmissioneProvvedimento" >
            <img align="middle" src="<%=IWebConstants.IMAGES_DIR%>arrowleft24.gif" alt="ritorna su" width="24" height="24" border="0">
          </a>
      </td>
    ...
    <table>
      <tr>
        ...
        <%if(lFascicoloAssociato.getFlagAltraCausa()!=null && lFascicoloAssociato.getFlagAltraCausa().equals("S"))
          {%>
            <td class="L" colspan=3><font class="campo">DETENUTO PER ALTRA CAUSA <%=posizioneluogoaltra.getAltraCausa().getDescrTipoPosGiuridica()%> </font> </td>
        <%}else{%>
...
<%//modifica relativa al tipo istituto
if(lEve != null && lEve.getNotifiche()!= null && lEve.getNotifiche().length > 0 &&  lEve.getNotifiche()[0] != null && lEve.getNotifiche()[0].getIstDetIdIstitutoDetenzione()!= null)
 {%>
    <tr>
      <td class="l">Autorita Esecuzione</td>
      <td class="L" colspan=2>
       <font class="campo">
...
<%}else{
    if(lEve != null && lEve.getNotifiche()!= null && lEve.getNotifiche().length > 0 && lEve.getNotifiche()[0] != null && lEve.getNotifiche()[0].getAutoritaEsterna() != null )
     {%>
    <tr>
      <td class="l">Autorita Esecuzione</td>
      <td class="L" colspan=2>
...
%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.calcolopena.action.ActUploadEmissioneProvvedimento">
  ...
  <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.calcolopena.action.ActLoadDettaglioEmissioneProvvedimento">
          </td>
        </tr>
      </table>
    </FORM>
