...
<jsp:useBean id="NoteUfficio"   		scope="request" class="java.lang.String"/>
...
<jsp:useBean id="autoritaUfficio"   scope="request" class="siap.sico.ufficio.model.UfficioModel"/>
...
<html>
  ...
  <script language="JavaScript" src="<%=ISIAPCostantiWeb.JS_CONTROL_UPLOAD%>"></script>
    <title>[S.I.E.S.] -Dettaglio Decreto Computo C.C. Fungibilita</title>
  </head>
  <body class="corpo">
<%
  //FascicoloSiepModel lFascicoloAssociato = (FascicoloSiepModel)session.getAttribute("fascicolo");
...
%>
  ...
  <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
         <font class="campo">Dettaglio Decreto Computo C.C. Fungibilita</font>
      </td>
...
<%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
     <%--td class="LBG">
          <a href="/jsp/Main.jsp?Action=siap.siep.calcolopena.action.ActStampaFungibilita&IdEvento=
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.calcolopena.action.ActStampaFungibilita&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&codposizionegiuridica="+posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()+"&annoGE="+annoGE%>"/>
   </jsp:include>
 <%}%>
...
%>
    <tr>
       <td class="l">Autorità giudiziaria</td >
       <td class="L">
          <font class="campo"> <%=StringUtils.toStringJSP(autoritaUfficio.getDescrTipoUfficio()) %></font>
       </td>
    </tr>
    <tr>
       <td class="l">Sede </td>
       <td class="L">
         <font class="campo"><%=StringUtils.toStringJSP(autoritaUfficio.getDescrComune()) %></font>
       </td>
    </tr>
<%
  if(NoteUfficio!= null && !NoteUfficio.equals(""))
  {
%>
    <tr>
      <td class="l">Note</td>
      <td class="L">
        <font class="campo"><%=NoteUfficio%>&nbsp;</font>
      </td>
    </tr>
<%
  }
...
{%>
   <tr>
      <td class="l">Autorità di polizia per restituzione OE</td >
     <td class="L">
...
%>
    <tr>
         ...
         <td class="L"><font class="campo"><%=StringUtils.toStringJSP(autoritaEsternaNC.getDescrTipoAutorita())%></font>
         </td>
   </tr>
   <tr>
      <td class="l">Sede  </td>
...
while(count < eventonotifica.getNotifiche().length)
{
 ...
 if(lNotMod.getCodTipoNotifica().equals("ND") && lNotMod.getAutoritaEsterna()!=null && lNotMod.getAvvIdAvvocatoFascicoloSiep()!= null)
  {
      ...
      <table>
        ...
        <tr>
          <td class="L">
           ...
           <input type="HIDDEN" name="flagPage" value="<%=flagPage%>">
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.calcolopena.action.ActUploadFungibilita">
            <input type="HIDDEN" name="IdPosizioneGiuridica" value="<%=posizioneGiuridica.getIdPosizioneGiuridica()%>">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.calcolopena.action.ActDettaglioFungibilita">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
