...
// menu: 'Rideterminazione Pena - Provvedimenti del PM - Revoca LA'
//
// - Posizione giuridica
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Rideterminazione della Pena - Revoca Liberazione Anticipata</font>
      </td>
    </tr>
  </table>
...
<%
//==============================================================================
// Sezione con la scelta tipo LA per comilazione manuale.
...
<table style="width: 95%;">
  <tr>
    <td class="Titolo"  colspan="6"> Giorni Liberazione Anticipata da Revocare/Periodi </td>
  </tr>
  <% for (int k=0; k<6; k++) { %>
  <tr>
    <% if (k==0) { %>
    <td class="l">
      Totale giorni Liberazione Anticipata da Revocare<font class="ob">(*)</font>
      <input type="text" Title="Totale Giorni L.A." name="<%=ICostantiCalcoloPena.CAMPO_NUM_GIORNI_LA %>" value="" 
             size="5" maxlength="4"
             onkeypress="return TicTabNumField(this,event)"
             >
    </td>
...
<table style="width: 95%;">
  <tr>
    <td class="Titolo"  colspan="6"> Giorni Liberazione Anticipata Speciale da Revocare/Periodi </td>
  </tr>
  <% for (int k=0; k<6; k++){ %>
  <tr>
    <% if (k==0){ %>
    <td class="l">
      Totale giorni Liberazione Anticipata Speciale da Revocare<font class="ob">(*)</font>
      <input type="text" Title="Totale Giorni L.A. Speciale" name="<%=ICostantiCalcoloPena.CAMPO_NUM_GIORNI_LA_SPE%>" value="" 
             size="5" maxlength="4"
             onkeypress="return TicTabNumField(this,event)">
    </td>
    <%}else {%>
...
<table style="width: 95%;">
  <tr>
    <td class="Titolo"  colspan="6"> Giorni Integrazione Liberazione Anticipata da Revocare/Periodi </td>
  </tr>
  <% for (int k=0; k<6; k++) {%>
  <tr>
    <% if (k==0){ %>
    <td class="l">
      Totale giorni Integrazione Liberazione Anticipata da Revocare<font class="ob">(*)</font>
      <input type="text" Title="Totale Giorni Integrazione L.A." name="<%=ICostantiCalcoloPena.CAMPO_NUM_GIORNI_LA_INT %>" value="" 
             size="5" maxlength="4"
             onkeypress="return TicTabNumField(this,event)" >
    </td>
    <% } else { %>
