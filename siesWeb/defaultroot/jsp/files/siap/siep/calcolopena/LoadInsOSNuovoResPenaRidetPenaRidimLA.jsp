...
<!-- LoadInsOSNuovoResPenaRidetPenaRidimLA -->
    ...
    <script language="JavaScript">
      ...
      function Verify()
      {
        ...
        <% if (   lPosizione.getCodPosizioneGiuridica().equals("01")
               ...
               || lPosizione.getCodPosizioneGiuridica().equals("14")
...
<body class="corpo">
  ...
  <form method="POST" name="LoadInserisciComunicazione" action="<%=IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.calcolopena.action.ActInserisciOSRidetPenaRidimLA">
    ...
    <table width=95%>
      ...
      <tr>
        ...
        <td class="L" colspan="100%">
          ...
          <input type="HIDDEN" value="<%=StringUtils.toStringJSP(aCampoNota.getDescr() )%>" type="text" name="camponote" >
        </td>
      </tr>
    </table>
   ...
   <!-- ==================================================================== -->
    ...
    <table width=100%>
      ...
      <% if (   lPosizione.getCodPosizioneGiuridica().equals("01")
             ...
             || lPosizione.getCodPosizioneGiuridica().equals("03")
             || lPosizione.getCodPosizioneGiuridica().equals("23")
             || lPosizione.getCodPosizioneGiuridica().equals("14") // Semilibero new 02/10/2014
             || lPosizione.isMisSosp()
           ) 
      {  %>
      <tr>
