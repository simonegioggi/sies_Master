...
<head>
  ...
  <script language="JavaScript">
    ...
    function Verify()
      ...
      if(document.LoadInserisciOrdineScarcerazione.<%= ICostantiMagistrato.CAMPO_COGNOME %>.value=="" && document.LoadInserisciOrdineScarcerazione.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
      {
...
<%
              //REATO ANNOTAZIONE MANUALE
                  if(lFlagAnnoNumero)
                  {
                    ...
                    if(lAnn.getAnnoFonte() != null && !lAnn.getAnnoFonte().equals(""))
...
%>
        ...
        <font class="campo">
          <%=StringUtils.toStringJSP(lAnn.getAnnoCc())%>/<%=StringUtils.toStringJSP(lAnn.getNumeroCc())%>
        </font>
        <font class="label">&nbsp;in data</font>
...
/*
  if( lCodicePosizione.equals("11")
    || lCodicePosizione.equals("12")
    || lCodicePosizione.equals("13")
    || lCodicePosizione.equals("14")
    || lCodicePosizione.equals("19")
    )
*/
