...
<!-- DettOSNuovoResPenaRidetPenaAltro -->
<% 
//==============================================================================
// Form per la visualizzazione del dettaglio dell'Evento di Rideterminazione
// pena (nuovo residuo pena) a seguito di Rideterminazione Pena Altro.
  ...
  <table>
    <tr>
      ...
      <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
        <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.calcolopena.action.ActStampaOSRidetPenaAltro&IdEvento="+lEveComu.getIdEvento()%>"/>
      </jsp:include>
      <%}%>
    ...
    if(eventonotifica.getNotifiche() != null && eventonotifica.getNotifiche().length >0)
    {
      ...
      //====================
       ...
       <%
        ...
        {%>
		  <tr>
		      <td class="l"><%=StringUtils.toStringJSP(lNotMod.getCSSA().getTipoDesc())%></td>
		         <td class="l">
      ...
      <%--   
        ...
        //============================
        if(   lNotMod != null && lNotMod.getCodTipoNotifica() != null 
           && (lNotMod.getCodTipoNotifica().equals("MS") ||  lNotMod.getCodTipoNotifica().equals("MM"))
           && lNotMod.getUfficio()!= null &&  lNotMod.getUfficio().getDescrComune() != null
          )
        {
        	
        	//MAC20191129017-MG-04/12/2019: decodifica ufficio TDS
        	//NotificaModel nm = (NotificaModel) lTable.get("UffTDS");
 			String uffTDS = MinorMask.dettaglioMagistrato(lNotMod.getUfficio(), codiceTipoUfficio);
        ...
        //============================
        if(   lNotMod != null && lNotMod.getCodTipoNotifica() != null 
           && (lNotMod.getCodTipoNotifica().equals("TS") || lNotMod.getCodTipoNotifica().equals("TM"))
           && lNotMod.getUfficio()!= null &&  lNotMod.getUfficio().getDescrComune() != null
          )
        {      
        	
 			String uffUDS = MinorMask.dettaglioTribunale(lNotMod.getUfficio());
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>"              value="siap.siep.calcolopena.action.ActUploadOSRidetPenaAltro">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>"         value="<%=lEveComu.getIdEvento() %>">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.calcolopena.action.ActLoadDettaglioOSRidetPenaAltro">
          </td>
        </tr>
      </table>
    </FORM>
