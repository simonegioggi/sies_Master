...
<%
// Annotazioni manuali concessi con il provvedimento
%>
...
<%
// Annotazioni manuali richieste
%>
<jsp:useBean id="AnnManRicConcessiReclusione" scope="request" class="siap.sico.calendar.model.CalendarModel" />
<jsp:useBean id="AnnManRicConcessiArresto"    scope="request" class="siap.sico.calendar.model.CalendarModel" />
<jsp:useBean id="AnnManRicRevocatiReclusione" scope="request" class="siap.sico.calendar.model.CalendarModel" />
<jsp:useBean id="AnnManRicRevocatiArresto"    scope="request" class="siap.sico.calendar.model.CalendarModel" />
...
<jsp:useBean id="TipoRichieste"  scope="request" class="java.lang.String" />
<jsp:useBean id="TipoDecisione"  scope="request" class="java.lang.String" />
...
/*
    ...
    di Amnistia/Indulto per ora solo nel caso di Decisioni del GE. !!!!!!!!!!!!!!!!!!!!
    ...
    - sezione con le date (decorrenza/scadenza)
    - sezione relativa alla fungibilità

    Viene infine visualizzata la pena rideterminata.
...
*/
  ...
  // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
  siesLogger.debug("jsp: lIsSoloImporti = "+lIsSoloImporti.booleanValue());
%>
<html>
  <!-- VediCalcoloPenaDecisioniGE -->
  <head>
...
// La visualizzazione contiene
//   - Pena di partenza (ultima validata o calcolata)
//   - quantum richiesti (concessi/revocati) con provvedimento (solo se decisione collegata a richieste)
//   - quantum concessi/revocati con provvedimento
//
//==============================================================================
%>
  <table>
    ...
    //==========================================================================
    //                        PENA IN DECORRENZA
    // n.b. non visualizzata nel caso di decisione del GE conforme a una
    //      richiesta con anticipazione degli effetti e soggetto scarcerato
    //
    //==========================================================================
    %>
    <% if (
            !( TipoRichieste.equals("A") && dataScarcerazione!=null && TipoDecisione.equals("C"))
          )
    {
    %>
    <tr>
    ...
    <%
    //====================================================================
    // BENEFICI CONCESSI CON LE RICHIESTE AGGANCIATE E QUESTA DECISIONE
    //====================================================================
    if ( !(   lCalendarUtil.isZero(AnnManRicConcessiReclusione)
           && AnnManRicConcessiReclusione.getImportoMulta()==0
           && lCalendarUtil.isZero(AnnManRicConcessiArresto)
           && AnnManRicConcessiArresto.getImportoAmmenda()==0))
    {
    %>
      <tr>
        <% if (TipoRichieste.equals("A")) {%>
        <td class="Titolo" colspan=9><font class="label">Benefici Concessi Contenuti nelle Richieste (con anticipazione)</font></td>
        <% } else if (TipoRichieste.equals("R")) {%>
        <td class="Titolo" colspan=9><font class="label">Benefici Concessi Contenuti nelle Richieste (senza anticipazione)</font></td>
        <% } else {%>
        <td class="Titolo" colspan=9><font class="label">Benefici Concessi Contenuti nelle Richieste</font></td>
        <% } %>
      </tr>

      <%
      if (!(lCalendarUtil.isZero(AnnManRicConcessiReclusione) && AnnManRicConcessiReclusione.getImportoMulta()==0 ))
      {
      %>
        <tr>
          <td class="l"><font class="label">Reclusione / Multa :</font></td>
          <td class="l"><font class="label">Anni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiReclusione.getNumAnni()%></font></td>
          <td class="l"><font class="label">Mesi</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiReclusione.getNumMesi()%></font></td>
          <td class="l"><font class="label">Giorni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiReclusione.getNumGiorni()%></font></td>
          <td class="l"><font class="label">Importo</font></td>
          <td class="r"><font class="campo"><%=StringUtils.toEuroFormat(new BigDecimal(AnnManRicConcessiReclusione.getImportoMulta()))%></font></td>
        </tr>
      <%
      }

      if (!( lCalendarUtil.isZero(AnnManRicConcessiArresto) && AnnManRicConcessiArresto.getImportoAmmenda()==0))
      {
      %>
        <tr>
          <td class="l"><font class="label">Arresto / Ammenda :</font></td>
          <td class="l"><font class="label">Anni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiArresto.getNumAnni()%></font></td>
          <td class="l"><font class="label">Mesi</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiArresto.getNumMesi()%></font></td>
          <td class="l"><font class="label">Giorni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicConcessiArresto.getNumGiorni()%></font></td>
          <td class="l"><font class="label">Importo</font></td>
          <td class="r"><font class="campo"><%=StringUtils.toEuroFormat(new BigDecimal(AnnManRicConcessiArresto.getImportoAmmenda())) %></font></td>
        </tr>
      <%
      }
    }
    ...
    //====================================================================
    //  BENEFICI REVOCATI CON LE RICHIESTE AGGANCIATE E QUESTA DECISIONE
    //====================================================================
    if (! (   lCalendarUtil.isZero(AnnManRicRevocatiReclusione)
           && AnnManRicRevocatiReclusione.getImportoMulta()==0
           && lCalendarUtil.isZero(AnnManRicRevocatiArresto)
           && AnnManRicRevocatiArresto.getImportoAmmenda()==0
          )
       )
    {
    %>
      <tr>
        <td class="Titolo" colspan=9><font  class="label">Benefici Revocati Contenuti nelle Richieste</font></td>
      </tr>
      <%
      if (!(lCalendarUtil.isZero(AnnManRicRevocatiReclusione) && AnnManRicRevocatiReclusione.getImportoMulta()==0 ))
      {
      %>
        <tr>
          <td class="l"><font class="label">Reclusione / Multa :</font></td>
          <td class="l"><font class="label">Anni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiReclusione.getNumAnni()%></font></td>
          <td class="l"><font class="label">Mesi</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiReclusione.getNumMesi()%></font></td>
          <td class="l"><font class="label">Giorni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiReclusione.getNumGiorni()%></font></td>
          <td class="l"><font class="label">Importo</font></td>
          <td class="r"><font class="campo"><%=StringUtils.toEuroFormat(new BigDecimal(AnnManRicRevocatiReclusione.getImportoMulta()))%></font></td>
        </tr>
      <%
      }

      if (!( lCalendarUtil.isZero(AnnManRicRevocatiArresto) && AnnManRicRevocatiArresto.getImportoAmmenda()==0))
      {
      %>
        <tr>
          <td class="l"><font class="label">Arresto / Ammenda :</font></td>
          <td class="l"><font class="label">Anni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiArresto.getNumAnni()%></font></td>
          <td class="l"><font class="label">Mesi</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiArresto.getNumMesi()%></font></td>
          <td class="l"><font class="label">Giorni</font></td>
          <td class="l"><font class="campo"><%=AnnManRicRevocatiArresto.getNumGiorni()%></font></td>
          <td class="l"><font class="label">Importo</font></td>
          <td class="r"><font class="campo"><%=StringUtils.toEuroFormat(new BigDecimal(AnnManRicRevocatiArresto.getImportoAmmenda()))%></font></td>
        </tr>
      <%
      }
    }
    ...
    %>
      <tr>
        <td class="Titolo" colspan=9><font  class="label">Benefici Rigettati con Provvedimento</font></td>
      </tr>
      <%
...
// NEW 3.0
// - se pena non in espiazione e quantum negativi non visualizzo più i quantum 
// - negativi, ma li visualizzo nulli e visualizzo un campo 'periodo espiato/calcolato in eccesso' 
//==============================================================================
%>
  <br>
  <table>
    <tr>
      ...
      if (   DataInizioPena!=null
          && (   !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumReclusione())
              || !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumArresto())
             )
         )
      { // Pena in decorrenza e Quantum negativi visualizzo i dati evidenziandoli in rosso
      %>
        <tr>
          <td class="l"><font class="label">Reclusione / Multa : </font></td>
          <td class="l"><font class="label">Anni</font></td>
      ...
      else if (   DataInizioPena==null 
               && (   !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumReclusione())
                   || !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumArresto())
                  )
              )
      { // Quantum negativi e pena non in decorrenza visualizzo iquantum di pena a 0
      %>
        <tr>
          <td class="l"><font class="label">Reclusione / Multa : </font></td>
          <td class="l"><font class="label">Anni</font></td>
          <td class="r"><font class="campo">0</font></td>
          <td class="l"><font class="label">Mesi</font></td>
          <td class="r"><font class="campo">0</font></td>
          <td class="l"><font class="label">Giorni</font></td>
          <td class="r"><font class="campo">0</font></td>
    ...
    // NEW 3.0
    // [FT] - 05/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    // siesLogger.debug("Fungibilita: "+Fungibilita);
    if (   DataInizioPena==null
        && (   !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumReclusione())
            || !lCalendarUtil.isPositiveTime(PenaRideterminata.getQuantumArresto())
           )
       )
    { // Pena non in decorrenza e Quantum negativi visualizzo la pena espiata in eccesso
      ...
      <table>
        <tr>
          <td class="Titolo" colspan="9"><font class="label">Periodo Espiato/Calcolato In Eccesso</font></td>
          <td class="l"><font class="label">Anni</font></td>
    ...
    // n.b. tali quantum non andrebbero visualizzati nemmeno se si sta applicando
...
//==============================================================================
      ...
      // n.b. se il calcolo è stato effettuato solo sugli importi importi
      //      non faccio nulla sulle date e quantum
      //========================================================================
