...
<%
    String giorniMRCD=request.getParameter("giorni");
	String mesiMRCD=request.getParameter("mesi"); 
	String anniMRCD=request.getParameter("anni"); 
    ...
    if(giorniMRCD.equalsIgnoreCase(""))
    	 lMisMod.setNumGiorni(new BigDecimal(0));
    else
    	 lMisMod.setNumGiorni(new BigDecimal(giorniMRCD));
    if(mesiMRCD.equalsIgnoreCase(""))
    	lMisMod.setNumMesi(new BigDecimal(0));
    else
    	lMisMod.setNumMesi(new BigDecimal(mesiMRCD));
    if(anniMRCD.equalsIgnoreCase(""))
    	lMisMod.setNumAnni(new BigDecimal(0));
    else
    	lMisMod.setNumAnni(new BigDecimal(anniMRCD));
    ...
    //dove consideriamo periodi sovrapposti solo per Misure Cautelari
     String totGiorniMesiAnni = sommaColonnaGiorni+"|"+sommaColonnaMesi+"|"+sommaColonnaAnni;
     out.println (totGiorniMesiAnni);
%>
