...
<jsp:useBean id="contesto"               scope="request" class="java.lang.String" />
...
// Decisioni del GE - Depenalizzazione
// Sezioni della form
// - Capi di Imputazione
// - Stato della Pena
...
%>
	...
	// MEV 37- Inizio
	// se non si seleziona La richiesta dalla lista, il Tipo di provvedimento da effettuare è 'senza richiesta' 
	if( document.f.Radio_Depe_Ammi[0].checked  || 
	    document.f.Radio_Depe_Ammi[1].checked )
	{
		 if (document.f.TipoOrd[1].checked || 
			 document.f.TipoOrd[2].checked	 )
		 {
			// alert("Se si seleziona Depenalizzazione o Illecito Amministrativo \n il provvedimento deve essere del tipo 'Senza Richiesta' ");
			 alert(" In assenza della Richiesta, \n bisogna selezionare 'senza richiesta' ");
			 document.f.TipoOrd[0].focus();
			 return false;
		 }	 
	}
	...
	if( document.f.Radio_Depe_Ammi[0].checked == false && 
	    document.f.Radio_Depe_Ammi[1].checked == false )
		{
			 if (document.f.TipoOrd[1].checked || 
				 document.f.TipoOrd[2].checked	 )
			 {
				 if(document.f.<%=ICostantiAnnotazioneManuale.CAMPO_COD_TIPO_ANNOTAZIONE%>.value != "004" &&
					document.f.<%=ICostantiAnnotazioneManuale.CAMPO_COD_TIPO_ANNOTAZIONE%>.value != "017" )
				 {	 
				 	//alert("Selezionare 'Depenalizzazione' o 'Illecito Amministrativo' ");
				 	alert(" selezionare Elenco delle Richieste (Link 'Seleziona Richieste') ");
				 	document.f.TipoOrd[0].focus();
				 	return false;
				 }	
			 }	 
	...
	// se non si specifica depenalizzazione o Illecito Amministrativo, allora va indicato 'in conformità ... ' o 'in difformità...'
	if (document.f.TipoOrd[0].checked )
 	{
		...
		{
			//alert("Selezionare Depenalizzazione o Illecito Amministrativo ");
			alert(" Se è stata selezionata la Richiesta, bisogna indicare \n 'in conformità ... ' o 'in difformità ... ' ");
	...
	// MEV 37 Inizio	
 	function mettiFonte()
 	{
	   	if(document.f.Radio_Depe_Ammi[0].checked)
	   	{
	   		...
	   		document.f.<%=ICostantiAnnotazioneManuale.CAMPO_COD_TIPO_ANNOTAZIONE%>.value = "004";
	   	}
 	...
 	function vediradio()
   	{
 	  	...
 	  	var nodeRadio = document.getElementById('divRadio');
 	  	nodeRadio.style.display = 'block';
 	  	
 	  	document.f.Radio_Depe_Ammi[0].checked = false;
 	  	document.f.Radio_Depe_Ammi[1].checked = false;
...
<body class="corpo" onLoad="javascript:vediradio()">
  <form action="<%=IWebConstants.PG_MAIN%>" method="post" name=f>
		<input type="hidden" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.calcolopena.action.ActInserisciAnnotazioniManualiDepen">
    ...
    <input type="hidden" name="lFlagPage"     value="DEPEN">

    <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_COD_MOTIVO%>" value="0285">
    <input type="HIDDEN" name="<%=ICostantiAnnotazioneManuale.CAMPO_COD_TIPO_ANNOTAZIONE%>" >
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;<font class="campo">Depenalizzazione</font>
      </td>
    </tr>
  </table>
  <br>
...
<table width="45%" >
  <tr><td class="Titolo">Richieste al GE</td></tr>
  <tr>
    <td class="l" style="text-align:center" >
      <a href="Javascript:ListaRichiesteAlGE('f', 'DEPEN');">Seleziona Richieste <img src="/images/filefolder.gif" border=0></a>
    </td>
  </tr>
</table>
<!-- 		MEV 37 . INIZIO	 -->
<div id="divRadio" style="display:none; position:relative;">
<table width="45%" >
	<tr><td class="l" style="text-align:center" colspan="2"><font class="label">&nbsp;OPPURE&nbsp;</font></td></tr>
	<tr><td>&nbsp;</td></tr>
  <tr>  	    
    <td class="l" width="15%"> Depenalizzazione <input type="radio" name="Radio_Depe_Ammi" value="D" onClick="javascript:mettiFonte();" ></td> 
    <td class="l" width="20%"> Illecito Amministrativo <input type="radio" name="Radio_Depe_Ammi" value="I" onClick="javascript:mettiFonte();" ></td>
  </tr>
</table>
</div>
<!-- 		MEV 37 . FINE	 -->  
...
<%
    ...
    <td class="l">
      <table>
        ...
        <td class="lnobord"><font class="label">MA</font></td>
...
<%
//==============================================================================
//        Sezione con i dati della Decisione del Giudice dell' Esecuzione
//==============================================================================
%>
<table style="width: 95%;">
...
<%
//==============================================================================
//              S  E Z I O N E    C O N    I    Q U A N T U M 
//==============================================================================
%>
