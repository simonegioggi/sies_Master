...
<html>
<head>
  <title> Dettaglio Annotazione Depenalizzazione </title>
  ...
  <script language="JavaScript">
    ...
    function eseguiFunzione(aTipoAzione)
    {
      if (aTipoAzione=='Inserisci'){
        ...
        lAzione = "siap.siep.modulocumulo.action.ActRicercaDepenalizzazioneCumulo";
        document.formName.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.formName.submit();
      }
    }
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Dettaglio Annotazione Depenalizzazione &nbsp;</font>
      </td>
...
<% 	} %>
  	...
  	<table align="center" width="95%" style="border:0;" cellspacing="1" cellpadding="1">
		    ...
		    <tr> 
		      <td class="l">Declaratoria N.° </td>
		      <td class="l">
				<font class="campo">
<%					if(lComputo.getAnnoProvv() != null && !lComputo.getAnnoProvv().equals("") && !lComputo.getAnnoProvv().equals("0"))
					{
					   out.println(lComputo.getAnnoProvv()+" ");
				  	}%>
				</font>&nbsp; /
		        <font class="campo">
<%					if(lComputo.getProgrProvv() != null && !lComputo.getProgrProvv().equals("") && !lComputo.getProgrProvv().equals("0"))
					{
					   out.println(lComputo.getProgrProvv()+" ");
				  	}%>
		        </font>&nbsp;
		      </td>
...
<%			// Dati Fonte %>
		    <tr>
		      <td colspan=7 class="Titolonocap">Contenuto Decisione</td>
		    </tr>
	    	<tr>
		  ...
		  <table align="center" width="95%" style="border:0;" cellspacing="1" cellpadding="1">      
		    <tr>
		      <td class="l" width="15%">Reclusione :</td>
		      <td class="l" width="25%" >&nbsp;
		        Anni
		    ...
		    <tr>
		      <td class="l" width="15%">Arresto : </td>
		      <td class="l" width="25%" >&nbsp;
		        Anni
		        <font class="campo"><%=StringUtils.toStringJSP(lComputo.getNumAnniArresto(),"-")%></font>&nbsp;&nbsp;
		        Mesi
		        <font class="campo"><%=StringUtils.toStringJSP(lComputo.getNumMesiArresto(),"-")%></font>&nbsp;&nbsp;
		        Giorni
		        <font class="campo"><%=StringUtils.toStringJSP(lComputo.getNumGiorniArresto(),"-")%></font>&nbsp;
		      </td>
		      <td class="l"  width="30%" >Ammenda :
		        &nbsp;<font class="campo">
