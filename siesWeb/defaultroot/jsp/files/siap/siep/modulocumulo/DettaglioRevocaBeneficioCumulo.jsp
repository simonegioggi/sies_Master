...
// In particolare   SOSPENSIONE CONDIZIONALE in Altro Titolo Cumulato e 
//					NON MENZIONE in Altro Titolo Cumulato 
//==============================================================================
%>

<!-- 					DettaglioRevocaBeneficioCumulo					 -->
<html>
  	<head>
	<title>[S.I.E.S.] - Gestione Cumulo - Dettaglio Revoca Beneficio </title>
    ...
    {
      document.DettaglioRevocaSospe.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.DettaglioRevocaSospe.submit();
    }
	
	function VaiadInserire(action)
    {
      document.DettaglioRevocaSospe.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.DettaglioRevocaSospe.modalita.value="I";
      document.DettaglioRevocaSospe.submit();
    }
    ...
    {
      document.DettaglioRevocaSospe.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.DettaglioRevocaSospe.modalita.value="M";
      document.DettaglioRevocaSospe.submit();
    }
    ...
    function VaiaCancellare(action, aIdBen, aStato, aMotivoModifica)
    {
    	if (aStato=='E' || aStato=='M')
    	{
            ...
            document.DettaglioRevocaSospe.<%=ICostantiBeneficiCumulo.CAMPO_FLAG_STATO%>.value = aStato;
            document.DettaglioRevocaSospe.modalita.value="C";
            var  desktop = window.open("/jsp/Main.jsp?Action=siap.siep.modulocumulo.action.ActLoadCancellaDatoAnalitico" 
                                       + "&" + "<%=ICostantiModuloCumulo.NOME_FORM%>" + "="+"DettaglioRevocaSospe"
    	...
    	<table>
      		<tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        		<td class="LBG">
        			...
        			<font class="campo">Dettaglio Revoca Sospensiome/Non Menzione di altro Titolo Cumulato</font>
      			</td>
		      	<td class="LBG">
...
<%				} %>       	
  ...
  <!-- BOTTONE DI RITORNO -->
	...
	<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="DettaglioRevocaSospe">
    ...
    <table cellspacing=2 cellpadding=2 width=90%>
			<tr>
				<td class="l" width=20%>Natura Beneficio</td>
