...
// Pena Accessoria Richiesta dal PM
String lRic_CodPA="";
String lRic_CodDurPA="";
String lRic_AnniPA="";
String lRic_MesiPA="";
String lRic_GiorPA="";

if(RichiestaGE.getCodTipoPenaAccessoria()!=null)
	lRic_CodPA = RichiestaGE.getCodTipoPenaAccessoria();

if(RichiestaGE.getCodTipoDurataPa()!=null)
	lRic_CodDurPA = RichiestaGE.getCodTipoDurataPa();

if(RichiestaGE.getNumAnniPa()!=null)
	lRic_AnniPA = RichiestaGE.getNumAnniPa().toString();

if(RichiestaGE.getNumMesiPa()!=null)
	lRic_MesiPA = RichiestaGE.getNumMesiPa().toString();

if(RichiestaGE.getNumGiorniPa()!=null)
	lRic_GiorPA = RichiestaGE.getNumGiorniPa().toString();

// Pena Accessoria della Decisione del GE
String lconforme="";
String lDec_CodPA="";
String lDec_CodDurPA="";
String lDec_AnniPA="";
String lDec_MesiPA="";
String lDec_GiorPA="";
if("M".equals(modalita))
{
	...
	if(ProvvGECum.getCodTipoPenaAccessoriaD()!=null)
		lDec_CodPA = ProvvGECum.getCodTipoPenaAccessoriaD();

	if(ProvvGECum.getCodTipoDurataPaD()!=null)
		lDec_CodDurPA = ProvvGECum.getCodTipoDurataPaD();

	if(ProvvGECum.getNumAnniPaD()!=null)
		lDec_AnniPA = ProvvGECum.getNumAnniPaD().toString();

	if(ProvvGECum.getNumMesiPaD()!=null)
		lDec_MesiPA = ProvvGECum.getNumMesiPaD().toString();

	if(ProvvGECum.getNumGiorniPaD()!=null)
		lDec_GiorPA = ProvvGECum.getNumGiorniPaD().toString();
}
...
<head>
  ...
  <script language="JavaScript">
    ...
    {
      document.LoadInsDecGEApplPA.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.LoadInsDecGEApplPA.submit();
    }
    
    function Verify() 
    { 
   		// Anno e Numero Procedimento SIGE
        if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.value == '' && 
           document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value != ''	 )
        {
        	alert('Anno Procedimento G.E. NON valido');
            document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.focus();
            return false;
        } 
        	...
        	document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value == ''	 )
        {
            ...
            document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.focus();
            return false;
        }
       ...
       if ( document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value;
       if ( document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value;

       var data_to_verify = document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_DATA_EMISSIONE_D%>.value;
       if (data_to_verify=='//' )
       {
           alert('Indicare la Data Emissione Procedimento');
           document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.focus();
           return false;
       }
       ...
       if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value.length == 1	 )
       {
      	 	alert('Ufficio Emittente non valido');
          	document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.focus();
          	return false;
       } 
       
       if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 1 ||
      	 document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 0 )
       {
      	 	alert('Sede Ufficio Emittente non valida');
          	document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.focus();
          	return false;
       }
       
       	// Tipo Pena Accessoria
       	if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME%>[1].checked  )
       	{	
	  	   	if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.value == "-" && 
	  	   	   document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.value.length < 2	)
	    	{
	  	   		alert('Selezionare Tipo Pena Accessoria Applicata in Difformità');
	  	   		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.focus();
	  	   		return false;
	    	}
       	}
    ...
    function aprichiudi()
    {
   	 	...
   	 	if( document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME%>[0].checked )		// Conformità
   	 	{
 			$('#DivPA').show();
 			$('#tabDivPA').show();

 			// Decisione Conforme alla Richiesta
	 		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.value = '<%=lRic_CodPA%>';
	 		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_DURATA_PA %>.value = '<%=lRic_CodDurPA%>';
	 		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_PA %>.value = '<%=lRic_AnniPA %>';
	 		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_PA %>.value = '<%=lRic_MesiPA %>';
	 		document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_PA %>.value = '<%=lRic_GiorPA %>';
 				
   	 	}
   	 	else if(document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME%>[1].checked)		// Difformità
   	 	{
   	 		$('#DivPA').show();
    		$('#tabDivPA').show();
    		...
    		if(lmodo == "I")
    		{
    			// Decisione Difforme presento i campo vuoti (comunque modificabili)
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.value = '-';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_DURATA_PA %>.value = '-';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_PA %>.value = '';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_PA %>.value = '';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_PA %>.value = '';	
    		}
    		else if(lmodo == "M")
    		{
    			// Decisione Difforme, presento i campi già inseriti nella Decisione (comunque modificabili)
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_PENA_ACCESSORIA %>.value = '<%=lDec_CodPA%>';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_TIPO_DURATA_PA %>.value = '<%=lDec_CodDurPA%>';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_PA %>.value = '<%=lDec_AnniPA %>';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_PA %>.value = '<%=lDec_MesiPA %>';
	 			document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_PA %>.value = '<%=lDec_GiorPA %>';
    		}	
   	 	}
   	 	else
   	 	{
...
<%	if("I".equals(modalita) )
	{	%>
        	<font class="campo">Inserimento Decisione del G.E. su Richiesta Applicazione di Pena Accessoria</font>
<% 	}	
	else if("M".equals(modalita) )
	{	%>
			<font class="campo">Modifica Decisione del G.E. su Richiesta Applicazione di Pena Accessoria</font>		
<%	}	%>	        
      </td>
...
<form action="<%=IWebConstants.PG_MAIN%>" method="post" name="LoadInsDecGEApplPA">
    ...
    <tr>
      ...
      <td class="l">Sede Ufficio Emittente <font class="ob">(*)</font> :
          <font class="campo">
            ...
            <a href="Javascript:ListaUfficiComuni('LoadInsDecGEApplPA','<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>',
            					document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>[document.LoadInsDecGEApplPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.options.selectedIndex].value);">
...
%>  
		  <input type="radio" name="<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME %>" value="C" <%=checkC%> onClick="javascript:aprichiudi();">in conformita' alla richiesta del PM &nbsp;&nbsp;	<!-- Conforme -->
          <input type="radio" name="<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME %>" value="D" <%=checkD%> onClick="javascript:aprichiudi();">in difformita' alla richiesta del PM &nbsp;&nbsp;	<!-- Difforme -->
          <input type="radio" name="<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME %>" value="R" <%=checkR%> onClick="javascript:aprichiudi();">rigetta &nbsp;&nbsp;	<!-- Rigetta -->
          <input type="radio" name="<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_CONFORME %>" value="I" <%=checkI%> onClick="javascript:aprichiudi();">dichiara inammissibile &nbsp;&nbsp;	<!-- Inammissibile -->	
 ...
 <div id="DivPA"  style="display:none" >    
  <table width="95%" align="center" id="tabDivPA"  style="display:none" >
    <tr>
      <td colspan=4>
        <hr width="100%">
      </td>
    ...
    <tr><td class="Titolo" colspan="4" style="text-align:left" >Pena Accessoria Applicata </td></tr>  
    <tr>
...
<script language="JavaScript" type="text/javascript">
  ...
  var frmvalidator  = new Validator("LoadInsDecGEApplPA");
