...
<html>
<head>
  <title> Dettaglio Annotazione Incostituzionalità </title>
  ...
  <script language="JavaScript">
    ...
    function eseguiFunzione(aTipoAzione)
    {
      if (aTipoAzione=='Inserisci'){
        ...
        lAzione = "siap.siep.modulocumulo.action.ActRicercaIncostituzionalitaCumulo";
        document.formName.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.formName.submit();
      }
    }
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Dettaglio Annotazione Incostituzionalità &nbsp;</font>
      </td>
