...
<jsp:useBean id="ListaSospEsecuzionePena" 	scope="request" class="java.util.Vector"/>

<%
//==================================================================================================================
// Form per la visualizzazione dell'elenco di Provvedimenti di Sospensione Esecuzione pena legate a un certo Titolo.
//
// La form presenta un elenco dei Provvedimenti di Sospensione Esecuzione pena già presenti con la possibilità di 
...
<html>
<head>
  <title> Elenco Provvedimenti di Sospensione Esecuzione Pena </title>
  ...
  <script language="JavaScript">
    ...
    function eseguiAzione(aTipoAzione, aIdStat, aIdComp, aStato, aMotivoModifica)
    {
      if (aTipoAzione=='Dettaglio'){
        lAzione = "siap.siep.modulocumulo.action.ActDettaglioSospEsecuzionePenaCumulo";
        document.ListaSospEsecuzionePena.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
        document.ListaSospEsecuzionePena.<%=ICostantiComputiCumulo.CAMPO_ID_COMPUTI_CUMULO%>.value = aIdComp;
        document.ListaSospEsecuzionePena.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.ListaSospEsecuzionePena.submit();
      }
      else if (aTipoAzione=='Modifica'){
        lAzione = "siap.siep.modulocumulo.action.ActLoadInserisciSospEsecuzionePenaCumulo";
        document.ListaSospEsecuzionePena.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
        document.ListaSospEsecuzionePena.<%=ICostantiComputiCumulo.CAMPO_ID_COMPUTI_CUMULO%>.value = aIdComp;
        document.ListaSospEsecuzionePena.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.ListaSospEsecuzionePena.modalita.value = 'M';
        ...
        if (window.confirm(msgConfirm)) {
          lAzione = "siap.siep.modulocumulo.action.ActInserisciSospEsecuzionePenaCumulo";
          document.ListaSospEsecuzionePena.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;

          document.ListaSospEsecuzionePena.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
          document.ListaSospEsecuzionePena.<%=ICostantiComputiCumulo.CAMPO_ID_COMPUTI_CUMULO%>.value = aIdComp;
          document.ListaSospEsecuzionePena.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_FLAG_STATO%>.value = aStato;
          document.ListaSospEsecuzionePena.modalita.value = 'C';
    ...
    function nuovoProvvedimento(){
      lAzione = "siap.siep.modulocumulo.action.ActLoadInserisciSospEsecuzionePenaCumulo";
      document.ListaSospEsecuzionePena.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
      document.ListaSospEsecuzionePena.modalita.value = 'I';
      document.ListaSospEsecuzionePena.submit();
    }
    ...
    {
      document.ListaSospEsecuzionePena.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.ListaSospEsecuzionePena.submit();
    }
  ...
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
                      <font class="campo">Elenco Provvedimenti di Sospensione Esecuzione Pena &nbsp;</font>
      </td>
...
<FORM action="<%=IWebConstants.PG_MAIN%>" method="post" name="ListaSospEsecuzionePena">
  ...
  <table cellspacing="2" cellpadding="2" align="center" width="95%">
    ...
    <%
      ...
      Iterator itx = ListaSospEsecuzionePena.iterator();
      while ( itx.hasNext()) {
    ...
    <% if (ListaSospEsecuzionePena.size()==0){ %>
    <tr>
