...
<!-- 							LoadInsDecisioneDellaSORVAltreRic								 -->
<%
//==============================================================================
...
<html>
<head>
  <title>[S.I.E.S.] - Gestione Cumulo - Decisione della SORVEGLIANZA su Altre Richieste del PM </title>
  ...
  <script language="JavaScript">
    ...
    {
      document.LoadInsDecSORValtro.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.LoadInsDecSORValtro.submit();
    }
    
    function Verify() 
    { 
        // Tipo provvedimento SORV
		if(document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_PROVVEDIMENTO %>.value == '-')
		{
			alert('selezionare Tipo provvedimento della Sorveglianza');
			document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_PROVVEDIMENTO %>.focus();
			return false;
		}	

 	   // Data Emissione Provvedimento SIUS
       if ( document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value;
       if ( document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value;

       var data_to_verify = document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_DATA_EMISSIONE_D%>.value;
       if (data_to_verify=='//' )
       {
           alert('Indicare la Data Emissione Provvedimento');
           document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.focus();
           return false;
       }
      ...
      if(document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.value == '' && 
         document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value != ''	 )
      {
      		alert('Anno Provvedimento NON valido');
          document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.focus();
          return false;
      } 
      	  ...
      	  document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value == ''	 )
      {
          ...
          document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.focus();
          return false;
      }
      
   	  // Anno e Numero Procedimento SIUS
      if(document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ANNO_PROCEDIMENTO%>.value == '' && 
         document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_PROGR_PROCEDIMENTO%>.value != ''	 )
      {
      		alert('Anno Procedimento SIUS NON valido');
          document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ANNO_PROCEDIMENTO%>.focus();
          return false;
      } 
      	  ...
      	  document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_PROGR_PROCEDIMENTO%>.value == ''	 )
      {
          ...
          document.LoadInsDecSORValtro.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_PROGR_PROCEDIMENTO%>.focus();
          return false;
      }
       
       // Tipo Ufficio e sede Ufficio Emittente
       if(document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value.length == 1	 )
       {
      	 	alert('Ufficio Emittente non valido');
          	document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.focus();
          	return false;
       } 
       
       if(document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 1 ||
      	 document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 0 )
       {
      	 	alert('Sede Ufficio Emittente non valida');
          	document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.focus();
          	return false;
       }
...
<%	if("I".equals(modalita) )
	{	%>
        	<font class="campo">Inserimento Decisione della SORVEGLIANZA - Altre Richieste del P.M.</font>
<% 	}	
	else if("M".equals(modalita) )
	{	%>
			<font class="campo">Modifica Decisione della SORVEGLIANZA - Altre Richieste del P.M.</font>		
<%	}	%>	        
      </td>
...
<form action="<%=IWebConstants.PG_MAIN%>" method="post" name="LoadInsDecSORValtro">
  ...
  <table width="95%" align="center">
    ...
    <tr>
      ...
      <td class="l" >
        ...
        <a href="Javascript:ListaUfficiComuni('LoadInsDecSORValtro','<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>',
        			document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>[document.LoadInsDecSORValtro.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.selectedIndex].value);">
...
<script language="JavaScript" type="text/javascript">
  ...
  var frmvalidator  = new Validator("LoadInsDecSORValtro");
