...
<head>
  ...
  <script language="JavaScript">
    ...
    { 
        ...
        if(document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.value == '' && 
           document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value != ''	 )
        {
        	alert('Anno Procedimento G.E. NON valido');
            document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.focus();
            return false;
        } 
        	...
        	document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value == ''	 )
        {
            ...
            document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.focus();
            return false;
        }
       ...
       if ( document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value;
       if ( document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value;

       var data_to_verify = document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_DATA_EMISSIONE_D%>.value;
       if (data_to_verify=='//' )
       {
           alert('Indicare la Data Emissione Procedimento');
           document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.focus();
           return false;
       }
       ...
       if(document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value.length == 1	 )
       {
      	 	alert('Ufficio Emittente non valido');
          	document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.focus();
          	return false;
       } 
       
       if(document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 1 ||
      	 document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 0 )
       {
      	 	alert('Sede Ufficio Emittente non valida');
          	document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.focus();
          	return false;
       }
...
<%	if("I".equals(modalita) )
	{	%>
        	<font class="campo">Inserimento Decisione del G.E. su Richiesta Revoca Pena Accessoria</font>
<% 	}	
	else if("M".equals(modalita) )
	{	%>
			<font class="campo">Modifica Decisione del G.E. su Richiesta Revoca Pena Accessoria</font>		
<%	}	%>	        
      </td>
...
<form action="<%=IWebConstants.PG_MAIN%>" method="post" name="LoadInsDecGERevoPA">
    ...
    <tr>
      ...
      <td class="l">Sede Ufficio Emittente <font class="ob">(*)</font> :
          <font class="campo">
            ...
            <a href="Javascript:ListaUfficiComuni('LoadInsDecGERevoPA','<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>',
            					document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>[document.LoadInsDecGERevoPA.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.options.selectedIndex].value);">
...
<script language="JavaScript" type="text/javascript">
  ...
  var frmvalidator  = new Validator("LoadInsDecGERevoPA");
