  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Stampa Richieste del PM al G.E.&nbsp;</font>
      </td>
...
<form action="<%=IWebConstants.PG_MAIN%>" method="post" name="LoadEmissRicPM">
  <input type="hidden" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.modulocumulo.action.ActEmettiRichiesteDelPM">
 ...
 %> 
		...
		<%// Inserire qui le get dei campi da visualizzare %>
          <td class="c" style="text-align:center">
            <input type="checkbox" name="<%=ICostantiRichiestePmInCumulo.CAMPO_ID_RICHIESTE_SELEZIONATE%>" value="<%=StringUtils.toStringJSP(lRichiestaGE.getIdRichiestePmInCumulo(), "") %>" >
          </td>
  ...
  <td colspan="100%" align="center">
    ...
    <table width="100%">
      <tr>
        ...
        <td class="L">
          <select  Title="Ufficio Giudice Esecuzione"  name="<%=ICostantiRichiestePmInCumulo.CAMPO_UFFICIO_DEST%>">
           <%=ufficioge%>
          </select>
        </td>
        <td class="l">Sede</td>
