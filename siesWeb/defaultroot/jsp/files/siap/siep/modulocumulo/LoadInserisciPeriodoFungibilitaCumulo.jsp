...
<jsp:useBean id="TipoComputo" 	scope="request" class="java.lang.String"/>
...
<!-- 		LoadInserisciPeriodoFungibilitaCumulo		 -->
<% 
//============================================================================== 
...
String lCodMotivo="";
if ( modalita.equals("NP") )
{
	lCodMotivo=StatoEsecTitoloCum.getCodMotivo();
}
...
<head>
  ...
  var testOnLoad = 'S';
    ...
    {
      document.LoadInserisciFungibilitaCumulo.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.LoadInserisciFungibilitaCumulo.submit();
    }
    ...
    function AbilitaFungibilita(CodMot){
      var lTipoComputo = CodMot;
...
//-------------------------------------------------
    ...
    function inizia()
    {
   	 	var modo=document.LoadInserisciFungibilitaCumulo.modalita.value;
 		var CodMot = '<%=lCodMotivo%>';
		if(modo=='NP')
		{
			AbilitaFungibilita(CodMot);
		}	
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        else if( modalita.equals("NP") ) {
           lAzione = "siap.siep.modulocumulo.action.ActInserisciFungibilitaCumulo"; 
         %>
         <font class="campo">Inserimento Periodo Fungibilità &nbsp;</font>
         <%
         }
      ...
      <td class="LBG">
        <a href="javascript:eseguiFunzione('siap.siep.modulocumulo.action.ActRicercaFungibilitaCumulo')">
...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="LoadInserisciFungibilitaCumulo">
  ...
  <table cellspacing="2" cellpadding="2" width="95%" align="center">
    ...
    <tr>
      ...
      <td class="l" colspan="1">
        <select Title="Tipo Provvedimento" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_MOTIVO%>" class="small" onChange="javascript:AbilitaFungibilita(this);">
    <%if( modalita.equals("NP") )
   	  {
    ...
    <%} %>      
      ...
      <td class="l">
          <input readonly type="text" size="2" maxlength="2" 
          ...
          <input readonly type="text" size="2" maxlength="2" 
                 ...
                 onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" >
          /
          <input readonly type="text" size="4" maxlength="4" 
  ...
  <table cellspacing="2" cellpadding="2" width="95%" align="center">  
  	<tr>
      <td class="L">
<%	if(StatoEsecTitoloCum.getCodTipoIstante().equals("U"))
	{ %>      
     	<input disabled type="radio" value="U" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" checked >&nbsp;d'Ufficio &nbsp;
     	<input disabled type="radio" value="D" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Difensore &nbsp;
     	<input disabled type="radio" value="I" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Interessato&nbsp;
     	<input disabled type="radio" value="G" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;Provvedimento Giudice Esecuzione &nbsp;
<%	}
	else if(StatoEsecTitoloCum.getCodTipoIstante().equals("D"))
   	{ %>
		<input disabled type="radio" value="U" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;d'Ufficio &nbsp;
     	<input disabled type="radio" value="D" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" checked >&nbsp;su Richietsa Difensore &nbsp;
     	<input disabled type="radio" value="I" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Interessato&nbsp;
     	<input disabled type="radio" value="G" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;Provvedimento Giudice Esecuzione &nbsp;
		    	
<%	}
	else if(StatoEsecTitoloCum.getCodTipoIstante().equals("I"))
 	{ %>    	
		<input disabled type="radio" value="U" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;d'Ufficio &nbsp;
     	<input disabled type="radio" value="D" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Difensore &nbsp;
     	<input disabled type="radio" value="I" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" checked >&nbsp;su Richietsa Interessato&nbsp;
     	<input disabled type="radio" value="G" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;Provvedimento Giudice Esecuzione &nbsp;
		    
<%	}
	else if(StatoEsecTitoloCum.getCodTipoIstante().equals("G"))
 	{ 
		...
		<input disabled type="radio" value="U" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;d'Ufficio &nbsp;
     	<input disabled type="radio" value="D" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Difensore &nbsp;
     	<input disabled type="radio" value="I" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" >&nbsp;su Richietsa Interessato&nbsp;
     	<input disabled type="radio" value="G" name="<%=ICostantiStatoEsecTitoloCumulato.CAMPO_COD_TIPO_ISTANTE%>" checked >&nbsp;Provvedimento Giudice Esecuzione &nbsp;
...
<div id="divDatiGEsecuzione" style="<%=lBlocca%>">
  <table width="95%" align="center">
    ...
    <tr>
      ...
      <td class="L">
      	<input readonly type="text" Title="Autorità Emittente ordinanza" name="<%= ICostantiTitoloCumulato.CAMPO_COD_TIPO_AUTORITA_PROVV_RIF %>" 
      		size="30" maxlength="30" value="<%=StringUtils.toStringJSP(StatoEsecTitoloCum.getDescrTipoUfficioAltro(),"")%>" > 
      </td>
      <td class="l">Luogo</td>
      <td class="L">
      	<input readonly type="text" Title="Comune Emittente ordinanza" name="<%= ICostantiTitoloCumulato.CAMPO_COD_LUOGO_PROVV_RIF %>" 
      		size="30" maxlength="30" value="<%=StringUtils.toStringJSP(StatoEsecTitoloCum.getDescrLuogoAltro(),"")%>" >
      </td>
      <td class="L">Sezione</td>
      <td class="L">
      	<input readonly Title="Sezione" value="<%=StringUtils.toStringJSP(StatoEsecTitoloCum.getSezioneAltro(),"")%>" 
      		type="text" name="<%= ICostantiTitoloCumulato.CAMPO_NUM_SEZIONE_AUTORITA_PROVV_RIF %>" maxlength="30" size="30" >
      </td>
    </tr>
    ...
    <td class="l">&nbsp;&nbsp;
      <input readonly type="text" title="Giorno Sentenza" name="<%=ICostantiComputiCumulo.CAMPO_GIORNO_DATA_RICHIESTA %>" 
      	maxlength="2" size="2" value="<%=StringUtils.toStringJSP (DateUtils.getDateToString(StatoEsecTitoloCum.getDataEmissioneAltro(),"dd"))%>" 
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
      /
      <input readonly type="text" title="Mese Sentenza" name="<%=ICostantiComputiCumulo.CAMPO_MESE_DATA_RICHIESTA %>" 
      	maxlength="2" size="2" value="<%=StringUtils.toStringJSP (DateUtils.getDateToString(StatoEsecTitoloCum.getDataEmissioneAltro(),"MM"))%>"
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
      /
      <input readonly type="text" title="Anno Sentenza" name="<%=ICostantiComputiCumulo.CAMPO_ANNO_DATA_RICHIESTA %>" 
      	maxlength="4" size="4" value="<%=StringUtils.toStringJSP (DateUtils.getDateToString(StatoEsecTitoloCum.getDataEmissioneAltro(),"yyyy"))%>"
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
    </td>
    <td class="l">Procedimento SIGE : </td>
      <td class="l">Anno/Numero
        <input readonly type="text" Title="Anno SIGE." name="<%=ICostantiPresoffertoCumulo.CAMPO_ANNO_PROVV %>" 
        	size=4 maxlength=4 value="<%=StringUtils.toStringJSP(StatoEsecTitoloCum.getAnnoProcedimento(),"")%>"
        	onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
        /
        <input readonly type="text" Title="Numero SIGE" name="<%=ICostantiPresoffertoCumulo.CAMPO_NUMERO_PROVV %>" 
        	size=6 maxlength=6 value="<%=StringUtils.toStringJSP(StatoEsecTitoloCum.getProgrProcedimento(),"")%>" >
      </td>
    </tr>    
  </table>
</div>  
  ...
  <div id="Div_0212" style="display:none">
    ...
    <tr id="TR_MC_2" style="display:block">
      ...
      <td class="l" colspan=2>
        <select Title="Causale Computo" name="<%=ICostantiComputiCumulo.CAMPO_COD_COMPUTO_MC %>" class="small">
          <option value = "-" />-
          <option value = "13"  />Altro
          <option value = "10"  />Custodia Cautelare Cessata per Altro Fatto Non Definitivo
          <option value = "09"  />Custodia Cautelare in Corso per Altro Fatto
          <option value = "11"  />Custodia Cautelare per Altro Fatto Definitivo
          <option value = "12"  />Misura Sicurezza Applicata in Via Provvisoria
        </select>
      </td>
    </tr>
    ...
    <tr id="TR_MC_3" style="display:block">
      ...
      <td class="l">Anno/Numero
        <input type="text" Title="Anno R.G.N.R." name="<%=ICostantiMisuraCautelareCumulo.CAMPO_ANNO_REGE_PM %>" size=4 maxlength=4 
       	 	onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
        /
        <input type="text" Title="Numero R.G.N.R." name="<%=ICostantiMisuraCautelareCumulo.CAMPO_NUMERO_REGE_PM %>" size=6 maxlength=6>
      </td>
    </tr>
    <tr>   
      ...
      <td class="l">Luogo</td>
      <td class="l" >
      	<input type="text" Title="Luogo" name="<%=ICostantiMisuraCautelareCumulo.CAMPO_DESCR_COMUNE_PM_SEDE %>" value=""  maxlength="35" size="35" >
    ...
    <tr id="TR_MC_4" style="display:block">
     ...
     <td class="l" nowrap>Procedimento B.D.M.C. : </td>
      <td class="l">Anno/Numero
        <input type="text" title="Anno B.D.M.C." name="<%=ICostantiMisuraCautelareCumulo.CAMPO_ANNO_FASC_BDMC %>" size=4 maxlength=4 
        	onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
        /
        <input type=text title="Numero B.D.M.C." name="<%=ICostantiMisuraCautelareCumulo.CAMPO_NUME_FASC_BDMC %>" size=6 maxlength=6>
      </td>
      
      <td class="l">Anno/Numero Reg.Gen. </td>
      <td class="L">
      	<input Title="Anno Reg.Gen." value="" type="text" name="<%=ICostantiMisuraCautelareCumulo.CAMPO_ANNO_REG_GEN %>" maxlength="4" size="4" 
      		onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)"> /
      	<input Title="Numero Reg.Gen." value="" type="text" name="<%=ICostantiMisuraCautelareCumulo.CAMPO_NUMERO_REG_GEN %>" maxlength="6" size="6"> &nbsp; 
    ...
    <tr>
      ...
      <td class="L">
      	<input Title="Luogo Emittente misura" name="<%=ICostantiMisuraCautelareCumulo.CAMPO_DESCR_AUTORITA_EMITTENTE_LUOGO%>" value="" type="text" maxlength="35" size="35"> 
...
<div id="Div_0213" style="display:none">
  ...
  <tr id="TR_PD_3" style="display:block">
    ...
    <td class="l" colspan=2>
      <select Title="Causale Computo" class="small" name="<%=ICostantiComputiCumulo.CAMPO_COD_COMPUTO_DET %>">
        <option value = "-" />-
        <option value = "08"  />Altro Motivo
        <option value = "06"  />Concessa Amnistia
        <option value = "07"  />Concesso Indulto
        <option value = "05"  />Condanna Revocata a Seguito di Giudizio di Revisione
        <option value = "02"  />Condanna Revocata per Abrogazione della Norma Incriminatrice
        <option value = "03"  />Condanna Revocata per Dichiarazione di Incostituzionalita' della Norma Incriminatrice
        <option value = "04"  />Condanna Revocata per Pluralita' di Sentenze per lo Stesso Fatto (Art. 669 Cpp.)
        <option value = "01"  />Periodo di Pena Espiato in Eccesso
      </select>
    </td>
  </tr>
  ...
  <tr id="TR_PD_2" style="display:block">
    ...
    <td class="L">
      &nbsp;
      <input type="text" title="Anno Sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_ANNO_SENTENZA %>" size=4 maxlength=4 
       onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
      /
      <input type="text" title="Numero Sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_NUMERO_SENTENZA %>" size=4 maxlength=4>
      &nbsp;
    </td>
    
    <td class="l"> Emessa in data : </td>  
    <td class="l">&nbsp;&nbsp;
      <input type="text" title="Giorno Sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_GIORNO_DATA_PROVVEDIMENTO %>" maxlength="2" size="2" 
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
      /
      <input type="text" title="Mese Sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_MESE_DATA_PROVVEDIMENTO %>" maxlength="2" size="2" 
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
      /
      <input type="text" title="Anno Sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_ANNO_DATA_PROVVEDIMENTO %>" maxlength="4" size="4" 
      	onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="l">Luogo</td>
    <td class="L">
      	<input Title="Comune Emittente sentenza" name="<%=ICostantiTitoloCumulato.CAMPO_COD_LUOGO_EMITTENTE%>" value="" type="text" maxlength="35" size="35" class="small"> 
  ...
  <tr>  
    ...
    <td class="l">Anno/Numero</td>
    <td class="L">
      <input type="text" title="Anno fascicolo SIEP" name="<%=ICostantiPresoffertoCumulo.CAMPO_ANNO_PROC_SIEP %>" size=4 maxlength=4 
       	onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
      /
      <input type=text title="Numero fascicolo SIEP" name="<%=ICostantiPresoffertoCumulo.CAMPO_NUMERO_PROC_SIEP %>" size=6 maxlength=6>
    </td>
  </tr>  
    ...
    <table width="95%" align="center">
      <tr>
        ...
        <td class="l">
          ...
          <input readonly Title="Istituto" name="<%=ICostantiComputiCumulo.CAMPO_DESCR_ISTITUTO_DETENZIONE%>" size="90" value="<%=StringUtils.toStringJSP (lDescrIstituto)%>" >
