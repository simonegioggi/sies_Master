...
<html>
<head>
  <title> Dettaglio Annotazione pagamento Pena Pecuniaria </title>
  ...
  <script language="JavaScript">
    ...
    function eseguiFunzione(aTipoAzione)
    {
      if (aTipoAzione=='Inserisci'){
        ...
        lAzione = "siap.siep.modulocumulo.action.ActRicercaPagamentiPP";
        document.formName.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.formName.submit();
      }
    }
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Dettaglio Annotazione pagamento Pena Pecuniaria &nbsp;</font>
      </td>
...
%>
			<tr>
		      <td class="titolo" colspan="4">Dati Provvedimento Altra Autorità</td>
			</tr>
			<tr>
		    ...
		    <tr> 
		      <td class="l">Anno / Numero Partita di Credito</td>
		      <td class="l">
		         <font class="campo"><%=StringUtils.toStringJSP(lComputo.getAnnoProvv().toString()) %></font>&nbsp; /
		         <font class="campo"><%=StringUtils.toStringJSP(lComputo.getProgrProvv().toString()) %></font>&nbsp;
		      </td>
		    ...
		    <tr> 
		      ...
		      <td class="l">
		         <font class="campo"><%=StringUtils.toStringJSP( lComputo.getSezioneProvv() ) %></font>&nbsp;
			  </td>
		    </tr>
<% 		}
...
%>
			<tr>
				<td class="titolo" colspan="4">Pena pecuniaria versata</td>
			</tr>
<% 		} %>			
		<tr>
      		<td class="l">Multa</td>
      		<td class="l">
		         <font class="campo"><%=lComputo.getImportoMulta()!=null?StringUtils.toEuroFormat( lComputo.getImportoMulta() ):"" %></font>&nbsp;
      		</td>
      		<td class="l">Ammenda</td>
      		<td class="l">
		         <font class="campo"><%=lComputo.getImportoAmmenda()!=null?StringUtils.toEuroFormat( lComputo.getImportoAmmenda() ):"" %></font>&nbsp;
      		</td>
    	</tr>
