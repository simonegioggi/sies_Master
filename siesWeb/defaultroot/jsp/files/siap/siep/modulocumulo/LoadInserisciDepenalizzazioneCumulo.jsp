...
String lTipoAnn="";
BigDecimal idReatoChecked = null;
...
idReatoChecked = aComputo.getReaIdReatoCum();

%> 

<html>
<head>
  <title> Gestione Provvedimento Depenalizzazione </title>
  ...
  <script language="JavaScript" >
    ...
    function Verify_Quantum()
    {
 	...
 	function mettiFonte()
 	{
	   	if(document.f.Radio_Depe_Ammi[0].checked)
	   	{
	   		...
	   		document.f.<%=ICostantiComputiCumulo.CAMPO_COD_TIPO_ANNOTAZIONE%>.value = "004";
	   	}
		else if(document.f.Radio_Depe_Ammi[1].checked)
	   	{
	   		...
	   		document.f.<%=ICostantiComputiCumulo.CAMPO_COD_TIPO_ANNOTAZIONE%>.value = "017";
	   	}
 	}

 	var TipoAnn = '<%=lTipoAnn%>';
 	  
 	function CaricaAnnotazione()
 	{
		if (TipoAnn=="004") {
	   		document.f.Radio_Depe_Ammi[0].checked=true;
		} 		
		if (TipoAnn=="017") {
	   		document.f.Radio_Depe_Ammi[1].checked=true;
		} 		
 	}
    ...
    function Verify()
    {
      ...
      //==========================================================================
      // Controllo del Tipo Annotazione e Fonte  
      //==========================================================================
	  if(!(document.f.Radio_Depe_Ammi[0].checked ) &&
...
<body class="corpo" onload="CaricaAnnotazione();" >
  <table>
    <tr>
      <td class="LBG">
      ...
      <td class="LBG">
        ...
        <font class="campo">Inserimento annotazione Depenalizzazione &nbsp;</font>
        <% } else if( modalita.equals("M") || modalita.equals("NP") ) { %>
        <font class="campo">Modifica annotazione Depenalizzazione &nbsp;</font>
        <%}%>
      </td>
      <td class="LBG">
        <a href="javascript:eseguiFunzione('siap.siep.modulocumulo.action.ActRicercaDepenalizzazioneCumulo')">
...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="f">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.modulocumulo.action.ActInserisciDepenalizzazioneCumulo">
  ...
  <input type="HIDDEN" name="<%=ICostantiComputiCumulo.CAMPO_COD_TIPO_ANNOTAZIONE%>" value="<%=StringUtils.toStringJSP(aComputo.getCodTipoAnnotazione()) %>">
...
<table cellspacing="2" cellpadding="2" width="95%" align="center">
  <tr>  	    
    ...
    <td class="l" width="20%" colspan="3"> Illecito Amministrativo <input type="radio" name="Radio_Depe_Ammi" value="I" onClick="javascript:mettiFonte();" ></td>
    <td class="L" width="65%" ></td>
  </tr>
</table>
...
<%
    ...
    <% 
    String checkReato = "";
    if (idReatoChecked!=null && lReato.getIdReatoCum().compareTo(idReatoChecked)==0)  
      checkReato = "checked";
    %>
