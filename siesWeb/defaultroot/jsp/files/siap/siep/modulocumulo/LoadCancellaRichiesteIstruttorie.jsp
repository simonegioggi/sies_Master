...
<jsp:useBean id="IdIstruCum"      scope="request" class="java.lang.String"/>

<!-- 		LoadcancellaRichiesteIstruttorie		 -->
<%
String nAction ="";
...
<html>
  ...
  <%}%>
    ...
    function verify()
    {
        ...
        window.opener.top.frames['centrale'].frames['body'].location.href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.modulocumulo.action.ActCancellaRichiesteIstruttorie&IdEvento="+<%=IdEvento%>+"&IdIstruttoriaCumulo="+<%=IdIstruCum%>+"&motivazioni="+lmotivazioni+"<%=nAction%>";
