...
<jsp:useBean id="ListaInterruzioni" 		scope="request" class="java.util.Vector"/>

<%
//==============================================================================
// Form per la visualizzazione delle Interruzioni legate a un certo Titolo.
//
  ...
  <script language="JavaScript">
    ...
    function eseguiAzione(aTipoAzione, aIdStat, aIdComp, aStato, aMotivoModifica)
    {
      if (aTipoAzione=='Dettaglio'){
        lAzione = "siap.siep.modulocumulo.action.ActDettaglioInterruzioneCumulo";
        document.ListaInterruzioni.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
        document.ListaInterruzioni.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.ListaInterruzioni.submit();
      }
      else if (aTipoAzione=='Modifica'){
        lAzione = "siap.siep.modulocumulo.action.ActLoadInserisciInterruzioneCumulo";
        document.ListaInterruzioni.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
        document.ListaInterruzioni.<%=ICostantiComputiCumulo.CAMPO_ID_COMPUTI_CUMULO%>.value = aIdComp;
        document.ListaInterruzioni.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
        document.ListaInterruzioni.modalita.value='M';
        document.ListaInterruzioni.submit();
      }
        ...
        if (window.confirm(msgConfirm)) {
          ...
          document.ListaInterruzioni.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_ID_STATO_ESEC_TITOLO_CUMULATO%>.value = aIdStat;
          document.ListaInterruzioni.<%=ICostantiComputiCumulo.CAMPO_ID_COMPUTI_CUMULO%>.value = aIdComp;
          document.ListaInterruzioni.<%=ICostantiStatoEsecTitoloCumulato.CAMPO_FLAG_STATO%>.value = aStato;
          document.ListaInterruzioni.modalita.value = "C";
    ...
    function nuovaAnnotazione(){
      lAzione = "siap.siep.modulocumulo.action.ActLoadInserisciInterruzioneCumulo";
      document.ListaInterruzioni.<%=IWebConstants.ACTION_FIELD%>.value = lAzione;
      document.ListaInterruzioni.modalita.value = "I";
      document.ListaInterruzioni.submit();
    }
    ...
    {
      document.ListaInterruzioni.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.ListaInterruzioni.submit();
    }
  ...
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
                      <font class="campo">Elenco Provvedimenti di Interruzione &nbsp;</font>
      </td>
...
<FORM action="<%=IWebConstants.PG_MAIN%>" method="post" name="ListaInterruzioni">
  ...
  <table cellspacing="2" cellpadding="2" align="center" width="95%">
    <tr>
      ...
      <td class="int">Data Interruzione</td>
   ...
   <%
      ...
      Iterator itx = ListaInterruzioni.iterator();
      while ( itx.hasNext()) {
