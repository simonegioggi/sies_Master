...
{	
	if(RichiestaGE.getDescrFonte() != null && !RichiestaGE.getDescrFonte().equals("-") )
		lDescrFonte += StringUtils.toStringJSP(RichiestaGE.getDescrFonte());
	
	if(RichiestaGE.getDescrSottonumerazione() != null && !RichiestaGE.getDescrSottonumerazione().equals("-") )
		lDescrBisTer += StringUtils.toStringJSP(RichiestaGE.getDescrSottonumerazione() );
...
<html>
<head>
  <title>[S.I.E.S.] - Gestione Cumulo - Decisione del GE su Richiesta Revoca </title>
  ...
  <script language="JavaScript">
    ...
    {
      document.LoadInsDecGERevPena.<%=IWebConstants.ACTION_FIELD%>.value = action;
      document.LoadInsDecGERevPena.submit();
    }
    ...
    { 
        ...
        if(document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.value == '' && 
           document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value != ''	 )
        {
        	alert('Anno Procedimento G.E. NON valido');
            document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_PROVV%>.focus();
            return false;
        } 
        	...
        	document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.value == ''	 )
        {
            ...
            document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>.focus();
            return false;
        }
       ...
       if ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value;
       if ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value.length==1)
         	document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value='0'+document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value;

       var data_to_verify = document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_MESE_DATA_EMISSIONE_D%>.value+'/'+document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_ANNO_DATA_EMISSIONE_D%>.value;
       if (data_to_verify=='//' )
       {
           alert('Indicare la Data Emissione Procedimento');
           document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_GIORNO_DATA_EMISSIONE_D%>.focus();
           return false;
       }
       ...
       if(document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.value.length == 1	 )
       {
      	 	alert('Ufficio Emittente non valido');
          	document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.focus();
          	return false;
       } 
       
       if(document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value == '-' || 
      	 document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 1 ||
      	 document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.value.length == 0 )
       {
      	 	alert('Sede Ufficio Emittente non valida');
          	document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>.focus();
          	return false;
       }

<%
//=====================================================================================
// Obbligatorietà quantum: se revoca SS (solo espulsione) i quantum non sono obbligatori
// ma se indicati va specificao il segno e viceversa 
//=====================================================================================
%>
      ...
      if(tipoDec == "C" || tipoDec == "D")
      {
        ...
        if (document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_PIU_MENO_D%>.value == ''  )
          segnoPresente = false;

       if( ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_RECLUSIONE_D%>.value == '' ||
      		   document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_RECLUSIONE_D%>.value.length == 0 )  &&
      	   ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_RECLUSIONE_D%>.value == '' ||
             document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_RECLUSIONE_D%>.value.length == 0  ) &&	
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_RECLUSIONE_D%>.value == '' ||
           	 document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_RECLUSIONE_D%>.value.length == 0 ) &&
           	 
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_ARRESTO_D%>.value == '' ||
          	 document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_ARRESTO_D%>.value.length == 0 ) &&
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_ARRESTO_D%>.value == '' ||
             document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_MESI_ARRESTO_D%>.value.length == 0 ) &&
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_ARRESTO_D%>.value == '' ||
             document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_GIORNI_ARRESTO_D%>.value.length == 0 ) &&	
             
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_MULTA_D%>INT.value.length == 0 ) &&
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_MULTA_D%>DEC.value.length == 0 ) &&	
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_AMMENDA_D%>INT.value.length == 0 ) &&
           ( document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_AMMENDA_D%>DEC.value.length == 0 ) 
         )	
       {
          quantumPresenti = false;
       }

<% if("023".equals(RichiestaGE.getCodTipoAnnotazione()) ) { // revoca SS %>
  if (segnoPresente && !quantumPresenti) {
    alert('Se si indica il segno (+ / -), vanno specificati anche i quantum di pena');
    document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_NUM_ANNI_RECLUSIONE_D%>.focus();
    return false;
  }
  else if (!segnoPresente && quantumPresenti) {
    alert('Se si indicano i quantum di pena va indicato anche il segno');
    document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_FLAG_PIU_MENO_D%>.focus();
    return false;
  }
<% } else { %>
  if (!segnoPresente) {
...
<% } %>
        ...
        // Quantum
        var pos = document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_MULTA_D%>INT.value.indexOf('.');
        if(pos >= 0)
        {
          alert('Iinserire correttamente il valore INTERO della Multa');
          document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_MULTA_D%>INT.focus();
          return false;
        }
    
        pos = document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_AMMENDA_D%>INT.value.indexOf('.');
        if(pos >= 0)
        {
          alert('Inserire correttamente il valore INTERO della Ammenda');
          document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_IMPORTO_AMMENDA_D%>INT.focus();
          return false;
        }
      }
...
<%	if("I".equals(modalita))
	{	
		if("023".equals(RichiestaGE.getCodTipoAnnotazione()) )
		{		%>        
        	<font class="campo">Inserimento Decisione del G.E. su Richiesta Revoca Sanzione Sostitutiva</font>
<%		}
		else
		{	%>
		    <font class="campo">Inserimento Decisione del G.E. su Richiesta Revoca Sentenza abolizione del Reato</font>  	
<%		}
	}	
	...
	{	
		if("023".equals(RichiestaGE.getCodTipoAnnotazione()) )
		{		%>  
			<font class="campo">Modifica Decisione del G.E. su Richiesta Revoca Sanzione Sostitutiva</font>
<%		}
		else
		{	%>
			<font class="campo">Modifica Decisione del G.E. su Richiesta Revoca Sentenza abolizione del Reato</font>		
<%		}
	}		%>	        
      </td>
...
<form action="<%=IWebConstants.PG_MAIN%>" method="post" name="LoadInsDecGERevPena">
...
<%	if(!lDescrFonte.equals(""))
	{	%>
	  <tr>	
		<td class="l" >Norma di Legge </td>
		<td class="l">
			<font class="campo"><%=lDescrFonte%></font>&nbsp;
	<%	if(!lAnnoNum.equals(""))
		{	%>
	...
	<%	if(!lDescrBisTer.equals(""))
		{	%>
			<font class="campo"><%=lDescrBisTer%></font>&nbsp;&nbsp;
	<%	} %>
    ...
    <tr>
      <td class="l">Ordinanza <font class="ob">(*)</font> :</td>
		<td class="l">
          ...
          /
          <input type="text" name="<%=ICostantiRichiestePmInCumulo.CAMPO_NUMERO_PROVV%>" size=8 maxlength=6 
                 value="<%=StringUtils.toStringJSP(ProvvGECum.getNumeroProvv(),"") %>" >
      	</td>
      	<td class="l">
    ...
    <tr>
      ...
      <td class="l">Sede Ufficio Emittente <font class="ob">(*)</font> :
          <font class="campo">
            ...
            <a href="Javascript:ListaUfficiComuni('LoadInsDecGERevPena','<%=ICostantiRichiestePmInCumulo.CAMPO_COD_LUOGO_EMITTENTE%>',
            					document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>[document.LoadInsDecGERevPena.<%=ICostantiRichiestePmInCumulo.CAMPO_COD_UFFICIO_EMITTENTE%>.options.selectedIndex].value);">
...
<script language="JavaScript" type="text/javascript">
  ...
  var frmvalidator  = new Validator("LoadInsDecGERevPena");
