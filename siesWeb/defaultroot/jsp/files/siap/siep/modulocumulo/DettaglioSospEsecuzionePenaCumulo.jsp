...
<html>
<head>
  <title> Dettaglio Sospensione Esecuzione isura </title>
  ...
  <script language="JavaScript">
    ...
    function eseguiFunzione(aTipoAzione)
    {
      if (aTipoAzione=='Indietro'){
        lAzione = "siap.siep.modulocumulo.action.ActRicercaSospEsecuzionePenaCumulo";
    ...
    function showDivForOggetto()
    {
      ...
      if ($.inArray(codOggetto, arrayDataScarcerazione)>-1) {
        ...
        $('#divDataScarcerazione textarea').prop('disabled',false);
      }
      else {
        $('#divDataScarcerazione').hide();
        $('#divDataScarcerazione textarea').prop('disabled',true);
      }
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Dettaglio Sospensione Esecuzione Pena &nbsp;</font>
      </td>
      <td class="LBG">
  	...
  	<table align="center" width="95%" style="border:0;" cellspacing="1" cellpadding="1">
		...
		<div id="divDataScarcerazione" style="display:block;">
		  <table width="95%" align="center" >
		  	...
		  	<tr>
		      <td class="l"  width="210">Data Sospensione Esecuzione </td>
		      <td class="l" >
		         <font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(lComputo.getDataScarcerazione(),"dd-MM-yyyy"))%></font>
		      </td>
	    	</tr>
