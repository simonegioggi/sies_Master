...
<html>
<head>
  <title> Gestione Provvedimento Depenalizzazionà </title>
  ...
  <script language="JavaScript" >
    ...
    function Verify()
    {
      ...
      if(AnnoScc == '' && NumScc == ''
      	  && AAScc == '' && MMScc == '' && GGScc == '' )
      {
			alert("Dati Sentenza Corte Costituzionale Obbligatori");
      ...
      if(AnnoScc == '')
      {
          alert("Dati Sentenza Corte Costituzionale Incompleti - Indicare Anno Sentenza");
          document.f.annoSCC.focus();
      ...
      if(NumScc == '')
      {
          alert("Dati Sentenza Corte Costituzionale Incompleti - Indicare Numero Sentenza");
          document.f.numeroSCC.focus();
      ...
      if(GGScc == '')
      {
          alert("Dati Sentenza Corte Costituzionale Incompleti. Indicare il giorno data Sentenza.");
          document.f.ggScc.focus();      
          return false;
      }
      if(MMScc == '')
      {
          alert("Dati Sentenza Corte Costituzionale Incompleti. Indicare il mese della data Sentenza.");
          document.f.mmScc.focus();      
          return false;
      }
      if(AAScc == '')
      {
          alert("Dati Sentenza Corte Costituzionale Incompleti. Indicare l'anno della data Sentenza.");
          document.f.aaScc.focus();      
          return false;
      }
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Inserimento annotazione Incostituzionalità &nbsp;</font>
        <% } else if( modalita.equals("M") || modalita.equals("NP") ) { %>
        <font class="campo">Modifica annotazione Incostituzionalità &nbsp;</font>
        <%}%>
      </td>
      <td class="LBG">
        <a href="javascript:eseguiFunzione('siap.siep.modulocumulo.action.ActRicercaIncostituzionalitaCumulo')">
...
<FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="f">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.modulocumulo.action.ActInserisciIncostituzionalitaCumulo">
  ...
  <input type="HIDDEN" name="<%=ICostantiComputiCumulo.CAMPO_COD_TIPO_ANNOTAZIONE%>" value="013">
...
%>
  <tr>
    ...
    <td class="l">
      ...
      /
      <input type="text" name="<%=ICostantiAnnotazioneManuale.CAMPO_CHIAVE_PROGR_SIGE%>" size=10 maxlength=38 
