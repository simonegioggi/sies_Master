...
<% 
//========================================================================================== 
// Form per la modifica delle richieste alla SORVEGLIANZA di Unificazione Misure diSicurezza
//========================================================================================== 
%>
...
%>    
  ...
  <table width="95%" align="center">
    ...
    <tr>
      ...
      <td class="l" colspan="1">
       <TEXTAREA cols="80" rows="3" name="<%=ICostantiRichiestePmInCumulo.CAMPO_MOTIVAZIONI %>"><%=StringUtils.toStringJSP(RichiestaAllaSORV.getMotivazioni())%></textarea>
      </td>
    </tr>
  </table>
