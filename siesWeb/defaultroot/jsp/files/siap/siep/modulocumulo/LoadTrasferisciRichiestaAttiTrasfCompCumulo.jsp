...
<body class="corpo">
  <table>
    ...
    <td class="LBG">
      <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.modulocumulo.action.ActDettaglioSollecitoRichiestaAttiTrasfCompCumulo&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=eventoSollecito.getIdEvento()%>">
  ...
  <form method="POST" action="<%= IWebConstants.PG_MAIN%>" name="TrasferisciSollecito" onsubmit="document.TrasferisciSollecito.conferma.disabled=true">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.modulocumulo.action.ActTrasferisciSollecitoRichiestaAttiTrasfCompCumulo">
