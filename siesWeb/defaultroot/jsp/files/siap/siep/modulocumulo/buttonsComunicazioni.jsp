	...
	if(lFun.getVisualizzazionType().equals(ICostantiFunzioni.FUNZIONE_BOTTONE))
	{
      ...
      {//
         ...
         if(lDett)
         {
           ...
           String lActDettaglio = lAction.getActionDettaglioProvvedimento(
           request.getParameter("MotivoEvento"),
    ...
    else //Non siamo in REWORK DETTAGLIO funziona tutto come prima
    {
      if(  request.getParameter("docRegistrato") == null
	      || request.getParameter("docRegistrato").equals("N") )
	    {
	      ...
	      ActGestisciButtonsProvvedimento lAction = new ActGestisciButtonsProvvedimento();
	      String lActDettaglio = lAction.getActionDettaglioProvvedimento(request.getParameter("MotivoEvento"), request.getParameter("TipoEvento"));
	      if (lActDettaglio.length()>1)
	      {
%>
					<td>
...
<%
	  ...
	  if(lFun.getFunctionType().equals(ICostantiFunzioni.TIPO_VALIDAZIONE)&& request.getParameter("Evento").equals("SI") && request.getParameter("docRegistrato").equals("N") && lModificabile.equals("SI"))
	  {
%>	  
		  <td>
