...
<table style="width: 95%;">
  ...
  <tr>
    <td class="l" nowrap>
      Contenuto <font class="ob">(*)</font>
    </td>
    <td class="l">
      <select Title="Contenuto Decisione" name="<%=ICostantiProvvedimentoGenerico.CAMPO_CONTENUTO%>" onchange="javascript:caricatuttecomboContenuto();">
      </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="l">
      <select Title="Oggetto Decisione" class="small" name="<%=ICostantiProvvedimentoGenerico.CAMPO_OGGETTO%>">
      </select>
    </td>
  </tr>
  <tr>
      <td class="l" nowrap>
          Esito <font class="ob">(*)</font>
      </td>
      <td class="l">
          <select Title="Tipologia Decisione" class="small" name="<%=ICostantiProvvedimentoGenerico.CAMPO_ESITO%>">
          </select>
      </td>
  </tr>
  <tr>
