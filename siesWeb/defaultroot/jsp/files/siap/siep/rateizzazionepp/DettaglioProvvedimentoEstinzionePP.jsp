...
<body class="corpo">
  <table>
    <tr>
      ...
      %>   
      <td class="LBG">
        <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.rateizzazionepp.action.ActLoadModificaProvvedimentoEstinzionePP&IdEvento=<%=eventonotifica.getEvento().getIdEvento()%>">
      ...
      <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
       <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.rateizzazionepp.action.ActStampaProvvedimentoEstinzionePP&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
      </jsp:include>
      <% } %>
    </tr>
  </table>
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.rateizzazionepp.action.ActUploadProvvedimentoEstinzionePP">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.rateizzazionepp.action.ActDettaglioProvvedimentoEstinzionePP">
        </td>
      </tr>
    </table>
  </form>
