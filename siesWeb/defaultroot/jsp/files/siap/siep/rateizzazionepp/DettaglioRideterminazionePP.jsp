...
<%-- MEV_2023-33: aggiunta pagina di Dettaglio Rideterminazione Pena Pecuniaria --%>
...
<jsp:useBean id="lListaNotObbligati"   	scope="request" class="java.util.ArrayList<NotificaModel>"/>
...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Rideterminazione Pena Pecuniaria </title>
...
<table>
	<tr>
		...
		<td class="LBG">
			...
			<font class="campo">Dettaglio Rideterminazione Pena Pecuniaria</font>
		</td>
<%
...
<table cellspacing=0 cellpadding=0 width=95%>
	<tr>
  	...
  	<tr>
    	<td class="l" width="20%">Data Emissione Provvedimento</td>
		<td class="L">
  			<font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(annotazioneManuale.getDataIscrizioneSiep(), "dd-MM-yyyy"))%></font>
		</td>
  	</tr>
  	<tr>
    	<td class="l">Anno / Numero Provvedimento</td>
		<td class="L">
  			<font class="campo"><%=StringUtils.toStringJSP(annotazioneManuale.getAnnoSiep())%>&nbsp;/&nbsp;<%=StringUtils.toStringJSP(annotazioneManuale.getNumeroSiep())%></font>
		</td>
  	</tr>
  	<tr>
    	<td class="l">Tipo Provvedimento</td>
		<td class="L">
  			<font class="campo"><%=StringUtils.toStringJSP(annotazioneManuale.getDescrTipoAnnotazione())%></font>
		</td>
  	</tr>
  	<tr>
    	<td class="l">Autorit&agrave; Emittente</td>
		<td class="L">
  			<font class="campo"><%=StringUtils.toStringJSP(annotazioneManuale.getDescrTipoUfficioSiep())%></font>
  			&nbsp;di&nbsp;
  			<font class="campo"><%=StringUtils.toStringJSP(annotazioneManuale.getDescrLuogoUfficioSiep())%></font>
		</td>
  	</tr>
</table>
<br>
