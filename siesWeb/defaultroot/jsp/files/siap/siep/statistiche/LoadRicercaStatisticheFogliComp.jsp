...
<head>
  ...
  <div id="comune" style="position: relative; top: 0; left: 0; visibility:visible; " >     
    ...
    <table  width=96%>
     ...
     <table width=96% >
      ...
      <tr>
	      <td class="c" width="50%" >
	            Anno:
				<input type="text" name="<%=ICostantiStatistiche.CAMPO_ANNO_INIZIALE%>" value=""  size="4" maxlength="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" />
		 		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	            Anno Finale:
    ...
    <div id="EstremiOrdinanza" style="position:relative;  top: 0; left: 0; " >  
      ...
      <tr>
        ...
        <td class="l" colspan="2">
          <font class="label">Fogli Complementari Trasmessi</font>
        </td>
        <td class="l">
        ...
        <tr>
        <td class="l" colspan="2">
          <font class="label">Fogli Complementari Iscritti Manualmente o con altre opzioni</font>
        </td>
        <td class="l">
    ...
    <br>
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.statistiche.action.ActRicercaFogliComplementari">
