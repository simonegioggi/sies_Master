...
<html>
<head>
  <title>[S.I.E.S.] - Riscontro Trasmissioni Atti per Esecuzione</title>
  ...
  <script language="JavaScript">
    ...
    function Verify()
    {
      var data_inizio=document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_GIORNO_DATA_TRASMISSIONE_INIZIO%>.value+'/'+document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_MESE_DATA_TRASMISSIONE_INIZIO%>.value+'/'+document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_ANNO_DATA_TRASMISSIONE_INIZIO%>.value;
      var data_fine=document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_GIORNO_DATA_TRASMISSIONE_FINE%>.value+'/'+document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_MESE_DATA_TRASMISSIONE_FINE%>.value+'/'+document.LoadRicercaTrasmissioneAttiEsecuzione.<%=ICostantiSicoJMS.CAMPO_ANNO_DATA_TRASMISSIONE_FINE%>.value;
  ...
  <body class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Ricerca Atti Trasmessi per esecuzione</font>
        </td>
      </tr>
    </table>
    <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadRicercaTrasmissioneAttiEsecuzione'>
      <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sanzionesostitutiva.action.ActRicercaTrasmissioneAttiEsecuzione">
