...
<html>
  <head>
<title>[S.I.E.S.] - Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria</title>
...
%>
        	...
        	<input type="HIDDEN" title="Codice Posizione" type="text" maxlength="6" size="6" value="<%=StringUtils.toStringJSP(lPosizione.getCodPosizioneGiuridica())%>" name="<%=ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA%>">
		</td>
    </tr>
</table>
<%
...
%>
	<tr>
		...
		<td class="L" colspan="2">
			...
			&nbsp;Foro di&nbsp;
			<font class="campo"><%=StringUtils.toStringJSP(lAvvocatoSiep.getAvvSiep().getAvvocato().getForo())%></font>
			&nbsp;Difensore di&nbsp;
			<font class="campo"><%=StringUtils.toStringJSP(lAvvocatoSiep.getAvvSiep().getAvvocato().getDescrTipo())%></font>
		</td>
	</tr>
<%
