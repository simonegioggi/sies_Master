...
<%
  ...
  // Instanzia il model dell'EVENTO (per  posizione giuridica "13" motivo "2006" e tipo provvedimento "4" o "9" o "12" quando proviene da ammissione provvisoria))
...
//   if(lEventoAmmProvv == null)
//   	lEventoAmmProvv = new EventoModel();

// if(lMAAmmProvv == null)
//   	lMAAmmProvv = new MisuraAlternativaModel();

// if(lEventoAmmProvvAff == null)
//   	lEventoAmmProvvAff = new EventoModel();
...
%>
            ...
            var data_to_verify = document.LoadInserisciMisuraAlternativa.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value+'/'+document.LoadInserisciMisuraAlternativa.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value+'/'+document.LoadInserisciMisuraAlternativa.<%=ICostantiPenaResidua.CAMPO_ANNO_DATA_FINE%>.value;
...
<%
    ...
    {
%>
		// Controllo per posizione giuridica "29" e tipo misura "DETENZIONE"
		if(document.LoadInserisciMisuraAlternativa.tipomisura.value == 'DETENZIONE' && document.LoadInserisciMisuraAlternativa.posizionegiuridica.value == '29')
		{
			if (document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>.value.length==1)
		      ...
		      var data_to_verify = document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>.value;
		      if (!ControllaData(data_to_verify) )
		      {
		        alert('Data Ammissione Provvisoria e Detenzione Domiciliare non valida');
		        return false;
		      }
    }
    // Controllo per posizione giuridica "13" e tipo misura "AFFIDAMNETO" ed EVENTO con motivo 2006 e tipo provvedimento "4" o "9" o "12"

<%if(lEventoAmmProvvAff.getIdEvento() != null){%>

    else if(document.LoadInserisciMisuraAlternativa.tipomisura.value == 'AFFIDAMENTO' && document.LoadInserisciMisuraAlternativa.posizionegiuridica.value == '13')
    {
       /*
        Commentato perchè il campo "Data Ammissione Provvisoria ad Affidamento in Prova"
         non e' più modificabile
       if (document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>.value.length==1)
		        document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>.value='0'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>.value;
		      if (document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>.value.length==1)
		        document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>.value='0'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>.value;
		      ...
		      if (!ControllaData(data_to_verify) )
		      {
		        alert('Data Ammissione Provvisoria ad Affidamento in Prova non valida');
		        return false;
		      }
       */
    }
...
<%}%>
		...
		else
		{
		    if(document.LoadInserisciMisuraAlternativa.tipo[1].checked == true)
		    {
		      ...
		      {
			  	// Controllo per posizione giuridica "04" e tipo misura "DETENZIONE"
				// cambio gli alert
				if(document.LoadInserisciMisuraAlternativa.tipomisura.value == 'DETENZIONE' && document.LoadInserisciMisuraAlternativa.posizionegiuridica.value == '04')
				{
					alert("La data Esecuzione è obbligatoria")
				}
				else
				{
					alert("La data di Scarcerazione è obbligatoria")
				}// Fine - Controllo posizione giuridica "04"e tipo misura "DETENZIONE"
		      ...
		      ||document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>.value != "" )
		    {
		      ...
		      if (!ControllaData(data_to_verify) )
				  {
				  	// Controllo per posizione giuridica "04"
					// cambio gli alert
					if(document.LoadInserisciMisuraAlternativa.posizionegiuridica.value == '04')
					{
						alert('Data Esecuzione non valida');
					}
					else
					{
						alert('Data Scarcerazione non valida');
					}// Fine - Controllo posizione giuridica "04"
...
%>
    ...
    if(!document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS%>.disabled)
    {
      ...
      {
        alert("Il Magistrato di Sorveglianza è obbligatorio");
        return false;
      }
    }
...
<%}%>
  ...
  {
    if(pos == "13" && tipomisuraJS == "AFFIDAMENTO" && lEveAmmProvAff != null)
    {
        nodeautoritaE.style.visibility='visible';
		    nodecssa.style.visibility='visible';
		    nodesor.style.visibility='visible';
    ...
    else if((pos == "03") || (pos == "14" && tipomisuraJS != "INDULTINO"))
    {
...
<%if(eventonotifica != null && eventonotifica.getNotifiche()!= null && eventonotifica.getNotifiche().length !=0 && eventonotifica.getNotifiche()[0] != null && eventonotifica.getNotifiche()[0].getDataInvio()!= null)
  {%>
 <td class="L">
          <input title = "Giorno Data Trasmissione" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getNotifiche()[0].getDataInvio(),"dd"))%>"   type="text" size="2" maxlength="2" name="<%= ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO %>" <%=IWebConstants.UTIL_DATA%> > -
          <input title = "Mese Data Trasmissione" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getNotifiche()[0].getDataInvio(),"MM"))%>"   type="text" size="2" maxlength="2" name="<%= ICostantiNotifica.CAMPO_MESE_DATA_INVIO %>"  <%=IWebConstants.UTIL_DATA%> > -
          <input title = "Anno Data Trasmissione" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getNotifiche()[0].getDataInvio(),"yyyy"))%>" type="text" size="4" maxlength="4" name="<%= ICostantiNotifica.CAMPO_ANNO_DATA_INVIO %>"  <%=IWebConstants.UTIL_DATA_ANNO%> >
        </td>
...
%>
      <tr>
        ...
        <td class="l">
          <font class="campo">
            <%=StringUtils.toStringJSP(misuraalternativa.getChiaveAnnoFascicoloSius())%>
            /
          </font>
...
%>
    <tr>
      ...
      <td class="l" colspan="3"><font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(misuraalternativa.getDataFineMisura(),"dd-MM-yyyy"))%></font></td>
    </tr>
<%
  }
%>
...
%>
    <tr>
      ...
      <td class="l">Data Scarcerazione  &nbsp;
        <input title = "Giorno Data Scarcerazione" value="<%=DateUtils.getDateToString(misuraalternativa.getDataScarcerazione(),"dd")%>" type="text" size="2" maxlength="2" name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE%>" <%=disabilitaData%>  <%=IWebConstants.UTIL_DATA%> > -
        <input title = "Mese Data Scarcerazione" value="<%=DateUtils.getDateToString(misuraalternativa.getDataScarcerazione(),"MM")%>" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE%>"  <%=disabilitaData%>  <%=IWebConstants.UTIL_DATA%> > -
        <input title = "Anno Data Scarcerazione" value="<%=DateUtils.getDateToString(misuraalternativa.getDataScarcerazione(),"yyyy")%>" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>"  <%=disabilitaData%>  <%=IWebConstants.UTIL_DATA_ANNO%> >
      </td>
    </tr>
<%
    }
...
%>
   <tr>
    ...
    <tr>
      ...
      <td class="l"> Anno / Numero Ordinanza</td>
      <td class="l">
        <input Title="Anno Ordinanza" name="<%=ICostantiMisuraAlternativa.CAMPO_ANNO_REGISTRO%>" type="text" size="4" maxlength="4" onChange="pulisciId();">
        /
...
<%
            ...
            {
%>
              <select title="tipoUfficioSIUS" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA%>">
                <%= tipoUfficioSIUS %>
              </select>
<%
            }
            ...
            {
%>
              <font class="campo">TRIBUNALE DI SORVEGLIANZA</font>
              <input type="hidden" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA%>" value="TDS">
<%
            }
%>      
       </td>
    ...
    <tr>
      ...
      <td class="l" colspan="3">
        <font class="campo">
          ...
          <a href="Javascript:ListaTDS_UDS('LoadInserisciMisuraAlternativa','<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT%>');">
...
<%}else if(tipoMisura.equals("DETENZIONE")){%>
    <tr>
      ...
      <td class="l" colspan="3">
        <font class="campo">
          <input Title="Luogo della Detenzione Domiciliare" name="<%= ICostantiMisuraAlternativa.CAMPO_DESCR_LUOGO_PROVA %>" value="<%=lMAAmmProvv.getDescrLuogoProva()%>" size=35 type="text" onChange="pulisciId();">
        </font>
      </td>
    </tr>
<%}else if(tipoMisura.equals("INDULTINO")){%>
...
<%
    if(!lPosizione.isLibero() && lFlagAffi.equals("N") && !tipoMisura.equals("SEMILIBERTA"))
    {
		...
		// POSIZIONE GIURIDICA "04" e Misura "DETENZIONE"
...
<%
		...
		// CONTROLLO POSIZIONE GIURIDICA "29"
		// cambiano la label e i campi data e spariscono i rabio button
		else if(tipoMisura.equals("DETENZIONE") && lPosizione.getCodPosizioneGiuridica().equals("29"))
		{
%>			<tr>
	        	<td class="l">
					Data Ammissione Provvisoria e Detenzione Domiciliare&nbsp;
	        	</td>
	        	<td class="l">&nbsp;
		          	<input title = "Giorno Data Ammissione Provvisoria e Detenzione Domiciliare" type="text" size="2" maxlength="2" name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvv.getDataEmissione(), "dd"))%>" <%=IWebConstants.UTIL_DATA%> > -
		          	<input title = "Mese Data Ammissione Provvisoria e Detenzione Domiciliare" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvv.getDataEmissione(), "MM"))%>" <%=IWebConstants.UTIL_DATA%> > -
		          	<input title = "Anno Data Ammissione Provvisoria e Detenzione Domiciliare" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvv.getDataEmissione(), "yyyy"))%>" <%=IWebConstants.UTIL_DATA_ANNO%> >
	        	</td>
	       	</tr>
<%
		}
    // CONTROLLO PER POSIZIONE GIURIDICA "13"
    // con Evento validato motivo 2006 e tipo provvedimento 4 o 9 o 12
    else if(tipoMisura.equals("AFFIDAMENTO")&& lPosizione.getCodPosizioneGiuridica().equals("13") && lEventoAmmProvvAff.getIdEvento() != null)
    {
%>
        <tr>
	        	<td class="l">
	        	...
	        	<td class="l">
                                ...
                                <font class="campo">
                                    <%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "dd"))%>-
                                    <%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "MM"))%>-
                                    <%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "yyyy"))%>
                                </font>

                                <!-- campi Data nascosti  Commentato perchè il campo "Data Ammissione Provvisoria ad Affidamento in Prova"
                                     non e' più modificabile sono state inserite le label per visulizzare i valori-->
		          	<input title = "Giorno Data Ammissione Provvisoria ad Affidamento in Prova" type="HIDDEN" size="2" maxlength="2" name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "dd"))%>" <%=IWebConstants.UTIL_DATA%>>
		          	<input title = "Mese Data Ammissione Provvisoria ad Affidamento in Prova" type="HIDDEN" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "MM"))%>" <%=IWebConstants.UTIL_DATA%> >
		          	<input title = "Anno Data Ammissione Provvisoria ad Affidamento in Prova" type="HIDDEN" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lEventoAmmProvvAff.getDataEmissione(), "yyyy"))%>" <%=IWebConstants.UTIL_DATA_ANNO%> >
	        	</td>
        </tr>
<%
    }
  ...
  <tr>
      ...
      <td class="L">
       ...
       <a href="Javascript:ListaUDS('LoadInserisciMisuraAlternativa','<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS%>');">
              <img src="/images/filefolder.gif" border=0> </a>
        <input type="hidden" Title="uds" name="UDSE" value="S">
      </td>
      </tr>
<%if(!tipoMisura.equals("INDULTINO")){%>
   <tr>
...
//Controlli Data Emissione
  ...
  // Controlli Data Ammissione Provvisoria e Detenzione Domiciliare
  <%if(tipoMisura.equals("DETENZIONE") && lPosizione.getCodPosizioneGiuridica().equals("29"))
  {%>
     frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>","req","Il campo Giorno Data Ammissione Provvisoria e Detenzione Domiciliare è obbligatorio");
     ...
     frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>","req","Il campo Mese Data Ammissione Provvisoria e Detenzione Domiciliare è obbligatorio");
     ...
     frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>","req","Il campo Anno Data Ammissione Provvisoria e Detenzione Domiciliare è obbligatorio");
...
<%if(!lPosizione.isLibero() && lFlagAffi.equals("N") && !tipoMisura.equals("SEMILIBERTA") && !lPosizione.getCodPosizioneGiuridica().equals("29")){

     if(tipoMisura.equals("AFFIDAMENTO") && lPosizione.getCodPosizioneGiuridica().equals("13") && lEventoAmmProvvAff.getIdEvento() != null){
%>
        /*
         Commentato perchè il campo "Data Ammissione Provvisoria ad Affidamento in Prova"
         non e' più modificabile

        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>","req","Il campo Giorno Data Ammissione Provvisoria ad Affidamento in Prova è obbligatorio");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>","numeric");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>","gt=1");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA%>","lt=31");

        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>","req","Il campo Mese Data Ammissione Provvisoria ad Affidamento in Prova è obbligatorio");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>","numeric");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>","gt=1");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA%>","lt=12");

        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>","req","Il campo Anno Data Ammissione Provvisoria ad Affidamento in Prova è obbligatorio");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>","numeric");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>","gt=1900");
        frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA%>","lt=2050");
        */
...
//Controlli Data Scarcerazione
       ...
       frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>","lt=2050");
