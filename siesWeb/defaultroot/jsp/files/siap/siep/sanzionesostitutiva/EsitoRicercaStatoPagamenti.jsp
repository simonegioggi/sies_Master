...
<body class="corpo">
  ...
  <table>
    ...
    <tr>
      <td class="L">Data Iscrizione Iniziale: </font></td>
      ...
      <td class="L">Data Iscrizione Finale: </font></td>
    ...
    <tr>
      <td class="L">Tipologi Statistica: </font></td>
  ...
  <table cellspacing=2 cellpadding=2>
    ...
    <tr>
      <td class="r">
      	<font class="label"><%=StringUtils.toStringJSP(fascicolo.getChiaveProgr())+"/"+StringUtils.toStringJSP(fascicolo.getChiaveAnno())%></font>
      </td>
