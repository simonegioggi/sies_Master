...
<head>
  ...
  <script language="JavaScript" src="<%=IWebConstants.JS_VALIDATOR%>"></script>
   ...
   function stampa() {
	   document.RicercaStatoPagamenti.submit();	   
   }
   </script>
</head>
...
<form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="RicercaStatoPagamenti" >
  ...
  <input type="HIDDEN" name="tipoRicerca" value="stampaExcel">
	...
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_ANNO_INIZIALE%>"  value="<%=StringUtils.toStringJSP(criteriRicerca.getChiaveAnnoIniziale(),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_INIZIALE%>" value="<%=StringUtils.toStringJSP(criteriRicerca.getChiaveProgrIniziale(),"")%>" />
	
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_ANNO_FINALE%>"  value="<%=StringUtils.toStringJSP(criteriRicerca.getChiaveAnnoFinale(),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_FINALE%>" value="<%=StringUtils.toStringJSP(criteriRicerca.getChiaveProgrFinale(),"")%>" />	
	
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_GIORNO_ISCRIZIONE_INIZIALE%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneIniziale(),"dd"),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_MESE_ISCRIZIONE_INIZIALE%>"   value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneIniziale(),"MM"),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_ANNO_ISCRIZIONE_INIZIALE%>"   value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneIniziale(),"yyyy"),"")%>" />
	
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_GIORNO_ISCRIZIONE_FINALE%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneFinale(),"dd"),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_MESE_ISCRIZIONE_FINALE%>"   value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneFinale(),"MM"),"")%>" />
	<input type="hidden" name="<%=ICostantiFascicoloSiep.CAMPO_ANNO_ISCRIZIONE_FINALE%>"   value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(criteriRicerca.getDataIscrizioneFinale(),"yyyy"),"")%>" />
	
	<input type="hidden" name="<%=ICostantiSanzioneSostitutiva.CAMPO_TIPO_RICERCA_STATO_PAGAMENTO%>"  value="<%=StringUtils.toStringJSP(tipoRicerca,"")%>" />
</form>
