...
<%
  if(lTipoFunzione == null || lTipoFunzione.equals("")) // lTipoFunzione per capire che si proviene da iscrizione guidata
  {
    if(!lAvvocato.getAvvocatoFascicoloSiepModel().getCodMotivoDesignazione().equals("-") 
    	...
    	&& lEve.getEvento().getIdEvento() !=null && !"S".equals(lEve.getEvento().getFlagDocumentoRegistrato()))
    	{
%>
 ...
 <%
   ...
   //  <jsp:include page="<%=IWebConstants.PG_RETURN_BUTTON....
				...
				if (request.getParameter("NomeAzione") != null
					...
					"siap.siep.avvocato.action.ActRicercaStoricoAvvocatoFascicolo")) {
%>
...
<%
    if(lAvvocato.getAvvocato().getDescrTipo().equalsIgnoreCase("DI FIDUCIA") || lAvvocato.getAvvocato().getDescrTipo().equalsIgnoreCase("D'UFFICIO"))
    {
%>
    <tr>
<%
    if(lAvvocato.getAvvocato().getDescrTipo().equalsIgnoreCase("DI FIDUCIA"))
    {
%>
       <td class="l"><font class="label">Data Nomina</font></td>
<%
    }
    if(lAvvocato.getAvvocato().getDescrTipo().equalsIgnoreCase("D'UFFICIO"))
    {
%>
...
<%
  ...
  if( lAvvocato.getAvvocato().getDescrTipo().equalsIgnoreCase("D'UFFICIO"))
  {
    if(!lAvvocato.getAvvocatoFascicoloSiepModel().getDescrMotivoDesignazione().equals("-"))
    {
%>
      <tr>
...
<%
    ...
    if(!lAvvocato.getAvvocatoFascicoloSiepModel().getDescrTipoAutorita().equals("-"))
    {
%>
      <tr>
				...
				<font class="campo"><%=StringUtils.toStringJSP(lAvvocato.getAvvocatoFascicoloSiepModel().getIndirizzoTipoAutorita()) %>  </font></td>
      </tr>
<%
    }
...
<%
    ...
    if(!lAvvocato.getAvvocatoFascicoloSiepModel().getDescrTipoAutoritaDif().equals("-"))
    {
%>
      <tr>
