...
<script language="JavaScript">
  ...
  function Verify() {
    ...
    if(tipo =="01" && document.LoadModificaAvvocato.<%= ICostantiAvvocato.CAMPO_COD_MOTIVO_DESIGNAZIONE%>
      [document.LoadModificaAvvocato.<%= ICostantiAvvocato.CAMPO_COD_MOTIVO_DESIGNAZIONE%>.selectedIndex].value=='-'){
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadModificaAvvocato">
  ...
  <%/******************************************************************************
     Div da Visualizzare nel caso dei avvocato di fiducia contenente la data della
     nomina
    ******************************************************************************/ %>
  ...
  <%/******************************************************************************
     Div da Visualizzare nel caso dei avvocato d'ufficio contenente la data della
     nomina
    ******************************************************************************/ %>
