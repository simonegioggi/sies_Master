...
if (codFunzione != null
		&& (codFunzione.equals(ICostantiFascicoloSius.COD_FUNZIONE_90010000)
				|| codFunzione.equals(ICostantiFascicoloSius.COD_FUNZIONE_90020000)
				|| codFunzione.equals(ICostantiFascicoloSius.COD_FUNZIONE_90040000)
				|| codFunzione.equals(ICostantiFascicoloSius.COD_FUNZIONE_90050000)
...
%>
    ...
    <tr>
   	...
   	<%-- MEV_21: aggiunto campo per inserire avvocato non trovato nè in RegInde che in SIES --%>
    <tr>
		<td class="l">pec</td>
    ...
    <tr>
      	<td colspan=2>
	        ...
	        <%-- MEV_21: disabilito bottone di inserimento per inserire avvocato non trovato nè in RegInde che in SIES --%>
	        <%-- è possibile solo associarlo al fascicolo in essere --%>
...
<%-- 20210610 MEV_21: tale campo non ha senso più poichè sostituito da CAMPO_DESC_COMUNE_STUDIO --%>
