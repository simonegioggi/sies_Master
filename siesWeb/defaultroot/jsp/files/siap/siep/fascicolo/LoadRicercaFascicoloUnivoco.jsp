...
<jsp:useBean id="cumulo" scope="request" class="java.lang.String"/>
...
<body class="corpo" onLoad="document.f.<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_ORIGIN%>.focus();">
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.fascicolo.action.ActLoadFascicoloInSessione">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      ...
      <% }else
      {%>
       <td class=LBG><font class="label">Funzione :</font>&nbsp;<font class="campo">Ricerca Fascicolo Cumulante</font></td>
       <%} %>
    </tr>
  </table>
  ...
  <table cellpadding=2 cellspacing=2>
    <tr>
      ...
      <td class="l">
        <input type="text" title="Anno" value="<%=DateUtils.getSysDate("yyyy")%>" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_ANNO%>" maxlength="4" size="4" 
