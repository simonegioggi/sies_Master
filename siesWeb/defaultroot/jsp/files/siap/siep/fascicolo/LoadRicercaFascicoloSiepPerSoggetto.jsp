...
document.onmousemove=positiontip
	...
	<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>"
		...
		<input type="HIDDEN" name="redirigi" value="S"> <input
			type="HIDDEN" name="<%=ICostantiJmsCode.CAMPO_DESCRIZIONE%>">
		<input type="HIDDEN"
		...
		<table>
			<tr>
				...
				<td class="LBG"><font class="label">Funzione :</font> <font
					class="campo">Ricerca Procedimento per Soggetto</font></td>
			</tr>
		</table>
		<br>
		<table width=80%>
			...
			<tr>
				<td class="c">Nell'Ufficio &nbsp;<input type="radio"
					name="tipoRicerche" value="ufficio" onClick="radioBase();">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nel distretto &nbsp;<input
					type="radio" name="tipoRicerche" value="distretto" checked
					onClick="radioBase();"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In
					altri distretti &nbsp; <input type="radio" name="tipoRicerche"
					value="altriDistretti" onClick="radioBase();">
				</td>
			</tr>
		</table>
		<div id="divAncheAlias" style="display: block; width: 100%;">
			<table width=80%>
				<tr>
					<td class="l">Anche Alias&nbsp;<input type="checkbox"
						name="ancheAlias" value="ancheAlis" onClick="checkbox();"></td>
				</tr>
			</table>
		</div>
		<div id="divDistretto" style="display: none; width: 100%;">
			<table cellspacing=2 cellpadding=2>
				...
				<tr>
					...
					<td class="l"><input title="Comune di Nascita" value=""
						...
						<a
						href="Javascript:ListaComuniNascita('LoadRicercaSoggetto','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>[0]');">
			...
			<div id="chkDivAncheAlias" style="display: block; width: 100%;">
				<table cellspacing=2 cellpadding=2>
					...
					<tr>
						<td class="l"><span
							id="<%= ICostantiSoggetto.CAMPO_NOME_MADRE %>">Nome Madre
						</span></td>
					...
					<tr>
						<td class="l"><span
							id="<%= ICostantiSoggetto.CAMPO_ATTO_NASCITA %>">Atto
								Nascita</span></td>
			...
			<div id="tipoClassiDiv" style="display: block; width: 100%;">
				<table cellspacing=2 cellpadding=2>
					...
					<tr>
						<td class="l" ONMOUSEOVER="ddrivetip('Pena Detentiva','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe I</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="1"></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td class="l" ONMOUSEOVER="ddrivetip('Pena Pecuniaria','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe II</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="2"></td>
					</tr>
					<tr>
						<td class="l" ONMOUSEOVER="ddrivetip('Pena Sospesa','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe III</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="3"></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td class="l" ONMOUSEOVER="ddrivetip('Misura Sicurezza','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe IV</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="4"></td>
					</tr>
					<tr>
						<td class="l"
							ONMOUSEOVER="ddrivetip('Persona Giuridica','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe V</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="5"></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td class="l" ONMOUSEOVER="ddrivetip('Giudice di Pace','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe VI</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="6"></td>
					</tr>
					<tr>
						<td class="l"
							ONMOUSEOVER="ddrivetip('Conversione Pena Pecuniaria','yellow')"
							ONMOUSEOUT="hideddrivetip()">Classe VII</td>
						<td class="l"><input type="checkbox" name="tipoClasse"
							value="7"></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
			...
			<table cellspacing=2 cellpadding=2>
				...
				<tr>
					...
					<td valign="middle"><select
						name="<%=ICostantiJmsCode.CAMPO_CODICE%>"
...
%>
				...
				<tr>
					<td class="l">Cognome
						<div id="sog1" style="display: none">
							<font class=obr>(*)</font>
						</div>
					</td>
					<td class="l"><input title="Cognome Soggetto" type="text"
						name="<%=ICostantiSoggetto.CAMPO_COGNOME%>" value="" size="30"
						maxlength="30" onFocus="javascript:VediOb(1);"></td>
				</tr>

				<tr>
					<td class="l">Nome
						<div id="sog2" style="display: none">
							<font class=obr>(*)</font>
						</div>
					</td>
					<td class="l"><input title="Nome Soggetto" type="text"
				...
				<tr>
					<td class="l">Comune di nascita
						<div id="sog3" style="display: none">
							<font class=obr>(*)</font>
						</div>
					</td>
					<td class="l"><input title="Comune di Nascita" value=""
						...
						maxlength="30" size="30" onChange="cancellaCodComuneReale();">
						<a
						href="Javascript:ListaComuniNascita('LoadRicercaSoggetto','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>[1]');">
							<img src="/images/filefolder.gif" border=0>
					</a></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="l">Data di nascita
						<div id="sog4" style="display: none">
							<font class=obr>(*)</font>
						</div>
					</td>
					<td class="l"><input title="Data di nascita" type="text"
						name="<%= ICostantiSoggetto.CAMPO_GIORNO_DATA_NASCITA2%>"
						maxlength="2" size="2" <%=IWebConstants.UTIL_DATA%>> / <input
						title="Data di nascita" type="text"
						name="<%= ICostantiSoggetto.CAMPO_MESE_DATA_NASCITA2 %>"
						maxlength="2" size="2" <%=IWebConstants.UTIL_DATA%>> / <input
						title="Data di nascita" type="text"
						name="<%= ICostantiSoggetto.CAMPO_ANNO_DATA_NASCITA2%>"
						maxlength="4" size="4" <%=IWebConstants.UTIL_DATA_ANNO%>>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="l">Codice CUI
						<div id="cui" style="display: none">
							<font class=obr>(*)</font>
						</div>
					</td>
					<td class="L"><input title="Codice CUI" type="text"
						name="<%= ICostantiSoggetto.CAMPO_COD_AFIS %>" maxlength="7"
						size="7" onFocus="javascript:VediOb(2);"></td>
				</tr>
