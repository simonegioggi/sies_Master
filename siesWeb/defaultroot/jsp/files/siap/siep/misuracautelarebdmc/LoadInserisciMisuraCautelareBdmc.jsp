...
<html>
<head>
  <title> Gestione MisuraCautelareBdmc </title>
  ...
  <script language="JavaScript" >
    ...
    function Verify() { 
      ...
      */
      ...
      //=============================================================
      var data_to_verify = document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INIZIO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_INIZIO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_ANNO_DATA_INIZIO%>.value; 
      if (!ControllaData(data_to_verify) && data_to_verify.length>2){ 
        alert('Data Inizio non corretta'); 
        document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INIZIO%>.focus(); 
        return false; 
      } 
      ...
      //=============================================================
      var data_to_verify = document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_FINE%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_FINE%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_ANNO_DATA_FINE%>.value; 
      if (!ControllaData(data_to_verify) && data_to_verify.length>2){ 
        alert('Data Fine non corretta'); 
        document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_FINE%>.focus(); 
        return false; 
      } 

      //=============================================================
      // controllo correttezza campo 'Data Computo' 
      //=============================================================
      var data_to_verify = document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_COMPUTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_COMPUTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_ANNO_DATA_COMPUTO%>.value; 
      if (!ControllaData(data_to_verify) && data_to_verify.length>2){ 
        alert('Data Computo non corretta'); 
        document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_COMPUTO%>.focus(); 
        return false; 
      } 
      ...
      //=============================================================
      var data_to_verify = document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INSERIMENTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_INSERIMENTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_ANNO_DATA_INSERIMENTO%>.value; 
      if (!ControllaData(data_to_verify) && data_to_verify.length>2){ 
        alert('Data Inserimento non corretta'); 
        document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INSERIMENTO%>.focus(); 
        return false; 
      } 
      ...
      //=============================================================
      var data_to_verify = document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_AGGIORNAMENTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_AGGIORNAMENTO%>.value+'/'+ 
                           document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_ANNO_DATA_AGGIORNAMENTO%>.value; 
      if (!ControllaData(data_to_verify) && data_to_verify.length>2){ 
        alert('Data Aggiornamento non corretta'); 
        document.LoadInserisciMisuraCautelareBdmc.<%=ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_AGGIORNAMENTO%>.focus(); 
        return false; 
      } 
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <%
        MisuraCautelareBdmcModel lMisuraCautelareBdmc = new MisuraCautelareBdmcModel(); 
        String lAzione = new String();
        if( modalita.equals("I") ) {
          lAzione = "siap.siep.misuracautelarebdmc.action.ActInserisciMisuraCautelareBdmc"; 
        %>
        <font class="campo">Inserimento MisuraCautelareBdmc</font>
        <%
        }
        else if( modalita.equals("M") ) {
          lAzione = "siap.siep.misuracautelarebdmc.action.ActModificaMisuraCautelareBdmc";
          lMisuraCautelareBdmc = misuracautelarebdmc;
        %>
        <font class="campo">Modifica MisuraCautelareBdmc</font>
        <%}%>
      </td>
    </tr>
  </table>

<FORM method="POST" action="Main.jsp" name="LoadInserisciMisuraCautelareBdmc">
  ...
  <table>
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getIdMisuraCautelare()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getFasSieIdFascicoloSiep()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getSogIdSoggetto()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getEveIdEvento()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getPenResIdPenaResidua()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getIdPren()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="38" size="40" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getProgPeriPres()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="4" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getFlagCaricamento()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="1" size="1" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getFlagStato()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="2" size="2" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodTipoMisura()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInizio(),"dd")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INIZIO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInizio(),"MM")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_INIZIO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="4" maxlength="4" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInizio(),"yyyy")) %>" 
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataFine(),"dd")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_FINE %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataFine(),"MM")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_FINE %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="4" maxlength="4" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataFine(),"yyyy")) %>" 
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumAnni()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumMesi()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumGiorni()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="4" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getIstDetIdIstitutoDetenzione()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="1000" size="1000" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAltroLuogoDetenzione()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="1" size="1" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getFlagComputabile()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="2" size="2" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodMotivoNonComputabile()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="6" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodTipoUfficioRifer()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="6" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodLuogoUfficioRifer()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataComputo(),"dd")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_COMPUTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataComputo(),"MM")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_COMPUTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="4" maxlength="4" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataComputo(),"yyyy")) %>" 
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoFascSiep()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeFascSiep()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="2000" size="2000" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNote()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoFascBdmc()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeFascBdmc()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioBdmc()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRgnr()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeRgnr()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioRgnr()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRegeGip()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeroRegeGip()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioGip()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRegeDib()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeroRegeDib()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioDib()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRegeCas()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeroRegeCas()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioCas()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRegeCap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeroRegeCap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioCap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="4" size="6" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getAnnoRegeCasap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="6" size="8" ONKEYPRESS="return TicTabNumField(this,event)" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getNumeroRegeCasap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioCasap()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="100" size="100" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodOperatoreInserimento()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInserimento(),"dd")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_INSERIMENTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInserimento(),"MM")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_INSERIMENTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="4" maxlength="4" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataInserimento(),"yyyy")) %>" 
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioInserimento()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="100" size="100" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodOperatoreAggiornamento()) %>"
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataAggiornamento(),"dd")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_GIORNO_DATA_AGGIORNAMENTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="2" maxlength="2" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataAggiornamento(),"MM")) %>" 
               name="<%= ICostantiMisuraCautelareBdmc.CAMPO_MESE_DATA_AGGIORNAMENTO %>" 
               onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" 
         >&nbsp;/&nbsp;
        <input type="text" size="4" maxlength="4" <%=readonly%> 
               value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(lMisuraCautelareBdmc.getDataAggiornamento(),"yyyy")) %>" 
    ...
    <tr>
      ...
      <td class="l"> 
        <input type="text" maxlength="11" size="11" 
               value="<%=StringUtils.toStringJSP(lMisuraCautelareBdmc.getCodUfficioAggiornamento()) %>"
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciMisuraCautelareBdmc");

  frmvalidator.addValidation("<%= ICostantiMisuraCautelareBdmc.CAMPO_ID_MISURA_CAUTELARE %>","req","Il campo Id Misura Cautelare è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiMisuraCautelareBdmc.CAMPO_FAS_SIE_ID_FASCICOLO_SIEP %>","req","Il campo Fas Sie Id Fascicolo Siep è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiMisuraCautelareBdmc.CAMPO_SOG_ID_SOGGETTO %>","req","Il campo Sog Id Soggetto è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiMisuraCautelareBdmc.CAMPO_FLAG_CARICAMENTO %>","req","Il campo Flag Caricamento è obbligatorio");
  frmvalidator.addValidation("<%= ICostantiMisuraCautelareBdmc.CAMPO_FLAG_STATO %>","req","Il campo Flag Stato è obbligatorio");
