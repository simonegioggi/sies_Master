...
<!-- 		LoadStatisticaRiepilogoIscrizionieAttivitaCPP		 -->
<html>
  <head>
...
// Scelta della classe Procedimento da elaborare
			if(!document.c.tipo[0].checked && 
				!document.c.tipo[1].checked &&
				!document.c.tipo[2].checked &&
				!document.c.tipo[3].checked &&
				!document.c.tipo[4].checked && 
				!document.c.tipo[5].checked &&
				!document.c.tipo[6].checked &&
				!document.c.tipo[7].checked )
			{
				alert('Inserire il check su Classe Procedimenti');
	        	document.c.tipo[0].blur();
	        	return false;						
			}	
    ...
    {
    	if(document.c.tipo[0].checked)			// Classe I - Pena Detentiva
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[1].checked)		// Classe II - Pena Pecuniaria
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[2].checked)		// Classe III  - Pena Sospesa
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[3].checked)		// Classe IV - Misure Sicurezza
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[4].checked)		// Classe V - Persona Giuridica
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[5].checked)		// Classe VI - Giudice di pace
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
    	else if(document.c.tipo[6].checked)		// Classe VII - Conversione Pene Pecuniarie
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.siep.statis.action.ActCreaRiepilogoIscrizioniAttivitaCPP";
    	}
    	else if(document.c.tipo[7].checked)		// Registro Istanze
    	{
    		document.c.<%=IWebConstants.ACTION_FIELD%>.value="siap.sico.web.ActionUnderConstruction";
    	}
  ...
  <table>
  	<tr>
        ...
        <td class="LBG">
          ...
          <font class="campo">STATISTICHE UFFICIO - RIEPILOGO ISCRIZIONI E ATTIVITA</font>
        </td>
     </tr>
   </table>
<br>
