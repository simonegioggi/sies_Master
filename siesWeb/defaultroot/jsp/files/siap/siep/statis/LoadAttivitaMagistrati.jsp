...
<html>
  <head>
	...
	var data_sistema="<%=sysdate%>";
      ...
      if(!CompareDate(data_inizio, data_fine))
      {
    	...
    	if (document.c.<%=ICostantiStatis.CAMPO_LISTA_MAGISTRATI%> != null && document.c.<%=ICostantiStatis.CAMPO_LISTA_MAGISTRATI%>.selectedIndex == -1) {
  ...
  <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name="c">
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          <font  class="label">Funzione :&nbsp;</font><font class="campo">STATISTICHE UFFICIO - ATTIVITA' MAGISTRATI</font>
        </td>
      </tr>
    </table>
    <br>
...
<% // END NGG %>
    ...
    <tr>
      <td>
        ...
        <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.statis.action.ActCreaAttivitaMagistrati">
      </td>
	</tr>
    <tr>
      <td>
...
<table>
    ...
    <tr>
      <td>
        <input type=submit value="Visualizza Magistrati" class=bottone name="btnMag">
        <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.statis.action.ActLoadAttivitaMagistrati">
      </td>
	</tr>
    <tr>
      <td>
