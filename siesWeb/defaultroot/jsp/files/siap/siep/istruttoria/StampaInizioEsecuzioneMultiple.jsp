...
function mostraAttesa(testo) 
{
  ...
  stampa('/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaMultiInizioEsecuzione&CampoChiaveProgrIniziale=<%=CampoChiaveProgrIniziale %>&CampoChiaveAnnoIniziale=<%=CampoChiaveAnnoIniziale%>&CampoChiaveProgrFinale=<%=CampoChiaveProgrFinale%>&CampoChiaveAnnoFinale=<%=CampoChiaveAnnoFinale%>')
...
function stampaDoc()
{ 
  var url = "/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaMultiInizioEsecuzione&CampoChiaveProgrIniziale=<%=CampoChiaveProgrIniziale %>&CampoChiaveAnnoIniziale=<%=CampoChiaveAnnoIniziale%>&CampoChiaveProgrFinale=<%=CampoChiaveProgrFinale%>&CampoChiaveAnnoFinale=<%=CampoChiaveAnnoFinale%>";
  //alert (url);
  stampa('/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaMultiInizioEsecuzione&CampoChiaveProgrIniziale=<%=CampoChiaveProgrIniziale %>&CampoChiaveAnnoIniziale=<%=CampoChiaveAnnoIniziale%>&CampoChiaveProgrFinale=<%=CampoChiaveProgrFinale%>&CampoChiaveAnnoFinale=<%=CampoChiaveAnnoFinale%>');
}
  ...
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      ...
      <td class="LBG">
        ...
        <font class="campo">Stampa Inizio Esecuzione Multiple</font>
      </td>
      <td class="LBG">
      </td>
     </tr>
...
<a href="/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaMultiInizioEsecuzione&CampoChiaveProgrIniziale=<%=CampoChiaveProgrIniziale %>&CampoChiaveAnnoIniziale=<%=CampoChiaveAnnoIniziale%>&CampoChiaveProgrFinale=<%=CampoChiaveProgrFinale%>&CampoChiaveAnnoFinale=<%=CampoChiaveAnnoFinale%>">
<img align="middle" src="<%=IWebConstants.IMAGES_DIR%>print24.gif" alt="Stampa Inizio Esecuzione Multiple" width=64 border=3></a>
