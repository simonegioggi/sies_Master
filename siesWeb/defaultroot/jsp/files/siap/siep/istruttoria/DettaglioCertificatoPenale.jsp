...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Certificato Penale - </title>
    ...
    <table>
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Certificato Penale</font>
        </td>
 <%if (lEve.getEvento().getFlagDocumentoRegistrato()!=null)
 if (lEve.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
    ...
    <!-- BOTTONE DI STAMPA -->
       <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
          <jsp:param name="ActionLink" value="<%=      "/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaCertificatoPenale&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
       </jsp:include>
     <%}%>
...
<%if (lEve.getEvento().getFlagDocumentoRegistrato()==null)
 {%>
  ...
  <table cellspacing=4 cellpadding=4>
   ...
   <tr>
      <td class="l" colspan=2>CASELLARIO di 
