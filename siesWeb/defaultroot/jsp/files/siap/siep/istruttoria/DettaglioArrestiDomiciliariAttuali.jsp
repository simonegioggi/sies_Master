...
<html>
  ...
  <head>
    <title> [S.I.E.S.] - Dettaglio Richiesta Arresti Domiciliari Attuali- </title>
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Arresti Domiciliari Attuali</font>
        </td>
 <%if (lEve.getEvento().getFlagDocumentoRegistrato()!=null)
 if (lEve.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
       <!-- BOTTONE DI STAMPA -->
       <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
          <jsp:param name="ActionLink" value="<%=      "/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaArrestiDomiciliariAttuali&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
       </jsp:include>
        <%}%>
         ...
         <FORM name="comandi" enctype="multipart/form-data" method="post">
          ...
          <jsp:include page="<%=ISIAPCostantiWeb.CAMPI_VALIDA_UPLOAD%>" />
             <tr><td class="L">
                 ...
                 <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.istruttoria.action.ActDettaglioArrestiDomiciliariAttuali">
               </td> </tr>
              </table>
