...
<head>
 ...
 function Verify()
 {
  ...
  annof = document.a.CampoChiaveAnnoFinale.value;
  annoi = document.a.CampoChiaveAnnoIniziale.value;
  progrf = document.a.CampoChiaveProgrFinale.value;
  progri = document.a.CampoChiaveProgrIniziale.value;
...
<table >
    ...
    <tr>
      ...
      <td class="l">
        ...
        /
        <input type="text" title="Numero Procedimento Iniziale" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_INIZIALE%>" maxlength="6" size="6">
      </td>
      <td class="L">
        <font class="label">
          Anno/Numero Finale
      ...
      <td class="l">
        ...
        /
        <input type="text" title="Numero Procedimento Finale" name="<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_FINALE%>" maxlength="6" size="6">
      </td>
     </tr>
     </table>
     <br>
...
<script language="JavaScript" type="text/javascript">
  ...
  frmvalidator.addValidation("<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_INIZIALE%>","maxlen=13","La lunghezza massima per il Numero Procedimento è di 13 caratteri");
  ...
  frmvalidator.addValidation("<%=ICostantiFascicoloSiep.CAMPO_CHIAVE_PROGR_FINALE%>","maxlen=13","La lunghezza massima per il Numero Procedimento è di 13 caratteri");
