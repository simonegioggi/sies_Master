...
<%-- 20181113: eliminato div inutile --%>
<!--   <div id="intervallo" width=100% style="visibility:visible; position:relative; top:15px; " > -->
  
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.istruttoria.action.ActLoadStampaCopertineMultiple">
<table >
