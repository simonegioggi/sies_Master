    ...
    <table>
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Richiesta Informazioni Arresto e/o Denuncia</font>
        </td>
 <%if (lEve.getEvento().getFlagDocumentoRegistrato()!=null)
 if (lEve.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
    <!-- BOTTONE DI STAMPA -->
       <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
          <jsp:param name="ActionLink" value="<%=      "/jsp/Main.jsp?Action=siap.siep.istruttoria.action.ActStampaInfoArrestoDenuncia&IdEvento="+lEve.getEvento().getIdEvento()%>"/>
       </jsp:include>
     <%}%>
...
<%if (lEve.getEvento().getFlagDocumentoRegistrato()==null)
 {%>   <!-- BOTTONE DI STAMPA -->
  ...
  <table cellspacing=4 cellpadding=4>
    ...
    <tr>
      <td class="l">Data Arresto e/o Denuncia </td>
      <td class="L" >
       ...
       <tr>
        <td class="L">
          <input  class=bottone  type="submit" value="Conferma">
           ...
           <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.istruttoria.action.ActDettaglioInfoArrestoDenuncia">
        </td>
       </tr>
      </table>
