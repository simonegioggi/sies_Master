...
<html>
<head>
<title>[S.I.E.S.] - Differimento Interruzione </title>
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciSosp">
  ...
  <table>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActLoadValidaInterruzione">
    <input type="HIDDEN" name="<%=ICostantiDecretoOrdinanzaSiep.CAMPO_ID_DECRETO_ORDINANZA_SIEP%>" value="<%=decretoordinanza.getIdDecretoOrdinanzaSiep()%>">
      ...
      <font class="campo">Dettaglio Interruzione Pena</font>
    </td>
<!--
     <td class="LBG">
-->
