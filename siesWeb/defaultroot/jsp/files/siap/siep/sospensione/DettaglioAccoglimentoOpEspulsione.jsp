...
<body class="corpo">
  ...
  <font class="campo">DETTAGLIO ACCOGLIMENTO OPPOSIZIONE ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD.
</font>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.sospensione.action.ActDettaglioAccoglimentoOpEspulsione">
          </td>
        </tr>
      </table>
</form>
