...
%>
	...
	<tr>
	  	...
	  	<td class="l" colspan="3"><font class="campo"><%=StringUtils.toStringJSP(misuraalternativa.getDescrTipoDecisione())%></font></td>
	</tr>
	<tr>
...
%>
	<tr>
	    ...
	    <td class="l"><font class="campo"><%=StringUtils.toStringJSP(misuraalternativa.getNote())%></font><td>
	</tr>
<%
}
%>
...
%>
	<tr>
	  	<td class="l"><font class="label">Pena Espiata</font></td>
	  	<td class="l" colspan="3">
...
if ("N".equals(penaresidua.getFlagErgastolo()) && (!sospensione.isQuantumReclusioneResiduoZero()
		|| !sospensione.isQuantumArrestoResiduoZero())) {
%>
	<tr>
  		<td class="l"><font class="label">Pena Residua</font></td>
  		<td class="l" colspan="3">
<%
...
%>
	<tr>
	  	<td class="l"><font class="label">Pena Complessiva</font></td>
...
if (lIstMod.getIdIstitutoDetenzione() != null && !lIstMod.getIdIstitutoDetenzione().equals("")) {
%>
	<tr>
