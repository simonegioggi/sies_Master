...
%>
        ...
        document.LoadInserisciEspulsione.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.disabled=false;
        document.LoadInserisciEspulsione.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>.disabled=false;
        document.LoadInserisciEspulsione.<%=ICostantiNotifica.CAMPO_NOTE%>.disabled=false;
...
%>
        ...
        document.LoadInserisciEspulsione.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.disabled=true;
        document.LoadInserisciEspulsione.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>.disabled=true;
        document.LoadInserisciEspulsione.<%=ICostantiNotifica.CAMPO_NOTE%>.disabled=true;
<%
...
<body class="corpo" onload="radio();">
  <table>
    ...
    <font class="campo">ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD.
</font>
</td>
</tr>
</table>
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciConcessioneEspulsione">
...
<table width='90%'>
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="l" colspan="3">
        <font class="campo">
          ...
          <a href="Javascript:ListaComuniEmitUdsMinor('LoadInserisciEspulsione','<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT%>');">
    ...
    <tr>
      ...
      <td class="L" colspan="3">
         <select  Title="Codice Motivo" class="small" name="<%=ICostantiEvento.CAMPO_COD_MOTIVO%>" onChange="pulisciId();">
          <%=motivoProvv%>
        </select>
   </td>
    </tr>
    ...
    <tr>
      ...
      <td class="l" colspan="3">
        Anni &nbsp;
        <font class="campo">
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_MISURA%>" onChange="pulisciId();">
        </font>
        Mesi &nbsp;
        <font class="campo">
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_NUM_MESI_MISURA%>" onChange="pulisciId();">
        </font>
        Giorni &nbsp;
        <font class="campo">
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_MISURA%>" onChange="pulisciId();">
        </font>
      </td>
    </tr>
    <tr>
...
%>
  ...
  <tr>
     ...
     <td class="L">
         ...
         <a href="Javascript:ListaComuni('LoadInserisciEspulsione','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>');">
          <img src="/images/filefolder.gif" border=0>
        </a>
      </td>
           <td class="l">Indirizzo</td>
