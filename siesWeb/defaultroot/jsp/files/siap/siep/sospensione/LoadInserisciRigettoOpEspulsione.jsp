...
%>
    ...
    var data_to_verify = document.LoadInserisciEspulsione.<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>.value+'-'+document.LoadInserisciEspulsione.<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>.value+'-'+document.LoadInserisciEspulsione.<%=ICostantiNotifica.CAMPO_ANNO_DATA_INVIO%>.value;
...
<body class="corpo">
  <table>
    ...
    <font class="campo">RIGETTO OPPOSIZIONE ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD.
</font>
</td>
</tr>
</table>
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciRigettoOpEspulsione">
...
//Controlli Data Emissione
  ...
  if(!document.LoadInserisciEspulsione.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_DECISIONE%>.disabled)
    {
