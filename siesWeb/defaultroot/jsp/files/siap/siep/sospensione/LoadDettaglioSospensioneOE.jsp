...
<% // paolo cherubini 14/02/2011 cambio con quello sotto 
  ...
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
        <font class="campo">Provvedimento Ordine di Esecuzione </font>
      </td>
      ...
      if (   eventonotifica.getEvento().getFlagDocumentoRegistrato()==null
          || eventonotifica.getEvento().getFlagDocumentoRegistrato().equals("N")
         )
      {%>
...
<%
//==============================================================================
//       Sezione con il Riepilogo Dati del provvedimento di interruzione
//==============================================================================
%>
...
<table width="90%">
  ...
  <tr>
    <td class="l">Data Interruzione</td>
    <td class="L">
    ...
    <table width="90%">
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>"             value="siap.siep.sospensione.action.ActUploadSospensioneOE">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>"        value="<%= eventonotifica.getEvento().getIdEvento() %>">
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.sospensione.action.ActLoadDettaglioSospensioneOE">
        </td>
      </tr>
    </table>
  </FORM>
