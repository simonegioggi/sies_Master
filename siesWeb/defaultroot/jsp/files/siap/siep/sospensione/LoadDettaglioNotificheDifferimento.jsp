...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Provvedimento Differimento</title>
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciSosp">
  ...
  <table>
    <tr>
      ...
      <font class="campo">Provvedimento Differimento</font>
    </td>
...
<!-- BOTTONE DI STAMPA -->
   ...
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.sospensione.action.ActStampaSospensioneArt47&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&tipo=D"%>"/>
   </jsp:include>
<%}%>
      ...
      <table width="90%">
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActUploadDifferimento">
