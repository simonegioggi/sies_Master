...
<html>
  ...
  <body class="corpo" >
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class=lbg>
         ...
         <font class="campo">Decreto Sospensione pena art. 47 comma 4</font>
        </td>
      </tr>
    </table>
    <br>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciSospensioneArt47">
...
{%>
        ...
        -
        <input type="text" Title="Anno trasmissione " value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getEvento().getDataTrasmissioneAtti(),"yyyy"))%>" name="<%=ICostantiNotifica.CAMPO_ANNO_DATA_INVIO%>" maxlength="4" size="4" onBlur="javascript:value=FillYear(value)">
      </td>
<%}else{%>
