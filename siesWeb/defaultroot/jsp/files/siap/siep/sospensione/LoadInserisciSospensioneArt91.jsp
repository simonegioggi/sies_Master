...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Sospensione art.90 DPR 309/90 </title>
  ...
  <body class="corpo" >
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class=lbg>
         ...
         <font class="campo">Sospensione art.90 DPR 309/90 </font>
        </td>
      </tr>
    </table>
    <br>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciSospensioneArt91">
...
<%if(Cssa!= null && Cssa.getIdCSSA() != null){%>
         <td class="l">
           <input readonly Title="UEPE Competente" name="Indirizzo" value="<%=StringUtils.toStringJSP(Cssa.getComune())%>-<%=StringUtils.toStringJSP(Cssa.getIndirizzo())%>" size=60 >
           <input type="hidden" Title="UEPE Competente" name="<%=ICostantiCSSA.CAMPO_ID_CSSA%>" value="<%=StringUtils.toStringJSP(Cssa.getIdCSSA())%>" size=35 >
...
<%}%>
 ...
 <tr>
  ...
  <%if(decretoordinanza.getCodTipoAutoritaEmittente().equals("UDS")){%>
     <td class="L">
     <%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
      <%--input type="HIDDEN" title="CodiceMagistrato" value="<%=StringUtils.toStringJSP(magistratosorveglianza.getCodMagistrato() )%>" type="text" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS%>"  maxlength="35" size="35" --%>
       <input title="ufficio" value="<%=StringUtils.toStringJSP(decretoordinanza.getDescrLuogoEmittente())%>" type="text" name="<%=ICostantiSospensione.CAMPO_CODICE_MAGISTRATO%>" maxlength="35" size="25">
...
%>
 <tr>
    ...
    <%if(decretoordinanza.getCodTipoAutoritaEmittente().equals("TDS")){%>

       <td class="l" colspan="3"><font class="campo">
        <input Title="Luogo Ufficio Sorveglianza" value="<%=StringUtils.toStringJSP(decretoordinanza.getDescrLuogoEmittente())%>"name="<%=ICostantiSospensione.CAMPO_SEDE_TDS%>" size=35 type="text">
...
<!--autorità di polizia-->
    ...
    <tr>
     ...
     <td class="L">
        ...
        <input title="Sede Autorita Esterna"  value="<%=StringUtils.toStringJSP(autorita.getDescrSede())%>" type="text" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>"  maxlength="35" size="35">
