...
%>
        if (document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value.length==1)
          document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value='0'+document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value;
        if (document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value.length==1)
          document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value='0'+document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value;

  		  var data_to_verifica = document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value+'/'+document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value+'/'+document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiPenaResidua.CAMPO_ANNO_DATA_FINE%>.value;
...
<%
  ...
  {
%>
    if(document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="" && document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
    {
   ...
   if(!document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiCSSA.CAMPO_ID_CSSA%>.disabled)
    {
     cssa = false;
     if(document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiCSSA.CAMPO_ID_CSSA%>.value=="" || document.LoadInserisciSospensioneDecisioniSorv.<%=ICostantiCSSA.CAMPO_ID_CSSA%>.value=="-")
     {
       cssa = true;
     }
    }
...
<%
      ...
      {
       if(misuraalternativa.getCodTipoMisura().equals("2000") || misuraalternativa.getCodTipoMisura().equals("2001"))
       {
%>
...
%>
      ...
      &nbsp; Libero per avvenuta Scarcerazione  &nbsp; <input type="radio" name="tipo" value="scarcerato"  <%=StringUtils.toStringJSP(scarcerato)%> onclick="radio();"></td>
...
<table style="width: 95%;">
  <tr>
    <td class="l" width=30%>Autorità di polizia</td>
    <td class="L" colspan="3">
