...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Sospensione art.90 DPR 309/90 </title>
...
<FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadInserisciSosp">
  ...
  <table>
    <tr>
      ...
      <font class="campo">Dettaglio Sospensione art.90 DPR 309/90 </font>
    </td>
...
<%}%>
<%if(!cssa.getComune().equals("")){%>

 <tr>
     <td class="l" width=30%>UEPE </td>
  <td class="l"><font class="campo"><%=StringUtils.toStringJSP(cssa.getComune())%> - <%=StringUtils.toStringJSP(cssa.getIndirizzo())%>
</font>
</td>
</tr>
<%}%>
...
<%if(autorita != null && autorita.getIdAutoritaEsterna()!=  null){%>
 ...
 <tr>
     <td class="l" width=30%>Autorita competente per Territorio </td>
  <td class="l"><font class="campo"><%=StringUtils.toStringJSP(autorita.getDescrTipoAutorita())%> di <%=StringUtils.toStringJSP(autorita.getDescrSede())%>
</font>
</td>
</tr>
<%}%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActUploadSospensioneArt91">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.sospensione.action.ActLoadDettaglioSospensioneArt91">
          </td>
        </tr>
      </table>
</form>
