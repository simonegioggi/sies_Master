...
<html>
  ...
  <body class="corpo" >
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciNotificheEspulsione">
...
<tr>
 ...
 <tr>
      <td class="Titolo" colspan=6>Comunicazione scadenza termini</td></tr>
...
<%}%>
 ...
 <td class="l">Autorità di polizia </td>
   <td class="L">
    <select  Title="Autorita Pilizia"  class="small" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>">
    <%=autoritaEsterna%>
    </select>
     </td>
</tr>
    <tr>
      <td class="l">Sede</td>
     <td class="L">
<%if(autorita!= null && autorita.getDescrSede() != null){%>
...
<%}else{%>
        <input title="Sede Autorita Esterna" value="" type="text" name="<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE %>"  maxlength="35" size="35">
...
%>
     ...
     <tr>
      <td class="l">Sede </td><td class="L">
        ...
        <a href="Javascript:ListaComuni('f','<%=ICostantiAvvocato.CAMPO_COD_SEDE_AUTORITA_DIF %>');">
          <img src="/images/filefolder.gif" border=0>
        </a>
      </td>
    </tr>
...
%>
  ...
  frmvalidator.addValidation("<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>","req","Il campo Sede Autorità è obbligatorio");
