...
<html>
<head>
<title>[S.I.E.S.] - Dettaglio Sospensione </title>
...
<link rel="STYLESHEET" type="text/css" href="<%=IWebConstants.PG_STYLE%>">
  ...
  <script language="JavaScript">
    function subm(id)
    {
       if(id==2)
      {
       document.LoadInserisciSosp.<%=IWebConstants.ACTION_FIELD%>.value="siap.siep.sospensione.action.ActLoadInserisciSospensioneArt47";
      }
      if(id==3)
      {
       document.LoadInserisciSosp.<%=IWebConstants.ACTION_FIELD%>.value="siap.siep.sospensione.action.ActLoadInserisciSospensioneArt91";
      }
      if(id==1)
      {
       document.LoadInserisciSosp.<%=IWebConstants.ACTION_FIELD%>.value="siap.siep.sospensione.action.ActLoadInserisciSospensionePena";
      }
  ...
  <table cellpadding="5" cellspacing="5" width="95%" onMouseover="over_effect(event,'outset')" onMouseout="over_effect(event,'solid')" onMousedown="over_effect(event,'inset')" onMouseup="over_effect(event,'outset')">
    ...
    <tr>
      <td class="titolo" colspan=3>Stampe Provvedimenti</td>
		...
		<tr>
			<td width="32%" class="menulines" nowrap><a href="javascript:subm(1);">Giudice dell'esecuzione</a></td>
			<td width="32%" class="menulines" nowrap></td>
			<td width="32%" class="menulines" nowrap></td>
     <!-- modifica del 27-06-06 -- dario -- viviana -- a seguito della divisione della maschera di sospensine della pena
      ...
      <!--td width="32%" class="menulines" nowrap><a href="javascript:subm(2);">Sospensione art.47</a></td>
			<td width="32%" class="menulines" nowrap><a href="javascript:subm(3);">Sospensione art.90 DPR 309/90 </a></td-->
		</tr>
  </table>
</form>
  </body>
