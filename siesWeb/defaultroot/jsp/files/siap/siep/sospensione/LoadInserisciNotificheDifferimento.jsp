...
<html>
  ...
  <body class="corpo" >
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.sospensione.action.ActInserisciNotificheDifferimento">
...
<%
//==============================================================================
// Sezione contenete Posizione giuridica e dati della pena
//==============================================================================
%>
...
<%
//==============================================================================
//                  Riepilogo Dati del differimento / rinvio
//==============================================================================
%>  
  <table style="width: 95%;">
    <tr>
      <td colspan ="3" class="titolo">Riepilogo Dati del differimento / rinvio</td>
    </tr>
    <tr>
      <td class="l" >
       Contenuto Decisione
...
<%
//==============================================================================
//                  Decreto Sospensione Esecuzione Pena
//==============================================================================
%>  
  <table width="100%">
    <tr>
      <td class="Titolo" colspan=6>Decreto Sospensione Esecuzione Pena</td>
    </tr>
...
%>
  <tr>
    ...
    <%if(decretoordinanza.getAltraAutorita()!= null ){%>
      <input Title="Luogo Ufficio Sorveglianza" value="<%=StringUtils.toStringJSP(decretoordinanza.getAltraAutorita())%>"name="<%=ICostantiSospensione.CAMPO_SEDE_TDS%>" size=35 type="text">
    <%}else{%>
      <input Title="Luogo Ufficio Sorveglianza" value=""name="<%=ICostantiSospensione.CAMPO_SEDE_TDS%>" size=35 type="text">
    <%}%>
...
<%
//==============================================================================
//                  Ufficiali giudiziari per notifica al difensore
//==============================================================================
%>  
  <tr>
