...
function checkSezioneAltraCausa() {
	...
	if (checkAltraCausa.checked) {
		...
		// 20250326 [SG]: se seleziono altra causa e poi uno dei radio delle MC e poi deseleziono altra causa al salvataggio il sistema
		// rilanciava il messaggio di obbligatorietà "Tipo MIsura"
		var radioTipoAltraCausa = document.getElementsByName('tipoAltraCausa');
		radioTipoAltraCausa[0].checked = true;
	}
}
