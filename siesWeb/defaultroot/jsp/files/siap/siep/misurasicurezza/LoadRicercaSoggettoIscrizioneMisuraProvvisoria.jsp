...
<head>
  ...
  <title> [S.I.E.S.] Load Ricerca Soggetto - Misura Sicurezza Provvisoria </title>
...
<body class="corpo">
  ...
  <FORM method="POST" action="<%= IWebConstants.PG_MAIN%>" name="LoadRicercaSoggMisuraProvv">
    ...
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font> 
        				<font class="campo">Iscrizione Procedimento Esecuzione Misura Sicurezza Applicazione Provvisoria - Ricerca Soggetto</font></td>
      </tr>
    </table>
<br>
<table width="100%" >
      ...
      <tr>
       ...
       <tr>
        ...
        <td class="l">
          ...
          <a href="Javascript:ListaComuni('LoadRicercaSoggMisuraProvv','<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>');">
