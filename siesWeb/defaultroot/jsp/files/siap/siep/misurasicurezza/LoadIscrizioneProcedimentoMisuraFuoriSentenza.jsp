...
<jsp:useBean id="provvedimento" scope="request" class="siap.sius.depositoordinanzapc.model.DepositoOrdinanzaPcModel" />
<jsp:useBean id="evento"    scope="request" class="siap.sico.evento.model.EventoModel" />
<jsp:useBean id="misura"    scope="request" class="siap.siep.misurasicurezza.model.MisuraSicurezzaModel"/> 
...
<jsp:useBean id="VectipoMisuraSicurezza"   scope="request" class="java.util.Vector"/>
...
<html>
<head>
  <title> Gestione Misure Sicurezza disposte Fuori Sentenza- Iscrizione Procedimento  </title>
...
/***************************PROVVEDIMENTO (sentenza)*********************************************************/
 ...
 /*************************** DATE ISCRIZIONE e ARRIVO ATTO *********************************************************/
	...
	return lRitorno;
      ...
      <body class="corpo" onload="javascript:caricaComboMod(strOggetto,';','#',document.LoadInserisciSentenza.<%= ICostantiMisuraSicurezza.CAMPO_COD_NATURA %>.value, document.LoadInserisciSentenza.<%= ICostantiMisuraSicurezza.CAMPO_COD_TIPO %>);" >
  ...
  <table>
    <tr>
      ...
      <td class="LBG">
        ...
        <font class="campo">Iscrizione Procedimento Esecuzione Misura Sicurezza Fuori Sentenza  </font>
      </td>
    </tr>
  </table>
...
<FORM method="POST" action="Main.jsp" name="LoadInserisciSentenza">
    ...
    <input type="hidden" name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_ID_DEPOSITO_ORDINANZA_PC %>" value="<%=idordinanza%>" >
...
<%
 ...
 %>  
      <input type="hidden" name="<%=ICostantiFascicoloSius.CAMPO_ID_FASCICOLO_SIUS %>" value="<%=evento.getFasSiuIdFascicoloSius() %>" >
...
<table cellspacing=2 cellpadding=2 width="90%">
  ...
  <tr>
    ...
    <td class="L">
      <input Title="Data Provv" type="text" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(provvedimento.getDataCameraConsiglio(),"dd") ) %>" 
      ...
      <input Title="Data Provv" type="text" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(provvedimento.getDataCameraConsiglio(),"MM")) %>" 
          name="<%= ICostantiSentenza.CAMPO_MESE_DATA_PROVVEDIMENTO %>" 
          maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> - 
      <input Title="Data Provv" type="text" value="<%=StringUtils.toStringJSP( DateUtils.getDateToString(provvedimento.getDataCameraConsiglio(),"yyyy")) %>" 
    ...
    <td class="L">
      <input Title="Anno Provv" value="<%=StringUtils.toStringJSP(provvedimento.getAnnoS3(),"") %>" 
             type="text" name="<%= ICostantiSentenza.CAMPO_ANNO_SENTENZA %>" maxlength="4" size="4"
             onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)"
             > /
      <input Title="Numero Provv" value="<%=StringUtils.toStringJSP(provvedimento.getNumS3(),"") %>" type="text" name="<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA %>" maxlength="6" size="6">
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="L">
      <input Title="Luogo Emittente" name="<%=ICostantiSentenza.CAMPO_COD_LUOGO_EMITTENTE%>" value="<%=StringUtils.toStringJSP(evento.getDescrLuogoEmittente() ,"")%>" type="text" maxlength="35" size="35"> 
  ...
  <tr><td class="Titolo" colspan=4>Misura Sicurezza</td></tr>
   <tr>
    ...
    <tr>
        ...
        <td class="l">
          <select title="Tipo Misura" name="<%= ICostantiMisuraSicurezza.CAMPO_COD_TIPO %>"></select>
        </td>
    </tr>
    <tr>
        ...
        <td class="l">Anni
          <input title="Anni" size=2 maxlength=2 value="<%=StringUtils.toStringJSP(misura.getNumAnni(),"")%>" type="text" name="<%= ICostantiMisuraSicurezza.CAMPO_NUM_ANNI %>"  onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
          Mesi
          <input title="Mesi" size=2 maxlength=2 value="<%=StringUtils.toStringJSP(misura.getNumMesi(),"") %>" type="text" name="<%= ICostantiMisuraSicurezza.CAMPO_NUM_MESI%>"  onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
          Giorni
          <input title="Giorni" size=2 maxlength=2 value="<%=StringUtils.toStringJSP(misura.getNumGiorni(), "") %>" type="text" name="<%= ICostantiMisuraSicurezza.CAMPO_NUM_GIORNI %>"  onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)">
        </td>
    </tr>
    <tr>
     <td class="l">Luogo Esecuzione Misura</td>
     <td class="L">
      <textarea name="<%=ICostantiMisuraSicurezza.CAMPO_LUOGO_ESECUZIONE_MISURA %>" rows="2" cols="80"><%=StringUtils.toStringJSP(lLuogoEsec ,"")%></textarea>
	 </td>
	</tr>     	 
</table> 
...
<table cellspacing=2 cellpadding=2 width="90%">
  <tr><td class="Titolo" colspan=2>Provvedimento da Eseguire</td></tr>
  <% if ("N".equals(EsisteFascicoloClasseIVAnnoCorrente) ){ %>
  <tr>
  ...
  <tr>
    ...
    <td class="L">
      <input Title="Data Iscrizione" type="text" value="" name="<%= ICostantiSentenza.CAMPO_GIORNO_DATA_ISCRIZIONE %>"
          maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> - 
      <input Title="Data Iscrizione" type="text" value="" name="<%= ICostantiSentenza.CAMPO_MESE_DATA_ISCRIZIONE %>" 
          maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> - 
      <input Title="Data Iscrizione" type="text" value="" name="<%= ICostantiSentenza.CAMPO_ANNO_DATA_ISCRIZIONE %>"
          maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
    </td>
  </tr>
  <tr>
    ...
    <td class="L">
      <input Title="Data arrivo atto" type="text" value="" name="<%= ICostantiSentenza.CAMPO_GIORNO_DATA_ARRIVO_ATTO %>"
          maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> - 
      <input Title="Data arrivo atto" type="text" value="" name="<%= ICostantiSentenza.CAMPO_MESE_DATA_ARRIVO_ATTO %>" 
          maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> - 
      <input Title="Data arrivo atto" type="text" value="" name="<%= ICostantiSentenza.CAMPO_ANNO_DATA_ARRIVO_ATTO %>"
          maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
    </td>
  </tr>
  <% if ("N".equals(EsisteFascicoloClasseIVAnnoCorrente) ){ %>
