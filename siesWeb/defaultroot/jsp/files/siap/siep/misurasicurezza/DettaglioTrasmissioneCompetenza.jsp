  ...
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
        <font class="campo">DETTAGLIO TRASMISSIONE PER COMPETENZA ESECUZIONE MISURE DI SICUREZZA</font>
      </td>
      ...
      <%if(   !"S".equalsIgnoreCase(eventonotifica.getEvento().getFlagDocumentoRegistrato())
       ...
       { %>
        ...
        <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
          <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misurasicurezza.action.ActStampaTrasmissioneCompetenza&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
        </jsp:include>
      <%} %>
...
<table>   
  ...
  <table width=90%>
    <!--  UFFICIO COMPETETNTE  -->
    <tr>
      <td class="Titolo" colspan="2">Ufficio Competente all'Emissione del Provvedimento</td>
    </tr>
    ...
    %>
      ...
      <tr>
        ...
        <td class="L">
          ...
          di
          <font class="campo"><%=StringUtils.toStringJSP(lNotifica.getIstitutoDetenzione().getDescrComune())%>
                        &nbsp;<%=StringUtils.toStringJSP(lNotifica.getIstitutoDetenzione().getIndirizzo())%></font>
          <% %>
        </td>
      </tr>
      <% } %>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misurasicurezza.action.ActUploadTrasmissioneCompetenza">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>"  value="<%= eventonotifica.getEvento().getIdEvento() %>">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>"  value="siap.siep.misurasicurezza.action.ActLoadDettaglioTrasmissioneCompetenza">
          </td>
        </tr>
      </table>
    </FORM>
