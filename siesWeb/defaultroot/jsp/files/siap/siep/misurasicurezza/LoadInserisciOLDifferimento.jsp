...
<jsp:useBean id="ordinanza"				scope="request" class="siap.sius.depositoordinanzapc.model.OrdinanzaEventoTenoriFascicoloSiusModel"/>
...
<%
if (ordinanza != null && Utils.isNullObj(ordinanza.getEvento())) {
%>
...
<%
	...
	if (provvedimento.getOrdinanza() != null) {
		if (provvedimento.getOrdinanza().getDataFineMisura() != null) {
			gdfm = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataFineMisura(), "dd"));
			mdfm = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataFineMisura(), "MM"));
			adfm = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataFineMisura(), "yyyy"));
		}
		aass = StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(provvedimento.getOrdinanza().getSospensioneAASS()),"");
		mmss = StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(provvedimento.getOrdinanza().getSospensioneMMSS()),"");
		ggss = StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(provvedimento.getOrdinanza().getSospensioneGGSS()),"");
		lsdp = StringUtils.toStringJSP(provvedimento.getOrdinanza().getLuogoSvolgimentoProva(),"-");
		if (provvedimento.getOrdinanza().getDataInizioPeriodo() != null) {
			gdip = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataInizioPeriodo(), "dd"));
			mdip = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataInizioPeriodo(), "MM"));
			adip = StringUtils.toStringJSP(DateUtils.getDateToString(provvedimento.getOrdinanza().getDataInizioPeriodo(), "yyyy"));
		}
	}
%>
		<table style="width: 95%;">
...
<%
	...
	if (ordinanza != null && ordinanza.getEvento() != null && ordinanza.getFascicoloSiusModel() != null
			&& ordinanza.getOrdinanza() != null) {
...
%>
		<table style="width: 95%;"> 
			...
			<tr>
				<td class="l">
      				<input type="hidden" name="idEventoFascSius" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getIdEvento())%>">
      				<input type="hidden" name="<%=ICostantiFascicoloSius.CAMPO_ID_FASCICOLO_SIUS%>" value="<%=StringUtils.toStringJSP(ordinanza.getFascicoloSiusModel().getIdFascicoloSius())%>">
<!--         			<a href="Javascript:listaProvvSIUS('LoadInsOLDifferimento');"> -->
<!--           				Seleziona provvedimento di Sorveglianza dalla lista <img src="/images/filefolder.gif" border="0"> -->
<!--         			</a> -->
				</td>
		...
		<table style="width: 95%;">
			<tr>
		    	<td class="l" width="21%">Autorita' Emittente<font class="ob">(*)</font></td>
		    	<td class="l">
		    		<input type="hidden" name="<%=ICostantiFascicoloSius.CAMPO_CHIAVE_UFFICIO%>" value="<%=StringUtils.toStringJSP(ordinanza.getFascicoloSiusModel().getChiaveUfficio())%>">
		    		<input type="hidden" name="<%=ICostantiEvento.CAMPO_COD_UFFICIO_EMITTENTE%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getCodUfficioEmittente())%>">
		    		<input Title="Autorita' Emittente" type="text" name="descrTipoUfficio" value="<%=StringUtils.toStringJSP(ordinanza.getDescrTipoUfficio())%>" size="35" readonly>
<%-- 		    		<select Title="Autorita' Emittente" name="<%=ICostantiEvento.CAMPO_COD_UFFICIO_EMITTENTE%>"> --%>
<%--         				<%=autorita%> --%>
<!--       				</select> -->
		      	</td>
		      	<td class="l">Sede<font class="ob">(*)</font></td>
		      	<td class="l">	
		        	<input type="hidden" name="<%=ICostantiEvento.CAMPO_COD_LUOGO_EMITTENTE%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getCodLuogoEmittente())%>">
		        	<input title="Sede Autorita' Emittente" type="text" name="descrComuneUfficio" value="<%=StringUtils.toStringJSP(ordinanza.getDescrComuneUfficio())%>" size="35" readonly>
<%--         			<a href="Javascript:ListaUfficiComuni('LoadInsOLDifferimento','<%=ICostantiEvento.CAMPO_COD_LUOGO_EMITTENTE%>', --%>
<%--         					document.LoadInsOLDifferimento.<%=ICostantiEvento.CAMPO_COD_UFFICIO_EMITTENTE%>[document.LoadInsOLDifferimento.<%=ICostantiEvento.CAMPO_COD_UFFICIO_EMITTENTE%>.options.selectedIndex].value);"> --%>
<!--           				<img src="/images/filefolder.gif" border="0"> -->
<!--         			</a> -->
		...
		<table style="width: 95%;">
    		<tr>
        		<td class="l" width="21%">Data Emissione Provvedimento<font class="ob">(*)</font></td>
        		<td class="L">
          			<input Title="Giorno Emissione Provvedimento" name="<%=ICostantiFascicoloSius.CAMPO_GIORNO_DATA_ARRIVO%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getEvento().getDataEmissione(), "dd"))%>" type="text" size="2" readonly> -
          			<input Title="Mese Emissione Provvedimento" name="<%=ICostantiFascicoloSius.CAMPO_MESE_DATA_ARRIVO%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getEvento().getDataEmissione(), "MM"))%>" type="text" size="2" readonly> -
          			<input Title="Anno Emissione Provvedimento" name="<%=ICostantiFascicoloSius.CAMPO_ANNO_DATA_ARRIVO%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getEvento().getDataEmissione(), "yyyy"))%>" type="text" size="4" readonly>
        		</td>
        		<td class="l">Anno / Numero Fascicolo SIUS</td>
       			<td class="L">
         			<input Title="Anno Fascicolo SIUS" name="<%=ICostantiFascicoloSius.CAMPO_CHIAVE_ANNO%>" value="<%=StringUtils.toStringJSP(ordinanza.getFascicoloSiusModel().getChiaveAnno())%>" type="text" size="4" readonly> /
         			<input Title="Numero Fascicolo SIUS" name="<%=ICostantiFascicoloSius.CAMPO_CHIAVE_PROGR%>" value="<%=StringUtils.toStringJSP(ordinanza.getFascicoloSiusModel().getChiaveProgr())%>" type="text" size="6" readonly>
      			</td>
     		</tr>
     		<tr>
     			<td class="l">Tipo Provvedimento<font class="ob">(*)</font></td>
        		<td class="L">
        			<input type="hidden" name="<%=ICostantiEvento.CAMPO_COD_TIPO_PROVVEDIMENTO%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getCodTipoProvvedimento())%>">
        			<input title="Tipo Provvedimento" type="text" name="descrProvvedimento" value="<%=StringUtils.toStringJSP(ordinanza.getDescrProvvedimento())%>" size="70" readonly>
<%--         			<select title="Tipo Provvedimento" name="<%=ICostantiEvento.CAMPO_COD_TIPO_PROVVEDIMENTO%>"> --%>
<%--           				<%=tipoprovvedimento%> --%>
<!--           			</select> -->
        		</td>
      			<td class="l">Anno / Numero Provvedimento</td>
      			<td class="L">
         			<input Title="Anno Provvedimento" name="<%=ICostantiEvento.CAMPO_ANNO_PROTOCOLLO%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getAnnoProtocollo())%>" type="text" size="4" readonly> /
         			<input Title="Numero Provvedimento" name="<%=ICostantiEvento.CAMPO_PROGR_PROTOCOLLO%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getProgrProtocollo())%>" type="text" size="6" readonly>
      			</td>        
   			</tr>
			<!-- Definizione procedimento -->
			<tr>
				<td class="L">Oggetto<font class="ob">(*)</font></td>
			   	<td class="L" colspan="3">
			   		<input type="hidden" name="<%=ICostantiEvento.CAMPO_COD_MOTIVO%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getCodMotivo())%>">
			   		<input title="Oggetto Procedimento" type="text" name="descrOggetto" value="<%=StringUtils.toStringJSP(ordinanza.getDescrOggetto())%>" size="100" readonly>
<%-- 			   		<select title="Oggetto Procedimento" name="<%=ICostantiEvento.CAMPO_COD_MOTIVO%>"> --%>
<%--           				<%=mp%> --%>
<!--           			</select> -->
				</td>
			...
			<tr>
				<td class="L">Esito<font class="ob">(*)</font></td>
			   	<td class="L" colspan="3">
			   		<input type="hidden" name="<%=ICostantiEvento.CAMPO_COD_ESITO%>" value="<%=StringUtils.toStringJSP(ordinanza.getEvento().getCodEsito())%>">
					<input title="Esito Provvedimento" type="text" name="descrEsito" value="<%=StringUtils.toStringJSP(ordinanza.getDescrEsito())%>" size="100" readonly>
<%-- 					<select title="Esito Provvedimento" name="<%=ICostantiEvento.CAMPO_COD_ESITO%>"> --%>
<%--           				<%=et%> --%>
<!--           			</select> -->
				</td>
		...
		<table style="width: 95%;">
			<tr>
				<td class="L">Data Fine Rinvio</td>
				<td class="L" nowrap="nowrap">
			 		<input title="Giorno Data Fine Rinvio" type="text" size="2" name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_FINE_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getOrdinanza().getDataFineMisura(),"dd"))%>" readonly> -
					<input title="Mese Data Fine Rinvio" type="text" size="2" name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_MESE_DATA_FINE_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getOrdinanza().getDataFineMisura(),"MM"))%>" readonly> -
					<input title="Anno Data Fine Rinvio" type="text" size="4" name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_ANNO_DATA_FINE_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(ordinanza.getOrdinanza().getDataFineMisura(),"yyyy"))%>" readonly>
<%-- 					<a href="Javascript:impostaDataOdierna('<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_FINE_MISURA%>','<%=ICostantiDepositoOrdinanzaPc.CAMPO_MESE_DATA_FINE_MISURA%>','<%=ICostantiDepositoOrdinanzaPc.CAMPO_ANNO_DATA_FINE_MISURA%>', '<%=DateUtils.getSysDate("dd/MM/yyyy")%>');"> --%>
<!-- 						<img src="/images/Calendar2.png" border="0" height="20" width="20" align="top" title="Imposta data odierna"> -->
<!-- 			        </a> -->
			   	</td>
			   	<td class="L">oppure Durata:</td>
				<td class="L" nowrap="nowrap">
			 		&nbsp;Anni&nbsp;<input type="text" size="2" name="numAnniSospensione" value="<%=StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(ordinanza.getOrdinanza().getSospensioneAASS()),"")%>" readonly> -
					&nbsp;Mesi&nbsp;<input type="text" size="2" name="numMesiSospensione" value="<%=StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(ordinanza.getOrdinanza().getSospensioneMMSS()),"")%>" readonly> -
					&nbsp;Giorni&nbsp;<input type="text" size="4" name="numGiorniSospensione" value="<%=StringUtils.toZerotoStringaVuota(StringUtils.toStringJSP(ordinanza.getOrdinanza().getSospensioneGGSS()),"")%>" readonly>
					&nbsp;oppure&nbsp;Fino alla Decisione del TDS&nbsp;
					<input type="checkbox" name="flagDecisioneTribunale" title="Decisione TDS" onclick="this.checked=!this.checked;" readonly>
			   	</td>
			</tr>
...
<%-- <% --%>
<%-- 		if (Utils.isPresent(provvedimento) && Utils.isPresent(provvedimento.getOrdinanza())) {
<%-- 			if (provvedimento.getOrdinanza().getDataInizioPeriodo() != null) {
<%-- %> --%>
<%-- 				document.LoadInsOLDifferimento.eseguita[0].checked = false;
<%-- 				document.LoadInsOLDifferimento.eseguita[1].checked = true;
<%-- 				document.getElementById("rigaDataDiff").style.display = "block";
<%-- 	    		document.getElementById("rigaScarcerazione").style.display = "none";
<%-- <% --%>
<%-- 			} else {
<%-- %> --%>
<%-- 				document.LoadInsOLDifferimento.eseguita[0].checked = true;
<%--				document.LoadInsOLDifferimento.eseguita[1].checked = false;
<%-- 				document.getElementById("rigaDataDiff").style.display = "none";
<%-- 				document.getElementById("rigaScarcerazione").style.display = "block";
<%-- <% --%>
<%-- 			}
