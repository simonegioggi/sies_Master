...
%>
<!-- DettaglioArchiviazionePerProvvGEsecuzione -->
<html>
<head>
  <title>[S.I.E.S.] - Gestione Misure sicurezza- Archiviazione per Provvedimento G.E.</title>
  ...
  <table>
    <tr>
      ...
      <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
      	<font class="campo">Dettaglio Definizione Procedimento - Archiviazione per Provvedimento del G.E.</font>
      </td>
...
<!-- BOTTONE DI VALIDAZIONE -->
     <td class="LBG">
       <a href="/jsp/Main.jsp?Action=siap.siep.misurasicurezza.action.ActUploadAnnotazioneDecisioneDellaSorveglianza&IdEvento=<%=eventonotifica.getEvento().getIdEvento()%>&<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>=siap.siep.misurasicurezza.action.ActDettaglioArchiviazionePerProvvGEsecuzione&IdEvento=<%=eventonotifica.getEvento().getIdEvento()%>&<%=ICostantiEvento.CAMPO_VALIDA%>=S&noblob=S">
...
<!-- 	ICONA DI MODIFICA	 -->
	<td class="LBG">
	  <a href="Main.jsp?Action=siap.siep.misurasicurezza.action.ActLoadModificaArchiviazionePerProvvGEsecuzioneMS&IdEvento=<%=eventonotifica.getEvento().getIdEvento()%>&TornaQui=10">
...
<%				}
				else if(eventonotifica.getNotifiche()[i].getCodTipoNotifica().compareTo("NG")== 0)
				{ %>
					<tr>
				     	<td class="l" width="30%">Giudice Esecuzione </td>
			         	<td class="L" colspan=2 width="60%">
			            	<font class="campo"><%=StringUtils.toStringJSP( eventonotifica.getNotifiche()[i].getUfficio().getDescrTipoUfficio()) %>
			            	</font>&nbsp;
							di 
...
%>
				   		<tr>
			    			<td class="l" width="30%">Note</td>
			    			<td class="L" colspan="2" width="60%"><font class="campo"><%=StringUtils.toStringJSP(eventonotifica.getNotifiche()[i].getNote())%></font>&nbsp;</td>
				   		</tr>			        
<% 	
					}
				}
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misurasicurezza.action.ActDettaglioArchiviazionePerProvvGEsecuzione">
          </td>
        </tr>
      </table>
</form>
