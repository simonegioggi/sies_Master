...
%>
<!-- LoadInserisciOEInternamento -->
<html>
  <head>
    <title>[S.I.E.S.] -Gestione Misure sicurezza- Richiesta O.E. per Internamento (esecuzione M.S.)</title>
...
<body class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Emissione Ordine di Esecuzione per Internamento</font>
      </td>
    </tr>
  </table>
  <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misurasicurezza.action.ActInserisciOEInternamento">
    <table>
      <tr>
...
<tr><td class="Titolo" colspan=6>Destinatari per Esecuzione</td></tr>
	...
	<!-- Notifica per ESECUZIONE - Istituto di detenzione-->
	<tr>	
		<td class="L"> Istituto di detenzione</td>
	<%
		if (lLuogoDetenzione == null
		|| lLuogoDetenzione.getIstDetIdIstitutoDetenzione() == null
		|| lLuogoDetenzione.getIstDetIdIstitutoDetenzione().equals("")
		|| lLuogoDetenzione.getIstDetIdIstitutoDetenzione().equals("-")) {
	%>
		<td class="l" colspan="3">
	...
	<%
		...
		// Precaricato con l'istutito di detenzione attuale se presente
		if (codposizione.equals("01")
				|| codposizione.equals("03")
				|| codposizione.equals("22")
				|| codposizione.equals("24")
				// internato
				|| codposizione.equals("09")) {
%>
			<td class="l" colspan="3">
