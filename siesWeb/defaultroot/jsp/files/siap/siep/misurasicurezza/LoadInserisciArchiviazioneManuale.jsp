...
<%
//==============================================================================
//Form per inserimento di Archiviazione Manuale Misure Sicurezza 
//==============================================================================
...
%>
<!--          LoadInserisciArchiviazioneManuale         -->
<html>
  <head>
    ...
    <script language="JavaScript">
      ...
      function Difensore()
      {
          ...
          if( document.LoadArchiviazioneMan.Difesa.checked )
       	  { 
         		nodequan.style.display='block';
         		
     	        <% if (avvocati.size()==1) {%>
          		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.disabled=false;
         			document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1;
             		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.disabled=false;
             		document.LoadArchiviazioneMan.<%=ICostantiNotifica.CAMPO_NOTE%>.disabled=false;
        	    <% } else { %>
      	      	for (var i=0; i< <%=avvocati.size()%>; i++){ 
	            		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].disabled=false;
	    				document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1;
	               		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].disabled=false;
	               		document.LoadArchiviazioneMan.<%=ICostantiNotifica.CAMPO_NOTE%>[i].disabled=false;
					}
 	   	     <% } %>
     	  }
          else
          {
          	nodequan.style.display='none';
     	        ...
     	        <% if (avvocati.size()==1) {%>
	        		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value="";
	        		document.LoadArchiviazioneMan.<%=ICostantiNotifica.CAMPO_NOTE%>.value="";
      				document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1;
        	    <% } else { %>
 	      			for (var i=0; i< <%=avvocati.size()%>; i++){ 
		        		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value="";
		        		document.LoadArchiviazioneMan.<%=ICostantiNotifica.CAMPO_NOTE%>[i].value="";
	    				document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1;
					}
 	   	     <% } %>
          }
  	...
  	function AutEsterna()
    {
          ...
          if( document.LoadArchiviazioneMan.SiNoTe.checked )
       	{ 
    ...
    function pulisciIstituto (nomeCampoComune, nomeCampoId)
    {
      ...
      function Verify()
      {
		...
		// CONTROLLO DATA DEFINIZIONE
	  	if (document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value.length==1)
		  	document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value='0'+document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value;
	  	if (document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_MESE_DATA_DEFINIZIONE%>.value.length==1)
		  	document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_MESE_DATA_DEFINIZIONE%>.value='0'+document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_MESE_DATA_DEFINIZIONE%>.value;

	  	var data_to_verify = document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value+'/'+document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_MESE_DATA_DEFINIZIONE%>.value+'/'+document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_ANNO_DATA_DEFINIZIONE%>.value;
        ...
        if( !CompareDate( data_to_verify, data_sistema) )
        {
          ...
          document.LoadArchiviazioneMan.<%=ICostantiMisuraSicurezza.CAMPO_GIORNO_DATA_DEFINIZIONE%>.focus();
          return false;
        }

        if(document.LoadArchiviazioneMan.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="" && document.LoadArchiviazioneMan.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
        {
          alert("Il Magistrato è obbligatorio");
          document.LoadArchiviazioneMan.<%=ICostantiMagistrato.CAMPO_COGNOME %>.focus();
          return false;
        }
        ...
        if ( ((penaresidua.getFlagErgastolo() == null) || (penaresidua.getFlagErgastolo() != null && !penaresidua.getFlagErgastolo().equals("S") && !penaresidua.getFlagErgastolo().equals("D"))))
        {
            ...
            {
        %>
              if (document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value.length==1)
                document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value='0'+document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value;
              if (document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value.length==1)
                document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value='0'+document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value;
        
              var data_to_verifica = document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.value+'/'+document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_MESE_DATA_FINE%>.value+'/'+document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_ANNO_DATA_FINE%>.value;
    
              if (!ControllaData(data_to_verifica) )
              {
                alert('Data fine pena non valida');
                document.LoadArchiviazioneMan.<%=ICostantiPenaResidua.CAMPO_GIORNO_DATA_FINE%>.focus();
                return false;
              }
    <%
          }
...
%>
		...
		if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.value != "-" )
		{
			if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.value == "" )
			{
				alert('ERRORE : Inserire Sede Destinatario');
				document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.focus();
				return false;
			}	
		}
		...
		if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.value != "" )
		{
			if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.value == "-" )
			{
				...
				document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.focus();
				return false;
			}	
		}
		...
		{
		       <% if (avvocati.size()==1) {%>
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value == "-" 
					&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value == "" )
					{
						alert('Attenzione : Inserire Dati Destinatario notifica Difensore ');
		      			document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.focus();
			 			return false;		
					}
		
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1
						&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value == "" )
					{
						alert('Attenzione : Inserire la Sede Destinatario notifica Difensore ');
		      			document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.focus();
			 			return false;		
					}
		
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value != ""
						&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value == "-" )
					{
			   ...
			   <% } else { %>
			    for (var i=0; i< <%=avvocati.size()%>; i++) { 
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value == "-" 
						&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value == "" )
					{
						alert('Attenzione : Inserire Dati Destinatario notifica Difensore '+i);
		      			document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].focus();
			 			return false;		
					}
		
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1
					&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value == "" )
					{
						alert('Attenzione : Inserire la Sede Destinatario notifica Difensore ');
		      			document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].focus();
		      			bloccaUNEP();
			 			return false;		
					}
		
					if(document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value != ""
						&& document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value == "-" )
					{
						alert('Attenzione : Inserire il tipo di  Destinatario notifica Difensore  ');
			          	document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].focus();
					 	return false;		
		...
		if( document.LoadArchiviazioneMan.SiNoTe.checked ) {
		       <% if (avvocati.size()==1) {%>
					document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value = "-";
		    		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=0;
		    		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value='C0';
					var codAut=document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value;
					var indAut=document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex;
		  <% } else { %>
			    for (var i=0; i< <%=avvocati.size()%>; i++) { 
					document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value = "-";
		    		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=0;
		    		document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value='C0';
					var codAut2=document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value;
					var indAut2=document.LoadArchiviazioneMan.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex;
				}
		<%	} %>
		}
		else
		...
		if(document.LoadArchiviazioneMan.tipoUDS.value != "-")
		{
			if(document.LoadArchiviazioneMan.<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>.value == "")
			{
				alert(' Inserire Sede Destinatario Sorveglianza');
				document.LoadArchiviazioneMan.<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>.focus();
				return false;
			}	
		}
...
<body class="corpo">
  <table>
    <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
      <td class="LBG">
        ...
        <font class="campo">Definizione Procedimento - Archiviazione Manuale</font>
      </td>
    </tr>
  </table>
  <br>
  ...
  <br>
  <FORM method="POST" name="LoadArchiviazioneMan" action="<%= IWebConstants.PG_MAIN%>">
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misurasicurezza.action.ActInserisciArchiviazioneManuale">
  ...
  <tr>
    ...
    <td class="L" colspan="3">
     ...
     <input readonly title= "Nome Magistrato"    value="<%=StringUtils.toStringJSP(magistrato.getMagistrato().getNome() )%>" type="text" name="<%= ICostantiMagistrato.CAMPO_NOME %>"        maxlength="35" size="35">
       <a href="Javascript:ListaMagistrati('LoadArchiviazioneMan');">
	    	...
	    	<td class="l" width="20%">Struttura Designata</td> 
	     	<td class="l" colspan="3">
	      		...
	      		<input type="hidden"  Title="Istituto" name="<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" value="<%= posizioneluogoaltra.getLuogoDetenzione().getIstDetIdIstitutoDetenzione()%>" size=90>
	      			<a href="Javascript:ListaIstitutoDetenzione('LoadArchiviazioneMan','<%= ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>','Comune');">
...
<%	} %>		
		...
		<tr>
			...
			<td class="L">
				<select Title="Autorita Esterna" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>"> <%=autoritaEsternaE%> </select>
			</td>
			<td class="l">Note</td>
		...
		<tr>
			...
			<td class="L"><input title="Sede Autorita Esterna" value="" type="text" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>" size="35"> 
				<a href="Javascript:ListaComuni('LoadArchiviazioneMan','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>');"> 
				<img src="/images/filefolder.gif" border=0>
				</a>
			</td>
		</tr>
	...
	<tr>
	    ...
	    <td class="L">
	      ...
	      <a href="Javascript:ListaUfficiComuni('LoadArchiviazioneMan','<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>'
	                                           ,document.LoadArchiviazioneMan.tipoUDS[document.LoadArchiviazioneMan.tipoUDS.options.selectedIndex].value);">
	         <img src="/images/filefolder.gif" border=0>
	      </a> 
	    </td>
  </tr>   
...
<div id="divq" style="display: none; position: relative; width: 90%;">
  ...
  %>
      <table width="90%">
       ...
       <%	if(avvocati.size()>1)
			{	%>              
              <a href="Javascript:ListaComuni('LoadArchiviazioneMan','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[<%=lIdxAvv%>]');">
                <img src="/images/filefolder.gif" border=0>
              </a>
       <%	}
       		else
       		{	%>
              <a href="Javascript:ListaComuni('LoadArchiviazioneMan','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>');">
                <img src="/images/filefolder.gif" border=0>
              </a>
       <%	} %>              		       
          </td>
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadArchiviazioneMan");
