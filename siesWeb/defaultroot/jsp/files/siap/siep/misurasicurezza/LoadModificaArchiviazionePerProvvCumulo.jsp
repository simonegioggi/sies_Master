...
<%-- MEV_39: aggiunta pagina di caricamento per aggiornamento archiviazione per provvedimento di cumulo --%>
...
<jsp:useBean id="tipoAltraAutorita" 	scope="request" class="java.lang.String"/>
<jsp:useBean id="tipoUfficio"     		scope="request" class="java.lang.String"/>
<jsp:useBean id="codSedeUffRecCred"		scope="request" class="java.lang.String"/>
<jsp:useBean id="descSedeUffRecCred"	scope="request" class="java.lang.String"/>
<jsp:useBean id="codSedeAutPol"			scope="request" class="java.lang.String"/>
<jsp:useBean id="descSedeAutPol"		scope="request" class="java.lang.String"/>
<jsp:useBean id="indAutPol"				scope="request" class="java.lang.String"/>
<jsp:useBean id="codSedeTDS"			scope="request" class="java.lang.String"/>
<jsp:useBean id="descSedeTDS"			scope="request" class="java.lang.String"/>
<jsp:useBean id="codSedeUDS"			scope="request" class="java.lang.String"/>
<jsp:useBean id="descSedeUDS"			scope="request" class="java.lang.String"/>
<jsp:useBean id="codSedeAltraAut"		scope="request" class="java.lang.String"/>
<jsp:useBean id="descSedeAltraAut"		scope="request" class="java.lang.String"/>
<jsp:useBean id="indAltraAut"			scope="request" class="java.lang.String"/>
<jsp:useBean id="descAltraAut"			scope="request" class="java.lang.String"/>
<jsp:useBean id="codUfficioUtente"    	scope="request" class="java.lang.String"/>

<%
//===================================================================================================
// Form per aggiornamento di Archiviazione per Provvedimento di cumulo
//====================================================================================================
...
<!-- LoadModificaArchiviazionePerProvvCumulo -->
<html>
  	<head>
    <link rel="STYLESHEET" type="text/css" href="<%=IWebConstants.PG_STYLE%>">
    <title>[S.I.E.S.] - Aggiornamento Archiviazione per Provvedimento di Cumulo</title>
	...
	function ListaUDS(a_formname,a_fieldname) {
   	...
   	function radio() {
        ...
        if(document.ArchiviazionePC.codComuneCumulo.value == document.ArchiviazionePC.codUfficioUtente.value){
...
<%-- 		if (document.ArchiviazionePC.<%=ICostantiArchiviazione.CAMPO_COD_OGGETTO_DEFINIZIONE%>[0].checked) {
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misurasicurezza.action.ActModificaArchiviazionePerProvvCumulo">
...
<%
	...
	if (!lPosizione.isLibero()
			|| (fascicolosiep.getFlagAltraCausa() != null
				&& "S".equals(fascicolosiep.getFlagAltraCausa()))) {
		if (penaresidua.getFlagErgastolo() == null
...
%>
		<tr>
        	...
        	<td class="L">
          		<input value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getEvento().getDataTrasmissioneAtti(), "dd"))%>" type="text" size="2" maxlength="2" name="<%=ICostantiNotifica.CAMPO_GIORNO_DATA_INVIO%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
          		<input value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getEvento().getDataTrasmissioneAtti(), "MM"))%>" type="text" size="2" maxlength="2" name="<%=ICostantiNotifica.CAMPO_MESE_DATA_INVIO%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
          		<input value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(eventonotifica.getEvento().getDataTrasmissioneAtti(), "yyyy"))%>" type="text" size="4" maxlength="4" name="<%=ICostantiNotifica.CAMPO_ANNO_DATA_INVIO%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
        	</td>
    	</tr>
  	</table>
 	<br>
	<!--  Definizione Procedimento -->
  	<table cellspacing=0 cellpadding=0 width="95%">
    	...
    	<tr>
     		<td class="l" colspan="2">
<%
if (eventonotifica.getEvento() != null && "1153".equals(eventonotifica.getEvento().getCodMotivo())) {
%>
...
%>
    	...
    	<tr>
      		...
      		<td class="l">
        		<input type="text" Title="Giorno cumulo" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(fascicolosiep.getDataUnione(), "dd"))%>" name="<%=ICostantiFascicoloSiep.CAMPO_GIORNO_UNIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" readonly="readonly">
        		/
        		<input type="text" Title="Mese cumulo" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(fascicolosiep.getDataUnione(), "MM"))%>" name="<%=ICostantiFascicoloSiep.CAMPO_MESE_UNIONE%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" readonly="readonly">
        		/
        		<input type="text" Title="Anno cumulo" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(fascicolosiep.getDataUnione(), "yyyy"))%>" name="<%=ICostantiFascicoloSiep.CAMPO_ANNO_UNIONE%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)" readonly="readonly">
      		</td>
    	</tr>
	</table>
	...
	<table cellspacing=0 cellpadding=0 width="95%">
		<tr>
     		<td class="l" width="25%">Ufficio che ha Emesso il Cumulo <font class=ob>(*)</font></td>
      		<td class="L">
      			<input type="HIDDEN" name="<%=ICostantiFascicoloSiep.CAMPO_COD_UFFICIO_UNIONE%>" value="<%=fascicolosiep.getCodTipoUfficio()%>">
      			<input title="Descr Tipo Ufficio" name="descrTipoUfficioUnione" value="<%=fascicolosiep.getDescrTipoUfficioUnione()%>" type="text" maxlength="35" size="70" readonly="readonly">
      		</td>
    	</tr>
    	<tr>
      		<td class="l">Sede <font class=ob>(*)</font></td>
     		<td class="L">
     			<input type="hidden" name="codComuneCumulo" value="<%=fascicolosiep.getCodUfficioUnione()%>"> 
          		<input title="Sede Ufficio" name="<%=ICostantiFascicoloSiep.CAMPO_SEDE_UFFICIO_UNIONE%>" value="<%=fascicolosiep.getDescrComuneUfficioUnione()%>" type="text" maxlength="35" size="35" readonly="readonly">
      		</td>
    	</tr>
	</table>
	</div>
	<table cellspacing=0 cellpadding=0 width="95%">
		 <tr>
      		...
      		<td class="l">
         		<input Title="Anno Unione" value="<%=StringUtils.toStringJSP(fascicolosiep.getAnnoFascicoloUnione())%>" name="<%=ICostantiFascicoloSiep.CAMPO_ANNO_FASCICOLO_UNIONE%>" type="text" size="4" maxlength="4" readonly="readonly"> /
         		<input Title="Numero Unione" value="<%=StringUtils.toStringJSP(fascicolosiep.getNumFascicoloUnione())%>" name="<%=ICostantiFascicoloSiep.CAMPO_NUM_FASCICOLO_UNIONE%>" type="text" size="6" maxlength="6" readonly="readonly">
      		</td>
    	</tr>
    	<tr>
      		<td class="l">Data Definizione <font class=ob>(*)</font></td>
      		<td class="l">
        		<input type="text" Title="Giorno definizione" name="<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(archiviazione.getDataDefinizione(), "dd"))%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
        		/
        		<input type="text" Title="Mese definizione" name="<%=ICostantiArchiviazione.CAMPO_MESE_DATA_DEFINIZIONE%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(archiviazione.getDataDefinizione(), "MM"))%>" maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
        		/
        		<input type="text" Title="Anno definizione" name="<%=ICostantiArchiviazione.CAMPO_ANNO_DATA_DEFINIZIONE%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(archiviazione.getDataDefinizione(), "yyyy"))%>" maxlength="4" size="4" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
      		</td>
    	</tr>
    	<tr>
     		<td class="L">Motivazione</td>
      		<td class="L">
        		<TEXTAREA title="Motivazione" name="<%=ICostantiArchiviazione.CAMPO_NOTE%>" cols="70" rows="2"><%=StringUtils.toStringJSP(archiviazione.getNote())%></textarea>
      		</td>
     	</tr>
  	</table>
  	<br>
	...
	<table cellspacing=0 cellpadding=0 width="95%">
  		...
  		<tr>
     		...
     		<td class="l">di</td>
     		<td class="L">
     			<input type="HIDDEN" name="codSedeUffRecCred" value="<%=codSedeUffRecCred%>">
          		<input title="Sede Ufficio recupero crediti" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>" value="<%=descSedeUffRecCred%>" type="text" maxlength="35" size="35">
  		...
  		<tr>
      		...
      		<td class="L" colspan="3">
        		<select title="Autorita Polizia" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>">
         			<%=tipoAutoritaPolizia%>
         		</select>
      		</td>
    	</tr>
    	<tr>
     		<td class="l">Sede</td>
     		<td class="L">
     			<input type="HIDDEN" name="codSedeAutPol" value="<%=codSedeAutPol%>">
          		<input title="Sede Autorita" type="text" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>" value="<%=descSedeAutPol%>" maxlength="35" size="35">
      		...
      		<td class="L">
         		<TEXTAREA title="Note" name="<%=ICostantiNotifica.CAMPO_NOTE_E%>" cols="30"><%=indAutPol%></textarea>
      		</td>
    	</tr>
    	<tr>
      		<td class="l">Magistrato di Sorveglianza</td>
      		<td class="L" colspan="3">
      			<input type="HIDDEN" name="codSedeUDS" value="<%=codSedeUDS%>">
       			<input title="ufficio" value="<%=descSedeUDS%>" type="text" name="<%=ICostantiNotifica.CAMPO_SEDE_MDS%>" maxlength="35" size="35">
    	...
    	<tr>
       		...
       		<td class="L" colspan="3">
       			<input type="HIDDEN" name="codSedeTDS" value="<%=codSedeTDS%>">
         		<input title="Sede Tribunale Sorveglianza" name="<%=ICostantiNotifica.CAMPO_SEDE_TDS%>" value="<%=descSedeTDS%>" type="text" maxlength="35" size="35">
    	...
    	<tr>
      		...
      		<td class="L" colspan="3">
        		<select title="Altra Autorita" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>">
         			<%=tipoAltraAutorita%>
         		</select>
      		</td>
    	</tr>
    	<tr>
     		<td class="l">Sede</td>
     		<td class="L">
     			<input type="HIDDEN" name="codSedeAltraAut" value="<%=codSedeAltraAut%>">
          		<input title="Sede Altra Autorita" type="text" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>" value="<%=descSedeAltraAut%>" maxlength="35" size="35">
      		...
      		<td class="l">Indirizzo</td>
      		<td class="L">
          		<TEXTAREA title="Note" name="<%=ICostantiNotifica.CAMPO_NOTE_C%>" cols="30"><%=indAltraAut%></textarea>
       		</td>
    	</tr>
    	<tr>
      		<td class="l">Altra Autorità </td>
       		<td class="l" colspan="3">
       			<font class="campo">
        			<input title="Altra Autorità" name="<%=ICostantiNotifica.CAMPO_NOTE%>" value="<%=descAltraAut%>" size="70" type="text">
        		</font>
       		</td>
    	</tr>
	</table>
