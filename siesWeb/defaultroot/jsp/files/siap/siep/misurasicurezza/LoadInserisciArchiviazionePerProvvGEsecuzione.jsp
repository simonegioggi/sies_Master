...
<jsp:useBean id="autoritaDest"			scope="request" class="java.lang.String"/>
...
%>
<!-- 					LoadInserisciArchiviazionePerProvvGEsecuzione 				-->
<html>
  <head>
    <link rel="STYLESHEET" type="text/css" href="<%=IWebConstants.PG_STYLE%>">
    <title>[S.I.E.S.] - -Gestione Misure sicurezza - Archiviazione per Provvedimento del G.E. </title>
    ...
    <script language="JavaScript">
     ...
     //DATA EMISSIONE
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_EMISSIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_EMISSIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_EMISSIONE%>.value;
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_EMISSIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_EMISSIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_EMISSIONE%>.value;
	
	        var data_to_verify = document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_EMISSIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_EMISSIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_ANNO_DATA_EMISSIONE%>.value;
	
	        if (!ControllaDataPassaVuota(data_to_verify) )
	        {
	          alert('Data emissione non valida');
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_EMISSIONE%>.focus();
	...
	//DATA RICEZIONE
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_RICEZIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_RICEZIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_RICEZIONE%>.value;
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_RICEZIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_RICEZIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_RICEZIONE%>.value;
	
	        var data_to_verify = document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_RICEZIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_RICEZIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_ANNO_DATA_RICEZIONE%>.value;
	
	        if (!ControllaDataPassaVuota(data_to_verify) )
	        {
	          alert('Data ricezione non valida');
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_RICEZIONE%>.focus();
	...
	//DATA DEFINIZIONE
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value;
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_DEFINIZIONE%>.value.length==1)
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_DEFINIZIONE%>.value='0'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_DEFINIZIONE%>.value;
	
	        var data_to_verify = document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_MESE_DATA_DEFINIZIONE%>.value+'/'+document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_ANNO_DATA_DEFINIZIONE%>.value;
	
	        if (!ControllaData(data_to_verify) )
	        {
	          alert('Data definizione non valida');
	          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_GIORNO_DATA_DEFINIZIONE%>.focus();
	
	          return false;
	        }
	        
// Autorità 
	        if(document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_TIPO_AUTORITA_EMITTENTE %>.value == "-")
		    {
		       	alert("Digitare Tipo Autorità Emittente ");
		       	document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_TIPO_AUTORITA_EMITTENTE %>.focus();
		       	return false;
		    }	
		    
// Sede Autorità	
	        if(document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_TIPO_AUTORITA_EMITTENTE %>.value != "-" &&
			   	document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_LUOGO_EMITTENTE %>.value == "" )
			{
			   	alert("Digitare Sede Autorità Emittente");
			   	document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_LUOGO_EMITTENTE %>.focus();
			   	return false;
			}		    
		    
// Tipo Provvedimento
			if(document.ArchProvvGE.<%= ICostantiArchiviazione.CAMPO_COD_TIPO_PROVVEDIMENTO_ARC %>.value == "-") 
			{
				alert(" TIPO Provvedimento OBBLIGATORIO");
	        	document.ArchProvvGE.<%= ICostantiArchiviazione.CAMPO_COD_TIPO_PROVVEDIMENTO_ARC %>.focus();
	        	return false;
			}	

// Anno e numero protocollo		
			if(document.ArchProvvGE.<%=ICostantiEvento.CAMPO_PROGR_PROTOCOLLO%>.value=="" && document.ArchProvvGE.<%=ICostantiEvento.CAMPO_ANNO_PROTOCOLLO%>.value!="")
	      	{
		        alert("Inserire Numero Protocollo");
		        document.ArchProvvGE.<%=ICostantiEvento.CAMPO_PROGR_PROTOCOLLO%>.focus();
		        return false;
	      	}
			...
			if(document.ArchProvvGE.<%=ICostantiEvento.CAMPO_PROGR_PROTOCOLLO%>.value !="" && document.ArchProvvGE.<%=ICostantiEvento.CAMPO_ANNO_PROTOCOLLO%>.value =="")
	      	{
		        ...
		        document.ArchProvvGE.<%=ICostantiEvento.CAMPO_ANNO_PROTOCOLLO%>.focus();
		        return false;
	      	}
		    
// Oggetto Definizione
	        if (document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_OGGETTO_DEFINIZIONE%>[document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_OGGETTO_DEFINIZIONE%>.selectedIndex].value == '-')
	        {
		          alert("Il Campo Oggetto definizione è obbligatorio");
		          document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_OGGETTO_DEFINIZIONE%>.focus();
		          return false;
	        }
	        
// Magistrato	
	        if(document.ArchProvvGE.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="")
	        {
		          alert("Il Cognome del Magistrato è obbligatorio");
		          document.ArchProvvGE.<%=ICostantiMagistrato.CAMPO_COGNOME %>.focus();
		          return false;
	        }
	
	        if(document.ArchProvvGE.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
	        {
		          alert("Il Nome del Magistrato è obbligatorio");
		          document.ArchProvvGE.<%=ICostantiMagistrato.CAMPO_NOME %>.focus();
		          return false;
	        }
	        
   	// Controllo su AUTORITA (destinatari)
			if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.value != "-" )
			{
				if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.value == "" )
				{
					alert('ERRORE : Inserire Sede Destinatario');
					document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.focus();
					return false;
				}	
			}
			...
			if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>.value != "" )
			{
				if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.value == "-" )
				{
					...
					document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_E%>.focus();
					return false;
				}	
			}
			
		// Controllo su AUTORITA ESECUZIONE (destinatari)	
			if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.value != "-" )
			{
				if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>.value == "" )
				{
					alert('ERRORE : Inserire Sede Destinatario Giudice Esecuzione');
					document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>.focus();
					return false;
				}	
			}
			...
			if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>.value != "" )
			{
				if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.value == "-" )
				{
					...
					document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.focus();
					return false;
				}	
			}
			
			// Controlli su Notifica al Difensore
			if( document.ArchProvvGE.Difesa.checked )
			{
			       <% if (avvocati.size()==1) {%>
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value == "-" 
						&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value == "" )
						{
							alert('Attenzione : Inserire Dati Destinatario notifica Difensore ');
			      			document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.focus();
				 			return false;		
						}
			
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1
							&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value == "" )
						{
							alert('Attenzione : Inserire la Sede Destinatario notifica Difensore ');
			      			document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.focus();
				 			return false;		
						}
			
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value != ""
							&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value == "-" )
						{
				   ...
				   <% } else { %>
				    for (var i=0; i< <%=avvocati.size()%>; i++) { 
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value == "-" 
							&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value == "" )
						{
							alert('Attenzione : Inserire Dati Destinatario notifica Difensore '+i);
			      			document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].focus();
				 			return false;		
						}
			
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1
						&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value == "" )
						{
							alert('Attenzione : Inserire la Sede Destinatario notifica Difensore ');
			      			document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].focus();
			      			bloccaUNEP();
				 			return false;		
						}
			
						if(document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value != ""
							&& document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value == "-" )
						{
							alert('Attenzione : Inserire il tipo di  Destinatario notifica Difensore  ');
				          	document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].focus();
						 	return false;		
			...
			if( document.ArchProvvGE.SiNoTe.checked ) {
			       <% if (avvocati.size()==1) {%>
						document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value = "-";
			    		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=0;
			    		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value='C0';
						var codAut=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value;
						var indAut=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex;
			  <% } else { %>
				    for (var i=0; i< <%=avvocati.size()%>; i++) { 
						document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value = "-";
			    		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=0;
			    		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value='C0';
						var codAut2=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value;
						var indAut2=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex;
					}
			<%	} %>
			}
			else
			{
				if( document.ArchProvvGE.Difesa.checked ) {
				        <% if (avvocati.size()==1) {%>
			        		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1;
							var codAut=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.value;
							var indAut=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex;
				   <% } else { %>
			    	    for (var i=0; i< <%=avvocati.size()%>; i++) { 
			        		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1;
							var codAut2=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].value;
							var indAut2=document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex;
						}
				<%	} %>
			...
			if(document.ArchProvvGE.tipoUDS.value != "-")
			{
				if(document.ArchProvvGE.<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>.value == "")
				{
					alert(' Inserire Sede Destinatario Sorveglianza');
					document.ArchProvvGE.<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>.focus();
					return false;
				}	
			}
...
// End Verify
      ...
      function Difensore()
      {
          ...
          if( document.ArchProvvGE.Difesa.checked )
       	  { 
     	        ...
     	        <% if (avvocati.size()==1) {%>
          		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.disabled=false;
         			document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1;
             		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.disabled=false;
             		document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>.disabled=false;
        	    <% } else { %>
      	      	for (var i=0; i< <%=avvocati.size()%>; i++){ 
	            		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].disabled=false;
	    				document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1;
	               		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].disabled=false;
	               		document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>[i].disabled=false;
					}
 	   	     <% } %>
     	  }
          else
          {
          	nodequan.style.display='none';
     	        ...
     	        <% if (avvocati.size()==1) {%>
	        		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value="";
	        		document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>.value="";
      				document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>.selectedIndex=1;
        	    <% } else { %>
 	      			for (var i=0; i< <%=avvocati.size()%>; i++){ 
		        		document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value="";
		        		document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>[i].value="";
	    				document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>[i].selectedIndex=1;
					}
 	   	     <% } %>
          }
          ...
          if( document.ArchProvvGE.SiNoTe.checked )
       	{ 
     	        ...
     	        <% if (avvocati.size()==1) {%>
					document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>.value = "-";
	           		document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>.value='';
	           		//document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>.disabled=true;
        	    <% } else { %>
		    	    	for (var i=0; i< <%=avvocati.size()%>; i++) { 
							document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[i].value = "-";
		           			//document.ArchProvvGE.<%=ICostantiNotifica.CAMPO_NOTE%>[i].value='';
  ...
  <body class="corpo" onLoad="valorizzaAutorita();">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class=lbg>
         ...
         <font class="campo">Definizione Procedimento - Archiviazione per Provvedimento del Giudice Esecuzione</font>
        </td>
      </tr>
    </table>
    <br>
    ...
    <br>
    <form method="POST" name="ArchProvvGE" action="<%=IWebConstants.PG_MAIN%>">
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misurasicurezza.action.ActInserisciArchiviazionePerProvvGEsecuzione">
...
<%	}%> 
  ...
  <!--  Dati del Giudice per Esecuzione  -->  
  <table width="80%">
    <tr>
      <td colspan=4 class="titolo">dati provvedimento dell'Esecuzione</td>
    </tr>
    <tr>
      <td class="l" colspan="4">
        <a href="Javascript:ListaProvvGE('ArchProvvGE');">
...
<!-- 	Dati Autorità Emittente (di Ufficio Esecuzione) -->
<table width="80%">  
  <tr>
    <td class="l" width="15%">Autorità </td>
	<td class="L" width="25%">
    ...
    <td class="L" width="25%">
          ...
          <a href="Javascript:ListaComuniperuff('ArchProvvGE','<%=ICostantiArchiviazione.CAMPO_COD_LUOGO_EMITTENTE%>',document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_TIPO_AUTORITA_EMITTENTE%>[document.ArchProvvGE.<%=ICostantiArchiviazione.CAMPO_COD_TIPO_AUTORITA_EMITTENTE%>.selectedIndex].value);">
    ...
    <tr>
      ...
      <td class="L" colspan="3">
        ...
        <input readonly title= "Nome Magistrato"    value="<%=StringUtils.toStringJSP(magistratocompetente.getMagistrato().getNome() )%>" type="text" name="<%= ICostantiMagistrato.CAMPO_NOME %>"      maxlength="35" size="25">
         <a href="Javascript:ListaMagistrati('ArchProvvGE');">
           <img src="/images/filefolder.gif" border=0>
         </a>
       </td>
       <td>
	...
	{ %>	
		  ...
		  <td class="l" colspan="3">
		  	...
		  	<input type="hidden"  Title="Istituto" name="<%=ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE%>" value="<%= posizioneluogoaltra.getLuogoDetenzione().getIstDetIdIstitutoDetenzione()%>" size=90>
		  		<a href="Javascript:ListaIstitutoDetenzione('ArchProvvGE','<%= ICostantiLuogoDetenzione.CAMPO_IST_DET_ID_ISTITUTO_DETENZIONE %>','Comune');">
...
<%	} %>
	...
	<!--Notifica per Altra Autorità 	-->
		...
		<tr>
			...
			<td class="L"><input title="Sede Autorita Esterna" value="" type="text" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>" size="35"> 
				<a href="Javascript:ListaComuni('ArchProvvGE','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_E%>');"> 
				<img src="/images/filefolder.gif" border=0>
				</a>
			</td>
		</tr>
	...
	<tr>
	    ...
	    <td class="L">
	      ...
	      <a href="Javascript:ListaUfficiComuni('ArchProvvGE','<%=ICostantiUfficio.CAMPO_SEDE_UFFICIO%>'
	                                           ,document.ArchProvvGE.tipoUDS[document.ArchProvvGE.tipoUDS.options.selectedIndex].value);">
	         <img src="/images/filefolder.gif" border=0>
	      </a> 
	    </td>
  	</tr>    	     

<!-- 	Destinatario per Notifica: Autorità dell'Esecuzione -->
  <tr>
    ...
    <td class="L" width="25%">
          ...
          <a href="Javascript:ListaComuniperuff('ArchProvvGE','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE_C%>',document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>[document.ArchProvvGE.<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C%>.selectedIndex].value);">
          <img src="/images/filefolder.gif" border=0>
        </a>
    </td>        
  </tr>
  <tr>    
    <td class="l" width="15%">Indirizzo</td>
    <td class="L" width="25%">
      <TEXTAREA title="IndirizzoCdest" name="<%=ICostantiAutoritaEsterna.CAMPO_NOTE_C%>"  cols=40 ></textarea>
    </td>
  </tr>
...
<div id="divq" style="display: none; position: relative;  width: 90%;">
  ...
  %>
      <table width="90%">
       ...
       <%	if(avvocati.size()>1)
			{	%>             
              <a href="Javascript:ListaComuni('ArchProvvGE','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>[<%=lIdxAvv%>]');">
                <img src="/images/filefolder.gif" border=0>
              </a>
      <%	}
       		else
       		{	%>
              <a href="Javascript:ListaComuni('ArchProvvGE','<%=ICostantiAutoritaEsterna.CAMPO_COD_SEDE%>');">
                <img src="/images/filefolder.gif" border=0>
              </a>       		
       	<%	} %>	        
          </td>
...
<table width="100%">   
  ...
  <script language="JavaScript" type="text/javascript">
    var frmvalidator = new Validator("ArchProvvGE");
