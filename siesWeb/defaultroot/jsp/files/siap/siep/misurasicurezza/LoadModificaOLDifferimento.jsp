		...
		<table style="width: 95%;">
			<tr>
				...
				<td class="L" nowrap="nowrap">
			 		<input name="<%=ICostantiDepositoOrdinanzaPc.CAMPO_GIORNO_DATA_FINE_MISURA%>" value="<%=StringUtils.toStringJSP(DateUtils.getDateToString(provvSorv.getOrdinanza() != null ? provvSorv.getOrdinanza().getDataFineMisura() : provvSorv.getMisuraAlternativa() != null ? provvSorv.getMisuraAlternativa().getDataFineMisura() : misuraAlternativa.getDataFineMisura(), "dd"), "")%>"
				...
				<td class="L" nowrap="nowrap">
			 		&nbsp;Anni&nbsp;<input value="<%=StringUtils.toZerotoStringaVuota(provvSorv.getOrdinanza() != null ? StringUtils.toStringJSP(provvSorv.getOrdinanza().getSospensioneAASS()) : StringUtils.toStringJSP(misuraAlternativa.getNumAnniMisura()), "")%>" type="text" size="2" name="numAnniSospensione" readonly> -
					&nbsp;Mesi&nbsp;<input value="<%=StringUtils.toZerotoStringaVuota(provvSorv.getOrdinanza() != null ? StringUtils.toStringJSP(provvSorv.getOrdinanza().getSospensioneMMSS()) : StringUtils.toStringJSP(misuraAlternativa.getNumMesiMisura()), "")%>" type="text" size="2" name="numMesiSospensione" readonly> -
					&nbsp;Giorni&nbsp;<input value="<%=StringUtils.toZerotoStringaVuota(provvSorv.getOrdinanza() != null ? StringUtils.toStringJSP(provvSorv.getOrdinanza().getSospensioneGGSS()) : StringUtils.toStringJSP(misuraAlternativa.getNumGiorniMisura()), "")%>" type="text" size="4" name="numGiorniSospensione" readonly>
			...
			<tr>
				<td class="L">Casa o Altro Luogo di Cura</td>
			   	<td class="L" colspan="3">
			   		<input title="Casa o Altro Luogo di Cura" type="text" value="<%=StringUtils.toStringJSP(StringUtils.cStrForJS(provvSorv.getOrdinanza() != null ? provvSorv.getOrdinanza().getLuogoSvolgimentoProva() : misuraAlternativa.getDescrLuogoProva()))%>"
