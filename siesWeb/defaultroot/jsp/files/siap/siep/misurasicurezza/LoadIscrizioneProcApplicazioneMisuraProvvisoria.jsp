...
<%
  // Tipo Iscrizione : Misura PROVVISORIA
  String TipoIscrMisura = "PROVVISORIA";
...
/***************************PROVVEDIMENTO (sentenza)*********************************************************/
      ...
      if(document.LoadInserisciSentenza.ARG.value=="" || document.LoadInserisciSentenza.NRG.value == "")
      {
          alert('Anno e/o Numero Reg. Gen. Non Validi');
          document.LoadInserisciSentenza.ARG.focus();
          return false;
      }

      if(document.LoadInserisciSentenza.TipoRG.value=="-" )
      {
    ...
    /***************************  MISURA SICUREZZA  *********************************************************/
       ...
       if(!document.LoadInserisciSentenza.<%=ICostantiMisuraSicurezza.CAMPO_COD_TIPO %>.disabled)
       {
         if(document.LoadInserisciSentenza.<%= ICostantiMisuraSicurezza.CAMPO_COD_TIPO %>.value == "-" ||
       		 document.LoadInserisciSentenza.<%= ICostantiMisuraSicurezza.CAMPO_COD_TIPO %>.value.length == 0)
         {
...
<%--   frmvalidator.addValidation("<%= ICostantiSoggetto.CAMPO_COD_COMUNE_NASCITA %>","alpha"); --%>
  ...
  /**************************Sentenza****************************************/    
    ...
    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_ANNO_REGE_PM%>", "req", "Anno R.G.N.R. Obbligatorio");

    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_NUMERO_REGE_PM%>","numeric");
    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_NUMERO_REGE_PM%>", "req", "Numero R.G.N.R. Obbligatorio");
    ...
    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_ANNO_SENTENZA%>","req", "Anno provvedimento Obbligatorio");
    
    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA%>","alfanumeric");
    frmvalidator.addValidation("<%= ICostantiSentenza.CAMPO_NUMERO_SENTENZA%>","req", "Numero provvedimento Obbligatorio" );
