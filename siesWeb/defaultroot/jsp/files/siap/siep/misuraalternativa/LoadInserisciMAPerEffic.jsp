...
%>
   //Controlli Data Emissione Nota
     ...
     frmvalidator.addValidation("<%= ICostantiRefertoScarcerazione.CAMPO_ANNO_DATA_NOTA%>","lt=2050");
    ...
    if(!document.LoadInserisciMisuraAlternativa.<%=ICostantiRefertoScarcerazione.CAMPO_MESE_DATA_SCARCERAZIONE%>.disabled)
      ...
      //Controlli Data Scarcerazione
        ...
        frmvalidator.addValidation("<%= ICostantiRefertoScarcerazione.CAMPO_ANNO_DATA_SCARCERAZIONE%>","lt=2050");
