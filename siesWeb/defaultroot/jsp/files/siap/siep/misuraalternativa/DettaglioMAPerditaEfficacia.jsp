...
<body class="corpo">
  ...
  <font class="campo">DETTAGLIO CESSAZIONE SOSPENSIONE PROVVISORIA
...
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMAPerditaEfficacia&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&notificaE="+notificaE%>"/>
   </jsp:include>
<%}%>
...
<tr>
        ...
        <% if(eventonotifica!=null && eventonotifica.getNotifiche().length>0)
        {%>
...
<%if(referto != null && referto.getIdRefertoScarcerazione() != null)
{%>
 <tr>
  <td class="l">Istituto di detenzione</td>
    <td class="l">
       <font class="campo"> <%=StringUtils.toStringJSP(referto.getIstitutoDetenzione().getDescrTipoIstituto())%></font>&nbsp;di
       <font class="campo"> <%=StringUtils.toStringJSP(referto.getIstitutoDetenzione().getDescrComune())%></font>
     </td>
</tr>
<tr>
      <td class="l">Anno / Numero Nota</td>
      <td class="l"><font class="campo"> <%=StringUtils.toStringJSP(referto.getAnnoNota())%> /</font>
      <font class="campo"><%=StringUtils.toStringJSP(referto.getNumNota())%></font>
     </td>
      <td class="l">Data Emissione Nota</td>
      <td class="l">
         <font class="campo">
          <%=StringUtils.toStringJSP(DateUtils.getDateToString(referto.getDataNota(),"dd-MM-yyyy"))%>&nbsp;
        </font>
     </td>
</tr>
<tr>
...
<tr>
      ...
      <td class="l">
         <font class="campo">
          <%=StringUtils.toStringJSP(DateUtils.getDateToString(referto.getDataScarcerazione(),"dd-MM-yyyy"))%>
        </font>
     </td>
</tr>
...
<td class="l">Note</td>
    <td class="l">
         <font class="campo"><%=StringUtils.toStringJSP(referto.getNote())%>&nbsp;</font>
    <td>
</tr>
...
<%if(misuraalternativa != null && misuraalternativa.getIdMisuraAlternativa()!= null) //inizio misura alternativa
{%>
 <tr>
...
<%if(misuraalternativa != null && misuraalternativa.getDescrLuogoProva() != null){%>
<tr>
<td class="l">Domicilio Imposto</td>
    <td class="l">
         <font class="campo"><%=misuraalternativa.getDescrLuogoProva()%>&nbsp;</font>
    <td>
</tr>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMAPerditaEfficacia">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMAPerditaEfficacia">
          </td>
        </tr>
      </table>
</form>
