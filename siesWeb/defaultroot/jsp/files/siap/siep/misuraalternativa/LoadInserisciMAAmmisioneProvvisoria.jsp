...
<title>[S.I.E.S.] - Gestione evento </title>
  ...
  {  
    ...
    { //data emissione decreto/ordinanza
...
<%
   // verbale.getIdVerbale()!=null se ho registrato il verbale di sottomissione
   // agli obblighi
   if(tipomisura.equals("AFFIDAMENTO") && (verbale.getIdVerbale()!=null))
   { 
...
<%
  ...
  {
    // Sto inserendo il primo provvedimento, devo indicare o selezionare i dati 
...
%>
<% 
if (   lPosizione.isLibero() && misuraalternativa.getIdMisuraAlternativa()== null
		...
		<div id="divsor" style="width: 100%; display: block; position: relative;">
			...
			<table width="100%">
			    ...
			    <tr>
			    	<td class="l">Sede</td>
					<td class="L" colspan="3">
						<input type="text" title="ufficio" maxlength="35" size="25"
...
%>
<%//if ((tipomisura.equals("AFFIDAMENTO"))||((tipomisura.equals("DETENZIONE")) && (!lPosizione.isLibero())
  //  && (verbale.getIdVerbale()==null)))
if( (tipomisura.equals("AFFIDAMENTO") || tipomisura.equals("DETENZIONE"))
 && ( misuraalternativa.getIdMisuraAlternativa() == null ) )
{
