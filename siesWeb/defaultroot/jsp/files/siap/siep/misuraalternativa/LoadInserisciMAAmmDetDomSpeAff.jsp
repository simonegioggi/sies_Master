...
<html>
<head>
<title>[S.I.E.S.] - Ammissione da Detenzione domiciliare speciale ad affidamento </title>
 ...
 if(document.LoadInserisciMisuraAlternativa.tipo[1].checked == true)
    ...
    if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>.value=="")
    {
        alert("La data di Scarcerazione è obbligatoria");
         document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>.focus();        return false;
     }
...
if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.value=="")
 ...
 if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_POL_E %>.value=="")
      {
        alert("La Sede dell' Autorità di destinazione è obbligatoria");
...
%>
    <font class="campo">Ammissione da Detenzione domiciliare speciale ad affidamento</font>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciMAAmmDetDomSpeAff">
...
<table>
   <tr>
      <td class="Titolo" colspan='7'> Dati Ordinanza Tribunale di Sorveglianza </td>
   </tr>
   <tr>
...
<tr>
<td class="l">Eseguito da M.D.S. &nbsp;<input type="radio" name="tipo" value="mds" checked >
&nbsp; Eseguita da Procura  &nbsp; <input type="radio" name="tipo" value="proc" ></td>
