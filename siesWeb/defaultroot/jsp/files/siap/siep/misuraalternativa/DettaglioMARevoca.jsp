...
{%>
   <font class="campo">Dettaglio Revoca Detenzione Domiciliare</font>
<%}else if(tipoMisura != null && tipoMisura.equals("SEMILIBERTA"))
  {%>
   <font class="campo">Dettaglio Revoca Semilibertà</font>
<%}%>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMARevoca&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
   </jsp:include>
 <%}%>
        ...
        <tr>
          <td class="L">
           ...
           <input type="HIDDEN" name="<%=ICostantiMisuraAlternativa.CAMPO_ID_MISURA_ALTERNATIVA%>" value="<%=misuraalternativa.getIdMisuraAlternativa()%>">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioRevocaMA">
          </td>
        </tr>
      </table>
</form>
