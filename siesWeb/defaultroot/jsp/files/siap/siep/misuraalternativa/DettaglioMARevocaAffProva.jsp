...
{%>
   <font class="campo">Dettaglio Revoca L.207/2003</font>
<%}else if(tipoMisura != null && tipoMisura.equals("AFFIDAMENTO"))
  {%>
   <font class="campo">Dettaglio Revoca Affidamento in Prova</font>
...
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMARevocaAffInProva&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&tipoMisura="+tipoMisura%>"/>
   </jsp:include>
<%}%>
...
<%if(misuraalternativa.getNumAnniRevocaReclusione() != null || misuraalternativa.getNumMesiRevocaReclusione() != null
    || misuraalternativa.getNumGiorniRevocaReclusione() != null || misuraalternativa.getNumAnniRevocaArresto() != null || misuraalternativa.getNumMesiRevocaArresto() != null
  ...
  <tr>
     <td class="l">Istituto Detenzione</td>
      <td class="l">
         ...
         <font class="campo"><%=StringUtils.toStringJSP(eventonotifica.getNotifiche()[cont].getIstitutoDetenzione().getDescrizione())%></font>
       </td>
 </tr>
...
cont++;
	...
	<%-- MEV10-s3: correzione tramite controllo preventivo e modifica al layout --%>
	<% if (Utils.isPresent(StringUtils.toStringJSP(UffTDS))) { %>
		<tr>
	...
	<% if (Utils.isPresent(StringUtils.toStringJSP(UffUDS))) { %>
		<tr>
			<td class="l">Destinatario</td >
		    <%
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMARevoca">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioRevocaMAAffInProva">
          </td>
        </tr>
      </table>
</form>
