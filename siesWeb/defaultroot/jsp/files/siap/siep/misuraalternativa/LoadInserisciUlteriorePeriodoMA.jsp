...
<jsp:useBean id="MisuraConcessaPrec"         scope="request" class="siap.sico.misuraalternativa.model.MisuraAlternativaModel"/>
...
if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.value=="")
 ...
 if(document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_CSS_ID_CSSA%>.value=="" || document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_CSS_ID_CSSA%>.value=="-")
      {
         alert("Inserire l' UEPE Preposto al controllo");
        return false;
...
%>
    <font class="campo">Ulteriore Periodo Misura Alternativa</font>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciUlteriorePeriodoMA">
...
%>
  <td class="l">Data Inizio Misura</td>
       ...
       <td class="l"><font class="campo">
          <%=StringUtils.toStringJSP(DateUtils.getDateToString(misuraalternativa.getDataInizioMisura(),"dd-MM-yyyy"))%></font></td>
<%}}else if(MisuraConcessaPrec != null){%>
  <td class="l">Data Inizio Misura</td>
...
%>
  <td class="l">Data Fine Misura</td>
         ...
         <td class="l"><font class="campo">
          <%=StringUtils.toStringJSP(DateUtils.getDateToString(penaresidua.getDataFine(),"dd-MM-yyyy"))%></font></td>
