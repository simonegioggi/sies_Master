...
<table>
  <tr>
    ...
    <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
      <%if(tipoMisura != null && tipoMisura.equals("DETENZIONE")){%>
      <font class="campo">Dettaglio Cessazione Detenzione Domiciliare</font>
      <%}else if(tipoMisura != null && tipoMisura.equals("SEMILIBERTA")) {%>
      <font class="campo">Dettaglio Cessazione Semilibertà</font>
      <%}%>
    </td>
  ...
  %> 
    ...
    <td class="LBG">
      <a href="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActUploadMACessazione&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=eventonotifica.getEvento().getIdEvento()%>&<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>=siap.siep.misuraalternativa.action.ActDettaglioCessazioneMA&<%=ICostantiEvento.CAMPO_VALIDA%>=S&noblob=S">
        <img align="middle" src="/images/upload24.gif" alt="Valida Provvedimento" width="24" height="24" border="0">
      </a>
    </td> 
    <!-- BOTTONE DI STAMPA -->
    <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
      <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMACessazione&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
    </jsp:include>
  <%}%>
  </tr>
</table>
...
<tr>
  <td class="l">Data Inizio Provvedimento di Cessazione</td>
...
<tr>
  <td class="l">&nbsp;</td>
  <td class="l">
    <font class="campo">Esecuzione contro soggetto non detenuto&nbsp;</font>
  <td>
</tr>
<% 
} else if ("SORV".equals(misuraalternativa.getCodTipoUfficioScarcerazione())) {
%>
<tr>
  <td class="l">&nbsp;</td>
  <td class="l">
    <font class="campo">Esecuzione contro soggetto detenuto dal <%=StringUtils.toStringJSP(DateUtils.getDateToString(misuraalternativa.getDataIngressoIstituto(),"dd-MM-yyyy"))  %> </font>
  <td>
</tr>
<% } %>
...
<tr>
  ...
  <td class="L" colspan="3">
    ...
    <%if(autoritaEsternaE != null && autoritaEsternaE.getDescrSede()!= null && !autoritaEsternaE.getDescrSede().equals("-")) {%>
    ...
    <table>
      ...
      <tr>
        <td class="L">
          ...
          <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioCessazioneMA">
        </td>
      </tr>
    </table>
  </form>
