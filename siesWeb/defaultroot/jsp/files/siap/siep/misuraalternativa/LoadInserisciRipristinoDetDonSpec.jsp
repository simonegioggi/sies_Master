...
<jsp:useBean id="magistrato"         scope="request" class="siap.sico.w_magistrato.model.WMagistratoModel"/>
...
if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.value=="")
 ...
 if(document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS %>.value=="")
    ...
    {
        alert("Indicare se il condannato è scarcerato o da scarcerare");
        return false;
...
%>
    <font class="campo">Ripristino Detenzione Domiciliare Speciale</font>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciMARipristinoDetDomSpec">
...
<tr>
<td class="l">Da scarcerare &nbsp;<input type="radio" name="tipo" value="scarcerare" checked >
&nbsp; Scarcerato  &nbsp; <input type="radio" name="tipo" value="scarcerato" ></td>
<td  class="l">Data Scarcerazione  &nbsp;
<%if((misuraalternativa != null && misuraalternativa.getIdMisuraAlternativa()!= null) && misuraalternativa.getDataScarcerazione()!=null)
{%>

        <input value="<%=DateUtils.getDayToString(misuraalternativa.getDataScarcerazione())%>" type="text" size="2" maxlength="2" name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" > -
          <input value="<%=DateUtils.getMonthToString(misuraalternativa.getDataScarcerazione())%>" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" > -
          <input value="<%=DateUtils.getYearToString(misuraalternativa.getDataScarcerazione())%>" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)" >



<%}else{%>

<input value="" type="text" size="2" maxlength="2" name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE%>"  onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)" > -
          <input value="" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)" >
...
<script language="JavaScript" type="text/javascript">
  ...
  frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_CHIAVE_ANNO_FASCICOLO_SIUS%>","req","Il campo Anno Fascicolo Sius è obbligatorio");
  frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_CHIAVE_ANNO_FASCICOLO_SIUS%>","numeric");
  frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_CHIAVE_PROGR_FASCICOLO_SIUS%>","req","Il campo Prgr. Fascicolo Sius è obbligatorio");
