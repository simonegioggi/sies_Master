   ...
   // Chiamata lista Avvocati.
    ...
    function ListaDocumentiSius(a_formname)
    {
      ...
      if(document.LoadInserisciMisuraAlternativa.tipomisura.value=='AFFIDAMENTO')
      {
        ...
        naturaMA='<%=ICostantiMisuraAlternativa.ESTENSIONE_DEFINITIVA%>';
      }
      else if(document.LoadInserisciMisuraAlternativa.tipomisura.value=='AFFIDAMENTOCUMULO')
      {
        tipoMA='<%=ICostantiMisuraAlternativa.AFFIDAMENTO_IN_PROVA%>';
        naturaMA='<%=ICostantiMisuraAlternativa.ESTENSIONE_DEFINITIVA_CUMULO%>';
      }
...
if(document.LoadInserisciMisuraAlternativa.flagmisura.value=="N")
{
  ...
  /*if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA %>[document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA%>.selectedIndex].value == '-')
      {
...
<%if(tipoMisura.equals("DETENZIONE") || tipoMisura.equals("DETENZIONECUMULO"))
{%>
...
<%
  ...
  {
%>
    <font class="campo">Estensione Definitiva Detenzione Domiciliare (senza cumulo)</font>
<%
  }
  else if(tipoMisura.equals("AFFIDAMENTO"))
  {
%>
    <font class="campo">Estensione Definitiva Affidamento In Prova (senza cumulo)</font>
<%
  }
  else if(tipoMisura.equals("SEMILIBERTA"))
  {
%>
    <font class="campo">Estensione Definitiva Semilibertà (senza cumulo)</font>
<%
  }
  else if(tipoMisura.equals("DETENZIONECUMULO"))
  {
%>
    <font class="campo">Estensione Definitiva Detenzione Domiciliare (con cumulo)</font>
<%
  }
  else if(tipoMisura.equals("AFFIDAMENTOCUMULO"))
  {
%>
    <font class="campo">Estensione Definitiva Affidamento In Prova (con cumulo)</font>
<%
  }
  else if(tipoMisura.equals("SEMILIBERTACUMULO"))
  {
%>
    <font class="campo">Estensione Definitiva Semilibertà (con cumulo)</font>
<%
  }
%>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciEstensioneDefinitiva">
...
<tr>
  ...
  <%if(tipoMisura.equals("AFFIDAMENTO") || tipoMisura.equals("AFFIDAMENTOCUMULO"))
    {%>
