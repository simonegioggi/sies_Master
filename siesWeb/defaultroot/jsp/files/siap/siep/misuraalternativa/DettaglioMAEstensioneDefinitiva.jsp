...
<body class="corpo">
  ...
  <font class="campo">Dettaglio Estensione Definitiva </font>

<%if(tipoMisura.equals("DETENZIONE")){%>
    <font class="campo">Detenzione Domiciliare (senza cumulo)</font>
<%}else if(tipoMisura.equals("AFFIDAMENTO")){%>
    <font class="campo">Affidamento In Prova (senza cumulo)</font>
<%}else if(tipoMisura.equals("SEMILIBERTA")){%>
    <font class="campo"> Semilibertà (senza cumulo)</font>
<%}else if(tipoMisura.equals("DETENZIONECUMULO")){%>
    <font class="campo">Detenzione Domiciliare (con cumulo)</font>
<%}else if(tipoMisura.equals("AFFIDAMENTOCUMULO")){%>
    <font class="campo">Affidamento In Prova (con cumulo)</font>
<%}else if(tipoMisura.equals("SEMILIBERTACUMULO")){%>
    <font class="campo"> Semilibertà (con cumulo)</font>
<%}%>
...
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMAEstensioneDefinitiva&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&codposizionegiuridica="+posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()+"&tipoMisura="+tipoMisura%>"/>
   </jsp:include>
 <%}%>
 ...
 {%>
   <tr>
     <td class="l">TDS che ha emesso l'ordinanza</td >
      <td class="L">
      <font class="campo">
       TRIBUNALE DI SORVEGLIANZA</font> di <font class="campo"><%=StringUtils.toStringJSP(UffTDS)%>
       </font>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMAEstensioneDefinitiva">
           ...
           <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMAEstensioneDefinitiva">
