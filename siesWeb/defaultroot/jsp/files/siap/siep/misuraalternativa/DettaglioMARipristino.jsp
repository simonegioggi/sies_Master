...
<%if(eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMARipristino&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&notificaE="+notificaE%>"/>
   </jsp:include>
<%}%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMARipristino">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMARipristino">
          </td>
        </tr>
      </table>
</form>
