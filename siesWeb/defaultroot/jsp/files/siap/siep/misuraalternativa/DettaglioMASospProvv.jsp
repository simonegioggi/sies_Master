...
<%if(tipoMisura.equals("DETENZIONE")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria Detenzione Domiciliare</font>
<%}else if(tipoMisura.equals("AFFIDAMENTO")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria Affidamento In Prova</font>
<%}else if(tipoMisura.equals("SEMILIBERTA")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria Semilibertà</font>
<%}else if(tipoMisura.equals("AFFIDAMENTO51BIS")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria 51 Bis Affidamento In Prova (SENZA CUMULO)</font>
<%}else if(tipoMisura.equals("DETENZIONE51BIS")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria 51 Bis Detenzione Domiciliare (SENZA CUMULO)</font>
<%}else if(tipoMisura.equals("SEMILIBERTA51BIS")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria 51 Bis Semilibertà (SENZA CUMULO)</font>
<%}else if(tipoMisura.equals("INDULTINO51BIS")){%>
    <font class="campo">Dettaglio Sospensione Provvisoria Art.51 Bis L.207/2003 (SENZA CUMULO) </font>
<%}else if(tipoMisura.equals("INDULTINO")){%>
      <font class="campo">Dettaglio Sospensione Provvedimento Art. 51 Ter O.P. L.207/2003</font>
<%}else if(tipoMisura.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM)){%>
      <font class="campo">Dettaglio Sospensione Espiazione Pena presso Domicilio</font>
<%}else if(tipoMisura.equals(ICostantiMisuraAlternativa.SOSP_ESP_PRESSO_DOM_51BIS)){%>
      <font class="campo">Dettaglio Sospensione Espiazione Pena presso Domicilio  (SENZA CUMULO) </font>
<%}else if(tipoMisura.equals(ICostantiMisuraAlternativa.REVOCA_ESP_PRESSO_DOM)){%>
      <font class="campo">Dettaglio Revoca Espiazione Pena presso Domicilio </font>
<%}%>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMASospProvv&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&notificaE="+notificaE+"&tipoMisura="+tipoMisura%>"/>
   </jsp:include>
<%}%>
...
%>
   <tr>
     <td class="l">Destinatario</td >
      <td class="L"> <%=StringUtils.toStringJSP(UffUDS)%>
...
{%>
   <tr>
     <td class="l">Destinatario</td >
      <td class="L"> <%=StringUtils.toStringJSP(UffTDS)%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMASospProvv">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMASospProvv">
          </td>
        </tr>
      </table>
</form>
