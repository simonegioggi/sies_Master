...
<%if(tipoMisura.equals("REVOCAAD2744") || "REVOCAAD0232".equals(tipoMisura)){%>
    <font class="campo">Revoca Arresti Domiciliari ex art. 656 comma 10</font>
<%}else if(tipoMisura.equals("REVOCAAD2757")){%>
    <font class="campo">Revoca Domiciliari ex art. 89 dpr 309/90</font>
<%}else if(tipoMisura.equals("REVOCAAD2746")){%>
    <font class="campo">Revoca Permanenza in Casa</font>
<%}else if(tipoMisura.equals("REVOCAAD2747")){%>
    <font class="campo">Revoca Collocamento in Comunità</font>
<%}%>
</td>
...
<font class="campo">
   ...
   <tr>
     <td class="l">Data Inizio Provvedimento di Revoca</td>
...
<%-- MEV10-s3: aggiunta porzione di codice --%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadRevocaArrestiDomiciliari">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioRevocaArrestiDomiciliari">
