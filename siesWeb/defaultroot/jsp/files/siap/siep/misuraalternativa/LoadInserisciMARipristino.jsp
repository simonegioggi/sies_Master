...
<title>[S.I.E.S.] - Gestione evento </title>
   ...
   // Chiamata lista Avvocati.
    ...
    function ListaDocumentiSius(a_formname)
    {
      ...
      desktop = window.open("<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.misuraalternativa.action.ActListaDocumentiSius&formname="+a_formname+"&<%=ICostantiFascicoloSiep.CAMPO_ID_FASCICOLO_SIEP%>=<%=lFascicoloAssociato.getIdFascicoloSiep()%>&<%=ICostantiMisuraAlternativa.CAMPO_NATURA_MA%>=<%=ICostantiMisuraAlternativa.RIPRISTINO%>&<%=ICostantiMisuraAlternativa.CAMPO_TIPO_MA%>="+tipoMA, "Lista_Provvedimenti_Sius", "toolbar=no, location=no, status=no, menubar=no ,scrollbars=yes, resizable=no, width=800, height=500");
    }
  ...
  function radio()
   {
       ...
       var nodebottone;
        ...
        nodeAutoritaC=document.getElementById('divautoritaC');
        nodeSorCssa=document.getElementById('divsorcssa');
        nodebottone=document.getElementById('divbottone');
        ...
        if(document.LoadInserisciMisuraAlternativa.tipo[1].checked)
        {
         <%if(tipoSospensione.equals("AFFIDAMENTO"))
          ...
          nodeSorCssa.style.visibility='visible';
          nodeAutoritaC.style.visibility='visible';

          nodebottone.style.visibility='visible';
          nodebottone.style.top='-105px';

          nodeSorCssa.style.top='-105px';
        ...
        <%}%>
         ...
         <%if(tipoSospensione.equals("SEMILIBERTA") || 
          ...
          {%>
	           ...
	           nodebottone.style.visibility='visible';
	           nodebottone.style.top='-75px';

	           // MEV10-s3: modificata posizione div
// 			   nodeSorCssa.style.top='0px';
// 	           nodeAutoritaC.style.top='-171px'
			   nodeSorCssa.style.top='-75px';
          	   nodeIstituto.style.top='-75px';
          	   nodeAutoritaC.style.top='-75px';
        ...
        else if(document.LoadInserisciMisuraAlternativa.tipo[0].checked)
        {
          nodeIstituto.style.visibility='visible';
          nodeAutorita.style.visibility='hidden';
...
<%
  if(tipoSospensione.equals("DETENZIONE"))
  {%>
    <font class="campo">Ripristino Detenzione Domiciliare</font>
<%}else if(tipoSospensione.equals("AFFIDAMENTO"))
  {%>
    <font class="campo">Ripristino Affidamento In Prova</font>
<%}else if(tipoSospensione.equals("SEMILIBERTA"))
  {%>
    <font class="campo">Ripristino Semilibertà</font>
<%}else if(tipoSospensione.equals("INDULTINO"))
  {%>
    <font class="campo">Ripristino Sospensione Condizionata Esecuzione Pena Detentiva (L.207/2003)</font>
<%}else if(tipoSospensione.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM))
  {%>
    <font class="campo">Ripristino Espiazione Pena presso Domicilio</font>
<%}%>
</td>
</tr>
</table>
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciRipristinoMA">
...
String leggiMDS= null;
String leggiProc = null;
...
<%
        if(lFascicoloAssociato.getFlagAltraCausa()!=null && lFascicoloAssociato.getFlagAltraCausa().equals("S"))
        {
           if( lAltraCausa.getIstDetIdIstitutoDetenzione()!= null )
           {
%>
           <tr>
...
<%
        ...
        else if(lLuogoDetenzione.getIstDetIdIstitutoDetenzione()!= null )
        {
%>
          <tr>
           <td class="l">Detenuto presso </td>
...
<table width ="90%">
   <tr>
      <td class="Titolo" colspan='8'>Dati dell'Ordinanza della Sorveglianza</td>
   </tr>
   <tr>
...
String listaComuniScript = "";
    ...
    <tr>
      ...
      <td class="L" colspan="3"><font class="campo"> Rigetto </font>
<%
...
<%}else if(tipoSospensione.equals("AFFIDAMENTO") ) {%>
        <td class="l">Luogo dell'Affidamento </td>
<%}else if(tipoSospensione.equals("INDULTINO") || tipoSospensione.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM)){%>
...
<table width ="90%">
  <tr>
    ...
    <td class="l">Data di Scarcerazione &nbsp;
...
<div id="istituto" style="width: 100%; visibility:visible;  position:relative; top:0px" >
<table width="100%">
<tr>
...
<div id="divsorcssa" style="width: 100%; visibility:visible; position:relative;">
<table width ="100%">
...
<div id="divautoritaC" style="width: 100%; visibility:visible;  position:relative; " >
<table width ="100%">
 <tr>
         <input type="hidden" name="notificaSemiliberta" value="S">
