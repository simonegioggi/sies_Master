...
%>
    ...
    if (document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCADENZA_PROROGA%>.value.length==1)
			  document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCADENZA_PROROGA%>.value='0'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCADENZA_PROROGA%>.value;

	  if (document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCADENZA_PROROGA%>.value.length==1)
			  document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCADENZA_PROROGA%>.value='0'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCADENZA_PROROGA%>.value;

		  var data_to_verify_sca = document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCADENZA_PROROGA%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCADENZA_PROROGA%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCADENZA_PROROGA%>.value;

      if (!ControllaDataPassaVuota(data_to_verify_sca))
		  {
        alert('Data Scadenza proroga non valida');
        return false;
		  }
    if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCADENZA_PROROGA%>.value==""
     && !document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_FLAG_DECISIONE_TRIBUNALE%>.checked)
      {
        alert("Data Scadenza proroga o Proroga fino alla decisione del TDS Obbligatori");
        return false;
      }
    }

<%
    if(lPosizione.getCodPosizioneGiuridica().equals("03"))
    {
%>
 ...
 if(pos == "03")
  {
   if(document.LoadInserisciMisuraAlternativa.tipo[0].checked)
    ...
    if(document.LoadInserisciMisuraAlternativa.tipo[1].checked)
    {
		...
		// MEV10-s3: aggiornati valori proprietà "top"
		nodecssa.style.top='-30px';
		nodeautoritaC.style.top='-30px';
		nodesor.style.top='-30px';
		nodebottone.style.top='-30px';
...
%>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciMAProrogaProvvDetDomTemp">
...
%>
  ...
  <table width="90%">
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="l" colspan="3">
        <font class="campo">
          ...
          <a href="Javascript:ListaComuniEmitUdsMinor('LoadInserisciMisuraAlternativa','<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT%>');"><img src="/images/filefolder.gif" border=0></a>
        </font>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="l">Proroga fino alla decisione del TDS</td>
      <td class="l" colspan="3">
        <input type="checkbox" name="<%=ICostantiMisuraAlternativa.CAMPO_FLAG_DECISIONE_TRIBUNALE%>">
      </td>
   </tr>
    <tr>
      <td class="l">Data scadenza proroga</td>
      <td class="l" colspan="3">
        <font class="campo">
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCADENZA_PROROGA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
          <input value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCADENZA_PROROGA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
          <input value="" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCADENZA_PROROGA%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
        </font>
      </td>
    </tr>
    <tr>
...
%>
    ...
    //frmvalidator.addValidation("<-%=ICostantiMisuraAlternativa.CAMPO_ANNO_REGISTRO%>","//req","Il Campo Anno Decreto è obbligatorio");
    ...
    //frmvalidator.addValidation("<-%=ICostantiMisuraAlternativa.CAMPO_NUMERO_REGISTRO%>","//req","Il Campo Numero Decreto è obbligatorio");
