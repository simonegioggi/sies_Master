...
%>
  <font class="campo">Dettaglio Concessione Liberazione Condizionale</font>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 if (eventonotifica.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
 <%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
     <%--td class="LBG">
          <a href="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMACoLibCond&IdEvento=<%=eventonotifica.getEvento().getIdEvento()%>&codposizionegiuridica=<%=posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()%>&verbale=<%=verbaleSott%>" onclick="javascript:lookUpload();">
            <img align="middle" src="/images/print24.gif" alt="Generazione Stampa" width="24" height="24" border="0">
          </a>
        </td--%>
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMACoLibCond&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&codposizionegiuridica="+posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()+"&verbale="+verbaleSott%>"/>
   </jsp:include>
<%}%>
...
<%if(lPosizione.equals("03") || lPosizione.equals("14"))
{
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMACoLibCond">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMACoLibCond">
          </td>
        </tr>
      </table>
</form>
