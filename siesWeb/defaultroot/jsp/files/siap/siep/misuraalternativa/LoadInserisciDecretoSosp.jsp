...
<%
  ...
  {
%>
    <font class="campo">Sospensione Provvisoria Detenzione Domiciliare</font>
<%
  }
...
%>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciSospProvv">
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="l" colspan="3">
        <font class="campo"><%=MinorMask.comboEmittente(filtroMinorenni, MinorMask.EmittenteUfficio)%></font>
      </td>
    </tr>
    <tr>
...
<%-- MEV10-s3: modificato layout con aggiunta etichette --%>
		<div id="divsor" style="width: 100%; visibility: visible; position: relative;">
			<table width="100%">
				<tr>
     				<td class="Titolo" colspan="2">Ufficio / Magistrato di Sorveglianza</td>
   				</tr>
				<tr>
				...
				<tr>
					...
					<td class="L">
						...
						<input title="Sede Ufficio" value="" type="text" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS%>"
				...
				<tr>
     				<td class="Titolo" colspan="2">Tribunale di Sorveglianza</td>
   				</tr>
				<tr>
				...
				<tr>
					<td class="l">Sede</td>
					<td class="L">
						<input title="Sede Tribunale Sorveglianza" value="" type="text"
							name="<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS%>" maxlength="35" size="35">
