...
%>
  <font class="campo">Dettaglio Proroga Provvisoria Detenzione Domiciliare a Termine</font>
</td>
...
<%
 if(misuraalternativa.getFlagDecisioneTribunale() != null)
 {%>
        <tr>
...
<%if(misuraalternativa.getDataScadenzaProroga()!= null){%>
   <tr>
     <td class="l">Data Scadenza Proroga</td>
     <td class="l"><font class="campo">
      <%=StringUtils.toStringJSP(DateUtils.getDateToString(misuraalternativa.getDataScadenzaProroga(),"dd-MM-yyyy"))%>
      </font></td>
  </tr>
<%}%>
...
<%if(NoteUDS!= null && !NoteUDS.equals("")){%>
  <tr>
    <td class="l">Note</td>
    <td  class="L"><font class="campo"><%=NoteUDS%>&nbsp;</font></td>
  </tr>
<%}}
...
<%if(NoteTDS != null && !NoteTDS.equals("")){%>
  <tr>
    <td class="l">Note</td>
    <td  class="L"><font class="campo"><%=NoteTDS%>&nbsp;</font></td>
  </tr>
<%}}%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="tipoMisura" value="PROROGAPROVVISORIA">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
            <input type="HIDDEN" name="IdPosizioneGiuridica" value="<%=lPosizione.getIdPosizioneGiuridica()%>">
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMAProrogaProvvDetDomTemp">
          </td>
        </tr>
      </table>
</form>
