...
%>
      ...
      frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_ALTRO_TITOLO%>","lt=2099");
<%
    }
...
%>
      ...
      frmvalidator.addValidation("<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_ALTRO_TITOLO%>","lt=2099");
<%
    }
  }
%>
