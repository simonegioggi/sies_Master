...
<body class="corpo">
  ...
  <font class="campo">Dettaglio Detenzione Domiciliare a Termine</font>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 if (eventonotifica.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMADetDomTemp&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
   </jsp:include>
 <%}%>
...
<%   if((misuraalternativa.getNumAnniMisura() != null && misuraalternativa.getNumAnniMisura().compareTo(new BigDecimal(0))!=0)||
        (misuraalternativa.getNumMesiMisura() != null && misuraalternativa.getNumMesiMisura().compareTo(new BigDecimal(0))!=0) ||
        (misuraalternativa.getNumGiorniMisura() != null && misuraalternativa.getNumGiorniMisura().compareTo(new BigDecimal(0))!=0))
        {%>
        <tr>
...
<%if(misuraalternativa.getCodTipoUfficioScarcerazione()!= null  && misuraalternativa.getCodTipoUfficioScarcerazione().equals("SORV")){%>
...
<%
 if(autoritaEsternaE!= null && autoritaEsternaE.getCodTipoAutorita()!= null && autoritaEsternaE.getCodSede()!= null){%>
   ...
   <tr>
<%if(misuraalternativa != null && misuraalternativa.getIdMisuraAlternativa() != null && misuraalternativa.getDataInizioMisura()!= null )
 {%>
...
<%
if(autoritaEsternaN != null && autoritaEsternaN.getCodTipoAutorita()!= null
  && autoritaEsternaN.getCodSede()!= null && notifica!= null && notifica.getAvvIdAvvocatoFascicoloSiep() == null)
{%>
 <tr>
    <td class="l">Autorità di Polizia Competente per territorio</td>
    <td class="L">
       <font class="campo">
        <%=StringUtils.toStringJSP(autoritaEsternaN.getDescrTipoAutorita())%></font>

<%if(autoritaEsternaN!= null && !autoritaEsternaN.getDescrSede().equals("-"))
{%>
di <font class="campo"><%=StringUtils.toStringJSP(autoritaEsternaN.getDescrSede())%>
      </font>
<%}%>
     </td>
  </tr>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMADetDomTemp">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMADetDomTemp">
          </td>
        </tr>
      </table>
</form>
