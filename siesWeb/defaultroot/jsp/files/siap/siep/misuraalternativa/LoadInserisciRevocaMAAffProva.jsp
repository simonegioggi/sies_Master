...
<%
// Nel caso di Espiazione presso il domicilio vanno gestiti sia i provvedimenti 
// del TDS che del UDS. La combo motivo provv va caricata dinamicamente in funzione
// del tipo ufficio selezionato
...
%>
    ...
    {
    if (  ( "AFFIDAMENTO".equals(tipoRevoca) &&  (   lPosizione.getCodPosizioneGiuridica().equals("32") 
                                                  || lPosizione.getCodPosizioneGiuridica().equals("37")))
        ||( "INDULTINO".equals(tipoRevoca) && (   lPosizione.getCodPosizioneGiuridica().equals("35") 
                                               || lPosizione.getCodPosizioneGiuridica().equals("40")))
        ||( ICostantiMisuraAlternativa.ESP_PRESSO_DOM.equals(tipoRevoca) && (   lPosizione.getCodPosizioneGiuridica().equals("51") 
...
<%     
        ...
        if ((tipoRevoca != null && tipoRevoca.equals("AFFIDAMENTO") && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null && (lPosizione.getCodPosizioneGiuridica().equals("32") || lPosizione.getCodPosizioneGiuridica().equals("37")))
          ...
          ||(tipoRevoca != null && tipoRevoca.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM) && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null && (lPosizione.getCodPosizioneGiuridica().equals("50") || lPosizione.getCodPosizioneGiuridica().equals("51") || lPosizione.getCodPosizioneGiuridica().equals("52"))))
        {
%>
