...
if(lEventoAmmProvvAff.getIdEvento() != null && misuraalternativa != null && lPosizione.getCodPosizioneGiuridica().equals("13") && tipoMisura.equals("AFFIDAMENTO"))
{
%>
   <tr>
...
if(misuraalternativa != null && (misuraalternativa.getNumAnniRevocaArresto() != null || misuraalternativa.getNumMesiRevocaArresto() != null
   || misuraalternativa.getNumGiorniRevocaArresto() != null || misuraalternativa.getNumAnniRevocaReclusione() != null
   || misuraalternativa.getNumMesiRevocaReclusione() != null || misuraalternativa.getNumGiorniRevocaReclusione() != null))
{%>
  <tr>
