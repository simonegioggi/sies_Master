...
<jsp:useBean id="IndirizzoCssa"   scope="request" class="java.lang.String"/>
<jsp:useBean id="ComuneCssa"   scope="request" class="java.lang.String"/>
<jsp:useBean id="CssaModel"   scope="request" class="siap.sico.cssa.model.CSSAModel"/>
...
%>
  <font class="campo">Dettaglio Ulteriore periodo misura alternativa</font>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 if (eventonotifica.getEvento().getFlagDocumentoRegistrato().compareTo("N")==0) {%>
<%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
<%--td class="LBG">
	<a href="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaUlteriorePeriodoMA&IdEvento=<%= eventonotifica.getEvento().getIdEvento() %>&codposizionegiuridica=<%=posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()%>" onclick="javascript:lookUpload();">
		<img  align="middle" src="/images/print24.gif" alt="Generazione Stampa" width="24" height="24" border="0">
	</a>
</td--%>
 <!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaUlteriorePeriodoMA&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&codposizionegiuridica="+posizioneluogoaltra.getPosizioneGiuridica().getCodPosizioneGiuridica()%>"/>
   </jsp:include>
<%}%>
...
<tr>
 ...
 <td class="l"><font class="campo"><%=StringUtils.toStringJSP(ComuneCssa)%>-<%=StringUtils.toStringJSP(IndirizzoCssa)%></font></td>
  </tr>
<%if(magistrato != null){%>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadUlteriorePeriodoMA">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioUlteriorePeriodoMA">
          </td>
        </tr>
      </table>
</form>
