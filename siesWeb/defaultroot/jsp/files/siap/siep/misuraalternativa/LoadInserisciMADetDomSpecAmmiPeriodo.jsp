...
*/
 if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA %>.value=="")
        {
          alert("L'Uffico di Sorveglianza è obbligatorio");
        ...
        {
          alert("La Sede dell'Uffico Emittente è obbligatoria");
...
%>
        ...
        {
          alert("Indicare la Data di Scarcerazione");
          return false;
        }
<%
      }
...
%>
        <font class="campo">Ammissione ad un periodo</font>
      </td>
    </tr>
  </table>
  <br>
  ...
  <INPUT type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInserisciMADetDomSpecAmmiPeriodo">
...
<%
  ...
  if(lcodicePosizione.equals("03"))
  {
    ...
    String disabilitaTDS = null;
    String disabilitaPROC = null;
      ...
      )
    {
      ...
      disabilitaPROC= "disabled";

    }
    else if( misuraalternativa.getIdMisuraAlternativa() != null
      && misuraalternativa.getCodTipoUfficioScarcerazione() != null
      && !misuraalternativa.getCodTipoUfficioScarcerazione().equals("")
...
%>
    <tr>
      <td class="l">Eseguito da Procura &nbsp;<input type="radio" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_TIPO_UFFICIO_SCARCERAZIONE%>" value="PROC" <%=checkProcura%> <%=disabilitaPROC%>>
      &nbsp; Eseguito da TDS  &nbsp; <input type="radio" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_TIPO_UFFICIO_SCARCERAZIONE%>" value="SORV" <%=checkSorv%> <%=disabilitaTDS%>></td>
...
// Anno/Progr Sius
      ...
      frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS%>","req","Luogo Tribunale di Sorveglianza obbligatorio");
...
<%
    ...
    {
%>
      frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_SEDE_POL_E %>","req","Luogo Autorità Destinazione obbligatorio");
...
<%
    ...
    {
%>
      frmvalidator.addValidation("<%=ICostantiMisuraAlternativa.CAMPO_SEDE_POL_C %>","req","Luogo Autorità Destinazione obbligatorio");
