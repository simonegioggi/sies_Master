...
<jsp:useBean id="flagceck"      scope="request" class="java.lang.String"/>
...
<body class="corpo">
<input type="HIDDEN" name="<%=ICostantiMisuraAlternativa.CAMPO_COD_TIPO_UFFICIO_SCARCERAZIONE%>" value="<%=flagceck%>">
  <table>
...
%>
  <font class="campo">Dettaglio Ammissione Provvedimento da Detenzione domicilire speciale e detenzione domiciliare</font>
</td>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()!=null)
 ...
 <%-- MEV NUOVA INFRASTRUTTURA: refactoring --%>
     <%--td class="LBG">
      <a href="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaAmmissioneADetDom&IdEvento=<%=eventonotifica.getEvento().getIdEvento() %>&flagceck=<%=misuraalternativa.getCodTipoUfficioScarcerazione() %>" onclick="javascript:lookUpload();">
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%=  "/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaAmmissioneADetDom&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&flagceck="+misuraalternativa.getCodTipoUfficioScarcerazione()%>"/>
   </jsp:include>
<%}%>
<%if (eventonotifica.getEvento().getFlagDocumentoRegistrato()==null)
 {%>
...
%>
         ...
         <td class="L" >
           <font class="campo"><%=StringUtils.toStringJSP(DateUtils.getDateToString(penaresidua.getDataFine(), "dd-MM-yyy") )%></font></td>
...
<%if(misuraalternativa.getChiaveAnnoFascicoloSius()!= null && misuraalternativa.getChiaveProgrFascicoloSius()!= null){%>
 <tr>
...
<%for(int cont=0;cont < eventonotifica.getNotifiche().length;cont++)
{
if(eventonotifica.getNotifiche()[cont].getCodTipoNotifica().equals("E"))
  {%>
<tr>
    <td class="l">Destinatario per l'esecuzione </td>
    <td class="L"><font class="campo"><%=StringUtils.toStringJSP(eventonotifica.getNotifiche()[cont].getAutoritaEsterna().getDescrTipoAutorita())%></font>
     </td>
   </tr>
   <tr>
      <td class="l">Sede  </td>
...
<td class="l">Note</td>
    <td class="l">
         <font class="campo"><%=StringUtils.toStringJSP(eventonotifica.getNotifiche()[cont].getNote())%>&nbsp;</font>
    </td>
</tr>
<%cont++;%>
<%}
if(eventonotifica.getNotifiche()[cont].getCodTipoNotifica().equals("C"))
  {%>
<tr>
...
<%cont++;%>
  ...
  <tr>
     <td class="l">Sede</td><td class="L">
      <font class="campo"><%=StringUtils.toStringJSP(sedeUfficioEmittente.getDescrComune())%></font>
     </td>
  </tr>
<tr>
 <td class="l">Note</td>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadAmmissioneADetDom">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioAmmissioneADetDom">
          </td>
        </tr>
      </table>
</form>
