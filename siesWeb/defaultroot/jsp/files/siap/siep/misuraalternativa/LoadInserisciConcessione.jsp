...
<%
// Se provengo dal Verbale Sottoscrizione, viene caricata e passata alla form
// la Misura Alternativa di concessione
%>
...
<%       // AMBROSINO   - 23-12-2010 
  //============================================================================
  // Controllo sui campi: Scarcerato/da scarcerare, Data Scarcerazione, 
  //                      Data Ammissione Provvisoria
  //============================================================================
...
<%--     		document.getElementById('<%=MinorMask.ComboCSSAId%>').value == "-") { 
	...
	if (document.getElementById('divsor') && document.getElementById('divsor').style.visibility != 'hidden' && !document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_COD_UDS%>.disabled) {
...
<%if(!tipoMisura.equals("INDULTINO")  &&
		 !tipoMisura.equals("ESP_PRESSO_DOM"))
{%>
	<%-- MEV10-s3: modificato il controllo: document.getElementById('nodesor') && (nodesor.style.visibility!='hidden') && --%>
	<%-- 20170908: [SG] aggiunte and condition --%>
	if (document.getElementById('divsor') && document.getElementById('divsor').style.visibility!='hidden' && !document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_SEDE_TDS%>.disabled) {
...
%>
    	...
    	<%--- fine ELSE di else if((pos == "03") ||(flagsanzione == "S" && pos=="19")
    		|| (pos == "14" && (tipomisuraJS != "INDULTINO" && tipomisuraJS != "ESP_PRESSO_DOM"))) --%>
...
%>
	   <tr>
	    ...
	    <tr>
	      ...
	      <td class="l"> Anno / Numero Ordinanza</td>
	      <td class="l">
	        <input Title="Anno Ordinanza" name="<%=ICostantiMisuraAlternativa.CAMPO_ANNO_REGISTRO%>" 
	               type="text" size="4" maxlength="4" 
	               onkeypress="return TicTabNumField(this,event)"  onBlur="javascript:value=FillYear(value)"
	               onChange="pulisciId();">
	        /
	        <input Title="Numero Ordinanza" name="<%=ICostantiMisuraAlternativa.CAMPO_NUMERO_REGISTRO%>" type="text" size="6" maxlength="6" onkeypress="return TicTabNumField(this,event)" onChange="pulisciId();">
	      </td>
	    </tr>
	    <tr>
	      <td class="l">Ufficio Emittente</td>
	...
	String listaComuniScript = "";	
	    if(tipoMisura != null && 
	      (tipoMisura.equals("INDULTINO") || tipoMisura.equals("ESP_PRESSO_DOM") ) )
	    {
...
<%	}
 ...
 <%   }   // AMBROSINO 12-2010 Chiude la Elese della if MisAlt != null %>
</table>
<table>
<%
	// -- AMBROSINO 12-2010
...
<%
	...
	else if(lPosizione.isDetenuto() || lPosizione.getCodPosizioneGiuridica().equals("14")	// Espiazione Pena in Regime di Semilibertà 
									|| lPosizione.getCodPosizioneGiuridica().equals("43")	// Espiazione Pena in Regime di Semilibertà in Prosec.Provv. 51 Bis
...
<%
      ...
      // AMBROSINO -FINE  1-2010 TOLGO UNA PARENTESI CHIUSA '{'
%>
</table>
...
%>
        <table>
         ...
         <table>
          <tr><td class="l" width="35%">Autorita' Destinazione </td >
          <td class="L" colspan="3">
