...
%>
		  ...
		  var data_to_verify_ing = document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INGRESSO_ISTITUTO%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INGRESSO_ISTITUTO%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%=ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INGRESSO_ISTITUTO%>.value;
...
<%}%>
  ...
  if(document.LoadInserisciMisuraAlternativa.<%=ICostantiMagistrato.CAMPO_COGNOME %>.value=="" && document.LoadInserisciMisuraAlternativa.<%=ICostantiMagistrato.CAMPO_NOME %>.value=="")
  {
	...
	if(document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.value=="" || document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.value=='-')
	{
		alert("L'Ufficio Emittente e la Sede Ufficio Emittente sono obbligatorie");
	    document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_SEDE_TDS_EMITT %>.focus();
	    return false;
	}
...
// MEV10-s3: commentata funzione NON utile e utilizzabile
...
//  	//alert("decisioneMagistrato "+decisioneMagistrato);
//  	//alert("decisioneTribunale "+decisioneTribunale);
...
<%--  	    			document.LoadInserisciMisuraAlternativa.<%=ICostantiEvento.CAMPO_COD_MOTIVO_TRIBUNALE%>.value=="-")) --%>
//  	{
//  		alert("L'Oggetto Decreto è obbligatorio");
//  		return false;
//  	}
...
//  	if((campoSedeTdsEmitt.value=="" || campoSedeTdsEmitt.value=="-") && (campoSedeTdsEmitt.value=="" || campoSedeTdsEmitt.value=="-"))
//  	{
//  		alert("L'Ufficio Emittente e la Sede Ufficio Emittente sono obbligatorie");
//  		return false;
//  	}
<%--  	var campoCodTipoAutorita = document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_COD_POLIZIA_E %>.value; --%>
//  	if((campoCodTipoAutorita.value=="" || campoCodTipoAutorita.value=="-") && (campoCodTipoAutorita.value=="" || campoCodTipoAutorita.value=="-"))
//  	{
//  		alert("L'Autorità competente per territorio è obbligatoria");
//  		return false;
//  	}
...
//  	if((campoIstDetIdIstDet.value=="" || campoIstDetIdIstDet.value=="-") && (campoIstDetIdIstDet.value=="" || campoIstDetIdIstDet.value=="-"))
//  	{
//  		alert("L'Istituto di Detenzione è obbligatoria");
//  		return false;
//  	}
<%--  	var campoCodUds = document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_COD_UDS %>.value; --%>
//  	if((campoCodUds.value=="" || campoCodUds.value=="-") && (campoCodUds.value=="" || campoCodUds.value=="-"))
//  	{
...
//  	if((campoSedeTds.value=="" || campoSedeTds.value=="-") && (campoSedeTds.value=="" || campoSedeTds.value=="-"))
//  	{
//  		alert("Il Tribunale di Sorveglianza è obbligatorio");
//  		return false;
//  	}
<%--  	var campoCodTribunale = document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_COD_TRIBUNALE %>.value; --%>
//  	if((campoCodTribunale.value=="" || campoCodTribunale.value=="-") && (campoCodTribunale.value=="" || campoCodTribunale.value=="-"))
//  	{
//  		alert("Il Tribunale di Sorveglianza è obbligatorio");
//  		return false;
//  	}
...
%>
 ...
 <br>
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActInsSospProvvArrestiDomiciliari">
   ...
   <tr>
    ...
    <tr>		
	    ...
	    <td class="l" colspan="3">	      
	      <%=MinorMask.comboEmittente(filtroMinorenni, MinorMask.EmittenteAutoritaUff,"",ICostantiMisuraAlternativa.CAMPO_COD_UFFICIO_SORVEGLIANZA)%>
	    </td>	         	     
	</tr>
...
%>
      <td class="l">Data Ingresso in carcere &nbsp;
        <input title = "Giorno Data Ingresso in carcere" value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INGRESSO_ISTITUTO%>" <%=IWebConstants.UTIL_DATA%> > -
        <input title = "Mese Data Ingresso in carcere" value="" type="text" size="2" maxlength="2" name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INGRESSO_ISTITUTO%>" <%=IWebConstants.UTIL_DATA%> > -
        <input title = "Anno Data Ingresso in carcere" value="" type="text" size="4" maxlength="4" name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INGRESSO_ISTITUTO%>" <%=IWebConstants.UTIL_DATA_ANNO%> >
      </td>
<%
    }
%>
...
<div id="autorita" style="width: 100%; visibility:hidden; position:relative; top:0px;" >
<table width ="100%">
     <tr>
	 <!--autorità esterna e-->
...
<div id="istituto" style="width: 100%; visibility:visible;  position:relative; top:-75px" >
<table width="100%">
<tr>
...
<tr>
	<td class="lNoBord" colspan="2">
		<%-- MEV10-s3: modificata chiamata metodo di verifica dati --%>
