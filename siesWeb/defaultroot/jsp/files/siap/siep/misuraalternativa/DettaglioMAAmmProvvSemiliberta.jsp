...
<table>
  <tr>
    ...
    <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
      <font class="campo">Dettaglio Ammissone Provvisoria Semilibertà</font>
    </td>
...
%>  
  ...
  <td class="LBG">
   ...
   <jsp:include page="<%=ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActStampaMAAmmProvSemiliberta&IdEvento="+eventonotifica.getEvento().getIdEvento()+"&tipoMisura="+tipoMisura%>"/>
   </jsp:include>
<%}%>
...
{%>
  ...
  <td class="LBG">
    <a href="/jsp/Main.jsp?Action=siap.siep.misuraalternativa.action.ActUploadMAAmmProvSemiliberta&<%=ICostantiEvento.CAMPO_ID_EVENTO%>=<%=eventonotifica.getEvento().getIdEvento()%>&<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>=siap.siep.misuraalternativa.action.ActDettaglioMAAmmProvSemiliberta&<%=ICostantiEvento.CAMPO_VALIDA%>=S&noblob=S">
...
<form method="POST" action="<%=IWebConstants.PG_MAIN%>" name="modifica">
  ...
  <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActLoadModificaMAAmmProvSemiliberta">
</form>
<% } %>   
...
<% if(autoritaEsternaE!= null && autoritaEsternaE.getCodTipoAutorita() != null && autoritaEsternaE.getCodSede()!= null) {%>
  <tr>
    ...
    <td class="L">
      ...
      <% if(!autoritaEsternaE.getDescrSede().equals("-")) { %>
 ...
 <br>
  ...
  <div align=left style="visibility:hidden" id="upld">
    <FORM name="comandi" enctype="multipart/form-data" method="post" onSubmit="return controllaUpload();">
      <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.misuraalternativa.action.ActUploadMAAmmProvSemiliberta">
      <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_ID_EVENTO%>" value="<%= eventonotifica.getEvento().getIdEvento() %>">
      <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.misuraalternativa.action.ActDettaglioMAAmmProvSemiliberta">
      <table>
