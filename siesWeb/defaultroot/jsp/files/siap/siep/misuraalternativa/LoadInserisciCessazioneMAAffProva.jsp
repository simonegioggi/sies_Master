...
//==============================================================================    
    ...
    if(document.LoadInserisciMisuraAlternativa.tipo[1].checked == true)
    {
        ...
        ||document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INGRESSO_ISTITUTO%>.value != "" )
      {
        ...
        var data_to_verify = document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INGRESSO_ISTITUTO%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INGRESSO_ISTITUTO%>.value+'-'+document.LoadInserisciMisuraAlternativa.<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INGRESSO_ISTITUTO%>.value;
    ...
    <%
    if (  (tipoRevoca != null && tipoRevoca.equals("AFFIDAMENTO") && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null && (lPosizione.getCodPosizioneGiuridica().equals("32") || lPosizione.getCodPosizioneGiuridica().equals("37")))
        ||(tipoRevoca != null && tipoRevoca.equals("INDULTINO") && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null && (lPosizione.getCodPosizioneGiuridica().equals("35") || lPosizione.getCodPosizioneGiuridica().equals("40")))
        ||(tipoRevoca != null && tipoRevoca.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM) && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null && (lPosizione.getCodPosizioneGiuridica().equals("51") || lPosizione.getCodPosizioneGiuridica().equals("52"))))
    {
    %>
...
<%     
        ...
        if (  ( tipoRevoca.equals("AFFIDAMENTO") &&  (   lPosizione.getCodPosizioneGiuridica().equals("32") // sosp 51 ter
                                                      || lPosizione.getCodPosizioneGiuridica().equals("37") // sosp 51 bis
                                                      || lPosizione.getCodPosizioneGiuridica().equals("13") // in Misura!!
                                                     )
              )
            ||( tipoRevoca.equals("INDULTINO") && (   lPosizione.getCodPosizioneGiuridica().equals("35") 
...
<%
        ...
        { // Soggetto non in sospensione: dest is Autorità per l'esecuzione
%> 
          nodeist.style.display='none'; 
          nodeaut.style.display='block';
...
<body class="corpo" onload="caricaComboOggetto();functionRadio();">
  ...
  <tr>
    <td class="l">Ufficio Emittente</td>
      ...
      %>
        ...
        { // Nel caso di INDULTINO e ESP_PRESSO_DOM l'Uff emittente può essere sia il TDS che il MDS 
        %>
...
{ 
// if(nuovapenaresidua != null && nuovapenaresidua.getIdPenaResidua()!= null)
// nuovapenaresidua è null sto caricando per la prima volta la form
%>
   <tr>
...
if(   misuraalternativa == null 
   ...
   || nuovapenaresidua == null 
   || nuovapenaresidua.getIdPenaResidua() == null
  )
{
%>
...
%>
    ...
    <% // Se soggetto in MISURA visualizza i giorni espiati da detrarre
      if(   (   tipoRevoca.equals("AFFIDAMENTO") 
             && lPosizione.getCodPosizioneGiuridica().equals("13")  // Espiazione Pena in Regime di Affidamento in Prova
            )
         || (   tipoRevoca.equals("INDULTINO") 
             && lPosizione.getCodPosizioneGiuridica().equals("27") // Sospensione Pena ex L. 207/03
            )
         || (   tipoRevoca.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM) 
...
<%
    ...
    { // Fase di inserimento del Provvedimento SIEP, visualizzo i dati dell'ordinanza
...
{ 
  ...
  // viene visualizzata sia in fase di inserimento dell'ordinanza sia in fase di inserimento del
  // provvedimento SIEP
%>
  <table>
    <tr>
    <% if(nuovapenaresidua != null && nuovapenaresidua.getIdPenaResidua()!= null) { %>
      ...
      &nbsp; Esecuzione contro soggetto detenuto  &nbsp; <input type="radio" name="tipo" value="detenuto"  <%=StringUtils.toStringJSP(scarceratodisabilita)%> <%=StringUtils.toStringJSP(scarcerato)%> onclick="functionRadio();"></td>
      <td  class="l">Dal &nbsp;
        <%
        if(   (misuraalternativa != null && misuraalternativa.getIdMisuraAlternativa()!= null)
    ...
    %>
      ...
      &nbsp; Esecuzione contro soggetto detenuto  &nbsp; <input type="radio" name="tipo" value="detenuto" onclick="functionRadio();"></td>
      <td  class="l">Dal &nbsp;
        <input type="text" size="2" maxlength="2" value=""  name="<%=ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INGRESSO_ISTITUTO%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
        <input type="text" size="2" maxlength="2" value=""  name="<%= ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INGRESSO_ISTITUTO%>"  onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)"> -
        <input type="text" size="4" maxlength="4" value=""  name="<%= ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INGRESSO_ISTITUTO%>" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillYear(value)">
...
if(   (  tipoRevoca != null && lPosizione!= null && lPosizione.getCodPosizioneGiuridica()!= null )
   &&(   (  tipoRevoca.equals("AFFIDAMENTO") && lPosizione.getCodPosizioneGiuridica().equals("13") )
      ...
      || (  tipoRevoca.equals(ICostantiMisuraAlternativa.ESP_PRESSO_DOM)  && lPosizione.getCodPosizioneGiuridica().equals("50") )
     )
  )
{
  if(misuraalternativa == null || misuraalternativa.getIdMisuraAlternativa() == null)
