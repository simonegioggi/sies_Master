...
function Verifica()
  {
    ...
    if (cod == "Sentenza"){
    	var data_sentenza=document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_GIORNO_DATA_SENTENZA_REVOCA%>.value+'/'+document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_MESE_DATA_SENTENZA_REVOCA%>.value+'/'+document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_ANNO_DATA_SENTENZA_REVOCA%>.value;
    	...
    	var data_ordi=document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_GIORNO_DATA_ORDINANZA_REVOCA%>.value+'/'+document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_MESE_DATA_ORDINANZA_REVOCA%>.value+'/'+document.LoadInserisciAnnotazioneRevoca.<%=ICostantiPenaSospesa.CAMPO_ANNO_DATA_ORDINANZA_REVOCA%>.value;
    ...
    <tr>
      <td colspan="2">
    	...
    	<tr>
    	  	...
    	  	<td class="l">
	        	<input Title="Giorno Arrivo Atto" type="text" value="" name="<%=ICostantiPenaSospesa.CAMPO_GIORNO_DATA_ARRIVO_ATTO %>"
	        	...
	        	-
	        	<input Title="Mese Arrivo Atto" type="text" value="" name="<%=ICostantiPenaSospesa.CAMPO_MESE_DATA_ARRIVO_ATTO%>"
	        		maxlength="2" size="2" onFocus="javascript:textboxSelect(this)" onkeypress="return TicTabNumField(this,event)" onBlur="javascript:value=FillDM(value)">
	        	-
	        	<input Title="Anno Arrivo Atto" type="text" value="" name="<%=ICostantiPenaSospesa.CAMPO_ANNO_DATA_ARRIVO_ATTO%>"
