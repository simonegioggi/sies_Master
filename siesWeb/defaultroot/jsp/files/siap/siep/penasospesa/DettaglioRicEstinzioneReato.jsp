...
<html>
<head>
  <title>[S.I.E.S.] - Dettaglio Richiesta Estinzione Reato </title>
...
<table>
  <tr>
    ...
    <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
      <font class="campo">Dettaglio Richiesta Estinzione Reato</font>
    </td>
    ...
    %>
      <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
        <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.penasospesa.action.ActStampaRicEstinzioneReato&IdEvento="+eventonotifica.getEvento().getIdEvento()%>"/>
      </jsp:include>
    <%
    } 
    %>
  ...
  <td class="l">
    <font class="campo">
    <%=(eventonotifica.getCampoNote() != null && eventonotifica.getCampoNote().length > 0)  ? eventonotifica.getCampoNote()[0].getDescr() : " "%>
    </font>
  </td>
</tr>
  </table>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiEvento.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.penasospesa.action.ActDettaglioRicEstinzioneReato">
          </td>
        </tr>
      </table>
</form>
