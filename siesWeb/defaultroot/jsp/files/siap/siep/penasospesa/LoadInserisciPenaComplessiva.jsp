...
//  - Continuazione
//==============================================================================
  session.setAttribute("penaComplessivaSanzioneSostitutiva","");
...
function prosegui()
{
	...
	if (op!=null)
		op.LoadInserisciRichiestaRevoca.pcompl.value= conto;
	else
		window.parent.opener.document.LoadInserisciRichiestaRevoca.pcompl.value= conto;
  	window.parent.close();
}      
</script>
<script language="JavaScript">
...
%>      
      ...
      <table cellspacing="2" cellpadding="2">
        ...
        <tr>
          <td class="l">Pena Pecuniaria MULTA</td>
          <td class="l">
<%
...
%>      
          ...
          <td class="l">Pena Pecuniaria AMMENDA</td>
          <td class="l">
<%
...
%>
      ...
      <table cellspacing="2" cellpadding="2" width="100%">
        ...
        <tr>
          <td colspan="2">
            <br>
            <input class="bottone" type="submit" name="INSERISCI" value="Conferma" onclick="javascript:prosegui();">
          </td>
        </tr>
  </table>
  ...
  <input type="HIDDEN" name="dapenacomplessiva" value="SI">
