...
function Verify() {
	...
	/* fine modifica 09/03/2009 */

	// MEV_2025-48
	if (document.LoadInserisciFascicolo.tipoV[0].checked == false
			&& document.LoadInserisciFascicolo.tipoV[1].checked == false
			&& document.LoadInserisciFascicolo.tipoV[3].checked == false
			&& document.LoadInserisciFascicolo.tipoV[4].checked == false
			&& document.LoadInserisciFascicolo.tipoV[5].checked == false
			&& document.LoadInserisciFascicolo.tipoV[6].checked == false) {
