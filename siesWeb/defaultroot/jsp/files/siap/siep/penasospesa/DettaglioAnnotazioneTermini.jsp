...
<table>
  <tr>
    ...
    <td class="LBG"><font class="label">Funzione :</font>&nbsp;&nbsp;
      <font class="campo">Dettaglio Annotazione Termini Adempimento Obblighi</font>
    </td>
  </tr>
</table>
  <br>
    ...
    <%=annotazioneManuale.getMotivazioni()%>
	 ...
	 <tr>
      ...
      <td class="l"> Stabilisce termine adempimento obblighi in &nbsp;&nbsp;
        Anni&nbsp; <font class="campo"><%=StringUtils.toStringJSP (annotazioneManuale.getNumAnniReclusione(),"0")%> </font>
        Mesi&nbsp;  <font class="campo"><%=StringUtils.toStringJSP (annotazioneManuale.getNumMesiReclusione(),"0")%> </font>   
       Giorni&nbsp; <font class="campo"><%=StringUtils.toStringJSP (annotazioneManuale.getNumGiorniReclusione(),"0")%> </font>
      </td>
      </tr>
