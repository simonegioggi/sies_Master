...
<html>
<head>
  <title>[S.I.E.S.] - Riscontro Trasmissioni - Ricerca Istanze Trasmesse</title>
  ...
  <script language="JavaScript">
    ...
    function Verify()
    {
      var data_inizio=document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_GIORNO_DATA_TRASMISSIONE_INIZIO%>.value+'/'+document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_MESE_DATA_TRASMISSIONE_INIZIO%>.value+'/'+document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_ANNO_DATA_TRASMISSIONE_INIZIO%>.value;
      var data_fine=document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_GIORNO_DATA_TRASMISSIONE_FINE%>.value+'/'+document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_MESE_DATA_TRASMISSIONE_FINE%>.value+'/'+document.LoadListaIstanzeTrasmesse.<%=ICostantiSicoJMS.CAMPO_ANNO_DATA_TRASMISSIONE_FINE%>.value;
      ...
      if( (document.LoadListaIstanzeTrasmesse.<%=ICostantiSiepJMS.CAMPO_TIPO_UFFICIO%>.value.length > 1)
           && (document.LoadListaIstanzeTrasmesse.<%=ICostantiSiepJMS.CAMPO_SEDE_UFFICIO%>.value.length == 0) )
      {
      ...
      if( (document.LoadListaIstanzeTrasmesse.<%=ICostantiSiepJMS.CHIAVE_PROGR_SIEP%>.value.length != 0)
           && (document.LoadListaIstanzeTrasmesse.<%=ICostantiSiepJMS.CHIAVE_ANNO_SIEP%>.value.length == 0) )
      {
  ...
  <body class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class="LBG"><font class="label">Funzione :</font>&nbsp;<font class="campo">Ricerca Istanze Trasmesse: </font>
        </td>
      </tr>
    </table>
    <FORM method="POST" action="<%=IWebConstants.PG_MAIN%>" name='LoadListaIstanzeTrasmesse'>
      <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.jms.action.ActListaIstanzeTrasmesse">
      ...
      <tr>
        ...
        <td class="l">
          <input Title="Sede Ufficio" name="<%=ICostantiSiepJMS.CAMPO_SEDE_UFFICIO%>" type="text" maxlength="35" size="35">
            <a href="Javascript:ListaUffici('LoadListaIstanzeTrasmesse','<%= ICostantiSiepJMS.CAMPO_SEDE_UFFICIO %>');">
  ...
  <input type="HIDDEN" name="<%=IWebConstants.LINK_RITORNO%>" value="<%=TornaQui%>" >
    ...
    <script language="JavaScript" type="text/javascript">
      ...
      var frmvalidator  = new Validator("LoadListaIstanzeTrasmesse");
