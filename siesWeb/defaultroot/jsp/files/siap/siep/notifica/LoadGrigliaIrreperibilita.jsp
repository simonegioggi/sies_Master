...
<html>
<head>
  <title>[S.I.E.S.] - IRREVOCABILITA' </title>
  ...
  <table>
    <tr>
      <td class="LBG">
        ...
        <font class="campo">IRREPERIBILITA'</font>
      </td>
      <td class="LBG">
      </td>
     </tr>
    ...
    <table cellpadding="1" cellspacing="1" width="95%" onMouseover="over_effect(event,'outset')" onMouseout="over_effect(event,'solid')" onMousedown="over_effect(event,'inset')" onMouseup="over_effect(event,'outset')">
      ...
      <tr>
        <td width="32%" class="menulines" nowrap>
          <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.sospensione.action.ActLoadInserisciDecretoSospensione">Decreto</a>
        </td>
        <td width="32%" class="menulines" nowrap>
          <a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.notifica.action.ActLoadRicercaNotificaDecretoIrreperibilita">Registrazione Notifica</a>
        </td>
      </tr>
  </table>
</body>
