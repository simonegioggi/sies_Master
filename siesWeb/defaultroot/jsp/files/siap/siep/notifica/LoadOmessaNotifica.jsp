...
<script language="JavaScript">
	...
	function Verify()
	{
		if(document.LoadOmessaNotifica.Notifica[0].checked)
		{
			if(document.LoadOmessaNotifica.Rinnovo[1].checked)
			{
	    	if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value.length==1)
				  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value;
			  if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value.length==1)
				  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value;

			  var data_to_verify = document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RA%>.value;
		...
		{
	    if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value;
		  if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value;

		  var data_to_verify = document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO%>.value;
 ...
 {
    if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RELATA%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RELATA%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RELATA%>.value;
		  if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RELATA%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RELATA%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RELATA%>.value;

		  var data_to_verify = document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RELATA%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RELATA%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RELATA%>.value;
 ...
 if(document.LoadOmessaNotifica.Ufficiali[1].checked)
 {
    if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value;
		  if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value;

		  var data_to_verify = document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_AR%>.value;
   ...
   {
    if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value;
		  if (document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value.length==1)
			  document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value='0'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value;

		  var data_to_verify = document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value+'-'+document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RN%>.value;
  ...
  document.LoadOmessaNotifica.INSERISCI.disabled=true;
}
  ...
  if(document.LoadOmessaNotifica.Notifica[0].checked)
    {
     ...
     // if per gestire autorità delegata
      if(document.LoadOmessaNotifica.Rinnovo[1].checked)
      {
        ...
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value = giorno;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value = mese;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RA%>.value = anno;

        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value = "";
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value = "";
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO%>.value = "";
      ...
      }else
      {
        ...
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value = giorno;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value = mese;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO%>.value = anno;

        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RA%>.value = "";
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RA%>.value = "";
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RA%>.value = "";
     ...
     if(lverbale == null)
    ...
    }else
      {
        ...
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RELATA%>.value = giorno;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RELATA%>.value = mese;
        document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RELATA%>.value = anno;

        // if per gestire la ricerca o notifica dell'Ufficile giudiziario
           if(document.LoadOmessaNotifica.Ufficiali[0].checked)
           {
             nodeNo.style.visibility='visible';
             nodeRi.style.visibility='hidden';

             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value = giorno;
             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value = mese;
             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RN%>.value = anno;

             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value = "";
             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value = "";
             document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_AR%>.value = "";
           ...
           }else
           {
            ...
            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_AR%>.value = giorno;
            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_AR%>.value = mese;
            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_AR%>.value = anno;

            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO_RN%>.value = "";
            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO_RN%>.value = "";
            document.LoadOmessaNotifica.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RN%>.value = "";
  ...
  <br>
   ...
   <tr>
    ...
    <table>
      <tr>
        <td class="LGB">
          <a href="Javascript:ListaNotifiche('LoadOmessaNotifica',<%=notifica.getIdNotifica()%>);">Elenco Notifiche Precedenti</a>
        </td>
      </tr>
    </table>
...
<table width="100%">
      ...
      <tr>
         ...
         <td class="L">
            ...
            <a href="Javascript:ListaComuni('LoadOmessaNotifica','<%= ICostantiRinnovo.CAMPO_COD_LUOGO_RINNOVO %>');">
...
<table width=100%>
      ...
      <%if(notifica != null && notifica.getAutoritaEsterna() != null &&
         ...
         <%}else
          ...
          <%}%>
             <a href="Javascript:ListaComuni('LoadOmessaNotifica','<%= ICostantiVerbale.CAMPO_COD_LUOGO_UFFICIO_FIRMATARIO_UG%>');">
              <img src="/images/filefolder.gif" border=0>
             </a>
         </td>
       <td class="l" >in data
...
<table width=100%>
      <tr>
         ...
         <td class="L">
            ...
            <a href="Javascript:ListaComuni('LoadOmessaNotifica','<%= ICostantiRinnovo.CAMPO_COD_LUOGO_RINNOVO_UG%>');">
            <img src="/images/filefolder.gif" border=0>
            </a>
         </td>
      </tr>
...
<table width=100%>
      ...
      <tr>
         ...
         <td class="L">
            ...
            <a href="Javascript:ListaComuni('LoadOmessaNotifica','<%= ICostantiRinnovo.CAMPO_COD_LUOGO_RINNOVO_UG_AR%>');">
            <img src="/images/filefolder.gif" border=0>
            </a>
         </td>
      </tr>
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadOmessaNotifica");
...
if(document.LoadOmessaNotifica.Notifica[0].checked)
 ...
 if(document.LoadOmessaNotifica.Rinnovo[1].checked)
 {
  ...
  frmvalidator.addValidation("<%= ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RA%>","lt=2050");
...
}else if(document.LoadOmessaNotifica.Notifica[1].checked)
 {
  ...
  frmvalidator.addValidation("<%= ICostantiRinnovo.CAMPO_ANNO_DATA_RELATA%>","lt=2050","Il campo luogo relata rinnovo è alfabetico");
 ...
 if(document.LoadOmessaNotifica.Ufficiali[1].checked)
 {
  ...
  frmvalidator.addValidation("<%= ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_AR%>","lt=2050");
  ...
  frmvalidator.addValidation("<%=  ICostantiRinnovo.CAMPO_COD_LUOGO_RINNOVO_UG_AR%>","alphabetic","Il campo luogo rinnovo rinnovo è alfabetico")
 }else
   {
    ...
    frmvalidator.addValidation("<%= ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO_RN%>","lt=2050");
