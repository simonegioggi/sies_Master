...
// Ticket#20190906015 - Impossibile registrare la data della notifica al difensore
...
if (lLungNot == 1) {
	NotificaModel lNotMod = new NotificaModel();
	lNotMod = (NotificaModel)lNot.get(0);		
	if (lNotMod != null && lNotMod.getAutoritaEsternaDelegata() != null
			&& lNotMod.getAutoritaEsternaDelegata().getIdAutoritaEsterna() != null) {
%>
...
<table>
	<tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
		<td class="LBG">
	  		...
	  		<font class="campo">Modifica Avvenuta Notifica al Difensore</font>
	 	</td>
	</tr>
</table>
<br>
	...
	<tr>		           
        <td class="l">Autorità che ha effettuato la notifica</td>
     	<td class="l" colspan="2">
			<select Title="Autorità che ha effettuato la notifica"  class="small" name="<%=ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA%>">
<%
...
%>
	...
	<tr>				       
     	<td class="l">Sede</td>
	 	<td class="L">
			<input readOnly title="Sede Autorità che ha effettuato la notifica" value="<%= lNotMod.getAutoritaEsternaDelegata()!= null ? StringUtils.toStringJSP(lNotMod.getAutoritaEsternaDelegata().getDescrSede()) : ""%>" type="text" name="<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE %>"  maxlength="35" size="35">
...
%>
			<TEXTAREA readOnly title="Indirizzo" name="<%=ICostantiAutoritaEsterna.CAMPO_DESCRIZIONE%>" cols=30><%=StringUtils.toStringJSP(StringUtils.toStringJSP(lNotMod.getAutoritaEsternaDelegata().getDescrizione()))%></TEXTAREA>
<%
		} else {
%>
