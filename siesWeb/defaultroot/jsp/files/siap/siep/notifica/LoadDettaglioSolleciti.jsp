...
<table>
  ...
  <%if(Notifica != null && Notifica.equals("FP"))
    {%>
        <font class="campo">Dettaglio Solleciti Forza di Polizia</font>
  <%}else if(Notifica != null && Notifica.equals("UG")){%>
        <font class="campo">Dettaglio Solleciti Ufficiali Giudiziari</font>
     <%}%>
      </td>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.notifica.action.ActStampaSolleciti&idrinnovo="+rinnovo.getIdRinnovo()+"&notifica="+Notifica%>"/>
   </jsp:include>
     <%}%>
     </tr>
</table>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiNotifica.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.notifica.action.ActLoadDettaglioSolleciti">
          </td>
        </tr>
      </table>
</form>
