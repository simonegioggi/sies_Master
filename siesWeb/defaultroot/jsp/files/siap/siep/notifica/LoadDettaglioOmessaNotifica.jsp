...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.notifica.action.ActStampaOmessaNotifica&idrinnovo="+rinnovo.getIdRinnovo()+"&notifica="+Notifica+"&ufficiali="+Ufficiali%>"/>
   </jsp:include>
     <%}%>
     </tr>
</table>
      ...
      <table>
        ...
        <tr>
          <td class="L">
            ...
            <input type="HIDDEN" name="<%=ICostantiNotifica.CAMPO_AZIONE_DETTAGLIO%>" value="siap.siep.notifica.action.ActLoadDettaglioOmesaNotifica">
          </td>
        </tr>
      </table>
</form>
