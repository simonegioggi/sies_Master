...
function Verify()
{
    ...
    if (document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value.length==1)
			  document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value='0'+document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value;
    if (document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value.length==1)
			  document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value='0'+document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value;

		  var data_to_verify = document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_GIORNO_DATA_RINNOVO%>.value+'-'+document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_MESE_DATA_RINNOVO%>.value+'-'+document.LoadInserisciSolleciti.<%=ICostantiRinnovo.CAMPO_ANNO_DATA_RINNOVO%>.value;
  ...
  function ListaSolleciti(a_formname,a_fieldname)
  {
   ...
   if(document.LoadInserisciSolleciti.Notifica[1].checked)
    {
      a_fieldname_1="FP";
    }else  if(document.LoadInserisciSolleciti.Notifica[0].checked)
      {
        a_fieldname_1="UG";
      }
    desktop = window.open("/jsp/Main.jsp?<%=IWebConstants.ACTION_FIELD%>=siap.siep.notifica.action.ActLoadRicercaSolleciti&formname="+a_formname+"&fieldname="+a_fieldname+"&fieldname_1="+a_fieldname_1, "LoadInserisciSolleciti","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=600,height=500");
  }
...
<body class="corpo">
  ...
  <form name="LoadInserisciSolleciti" method="POST" action="/jsp/Main.jsp">
 ...
 <br>
  ...
  <br>
    <table>
      <tr>
        <td class="LGB">
          <a href="Javascript:ListaSolleciti('LoadInserisciSolleciti',<%=notifica.getIdNotifica()%>);">Elenco Solleciti Precedenti</a>
        </td>
      </tr>
    </table>
...
<table width="100%">
     ...
     <tr>
      ...
      <tr>
         ...
         <td class="L">
            ...
            <a href="Javascript:ListaComuni('LoadInserisciSolleciti','<%= ICostantiRinnovo.CAMPO_COD_LUOGO_RINNOVO %>');">
     ...
     <tr>
      <td>
       <input type="hidden" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.notifica.action.ActInserisciSollecito">
...
<script language="JavaScript" type="text/javascript">
  var frmvalidator  = new Validator("LoadInserisciSolleciti");
