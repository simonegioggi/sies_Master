...
<body class="corpo" >
  ...
  <form name="DettaglioNotifica" method="POST" action="/jsp/Main.jsp">
      ...
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        ...
        <font class="campo">Modifica Avvenuta Notifica al Condannato</font>
      </td>
     </tr>
   </table>
 <br>
...
%>
       ...
       <td class="l">Sede</td>
			 <td class="L">
		   	 <input title="Sede Autorita Esterna Delegata" value="<%= lNotMod.getAutoritaEsternaDelegata()!= null ? StringUtils.toStringJSP(lNotMod.getAutoritaEsternaDelegata().getDescrSede()) : ""%>" type="text" name="<%= ICostantiAutoritaEsterna.CAMPO_COD_SEDE %>"  maxlength="35" size="35">
...
<%
          ...
          {
%>
	          <TEXTAREA title="Indirizzo" name="<%=ICostantiAutoritaEsterna.CAMPO_DESCRIZIONE%>" cols=30><%=StringUtils.toStringJSP(StringUtils.toStringJSP(lNotMod.getAutoritaEsternaDelegata().getDescrizione()))%></TEXTAREA>
<%
          }
					else
					{
