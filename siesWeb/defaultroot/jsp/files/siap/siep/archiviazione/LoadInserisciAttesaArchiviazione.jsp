...
<html>
  <head>
    ...
    <title>[S.I.E.S.] - Definizione Procedimento - Attesa Archiviazione</title>
...
//funzioni
  ...
  <body class="corpo">
    <table>
      <tr><td class="LBG"><a href="Javascript:window.print();"><img align="middle" src="<%=IWebConstants.IMAGES_DIR%>quickprint24.gif" alt="Stampa questa videata" border=0></a></td>
        <td class=lbg>
         ...
         <font class="campo">Definizione Procedimento - Attesa Archiviazione</font>
        </td>
      </tr>
    </table>
    <br>
    ...
    <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.archiviazione.action.ActInserisciAttesaArchiviazione">
...
%>
  ...
  <table width="100%">
    <tr>
      <td colspan=5 class="titolo">Dati Attesa Archiviazione</td>
    </tr>
    <tr>
    ...
    <tr>
       <td rowspan=2 class="l" width="22%">Note</td>
