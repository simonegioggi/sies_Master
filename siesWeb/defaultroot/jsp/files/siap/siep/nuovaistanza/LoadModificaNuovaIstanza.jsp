  ...
  <script language="JavaScript">
   ...
   function Verify() 
   {
 	...
 	if(document.LoadInserisciSentenza.<%=ICostantiNuovaIstanza.CAMPO_COD_CONTENUTO%>.value=='-')
    {
  	...
  	// 20210824 MEV_21 - Aggiunti controlli per inserimento manuale avvocato non certificato.
    ...
    <%-- 20210824 MEV_21: Gestione Inserimento estemporaneo di avvocato da RegInde o manuale --%>
    ...
    <tr>
      ...
      <td class="LBG">
        ...
        String lAzione = new String();
          ...
          lAzione = "siap.siep.nuovaistanza.action.ActModificaNuovaIstanza"; 
         %>
...
-->   
  ...
  <table width="100%">
   <tr>
		<td class="Titolo" colspan=6>Procedimento(N.SIEP)</td>
	</tr>
	<tr>
		<td class="l" width="25%">Anno/Numero</td>
		<td class="L" colspan=5><font class="campo"><%=StringUtils.toStringJSP(fascicolo.getChiaveAnno())%></font>&nbsp; / <font class="campo"><%=StringUtils.toStringJSP(fascicolo.getChiaveProgr())%></font>&nbsp;
		</td>
	</tr>
  </table>	

  	<div id="divsoggetto" style="display:block; position:relative; ">  
      <jsp:include page="/jsp/files/siap/siep/nuovaistanza/IncludeDettaglioSoggetto.jsp"/>	
  	</div>
  	
  	<div id="divsentenza" style="display:block; position:relative; ">  	
