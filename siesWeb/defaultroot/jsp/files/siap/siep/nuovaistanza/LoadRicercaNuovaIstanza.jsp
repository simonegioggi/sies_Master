...
<table>
  	<tr>
    	...
    	<td class="LBG">
    		<font class="label">Funzione :</font>&nbsp;&nbsp;<font class="campo">Ricerca Istanza</font>
    	</td>
  	</tr>
</table>
...
<table>
    ...
    <tr>
      	<td class="L" ><font class="label">Anno/Numero Iniziale</font></td>
      	<td class="l">
        	<input type="text" title="Anno Registro Istanza Iniziale" name="<%=ICostantiNuovaIstanza.CAMPO_CHIAVE_ANNO_INIZIALE%>" maxlength="4" size="4" onkeypress="return TicTabNumField(this,event)">
        	/
        	<input type="text" title="Numero Registro Istanza Iniziale" name="<%=ICostantiNuovaIstanza.CAMPO_CHIAVE_PROGR_INIZIALE%>" maxlength="10" size="10" onkeypress="return TicTabNumField(this,event)">
      	</td>
      	<td class="L"><font class="label">Anno/Numero Finale</font></td>
      	<td class="l">
	        <input type="text" title="Anno Registro Istanza Finale" name="<%=ICostantiNuovaIstanza.CAMPO_CHIAVE_ANNO_FINALE%>" maxlength="4" size="4" onkeypress="return TicTabNumField(this,event)">
	        /
	        <input type="text" title="Numero Registro Istanza Finale" name="<%=ICostantiNuovaIstanza.CAMPO_CHIAVE_PROGR_FINALE%>" maxlength="10" size="10" onkeypress="return TicTabNumField(this,event)">
      	</td>
	</tr>
	...
	<tr>
		<td class="L">Per Attività sull'istanza&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td class="l">
			<select name="<%=ICostantiNuovaIstanza.CAMPO_ATTIVITA_ISTANZA%>"><%=statonuovaistanza%></select>
		</td>
	</tr>
	<tr>
		<td class="L">Per Tipologia Istanza&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td class="l">
			<select name="<%=ICostantiNuovaIstanza.CAMPO_TIPOLOGIA_ISTANZA%>">
	          	<option value="-" >-</option>
	          	<option value="P">Presentata</option>
	          	<option value="D">Depositata</option>
			</select>
		</td>
	</tr>
    <tr>
