...
%>
          ...
          <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_TOOLBAR_STAMPA_SIEP%>">
            <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action="+lFun.getNameAction()+"&"+request.getParameter("CampoIdEntitaEvento")+"="+request.getParameter("ValoreIdEntitaEvento")%>"/>
          </jsp:include>
<%
        }
...
<%
        ...
        // SE L'ISTANZA HA ASSOCIATO UN EVENTO ed e' validato E' POSSIBILE TRASFERIRLA.
