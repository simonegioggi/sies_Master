...
<html>
  <head>
    <title>[S.I.E.S.] - Dettaglio Nuova Istanza</title>
  ...
  <body class="corpo">
      ...
      <table>
        <tr>
          ...
          <td class="LBG">
            ...
            <font class="campo">Dettaglio Nuova Istanza Spedita</font>
          </td>
          <!-- BOTTONE DI RITORNO -->
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        <td class="l">
					<font class="label">Oggetto</font></td>
        <td class="l">
					<font class="campo">
						<%=StringUtils.toStringJSP(nuovaistanza.getDescrContenuto())%>&nbsp;
					</font>
				</td>
      </tr>
      <tr>
...
--%>
      <tr>
        ...
        <td class="l">
					<font class="campo">
						<%=DateUtils.getDateToString(Messaggio.getDataInvio(),"dd-MM-yyyy  HH:mm:ss")%>&nbsp;
					</font>
				</td>
      </tr>
      <tr>
        ...
        <td class="l">
					<font class="campo">
						<%=StringUtils.toStringJSP(Messaggio.getCodiceUtenteMittente())%>&nbsp;
					</font>
				</td>
      </tr>
      <tr>
        ...
        <td class="l">
					<font class="campo">
						<%=StringUtils.toStringJSP(Messaggio.getDescrUfficioMittente() +" "+Messaggio.getDescrSedeUfficioMittente())%>&nbsp;
					</font>
				</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="l">
					<font class="campo">
						<%=StringUtils.toStringJSP(DateUtils.getDateToString(Messaggio.getDataEsito(),"dd-MM-yyyy HH:mm:ss"))%>&nbsp;
					</font>
				</td>
      </tr>
      <tr>
