...
<jsp:useBean id="FlagValidato"  scope="request" class="java.lang.String" />
...
<%
		...
		if( (lFunFiglie != null) && (lFunFiglie.size() != 0) )
		{
			...
			while(lIterBottoni.hasNext())
			{
				...
				{
					if(lFun.getFunctionType().equals(ICostantiFunzioni.TIPO_DETTAGLIO) && lFun.getFunctionId().compareTo(new BigDecimal(ICostantiNuovaIstanza.FUNZIONE_DETTAGLIO_FASCICOLO))==0)
					{
%>
            <td>
