...
<html>
<head>
  <title>[S.I.E.S.] - Gestione Nuova Istanza </title>
...
<%
        ...
        lAction = "siap.siep.nuovaistanza.action.ActTrasferisciNuovaIstanza";
%>
        <font class="campo">Trasferimento Nuova Istanza</font>
    </tr>
  </table>
  <br>
    ...
    <table cellspacing=2 cellpadding=2>
      ...
      <tr>
        <td class="l">Sede Destinatario </td><td class="L">
          <input title="Sede Destinatario"  type="text" name="<%= ICostantiNuovaIstanza.CAMPO_COD_LUOGO_DESTINATARIO %>"  maxlength="35" size="35">
            <a href="Javascript:ListaComuniTds('TrasferisciIstanza','<%= ICostantiNuovaIstanza.CAMPO_COD_LUOGO_DESTINATARIO %>');">
