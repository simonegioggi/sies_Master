...
<%
		...
		if( (lFunFiglie != null) && (lFunFiglie.size() != 0) )
		{
			...
			while(lIterBottoni.hasNext())
			{
				...
				{
					if(lFun.getFunctionType().equals(ICostantiFunzioni.TIPO_DETTAGLIO) && lFun.getFunctionId().compareTo(new BigDecimal(ICostantiNuovaIstanza.FUNZIONE_DETTAGLIO_SOGGETTO))==0)
					{
%>
            <td>
