...
<html>
  <head>
    <title> [S.I.E.S.] - Dettaglio Trasmissione Nuova Istanza </title>
    ...
    <table>
      <tr>
        ...
        <td class="LBG">
          ...
          <font class="campo">Dettaglio Trasmissione Nuova Istanza</font>
        </td>
...
<!-- BOTTONE DI STAMPA -->
   <jsp:include page="<%= ISIAPCostantiWeb.PG_BUTTONS_STAMPA_SIEP%>">
     <jsp:param name="ActionLink" value="<%="/jsp/Main.jsp?Action=siap.siep.nuovaistanza.action.ActStampaTrasferimentoIstanza&IdEvento="+lEve.getIdEvento()%>"/>
   </jsp:include>
      </tr>
    </table>
  <br>
        ...
        <table>
          ...
          <font class="campo">
           <input type=file size="35" name="<%=ICostantiEvento.CAMPO_BLOB%>"></font>
            ...
            <input type="hidden" name="<%=ICostantiNuovaIstanza.CAMPO_COD_LUOGO_DESTINATARIO %>"  
									 value="<%=UfficioDestinatario.getDescrComune()%>" >
            <input type="hidden" name="<%=ICostantiNuovaIstanza.CAMPO_COD_TIPO_UFFICIO_DESTINATARIO %>" 
									 value="<%=UfficioDestinatario.getCodTipoUfficio()%>" >
          </tr>
          <tr><td><br></td></tr>
          <tr>
            <td class="L">
              <input name=go  class=bottone  type="submit" value="Conferma Trasmissione Nuova Istanza">
              <input type="HIDDEN" name="<%=IWebConstants.ACTION_FIELD%>" value="siap.siep.nuovaistanza.action.ActUploadDocumentConfermaTrasmissione">
