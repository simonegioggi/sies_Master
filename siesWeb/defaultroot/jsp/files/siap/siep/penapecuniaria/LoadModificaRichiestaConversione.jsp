...
function Verify() { 
	...
	var insMulta = document.LoadModificaRichiestaConversione.<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_MULTA%>INT.value + "." +
		document.LoadModificaRichiestaConversione.<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_MULTA%>DEC.value;
	var insAmmenda = document.LoadModificaRichiestaConversione.<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_AMMENDA%>INT.value + "." +
		document.LoadModificaRichiestaConversione.<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_AMMENDA%>DEC.value;
	if (insMulta > aMulta) {
...
<table>
    ...
    <tr>
		...
		<td class="L"colspan="4">
			<input Title="Sede" name="<%=ICostantiPenaPecuniaria.CAMPO_COD_LUOGO_EMITTENTE%>"
				value="<%=richiestaconversione.getDescrLuogoEmittente()%>" type="text" maxlength="35" size="35">
			<a href="Javascript:ListaComuni('LoadModificaRichiestaConversione','<%=ICostantiPenaPecuniaria.CAMPO_COD_LUOGO_EMITTENTE%>');">
    ...
    <tr>
      	...
      	<td class="l"> 
			<input type="text"  maxlength="14" size="16"  ONKEYPRESS="return TicTabNumField(this,event)" style="text-align:right"
				...
				name="<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_MULTA%>INT"><strong>&nbsp;,&nbsp;</strong>
      	...
      	<td class="l"> 
        	<input type="checkbox" name="<%=ICostantiPenaPecuniaria.CAMPO_FLAG_IMPRESCRITTIBILE_MULTA%>" 
<%
    ...
    <tr>
      	...
      	<td class="l"> 
        	<input type="text"  maxlength="14" size="16"  ONKEYPRESS="return TicTabNumField(this,event)" style="text-align:right" 
               	...
               	name="<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_AMMENDA%>INT"><strong>&nbsp;,&nbsp;</strong>
        	<input type="text"  maxlength="2" size="2"  ONKEYPRESS="return TicTabNumField(this,event)" 
...
frmvalidator.addValidation("<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_MULTA%>INT","numeric","Il campo Multa è numerico");
frmvalidator.addValidation("<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_MULTA%>DEC","numeric");
frmvalidator.addValidation("<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_AMMENDA%>INT","numeric","Il campo Ammenda è numerico");
frmvalidator.addValidation("<%=ICostantiPenaPecuniaria.CAMPO_IMPORTO_AMMENDA%>DEC","numeric");
