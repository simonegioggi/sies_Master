...
function insertIT(id, descrTipoDecisione, annoSius, numeroSius, annoRegistro, numeroRegistro, descrUfficioEmittente,
					comuneUfficioEmittente, g_DataEmissione, m_DataEmissione, a_DataEmissione, descrTipoSanzione,
					descrNaturaSanzione, note, codNaturaSanzione, durataEsitoAnni, durataEsitoMesi, durataEsitoGiorni,
					numeroRate, valoreRata, valoreRataI, valoreRataD, valoreUltRata, valoreUltRataI, valoreUltRataD,                      
					GiornoDataInizioPaga, MeseDataInizioPaga, AnnoDataInizioPaga, GiorniInizioPaga) {
	...
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_COD_TIPO_DECISIONE %>.value=descrTipoDecisione;
	...
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_ANNO_REGISTRO %>.value=annoRegistro;
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_NUMERO_REGISTRO %>.value=numeroRegistro;
	if (descrUfficioEmittente.toUpperCase().indexOf("UFF")==0)
  		window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_COD_UFFICIO_EMITTENTE%>.value="UDS";
	else
  		window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_COD_UFFICIO_EMITTENTE%>.value="TDS";
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_COD_SEDE_AUTORITA_EMITTENTE  %>.value=comuneUfficioEmittente;
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_GIORNO_DATA_EMISSIONE%>.value=g_DataEmissione;
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_MESE_DATA_EMISSIONE%>.value=m_DataEmissione;
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_ANNO_DATA_EMISSIONE%>.value=a_DataEmissione;
	...
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_COD_NATURA_SANZIONE %>.value=descrNaturaSanzione;
	window.parent.opener.document.<%=request.getParameter("formname")%>.<%=ICostantiScambioSanzione.CAMPO_NOTE_ANN %>.value=note;
	...
	<tr>
		...
		<td class="c">
  			<a href="Javascript:insertIT(
	  				'<%=StringUtils.toStringJSP(lScaRic.getScambioSanzione().getIdScambioSanzione(),"-")%>',
					...
					'<%=StringUtils.cStrForJS(lScaRic.getScambioSanzione().getNote())%>',
					'<%=StringUtils.toStringJSP(StringUtils.cStrForJS(lScaRic.getScambioSanzione().getCodNaturaSanzione() ),"-")%>',
