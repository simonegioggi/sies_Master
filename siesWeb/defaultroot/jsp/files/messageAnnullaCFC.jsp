...
<%
// MEV 16: allungata la storia della pagina a cui tornare
String jumpPage = "history.go(-2)";
...
<table width="300"  cellspacing="0" align="center" class="tab" border="1">
	...
	<tr align="center" valign="middle">
      	<td align="center" colspan="2" class="tab2">
       	<%-- MEV 16: modificata la pagina di inoltro --%>
<%
if (Utils.isPresent(tipoWS)) {
%>
			<a href="<%=IWebConstants.PG_MAIN%>?<%=IWebConstants.ACTION_FIELD%>=siap.siep.ordineesecuzione.action.ActRicercaProvvedimenti">
