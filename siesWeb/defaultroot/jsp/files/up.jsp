            ...
            <table width=100% cellpadding="0" cellspacing="0" border=1 bordercolor="#BEC6FC">
              <tr>
                <td width=10% bordercolor=#BEC6FC>
                  <font class=label>Utente:</font>&nbsp;&nbsp;</td>
...
<%
				      ...
				      { // L'help on line viene aperto a tutto schermo su una pagina distinta
				        // come ultimo link allineato a destra
%>
			          <a href="Javascript:openHelp('<%=lFun.getNameAction()%>');" >
		            	...
		            	<font class=label>Help On Line</font></a>
			          </a>
<%							}
						}%>
            <a href="<%=IWebConstants.PG_MAIN+"?"+IWebConstants.ACTION_FIELD+"=siap.sico.utente.action.ActLoadModificaPassword"%>" target="body">
            	...
            	<font class=label>Cambio Password</font></a>
            <a href="<%=IWebConstants.PG_MAIN+"?"+IWebConstants.ACTION_FIELD+"=siap.sico.security.action.ActLogout"%>" target="_top"><img align="middle" src="/images/logout.gif" width="32" height="32" alt="" border="0"><font class=label>Logout</font></a>
            ...
            <a href="/frame.htm" target="_top"><img align="middle" src="/images/home.gif" width="32" height="32" alt="" border="0"><font class=label>Home</font></a>
          </td>
        </tr>
      </table>
    </div>
