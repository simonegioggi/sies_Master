...
<%-- MEV INTEGRAZIONE SIES ADN: aggiunto jsp:useBean --%>
...
<%
UfficioModel ufficioModel = UtenteConnesso.getUfficioUtente();
%>
			<font class=campo><%=ufficioModel.getDescrTipoUfficio() +" - "+ ufficioModel.getDescrComune()%></font>
    	</td>
  	</tr>
</table>
<br>
...
<%-- MEV INTEGRAZIONE SIES ADN: aggiunti campi nascosti --%>
<input type="hidden" name="testProvenienza" value="<%=msg%>">
