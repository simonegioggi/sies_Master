...
<html>
  ...
  <SCRIPT LANGUAGE="JavaScript">
	...
	// si differenzia dalla message normale xchè consente il redirigi   
  	// anche in caso di finestra pop up 
  	// è usata nella cancellazione del periodo altra sanzione dalla finestra 'lista'
...
%>
  <SCRIPT LANGUAGE="JavaScript">
    ...
    function go()
    {
	 	window.parent.opener.document.location.href ('<%=newPage%>')
	  	window.parent.close();
    }
  ...
  <link rel="STYLESHEET" type="text/css" href="<%=IWebConstants.PG_STYLE%>">
    <title>Siap: Cancellato periodo</title>
  </head>
