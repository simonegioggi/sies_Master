...
public abstract class Anagrafica  implements java.io.Serializable {
    public Anagrafica() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.giustizia.it/serviziTelematici/pstbe/gestione", "anagrafica"));
    }
