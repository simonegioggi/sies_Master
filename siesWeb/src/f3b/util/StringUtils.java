...
public class StringUtils {
	...
	public static String getParteDecimale(BigDecimal aValue) {
		...
		if (aValue != null) {
			 ...
			 * strValueDec + "0"; } else { // strValueInt = strValue; strValueDec = "00"; } } return
			 * strValueDec;
			 */
		} else
			return ("");
	...
	/**
	 * Ticket#20230419018 - I nomi dei fogli Excel non possono contenere alcuni caratteri per cui si aggiunge
	...
	public static String encodeExcelSheetName(String sheetName) {
		...
		// n.b. non si eliminano gli apostrofi perchè potrebbero essere legati al mone del magistrato es
		// MARILU'
		return sheetName;
	}
