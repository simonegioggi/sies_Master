...
/**
 * Utils - Classe di utilit� generica.
 * 
 * @version 1.0
 */
...
public class Utils {
	...
	public static Iterator sortHashKeys(Hashtable aHash) {
		...
		// Affinch� possa effetturae il sort della tabella di hash
	...
	/**
	 * STUB : PM - Ma questo non � uguale al precedente ?
	 * Questo metodo acccetta in ingresso una Hashtable e ritorna un oggetto Iterator che contiene la lista
	 * delle chiavi sortate.
	 *
	 * @param aHash
	...
	/**
	 * Verifica se la stringa passata � un valore numerico.
	 *
	 * @param lValue
