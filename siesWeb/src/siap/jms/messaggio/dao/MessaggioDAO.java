...
/**
 * MessaggioDAO - Classe DAO che rappresenta la tabella Messaggio
 *
 * @version 1.0
 */
public class MessaggioDAO extends TableDAO {
	...
	public BigDecimal getIdMessaggio() throws DAOException {
		return getBigDecimal("ID_MESSAGGIO");
	}

	public String getTipoMessaggio() throws DAOException {
		return getString("COD_TIPO_MESSAGGIO");
	}

	public String getTipoOperazione() throws DAOException {
		return getString("COD_TIPO_OPERAZIONE");
	}

	public String getCodUfficioMittente() throws DAOException {
		return getString("COD_UFFICIO_MITTENTE");
	}

	public String getCodBdiMittente() throws DAOException {
		return getString("COD_BDI_MITTENTE");
	}
	...
	public String getCodBdiDestinataria() throws DAOException {
		return getString("COD_BDI_DESTINATARIA");
	}
	...
	public Date getDataEsito() throws DAOException {
		return getDate("DATA_ESITO");
	}

	public String getCodiceUtenteMittente() throws DAOException {
		return getString("CODICE_UTENTE_MITTENTE");
	}
	...
	public String getJmsIdMessage() throws DAOException {
		return getString("JMS_ID_MESSAGE");
	}

	public String getJmsCorrelationIdMessage() throws DAOException {
		return getString("JMS_CORRELATION_ID_MESSAGE");
	}
	...
	public BigDecimal getChiaveAnnoSius() throws DAOException {
		return getBigDecimal("CHIAVE_ANNO_SIUS");
	}

	public BigDecimal getChiaveProgrSius() throws DAOException {
		return getBigDecimal("CHIAVE_PROGR_SIUS");
	}

	// UEPE
	public BigDecimal getChiaveAnnoSiepe() throws DAOException {
		return getBigDecimal("CHIAVE_ANNO_SIEPE");
	}

	public BigDecimal getChiaveProgrSiepe() throws DAOException {
		return getBigDecimal("CHIAVE_PROGR_SIEPE");
	}
	...
	public BigDecimal getChiaveAnnoFasCumulante() throws DAOException {
		return getBigDecimal("CHIAVE_ANNO_FAS_CUMULANTE");
	}

	public BigDecimal getChiaveProgrFasCumulante() throws DAOException {
		return getBigDecimal("CHIAVE_PROGR_FAS_CUMULANTE");
	}

	public String getChiaveUfficioFasCumulante() throws DAOException {
		return getString("CHIAVE_UFFICIO_FAS_CUMULANTE");
	}
	...
	public String getDeliveryMode() throws DAOException {
		return getString("DELIVERY_MODE");
	}

	public String getCodUfficioInoltro() throws DAOException {
		return getString("COD_UFFICIO_INOLTRO");
	}

	public String getCodBdiInoltro() throws DAOException {
		return getString("COD_BDI_INOLTRO");
	}

	public String getCodUfficioReplyTo() throws DAOException {
		return getString("COD_UFFICIO_REPLY_TO");
	}

	public String getCodBdiReplyTo() throws DAOException {
		return getString("COD_BDI_REPLY_TO");
	}

	public String getJmsCorrelationReplyTo() throws DAOException {
		return getString("JMS_CORRELATION_REPLY_TO");
	}

	public String getIdMessaggioSollecitato() throws DAOException {
		return getString("ID_MESSAGGIO_SOLLECITATO");
	}

	public BigDecimal getIdRichiesta() throws DAOException {
		return getBigDecimal("ID_RICHIESTA");
	}

	// public Blob getBlobEsito() throws DAOException { return getBlob("BLOB_ESITO"); }
	public ByteArrayOutputStream getBlobEsito() throws DAOException {
		return getBlob("BLOB_ESITO");
	}
	...
	public void setIdMessaggio(BigDecimal aValore) {
		setBigDecimal("ID_MESSAGGIO", aValore);
	}

	public void setTipoMessaggio(String aValore) {
		setString("COD_TIPO_MESSAGGIO", aValore);
	}

	public void setTipoOperazione(String aValore) {
		setString("COD_TIPO_OPERAZIONE", aValore);
	}

	public void setCodUfficioMittente(String aValore) {
		setString("COD_UFFICIO_MITTENTE", aValore);
	}

	public void setCodBdiMittente(String aValore) {
		setString("COD_BDI_MITTENTE", aValore);
	}
	...
	public void setCodBdiDestinataria(String aValore) {
		setString("COD_BDI_DESTINATARIA", aValore);
	}
	...
	public void setDataEsito(Date aValore) {
		setDate("DATA_ESITO", aValore);
	}

	public void setCodiceUtenteMittente(String aValore) {
		setString("CODICE_UTENTE_MITTENTE", aValore);
	}
	...
	public void setBlobEsito(ByteArrayInputStream aValore) {
		setBlob("BLOB_ESITO", aValore);
	}

	public void setJmsIdMessage(String aValore) {
		setString("JMS_ID_MESSAGE", aValore);
	}

	public void setJmsCorrelationIdMessage(String aValore) {
		setString("JMS_CORRELATION_ID_MESSAGE", aValore);
	}
	...
	public void setChiaveAnnoSius(BigDecimal aValore) {
		setBigDecimal("CHIAVE_ANNO_SIUS", aValore);
	}

	public void setChiaveProgrSius(BigDecimal aValore) {
		setBigDecimal("CHIAVE_PROGR_SIUS", aValore);
	}

	// UEPE
	public void setChiaveAnnoSiepe(BigDecimal aValore) {
		setBigDecimal("CHIAVE_ANNO_SIEPE", aValore);
	}

	public void setChiaveProgrSiepe(BigDecimal aValore) {
		setBigDecimal("CHIAVE_PROGR_SIEPE", aValore);
	}
	...
	public void setChiaveFasAnnoCumulante(BigDecimal aValore) {
		setBigDecimal("CHIAVE_ANNO_FAS_CUMULANTE", aValore);
	}

	public void setChiaveFasProgrCumulante(BigDecimal aValore) {
		setBigDecimal("CHIAVE_PROGR_FAS_CUMULANTE", aValore);
	}

	public void setChiaveFasUfficioCumulante(String aValore) {
		setString("CHIAVE_UFFICIO_FAS_CUMULANTE", aValore);
	}

	public void setDeliveryMode(String aValore) {
		setString("DELIVERY_MODE", aValore);
	}

	public void setCodUfficioInoltro(String aValore) {
		setString("COD_UFFICIO_INOLTRO", aValore);
	}

	public void setCodBdiInoltro(String aValore) {
		setString("COD_BDI_INOLTRO", aValore);
	}

	public void setCodUfficioReplyTo(String aValore) {
		setString("COD_UFFICIO_REPLY_TO", aValore);
	}

	public void setCodBdiReplyTo(String aValore) {
		setString("COD_BDI_REPLY_TO", aValore);
	}

	public void setJmsCorrelationReplyTo(String aValore) {
		setString("JMS_CORRELATION_REPLY_TO", aValore);
	}

	public void setIdMessaggioSollecitato(String aValore) {
		setString("ID_MESSAGGIO_SOLLECITATO", aValore);
	}

	public void setIdRichiesta(BigDecimal aValore) {
		setBigDecimal("ID_RICHIESTA", aValore);
	}
