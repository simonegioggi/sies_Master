...
public class ActStampaOSLiberazioneAnticipata extends ActionSiap
                                              implements ICostantiOrdineScarcerazione
{
  public String processRequest() throws F3BException
  {
    ...
    lTemMod = lCtrlTem.ExRicercaTemplateByTipEveTipoProvCodMotivoFlagTemplate("01", "09", lMotivo, flagTemplate);
