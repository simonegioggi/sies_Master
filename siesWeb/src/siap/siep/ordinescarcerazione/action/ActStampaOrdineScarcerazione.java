...
public class ActStampaOrdineScarcerazione
    extends ActionSiap
    implements ICostantiOrdineScarcerazione
{
  public String processRequest() throws F3BException
  {
	...
	if (lAltraMod != null) {
		lEveMod.setNomeTemplate(TEMPLATE_ORDINE_SCARCERAZIONE_ALTRA_CAUSA);
	}
	else {
		lEveMod.setNomeTemplate(TEMPLATE_ORDINE_SCARCERAZIONE);
	}
