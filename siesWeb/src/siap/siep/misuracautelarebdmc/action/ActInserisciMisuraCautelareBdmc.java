...
/**
 * <p>
 * Title: ActInserisciMisuraCautelareBdmc
 * </p>
 * <p>
 * Description: Classe Action per l'inserimento di MisuraCautelareBdmc
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActInserisciMisuraCautelareBdmc extends ActionSiap implements ICostantiMisuraCautelareBdmc {

	/*****************************************************************************
	 * Azione di Inserimento del MisuraCautelareBdmc
	 * 
	...
	public String processRequest() throws F3BException {
		...
		MisuraCautelareBdmcModel lMisRetMod = new MisuraCautelareBdmcModel();
		lMisRetMod = lCtrl.ExInserisciMisuraCautelareBdmc(lMisMod);
		...
		lPage += "&" + CAMPO_ID_MISURA_CAUTELARE + "=" + lMisRetMod.getIdMisuraCautelare().toString();
