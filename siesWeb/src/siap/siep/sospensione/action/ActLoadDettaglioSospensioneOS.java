...
/**
* <p>Title: ActLoadDettaglioSospensioneOS</p>
* <p>Description: Classe Action per la load dettaglio di Sospensione Ordine di Scarcerazione</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActLoadDettaglioSospensioneOS extends ActSIESDettaglioProvvedimento
                                         implements ICostantiSospensione,
                                                    ICostantiEvento
{
  /**
   * Recupera i dati da passare alla form di visualizzazione del dettaglio
   * Ordine di scarceraziione.
   * @return
   */
  public String processRequest() throws F3BException
  {
    ...
    return PG_LOAD_DETTAGLIO_SOSPENSIONE_OS;
  }
}