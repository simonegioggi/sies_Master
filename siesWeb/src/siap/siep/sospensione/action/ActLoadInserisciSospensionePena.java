...
/**
 * <p>Title: ActLoadInserisciSospensionePena</p>
 * <p>Description: Classe Action per la load inserimento di Sospensione Pena</p>
...
public class ActLoadInserisciSospensionePena extends ActionSiap implements ICostantiSospensione {
	...
	public String processRequest() throws Exception {
		...
		setRequestAttribute(ISIAPCostantiWeb.CAMPO_AZIONE_CHIAMANTE,
				"siap.siep.sospensione.action.ActLoadInserisciSospensionePena");

		return PG_LOAD_INSERISCI_SOSPENSIONE_PENA; // restituisce la jsp di VIEW
	}
}