...
/**
 * <p>Title: ActUploadSospensioneEsecPenaDispPm</p>
 * <p>Description: Classe Action per l' Upload  del Decreto Sospensione </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActUploadSospensioneEsecPenaDispPm extends ActionSiap implements ICostantiEvento
{
  ...
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaSospensioneEsecPenaDispPm(lModel, lFascMod);
    }
    else
    {
    ...
    // STUB 17/05/2005 Escluso il messaggio di avvenuta modifica.
    ...
    RedirectTo lRedirigi = new RedirectTo();
    lRedirigi.setPage( IWebConstants.PG_MAIN );
    lRedirigi.setParameter(CAMPO_ID_EVENTO, getRequestStringParameter(ICostantiEvento.CAMPO_ID_EVENTO));
    lRedirigi.setAction( "siap.siep.sospensione.action.ActLoadTrasferisciProvvedimentoDS");
