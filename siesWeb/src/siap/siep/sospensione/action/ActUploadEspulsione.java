...
/**
 * <p>Title: ActUploadEspulsione</p>
 * <p>Description: Classe Action per l' Upload  dell'Avvenuta Espulsione </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActUploadEspulsione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaEspulsione(lModel, lFascMod,"26","NP218","0232");
    }
    else
    {
