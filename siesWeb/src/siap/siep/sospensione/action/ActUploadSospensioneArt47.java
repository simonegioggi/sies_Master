...
/**
 * <p>Title: ActUploadSospensioneArt47</p>
 * <p>Description: Classe Action per l' Upload  di Sospensione  Art. 47 </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActUploadSospensioneArt47 extends ActionSiap
  ...
  public String processRequest() throws Exception
  {
   ...
   //  EventoModel EveMod=lCtrlEvento.ExRicercaEventoByKey(getRequestBigDecimalParameter( CAMPO_ID_EVENTO));
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaSospensione(lModel, lFascMod,"46","NP104","0083");
    }
    else
    {
