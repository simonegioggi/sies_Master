...
/**
 * <p>Title: ActLoadInserisciConcessioneEspulsione</p>
 * <p>Description: Classe Action per la load inserimento della Concessione di Espulsione</p>
...
public class ActLoadInserisciConcessioneEspulsione extends ActionSiap implements ICostantiSospensione {
	...
	public String processRequest() throws Exception {
		...
		Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoEspulsione());
		...
		return PG_LOAD_INSERISCI_CONCESSIONE_ESPULSIONE; // restituisce la jsp di VIEW
	}
}