...
/**
 * ActUploadSospensioneDecisioniSorv - Classe Action per l' Upload di Sospensione della pena
 *
 * @version 1.0
 */
public class ActUploadSospensioneDecisioniSorv extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			lCtrl.ExUpdateValidaSospensioneDecisioniSorveglianza(lModel, lFascMod);
		} else {
