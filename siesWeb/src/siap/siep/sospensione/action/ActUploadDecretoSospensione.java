...
/**
 * <p>Title: ActUploadDecretoSospensione</p>
...
public class ActUploadDecretoSospensione extends ActionSiap implements ICostantiEvento
{
	public String processRequest() throws Exception
	{
		...
		if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
		{
			...
			lCtrl.ExUpdateValidaDecretoSospensione(lModel, lFascMod);
		}
		else
		{
