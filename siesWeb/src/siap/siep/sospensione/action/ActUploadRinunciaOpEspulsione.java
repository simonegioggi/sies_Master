...
/**
 * <p>Title: ActUploadRinunciaOpEspulsione</p>
 * <p>Description: ActUploadConcessioneEspulsione</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadRinunciaOpEspulsione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateRinunciaOpEspulsione(lModel, lFascMod);
    }
    else
    {
