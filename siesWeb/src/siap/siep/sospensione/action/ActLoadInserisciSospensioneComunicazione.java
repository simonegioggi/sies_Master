...
/**
 * <p>Title: ActLoadInserisciSospensioneComunicazione</p>
 * <p>Description: Classe Action per la load inserimento di Sospensione Comunicazione</p>
...
public class ActLoadInserisciSospensioneComunicazione extends ActionSiap implements ICostantiSospensione {
	...
	public String processRequest() throws Exception {
		...
		String[] lTipoProv = { "04", "25", "04", "25" };
		String[] lMotivi = { "0268", "0268", "0269", "0269" };
		// lEveRic.setCodTipoProvvedimento("04");
		// String[] motivi = {"0269","0268"};
		...
		if (lEve == null)
			throw new SIEPException(SIEPException.USER_MESSAGE,
					"Il Detenuto non risulta Estradato. Impossibile emettere la Comunicazione Generica");
		...
		} else if ((!lPosizione.isLibero() && !lPosizione.getCodPosizioneGiuridica().equals("48")
				&& !lPosizione.getCodPosizioneGiuridica().equals("30"))// non è libero E NON EVASO
		...
		setRequestAttribute(ISIAPCostantiWeb.CAMPO_AZIONE_CHIAMANTE,
				"siap.siep.sospensione.action.ActLoadInserisciSospensioneComunicazione");

		setRequestAttribute("azione", "CO");
