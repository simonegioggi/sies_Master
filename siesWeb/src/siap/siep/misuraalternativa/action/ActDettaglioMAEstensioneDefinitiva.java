...
/**
 * <p>
 * Title: ActDettaglioMAEstensioneProvvisoria
 * </p>
 * <p>
 * Description: Classe Action per la load dettaglio di Estensione definitiva senza cumulo
 * </p>
 * <p>
...
public class ActDettaglioMAEstensioneDefinitiva extends ActMisuraAlternativa
	...
	public String processRequest() throws F3BException {
		...
		lMisAlModEstesa = lMisAltCtrl
				.ExRicercaMisuraAlternativaByIdEvento(lEveMod.getEvento().getEveIdEvento());
		setRequestAttribute("misuraalternativa", lMisAlModEstesa);

		if (lMisAlModEstesa != null && lMisAlModEstesa.getCodTipoMisura() != null) {
			if (lMisAlModEstesa.getCodTipoMisura().equals("0095")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0100")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0101")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0102")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0103")) {
				if (lMisAlModEstesa.getCodNaturaDecisione().equals("EC"))
					setRequestAttribute("tipoMisura", "DETENZIONECUMULO");
				else
					setRequestAttribute("tipoMisura", "DETENZIONE");
			} else if (lMisAlModEstesa.getCodTipoMisura().equals("0020")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0092")
					|| lMisAlModEstesa.getCodTipoMisura().equals("0093")) {
				if (lMisAlModEstesa.getCodNaturaDecisione().equals("EC"))
					setRequestAttribute("tipoMisura", "AFFIDAMENTOCUMULO");
				else
					setRequestAttribute("tipoMisura", "AFFIDAMENTO");
			} else if (lMisAlModEstesa.getCodTipoMisura().equals("0094")) {
				if (lMisAlModEstesa.getCodNaturaDecisione().equals("EC"))
		...
		lUffEmiMod = lCtrlUffEmi.getUfficioByKey(lMisAlModEstesa.getChiaveUfficioFascicoloSius());
		...
		return PG_LOAD_DETTAGLIO_MA_EST_DEF;
	}
