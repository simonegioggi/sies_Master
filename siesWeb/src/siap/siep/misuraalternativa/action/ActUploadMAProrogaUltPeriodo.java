...
/**
 * <p>Title: ActUploadMAProrogaUltPeriodo</p>
 ...
 * @version 1.0
 */
public class ActUploadMAProrogaUltPeriodo extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMAProrogaUltPeriodo(lModel, lFascMod);
    }
    else
    {
