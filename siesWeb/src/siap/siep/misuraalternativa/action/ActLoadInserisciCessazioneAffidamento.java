 ...
 *
 * @author d.fiorletta
 * @deprecated probabilmente vecchia versione non censita nemmeno sulla tabella funzione usare
 *             {@link siap.siep.misuraalternativa.action.ActLoadInserisciMACessazioneAffProva}.
 */
public class ActLoadInserisciCessazioneAffidamento extends ActRevoca implements ICostantiMisuraAlternativa {
	...
	public String processRequest() throws F3BException {
		 ...
		 * cessazione. Inoltre se esiste la misura di revoca chiamata lrevoca devo cercare una misura
		 * precedente di tipo sospensione affidamento mentre se lrevoca non esiste vuol dire che è la prima
		 * volta che ci passo e quindi cerco la corrente misura.
		 */
		...
		Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoCessazioneMAffP());
