...
public class ActInserisciMADetDomSpecSospProvv extends ActMisuraAlternativa implements
...
//		String tipoMisura = "SOSPENSIONE_PROVVISORIA";
...
//		String lPosizione = getRequestStringParameter(ICostantiPosizioneGiuridica.CAMPO_COD_POSIZIONE_GIURIDICA);
		String lPage = null;
		...
		if (this.getRequestStringParameter("flagmisura").equals("N")) {
			...
			lEve.setCodTipoProvvedimento("02"); // DECRETO
			lEve.setCodEsito("-");
			...
			lDepDecMod
					.setAnnoS72(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_REGISTRO));
			lDepDecMod
					.setNumS72(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUMERO_REGISTRO));
			...
			// lDepDecMod.setIdCssaComp(getRequestBigDecimalParameter(ICostantiCSSA.CAMPO_ID_CSSA));
			...
			lDepDecMod.setCodMagistrato(getRequestStringParameter(ICostantiMagistrato.CAMPO_COD_MAGISTRATO));

			// setto il tenore
			TenoreModel lTenMod = new TenoreModel();

			lTenMod.setCodEsitoTenore("0062"); // SOSPENDE PROVVISORIAMENTE
			...
			/*
			 * //ricerco Pena residua PenaResiduaModel lPenaResMod = new PenaResiduaModel(); IPenaResidua
			 * lPenResCtrl = SIEPLookupRemote.getPenaResiduaRemote(); lPenaResMod =
			 * lPenResCtrl.ExRicercaPenaResiduaCorrenteByFascicoloSiep(lFascicoloModel.getIdFascicoloSiep());
			 * 
			 * //setto la misuraalternativa // ricerco se esite un altra MA // ricerca misura per il fascicolo
			 * MisuraAlternativaModel lMisAlModCorr = new MisuraAlternativaModel(); IMisuraAlternativa
			 * lMisAltCtrl = SICOLookupRemote.getMisuraAlternativaRemote(); lMisAlModCorr =
			 * lMisAltCtrl.ExRicercaMisuraAlternativaCorrenteByIdFascicolo
			 * (lFascicoloModel.getIdFascicoloSiep());
			 * 
			 * //setto la misuraalternativa if(lMisAlModCorr != null) {
			 ...
			 */
			lMisMod.setCodTipoDecisione("02");
			lMisMod.setCodNaturaDecisione("SP");
			 ...
			 * { lMisMod.setDataScarcerazione(getRequestDateParameter(ICostantiMisuraAlternativa.
			 * CAMPO_ANNO_DATA_SCARCERAZIONE,
			 * ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE,ICostantiMisuraAlternativa
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.misuraalternativa.action.ActDettaglioMADetDomSpecSospProvv&"
