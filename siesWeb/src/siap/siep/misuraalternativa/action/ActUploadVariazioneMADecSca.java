...
/**
 * <p>Title: ActUploadVariazioneMAAmmProvvisoria</p>
 ...
 * @version 1.0
 */
public class ActUploadVariazioneMADecSca extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
	     ...
	     lCtrl.ExUpdateValidaVariazioneMAAmmProvvisoria(lModel, lFascMod);
    }
    else
    {
