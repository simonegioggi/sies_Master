...
public class ActInserisciMADicEffAffInProva extends ActMisuraAlternativa implements
...
//		String tipoMisura = "AFFIDAMENTO";
		...
		if (this.getRequestStringParameter("flagmisura").equals("N")) {
			...
			lTenMod.setCodEsitoTenore("0011");
...
//			PenaResiduaModel lPenaResMod = new PenaResiduaModel();
			...
			lMisMod.setCodNaturaDecisione("DI");
			 ...
			 * CAMPO_ANNO_DATA_SCARCERAZIONE, ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE,
			...
			/*
			 * if(!lPosizione.equals("10") || !lPosizione.equals("07") ) {
			 * lMisMod.setDataInizioMisura(getRequestDateParameter(ICostantiVerbale.CAMPO_ANNO_DATA_EMISSIONE,
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.misuraalternativa.action.ActDettaglioMADicEffAffInProva&"
			...
			lMisAlModConcessa = lMisAltController
					.ExRicercaMisuraAlternativaDicEffAffInProvaByIdFascicolo(lFascicoloModel
							.getIdFascicoloSiep());
