...
/**
 * ActStampaConcessione - Classe action che Produce il documento
 *
 * @version 1.0
 */
		...
		if (flagTemplate != null && lEventoModel != null && lEventoModel.getCodTipoEvento() != null
			...
			if ("5460".equals(lMotivo) || "5461".equals(lMotivo) // AFFIDAMENTO
				...
				if (("0680".equals(lMotivo) || "0681".equals(lMotivo) || "0690".equals(lMotivo)
						...
						|| "0682".equals(lMotivo) || "0693".equals(lMotivo) || "1418".equals(lMotivo)
						|| "1424".equals(lMotivo)
						// SEMILIBERTA'
						|| "0683".equals(lMotivo) || "0694".equals(lMotivo)) || "1419".equals(lMotivo)
						|| "1425".equals(lMotivo)
					...
					lTemMod = lCtrlTem.ExRicercaTemplateByTipEveTipoProvCodMotivoFlagTemplateCodOgg(
