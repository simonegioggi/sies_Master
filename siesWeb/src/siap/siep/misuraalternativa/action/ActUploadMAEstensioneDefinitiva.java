...
/**
 * <p>Title: ActUploadMAEstensioneDefinitiva</p>
...
public class ActUploadMAEstensioneDefinitiva extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMAEstensione(lModel, lFascMod);
    }
    else
    {
