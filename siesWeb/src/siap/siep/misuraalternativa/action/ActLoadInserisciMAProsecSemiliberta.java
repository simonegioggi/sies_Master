 ...
 */
public class ActLoadInserisciMAProsecSemiliberta extends ActProsecuzione51Bis {
	/**
	...
	public String processRequest() throws F3BException {
		...
		// lOggettiDecisione.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoProsecMASemMDS51Bis());
		//
		...
		lOggettiDecisioneAT.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoMASemiL());
