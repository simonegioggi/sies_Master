...
public class ActLoadInserisciMACess51bisEsecPenPressoDom extends ActCessazione51bis {
	...
	public String processRequest() throws F3BException {
		...
		Collection<DecodificheModel> lCollOggettoMDS51bis = new Vector(
				DecodificheManager.getInstance().getMotivoProvvedimentoCessazioneMAEspPressoDomMDS51bis());
		Option lOggettoMDS51bis = new Option(lCollOggettoMDS51bis);
		setRequestAttribute("comboOggettiMDS", lOggettoMDS51bis.toString());

		setRequestAttribute("tipoCessazione", "ESP_PRESSO_DOM");
