...
/**
 * <p>Title: ActUploadMADetDomSpeAmmAff</p>
 ...
 * @version 1.0
 */
public class ActUploadMADetDomSpeAmmAff extends ActionSiap
  ...
  public String processRequest() throws Exception
  {
   ...
   //  EventoModel EveMod=lCtrlEvento.ExRicercaEventoByKey(getRequestBigDecimalParameter( CAMPO_ID_EVENTO));
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMADetDomSpeAmmAff(lModel, lFascMod,tipoMisura);
    }
    else
    {
