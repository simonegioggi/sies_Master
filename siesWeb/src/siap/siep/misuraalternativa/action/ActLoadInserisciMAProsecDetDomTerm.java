 ...
 */
public class ActLoadInserisciMAProsecDetDomTerm extends ActProsecuzione51Bis {
	/**
	...
	public String processRequest() throws F3BException {
		...
		// lOggettiDecisione.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoProsecMADetDomTerMDS51Bis());
		//
		...
		lOggettiDecisioneAT.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoMADetDomTemp());
