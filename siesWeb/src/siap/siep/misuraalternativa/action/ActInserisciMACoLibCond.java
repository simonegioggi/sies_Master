...
public class ActInserisciMACoLibCond extends ActMisuraAlternativa implements ICostantiMisuraAlternativa {
...
//		BigDecimal lidPosGiu = new BigDecimal(this.getRequestStringParameter("idPosizionegiuridica"));
		String lPage = null;
		...
		if (this.getRequestStringParameter("flagmisura").equals("N")) {
			...
			lDepOrdMod.setCodUfficioMagistratoComp(lCodiceUff);
			...
			lTenMod.setCodOggettoTenore(this.getRequestStringParameter(ICostantiEvento.CAMPO_COD_MOTIVO));
			...
			lMisMod.setCodTipoMisura(this.getRequestStringParameter(ICostantiEvento.CAMPO_COD_MOTIVO));
...
//			PosizioneGiuridicaModel lPosGiu = new PosizioneGiuridicaModel();
			...
			// lPosGiu.setIdPosizioneGiuridica(lidPosGiu);
			// lPosGiu.setDataFine(getRequestDateParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE,
			// ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE,
			// ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE));
			/*
			 * if (this.getRequestStringParameter("tipo").equals("scarcerato")) { MisuraAlternativaModel
			 * lMisuraModel = lCtrlMisura.ExInserisciMisuraAlternativaEventoNotifica(lEveMod, lDepOrdMod,
			 * lTenMod, lMisMod, lPosGiu);
			 * 
			 * } else {
			 */
			...
			lEveNot.getEvento()
					.setCodMotivo(this.getRequestStringParameter(ICostantiEvento.CAMPO_COD_MOTIVO));
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.misuraalternativa.action.ActDettaglioMACoLibCond&"
