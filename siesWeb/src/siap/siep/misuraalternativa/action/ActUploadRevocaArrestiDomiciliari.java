...
/**
 * <p>Title: ActUploadMASospProvv</p>
 ...
 * @version 1.0
 */
public class ActUploadRevocaArrestiDomiciliari extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMARevoca(lModel, lFascMod);
    }
    else
    {
  	...
  	//Prepara la "pagina" di destinAction
		...
		if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
		{
			...
			//lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" + CAMPO_ID_EVENTO + "=" + getRequestStringParameter(ICostantiEvento.CAMPO_ID_EVENTO)+ "&tipoMisura="+getRequestStringParameter("tipoMisura"));			
			lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" + CAMPO_ID_EVENTO + "=" + getRequestStringParameter(ICostantiEvento.CAMPO_ID_EVENTO)+ "&" + CAMPO_COD_MOTIVO + "=" + getRequestStringParameter(ICostantiEvento.CAMPO_COD_MOTIVO)+ "&tipoMisura="+getRequestStringParameter("tipoMisura"));
