	...
	public String SettaCodTipoProvvedimento(String PosizioneGiu, String flagverbale,
		...
		if (tipoMisura.equals("SEMINLIBERTA")) {
			if (flagverbale.equals("S")) {
				...
				aCodTipoProvedimento = "12"; // Comunicazione
			} else if ("PROC".equals(aMisMod.getCodTipoUfficioScarcerazione()) && (PosizioneGiu.equals("04") // detetnuto
																												// o
																												// arresti
																												// domiciliari
		...
		/*
		 * if (tipoMisura.equals("AFFIDAMENTO")) { if ( PosizioneGiu.equals("03") || PosizioneGiu.equals("04")
		 * // detetnuto o arresti domiciliari || PosizioneGiu.equals("12") || PosizioneGiu.equals("13") ||
		 * PosizioneGiu.equals("14") //già in misura || PosizioneGiu.equals("29") // Det Dom PROVV ||
		 * PosizioneGiu.equals("54") // Aff Prov PROVV ) { if ("S".equals(flagverbale) &&
		 * PosizioneGiu.equals("54")) { // Sto registrando il provvedimento successivo al verbale
		 * aCodTipoProvedimento = "12"; } else if (("PROC").equals(aMisMod.getCodTipoUfficioScarcerazione()))
		 * { aCodTipoProvedimento = "09"; // Ordine Scarcerazione } else { aCodTipoProvedimento = "12"; //
		 * Comunicazione } } else if (aPosMod.isLibero() &&
		 * ("PROC").equals(aMisMod.getCodTipoUfficioScarcerazione())) { // aCodTipoProvedimento = "06"; //
		 * Ordine Esecuzione aCodTipoProvedimento = "26"; } else aCodTipoProvedimento = "04"; // Provvedimento
		 * Tutte le altre posizioni } else if (tipoMisura.equals("DETENZIONE")) { if
		 * (PosizioneGiu.equals("03") || flagverbale.equals("S")) { if ("PROC".equals
		 * (aMisMod.getCodTipoUfficioScarcerazione())) aCodTipoProvedimento = "09"; // Ordine Scarcerazione
		 * else aCodTipoProvedimento = "12"; // Comunicazione } else if (aPosMod.isLibero() && "PROC".equals
		 * (aMisMod.getCodTipoUfficioScarcerazione())) { aCodTipoProvedimento = "06"; // Ordine Esecuzione }
		 * else aCodTipoProvedimento = "04"; // Provvedimento }
		 */
