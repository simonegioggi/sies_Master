...
public class ActInserisciMAAmmProvSemiliberta extends ActMisuraAlternativa implements ICostantiMisuraAlternativa {
  ...
  public String processRequest() throws F3BException {
    ...
    cPenaResiduaModel = lPenResCtrl.ExRicercaPenaResiduaCorrenteByFascicoloSiep(lFascicoloModel.getIdFascicoloSiep());
    ...
    lPosGiuMod = lPosCtrl.ExRicercaPosizioneGiuridicaCorrenteByIdFascicolo(lFascicoloModel.getIdFascicoloSiep());
    ...
    lPosPre = lCtrPos.ExRicercaPosizioneGiuridicaPrecedenteByIdFascicolo(lFascicoloModel.getIdFascicoloSiep());
    ...
    BigDecimal lIdEventoSIUS = getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_ID_DOCUMENTO_SIUS);
    ...
    if (lMisAlModAMM == null) {
      ...
      String lTipoProvvedimento = getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_COD_TIPO_DECISIONE);
      ...
      // setto il tenore
      TenoreModel lTenMod = setTenore(new BigDecimal(1), "0270"); // 0001 - Concede - 0270 = Applica Provvisoriamente
      ...
      // ========================================================================
      if (!this.isRequestParameterNullEmptyObj(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE)) {
      ...
      MisuraAlternativaModel lMisuraModel = lCtrlMisura.ExInserisciDecretoOrdinanzaMisAlt (lEveMod,lDepDecMod, lDepOrdMod, lTenMod, lMisMod);

      // =====================================================
      // Provvedimento SIEP
      // =====================================================
      EventoNotificaModel lEveNot = new EventoNotificaModel();
      String lCodTipoProvvedimento = this.SettaCodTipoProvvedimento(PosizioneGiu,
      ...
      //    verbale, e adesso sto emettendo un provvedimento dopo la registrazione del verbale inizio misura
      ...
      if (flagverbale.equals("N")) {
        ...
        if (!this.isRequestParameterNullObj(ICostantiMisuraAlternativa.CAMPO_DESCR_LUOGO_PROVA))
          lMisAlModAMM.setDescrLuogoProva(getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_DESCR_LUOGO_PROVA));
        ...
        if (lUffScar.equals("SORV") && lMisAlModAMM.getDataInizioMisura() != null && lPosMod.isLibero()) {
      ...
      IMisuraAlternativa lCtrlMisura = SICOLookupRemote.getMisuraAlternativaRemote();
      EventoNotificaModel lRetModel = lCtrlMisura.ExInserisciOModificaMANotifica(lEveNot, cPenaResiduaModel, lMisAlModAMM, null);
  ...
  public String SettaCodTipoProvvedimento(String PosizioneGiu, String flagverbale,
    ...
    String tipoMisura = "SEMINLIBERTA";
		if (tipoMisura.equals("SEMINLIBERTA")) {
			if (flagverbale.equals("S")) {
		  	...
		  	aCodTipoProvedimento = "12"; // Comunicazione
		  		     ...
		  		     && (   PosizioneGiu.equals("04")  // detetnuto o arresti domiciliari
		  		         || PosizioneGiu.equals("12") || PosizioneGiu.equals("13") || PosizioneGiu.equals("14") //già in misura
...
/*
    ...
    {
      if (   PosizioneGiu.equals("03") || PosizioneGiu.equals("04")  // detetnuto o arresti domiciliari
      		|| PosizioneGiu.equals("12") || PosizioneGiu.equals("13") || PosizioneGiu.equals("14") //già in misura
          || PosizioneGiu.equals("29") // Det Dom PROVV
          || PosizioneGiu.equals("54") // Aff Prov PROVV 
         ) 
  ...
  /**
   * Nel caso di ESEGUE SORVEGLIANZA soggetto libero va data decorrenza anche alla pena residua e calcolata la
   * data fine misura = data fine pena.
   * Calcola decorrenza e scadenza della pena a partire dell'ultima pena a
   * sistema (quantum) e dalla data inizio misura estratta dal MisuraAlternativaModel. 
   * 
  ...
  public void SettaDataFineMisuraSORV(MisuraAlternativaModel lMisMod) throws F3BException {
    ...
    try {
      ...
      PenaResiduaModel lPenaResiduaModel = lCalcoloPenaModel.getPenaDaEspiare(lMisMod.getDataInizioMisura(), null, "all");      
