...
/**
 * <p>Title: ActUploadMADetDomSpecSospProvv</p>
 ...
 * @version 1.0
 */
public class ActUploadMADetDomSpecSospProvv extends ActionSiap
    ...
    else
    {
  	...
  	//Prepara la "pagina" di destinAction
		...
		if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
		{
			...
			lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" + CAMPO_ID_EVENTO + "=" + getRequestStringParameter(ICostantiEvento.CAMPO_ID_EVENTO)+ "&flagRitorno=S&lIdposizione="+getRequestStringParameter("IdPosizioneGiuridica"));
