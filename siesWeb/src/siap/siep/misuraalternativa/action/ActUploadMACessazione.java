...
/**
 * <p>Title: ActUploadMACessazione</p>
 * <p>Description: Validazione della Cessazione della Misura alternativa</p>
 * <p>Questa Action è in comune a tutte le Misure: 
 *  - affidamento
 *  - detenzione domiciliare
 *  - semilibertà
 *  - indultino
 *  - detenzione domiciliare a termine 
 *  - Espiazione presso il domicilio</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadMACessazione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMACessazione(lModel, lFascMod);
    }
    else
    {
