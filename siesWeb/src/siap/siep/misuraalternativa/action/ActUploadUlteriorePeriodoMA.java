...
/**
 * <p>
 * Title: ActUploadUlteriorePeriodoMA
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActUploadUlteriorePeriodoMA extends ActionSiap implements ICostantiEvento {
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			lCtrl.ExUpdateValidaUlteriorePeriodoMA(lModel, lFascMod);
		} else {
