	...
	public String processRequest() throws F3BException {
		...
		if (lMisAlModAMM == null) {
			...
			if (tipoMisura.equals("AFFIDAMENTO") && lCodTipoProvvedimento.equals("26")) {
				...
				// MEV_2019-09 si rimappano i nuovi codici SIUS in caso di richiesta verbale sottoscrizione agli
				// obblighi
				...
				// MEV_2019-09 Si rimappano tutti i codici sius dell'Applicazione Provvisoria su nuovi codici SIEP
			...
			if (flagverbale.equals("N")) {
				...
				// MEV_2019-09: la modifica del luogo della prova è sempre consentita e non determina la
				// duplicazione del
