...
/**
 * <p>
 * Title: ActDettaglioMADetDomSpecAmmiPeriodo
 * </p>
 * <p>
...
public class ActDettaglioMADetDomSpecAmmiPeriodo extends ActMisuraAlternativa implements
...
//		PosizioneGiuridicaModel lPosGiuModificata = new PosizioneGiuridicaModel();
		...
		MisuraAlternativaModel lMisAlMod = lMisAltCtrl.ExRicercaMisuraAlternativaByIdEvento(lEveMod
		...
		/*
		 * //magistrato sorveglianza per la notifica if(lMisAlMod != null) { String lCodMag =
		 * lMisAlMod.getCodMagistrato();
		 * 
...
//		lDataFinePenaM = llPenMod.getDataFine();
		...
		return PG_LOAD_DETTAGLIO_MA_DETDOMSPECAMMIPERIODO;
	}
