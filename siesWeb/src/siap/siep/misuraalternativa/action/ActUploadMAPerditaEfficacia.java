...
/**
 * <p>Title: ActUploadMAPerditaEfficacia</p>
 * <p>Description: ActUploadMAIndultino</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadMAPerditaEfficacia extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMAPerditaEfficacia(lModel, lFascMod);
    }
    else
    {
