 ...
 */
public class ActDettaglioMAAmmProvSemiliberta extends ActMisuraAlternativa implements ICostantiMisuraAlternativa {
  ...
  public String processRequest() throws F3BException {
    ...
    MisuraAlternativaModel lMisura = lMisAltCtrl.ExRicercaMisuraAlternativaByIdEvento(lEveMod.getEvento().getEveIdEvento());
    ...
    if (lMisura != null) {
      ...
      lEveVer = lCtrlEven.ExRicercaEventoByEveIdEventoTipoProvCodMotivo(lMisura.getEveIdEvento(), "07", "18", "0314");
