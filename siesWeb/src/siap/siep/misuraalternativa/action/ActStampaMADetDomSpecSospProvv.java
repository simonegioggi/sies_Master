...
/**
 * <p>Title: ActStampaMADetDomSpecSospProvv</p>
...
public class ActStampaMADetDomSpecSospProvv
    extends ActionSiap
    implements ICostantiMisuraAlternativa
{
  public String processRequest() throws F3BException
  {
    ...
    if (lMotivo.equals("2152"))
    {
      if (   lMisAlMod != null
          && lMisAlMod.getCodTipoUfficioScarcerazione() != null
          && lMisAlMod.getCodTipoUfficioScarcerazione().equals("SORV"))//** TDS (SORVEGLIANZA) **
      {
        lEveMod.setNomeTemplate(TEMPLATE_DDS_MOTIVO_2152);
      }
      else
      {
        //** PROCURA **
        lEveMod.setNomeTemplate(TEMPLATE_DDS_MOTIVO_2152_BIS);
      }
    }
    else
    {
