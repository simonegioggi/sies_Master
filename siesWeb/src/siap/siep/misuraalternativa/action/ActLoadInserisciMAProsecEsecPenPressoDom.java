 ...
 */
public class ActLoadInserisciMAProsecEsecPenPressoDom extends ActProsecuzione51Bis {
	/**
	...
	public String processRequest() throws F3BException {
		...
		// lOggettiDecisione.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoProsecMAEsecPreDomMDS51Bis());
		//
		...
		lOggettiDecisioneAT.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoMAEspPressoDom());
