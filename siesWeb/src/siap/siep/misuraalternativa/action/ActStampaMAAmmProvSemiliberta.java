...
public class ActStampaMAAmmProvSemiliberta extends ActionSiap implements ICostantiMisuraAlternativa {
	...
	public String processRequest() throws F3BException {
		...
		// if (lPosAltra.getAltraCausa() != null && lPosAltra.getAltraCausa().getCodTipoPosGiuridica() !=
		// null) {
		...
		// ricerca misura alternativa legata all'evento (decreto/ordinanza) puntato dall'evento oggetto della
		// stampa
