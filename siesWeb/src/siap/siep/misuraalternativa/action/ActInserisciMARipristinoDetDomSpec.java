...
public class ActInserisciMARipristinoDetDomSpec extends ActMisuraAlternativa implements
...
//		String tipoMisura = "";
		...
		if (getRequestStringParameter("flagmisura").equals("N")) {
			...
			// String notificaPolizia = getRequestStringParameter("notificaPolizia");
			// String notificaAutorita = getRequestStringParameter("notificaAutorita");
			// setRequestAttribute("notificaPolizia", notificaPolizia);
			// setRequestAttribute("notificaAutorita", notificaAutorita);
			...
			lMisMod.setCodNaturaDecisione("RI");
			...
			lMisMod.setDataDecisione(getRequestDateParameter(
					...
					ICostantiMisuraAlternativa.CAMPO_MESE_DATA_DECISIONE,
					ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_DECISIONE));
			if (!isRequestParameterNullObj(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE)) {
			...
			if (!isRequestParameterNullObj("tipo")) {
				...
				if (lTipo.equals("scarcerato")) {
					lMisMod.setCodTipoUfficioScarcerazione("SORV");
				}
				if (lTipo.equals("scarcerare")) {
			...
			if (((lPosizione.equals("07") || lPosizione.equals("10") || lPosizione.equals("16")
					|| lPosizione.equals("17") || lPosizione.equals("46") || lPosizione.equals("47")
					|| lPosizione.equals("20") || lPosizione.equals("26") || lPosizione.equals("30")))
					|| lPosizione.equals("03")
					|| lPosizione.equals("04")
					|| lPosizione.equals("12")
					|| lPosizione.equals("14")) {
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.misuraalternativa.action.ActDettaglioMARipristinoDetDomSpec&"
			...
			lMisAlModConcessa = lMisAltController
					.ExRicercaMisuraAlternativaRipristinoDetDomSpecByIdFascicolo(lFascicoloModel
							.getIdFascicoloSiep());
			...
			if (((lPosizione.equals("07") || lPosizione.equals("10") || lPosizione.equals("16")
					...
					|| lPosizione.equals("12")
					|| lPosizione.equals("14")) {
				lEve.getEvento().setCodMotivo("0194");
