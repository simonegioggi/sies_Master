...
/**
 * <p>
 * Title: ActLoadInserisciCessazioneEspPressoDom
 * </p>
 * <p>
...
public class ActLoadInserisciCessazioneEspPressoDom extends ActRevoca {
	...
	public String processRequest() throws F3BException {
		...
		// Option lOption = new
		// Option(DecodificheManager.getInstance().getMotivoProvvedimentoCessazioneMAEspPressoDom());
		...
		Collection<DecodificheModel> lOggettoTDS51BisSuReclamo = new Vector(
				DecodificheManager.getInstance().getMotivoProvvedimentoCessazioneMAEspPressoDomTDS51bis());
