...
public class ActStampaMAAmmProvvisoria extends ActionSiap implements ICostantiMisuraAlternativa {
	...
	public String processRequest() throws F3BException {
		...
		if (lTipoMisura.equals("AFFIDAMENTO")) {
			...
			if (lEventoModel.getCodMotivo().equals("2008") || lEventoModel.getCodMotivo().equals("1400")
			...
			else if (lEventoModel.getCodMotivo().equals("2006") || lEventoModel.getCodMotivo().equals("1401")
					|| lEventoModel.getCodMotivo().equals("1411")) { // Vecchia gestione per il codice 2006
