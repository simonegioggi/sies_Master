...
/**
 * <p>Title: ActLoadInserisciEstensioneDefAffProvaCumulo</p>
...
public class ActLoadInserisciEstensioneDefAffProvaCumulo extends ActEstensioneDefinitiva
{
...
//setto il campo codice motivo
    Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoEstDefMAffP());
