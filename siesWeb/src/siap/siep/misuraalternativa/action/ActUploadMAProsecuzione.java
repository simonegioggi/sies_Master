...
/**
 * <p>Title: ActUploadMAProsecuzione</p>
 ...
 * @version 1.0
 */
public class ActUploadMAProsecuzione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    //BigDecimal lKeyMis = getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_ID_MISURA_ALTERNATIVA);
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaMAProsecuzione(lModel, lFascMod);
    }
    else
    {
