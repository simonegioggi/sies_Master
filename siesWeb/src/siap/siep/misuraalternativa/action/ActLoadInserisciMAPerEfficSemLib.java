...
/**
 * <p>Title: ActLoadInserisciMAPerEfficSemLib</p>
...
public class ActLoadInserisciMAPerEfficSemLib extends ActPerditaEfficacia
{
...
//ricerca referto di scarcerazione
    ...
    if(lEvento != null && lEvento.getIdEvento() != null)
    {
     ...
     if(lEventoProv != null && lEventoProv.getCodMotivo() != null && lEventoProv.getCodMotivo().equals("2163"))
     {
...
//setto il campo codice motivo
    Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoMAPreEffSemli());
