 ...
 * @version 1.0
 */
public class ActUploadMAReLibCond extends ActionSiap implements ICostantiEvento {
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			lCtrl.ExUpdateValidaMAReLibCond(lModel, lFascMod);
		} else {
