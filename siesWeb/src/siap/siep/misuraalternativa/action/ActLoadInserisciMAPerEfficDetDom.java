...
/**
 * <p>Title: ActLoadInserisciMAPerEfficDetDom</p>
...
public class ActLoadInserisciMAPerEfficDetDom extends ActPerditaEfficacia
{
...
//ricerca referto di scarcerazione
    ...
    if(lEvento != null && lEvento.getIdEvento() != null)
    {
      ...
      if(lEventoProv != null && lEventoProv.getCodMotivo() != null &&
        (lEventoProv.getCodMotivo().equals("2164") || lEventoProv.getCodMotivo().equals("2165") ||
         lEventoProv.getCodMotivo().equals("2166") || lEventoProv.getCodMotivo().equals("2167")))
     {
...
//setto il campo codice motivo
    Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoMAPreEffDetDom());
