...
/**
 * <p>
 * Title: ActDettaglioMACoLibCond
 * </p>
 * <p>
 * Description: Classe Action per la load dettaglio di concessione liberazione anticipata
 * </p>
 * <p>
...
public class ActDettaglioMACoLibCond extends ActMisuraAlternativa implements ICostantiMisuraAlternativa {
...
//		PosizioneGiuridicaModel lPosGiuModificata = new PosizioneGiuridicaModel();
		...
		// ricerca misura per EVE_ID EVENTO
		...
		return PG_LOAD_DETTAGLIO_MA_CONC_LIB_COND;
	}
