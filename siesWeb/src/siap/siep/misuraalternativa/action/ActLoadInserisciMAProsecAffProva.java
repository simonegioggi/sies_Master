 ...
 */
public class ActLoadInserisciMAProsecAffProva extends ActProsecuzione51Bis {
	/**
	...
	public String processRequest() throws F3BException {
		...
		// lOggettiDecisione.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoProsecMAAffProMDS51Bis());
		//
		...
		lOggettiDecisioneAT.addAll(DecodificheManager.getInstance().getMotivoProvvedimentoMAffP());
