...
/**
 * <p>
 * Title: ActLoadInserisciMAAmmDetDomSpeAff
 * </p>
 * <p>
...
public class ActLoadInserisciMAAmmDetDomSpeAff extends ActMisuraAlternativa implements
	...
	public String processRequest() throws F3BException {
		...
		lMisAlModConcessa = lMisAltController.ExRicercaMisuraAlternativaDetDomSpeAmmAffByIdFascicolo(lFascMod
				.getIdFascicoloSiep());
		...
		Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoMADetDomSpeAff());
		...
		return PG_LOAD_INSERISCI_MA_AMM_DET_DOM_SPE_AFF;
	}
