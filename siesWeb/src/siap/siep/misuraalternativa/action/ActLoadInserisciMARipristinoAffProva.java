...
/**
 * <p>Title: ActLoadInserisciMARipristinoAffProva</p>
 * <p>Description: Classe Action per la load inserisci di Ripristino Affidamento in Prova</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: Bull</p>
 * @version 1.0
 */

public class ActLoadInserisciMARipristinoAffProva extends ActRipristino
{
...
//ricerca esistenza almeno una  misura alternativa sospesa
     ...
     String[] tipoMisura = {"2145","2146","2147"};
     String[] natura = {"SP"};
     String[] decisione = {"02"};
...
//setto il campo codice motivo
    Option lOption = new Option(DecodificheManager.getInstance().getMotivoProvvedimentoRipristinoMAffP());
