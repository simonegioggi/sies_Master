...
public class ActLoadInserisciMACess51bisIndultino extends ActCessazione51bis {
	...
	public String processRequest() throws F3BException {
		...
		Collection<DecodificheModel> lCollOggettoMDS51bis = new Vector(
				DecodificheManager.getInstance().getMotivoProvvedimentoCessazioneMAIndultinoMDS51bis());
		Option lOggettoMDS51bis = new Option(lCollOggettoMDS51bis);
		setRequestAttribute("comboOggettiMDS", lOggettoMDS51bis.toString());

		setRequestAttribute("tipoCessazione", "INDULTINO");
