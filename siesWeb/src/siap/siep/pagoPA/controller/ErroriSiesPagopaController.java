...
public class ErroriSiesPagopaController  extends SiapController implements IErroriSiesPagopa {
   ...
   * 
   */
  public ErroriSiesPagopaModel ExInserisciErroreSiesPagopa (ErroriSiesPagopaModel aErrModel) throws F3BException {
   ...
   * 
   */
  public ErroriSiesPagopaModel ExRicercaErroreSiesPagopaByKey (BigDecimal aIdErrore)
      throws F3BException
  {
    Connection c = null;
    ...
    try {
      ...
      throw new SIEPException("ErroriSiesPagopaController.ExRicercaErroreSiesPagopaByKey: Non posso leggere : " + daoEx);
    } finally {
      ...
      throws F3BException
  {
    ...
    try {
      ...
      siesLogger.error("DAOException: ",daoEx);
      throw new SIEPException("ErroriSiesPagopaController.ExRicercaErroriSiesPagopaByCriteria: Non posso leggere : " + daoEx);
    } finally {
      cleanup(lErrSiesSqlDao);
      cleanup(c);
    }
   ...
   * 
   */
  public ErroriSiesPagopaModel ExInserisciAggiornaErroreSiesPagopa (ErroriSiesPagopaModel aErrModel) throws F3BException {
    ErroriSiesPagopaModel lErroreModelRet = null;
    ErroriSiesPagopaDAO lErroreDAO = null;
    ErroriSiesPagopaSqlDAO lErrSiesSqlDao = null;
    Connection c = null; 
    ...
    try {
      ...
      Vector <ErroriSiesPagopaModel> lListaErrori = new Vector <ErroriSiesPagopaModel> (lErrSiesSqlDao.getModels());
      ...
      if (lListaErrori.size()==0) {
        ...
        ErroriSiesPagopaModel lErroreDaAggiornare = (ErroriSiesPagopaModel) lListaErrori.elementAt(0);        
        ...
        siesLogger.warn("Attenzione è presente più di un 'ERRORI_SIES_PAGOPA' che corrisponde a quello in ingresso..."); 
      }
