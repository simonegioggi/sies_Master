...
public class CivilmenteObbligatoSqlDAO extends SIAPSqlDAO {
	...
	protected String getSqlQuery() {
		...
		s += "SELECT CO.ID_CIVILMENTE_OBBLIGATO, CO.COD_TUTORE, CO.COD_PERSONA,"
				...
				+ " CO.PEC, CO.E_MAIL, CO.FAS_SIE_ID_FASCICOLO_SIEP, DESCR_TUTORE.RV_MEANING DESCR_TUTORE"
				...
				+ " LEFT OUTER JOIN CG_REF_CODES DESCR_TUTORE ON (DESCR_TUTORE.RV_DOMAIN = 'TIPO_TUTORE' AND"
				+ " DESCR_TUTORE.RV_LOW_VALUE = CO.COD_TUTORE)"
				+ " WHERE 1 = 1";
		return s;
	}
	...
	public GenericModel getModel() throws DAOException {
		...
		aModel.setDescrTutore(getString("DESCR_TUTORE"));
