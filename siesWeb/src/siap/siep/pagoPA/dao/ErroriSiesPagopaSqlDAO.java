...
public class ErroriSiesPagopaSqlDAO extends SIAPSqlDAO {
  ...
  protected String getSqlQuery() {
    ...
    String s = new String("");
/*
    s += "SELECT ID_ERRORI_SIES_PAGOPA, ID_FASCICOLO_SIEP, ID_EVENTO, ";
    s +=       " AZIONE_CONTESTO_JAVA, DESCRIZIONE_FUNZIONE, ";
    s +=       " COD_UTENTE, COD_UFFICIO, "; 
    s +=       " ERRORE_ESECUZIONE, DATA_INSERIMENTO, ";
    s +=       " DATA_VISUALIZZAZIONE, COD_UTENTE_VISUALIZZAZIONE "; 
    s += "  FROM ERRORI_SIES_PAGOPA  ";
    s += " WHERE 1 = 1 ";  
*/
  ...
  public void ricercaErroreaByCriteria (ErroriSiesPagopaModel aCriteriRicerca, int aPage) throws DAOException {
    ...
    if (aCriteriRicerca.getAzioneContestoJava()!=null && aCriteriRicerca.getAzioneContestoJava().trim().length()>0)
