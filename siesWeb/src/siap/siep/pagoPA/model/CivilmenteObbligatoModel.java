 ...
 * @version 1.0
 */
public class CivilmenteObbligatoModel extends GenericModel {
	...
	private List<CivilmenteObbligatoDifensoreModel> mDifensori;
	...
	public CivilmenteObbligatoModel(CivilmenteObbligatoModel aModel) {
		...
		this.mIndirizzoResidenza = aModel.mIndirizzoResidenza;
	...
	public String getCodFiscaleRap() {
		return mCodFiscaleRap;
	}
	...
	public List<CivilmenteObbligatoDifensoreModel> getDifensori() {
		return mDifensori;
	}
	...
	public void setDescComuneNascita(String aValore) {
		mDescComuneNascita = aValore;
	}
	...
	public void setDifensori(List<CivilmenteObbligatoDifensoreModel> aValore) {
		mDifensori = aValore;
	}
	...
	public void setIndirizzoResidenza(String aValore) {
		mIndirizzoResidenza = aValore;
	}

	public void setPec(String mPec) {
		this.mPec = mPec;
	}
