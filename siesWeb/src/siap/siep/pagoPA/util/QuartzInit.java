...
public class QuartzInit extends HttpServlet {
    ...
    public void init() {
        ...
        pagoPaLogger.info("");
        pagoPaLogger.info("===================================================");
        pagoPaLogger.info("Inizializzazione schedulazione batch pagoPA  ");
       
        
        try {
            String lPagoPaSchedulerEnabled = F3BProperties.getInstance().getProperty("PagoPaSchedulerEnabled");
            ...
            if ("true".equals(lPagoPaSchedulerEnabled)) {
                ...
                if(!esisteCheckBollettini) 
                {
                    ...
                    //Blocco la scedulazione nel caso in cui al primo avvio la voglio configurare da interfaccia grafica
