...
/**
* <p>Title: ActInserisciOELibero</p>
...
public class ActInserisciOELibero extends ActionSiap implements ICostantiOrdineEsecuzione
{
/**
...
public String processRequest() throws F3BException
      ...
      //Codice motivo da CG_REF_CODES....
       ...
       DecodificheModel lDecMod = lDec.ExRicercaDecodificheByHighValue("OE-LIB");
    ...
    //Inserisco l'array di Notifiche nell'Evento
     ...
     String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.sico.evento.action.ActLoadDettaglioEventoNotifica&"+  ICostantiEvento.CAMPO_ID_EVENTO +"="+lRetModel.getEvento().getIdEvento()+"&modalita=I";
     return lPage;
