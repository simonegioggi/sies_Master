...
/**
 * <p>
 * Title: ActDettaglioLSAltrePosizioni
 * </p>
 * <p>
 * Description: Classe Action per la load dettaglio della Legge Simeone Altre Posizioni
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActDettaglioLSAltrePosizioni extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		// Istanza
		/*
		 * REWORK EventoModel lEveIstanzaMod = new EventoModel();
		 * lEveIstanzaMod.setFasSieIdFascicoloSiep(lEveMod.getEvento().getFasSieIdFascicoloSiep());
		 * //lEveMod.setCodTipoEvento("03"); IEvento lEvCtrl = SICOLookupRemote.getEventoRemote(); Vector
		 * lVectEvento = null; try { lVectEvento = lEvCtrl.ExRicercaEventoIstanzaRigettata(lEveIstanzaMod);
		 * //lVectEvento = lEvCtrl.ExRicercaEvento(lEveMod); } catch (F3BException e) { if (e.getErrorCode()
		...
		return PG_DETTAGLIO_LS_ALTRE_POSIZIONI;
	}
