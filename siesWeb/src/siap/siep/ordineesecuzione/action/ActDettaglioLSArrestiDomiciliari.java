...
/**
 * <p>
 * Title: ActDettaglioLSArrestiDomiciliari
 * </p>
 * <p>
 * Description: Classe Action per la load dettaglio di Ordine Esecuzione Simeone per Arresti Domiciliari
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActDettaglioLSArrestiDomiciliari extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		setRequestAttribute("tipoUfficio", "" + "SPA");
		setRequestAttribute("tipoUfficioMagistrato", "" + "UDS");
		 ...
		 * lEveModel.setCodTipoEvento("03"); IEvento lEvCtrl = SICOLookupRemote.getEventoRemote();
		 * 
		 * Vector lVectEvento = null; try { lVectEvento =
		...
		return PG_DETTAGLIO_LS_ARRESTI_DOMICILIARI;
	}
