 ...
 * @version 1.0
 */
public class ActUploadLS extends ActionSiap
							implements ICostantiEvento
{
	public String processRequest() throws Exception
	{
		...
		if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
		{
			...
			lCtrl.ExUpdateValidaLS(lModel, lFascMod);
		      ...
		      if(lPos!=null && lPos.getPosizioneGiuridica().getCodPosizioneGiuridica()!=null){
...
//			      if ( codPosCorrente.equals("76") ||  codPosCorrente.equals("77"))
//			      {
//			    	  lPos.getPosizioneGiuridica().setCodMaschera("L2");
//			    	  lPos.getPosizioneGiuridica().setAltCauIdAltraCausa(null);
//			      }
