...
/**
 * <p>
 * Title: ActDettaglioRevocaLSLibero
 * </p>
 * <p>
 * Description: Classe Action per il Dettaglio Revoca LS Libero
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActDettaglioRevocaLSLibero extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		/*
		 * SULLA JSP il decreto non viene mai usato!!! //decreto di Sospensione EventoModel lEventoMod = new
		 * EventoModel(); IEvento lEventoCtrl = SICOLookupRemote.getEventoRemote(); lEventoMod =
		 * lEventoCtrl.ExRicercaEventoByFascicoloSiepDecretoSospensione(lEveMod.getEvento().
		 * getFasSieIdFascicoloSiep());
		 * 
		 * setRequestAttribute("decreto", lEventoMod);
		 */
		/*
		 * L'istanza in questo caso non c'e' altrimenti sarei in ActDettaglioRevocaLSLiberoIstanzaProdotta
		 * 
		 ...
		 * lVectEvento = null; try { lVectEvento = lEvCtrl.ExRicercaEvento(lEveModel); } catch (F3BException
		 * e) { if (e.getErrorCode() != F3BException.USER_MESSAGE) { throw e; } }
		 * 
		 ...
		 * }
		 */
		return PG_DETTAGLIO_REVOCA_LS_LIBERO;
	}
