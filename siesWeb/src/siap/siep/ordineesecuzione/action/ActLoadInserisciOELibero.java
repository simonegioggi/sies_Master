...
/**
* <p>Title: ActLoadInserisciOELibero</p>
* <p>Description: Classe Action per la load inserisci </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
* @deprecated probabilmente non più utilizzata  
*/

@Deprecated
public class ActLoadInserisciOELibero extends ActionSiap implements ICostantiOrdineEsecuzione
{
     ...
     if( isSessionAttributeNullObj("fascicolo") )
      {
        String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
                        ...
                        "siap.siep.ordineesecuzione.action.ActLoadInserisciOELibero";
