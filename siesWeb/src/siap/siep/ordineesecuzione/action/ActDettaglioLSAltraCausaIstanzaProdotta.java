 ...
 * @version 1.0
 */
public class ActDettaglioLSAltraCausaIstanzaProdotta extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		 ...
		 * 
		 * if (lVectEvento != null) { if (lVectEvento.size() > 0) {
		 */
		...
		return PG_DETTAGLIO_LS_ALTRA_CAUSA_ISTANZA;
	}
