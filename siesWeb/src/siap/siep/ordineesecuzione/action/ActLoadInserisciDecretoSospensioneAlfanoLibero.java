...
/**
 * <p>
 * Title: ActLoadInserisciDecretoSospensioneAlfanoLibero
 * </p>
 * <p>
 * Description: Classe d'inserimento del Decreto di Sospensione Decreto Alfano (Pos Giu Libero)
 * </p>
 * <p>
 * </p>
 * <p>
 ...
 * </p>
 */
public class ActLoadInserisciDecretoSospensioneAlfanoLibero extends ActionSiap
	...
	public String processRequest() throws F3BException {
		...
		if (lFascMod.getFlagValidato().equalsIgnoreCase("N")) {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT, "Il Procedimento N." + lFascMod.getChiaveAnno()
					...
					+ " non è stato Validato. Impossibile inserire un Decreto di sospensione Legge Alfano!");
		...
		try {
			...
			lRedirigi.setPage(IWebConstants.PG_MAIN);
			setRequestAttribute(IWebConstants.MESSAGE_TEXT,
					e.getMessage() + " Impossibile eseguire il Decreto di Sospensione.");
		...
		// La posizione giuridica deve essere "Libero"
		...
		if (lFascMod.getFlagAltraCausa() != null && lFascMod.getFlagAltraCausa().equals("S")) {
			...
			// modifica relativa al tipo istituto
			if (lPos.getPosizioneGiuridica().isLibero() || lCodPosGiu.equals("02")
					|| lCodPosGiu.equals("04")) {
				lOption = new Option(DecodificheManager.getInstance().getTipoAutorita());
			} else {
		...
		return PG_LOAD_INSERISCI_DECRETO_SOSPENSIONE_ALFANO_LIBERO; // restituisce la jsp di VIEW
	}
