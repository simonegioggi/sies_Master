...
public class ActStampaLAlfanoNonLibero
    extends ActionSiap
    implements ICostantiOrdineEsecuzione
{
  public String processRequest() throws F3BException
  {
	...
	lEveMod.setNomeTemplate(TEMPLATE_ORDINE_ESECUZIONE_ALFANO_NONLIBERO_01);

	if (lIdPos.compareTo("02") == 0 || lIdPos.compareTo("70") == 0 ||
		lIdPos.compareTo("71") == 0 || lIdPos.compareTo("72") == 0 )
		lEveMod.setNomeTemplate(TEMPLATE_ORDINE_ESECUZIONE_ALFANO_NONLIBERO_02);
