 ...
 *
 * <p>
 * Title: ActLoadInserisciComunicazioneL78del2013
 * </p>
 * <p>
 * Description: Classe d'inserimento Del decreto (Comunicazione) Giugno 2013
 * </p>
 * <p>
 * </p>
 * <p>
 ...
 *
 */
public class ActLoadInserisciComunicazioneL78del2013 extends ActionSiap
		implements ICostantiOrdineEsecuzione, ICostantiNotifica {
	...
	public String processRequest() throws F3BException {
		...
		if (lFascMod.getFlagValidato().equalsIgnoreCase("N")) {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT, "Il Procedimento N." + lFascMod.getChiaveAnno()
					...
					+ " non è stato Validato. Impossibile inserire la Comunicazione ex art. 656 co.4 Bis cpp!");
		...
		if (lCodPosGiu.equals("46") || lCodPosGiu.equals("20") || lCodPosGiu.equals("02")
				|| lCodPosGiu.equals("05") || lCodPosGiu.equals("07") || lCodPosGiu.equals("08")
				|| lCodPosGiu.equals("10") || lCodPosGiu.equals("16") || lCodPosGiu.equals("17")
				|| lCodPosGiu.equals("23") || lCodPosGiu.equals("26") || lCodPosGiu.equals("70")
		...
		if (lPos.getPosizioneGiuridica().isLibero() || lCodPosGiu.equals("02") || lCodPosGiu.equals("70")
				|| lCodPosGiu.equals("71") || lCodPosGiu.equals("72")) {
		...
		return PG_LOAD_INSERISCI_COMUNICAZIONE_LEGGE_78_2013; // restituisce la jsp di VIEW
	}
