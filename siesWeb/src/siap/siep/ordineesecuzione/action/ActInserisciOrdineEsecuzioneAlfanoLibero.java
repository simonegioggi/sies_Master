 ...
 *
 * <p>
 * Title: ActInserisciOrdineEsecuzioneAlfanoLibero
 * </p>
 * <p>
 * Description: Inserimento degli Ordini di Esecuzione AlfanoLibero
 * </p>
 * <p>
 ...
 * </p>
 */
public class ActInserisciOrdineEsecuzioneAlfanoLibero extends ActOrdineEsecuzione
	...
	public String processRequest() throws Exception {
		...
		// 21/04/2015
		// MEV 10 S3 gestite le nuove posizioni giuridiche (76,77)
		if (lFascicoloModel.getFlagAltraCausa() != null && lFascicoloModel.getFlagAltraCausa().equals("S")) {
			...
			if (lPos.getAltraCausa() != null && lPos.getAltraCausa().getCodTipoPosGiuridica() != null
				...
				lPage = InserisciLSAltraCausa(lPos.getAltraCausa().getCodTipoPosGiuridica());

			} else {
				// funzionamento precedente alla MEV 10 S3
	...
	/**
	 * Inserisci l'ordine di Esecuzione Alfano per Libero
	 * 
	 * @return
	 * @throws Exception
	 */
	private String InserisciLALibero() throws Exception {
		...
		if (lIstPre.equals("N"))
			lEve.getEvento().setDescrMotivo("LED-LIB");
		else
			lEve.getEvento().setDescrMotivo("LED-LIB-I");
		...
		if (lIstPre.equals("S")) {
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.ordineesecuzione.action.ActDettaglioLAlfanoLibero&"
					+ ICostantiEvento.CAMPO_ID_EVENTO + "=" + lRetModel.getEvento().getIdEvento()
					+ "&modalita=I&fc=" + lFc;
		}
	...
	private String InserisciLSAltraCausa(String codPosGiuridica) throws Exception {
		String lCodiceOperatore = this.getCodUtenteConnesso();
		String lCodiceUfficio = this.getCodUfficioUtenteConnesso();
		Date lDataEmissione = getRequestDateParameter(ICostantiEvento.CAMPO_ANNO_DATA_EMISSIONE,
				ICostantiEvento.CAMPO_MESE_DATA_EMISSIONE, ICostantiEvento.CAMPO_GIORNO_DATA_EMISSIONE);
		...
		if (codPosGiuridica.equals("76")) {
			lEve.getEvento().setDescrMotivo("OE_AC_DET");
		} else if (codPosGiuridica.equals("77")) {
			lEve.getEvento().setDescrMotivo("OE_AC_MS");
		}
