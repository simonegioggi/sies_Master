...
public class ActStampaLSLiberoIstanzaProdotta
    extends ActionSiap
    implements ICostantiOrdineEsecuzione
{
  public String processRequest() throws F3BException
  {
    ...
    //Modifica richiesta il 25-02-04
    if ( (getRequestStringParameter("autorita").equals("22")))
    {
      lEveMod.setNomeTemplate(TEMPLATE_ORDINE_ESECUZIONE_SIMEONE_LIBERO_ISTANZA_ESTERNE);
      // lEveMod.setNomeTemplate(TEMPLATE_ORDINE_ESECUZIONE_SIMEONE_LIBERO_ISTANZA_POLIZIA);
    }
    else
    {
       lEveMod.setNomeTemplate(TEMPLATE_ORDINE_ESECUZIONE_SIMEONE_LIBERO_ISTANZA_POLIZIA);
