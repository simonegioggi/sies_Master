...
/**
 * PenaComplessivaDAO - Classe DAO che rappresenta la tabella PenaComplessiva
 *
 * @version 1.0
 */
public class PenaComplessivaDAO extends SIAPTableDAO {
	...
	public BigDecimal getIdPenaComplessiva() throws DAOException {
		return getBigDecimal("ID_PENA_COMPLESSIVA");
	}

	public String getCodTipoPenaDetentiva() throws DAOException {
		return getString("COD_TIPO_PENA_DETENTIVA");
	}
	...
	public String getFlagPenaInContinuazione() throws DAOException {
		return getString("FLAG_PENA_IN_CONTINUAZIONE");
	}
	...
	public BigDecimal getNumAnniCondonati() throws DAOException {
		return getBigDecimal("NUM_ANNI_CONDONATI");
	}

	public BigDecimal getNumMesiCondonati() throws DAOException {
		return getBigDecimal("NUM_MESI_CONDONATI");
	}

	public BigDecimal getNumGiorniCondonati() throws DAOException {
		return getBigDecimal("NUM_GIORNI_CONDONATI");
	}

	public BigDecimal getImportoCondonato() throws DAOException {
		return getBigDecimal("IMPORTO_CONDONATO");
	}
	...
	public Date getDataInizioIsolamentoDiurno() throws DAOException {
		return getDate("DATA_INIZIO_ISOLAMENTO_DIURNO");
	}

	public Date getDataFineIsolamentoDiurno() throws DAOException {
		return getDate("DATA_FINE_ISOLAMENTO_DIURNO");
	}

	public BigDecimal getNumAnniIsolamentoDiurno() throws DAOException {
		return getBigDecimal("NUM_ANNI_ISOLAMENTO_DIURNO");
	}

	public BigDecimal getNumMesiIsolamentoDiurno() throws DAOException {
		return getBigDecimal("NUM_MESI_ISOLAMENTO_DIURNO");
	}

	public BigDecimal getNumGiorniIsolamentoDiurno() throws DAOException {
		return getBigDecimal("NUM_GIORNI_ISOLAMENTO_DIURNO");
	}

	public Date getDataPrescrizione() throws DAOException {
		return getDate("DATA_PRESCRIZIONE");
	}
	...
	public void setIdPenaComplessiva(BigDecimal aValore) {
		setBigDecimal("ID_PENA_COMPLESSIVA", aValore);
	}

	public void setCodTipoPenaDetentiva(String aValore) {
		setString("COD_TIPO_PENA_DETENTIVA", aValore);
	}
	...
	public void setFlagPenaInContinuazione(String aValore) {
		setString("FLAG_PENA_IN_CONTINUAZIONE", aValore);
	}
	...
	public void setNumAnniCondonati(BigDecimal aValore) {
		setBigDecimal("NUM_ANNI_CONDONATI", aValore);
	}

	public void setNumMesiCondonati(BigDecimal aValore) {
		setBigDecimal("NUM_MESI_CONDONATI", aValore);
	}

	public void setNumGiorniCondonati(BigDecimal aValore) {
		setBigDecimal("NUM_GIORNI_CONDONATI", aValore);
	}

	public void setImportoCondonato(BigDecimal aValore) {
		setBigDecimal("IMPORTO_CONDONATO", aValore);
	}
	...
	public void setDataInizioIsolamentoDiurno(Date aValore) {
		setDate("DATA_INIZIO_ISOLAMENTO_DIURNO", aValore);
	}

	public void setDataFineIsolamentoDiurno(Date aValore) {
		setDate("DATA_FINE_ISOLAMENTO_DIURNO", aValore);
	}

	public void setNumAnniIsolamentoDiurno(BigDecimal aValore) {
		setBigDecimal("NUM_ANNI_ISOLAMENTO_DIURNO", aValore);
	}

	public void setNumMesiIsolamentoDiurno(BigDecimal aValore) {
		setBigDecimal("NUM_MESI_ISOLAMENTO_DIURNO", aValore);
	}

	public void setNumGiorniIsolamentoDiurno(BigDecimal aValore) {
		setBigDecimal("NUM_GIORNI_ISOLAMENTO_DIURNO", aValore);
	}

	public void setDataPrescrizione(Date aValore) {
		setDate("DATA_PRESCRIZIONE", aValore);
	}

	public GenericModel getModel() throws DAOException {

		return new PenaComplessivaModel(getIdPenaComplessiva(), getCodTipoPenaDetentiva(), "",
				getNumAnniReclusione(), getNumMesiReclusione(), getNumGiorniReclusione(), getImportoMulta(),
				getNumAnniArresto(), getNumMesiArresto(), getNumGiorniArresto(), getImportoAmmenda(),
				getDataInizio(), getDataFine(), getCodTipoRito(), "", getFlagPenaInContinuazione(),
				...
				getNumAnniCondonati(), getNumMesiCondonati(), getNumGiorniCondonati(), getImportoCondonato(),
				getFasSieIdFascicoloSiep(), getDataInizioIsolamentoDiurno(), getDataFineIsolamentoDiurno(),
				getNumAnniIsolamentoDiurno(), getNumMesiIsolamentoDiurno(), getNumGiorniIsolamentoDiurno(),
				getDataPrescrizione());
	}
	...
	public void setDAOFromModelForUpdate(PenaComplessivaModel aModel) throws DAOException {
		...
		// setDataInizio( aModel.getDataInizio());
		// setDataFine( aModel.getDataFine());
		// MEV_2025-48: aggiunta nuova sezione che insiste sul codice tipo rito = 'E'
		setCodTipoRito(aModel.getCodTipoRito());
		// setFlagPenaInContinuazione( aModel.getFlagPenaInContinuazione());
		setCodOperatoreAggiornamento(aModel.getCodOperatoreAggiornamento());
		setDataAggiornamento(aModel.getDataAggiornamento());
