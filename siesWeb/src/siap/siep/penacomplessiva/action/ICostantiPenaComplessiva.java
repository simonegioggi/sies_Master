...
/**
 * ICostantiPenaComplessiva - Classe di costanti di PenaComplessiva
 *
 * @version 1.0
 */
public interface ICostantiPenaComplessiva {
	...
	public static final String PG_LOAD_RICERCAPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/LoadRicercaPenaComplessiva.jsp";
	public static final String PG_LOAD_DETTAGLIOPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/DettaglioPenaComplessiva.jsp";
	public static final String PG_RICERCAPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/RicercaPenaComplessiva.jsp";
	public static final String PG_LOAD_INSERISCIPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/LoadInserisciPenaComplessiva.jsp";

	public static final String PG_LOAD_INSERISCI_ULTERIORI_CONTINUAZIONI = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/LoadInserisciUlterioriContinuazioni.jsp";
	public static final String PG_LOAD_MODIFICA_CONTINUAZIONE = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/LoadModificaContinuazione.jsp";
	public static final String PG_LOAD_DETTAGLIOMODIFICAPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/DettaglioModificaPenaComplessiva.jsp";
	public static final String PG_LOAD_DETTAGLIOCANCELLAPENACOMPLESSIVA = IWebConstants.ROOT_DIR
			+ "files/siap/siep/penacomplessiva/DettaglioCancellaPenaComplessiva.jsp";

	// MEV_2025-48: aggiunta nuova sezione
	public static final String CAMPO_FLAG_CONFISCA_PER_EQUIVALENTE = "FlagConfiscaPerEquivalente";
