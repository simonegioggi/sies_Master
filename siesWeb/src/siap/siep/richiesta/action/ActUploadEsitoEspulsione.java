...
/**
 * <p>Title: ActUploadEsitoEspulsione</p>
 * <p>Description: Validazione della richiesta esito espulsione</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadEsitoEspulsione extends ActionSiap
  implements ICostantiRichiesta
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrlRich.ExUpdateValidaRichiestaEsitoEspulsione(lModel,lFascMod);
    }
    else
    {
