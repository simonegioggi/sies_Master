 ...
 *
 * <p>
 * Title: ActDettaglioRichiesteDepenIncost
 * </p>
 * <p>
 * Description:
 * </p>
...
public class ActDettaglioRichiesteDepenIncost extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		if (lEveMod != null && lEveMod.getEvento() != null
			...
			String[] motivi = { "0210", "0211" };
			String[] lProvv = { "04", "26" };
			lEveModRic = lCtrlEve.ExRicercaEventoPerMotivoPerProvv(motivi, lProvv, lEveModRic);

			// lEveModRic = lCtrlEve.ExRicercaEventoPerMotivo(motivi,lEveModRic);
		...
		Vector lreati = IRea.ExRicercaReatoCircostanzaByFascicolo(lFascMod.getIdFascicoloSiep());
		this.setRequestAttribute("reati", lreati);
		...
		return PG_DETTAGLIO_RICHIESTA_DEP_O_INCONST;
	}
