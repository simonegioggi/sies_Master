...
public class ActUploadRichDetPenAboReato extends ActionSiap
                                         implements ICostantiEvento
{
  ...
  public String processRequest() throws Exception
  {
    ...
    //==========================================================================
    // Recupero l'evento da validare (Richiesta)
    //==========================================================================
    ...
    // (evento di appoggio, se ancora esiste)
    //========================================================================
    ...
    if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA))
    {
      ...
      // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
      siesLogger.debug("per aggiornare il flag@@@@@@@@@@" + lModel);

      lCtrlRich.ExUpdateValidaRichDetPenAboReato(lEveModRic, lModel, lFascMod);
    }
    else
    {
