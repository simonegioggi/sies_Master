...
/**
 * <p>
 * Title: ActConfermaTrasmissioneAttiExArt51Bis
 * </p>
 * <p>
 * Description: Classe Action per la conferma della trasmissione
 * </p>
 * <p>
 * del provvedimento 'ATTI di Richiesta Cessazione/Prosecuzione
 * </p>
 * <p>
 * della Misura Alternativa corrente (Ex art 51 Bis)'
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActConfermaTrasmissioneAttiExArt51Bis extends ActionSiap
	...
	public String processRequest() throws Exception {
		...
		try {
			...
			if (lNotEvento.getEvento().getCodMotivo().equals("5440"))
				lMessage.setCodTipoOperazione(RICHIESTA_CESSAZIONE_MISURA);
			else if (lNotEvento.getEvento().getCodMotivo().equals("5441"))
				lMessage.setCodTipoOperazione(RICHIESTA_PROSECUZIONE_MISURA);
