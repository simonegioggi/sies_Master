...
/**
*
* <p>Title: ActUploadRichAccDataReato </p>
* <p>Description: Action di Upload o Validazione per la Richiesta accertamento data commesso reato</p>
* <p>Copyright: Copyright (c) 2006</p>
* <p>Company: </p>
*/

public class ActUploadRichAccDataReato extends ActionSiap
                                       implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA))
    {
      ...
      lCtrlRich.ExUpdateValidaRichiestaAccReato(lEveModRic,lModel,lFascMod);
    }
    else
    {
