 ...
 *
 * <p>
 * Title: ActDettaglioRichiesteConCodice
 * </p>
 * <p>
 * Description:
 * </p>
...
public class ActDettaglioRichiesteConCodice extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		if (!this.isRequestParameterNullObj("modifica")
				&& "R".equals(this.getRequestStringParameter("modifica"))) {
			// Provengo dal dettaglio dei Provv del PM
			this.setRequestAttribute("modifica", "D");
		}

		setRequestAttribute("magistrato", lMagi);

		return PG_DETTAGLIO_RICHIESTe_CON_CODICE;
	}
