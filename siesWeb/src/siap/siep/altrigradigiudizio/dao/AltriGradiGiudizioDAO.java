...
/**
 * AltriGradiGiudizioDAO - Classe DAO che rappresenta la tabella AltriGradiGiudizio
 *
 * @version 1.0
 */
public class AltriGradiGiudizioDAO extends TableDAO {
	...
	public BigDecimal getIdAltrigradigiudizio() throws DAOException {
		return getBigDecimal("ID_ALTRIGRADIGIUDIZIO");
	}

	public Date getDataSentenzaIGrado() throws DAOException {
		return getDate("DATA_SENTENZA_I_GRADO");
	}

	public BigDecimal getAnnoSentenzaIGrado() throws DAOException {
		return getBigDecimal("ANNO_SENTENZA_I_GRADO");
	}

	public String getNumeroSentenzaIGrado() throws DAOException {
		return getString("NUMERO_SENTENZA_I_GRADO");
	}

	public String getCodAutEmittSentIGrado() throws DAOException {
		return getString("COD_AUT_EMITT_SENT_I_GRADO");
	}

	public String getCodLuoEmittSentIGrado() throws DAOException {
		return getString("COD_LUO_EMITT_SENT_I_GRADO");
	}

	public String getNumSezEmittSentIGrado() throws DAOException {
		return getString("NUM_SEZ_EMITT_SENT_I_GRADO");
	}

	public String getCodTipoSentenzaIiGrado() throws DAOException {
		return getString("COD_TIPO_SENTENZA_II_GRADO");
	}

	public Date getDataSentenzaIiGrado() throws DAOException {
		return getDate("DATA_SENTENZA_II_GRADO");
	}

	public BigDecimal getAnnoSentenzaIiGrado() throws DAOException {
		return getBigDecimal("ANNO_SENTENZA_II_GRADO");
	}

	public String getNumeroSentenzaIiGrado() throws DAOException {
		return getString("NUMERO_SENTENZA_II_GRADO");
	}

	public String getCodAutEmittSentIiGrado() throws DAOException {
		return getString("COD_AUT_EMITT_SENT_II_GRADO");
	}

	public String getCodLuoEmittSentIiGrado() throws DAOException {
		return getString("COD_LUO_EMITT_SENT_II_GRADO");
	}

	public String getNumSezEmittSentIiGrado() throws DAOException {
		return getString("NUM_SEZ_EMITT_SENT_II_GRADO");
	}

	public BigDecimal getAnnoRegGenCassaz() throws DAOException {
		return getBigDecimal("ANNO_REG_GEN_CASSAZ");
	}

	public String getNumeroRegGenCassaz() throws DAOException {
		return getString("NUMERO_REG_GEN_CASSAZ");
	}

	public BigDecimal getAnnoSentenzaCassaz() throws DAOException {
		return getBigDecimal("ANNO_SENTENZA_CASSAZ");
	}

	public String getNumeroSentenzaCassaz() throws DAOException {
		return getString("NUMERO_SENTENZA_CASSAZ");
	}

	public BigDecimal getAnnoRaccGenealeIiGrado() throws DAOException {
		return getBigDecimal("ANNO_RACC_GENEALE_II_GRADO");
	}

	public String getNumeroRaccGenealeIiGrado() throws DAOException {
		return getString("NUMERO_RACC_GENEALE_II_GRADO");
	}
	...
	public String getCodTipoRito() throws DAOException {
		return getString("COD_TIPO_RITO");
	}
	...
	public GenericModel getModel() throws DAOException {
		...
		return new AltriGradiGiudizioModel(getIdAltrigradigiudizio(), getDataSentenzaIGrado(),
				getAnnoSentenzaIGrado(), getNumeroSentenzaIGrado(), getCodAutEmittSentIGrado(), "",
				getCodLuoEmittSentIGrado(), "", getNumSezEmittSentIGrado(), getCodTipoSentenzaIiGrado(), "",
				getDataSentenzaIiGrado(), getAnnoSentenzaIiGrado(), getNumeroSentenzaIiGrado(),
				getCodAutEmittSentIiGrado(), "", getCodLuoEmittSentIiGrado(), "", getNumSezEmittSentIiGrado(),
				getAnnoRegGenCassaz(), getNumeroRegGenCassaz(), getAnnoSentenzaCassaz(),
				getNumeroSentenzaCassaz(), getAnnoRaccGenealeIiGrado(), getNumeroRaccGenealeIiGrado(),
				getCodTipoDecisioneCassazione(), "", getSenIdSentenza(), getCodOperatoreInserimento(),
				getDataInserimento(), getCodUfficioInserimento(), "", getCodOperatoreAggiornamento(),
				getDataAggiornamento(), getCodUfficioAggiornamento(), "", getCodTipoRito(), "");
	}
