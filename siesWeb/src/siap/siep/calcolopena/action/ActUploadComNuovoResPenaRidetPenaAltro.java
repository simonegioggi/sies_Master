...
/**
 * <p>Title: ActUploadComNuovoResPenaRidetPenaAltro</p>
 * <p>Description: Action per l'Upload e Validazione della Comunicazione Nuovo
 ...
 * @since 4.0
 */
public class ActUploadComNuovoResPenaRidetPenaAltro extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaComNuovoResPenaRidetPenaAltro(lModel, lFascMod);
    }
    else
