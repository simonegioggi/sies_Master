...
/**
 * <p>
 * Title: ActLoadInserisciOSRidetPenaRidimLA copiata da ActLoadInserisciOSRidetPenaAltro
 * </p>
 * <p>
 * Description: Classe Action per la Load Inserimento Odine di Scarcerazione per Nuovo residuo pena nel caso
 * di Rideterminazione Pena per Ridimensionamento LA Questa Action viene invocata dalla form della griglia dei
...
public class ActLoadInserisciOSRidetPenaRidimLA extends ActionSiap implements ICostantiCalcoloPena {
	...
	public String processRequest() throws F3BException {
		...
		// In Misura Alternativa (11,12,13,14,15,25,29,41,42,43,44) isMisuraAlternativa
		...
		return PG_LOAD_INS_OS_NUOVO_RES_PENA_RIDET_PENA_RIDIM_LA;
	}
}