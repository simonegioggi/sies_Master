...
/**
 * <p>Title: ActUploadEmissioneProvvedimento</p>
 * <p>Description: </p>
 ...
 * @version 1.0
 */
public class ActUploadEmissioneProvvedimento extends ActionSiap
  implements ICostantiEvento
{
  ...
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrl.ExUpdateValidaOrdineEsecuzioneRidetPena(lModel, lFascMod);
    }
    else
    {
    ...
    if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
		{
    		setRequestAttribute("flagPage",getRequestStringParameter("flagPage"));
    		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    		siesLogger.debug("flagPage"+getRequestStringParameter("flagPage"));
    		
			RedirectTo lRedirigi = new RedirectTo();
			lRedirigi.setPage(IWebConstants.PG_MAIN);
			lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" + CAMPO_ID_EVENTO + "=" + getRequestStringParameter(ICostantiEvento.CAMPO_ID_EVENTO)+"&flagPage="+getRequestStringParameter("flagPage"));
