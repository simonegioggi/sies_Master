...
/**
 * <p>Title: ActUploadOSRidetPenaAltro</p>
 * <p>Description: Action per l'Upload e Validazione della Rideterminazione Nuovo
 * residuo pena per rideterminazione pena Altro.
 * </p>
 * Attenzione questa action valida anche 
 * - Ridimensionamento LA  (01-09-0998)
 * - Revoca LA (01-09-1009)
 * - Scomputo permesso  (0994, 0996)
 * - Reclamo su Scomputo Permesso (0997)
 * 
 * 
 ...
 * @since 4.0
 */
public class ActUploadOSRidetPenaAltro extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      ICalcoloPena lCtrl = SIEPLookupRemote.getCalcoloPenaRemote();
      lCtrl.ExUpdateValidaOSNuovoResPenaRidetPenaAltro(lModel, lFascMod);
    }
    else
