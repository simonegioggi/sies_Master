...
public class ActUploadOrdineScarcerazionePerNuovaScadenzaPena
    extends ActionSiap
    implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    IOrdineScarcerazione lCtrlOrdine = SIEPLookupRemote.getOrdineScarcerazione();

    if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA))
    {
      lModel.setFlagDocumentoRegistrato("S");

      lCtrlOrdine.ExUpdateValidaOrdineScarcerazione(lModel, lFascMod);
    }
    else
    {
