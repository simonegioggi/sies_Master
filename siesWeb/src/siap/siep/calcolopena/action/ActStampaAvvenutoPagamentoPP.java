...
public class ActStampaAvvenutoPagamentoPP extends ActionSiap
                                              implements ICostantiEvento,ICostantiAnnotazioneManuale
{
  public String processRequest() throws F3BException
  {
    ...
    String lTipoEve = lEveModel.getEvento().getCodTipoEvento();
    String lTipoProv = lEveModel.getEvento().getCodTipoProvvedimento();
    ...
    lTemMod = lCtrlTem.ExRicercaTemplateByTipEveTipoProvCodMotivoFlagTemplate(lTipoEve, lTipoProv, lMotivo, flagTemplate);
