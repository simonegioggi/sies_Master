...
/**
 * AgdgFascicoloSiepDAO - Classe DAO che rappresenta la tabella AgdgFascicoloSiep
 *
 * @version 1.0
 */
public class AgdgFascicoloSiepDAO extends TableDAO {
	...
	public BigDecimal getIdAgdgFascicoloSiep() throws DAOException {
		return getBigDecimal("ID_AGDG_FASCICOLO_SIEP");
	}

	public BigDecimal getAgdgIdAltrigradigiudizio() throws DAOException {
		return getBigDecimal("AGDG_ID_ALTRIGRADIGIUDIZIO");
	}
	...
	public AltriGradiGiudizioModel getAltriGradiGiudizioModel() throws DAOException {
		return getAltriGradiGiudizioModel();
	}
	...
	public void setIdAgdgFascicoloSiep(BigDecimal aValore) {
		setBigDecimal("ID_AGDG_FASCICOLO_SIEP", aValore);
	}

	public void setAgdgIdAltrigradigiudizio(BigDecimal aValore) {
		setBigDecimal("AGDG_ID_ALTRIGRADIGIUDIZIO", aValore);
	}
	...
	public void setAltriGradiGiudizioModel(AltriGradiGiudizioModel aValore) {
		setAltriGradiGiudizioModel(aValore);
	}

	public GenericModel getModel() throws DAOException {

		return new AgdgFascicoloSiepModel(getIdAgdgFascicoloSiep(), getAgdgIdAltrigradigiudizio(),
				getFasSieIdFascicoloSiep(), getAltriGradiGiudizioModel());
	}
