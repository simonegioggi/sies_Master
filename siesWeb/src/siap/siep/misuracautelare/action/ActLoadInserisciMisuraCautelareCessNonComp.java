 ...
 * @version 1.0
 */
public class ActLoadInserisciMisuraCautelareCessNonComp extends ActionSiap implements
	...
	public String processRequest() throws F3BException {
		...
		// Option lOptionComp = new Option(
		// DecodificheManager.getInstance().getMotivoNonComputabileDescCompleta());
...
//		UfficioModel lUfficioModel = null;
		...
		// lOptionAutoritaEmittenteUff.setSelected("-");
		...
		setRequestAttribute("flagComputabile", "N");
