...
public class StatoEsecuzioneProvv extends StatoEsecuzioneElement {
	...
	public void elabora(siap.sico.evento.model.EventoModel aEvento) {
		...
		try {
			...
			// && !aEvento.getCodTipoProvvedimento().equals("12") Paolo Cherubini 13 Luglio 2011 segnalazione
			// di Pina Marchese
			) {
			...
			if (lSorveglianza && lEvento.getCodMotivo().equals("0000"))
				lEvento.setDescrTipoProvvedimento(
						lEvento.getDescrTipoProvvedimento() + " Provvedimento Indeterminato");
