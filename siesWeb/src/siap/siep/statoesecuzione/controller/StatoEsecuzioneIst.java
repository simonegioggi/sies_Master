...
/**
 * Stato Esecuzione Istruttoria
 * Estende l'elemento Stato Esecuzione Element in generale
...
public class StatoEsecuzioneIst extends StatoEsecuzioneElement 
{
	 ...
	 * 
	 * Regola: Istanza pervenuta il 22-10-2006 (oggetto) trasmessa in data (data).    
	 *			trasmissione) a ufficio (Tds/Uds/GE) di (luogo) 
	 *
	 *  Esempio:
	 *		
	 *		Istanza pervenuta il 22-10-2006 (oggetto)
	 *		
	 *		Istanza pervenuta il 22-10-2006 (oggetto) trasmessa in data 12/12/2006 
	 *		a ufficio Tribunale di Sorveglianza di Napoli
	 *
	 */
