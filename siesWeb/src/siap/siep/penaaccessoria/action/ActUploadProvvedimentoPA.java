...
/**
 * <p>
 * Title: ActUploadProvvedimentoPA
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * @version 1.0
 */
public class ActUploadProvvedimentoPA extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			// lCtrl.ExUpdateValidaEsecPA(lModel, lFascMod);
		} else {
