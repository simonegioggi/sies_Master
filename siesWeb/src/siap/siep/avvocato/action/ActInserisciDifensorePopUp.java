...
public class ActInserisciDifensorePopUp extends ActionSiap implements ICostantiAvvocato
{
  ...
  */
  public String processRequest() throws F3BException
  {
    ...
    {
      ComuneModel lComMod = new ComuneModel(getCodComuneByDescr(getRequestStringParameter(ICostantiAvvocato.CAMPO_COD_LUOGO_NASCITA )) );
      lAvvMod.setCodLuogoNascita(lComMod.getCodComune());
      ComuneModel lComModRes = new ComuneModel(this.getCodComuneByDescr(getRequestStringParameter(ICostantiAvvocato.CAMPO_COD_COMUNE_RESIDENZA )) );
    ...
    }else
    {
      ...
      lAvvMod.setCodComuneResidenza(getRequestStringParameter(ICostantiAvvocato.CAMPO_COD_COMUNE_RESIDENZA ));
    }

    lAvvMod.setDataNascita( getRequestDateParameter(ICostantiAvvocato.CAMPO_ANNO_DATA_NASCITA,ICostantiAvvocato.CAMPO_MESE_DATA_NASCITA,ICostantiAvvocato.CAMPO_GIORNO_DATA_NASCITA) );
    ...
    lAvvMod = lCtrl.ExInserisciAvvocato(lAvvMod); // setta la risposta nella request		 setRequestAttribute("avvocato",lVect);
    setRequestAttribute("formname",  getRequestStringParameter("formname"));
    return IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.avvocato.action.ActDettaglioAvvocatoPopUp&" + CAMPO_ID_AVVOCATO + "=" +
