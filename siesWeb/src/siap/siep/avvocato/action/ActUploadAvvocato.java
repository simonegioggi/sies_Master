...
/**
 * <p>Title: ActUploadAvvocato</p>
 * <p>Description: Validazione</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadAvvocato extends ActionSiap
  implements ICostantiEvento
{
  ...
  //  FascicoloSiepModel lFascMod = (FascicoloSiepModel) getSessionAttribute("fascicolo");
   ...
   // lRedirigi.setParameter( lAvvId, lModel.getIdEvento().toString() );
