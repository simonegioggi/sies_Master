...
public class AvvocatoFascicoloSiepSqlDAO extends SIAPSqlDAO {
	...
	private String getSqlQuery() {
		...
		lStatement += "SELECT ID_AVVOCATO, COGNOME, NOME, FORO, INDIRIZZO, "
				...
				+ " COMSEDEFORO.DESCRIZIONE descComuneSedeForo, PROVINCIA, AVVOCATO.CAP, "
				+ " COD_NON_ATTIVITA, CG.RV_MEANING DESCR_NON_ATTIVITA, PEC, FLAG_REGINDE, "
				+ "DESCR_COMUNE_STUDIO, COD_STATO_NASCITA_AVV, SN.RV_MEANING DESCR_STATO_NASCITA, "
		...
		lStatement += " FROM AVVOCATO, AVVOCATO_FASCICOLO_SIEP, CG_REF_CODES AVVTIPODESC, "
				+ "CG_REF_CODES AVVTIPODESCMOTIVO, CG_REF_CODES AVVTIPODESCAUTORITA, "
				+ "CG_REF_CODES AVVTIPODESCAUTORITADIF, COMUNE COMNA, COMUNE COMRES, "
				+ "COMUNE COMSEDE, COMUNE COMSEDEDIF ";
	...
	private String getSqlQueryDettaglio() {
		...
		lStatement += " FROM AVVOCATO, AVVOCATO_FASCICOLO_SIEP, CG_REF_CODES AVVTIPODESC, "
				+ "CG_REF_CODES AVVTIPODESCMOTIVO, CG_REF_CODES AVVTIPODESCAUTORITA, "
				+ "CG_REF_CODES AVVTIPODESCAUTORITADIF, COMUNE COMNA, COMUNE COMRES, COMUNE COMSEDE, "
				+ "COMUNE COMSEDEDIF ";
		// INIZIO: MEV_21 (avvocati)
		lStatement += " , CG_REF_CODES AVVFORO, COMUNE COMSEDEFORO ";
		lStatement += " , CG_REF_CODES CG ";
	...
	// + "AVVOCATO_FASCICOLO_SIEP.SEDE_TIPO_AUTORITA_DIF ";
	//
	// lStatement += "FROM AVVOCATO,AVVOCATO_FASCICOLO_SIEP,CG_REF_CODES AVVTIPODESC,CG_REF_CODES
	// AVVTIPODESCMOTIVO, CG_REF_CODES AVVTIPODESCAUTORITA, CG_REF_CODES AVVTIPODESCAUTORITADIF,COMUNE
	// COMNA,COMUNE COMRES, COMUNE COMSEDE, COMUNE COMSEDEDIF ";
	// lStatement += "WHERE ";
	// lStatement += "DATA_FINE_VALIDITA IS NULL AND ";
	// lStatement += "AVVOCATO.ID_AVVOCATO=AVVOCATO_FASCICOLO_SIEP.AVV_ID_AVVOCATO AND ";
	// lStatement += "AVVTIPODESC.RV_LOW_VALUE=AVVOCATO_FASCICOLO_SIEP.COD_TIPO_AVVOCATO AND ";
	...
	public GenericModel getModel() throws DAOException {
		...
		aModel.getAvvocatoFascicoloSiepModel()
				.setCodOperatoreAggiornamento(getString("AVV_FASC_SIEP_COD_OP_AGG"));
		aModel.getAvvocatoFascicoloSiepModel()
				.setCodOperatoreInserimento(getString("AVV_FASC_SIEP_COD_OP_INS"));
		aModel.getAvvocatoFascicoloSiepModel().setCodTipoAvvocato(getString("AVV_FASC_SIEP_COD_TIPO_AVV"));
		aModel.getAvvocatoFascicoloSiepModel()
				.setCodUfficioAggiornamento(getString("AVV_FASC_SIEP_COD_UFF_AGG"));
		aModel.getAvvocatoFascicoloSiepModel()
				.setCodUfficioInserimento(getString("AVV_FASC_SIEP_COD_UFF_INS"));
		...
		aModel.getAvvocatoFascicoloSiepModel()
				.setAvvIdAvvocatoFascicoloSost(getBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SOST"));
