...
/**
 * <p>
 * Title: ActRicercaScadenzarioRinnovoVerbaleVaneRicerche
 * </p>
 * <p>
 * Description: Classe Action per la ricerca di Scadenzario
 * </p>
 * <p>
 * di tipo 03 (Vane Ricerche) - con VVR pervenuto
 * <p>
...
public class ActRicercaScadenzarioRinnovoVerbaleVaneRicerche extends ActionSiap implements
	...
	public String processRequest() throws Exception {
		...
		// AMBROSINO
		lScaMod.setCodStatoNotifica("PP");
		...
		if (isRequestParameterNullObj("CountRisultati")) {
			...
			CountRisultati = lCtrl.ExGetCountScadenzarioVVRPaged(lScaMod, 0);
		} else {
			CountRisultati = getRequestBigDecimalParameter("CountRisultati");
		}

		// AMBROSINO 04-02-2011 Vers 5.1 - Su segnalazione di Marchese Aggiungo Data VVR alla ricerca
		// Scadenzario

		// lVect = lCtrl.ExRicercaScadenzarioPaged(lScaMod,Integer.parseInt(lPagina));

		lVect = lCtrl.ExRicercaScadenzarioVVRPaged(lScaMod, Integer.parseInt(lPagina));
		...
		return PG_RICERCASCADENZARIO_RINNOVO_VANERICERCHE;
	}
