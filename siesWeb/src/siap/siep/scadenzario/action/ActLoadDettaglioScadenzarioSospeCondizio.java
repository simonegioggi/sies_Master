...
/**
 * <p>Title: ActLoadDettaglioScadenzarioSospeCondizio</p>
 * <p>Description: Classe Action per la load dettaglio di Scadenzario </p>
 * <p>Pene Sospese con i Termini di Sospensione Condizionale in scadenza  </p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: Bull</p>
 * @version 1.0
 */

public class ActLoadDettaglioScadenzarioSospeCondizio extends ActionSiap implements ICostantiScadenzario
{
  public String processRequest() throws Exception 
  {
    ...
    if( lIdScadenzario == null )
    {
     ...
     llScaMod = lCtrlScad.ExScadenzarioCorrenteByIdFascicoloTipoScadenzario(lIdFascicoloSiep, "17");
    }
    else
    {
    ...
    return PG_LOAD_DETTAGLIOSCADENZARIO_SOSPECONDIZIO;
  }
}