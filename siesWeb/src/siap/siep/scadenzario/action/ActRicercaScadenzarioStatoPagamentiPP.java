...
public class ActRicercaScadenzarioStatoPagamentiPP extends ActionSiap implements ICostantiScadenzario {
	...
	public String processRequest() throws Exception {
		...
		if (!isRequestParameterNullObj("tipoRicerca")
			...
			Vector<ScadenzarioModel> lVect = lCtrl.ExRicercaScadenzarioPagedPP(lScaMod,
					Integer.parseInt("0"));
	...
	private String stampaExcel(Vector<ScadenzarioModel> listaScadenzari, ScadenzarioModel lScaMod)
			throws Exception {
		...
		lCtrlSanzSost.ExCreateExcelScadenzariPP(listaScadenzari, wb, this.getUfficioUtenteConnesso(),
				lScaMod);
