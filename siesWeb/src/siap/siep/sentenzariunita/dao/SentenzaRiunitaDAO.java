...
/**
* <p>Title: SentenzaRiunitaDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella SentenzaRiunita</p>
...
public class SentenzaRiunitaDAO extends SIAPTableDAO
{
  ...
  //
			...
			public BigDecimal 		 getIdSentenzaRiunita() 		throws DAOException	 { return getBigDecimal("ID_SENTENZA_RIUNITA"); }
			...
			public String 				 getSezioneAutoritaEmittente() 		throws DAOException	 { return getString("SEZIONE_AUTORITA_EMITTENTE"); }
  ...
  //
			...
			public void  	 setIdSentenzaRiunita(BigDecimal aValore ) 			 { setBigDecimal("ID_SENTENZA_RIUNITA", aValore); }
			...
			public void  	 setSezioneAutoritaEmittente(String aValore ) 			 { setString("SEZIONE_AUTORITA_EMITTENTE", aValore); }
	...
	public GenericModel getModel() throws DAOException
  			 {
 				 return new SentenzaRiunitaModel(
								 getIdSentenzaRiunita() ,
								 getDataSentenza() ,
								 getAnnoSentenza() ,
								 getNumeroSentenza() ,
