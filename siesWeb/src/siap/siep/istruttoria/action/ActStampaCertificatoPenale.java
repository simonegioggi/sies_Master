...
/**
 * <p>Title: ActStampaCertificatoPenale</p>
 * <p>Description: Stampa un Certificato da D.A.P.</p>
...
public class ActStampaCertificatoPenale extends ActionSiap
                                        implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_CERTIFICATO_PENALE);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
  ...
  //  setRequestAttribute("sedegiudiziaria", "" +this.getRequestStringParameter("sedegiu"));
