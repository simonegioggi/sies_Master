...
/**
 * ActInserisciCertificatoPenale - ActInserisciEstrattoSentenza
 *
 * @version 1.0
 */
public class ActInserisciCertificatoPenale extends ActionSiap implements ICostantiSecurity {

	public String processRequest() throws Exception {

		UtenteModel lUtenteModel = getUtenteConnesso();
		String oldPswNSC = null, oldUseIdNSC = null;
		if (!isRequestParameterNullObj("oldPswNSC") && getRequestStringParameter("oldPswNSC") != null
				&& !getRequestStringParameter("oldPswNSC").equals(""))
			oldPswNSC = getRequestStringParameter("oldPswNSC");
		if (!isRequestParameterNullObj("oldUserIdNSC") && getRequestStringParameter("oldUserIdNSC") != null
				&& !getRequestStringParameter("oldUserIdNSC").equals(""))
			oldUseIdNSC = getRequestStringParameter("oldUserIdNSC");
		...
		if (!isRequestParameterNullObj(ICostantiUtente.CAMPO_USERID_NSC)) {
			...
			if (!useridNSC.equals(oldUseIdNSC) || !pwdNSC.equals(oldPswNSC)) {
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				...
				+ "TipoFascicolo=SIEP&IdEvento=" + lRetModel.getEvento().getIdEvento();
