...
/**
 * <p>Title: ActInserisciInfoArrestoDenuncia</p>
 * <p>Description: ActInserisciInfoArrestoDenuncia</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
  * @version 1.0
 */
public class ActInserisciInfoArrestoDenuncia extends ActionSiap implements ICostantiIstruttoria
{
   public String processRequest() throws Exception
   {
          ...
          // IDecodifiche lDec = SICOLookupRemote.getDecodificheRemote();
           ...
           lEve.getEvento().setCodMotivo("0053");
       ...
       //Inserisco l'array di Notifiche nell'Evento
          ...
          // lEve.getEvento().setFlagDocumentoRegistrato("N");
           ...
           String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
               "=siap.siep.istruttoria.action.ActDettaglioInfoArrestoDenuncia&" +
