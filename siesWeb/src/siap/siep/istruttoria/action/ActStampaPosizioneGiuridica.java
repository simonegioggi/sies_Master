...
/**
 * <p>Title: ActStampaPosizioneGiuridica</p>
...
public class ActStampaPosizioneGiuridica extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_POSIZIONE_GIURIDICA);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
