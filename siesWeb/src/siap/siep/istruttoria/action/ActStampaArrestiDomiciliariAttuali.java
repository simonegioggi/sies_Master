...
/**
 * <p>Title: ActStampaArrestiDomiciliariAttuali</p>
...
public class ActStampaArrestiDomiciliariAttuali extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_ARRESTI_DOMICILIARI_ATTUALI);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
