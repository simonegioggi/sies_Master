...
/**
 * <p>Title: ActStampaAnagraficaCittadiniItaliani</p>
...
public class ActStampaAnagraficaCittadiniItaliani extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_ANAGRAFICA_CITTADINI_ITALIANI);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
