...
/**
 * <p>Title: ActStampaCertificatoEsecuzione</p>
...
public class ActStampaCertificatoEsecuzione extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_CERTIFICATO_ESECUZIONE);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
