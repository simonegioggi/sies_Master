...
/**
 * <p>Title: ActInserisciAnagraficaCittadiniItaliani</p>
 * <p>Description: ActInserisciEstrattoSentenza</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
  * @version 1.0
 */
public class ActInserisciAnagraficaCittadiniItaliani extends ActionSiap implements ICostantiIstruttoria
{
   public String processRequest() throws Exception
   {
          ...
          // IDecodifiche lDec = SICOLookupRemote.getDecodificheRemote();
           ...
           String lSede = lFascicoloModel.getSoggetto().getCodComuneNascita();
...
//***************************************************
           ...
           lAutEstMod.setCodTipoAutorita("26");
       ...
       //Inserisco l'array di Notifiche nell'Evento
          ...
          // lEve.getEvento().setFlagDocumentoRegistrato("N");
           ...
           String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
               "=siap.siep.istruttoria.action.ActDettaglioAnagraficaCittadiniItaliani&" +
