...
/**
 * <p>Title: ActStampaInfoArrestoDenuncia</p>
...
public class ActStampaInfoArrestoDenuncia extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
    ...
    // UfficioModel lUff = this.getUfficioUtenteConnesso();
     ...
     lEveMod.setNomeTemplate(TEMPLATE_INFO_ARRESTO_DENUNCIA);
