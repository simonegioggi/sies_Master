 ...
 * @version 1.0
 */
public class ActLoadInserisciArrestiDomiciliariAttuali extends ActionSiap implements ICostantiIstruttoria
{
     ...
     if( isSessionAttributeNullObj("fascicolo") )
        {
          String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
               ...
               "siap.siep.istruttoria.action.ActLoadInserisciArrestiDomiciliariAttuali";
...
*/
     ...
     return PG_LOAD_INSERISCI_ARRESTI_DOMICILIARI_ATTUALI;
   }
