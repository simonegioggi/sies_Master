...
/**
 * <p>Title: ActInserisciArrestiDomiciliariPrecedenti</p>
 * <p>Description: ActInserisciInfoArrestoDenuncia</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
  * @version 1.0
 */
public class ActInserisciArrestiDomiciliariPrecedenti extends ActionSiap implements ICostantiIstruttoria
{
   public String processRequest() throws Exception
   {
           //controllo comune e ufficio
           ComuneModel lCom =this.getCodComuneByDescrFlagVal(getRequestStringParameter(ICostantiIstruttoria.SEDE_AUTORITA_DESTINATARIO));
          ...
          // IDecodifiche lDec = SICOLookupRemote.getDecodificheRemote();
           ...
           lEve.getEvento().setCodMotivo("0045");
...
//***************************************************
           ...
           String lTestoNote ="avere tascorso un periodo di arresti domiciliari, in relazione alla citata sentenza, ";
           String LTestoNoteDateInizio=" dal "+getRequestStringParameter(ICostantiIstruttoria.DATA_INIZIO_GIORNO)+"/"+getRequestStringParameter(ICostantiIstruttoria.DATA_INIZIO_MESE)+"/"+getRequestStringParameter(ICostantiIstruttoria.DATA_INIZIO_ANNO+"");
           String LTestoNoteDateFine=" al "+getRequestStringParameter(ICostantiIstruttoria.DATA_FINE_GIORNO)+"/"+getRequestStringParameter(ICostantiIstruttoria.DATA_FINE_MESE)+"/"+getRequestStringParameter(ICostantiIstruttoria.DATA_FINE_ANNO+"");
           lNot.setNote(lTestoNote+LTestoNoteDateInizio+LTestoNoteDateFine);
       ...
       //Inserisco l'array di Notifiche nell'Evento
          ...
          // lEve.getEvento().setFlagDocumentoRegistrato("N");
           ...
           String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
               "=siap.siep.istruttoria.action.ActDettaglioArrestiDomiciliariPrecedenti&" +
