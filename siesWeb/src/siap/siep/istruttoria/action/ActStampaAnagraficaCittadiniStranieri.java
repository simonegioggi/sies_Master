...
/**
 * <p>Title: ActStampaAnagraficaCittadiniStranieri</p>
...
public class ActStampaAnagraficaCittadiniStranieri extends ActionSiap implements ICostantiIstruttoria
{
  public String processRequest() throws Exception
  {
     ...
     lEveMod.setNomeTemplate(TEMPLATE_ANAGRAFICA_CITTADINI_STRANIERI);
     lEveMod.getEvento().setDescrUfficioEmittente(lUff.getDescrTipoUfficio());
     lEveMod.getEvento().setDescrLuogoEmittente(lUff.getDescrComune());
     //-------
