...
/**
 * <p>Title: ActInserisciIstruttoriaRichiestaPagamentoPP</p>
...
public class ActInserisciIstruttoriaRichiestaPagamentoPP extends ActionSiap implements ICostantiIstruttoria
{
   ...
   public String processRequest() throws Exception
   {
       ...
       //    lEve.getEvento().setCodTipoProvvedimento("25"); //Tipo Provvedimento = Annotazione 
           lEve.getEvento().setCodMotivo("1050");			// Pagamento pena pecuniaria
       ...
       //Inserisco l'array di Notifiche nell'Evento
          ...
          // lEve.getEvento().setFlagDocumentoRegistrato("N");
           ...
           String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
               "=siap.siep.istruttoria.action.ActDettaglioIstruttoriaRichiestaPagamentoPP&" +
