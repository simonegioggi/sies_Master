...
public class ActUploadOrdineEsecuzioneRevoca extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		IDecretoOrdinanzaSiep lCtrlOrdine = SIEPLookupRemote.getDecretoOrdinanzaSiepRemote();

		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			lModel.setFlagDocumentoRegistrato("S");

			lCtrlOrdine.ExUpdateValidaOrdineEsecuzioneRevoca(lModel);
		} else {
