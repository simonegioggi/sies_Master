 ...
 * @version 1.0
 */
public class ActDettaglioAnnAdempObblighi extends ActionSiap implements ICostantiPenaSospesa
{
  ...
  public String processRequest() throws Exception
  {
	  ...
	  siesLogger.debug("ActDettaglioAnnAdempObblighi: inizio");
	   ...
	   // STUB: initile cercare anche le notifiche basta solo l'evento.
    	...
    	// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    	siesLogger.debug("lDescTipoUff="+lDescTipoUff);
        if (lDescTipoUff.equals(""))
        		lDescTipoUff = DecodificheUtils.getDescbyCode(DecodificheManager.getInstance().getTipoAutorita(), lAnnMod.getCodTipoUfficioSiep());
        setRequestAttribute("strDescrTipoUfficio", lDescTipoUff);
	...
	// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
	siesLogger.debug("ActDettaglioAnnAdempObblighi: fine");

    return IWebConstants.ROOT_DIR + "files/siap/siep/penasospesa/DettaglioAnnAdempObblighi.jsp"; 
  }
