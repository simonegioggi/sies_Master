...
/**
 * <p>Title: ActInserisciAnnotazioneRevoca</p>
...
{
  /**
   * Action non inserisce nulla ma raccoglie i dati dalla request,
   * li prepara per la pagina successiva e la richiama 
   */
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("DataArrivoAtto", getRequestDateParameter(
    		ICostantiPenaSospesa.CAMPO_ANNO_DATA_ARRIVO_ATTO,
    		ICostantiPenaSospesa.CAMPO_MESE_DATA_ARRIVO_ATTO,
    		ICostantiPenaSospesa.CAMPO_GIORNO_DATA_ARRIVO_ATTO));
    
    setRequestAttribute("DataIrrevocabilita", getRequestDateParameter("annoIrrevocabilita",	"meseIrrevocabilita","giornoIrrevocabilita"));
    
    String lPage = IWebConstants.ROOT_DIR+"/files/siap/siep/penasospesa/LoadInserisciNuovoFascicoloSiep.jsp";
    return lPage;
  }
  ...
  {	  
    ...
    lAnnMod.setAnnoSentenzaSiap(getRequestBigDecimalParameter(ICostantiPenaSospesa.CAMPO_ANNO_SENTENZA_REVOCA));
    lAnnMod.setNumeroSentenzaSiap(getRequestStringParameter(ICostantiPenaSospesa.CAMPO_NUMERO_SENTENZA_REVOCA));
    
    lAnnMod.setDataSentenzaSiap(getRequestDateParameter(
    		ICostantiPenaSospesa.CAMPO_ANNO_DATA_SENTENZA_REVOCA,
    		ICostantiPenaSospesa.CAMPO_MESE_DATA_SENTENZA_REVOCA,
    		ICostantiPenaSospesa.CAMPO_GIORNO_DATA_SENTENZA_REVOCA));    
    
    lAnnMod.setCodTipoUfficioSiep(getRequestStringParameter(ICostantiPenaSospesa.CAMPO_COD_TIPO_UFFICIO_SENTENZA_REVO));
    lAnnMod.setCodLuogoUfficioSiep(((ComuneModel )getCodComuneByDescr(getRequestStringParameter(ICostantiPenaSospesa.CAMPO_COD_LUOGO_SENTENZA_REVOCA))).getCodComune());
  ...
  {	  
    ...
    lAnnMod.setDataGE(getRequestDateParameter(
    		ICostantiPenaSospesa.CAMPO_ANNO_DATA_ORDINANZA_REVOCA,
	...
	String lDescrComune        = getRequestStringParameter(ICostantiPenaSospesa.CAMPO_COD_LUOGO_ORDINANZA_REVOCA);
	String lCodTipoUfficioEmi = getRequestStringParameter( ICostantiPenaSospesa.CAMPO_COD_TIPO_UFFICIO_ORDINANZA_REVO );
