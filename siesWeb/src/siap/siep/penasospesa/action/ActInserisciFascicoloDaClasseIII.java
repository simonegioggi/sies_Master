                                              ...
                                              implements ICostantiPenaSospesa,ICostantiFascicoloSiep
{
  ...
  ****************************************************************************/
  ...
  lEveMod.setCodLuogoEmittente(getUfficioUtenteConnesso().getCodComune());
	...
	lFasMod.setFlagValidato(lFasClasseIIIMod.getFlagValidato()); 
	...
	lFasMod.setDataArrivoAtto(getRequestDateParameter(
			ICostantiFascicoloSiep.CAMPO_ANNO_ARRIVO_ATTO,
    ...
    lFasMod=lCtrlPSosp.ExInserisciFascicolodaClasseIII(lSogMod,lEveMod,lFasMod, 
    		lDettaglioFascicolo, lFasClasseIIIMod, lAnnMod);
