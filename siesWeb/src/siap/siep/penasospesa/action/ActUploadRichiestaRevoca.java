 ...
 * @version 1.0
 */
public class ActUploadRichiestaRevoca extends ActionSiap implements ICostantiEvento
{
  ...
  public String processRequest() throws Exception
  {
    ...
    if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
    {
	  ...
	  String actchiamante="&AzioneChiamante=siap.siep.penasospesa.action.ActUploadRichiestaRevoca";
