...
/**
 * <p>
 * Title: ActUploadArchiviazione
 * </p>
 * <p>
 * Description: Validazione dell'Archiviazione
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActUploadArchiviazione extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		aDocAllegato.setEveIdEvento(lModel.getEveIdEvento());
		...
		setRequestAttribute("mIdDocumentoAllegato", aDocAllegato.getIdDocumentoAllegato());
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			lCtrl.ExUpdateValidaArchiviazione(lModel, lFascMod);
		} else {
