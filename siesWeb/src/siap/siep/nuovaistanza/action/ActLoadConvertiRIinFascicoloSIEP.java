 ...
 *
 */
public class ActLoadConvertiRIinFascicoloSIEP extends ActionSiap implements ICostantiNuovaIstanza {
	...
	public String processRequest() throws F3BException {
		if (isSessionAttributeNullObj("fascicolo")) {
			String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					...
					+ "siap.siep.nuovaistanza.action.ActLoadConvertiRIinFascicoloSIEP&"
		...
		// Restituisce SUCCESS
		return PG_LOAD_CONVERTI_ISTANZA;
