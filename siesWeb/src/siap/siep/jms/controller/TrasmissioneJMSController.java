	...
	private TreeModel ricercaFascicoloSiepCompleto(BigDecimal aKeyFascicolo) throws F3BException {
		...
		try {
			if (aKeyFascicolo != null) {
				...
				// Si aggiungono tutti i dati, anche le pene residue altrimenti va in errore la presa in carico 
				// in caso di eventi di pena iniziale. Il sistema non riesce a ricostruire la pena.
