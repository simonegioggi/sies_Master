...
public class ActListaProvvedimentiTrasmessi extends ActionSiap implements ICostantiMessaggio,
		ICostantiSiepJMS, ICostantiSicoJMS {
...
//		JmsCodeController lCrtl = new JmsCodeController();
		...
		try {
			...
			lVect = lCrtlMessaggio.ExRicercaMessaggioEsitoConFiltri(ICostantiJMS.TRASFERIMENTO_PROVVEDIMENTO,
		...
		return PG_LISTAPROVVEDIMENTITRASMESSI;
	}
