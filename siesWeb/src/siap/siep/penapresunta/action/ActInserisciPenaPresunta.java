...
/**
* <p>Title: ActInserisciPenaPresunta</p>
* <p>Description: Classe Action per l'inserimento di PenaPresunta</p>
...
public class ActInserisciPenaPresunta extends ActionSiap implements ICostantiPenaPresunta
{
/**
* Azione di Inserimento del PenaPresunta
...
public String processRequest() throws F3BException
		 ...
		 //---Aggiungere in SIEPLookupRemote il metodo getPenaPresuntaRemote()

		 IPenaPresunta lCtrl = SIEPLookupRemote.getPenaPresuntaRemote();
		 PenaPresuntaModel llPenModRet = lCtrl.ExInserisciPenaPresunta(lPenMod);		 // setta la risposta nella request
