...
/**
 * Title: AnnotazioneEsitoTrasmissioneSqlDAO Description: Classe SqlDAO che rappresenta la tabella
 * AnnotazioneEsitoTrasmissione
 *
 * @version 1.0
 */
public class AnnotazioneEsitoTrasmissioneSqlDAO extends SqlDAO {
	 ...
	 * @throws DAOException
	 ****************************************************************************/
	public void getCountAnnotazioneEsitoTrasmissione(AnnotazioneEsitoTrasmissioneModel aModel)
			throws DAOException {
	 ...
	 * @throws DAOException
	 ****************************************************************************/
	public void ricercaAnnotazioneEsitoTrasmissionePaged(AnnotazioneEsitoTrasmissioneModel aModel, int aPage)
			throws DAOException {
	 ...
	 * @throws DAOException
	 ****************************************************************************/
	public void ricercaAnnotazioneEsitoTrasmissione(AnnotazioneEsitoTrasmissioneModel aModel)
			throws DAOException {
	 ...
	 * @throws DAOException
	 ****************************************************************************/
	public void ricercaAnnotazioneEsitoTrasmissioneByKey(BigDecimal aIdEsitoTrasmissione)
			throws DAOException {
		// Recupera la select...from
		String lSql = getSqlQuery();
	...
	protected String getSqlQuery() {
		...
		lStatement += " SELECT " + "ID_ESITO_TRASMISSIONE, " + "DATA_TRASMISSIONE, "
				+ "OGGETTO_TRASMISSIONE, " + "COD_UFFICIO_DESTINATARIO, " + "COD_UFFICIO_INOLTRANTE, "
				+ "COD_UFFICIO_INOLTRO, " + "COD_UFFICIO_ESITO, " + "DATA_ESITO, " + "COD_ESITO, "
				+ "NOTE_ESITO, " + "CHIAVE_ANNO, " + "CHIAVE_PROGR, " + "CHIAVE_UFFICIO, " + "EVE_ID_EVENTO, "
				+ "FAS_SIE_ID_FASCICOLO_SIEP, " + "MES_ID_MESSAGGIO_RICHIESTA, " + "MES_ID_MESSAGGIO_ESITO, "
		...
		lStatement += "      , JMS_CODE oggettoTrasm "; // Oggetto Trasmissine JMS_CODE.DOMINIO =
														// 'TIPO_OPERAZIONE'
	...
	public String setCondizioni(AnnotazioneEsitoTrasmissioneModel aModel) {
		...
		if (aModel.getDataEsito() != null) {
			lCondizioni += " and to_char(DATA_ESITO,'dd/MM/yyyy') = '"
					+ DateUtils.getDateToString(aModel.getDataEsito(), "dd/MM/yyyy") + "' ";
		}
