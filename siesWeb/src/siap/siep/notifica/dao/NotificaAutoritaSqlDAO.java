...
/**
 * <p>Title: NotificaAutoritaSqlDAO</p>
 * <p>Description: Sql di Dao di Notifica in Join con Autorita</p>
     ...
     protected String getSqlQueryFascicolo(BigDecimal aFascicolo)
         {
           String lStatement = new String("");
            ...
            lStatement +=
               " SELECT	 N.ID_NOTIFICA ID_NOTIFICA, "+
               ...
               " AND N.EVE_ID_EVENTO =    E.ID_EVENTO  "+
               " AND E.COD_TIPO_PROVVEDIMENTO = '03' "+
               " AND E.FAS_SIE_ID_FASCICOLO_SIEP="+ aFascicolo;
