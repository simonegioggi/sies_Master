...
/**
 * NotificaDAO - Classe DAO che rappresenta la tabella Notifica
 *
 * @version 1.0
 */
...
public class NotificaDAO extends SIAPTableDAO {
	...
	// METODI GET()
	//
	public BigDecimal getIdNotifica() throws DAOException {
		return getBigDecimal("ID_NOTIFICA");
	}

	public String getCodTipoNotifica() throws DAOException {
		return getString("COD_TIPO_NOTIFICA");
	}

	public String getCodUffUepeUssmSS() throws DAOException {
		return getString("COD_UFF_UEPE_USSM_SS");
	}

	public String getCodUffUdsUdsm() throws DAOException {
		return getString("COD_UFF_UDS_UDSM");
	}

	public String getCodUffTdsTdsm() throws DAOException {
		return getString("COD_UFF_TDS_TDSM");
	}

	public Date getDataAvvenutaNotifica() throws DAOException {
		return getDate("DATA_AVVENUTA_NOTIFICA");
	}

	public Date getDataInvio() throws DAOException {
		return getDate("DATA_INVIO");
	}
	...
	public String getCodiceOperatoreAggiornamento() throws DAOException {
		return getString("CODICE_OPERATORE_AGGIORNAMENTO");
	}
	...
	public BigDecimal getAutEstIdAutoritaEsterna() throws DAOException {
		return getBigDecimal("AUT_EST_ID_AUTORITA_ESTERNA");
	}

	public BigDecimal getAvvIdAvvocatoFascicoloSiep() throws DAOException {
		return getBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIEP");
	}

	public BigDecimal getAvvIdAvvocatoFascicoloSius() throws DAOException {
		return getBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIUS");
	}
	...
	public String getUffCodUfficio() throws DAOException {
		return getString("UFF_COD_UFFICIO");
	}

	public BigDecimal getSollecito() throws DAOException {
		return getBigDecimal("SOLLECITO");
	}
	...
	public BigDecimal getAutEstIdAutoritaEstDeleg() throws DAOException {
		return getBigDecimal("AUT_EST_ID_AUTORITA_EST_DELEG");
	}

	public BigDecimal getAvvIdAvvocatoFascicoloSige() throws DAOException {
		return getBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIGE");
	}

	public BigDecimal getCurIdCuratore() throws DAOException {
		return getBigDecimal("CUR_ID_CURATORE");
	}

	public BigDecimal getFlagNotificaViaFax() throws DAOException {
		return getBigDecimal("FLAG_NOTIFICA_VIA_FAX");
	}
	...
	public void setCodiceOperatoreAggiornamento(String aValore) {
		setString("CODICE_OPERATORE_AGGIORNAMENTO", aValore);
	}
	...
	public void setAutEstIdAutoritaEsterna(BigDecimal aValore) {
		setBigDecimal("AUT_EST_ID_AUTORITA_ESTERNA", aValore);
	}
	...
	public void setAvvIdAvvocatoFascicoloSiep(BigDecimal aValore) {
		setBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIEP", aValore);
	}

	public void setAvvIdAvvocatoFascicoloSius(BigDecimal aValore) {
		setBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIUS", aValore);
	}

	public void setUffCodUfficio(String aValore) {
		setString("UFF_COD_UFFICIO", aValore);
	}

	public void setSollecito(BigDecimal aValore) {
		setBigDecimal("SOLLECITO", aValore);
	}
	...
	public void setAutEstIdAutoritaEstDeleg(BigDecimal aValore) {
		setBigDecimal("AUT_EST_ID_AUTORITA_EST_DELEG", aValore);
	}

	public void setAvvIdAvvocatoFascicoloSige(BigDecimal aValore) {
		setBigDecimal("AVV_ID_AVVOCATO_FASCICOLO_SIGE", aValore);
	}

	public void setCurIdCuratore(BigDecimal aValore) {
		setBigDecimal("CUR_ID_CURATORE", aValore);
	}

	public void setFlagNotificaViaFax(BigDecimal aValore) {
		setBigDecimal("FLAG_NOTIFICA_VIA_FAX", aValore);
	}
	...
	public GenericModel getModel() throws DAOException {
		return new NotificaModel(getIdNotifica(), getCodTipoNotifica(), getCodUffUepeUssmSS(),
				getCodUffUdsUdsm(), getCodUffTdsTdsm(), "", getDataAvvenutaNotifica(), getDataInvio(),
				getCodEsito(), "", getNote(), getCodOperatoreInserimento(), getDataInserimento(),
				getCodUfficioInserimento(), "", getCodiceOperatoreAggiornamento(), getDataAggiornamento(),
				getCodUfficioAggiornamento(), "", getEveIdEvento(), getAutEstIdAutoritaEsterna(),
				getSogIdSoggetto(), getAvvIdAvvocatoFascicoloSiep(), getAvvIdAvvocatoFascicoloSius(),
				getAvvIdAvvocatoFascicoloSige(), getUffCodUfficio(), getSollecito(), getCssIdCssa(), null,
				// modifica relativa al tipo istituto
				getIstDetIdIstitutoDetenzione(), null, getCurIdCuratore(), getFlagNotificaViaFax(),
				getIdParteUdienza(), null // MEV_2023-13
		);
	}
	...
	public void setDAOFromModelForUpdateIdSoggetto(EventoModel aModel, BigDecimal aIdSoggetto)
			throws DAOException {
	...
	public void setDAOFromModelForUpdateIdSoggetto(FascicoloSiusModel aFascicoloUnificante,
			FascicoloSiusModel aFascicoloUnificato) throws DAOException {
		...
		selCondizioneUpdateXIdFascicoloSiusIdSoggetto(aFascicoloUnificato.getIdFascicoloSius(),
				aFascicoloUnificato.getSogIdSoggetto());
	}
	...
	public void selCondizioneUpdateXIdFascicoloSius(BigDecimal key) {
		setCondition(
				" EVE_ID_EVENTO in (select id_evento from evento, fascicolo_sius where fascicolo_sius.id_fascicolo_sius = "
						+ key + " and evento.fas_siu_id_fascicolo_sius = fascicolo_sius.id_fascicolo_sius)");
	}

	public void selCondizioneUpdateXIdFascicoloSiusIdSoggetto(BigDecimal aIdFascicoloSius,
			BigDecimal aIdSoggetto) {

		setCondition(
				" EVE_ID_EVENTO in (select id_evento from evento, fascicolo_sius where fascicolo_sius.id_fascicolo_sius = "
						+ aIdFascicoloSius + " and notifica.sog_id_soggetto = " + aIdSoggetto
						+ " and evento.fas_siu_id_fascicolo_sius = fascicolo_sius.id_fascicolo_sius)");
	}

	/**
	 * Setta le condizioni di update per i record di Notifiche legati ad un Soggetto e ad un Provvedimento
	 * SIGE legato ad un Fascicolo SIGE.
	 *
	 * @param aIdFascicoloSige
	 * @param aIdSoggetto
	 */
	public void selCondizioneUpdateXIdFascicoliSigeIdSoggetto(BigDecimal aIdFascicoloSige,
			BigDecimal aIdSoggetto) {

		String lCondizione = " SOG_ID_SOGGETTO = " + aIdSoggetto;
		lCondizione += " and EVE_ID_EVENTO in ( select ID_EVENTO_GENERATO from PROVVEDIMENTO_SIGE WHERE FAS_ID_FASCICOLO_SIGE = "
				+ aIdFascicoloSige + ") ";
