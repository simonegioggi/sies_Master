...
/**
* <p>Title: EveNotificaSqlDAO</p>
* <p>Description: Classe SqlDAO che rappresenta la tabella Notifica join Evento</p>
* per ricavare il motivo Evento nella lista degli atti richiesti.
...
public class EveNotificaSqlDAO extends NotificaSqlDAO
{
  ...
  public void ricercaEveNotificaByFascicoloSius( BigDecimal  aKey, String aTipoEvento  )
    throws DAOException
  {
  ...
  protected String getSqlQuery()
  {
    String lStatement = new String("");
      ...
      lStatement += " SELECT " +
      "CODMOV.RV_MEANING MOTIVO_EVE, "+
      " N.ID_NOTIFICA ID_NOTIFICA, "+
      " N.COD_TIPO_NOTIFICA COD_TIPO_NOTIFICA, COD_NOT.RV_MEANING TIP_NOT,"+
      " N.DATA_AVVENUTA_NOTIFICA DATA_AVVENUTA_NOTIFICA,"+
      " N.DATA_INVIO DATA_INVIO,"+
      " N.COD_ESITO COD_ESITO, COD_ESI.RV_MEANING ESITO,"+
      " N.NOTE NOTE,"+
      ...
      " N.SOLLECITO SOLLECITO, CSS_ID_CSSA,"+
      " N.CUR_ID_CURATORE CUR_ID_CURATORE,"+
      " N.UFF_COD_UFFICIO UFF_COD_UFFICIO, " +
      " E.FLAG_DOCUMENTO_REGISTRATO FLAG, " +
   ...
   ****************************************************************************/
  public Date getDataInvioCertCasellario(BigDecimal aFascKey, String aTipoEvento, String aCodMotivo) throws DAOException
  {
    Date dataInvio = null;
    String lStatement = new String("");
