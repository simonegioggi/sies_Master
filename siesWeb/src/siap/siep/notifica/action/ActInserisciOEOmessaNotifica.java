...
/**
* <p>Title: ActInserisciOEOmessaNotifica</p>
...
public class ActInserisciOEOmessaNotifica extends ActionSiap implements ICostantiNotifica
{
  public String processRequest() throws F3BException
  {
    ...
    if (this.getRequestStringParameter("Notifica").equals("FP")) //FORZE DI POLIZIA
    {
     ...
     String lPage = "";
     lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.notifica.action.ActLoadDettaglioOEOmessaNotifica&"+ICostantiRinnovo.CAMPO_ID_RINNOVO+"="+lRinModel.getIdRinnovo().toString();
