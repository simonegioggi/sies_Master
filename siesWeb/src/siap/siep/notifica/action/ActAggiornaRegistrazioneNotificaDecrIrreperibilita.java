...
/**
* <p>Title: ActAggiornaRegistrazioneNotificaDecrIrreperibilita</p>
...
public class ActAggiornaRegistrazioneNotificaDecrIrreperibilita extends ActionSiap 
...
/*
      ...
      //scadenzario simeone gestito all'interno del controller
      lEveVect = lCtrl.ExAggiornaRegistrazioneNotificaDecretoIrreeribilita(lNotModArray, lFasc.getIdFascicoloSiep());
      setRequestAttribute("notifiche", lEveVect);
*/
      IOrdineEsecuzione lCtrlUno = SIEPLookupRemote.getOrdineEsecuzioneRemote();

      lEveVect = lCtrlUno.ExAggiornaAvvenutaNotifica(lNotModArray, lFasc.getIdFascicoloSiep(), true);
      setRequestAttribute("notifiche", lEveVect);

      String lPage = ""; 
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.notifica.action.ActLoadRicercaNotificaDecretoIrreperibilita&"+ICostantiEvento.CAMPO_ID_EVENTO+"="+((NotificaModel)lEveVect.get(0)).getEveIdEvento().toString();
