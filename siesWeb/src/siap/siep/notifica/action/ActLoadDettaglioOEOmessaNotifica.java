...
/**
* <p>Title: ActLoadDettaglioOEOmessaNotifica</p>
...
public class ActLoadDettaglioOEOmessaNotifica extends ActionSiap implements ICostantiNotifica
{
 public String processRequest() throws F3BException
  {
    ...
    return PG_DETTAGLIO_OE_OMESSA_NOTIFICA;  //restituisce la jsp di VIEW
   }
}