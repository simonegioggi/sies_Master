...
public class ActUploadSolleciti extends ActionSiap implements ICostantiNotifica
{
  public String processRequest() throws Exception
  {
    ...
    if (isRequestChecked(ICostantiRinnovo.CAMPO_VALIDA))
    {
      ...
      lCtrl.ExUpdateValidaSolleciti(lFascMod,lModel);
    }
    else
    {
