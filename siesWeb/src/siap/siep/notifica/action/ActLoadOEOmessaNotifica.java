...
/**
* <p>Title: ActLoadOEOmessaNotifica</p>
...
public class ActLoadOEOmessaNotifica extends ActionSiap implements ICostantiNotifica,ICostantiScadenzario
{
...
/*
	    ...
	    lEveNot = lCtrl1.ExRicercaEventoNotificaByIdFascicoloDescrMotivo(lIdFas,"OE");
*/
	  
      // Paolo Cherubini 07/06/2011 accedo direttamente per id_Evento 
	  // ho commentato la parte sopra
      EventoNotificaModel lEveNot = new EventoNotificaModel();
      ...
      IEvento lCtrlEve = SICOLookupRemote.getEventoRemote();
 	  lEveNot = lCtrlEve.ExRicercaEventoNotificaByKey(lIdEve);
	    ...
	    {	
	    	// Paolo Cherubini 15 novembre 2011 se non esiste la notifica la creiamo vedi sotto
	    	// throw new SIEPException(SIEPException.USER_MESSAGE, "Non Esiste Nessuna Notifica Associata all'OE ");
	    }	

	    EventoModel lEveMod = new EventoModel();
	    IEventoSimeone lCtrl1 = SICOLookupRemote.getEventoSimeoneRemote();
	    lEveMod = lCtrl1.ExRicercaEventoByEveIdEvento(lEveNot.getEvento().getIdEvento());
	    ...
	    return PG_LOAD_OE_OMESSA_NOTIFICA;  //restituisce la jsp di VIEW
  	}
}