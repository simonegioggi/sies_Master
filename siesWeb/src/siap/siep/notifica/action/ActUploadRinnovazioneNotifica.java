...
/**
 * <p>Title: ActUploadRinnovazioneNotifica</p>
 * <p>Description: </p>
...
public class ActUploadRinnovazioneNotifica extends ActionSiap implements ICostantiNotifica
{
  public String processRequest() throws Exception
  {
    ...
    if (isRequestChecked(ICostantiRinnovo.CAMPO_VALIDA))
    {
      ...
      lCtrl.ExUpdateValidaRinnovazioneNotifiche(lFascMod,lModel);
    }
    else
    {
   ...
   if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
    {
      ...
      lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" +
            ...
            getRequestStringParameter("Notifica"));
