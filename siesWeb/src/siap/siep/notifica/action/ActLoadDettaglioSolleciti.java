...
/**
* <p>Title: ActLoadDettaglioSolleciti</p>
...
public class ActLoadDettaglioSolleciti extends ActionSiap implements ICostantiNotifica
{
 public String processRequest() throws F3BException
  {
    ...
    return PG_DETTAGLIO_SOLLECITI;  //restituisce la jsp di VIEW
   }
}