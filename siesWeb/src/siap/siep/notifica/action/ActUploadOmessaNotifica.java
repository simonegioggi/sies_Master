...
public class ActUploadOmessaNotifica extends ActionSiap implements ICostantiNotifica
{
  public String processRequest() throws Exception
  {
    ...
    if (isRequestChecked(ICostantiRinnovo.CAMPO_VALIDA))
    {
      ...
      lCtrl.ExUpdateValidaRinnovo(lFascMod,lModel);
    }
    else
    {
   ...
   if (!isRequestParameterNullObj(CAMPO_AZIONE_DETTAGLIO))
    {
      ...
      lRedirigi.setAction(getRequestStringParameter(CAMPO_AZIONE_DETTAGLIO) + "&" +
            ICostantiRinnovo.CAMPO_ID_RINNOVO + "=" + getRequestStringParameter(ICostantiRinnovo.CAMPO_ID_RINNOVO)+"&Notifica="+
            getRequestStringParameter("Notifica")+"&Ufficiali="+ getRequestStringParameter("Ufficiali")
            +"&Rinnovo="+ getRequestStringParameter("Rinnovo"));
