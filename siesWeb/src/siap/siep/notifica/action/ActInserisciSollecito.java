 ...
 * @version 1.0
 */
public class ActInserisciSollecito extends ActionSiap implements ICostantiNotifica {
	...
	public String processRequest() throws F3BException {
		...
		lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.siep.notifica.action.ActLoadDettaglioSolleciti&" + ICostantiRinnovo.CAMPO_ID_RINNOVO
				+ "=" + lRinModel.getIdRinnovo().toString();
		return lPage;
	}
