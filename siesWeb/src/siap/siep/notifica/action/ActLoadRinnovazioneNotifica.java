...
/**
* <p>Title: ActLoadRinnovazioneNotifica</p>
...
public class ActLoadRinnovazioneNotifica extends ActionSiap implements ICostantiNotifica
{
public String processRequest() throws F3BException
  {
    if (this.isSessionAttributeNullObj("fascicolo"))
      ...
      }else
      {
       ...
       return PG_LOAD_RINNOVAZIONE_NOTIFICA;  //restituisce la jsp di VIEW
