...
/**
* <p>Title: PenaResiduaSqlDAO</p>
* <p>Description: Classe SqlDAO che rappresenta la tabella PenaResidua</p>
...
public class PenaResiduaSqlDAO extends SIAPSqlDAO
{
  ...
  /*****************************************************************************
   * Costruisce la query in base al contenuto del model 
   * <b>In realtà utilizza solo l'id fascicolo</b>
   * @param aModel
   * @throws DAOException
   ************************************************************************** */
  ...
  /*****************************************************************************
   * Effettua la ricerca dei record pena_residua NON VALIDATI (FLAG_VALIDATO = 'N')
   * ordinati per data CRESCENTE (dal meno recente)
   * 
   * @param aKeyFascicolo - id fascicolo
   * @throws DAOException
   ************************************************************************** */
  ...
  /*****************************************************************************
   * Effettua la ricerca dei record pena_residua NON VALIDATI (FLAG_VALIDATO = 'N')
   * ordinati per data descrescente (dal più recente)
   * 
   * @param aKeyFascicolo - id fascicolo
   * @throws DAOException
   ************************************************************************** */
  ...
  /*****************************************************************************
   * Effettua la ricerca dei record pena_residua ordinati per data
   * decrescente (dal più recente) validati o meno
   * @param aKeyFascicolo - id fascicolo
   * @throws DAOException
   ************************************************************************** */
  ...
  /*****************************************************************************
   * Restituisce l'elenco delle PENE_RESIDUE VALIDATE ordinate per data 
   * decrescente
   * @param aKeyFascicolo - id fascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepDataDesc( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
  ...
  /*****************************************************************************
   * Restituisce l'elenco delle PENE_RESIDUE ordinate per data decrescente 
   * indipendentemente dallo stato di validazione
   * 
   * @param aKeyFascicolo - id fascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepDataDesc_IgnoraValidazione( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
  ...
  /*****************************************************************************
   * Restituisce l'elenco delle PENE_RESIDUE ordinate per data inserimento
   * decrescente (validate o meno)
   * 
   * @param aKeyFascicolo
   * @throws DAOException
   ************************************************************************** */
   ...
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaValidata( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();

    lSql += " FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo;
    lSql += " AND FLAG_VALIDATO = 'S' ";
    lSql += " AND DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo + " AND FLAG_VALIDATO = 'S') ";
    lSql += " ORDER BY DATA_INSERIMENTO DESC";
  ...
  /*****************************************************************************
   * Restituisce la PENA_RESIDUA VALIDATA con data inserimento più recente 
   * e data fine valorizzata (not null) 
   * @param aKeyFascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaValidataDataFinePena( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
    ...
    lSql += " AND DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo + " AND FLAG_VALIDATO = 'S' AND DATA_FINE IS NOT NULL) ";
    lSql += " ORDER BY DATA_INSERIMENTO DESC";
  ...
  /*****************************************************************************
   * Restituisce la PENA_RESIDUA VALIDATA con data inserimento più recente 
   * e FLAG_PENA_SOSPESA = 'S'
   *  
   * @param aKeyFascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaValidataSospesa( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
    ...
    lSql += " AND DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo + " AND FLAG_VALIDATO = 'S' AND FLAG_PENA_SOSPESA = 'S') ";
    lSql += " ORDER BY DATA_INSERIMENTO DESC";
  ...
  /*****************************************************************************
   * Restituisce la PENA_RESIDUA NON VALIDATA con data inserimento più recente 
   * e FLAG_PENA_SOSPESA passato in input
   * 
   * @param aKeyFascicolo
   * @param aFlagPena
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaNonValidataFlagPena( BigDecimal aKeyFascicolo,String aFlagPena)	 throws DAOException
 {
   String lSql = getSqlQuery();
   ...
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaNonValidataSospesa( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
    ...
    lSql += " AND FLAG_VALIDATO = 'N' ";
    lSql += " AND FLAG_PENA_SOSPESA = 'S' ";
    lSql += " AND DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo + " AND FLAG_VALIDATO = 'N' AND FLAG_PENA_SOSPESA = 'S') ";
    lSql += " ORDER BY DATA_INSERIMENTO DESC";
   ...
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiepUltimaValidataSospesaInterruzione( BigDecimal aKeyFascicolo)	 throws DAOException
  {
    String lSql = getSqlQuery();
    ...
    lSql += " AND DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo + " AND FLAG_VALIDATO = 'S' AND FLAG_PENA_SOSPESA = 'I') ";
    lSql += " ORDER BY DATA_INSERIMENTO DESC";
  ...
  /*****************************************************************************
   * Recupera il record PENA_RESIDUA con data inserimento più recente 
   * indipendentemente dallo stato
   * 
   * @param aKey - id del fascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteByFascicoloSiep(BigDecimal aKey) throws DAOException
  {
    ...
    lSql += " DATA_INSERIMENTO = ( SELECT MAX(DATA_INSERIMENTO) FROM PENA_RESIDUA WHERE FAS_SIE_ID_FASCICOLO_SIEP = " + aKey + ")";
   ...
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaCorrenteFlagPiuMenoByFascicoloSiep(BigDecimal aIdFascicoloSiep) throws DAOException
  {
    String lSql =  "SELECT " +
                   "ID_PENA_RESIDUA, "+
                   "DATA_INIZIO, "+
...
//                   "DATA_FINE_SS, "+
  ...
  /**
   * Ricerca la pena residua da associare a una archiviazione RES. La pena da
   * recuperare è l'ultima pena inserita prima dell'archiviazione, quindi viene
   * ricercata sugli eventi inseriti prima dell'archiviazione
   * @param aIdFascicolo
   * @param aDataInserimento - data inserimento dell'evevnto di archiviazione
   * @throws DAOException
   */
  public void ricercaPenaDaArchiviazione (BigDecimal aIdFascicolo, Date aDataInserimento) throws DAOException
  {
    ...
    lStatement += " SELECT  PR.ID_PENA_RESIDUA, "+
                          ...
                          " PR.IMPORTO_MULTA, "+
                          " PR.NUM_ANNI_ARRESTO, PR.NUM_MESI_ARRESTO, PR.NUM_GIORNI_ARRESTO, "+
                          " PR.IMPORTO_AMMENDA, "+
                          " PR.DIES_A_QUO, "+
...
//                          " PR.DATA_FINE_SS ";
    ...
    // n.b. sulle date il test è <= perchè in genere per i dati migrati RES non sono presenti ora, minuti e secondi
    ...
    lStatement += "     AND EVENTO.DATA_INSERIMENTO <= to_date ('"+DateUtils.getDateToString(aDataInserimento,"dd/MM/yyyy HH:mm:ss")+"','dd/MM/yyyy hh24:mi:ss')" ;  
...
//    aModel.setDataFineSS              (getDate       ("DATA_FINE_SS") );
  ...
  /*****************************************************************************
   * Ricerca l'ultimo record PENA_RESIDUA inserito per il fascicolo e se ha
   * FLAG_VALIDATO diverso da S lo aggiorna, altrimenti inserisce un nuovo record
   * PENA_RESIDUA.
   * 
   * @param aPenaResidua - model con i dati da inserire/aggiornare
  ...
  /*****************************************************************************
   * Restituisce l'elenco delle PENE_RESIDUE VALIDATE ordinate per data inserimento
   * decrescente, ma inserite prima della data passata in input
   * 
   * @param aKeyFascicolo
   * @throws DAOException
   ************************************************************************** */
  public void ricercaPenaResiduaValidataPerData(BigDecimal aKeyFascicolo, Date aDataIns)  throws DAOException
  {
    String lSql = getSqlQuery();

    lSql += " FAS_SIE_ID_FASCICOLO_SIEP = " + aKeyFascicolo;
    lSql += " AND pena_residua.FLAG_VALIDATO = 'S'";
    lSql += " AND pena_residua.DATA_INSERIMENTO < to_date ('"+DateUtils.getDateToString(aDataIns,"dd/MM/yyyy HH:mm:ss")+"','dd/MM/yyyy hh24:mi:ss')";
    lSql += setOrderDataInserimentoDesc();
  ...
  /**
   * Ricerca il record pena residua associata all'ultima richiesta al GE di 
   * Amnistia/Indulto
   * @param aIdFascicolo
   * @throws DAOException
   */
  public void ricercaPenaResiduaRichestaAmnistiaIndulto(BigDecimal aIdFascicolo) throws DAOException
  {
    ...
    lStatement += " SELECT PR.ID_PENA_RESIDUA,  PR.DATA_INIZIO, PR.DATA_FINE, "+
                  ...
                  " PR.DATA_FINE_PRESUNTA, " +
                  " PR.DATA_FINE_RECLUSIONE," +
                  " PR.DATA_INIZIO_ARRESTO," +
                  " PR.FLAG_ERGASTOLO, " +
                  " PR.DATA_INIZIO_ISOLAMENTO_DIURNO, " +
                  " PR.DATA_FINE_ISOLAMENTO_DIURNO, " +
                  " PR.NUM_ANNI_ISOLAMENTO_DIURNO, " +
                  " PR.NUM_MESI_ISOLAMENTO_DIURNO, " +
                  " PR.NUM_GIORNI_ISOLAMENTO_DIURNO, " +
                  " PR.MIS_ALT_ID_MISURA_ALTERNATIVA, "+
                  " PR.FLAG_PENA_SOSPESA " ;
//                  " PR.FLAG_SANZIONE_SOSTITUTIVA, "+
//                  " PR.COD_TIPO_SANZIONE, " +
//                  " PR.NUM_ANNI_SS, "+
//                  " PR.NUM_MESI_SS, "+
