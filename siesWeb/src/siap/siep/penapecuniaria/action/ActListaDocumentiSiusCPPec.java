...
public class ActListaDocumentiSiusCPPec extends ActionSiap implements ICostantiPenaPecuniaria,
		ICostantiScambioSanzione {
	...
	public String processRequest() throws Exception {
		...
		String[] TipoDec = { "02", "03" }; // 26/11/2014 Consentito anche il decreto.

		lScaSanTipPro = lCtrlSanzione.ExRicercaScambioSanzioneRichConv(TipoDec, lIdFascicoloSiep);
...
//			lScaRic = new ScambioSanzioneRichiestaConvModel();
			...
			return PG_LISTA_DOCUMENTI_SIUS_CP_PEC;
		} else {
			setRequestAttribute("lScaSanzRC", lScambioSanzioneRC);
			setRequestAttribute("lCodTipPro", lCodTipProv);
			return PG_LISTA_DOCUMENTI_SIUS_CP_PEC;
