...
/**
* <p>Title: ActInserisciRichiestaConversione</p>
...
public class ActInserisciRichiestaConversione extends ActionSiap 
  ...
  ****************************************************************************/
  public String processRequest() throws F3BException 
  {
    ...
    if(!isRequestParameterNullObj(nomeIdFascClasseI)  &&
		...
		lDettaglioFascicolo.getFascicoloSiep().setFasSieIdFascicoloSiep(getRequestBigDecimalParameter("idFascicoloClasseI"));
    }
  ...
  //  lRicMod.setProtCircosrizioneDoganale   ( getRequestStringParameter     ( CAMPO_PROT_CIRCOSRIZIONE_DOGANALE) );
	...
	ComuneModel lComMod = new ComuneModel(getCodComuneByDescrFlagVal(getRequestStringParameter( CAMPO_COD_LUOGO_EMITTENTE )) );
    ...
    if  (lFascProg > 70000 && lFascProg < 80001){   	 
	    ...
	    //09/07/2015 lFasMod.setDataIscrizione(DateUtils.getDate(DateUtils.getSysDate("dd/MM/yyyy"), "dd/MM/yyyy"));
	...
	//    lFasMod.setSenIdSentenza(); mi riporto quelle del fascicolo classe I
	    ...
	    lRicRetMod=lCtrlRic.ExInserisciRichiestaConversionedaClasseI(lSogMod,lEveMod,lFasMod, lDettaglioFascicolo, lRicMod);
    ...
    String lPage="";
    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.penapecuniaria.action.ActLoadDettaglioRichiestaConversione";
