...
/**
  * <p>Title: ActStampaRideterminazionePenaRevocaSS</p>
...
public class ActStampaRideterminazionePenaRevocaSS extends ActionSiap
{
  ...
  public String processRequest() throws F3BException
  {
    ...
    //==========================================================================
    // Recupero l'evento per il quale produrre la Stampa (OE)
    //==========================================================================
...
//    ByteArrayOutputStream lReport = lCtrl.ExStampaDocumento(lEveNotMod, lUtenteMod);
    ByteArrayOutputStream lReport = lCtrlSanzSost.exStampaSS(lEveNotMod, lUtenteMod);
