...
/**
 * <p>Title: ActUploadAnnotazioneEspulsione</p>
 * <p>Description: Classe action per l'Upload/Validazione dell'annotazione avvenuta
 * espulsione e del verbale di espulsione</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadAnnotazioneEspulsione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    //===============================================
    // Recupero l'id della Comunicazione/Annotazione
    //===============================================
    ...
    { // devo effettuare la validazione
      ...
      lSanzioneCtrl.exUpdateAnnotazioneEspulsione(lEveUpdateModel);
    }
    else
    ...
    lRedirigi.setAction( "siap.siep.sanzionesostitutiva.action.ActLoadDettaglioAnnotazioneEspulsione" );
