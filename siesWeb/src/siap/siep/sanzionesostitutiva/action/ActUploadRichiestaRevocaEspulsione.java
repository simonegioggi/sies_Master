...
/**
 * <p>Title: ActUploadRichiestaRevocaEspulsione</p>
 * <p>Description: Classe action per l'Upload/Validazione della Richiesta al GE 
 ...
 * @version 1.0
 */
public class ActUploadRichiestaRevocaEspulsione extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    { // devo effettuare la validazione
      ...
      lSanzioneCtrl.exUpdateRichiestaRevocaEspulsione(lEveUpdateModel);
    }
    else
    ...
    lRedirigi.setAction( "siap.siep.sanzionesostitutiva.action.ActLoadDettaglioRichiestaRevocaEspulsione" );
