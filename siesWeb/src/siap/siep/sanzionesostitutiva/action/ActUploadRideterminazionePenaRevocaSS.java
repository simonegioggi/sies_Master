...
/**
 * <p>Title: ActUploadRideterminazionePenaRevocaSS</p>
 * <p>Description: Classe action per l'Upload/Validazione dell'OE rideterminazione 
 * pena a seguito revoca/conversione sanzione sostitutiva </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: </p>
 * @author not attributable
 * @version 1.0
 */
public class ActUploadRideterminazionePenaRevocaSS extends ActionSiap implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    { // devo effettuare la validazione
      ...
      lSanzioneCtrl.exUpdateOENuovoResiduoPena(lEveUpdateModel);
    }
    else
    ...
    lRedirigi.setAction( "siap.siep.sanzionesostitutiva.action.ActLoadDettaglioRideterminazionePenaRevocaSS" );
