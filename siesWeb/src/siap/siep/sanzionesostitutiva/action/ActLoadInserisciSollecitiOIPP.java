 ...
 * @since MAV_2023-33
 */
public class ActLoadInserisciSollecitiOIPP extends ActionSiap implements ICostantiSanzioneSostitutiva {
  ...
  public String processRequest() throws Exception {
    ...
    if (lFascMod.getFlagValidato().equalsIgnoreCase("N")) {
      ...
      setRequestAttribute(IWebConstants.MESSAGE_TEXT,
          "Il Procedimento N." + lFascMod.getChiaveAnno() + "/" + lFascMod.getChiaveProgr()
              + " non e' stato Validato. Impossibile inserire i Solleciti!");
    ...
    if (isRequestParameterNullObj(ICostantiEvento.CAMPO_ID_EVENTO)) {
      ...
      // Recupero eventuali SOLLECITI già inseriti da visualizzare in elenco e collegati alla notifica per
      // l'esecuzione
      Vector<RinnovoModel> lListaSolleciti = new Vector<>();
      String[] lTipoRinno = {"SP", "SU"};
      IRinnovo lCtrlRinnovi = SIEPLookupRemote.getRinnovoRemote();
      lListaSolleciti = lCtrlRinnovi.ExRicercaRinnovoIdNotificaCodTipoRinnovoStato(
      ...
      setRequestAttribute("listaSolleciti", lListaSolleciti);
    ...
    // pagina di ritorno
    return PG_LOAD_INSERISCI_SOLLECITI_OIPP;
  }
