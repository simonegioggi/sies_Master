...
/**
 * <p>
 * Title: ActRicercaTrasmessioneAttiEsecuzione
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * </p>
 * 
 * @author Eutelia S.p.A.
 * @version 1.0
 */
public class ActRicercaTrasmissioneAttiEsecuzione extends ActionSiap
		implements ICostantiMessaggio, ICostantiSiepJMS, ICostantiSicoJMS {
	...
	public String processRequest() throws Exception {
		...
		try {
			...
			lVect = lCrtlMessaggio.ExRicercaMessaggioEsitoConFiltri(
					ICostantiJMS.TRASFERIMENTO_SANZIONE_SOSTITUTIVA, codUfficio, codUtente, tipoEsito,
					lCodUffDest, lAnnoSiep, lProgrSiep, dataRicercaInizio, dataRicercaFine);
		...
		return ICostantiSanzioneSostitutiva.PG_RICERCA_TRASMISSIONE_ATTI_ESECUZIONE;
	}
}
