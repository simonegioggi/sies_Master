...
/**
 * <p>Title: ActUploadComunicazioneNuovoResiduoPena</p>
 * <p>Description: Classe action per l'Upload/Validazione della Comunicazione Nuovo Residuo Pena 
 * espulsione </p>
 ...
 * @version 1.0
 */
public class ActUploadComunicazioneNuovoResiduoPena extends ActionSiap
  implements ICostantiEvento
{
  public String processRequest() throws Exception
  {
    ...
    { // devo effettuare la validazione
      ...
      lSanzioneCtrl.exUpdateComunicazioneNuovoResiduoPena(lEveUpdateModel);
    }
    else
    ...
    lRedirigi.setAction( "siap.siep.sanzionesostitutiva.action.ActLoadDettaglioComunicazioneNuovoResiduoPena" );
