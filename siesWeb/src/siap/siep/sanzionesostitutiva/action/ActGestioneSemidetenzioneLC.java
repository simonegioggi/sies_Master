 ...
 *
 */
public class ActGestioneSemidetenzioneLC extends ActionSiap
                            implements ICostantiSanzioneSostitutiva
{
  public String processRequest() throws F3BException
  {
    ...
    setRequestAttribute("strFunzione", "Semidetenzione / Libertà controllata");

    return PG_GRIGLIA_SEMIDETENZIONE_LC;
  }
}
