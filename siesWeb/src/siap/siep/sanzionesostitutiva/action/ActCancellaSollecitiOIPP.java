...
/**
 * Funzione di cancellazione dei solleciti OIPP se non validati
 *
 * @author d.fiorletta
 * @since MAV_2023-33
 */
public class ActCancellaSollecitiOIPP extends ActionSiap implements ICostantiNotifica {
  ...
  public String processRequest() throws F3BException {
    ...
    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
        + "=siap.siep.sanzionesostitutiva.action.ActLoadInserisciSollecitiOIPP&"
