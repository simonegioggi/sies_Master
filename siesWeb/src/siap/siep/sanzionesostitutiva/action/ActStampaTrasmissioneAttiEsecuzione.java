...
/**
  * <p>Title: ActStampaTrasmissioneAttiEsecuzione</p>
...
public class ActStampaTrasmissioneAttiEsecuzione extends ActionSiap
{
...
//cerco il documento
    ...
    lTemMod = lCtrlTem.ExRicercaTemplateByTipEveTipoProvCodMotivoFlagTemplate(lEventoModel.getCodTipoEvento(),lEventoModel.getCodTipoProvvedimento(),lEventoModel.getCodMotivo(),"0");
