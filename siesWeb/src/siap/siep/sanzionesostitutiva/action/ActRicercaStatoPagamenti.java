 ...
 * @version 1.0
 */
public class ActRicercaStatoPagamenti extends ActionSiap implements ICostantiSanzioneSostitutiva, ICostantiFascicoloSiep
{
	...
	public String processRequest() throws Exception
	{
		...
		String tipoRicerca = getRequestStringParameter(ICostantiSanzioneSostitutiva.CAMPO_TIPO_RICERCA_STATO_PAGAMENTO);
		...
		Vector lVect = lCtrlSanzSost.ExRicercaFascicoliPerStatoPagamentoPaged(lFasMod, Integer.parseInt(lPagina), tipoRicerca);
