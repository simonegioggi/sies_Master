...
public class ActInserisciNotificaOrdineIngiunzione extends ActionSiap implements ICostantiSanzioneSostitutiva 
{
    ...
    public String processRequest() throws F3BException {
        ...
        Vector <NotificaModel> listaNotDaAggiornare = new Vector <NotificaModel> ();
        int conta = 0;
        ...
        for (int i = 0; i < lNotifiche.length; i++) {
            ...
            if (!isRequestParameterNullEmptyObj(ICostantiOrdineEsecuzione.ABILITA_NOTIFICA+"_"+lNotificaModel.getIdNotifica())) {
                ...
                String lGiornoNot = this.getRequestStringParameter(ICostantiNotifica.CAMPO_GIORNO_DATA_AVVENUTA_NOTIFICA+"_"+IdNotifica);
                String lMeseNot   = this.getRequestStringParameter(ICostantiNotifica.CAMPO_MESE_DATA_AVVENUTA_NOTIFICA+"_"+IdNotifica);
                String lAnnoNot   = this.getRequestStringParameter(ICostantiNotifica.CAMPO_ANNO_DATA_AVVENUTA_NOTIFICA+"_"+IdNotifica);
                ...
                String lAutoritaDelegata     = this.getRequestStringParameter(ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA+"_"+IdNotifica);
                String lSedeAutoritaDelegata = this.getRequestStringParameter(ICostantiAutoritaEsterna.CAMPO_COD_SEDE+"_"+IdNotifica);
                String lIndirizzo            = this.getRequestStringParameter(ICostantiAutoritaEsterna.CAMPO_DESCRIZIONE+"_"+IdNotifica);
