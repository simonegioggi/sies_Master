...
/**
 * Funzione di inserimento della Rinnovazione per Ordini di Ingiunzione al Pagamento
 * @author d.fiorletta
 * @since MEV_2023-33
 */
public class ActInserisciRinnovazioneOIPP extends ActionSiap implements ICostantiNotifica{
  public String processRequest() throws F3BException {
    ...
    lRinMod.setCodTipoRinnovo(this.getRequestStringParameter("Notifica"));
    ...
    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
        + "=siap.siep.sanzionesostitutiva.action.ActLoadDettaglioRinnovazioneOIPP&"
