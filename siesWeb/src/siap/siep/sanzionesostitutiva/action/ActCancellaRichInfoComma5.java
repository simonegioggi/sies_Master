...
public class ActCancellaRichInfoComma5 extends ActionSiap implements ICostantiNotifica {
  ...
  public String processRequest() throws F3BException
  {
    ...
    String lPage = "";
    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.sanzionesostitutiva.action.ActLoadInserisciRichInfoComma5&"+ICostantiEvento.CAMPO_ID_EVENTO+"="+lNotificaModel.getEveIdEvento();
    return lPage;
  }
