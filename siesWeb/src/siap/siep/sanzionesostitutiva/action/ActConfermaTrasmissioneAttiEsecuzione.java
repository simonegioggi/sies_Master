 ...
 * @version 1.0
 */
public class ActConfermaTrasmissioneAttiEsecuzione extends ActionSiap implements ICostantiJMS {
	public String processRequest() throws Exception {
		...
		// 0233 Trasmissione atti al MdS per l'esecuzione di Sanzioni Sostitutive
		/* EventoNotificaModel lEveNotMod = */lCtrl.ExConfermaTrasmissione(lEveMod, lNot, "0233");
		// **************************************************************************************/
