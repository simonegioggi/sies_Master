...
* @version 1.0
*/
public class ActRicercaFogliComplementari extends ActionSiap implements ICostantiStatistiche{
	...
	public String processRequest() throws Exception {
       ...
       mRicercaModel.setFcNonTrasmessi(provvedimentiFCNonTrasmessi);
