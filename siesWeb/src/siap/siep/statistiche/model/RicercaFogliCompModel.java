...
import siap.siep.statistiche.action.ICostantiStatistiche;
...
public class RicercaFogliCompModel extends GenericModel implements ICostantiStatistiche
{
	...
	private boolean fcNonTrasmessi=false;
	
	
	public boolean isFcNonTrasmessi() {
		return fcNonTrasmessi;
	}

	public void setFcNonTrasmessi(boolean fcNonTrasmessi) {
