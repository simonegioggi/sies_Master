...
/**
* <p>Title: StatisticheSigeController</p>
* <p>Description: Classe Controller per le Statistiche</p>
...
public class StatisticheSiepController extends SiapController implements IStatisticheSiep {
	...
	@Override
	public BigDecimal ExCountEstraiStatisticheFogliComplementari(
        ...
        StatisticheFogliComplementariSqlDAO lDao;
