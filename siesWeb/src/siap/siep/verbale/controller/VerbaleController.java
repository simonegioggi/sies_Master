...
/**
 * VerbaleController - Classe Controller per Verbale
 *
 * @version 1.0
 */
...
public class VerbaleController extends SiapController implements IVerbale {
	...
	public VerbaleModel ExInserisciVerbaleVaneRicerche(BigDecimal aKeyFasc, VerbaleModel aVerbale,
		...
		try {
			...
			String lFlagCUM = "N";
			/*
			 * ISSUE MAC : aggiunta variabile Numero MAC : 20200220016 Autore : monica Data : 02/mar/2020
			 * Branch : 12.1
			 */
			...
			if (lEveModOELSRSCUM != null) {
				 ...
				 * comma 1 cpp Numero MAC : 20200220016 Autore : monica Data : 02/mar/2020 Branch : 12.1
				 */
			...
			for (int ins = 1; ins < 3; ins++) {
				...
				if (ins == 1) {
					 ...
					 * new Numero MAC : 20200220016 Autore : monica Data : 02/mar/2020 Branch : 12.1
					 */
