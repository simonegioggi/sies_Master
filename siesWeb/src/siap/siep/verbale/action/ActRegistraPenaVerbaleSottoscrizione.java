...
public class ActRegistraPenaVerbaleSottoscrizione extends ActionSiap implements ICostantiVerbale
{
  ...
  */
  public String processRequest() throws F3BException
  {
    ...
    BigDecimal lIdMis = new BigDecimal (this.getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ID_MISURA_ALTERNATIVA));
...
/**************************************************************************/
    /*String lGiorno = this.getRequestStringParameter("GiornoInizio");
    String lMese = this.getRequestStringParameter("MeseInizio");
    String lAnno = this.getRequestStringParameter("AnnoInizio");
...
//model cssa
    ...
    if(lVerMod != null && lVerMod.getCssIdCssa()!= null && lVerMod.getCssIdCssa().compareTo(new BigDecimal(0))!=0)
    {
...
//POSIZIONE GIURIDICA PRECEDENTE PASSATA AL CONTROLLER
 ...
 /*   PosizioneGiuridicaModel lPosModel = new PosizioneGiuridicaModel();
    ...
    lPosModel.setDataInserimento(DateUtils.getSysDate());
    //lPosModel.setDataInizio(lDataInizio);
    lPosModel.setDataInizio(lVerMod.getDataPervenimento());
    if(lVerMod != null && lVerMod.getCssIdCssa() != null && lVerMod.getCssIdCssa().compareTo(new BigDecimal(0)) != 0)
    {
     lPosModel.setCodPosizioneGiuridica("13");
    }
    if(lVerMod != null && lVerMod.getIstDetIdIstitutoDetenzione()!= null && !lVerMod.getIstDetIdIstitutoDetenzione().equals("-"))
    {
     lPosModel.setCodPosizioneGiuridica("14");
    }
   if(lVerMod != null && lVerMod.getCodTipoUfficioFirmatario() != null
      ...
      && !lVerMod.getCodLuogoUfficioFirmatario().equals("-"))
    {
     lPosModel.setCodPosizioneGiuridica("12");
    }
...
/*
    ...
    // N.B. cerca quelli con FLAG_ELABORATO E
    int lTotGiorni = lCtrlLib.ExTotalePeriodiConcessiElaboratiByIdFascicoloSiep(lFascMod.getIdFascicoloSiep());
*/
