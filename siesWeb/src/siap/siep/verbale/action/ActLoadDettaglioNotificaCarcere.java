...
/**
 * <p>Title: ActLoadDettaglioNotificaCarcere</p>
 * <p>Description: Classe Action per la load dettaglio di Notifica Carcere</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: Bull</p>
 * @version 1.0
 */

public class ActLoadDettaglioNotificaCarcere extends ActSIESDettaglioProvvedimento implements ICostantiVerbale
{
...
//    int lTotGiorni = lCtrlLib.ExTotalePeriodiConcessiComputatiByIdFascicoloSiep(lIdFasc);
  ...
  //---REWORK  setRequestAttribute("luogodetenzione", lLuoDetMod);
    ...
    return PG_LOAD_DETTAGLIO_PENA_RESIDUA_NOTIFICA_CARCERE;
