...
public class ActCancellaReato extends ActionSiap implements ICostantiReato
{
  public String processRequest() throws Exception
  {
     ...
     if (proceed)
    {
      ...
      lReato.setIdReato((BigDecimal)getRequestBigDecimalParameter(CAMPO_ID_REATO));
      IReato lReaCtrl = SIEPLookupRemote.getReatoRemote();

      lReato=lReaCtrl.ExRicercaReatoByKey(lReato.getIdReato());

      lReaCtrl.ExCancellaReato(lReato);
