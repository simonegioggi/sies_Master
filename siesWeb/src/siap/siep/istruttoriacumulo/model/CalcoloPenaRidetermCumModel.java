...
public class CalcoloPenaRidetermCumModel extends GenericModel {
	...
	private BigDecimal mIdCalcoloPenaRidetermCum;
	...
	/********************************************************************************************
	 * Costruttore di default che inizializza i campi del model settandoli al valore 'null'
	 ********************************************************************************************/
	public CalcoloPenaRidetermCumModel() {
		this.mIdCalcoloPenaRidetermCum = null;
	...
	public CalcoloPenaRidetermCumModel(CalcoloPenaRidetermCumModel aModel) {
		this.mIdCalcoloPenaRidetermCum = aModel.mIdCalcoloPenaRidetermCum;
	...
	public CalcoloPenaRidetermCumModel(PenaRideterminataCumuloModel aModel) {
		this.mIdCalcoloPenaRidetermCum = aModel.getIdPenaRideterminataCumulo();
		this.mCodTipoPenaDetentiva = aModel.getCodTipoPenaDetentiva();
		this.mDescrTipoPenaDetentiva = aModel.getDescrTipoPenaDetentiva();
		...
		this.mNumeroGiorniLA = aModel.getNumeroGiorniLA();
		this.mNumeroGiorniLS = aModel.getNumeroGiorniLI();
		this.mNumeroGiorniLI = aModel.getNumeroGiorniLS();
		this.mNumeroGiorniRiduzione = aModel.getNumeroGiorniRiduzione();
		this.mNumeroGiorniScomputo = aModel.getNumeroGiorniScomputo();
		this.mFlagPenaResiduaCumulo = aModel.getFlagPenaResiduaCumulo();
		...
		this.mStringaPenaResiduaAdOggi = aModel.getStringaPenaResiduaAdOggi();
	...
	// METODI GET()
	// ============================================================================
	public BigDecimal getIdCalcoloPenaRidetermCum() {
		return mIdCalcoloPenaRidetermCum;
	}
	...
	// METODI SET()
	// ============================================================================
	public void setIdCalcoloPenaRidetermCumo(BigDecimal aValore) {
		mIdCalcoloPenaRidetermCum = aValore;
	}
	...
	public boolean isNegativeReclusione() {
		...
		if (mNumAnniReclusione != null)
			totGGRec += 360 * mNumAnniReclusione.intValue();
		if (mNumMesiReclusione != null)
			totGGRec += 30 * mNumMesiReclusione.intValue();
		if (mNumGiorniReclusione != null)
			totGGRec += mNumGiorniReclusione.intValue();
	...
	public boolean isNegativeArresto() {
		...
		if (mNumAnniArresto != null)
			totGGArr += 360 * mNumAnniArresto.intValue();
		if (mNumMesiArresto != null)
			totGGArr += 30 * mNumMesiArresto.intValue();
		if (mNumGiorniArresto != null)
			totGGArr += mNumGiorniArresto.intValue();
	...
	public String toString() {
		...
		lStr = "CalcoloPenaRidetermCumModel:\n" + "[ mIdCalcoloPenaRidetermCum = " + mIdCalcoloPenaRidetermCum
