...
/**
 * Action che effettua la ricerca del procedimento su cui trasferire 
 * i dati dell'istruttoria
 * @author difiorlett
 * @since MEV_2025-48 – 2.14 Caricamento Istruttoria Annullata
 */
public class ActRicercaFascPerTrasferisciIstruttoria extends ActionSiap implements ICostantiIstruttoriaCumulo {
    ...
    public String processRequest() throws F3BException {
        ...
        Vector <IstruttoriaCumuloModel> lVectIstruttorie = new Vector <IstruttoriaCumuloModel>();
        ...
        if (lIstMod!=null) {
            lIstrCtrl = SIEPLookupRemote.getIstruttoriaCumuloRemote();
            Vector lListaTitoli = lIstrCtrl.ExRicercaTitoliByIstruttoriaOrderBy(lIstMod.getIdIstruttoriaCumulo(),
