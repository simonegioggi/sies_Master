...
/**
 * <p>
 * Title: ActAggiornaDateAtti
 * </p>
 * <p>
 * Description: Azione specializzazione della ActRicercaStatoAtti. L'Azione attiva l'aggiornamento multiplo
 * delle date di ricezione Atti utilizzando l'apposita funzione nel Controller Evento; poi effettua la ricerca
 ...
 * @version 1.0
 */
public class ActAggiornaDateNotifica extends ActionSiap implements ICostantiSollecito {
	...
	public String processRequest() throws Exception {
		...
		if (lNumRec > 0)
			throw new F3BException(F3BException.USER_MESSAGE, "Aggiornate n° " + lNumRec
					+ " date restituzioni di atti istruttori.");
		...
		setFunctionsAvailableToRequest("siap.siep.sollecito.action.ActRicercaStatoAttiSollecito");
