...
public class BollettinoBatchPagopaDAO extends SIAPTableDAO {
	...
	public BigDecimal getFkIdInvocazionePagopa() throws DAOException { return getBigDecimal("FK_ID_INVOCAZIONE_PAGOPA");}
	public BigDecimal getFkIdBollettinoPagopa()  throws DAOException { return getBigDecimal("FK_ID_BOLLETTINO_PAGOPA");}
	public BigDecimal getFkIdBatchPagopa()       throws DAOException { return getBigDecimal("FK_ID_BATCH_PAGOPA");}
	public String     getStatoPagopa()           throws DAOException { return getString("STATO_PAGOPA");}
	
	public void setFkIdInvocazionePagopa (BigDecimal aValore) { setBigDecimal("FK_ID_INVOCAZIONE_PAGOPA", aValore); }
	public void setFkIdBollettinoPagopa  (BigDecimal aValore) { setBigDecimal("FK_ID_BOLLETTINO_PAGOPA", aValore); }
	public void setFkIdBatchPagopa       (BigDecimal aValore) { setBigDecimal("FK_ID_BATCH_PAGOPA", aValore); }
	public void setStatoPagopa           (String     aValore) { setString("STATO_PAGOPA", aValore);  }
