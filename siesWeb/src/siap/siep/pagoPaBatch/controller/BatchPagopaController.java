...
public class BatchPagopaController extends SiapController implements IBatchPagopa {
	...
	public Vector<BatchPagopaModel> ExRecuperaLancioBatchPagopa(CriteriRicercaBatchPagopaModel criteriModel,
		...
		try {
			...
			for (int i = 0; i < lElencoDebitori.size(); i++) {
				...
				try {
					 ...
					 * codiceDistretto, causale, stato, dataRichiestaDa, dataRichiestaA, dimensionePagina,
					 * numeroPagina);
					 */
					RisultatoRicerca rr = scpt.elencoPagamenti(codiceCRS, tipologia, codiceFiscale,
