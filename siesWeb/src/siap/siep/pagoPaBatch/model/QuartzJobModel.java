...
public class QuartzJobModel {
	...
	private String[] decodeGionoSett = { "Domenica", "Lunedi'", "Martedi'", "Mercoledi'", "Giovedi'",
			"Venerdi'", "Sabato" };
	...
	// SETTER
	public void setNomeDemone(String nomeDemone) {
		this.nomeDemone = nomeDemone;
	}

	public void setGruppoDemone(String gruppoDemone) {
		this.gruppoDemone = gruppoDemone;
	}
	...
	public void setNextSched(String nextSched) {
