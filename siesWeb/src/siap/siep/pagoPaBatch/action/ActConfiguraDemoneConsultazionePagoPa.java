...
public class ActConfiguraDemoneConsultazionePagoPa extends ActionSiap implements ICostantiBatchPagoPa {
    ...
    public String processRequest() throws Exception {
        ...
        String nuovaSchedulazione = secondi+" "+minuti+" "+orario+" "+giorno+" "+mese+" "+giornoSettimana;
        ...
        try {
            schedulerBuilder = CronScheduleBuilder.cronSchedule(nuovaSchedulazione).withMisfireHandlingInstructionDoNothing();
        } catch (Exception e) {
            siesLogger.error("Espressione non valida = "+e.getMessage()+" - "+e.getCause().getMessage());
            throw e;
        }
