...
public class ActVisualizzaBatchPagoPa extends ActionSiap implements ICostantiBatchPagoPa {
    ...
    public String processRequest() throws Exception {
        ...
        // e nella form vengono caricati 20 record ogni pagina per cui si ha la situazione degli ultimi 20 giorni
        ...
        Vector <BatchPagopaModel> listaLanci = lCtrlBatch.ExRecuperaLancioBatchPagopa (lCriteriRicerca, Integer.parseInt(lPagina));
