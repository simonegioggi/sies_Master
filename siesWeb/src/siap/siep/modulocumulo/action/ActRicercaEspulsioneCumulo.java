...
/**
* <p>Title: ActRicercaEspulsioneCumulo</p>
* <p>Description: Classe Action per la ricerca di Attività della Sorveglianza - Espulsione per un 
*                 certo Titolo</p>
* @version 1.0
*/
...
public class ActRicercaEspulsioneCumulo extends ActionModuloCumulo implements ICostantiComputiCumulo
{
 /*****************************************************************************************
  * Azione di Ricerca Delle Attività della Sorveglianza - Espulsione. 
  * 
  * Recupera i provvedimenti di Espulsione associati a un certo titolo.
  * 
  ...
  *****************************************************************************************/
  ...
  public String processRequest() throws F3BException 
  {
    ...
    //========================================================================================
    //Ricerca dei provvedimenti SORV. di Espulsione per titolo/istruttoria
    //========================================================================================
    ...
    listaProvv.add("2140");		// Espulsione straniero a titolo di sanzione alternativa (art. 16 comma 5 D.Lvo 286/1998 e succ.mod.)
    listaProvv.add("0029"); 	// Opposizione su espulsione (art. 16 comma 5 D.Lvo 286/1998 e succ.mod.) 
    ...
    setRequestAttribute("ListaEspulsione", lVect);
    
    return PG_ELENCO_ESPULSIONE_CUMULO;
  }
}