...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Depenalizzazione (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioDepenalizzazioneCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_DEPENALIZZAZIONE_CUMULO;
  }
}
