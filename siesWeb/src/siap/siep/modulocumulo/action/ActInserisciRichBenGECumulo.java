        ...
        implements ICostantiStatoEsecTitoloCumulato,  ICostantiComputiCumulo
{
    ...
    public String processRequest() throws F3BException 
    {
      ...
      String lPage = "";
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActRicercaRichBenGE" 
      ...
      if ("I".equals(lModalita)) {
        ...
        lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActDettaglioRichBenGECumulo" 
    ...
    private ComputiCumuloModel getDatiComputo (String aTipoOper) throws F3BException
    {
      ...
      if (lComputo.getCodTipoAnnotazione().equals("002") || lComputo.getCodTipoAnnotazione().equals("003")){
          // Amnistia/Indulto
          siesLogger.debug("Amnistia/Indulto");          
          lComputo.setCodDpr(getRequestStringParameter(ICostantiComputiCumulo.CAMPO_COD_DPR));
      }
      else if (lComputo.getCodTipoAnnotazione().equals("004") || lComputo.getCodTipoAnnotazione().equals("017")){
          // Depenalizzazione
      ...
      if (!isRequestParameterNullObj(ICostantiComputiCumulo.CAMPO_FLAG_APP_PROVVISORIA))
          lComputo.setFlagAppProvvisoria ( getRequestStringParameter  ( ICostantiComputiCumulo.CAMPO_FLAG_APP_PROVVISORIA) );
      else 
