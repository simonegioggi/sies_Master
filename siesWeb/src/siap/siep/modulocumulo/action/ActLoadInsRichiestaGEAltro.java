...
/**
 * Action per la load Inserimento e Modifica delle Richieste del PM al GE Tipo Richiesta: Altro (cod = 014) -
 * (Gestione Cumulo)
 *
...
public class ActLoadInsRichiestaGEAltro extends ActionModuloCumulo implements ICostantiRichiestePmInCumulo {
