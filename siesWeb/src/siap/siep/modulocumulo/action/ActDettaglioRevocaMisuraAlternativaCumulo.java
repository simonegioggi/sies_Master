...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Revoca Misura Alternativa (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioRevocaMisuraAlternativaCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_REVOCA_MISURAALTERNATIVA_CUMULO;
  }
}
