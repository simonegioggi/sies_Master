 ...
 * provedimento di Espulsione disposto su uno dei titoli cumulati
      ...
      implements ICostantiStatoEsecTitoloCumulato,  ICostantiComputiCumulo
{
  ...
  public String processRequest() throws F3BException 
  {
    ...
    if ("I".equals(lModalita)) {
      ...
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActDettaglioEspulsioneCumulo" 
      ...
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActRicercaEspulsioneCumulo" 
            + "&"+ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO + "=" +this.getRequestBigDecimalParameter(ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO)
            + "&"+ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO + "=" +this.getRequestBigDecimalParameter(ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO);
    } 
  ...
  private ComputiCumuloModel getDatiComputo(String aTipoOper) throws F3BException
  {
	...
	if (Arrays.asList(arrayUDS).contains(getRequestStringParameter ( CAMPO_COD_MOTIVO) ))
	{
	    if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_DECISIONE).equals(""))
	    	lComputo.setDataEmissioneProvv(DateUtils.getDate(getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_DECISIONE), getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_MESE_DATA_DECISIONE), getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_DECISIONE)));
