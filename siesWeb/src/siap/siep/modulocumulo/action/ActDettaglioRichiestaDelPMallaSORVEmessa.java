...
/**
 * Classe Action per il caricamento del dettaglio della richiesta Emessa del PM alla SORV
 * 
 * @author Intersistemi Italia S.p.A.
 *
 */
public class ActDettaglioRichiestaDelPMallaSORVEmessa extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		return PG_DETT_RICHIESTA_SORV_EMESSA;
	}
