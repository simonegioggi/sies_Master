...
/**
 * Action per l'inserimento, la modifica e la cancellazione dei dati di un provedimento di Sospensione
 * Esecuzione Pena disposto su uno dei titoli cumulati
 *
...
public class ActInserisciSospEsecuzionePenaCumulo extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		if ("I".equals(lModalita)) {
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.modulocumulo.action.ActDettaglioSospEsecuzionePenaCumulo" + "&"
			...
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.modulocumulo.action.ActRicercaSospEsecuzionePenaCumulo" + "&"
					+ ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO + "="
					+ this.getRequestBigDecimalParameter(ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO)
					+ "&" + ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO + "="
					+ this.getRequestBigDecimalParameter(
	...
	private ComputiCumuloModel getDatiComputo(String aTipoOper) throws F3BException {
		...
		if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE)
				.equals("")) {
			lComputo.setDataScarcerazione(DateUtils.getDate(
					getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE),
			...
			lDataSospensione = DateUtils.getDate(
					getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_SCARCERAZIONE),
					getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_MESE_DATA_SCARCERAZIONE),
					getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_SCARCERAZIONE));
		}
