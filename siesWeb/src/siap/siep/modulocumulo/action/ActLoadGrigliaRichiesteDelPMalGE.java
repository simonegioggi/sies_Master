 ...
 * P.M. dell'Esecuzione al Giudice dell'Esecuzione
 * 
 * @author 
 */
public class ActLoadGrigliaRichiesteDelPMalGE extends ActionModuloCumulo implements ICostantiModuloCumulo
{
  ...
  public String processRequest() throws F3BException
  {
    ...
    VecRichiesteGE = (Vector<RichiestePmInCumuloModel>)lCtrlRic.ExRicercaRichiestePmInCumuloByIdIstruttoriaTipoRichiesta(lIstruttoriaModel.getIdIstruttoriaCumulo(), "01", "tutte");
