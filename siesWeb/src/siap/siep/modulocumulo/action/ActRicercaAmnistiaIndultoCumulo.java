...
/**
* <p>Title: ActRicercaAmnistiaIndultoCumulo</p>
...
public class ActRicercaAmnistiaIndultoCumulo extends ActionModuloCumulo implements ICostantiComputiCumulo
{
 /*****************************************************************************
  * Azione di Ricerca Delle annotazioni su Provv. G.E. Amnistia/Indulto. 
  * 
  * Recupera i provvedimenti di Amnistia/Indulto associati a un certo titolo
  * 
  ...
  *****************************************************************************/
  ...
  public String processRequest() throws F3BException {
    ...
    //=====================================================================================
    //Ricerca dei provvedimenti G.E. di Amnistia/Indulto per titolo/istruttoria
    //=====================================================================================
    ...
    lVect = lCtrlStato.ExRicercaProvvedimentiCumuloByIdTitoloTipoProvv(lTitolo.getIdTitoloCumulato(),"01","03","0284");
    siesLogger.debug("lVect.size() = "+lVect.size());
    
    // Passo alla form i dati trovati
    setRequestAttribute("ListaAmnistieIndulti", lVect);
    
    return PG_ELENCO_AMNISTIA_INDULTO_CUMULO;
  }
}