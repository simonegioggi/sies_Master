...
/**
 * Action per la visualizzazione del Dettaglio dell'espiazione pregressa
 * @author 
 *
 */
public class ActDettaglioEspiazionePregressa  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_ESPIAZIONE_PREGRESSA;
  }
}
