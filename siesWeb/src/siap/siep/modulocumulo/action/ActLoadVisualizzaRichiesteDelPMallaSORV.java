...
/**
 * Action per il caricamento delle Richieste Emesse/inviate dal P.M. dell'Esecuzione alla SORV. relative ad
 * una specifica istruttoria cumulo
 *
 * @author
 */
public class ActLoadVisualizzaRichiesteDelPMallaSORV extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		// Ricerca delle Richieste inviate alla Sorveglianza.
		VecRichiesteInv = new Vector<>(lCtrlRic
				.ExRicercaRichiesteInviateCumuloByIdIstruttoria(lIstruttoriaModel.getIdIstruttoriaCumulo(),
						ICostantiRichiestePmInCumulo.RICHIESTA_ALLA_SORV));
		setRequestAttribute("ListaRichiesteInviate", VecRichiesteInv);

		return PG_LOAD_ELENCO_RICHIESTE_DEL_PM_SORV;
	}
}
