 ...
 * P.M. dell'Esecuzione agli uffici di Sorveglianza (TDS e UDS)
 * 
 * @author 
 */
public class ActLoadGrigliaRichiesteDelPMallaSORV extends ActionModuloCumulo implements ICostantiModuloCumulo
{
  /**
   * 
   */
  public String processRequest() throws F3BException
  {
    ...
    // Questa Query produce in Output un Elenco di richieste ; Il secondo parametro indica il TipoRichiesta (al GE, alla SORV., ...); Il terzo parametro indica quali richieste cercare:  tutte - dainviare - inviate  
    VecRichiesteSORV = (Vector<RichiestePmInCumuloModel>)lCtrlRic.ExRicercaRichiestePmInCumuloByIdIstruttoriaTipoRichiesta(lIstruttoriaModel.getIdIstruttoriaCumulo(), "02", "tutte");
