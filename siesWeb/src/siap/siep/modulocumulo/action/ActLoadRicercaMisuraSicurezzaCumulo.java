...
/**
* <p>Title: ActLoadRicercaMisuraSicurezzaCumulo</p>
* <p>Description: Classe Action per la load ricerca di MisuraSicurezzaCumulo</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: </p>
* @author 
* @deprecated Generata dal FrameWork ma mai utilizzata
* @version 1.0
*/
public class ActLoadRicercaMisuraSicurezzaCumulo extends ActionSiap implements ICostantiMisuraSicurezzaCumulo
{
 /*****************************************************************************
  ...
  *****************************************************************************/
  public String processRequest() throws F3BException {
    ...
    return PG_LOAD_RICERCAMISURASICUREZZACUMULO;
