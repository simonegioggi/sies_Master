...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Annotazione pagamento Pena Pecuniaria
 * @author 
 *
 */
public class ActDettaglioPagamentoPP  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_PAGAMENTI_PP_CUMULO;
  }
}
