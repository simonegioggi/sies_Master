 ...
 * provedimento di Revoca Misura Alternativa disposto su uno dei titoli cumulati
      ...
      implements ICostantiStatoEsecTitoloCumulato,  ICostantiComputiCumulo
{
  ...
  public String processRequest() throws F3BException 
  {
    ...
    if ("I".equals(lModalita)) {
      ...
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActDettaglioRevocaMisuraAlternativaCumulo" 
      ...
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActRicercaRevocheMisureAlternativeCumulo" 
            + "&"+ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO + "=" +this.getRequestBigDecimalParameter(ICostantiTitoloCumulato.CAMPO_ID_TITOLO_CUMULATO)
            + "&"+ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO + "=" +this.getRequestBigDecimalParameter(ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO);
    } 
  ...
  private ComputiCumuloModel getDatiComputo(String aTipoOper) throws F3BException
  {
   ...
   lComputo.setIstrIdIstruttoriaCumulo   ( getRequestBigDecimalParameter ( ICostantiIstruttoriaCumulo.CAMPO_ID_ISTRUTTORIA_CUMULO) );
	...
	lComputo.setCodLuogoUfficioProvv        	( getCodComuneByDescr(getRequestStringParameter (ICostantiTitoloCumulato.CAMPO_COD_LUOGO_EMITTENTE) ).getCodComune() );
	 ...
	 {
		 lComputo.setNumGiorniMap(getRequestBigDecimalParameter(ICostantiComputiCumulo.CAMPO_NUM_GIORNI_MAP));
...
// ===== Data Inizio Misura
	 ...
	 if(!isRequestParameterNullObj(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA) && 
		 !getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA).equals("") &&
		 getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA)!= null ) 
	 {
		 lDateIniMisura = (DateUtils.getDate ( getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA),
		 ...
		 lComputo.setDataInizioMisura(DateUtils.getDate ( getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_MISURA),
				 											getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_MISURA), 
				 											getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_MISURA)) );
		 //siesLogger.debug("--XX-- lDateIniMisura = "+DateUtils.getDateToString(lDateIniMisura, "yyyyMMdd"));
	 }
	 
// ===== data Fine Misura
	 Date lDateFineMisura = null;
	 if(!isRequestParameterNullObj(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_FINE_MISURA) && 
		 !getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_FINE_MISURA).equals("") &&
		 getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_FINE_MISURA)!= null ) 
	 {
		 lDateFineMisura = (DateUtils.getDate ( getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_FINE_MISURA),
		 ...
		 lComputo.setDataFineMisura(DateUtils.getDate ( getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_FINE_MISURA),
				 											getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_MESE_DATA_FINE_MISURA), 
				 											getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_FINE_MISURA)) );
		 
		 //siesLogger.debug("--XX-- lDateFineMisura = "+DateUtils.getDateToString(lDateFineMisura, "yyyyMMdd"));
	 }
...
// ===== Totale Pena Residua da Espiare ==============================================
    ...
    if (!isRequestParameterNullObj(ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_REVOCA_RECLUSIONE)) {
      ...
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_REVOCA_RECLUSIONE).equals("")) {
        lComputo.setNumAnniRevocaReclusione(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_REVOCA_RECLUSIONE));
        lResiduaReclusione.setNumAnni(lComputo.getNumAnniRevocaReclusione());
      }
      
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_MESI_REVOCA_RECLUSIONE).equals("")) {
        lComputo.setNumMesiRevocaReclusione(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_MESI_REVOCA_RECLUSIONE));
        lResiduaReclusione.setNumMesi(lComputo.getNumMesiRevocaReclusione());
      } 
      
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_REVOCA_RECLUSIONE).equals("")) {
        lComputo.setNumGiorniRevocaReclusione(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_REVOCA_RECLUSIONE));
        lResiduaReclusione.setNumGiorni(lComputo.getNumGiorniRevocaReclusione());
      }
      
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_REVOCA_ARRESTO).equals("")) {
        lComputo.setNumAnniRevocaArresto(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_ANNI_REVOCA_ARRESTO));
        lResiduaArresto.setNumAnni(lComputo.getNumAnniRevocaArresto());
      }
      
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_MESI_REVOCA_ARRESTO).equals("")) {
        lComputo.setNumMesiRevocaArresto(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_MESI_REVOCA_ARRESTO));
        lResiduaArresto.setNumMesi(lComputo.getNumMesiRevocaArresto());
      }
      
      if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_REVOCA_ARRESTO).equals("")) {
        lComputo.setNumGiorniRevocaArresto(getRequestBigDecimalParameter(ICostantiMisuraAlternativa.CAMPO_NUM_GIORNI_REVOCA_ARRESTO));
    ...
    if (!getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_REVOCA).equals(""))	{
	    	lComputo.setDataInizioRevoca(DateUtils.getDate(getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_ANNO_DATA_INIZIO_REVOCA), getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_MESE_DATA_INIZIO_REVOCA), getRequestStringParameter(ICostantiMisuraAlternativa.CAMPO_GIORNO_DATA_INIZIO_REVOCA)));
	    	
	 // ======= >>> ( se Data_Revoca è presente,  PENA-ESPIATA = (DATA_REVOCA - DATA_INIZIO_MISURA) + GG passati in Istituto
    ...
    if(!lGGPassatiinIst.equals("")) {
   	 lPenaEspiataModel = lCalUtil.sommaGiorni(lPenaEspiataModel, Integer.parseInt(lGGPassatiinIst), 0, 0);
...
// =======>>>>>>>>>>>  Riempio il Moel con i valori della PENA_ESPIATA calcolati 
    ...
    //siesLogger.debug("--XX-- Pena Espiata = AA = "+lComputo.getNumAnniReclusione()+" -MM = "+lComputo.getNumMesiReclusione()+" -GG = "+lComputo.getNumGiorniReclusione());

    //==============================================================================
    //		CALCOLO DI: 		PENA_RESIDUA
    //==============================================================================   
    if(lComputo.getNumAnniRevocaReclusione()	!=null ||
   	 lComputo.getNumMesiRevocaReclusione()	!=null || 
   	 lComputo.getNumGiorniRevocaReclusione()!=null	
   	|| 
   	 lComputo.getNumAnniRevocaArresto()	!=null ||
   	 lComputo.getNumMesiRevocaArresto()	!=null || 
