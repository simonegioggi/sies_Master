...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Espulsione (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioEspulsioneCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_ESPULSIONE_CUMULO;
  }
}
