 ...
 * provedimento di Amnistia / Indulto disposto su uno dei titoli cumulati
 * @author
 *
 */
public class ActInserisciAmnistiaIndultoCumulo extends ActionModuloCumulo 
      implements ICostantiStatoEsecTitoloCumulato,  ICostantiComputiCumulo
{
  ...
  public String processRequest() throws F3BException 
  {
    ...
    String lPage = "";
    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActRicercaAmnistiaIndultoCumulo" 
    ...
    if ("I".equals(lModalita)) {
      ...
      lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.siep.modulocumulo.action.ActDettaglioAmnistiaIndultoCumulo" 
  ...
  private StatoEsecTitoloCumulatoModel getDatiProvvedimento(String aTipoOper) throws F3BException
  {
    ...
    lStaMod.setCodMotivo                 ("0284");  // Provvedimeno Amnistia Indulto
