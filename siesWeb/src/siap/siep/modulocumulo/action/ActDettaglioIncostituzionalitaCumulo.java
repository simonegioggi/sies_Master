...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Incostituzionalita (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioIncostituzionalitaCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_INCOSTITUZIONALITA_CUMULO;
  }
}
