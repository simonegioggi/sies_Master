...
/**
 * Action per l'Emissione (invio logico) di una richiesta giàeffettuata del al GE
 *
 * @author Intersistemi Italia S.p.A.
 *
 */
public class ActEmettiRichiesteDelPM extends ActionModuloCumulo implements ICostantiRichiestePmInCumulo {
	// [FT] - 03/08/2016 - MAC_LOG - Dichiaro un'istanza di Logger per SIESLog
	private static Logger siesLogger = Logger.getLogger(LogF3B.SIES_LOG);

	public String processRequest() throws F3BException {
		siesLogger.debug("--XX-- >>>> Start  ActEmettiRichiesteDelPM....");
		...
		if ("I".equals(lModalita) || "M".equals(lModalita)) {
			lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
					+ "=siap.siep.modulocumulo.action.ActDettaglioRichiestaDelPMEmessa";
