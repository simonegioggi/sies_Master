...
/**
 * Action per il caricamento della stampa del prospetto della Proposta dati finali da prendere in Cumulo
 *
 */

public class ActStampaProspettoPropostaCumulo extends ActionModuloCumulo implements ICostantiModuloCumulo {
	...
	public String processRequest() throws F3BException {
		...
		lTemMod = lCtrlTem.ExRicercaTemplateByTipEveTipoProvCodMotivoFlagTemplate(null, null, "C998", null);

		ByteArrayOutputStream lReport = lIstrCtrl.ExStampaProspettoPropostaCumulo(lIstruttoriaModel,
