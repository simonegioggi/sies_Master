...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Interruzione (modulo cumulo)
 * 
 * @author
 *
 */
public class ActDettaglioInterruzioneCumulo extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		// MOTIVO INTERRUZIONE
		Option lOption = new Option(DecodificheManager.getInstance().getMotivoInterruzione());
		setRequestAttribute("motivointerruzione", "" + lOption);

		return PG_LOAD_DETTAGLIO_INTERRUZIONE_CUMULO;
	}
