...
/**
 * Classe Action per il Load della Form di Inserimento della decisione del G.E. a fronte di: Altre Richieste
 * del P.M. (cod = 014) (gestione Cumulo)
 * 
 * @author Intersistemi Italia S.p.A.
 */
public class ActLoadInsDecisioneDelGEAltro extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		return PG_INSMOD_DEC_GE_ALTRE_RIC;
	}
