...
/**
* <p>Title: ActLoadEmettiRichiestaDelPMallaSORV</p>
* <p>Description: Classe Action per la load Inserimento delle Richieste Del PM alla SORV</p>
*
...
public class ActLoadEmettiRichiestaDelPMallaSORV extends ActionModuloCumulo implements ICostantiModuloCumulo
{
 /*****************************************************************************
  ...
  *****************************************************************************/
  ...
  {
	  siesLogger.debug("ActLoadEmettiRichiestaDelPMallaSORV");
    ...
    VecRichiesteSORV = (Vector<RichiestePmInCumuloModel>)lCtrlRic.ExRicercaRichiestePmInCumuloByIdIstruttoriaTipoRichiesta(lIstruttoriaModel.getIdIstruttoriaCumulo(), "02", "dainviare");
    setRequestAttribute("ListaRichiestePM", VecRichiesteSORV);
    ...
    lOption.setFilter(new String[] {"TDS", "UDS", "UDSM", "TDSM", "-"} );

    setRequestAttribute("ufficioSorv", "" + lOption);

    return PG_LOAD_EMETTI_RICHIESTE_DEL_PM_SORV;
  }
}