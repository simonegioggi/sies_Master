...
/**
 * Action per la Load del form di Inserimento/Modifica dei provvedimenti di annotazione Incostituzionalita
 *
 * @author Intersistemi S.p.A.
 *
 */
public class ActLoadInserisciIncostituzionalitaCumulo extends ActionModuloCumulo
	...
	public String processRequest() throws F3BException {
		...
		return PG_LOAD_INSERISCI_INCOSTITUZIONALITA_CUMULO;
	}
