...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Sospensione Misura Alternativa (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioSospMisuraAlternativaCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_SOSP_MISURAALTERNATIVA_CUMULO;
  }
}
