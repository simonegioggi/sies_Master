...
/**
 * Action per l'Inserimento, Modifica, Cancellazione di una Richiesta al GE; Tipo Richiesta = Altro (cod =
 * 014) - (Gestione Cumulo)
 *
 * @author Intersistemi Italia S.p.A.
 */
public class ActInserisciRichiestaGEAltro extends ActionModuloCumulo implements ICostantiRichiestePmInCumulo {
