...
/**
 * Action per la visualizzazione del Dettaglio del provvedimento di Sospensione Esecuzione Pena (modulo cumulo)
 * @author 
 *
 */
public class ActDettaglioSospEsecuzionePenaCumulo  extends ActionModuloCumulo implements ICostantiComputiCumulo, ICostantiStatoEsecTitoloCumulato
{
  public String processRequest() throws F3BException 
  {
    ...
    return PG_LOAD_DETTAGLIO_SOSP_ESECUZIONEPENA_CUMULO;
  }
}
