...
public class RichPMMisSicCumSqlDAO extends SqlDAO {
  /***************************************************************************** 
   * Costruttore  
   * @param con 
   ****************************************************************************/ 
  public RichPMMisSicCumSqlDAO (Connection con) {
    super(con);
  }
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void getCountRichiestePmInCumulo(RichPMMisSicCumModel aModel) throws DAOException {
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void ricercaRichPmMisSicCumByRichIdRich( BigDecimal aIdRichiestePmInCumulo) throws DAOException {
  ...
  protected String getSqlQuery() {
    ...
    lStatement += " SELECT " +
                  ...
                  "FLAG_CONDONO " ;  
    lStatement += " FROM RICHPM_MISSICUR_CUM";
  ...
  public GenericModel  getModel() throws DAOException {
	  RichPMMisSicCumModel aModel = new  RichPMMisSicCumModel(); 

    //Inserire le opportune set delle descrizioni!
    aModel.setRicIdRichiestePmInCumulo  ( getBigDecimal ("RIC_ID_RICHIESTE_PM_IN_CUMULO"    ) ); 
    aModel.setMisIdMisSicCumulo			( getBigDecimal ("MIS_ID_MISSICUR_CUMULO"       ) ); 
   ...
   * @return 
   ****************************************************************************/ 
  public String setCondizioni(RichPMMisSicCumModel aModel) {
    ...
    if (aModel.getMisIdMisSicCumulo() != null ) { 
      lCondizioni += " and MIS_ID_MISSICUR_CUMULO = " + aModel.getMisIdMisSicCumulo() + ""; 
    } 
