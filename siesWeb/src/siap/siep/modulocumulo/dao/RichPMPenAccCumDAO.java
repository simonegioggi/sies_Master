...
* <p>Description: Classe DAO che rappresenta la tabella RichPM_PenAcc_Cum</p>
...
public class RichPMPenAccCumDAO extends TableDAO {
	 ...
	 *            connessione
	 ****************************************************************************/
	public RichPMPenAccCumDAO(Connection con) {
		super(con);
		setTable("RICHPM_PENACC_CUM");
		...
		setField("PEN_ID_PENACC_CUMULO", BIG_DECIMAL);
	...
	public BigDecimal getPenIdPenAccCumulo() throws DAOException {
		return getBigDecimal("PEN_ID_PENACC_CUMULO");
	}

	public String getFlagCondono() throws DAOException {
		return getString("FLAG_CONDONO");
	}
	...
	public void setPenIdPenAccCumulo(BigDecimal aValore) {
		setBigDecimal("PEN_ID_PENACC_CUMULO", aValore);
	}

	public void setFlagCondono(String aValore) {
		setString("FLAG_CONDONO", aValore);
	}
	...
	public void selCondizioneUpdateFlagCondono(BigDecimal aIdRichiestePmInCumulo, BigDecimal aIdPenaAccCum) {
		String lCondizioni = new String();

		lCondizioni += " and RIC_ID_RICHIESTE_PM_IN_CUMULO = " + aIdRichiestePmInCumulo;
		lCondizioni += " and PEN_ID_PENACC_CUMULO = " + aIdPenaAccCum;
	...
	public GenericModel getModel() throws DAOException {
		return new RichPMPenAccCumModel(getRichIdRichiestePMinCumulo(), getPenIdPenAccCumulo(),
				getFlagCondono());
	}
