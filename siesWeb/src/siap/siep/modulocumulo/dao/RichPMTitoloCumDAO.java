...
/**
* <p>Title: RichPMTitoloCumDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella RichPM_Titolo_Cum</p>
...
public class RichPMTitoloCumDAO extends TableDAO {
	 ...
	 *            connessione
	 ****************************************************************************/
	public RichPMTitoloCumDAO(Connection con) {
		super(con);
		setTable("RICHPM_TITOLO_CUM");
    ...
    setField("FLAG_INTERO_CUMULO"        	 , STRING);
	...
	public BigDecimal getTitIdTitoloCumulato() throws DAOException {
		return getBigDecimal("TIT_ID_TITOLO_CUMULATO");
	}
  public  String	  getFlagInteroCumulo()        	  throws DAOException  { return getString ("FLAG_INTERO_CUMULO"         ); } 
  ...
  public void  setFlagInteroCumulo	            (String  aValore )   	 { setString ("FLAG_INTERO_CUMULO"          , aValore); } 

	public void setTitIdTitoloCumulato(BigDecimal aValore) {
		setBigDecimal("TIT_ID_TITOLO_CUMULATO", aValore);
	}
