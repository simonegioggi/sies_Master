...
public class DatiFinaliCumuloController extends SiapController implements IDatiFinaliCumulo {
	...
	public void ExUpdateValidaProvvedimentoCumulo(EventoModel aEvento,
		...
		try {
			...
			if ("S".equals(lDatiFinaliModel.getFlagCreaFascicoloMs())) {
				...
				// lMisSicCumSqlDAO.start(); 2026.03.17 si commenta la riga. Lo start viene eseguito dalla
				// getModels()
	...
	public ByteArrayOutputStream ExStampaProvvedimentoCumulo(EventoNotificaModel aEventoNotModel,
		...
		try {
			...
			// lMisSicCumSqlDAO.start(); // 2026.03.17 Viene commentato lo start. Viene eseguito dalla
			// getModels
		...
		try {
...

			{
				...
				if (lPenaRideterminataLorda != null) {
					...
					if (csm.isDatiValorizzati()) // 2026.02 Post Collaudo - Si aggiungono i dati solo se
													// valorizzati
