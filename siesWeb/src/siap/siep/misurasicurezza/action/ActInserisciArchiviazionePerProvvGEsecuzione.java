 ...
 * </p>
 * <p>
 * per Provvedimento di Ufficio Esecuzione (G.E.) (appl. MIS. SIC.)
 * </p>
 * <p>
...
public class ActInserisciArchiviazionePerProvvGEsecuzione extends ActionSiap implements
	...
	public String processRequest() throws F3BException {
		...
		// Notifiche ---------> Destinatari Giudici Esecuzione ()
		if (!isRequestParameterNullObj(ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C)
				...
				&& !getRequestStringParameter(ICostantiAutoritaEsterna.CAMPO_COD_TIPO_AUTORITA_C).equals("-")) {
			...
			// lNotUffGE.setCodTipoNotifica("C");
			lNotUffGE.setCodTipoNotifica("NG");
			lNotUffGE.setDataInvio(lDataArch);
			...
			if (!isRequestParameterNullObj(ICostantiAutoritaEsterna.CAMPO_NOTE_C)
					...
					&& !getRequestStringParameter(ICostantiAutoritaEsterna.CAMPO_NOTE_C).equals("")) {
