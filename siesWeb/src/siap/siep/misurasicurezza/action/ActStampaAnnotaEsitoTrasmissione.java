...
public class ActStampaAnnotaEsitoTrasmissione extends ActionSiap implements ICostantiMisuraSicurezza {
...
//		UfficioModel lUff = this.getUfficioUtenteConnesso();
		...
		if (lEveMod.getEvento().getFlagDocumentoRegistrato() != null
			...
			lRedirigi.setAction("siap.siep.misurasicurezza.action.ActLoadDettaglioAnnotaEsitoTrasmissione&"
