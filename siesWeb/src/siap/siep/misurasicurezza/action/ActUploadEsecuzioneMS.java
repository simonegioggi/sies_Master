...
/**
 * <p>Title: ActUploadEsecuzioneMS</p>
 * <p>Description:  Valida dopo la Annotazione della SORVEGLIANZA </p>
 * <p>	i provvedimenti per l'esecuzione Misure Sicurezza/p>
 * <p>Company: </p>
 * @author AMBROS
 * @version 1.0
 */

public class ActUploadEsecuzioneMS extends ActionSiap
implements ICostantiMisuraSicurezza
{
	public String processRequest() throws Exception
	{
		...
		if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
		{
			...
			lCtrlRich.ExValidaAnnotazioneOComunicazioneApplicazioneMS(lModel,lFascMod);
		}
		else
		{
