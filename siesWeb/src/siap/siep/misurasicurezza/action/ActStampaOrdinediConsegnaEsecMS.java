...
/**
 * <p>
 * Title: ActStampaOrdinediConsegnaEsecMS
 * </p>
 * <p>
 * Description: Stampa provvedimento Ordine di Consegna per esecuzione della MIS. SIC.
 * </p>
 * <p>
...
public class ActStampaOrdinediConsegnaEsecMS extends ActionSiap
	...
	public String processRequest() throws F3BException {
		...
		// Controllo se trattasi di Ordine di Consegna di Ordinanza di Proroga Misura su Riesame Pericolosità
		// sociale
		...
		if (lProroga) {
			...
			// lEveMod.setNomeTemplate("SIEP_MS_934"); //SIEP_MS_PROROGA
			flagTemplate = "E";
			...
			if (CodTipoMis.compareTo("05") == 0 // Tipo Misura Non Detentiva Espulsione
				...
				if (CodTipoSentenza.compareTo("01") == 0) {
					// Misura nate in sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_992"); //SIEP_MS_COMUESP_LIB
					flagTemplate = "1";
				} else {
					// Misura provvisorie e/o disposte Fuori Sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_955"); //SIEP_MS_FS_COMUESP_LIB --> OK fatta
					flagTemplate = "D";
				}
				...
				if (CodTipoSentenza.compareTo("01") == 0) {
					// Misura nate in sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_999"); //SIEP_MS_COMUPOL_LIB_NOD
					flagTemplate = "0";
				} else {
					// Misura provvisorie e/o disposte Fuori Sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_978"); // SIEP_MS_FS_COMUPOL_LIB_NOD --> OK fatta
					flagTemplate = "C";
				}
				...
				if (lPrecMis.compareTo("02") == 0) {
					if (CodTipoSentenza.compareTo("01") == 0) {
						// Misura nate in sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_981_1"); // SIEP_MS_OE_LIB_VIG
						flagTemplate = "6";
					} else {
						// Misura provvisorie e/o disposte Fuori Sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_962"); // SIEP_MS_FS_OE_LIB_VIG --> NON HA SENSO
						// -- VUOTO
						flagTemplate = "B";
					}
				} else {
					if (CodTipoSentenza.compareTo("01") == 0) {
						// Misura nate in sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_997"); // SIEP_MS_COMUPOL_LIB_DET
						flagTemplate = "2";
					} else {
						// Misura provvisorie e/o disposte Fuori Sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_976"); // SIEP_MS_FS_COMUPOL_LIB_DET --> OK fatta
						flagTemplate = "A";
					}
				}
			}
			...
			if (CodTipoMis.compareTo("05") == 0 // Tipo Misura Non Detentiva Espulsione
				...
				if (CodTipoSentenza.compareTo("01") == 0) {
					// Misura nate in sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_983"); // SIEP_MS_COMUESP_DET
					flagTemplate = "4";
				} else {
					// Misura provvisorie e/o disposte Fuori Sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_959"); // SIEP_MS_FS_COMUESP_DET --> OK fatta
					flagTemplate = "9";
				}
			} else if (CodTipoMis.compareTo("02") == 0 || // Tipo Misura Non Detentiva
					CodTipoMis.compareTo("09") == 0 || CodTipoMis.compareTo("10") == 0
				...
				if (CodTipoSentenza.compareTo("01") == 0) {
					// Misura nate in sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_991"); // SIEP_MS_COMUPOL_DET_NOD
					flagTemplate = "3";
				} else {
					// Misura provvisorie e/o disposte Fuori Sentenza
					// lEveMod.setNomeTemplate("SIEP_MS_977"); // SIEP_MS_FS_COMUPOL_DET_NOD --> OK fatta
					flagTemplate = "8";
				}
			} else if (CodTipoMis.compareTo("01") == 0 || // Tipo Misura Detentiva
					CodTipoMis.compareTo("03") == 0 || CodTipoMis.compareTo("04") == 0
				...
				if (lPrecMis.compareTo("02") == 0) {
					...
					if (CodTipoSentenza.compareTo("01") == 0) {
						// Misura nate in sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_982_1"); // SIEP_MS_COMU_OE_DET_DET
						flagTemplate = "5";
					} else {
						// Misura provvisorie e/o disposte Fuori Sentenza
						// lEveMod.setNomeTemplate("SIEP_MS_966"); // SIEP_MS_FS_COMU_OE_DET_DET --> OK fatta
						flagTemplate = "7";
					}
				}
			}
		...
		// LogF3B.getLogger()
		// siesLogger.debug("--XX-- NomeTemplate (id) = "+lEveMod.getNomeTemplate());
		// // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		// siesLogger.debug("--XX-- flagTemplate = "+flagTemplate);
		// ========================================
...
} // Chiude classe ActStampaOrdinediConsegnaEsecMS