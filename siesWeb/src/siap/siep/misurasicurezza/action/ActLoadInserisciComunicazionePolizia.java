 ...
 *
 * <p>
 * Title: ActLoadInserisciComunicazionePolizia
 * </p>
 * <p>
 * Description: Classe la load inserimento Comunicazione alle Forze di P.S.
 * </p>
 * *
 * <p>
 * della Decisione del UDS sulla Misura di Sicurezza
 * </p>
 * <p>
 * Company:
 * </p>
...
public class ActLoadInserisciComunicazionePolizia extends ActionSiap implements ICostantiMisuraSicurezza {
	...
	public String processRequest() throws F3BException {
		 ...
		 * ": La Misura in esecuzione è di tipo DETENTIVA");
		 * lRedirigi.setAction("siap.siep.fascicolo.action.ActLoadRicercaFascicoloUnivoco&" +
		 * ICostantiFascicoloSiep.CAMPO_AZIONE_CHIAMANTE + "=" + getClass().getName());
		 * setRequestAttribute(IWebConstants.GOTO_PAGE, "" + lRedirigi);
		 * 
...
//		setRequestAttribute("avvocati", lAvvocati);
		...
		return PG_LOAD_INS_COMUNICAZIONE_POLIZIA; // restituisce la jsp di VIEW
