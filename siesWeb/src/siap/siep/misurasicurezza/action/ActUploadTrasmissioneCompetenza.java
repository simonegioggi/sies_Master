...
/**
 * <p>Title: ActUploadTrasmissioneCompetenza</p>
 * <p>Description: Validazione provvedimento di Trasmissione per Competenza</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
 * @author d.f.
 * @since 12/2013
 */
public class ActUploadTrasmissioneCompetenza extends ActionSiap
implements ICostantiMisuraSicurezza
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrlMisSic.ExUpdateValidaTrasmissioneCompetenza(lEveModel,lFascMod);
    }
    else
    {
