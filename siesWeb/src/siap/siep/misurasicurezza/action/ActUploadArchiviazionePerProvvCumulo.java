...
/**
 * <p>
 * Title: ActUploadArchiviazionePerProvvCumulo
 * </p>
 * <p>
 * Description: Validazio Archiviazione per Provvedimento di cumulo
 * </p>
 */
public class ActUploadArchiviazionePerProvvCumulo extends ActionSiap implements ICostantiMisuraSicurezza {
	...
	public String processRequest() throws Exception {
		...
		if (is != null) {
			...
			is.read(b);
			ByteArrayInputStream lSt = new ByteArrayInputStream(b);
			em.setDocBlobIn(lSt);
		}
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			iRichiesta.ExValidaArchiviazionePerProvvCumulo(em, fsm);
		} else {
