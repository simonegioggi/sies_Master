 ...
 * 
 * - L'iscrizione dei dati a sistema se proveniente da fuori distretto o 
 *   evetualmente l'aggiornamento se già presenti
 * - L'aggiornamento del messaggio come preso elaborato (FLAG_VISTO=S)
 * - L'invio della risposta alll'ufficio mittente 
 * 
 * 
 * @author d.fiorletta
 *
 */
public class ActPresaInCaricoAttoRicevuto extends ActionSiap implements ICostantiMisuraSicurezza, ICostantiJMS
{
  ...
  public String processRequest() throws F3BException, Exception
  {
    ...
    if (lUfficioAtti.getCodDistretto().equalsIgnoreCase(getCodDistrettoUtenteConnesso())) {
      ...
      try
      {
        ...
        lPres.ExInserisciFascicoloSiep(lMessIns, lPresaIncaricoModel);  
        // MEV_2024-DNA - FINE
      }
