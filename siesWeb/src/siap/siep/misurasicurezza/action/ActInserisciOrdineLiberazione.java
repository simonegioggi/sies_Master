 ...
 *
 * <p>
 * Title: ActInserisciOrdineLiberazione
 * </p>
 * <p>
 * Description: Classe per Emissione Ordine di Liberazione
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActInserisciOrdineLiberazione extends ActionSiap implements ICostantiMisuraSicurezza,
...
//		String codidMis = getRequestStringParameter(ICostantiMisuraSicurezza.CAMPO_ID_MISURA_SICUREZZA);
		...
		// Cambio 06 in 09 (M.T. 09/04/2015)
		// lEve.getEvento().setCodTipoProvvedimento("06"); // Ordine Esecuzione
		lEve.getEvento().setCodTipoProvvedimento("09"); // Ordine Scarcerazione

		lEve.getEvento().setCodMotivo("1129"); // per Liberazione
