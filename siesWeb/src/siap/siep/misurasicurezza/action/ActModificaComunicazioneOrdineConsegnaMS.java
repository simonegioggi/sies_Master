 ...
 *
 * <p>
 * Title: ActModificaComunicazioneOrdineConsegnaMS
 * </p>
 * <p>
 ...
 * @author AMBROSINO
 */
public class ActModificaComunicazioneOrdineConsegnaMS extends ActNotificheMS implements
	...
	public String processRequest() throws Exception {
		...
		if (!isRequestParameterNullObj("modalita") && "D".equals(getRequestStringParameter("modalita"))) {
			...
			if (lEve.getEvento().getCodMotivo().compareTo("1131") == 0) {
				lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
						+ "=siap.siep.misurasicurezza.action.ActDettaglioComunicazionePolizia&"
						+ ICostantiEvento.CAMPO_ID_EVENTO + "=" + lRetModel.getEvento().getIdEvento();
			} else if (lEve.getEvento().getCodMotivo().compareTo("1126") == 0) {
				lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
