...
/**
 * <p>
 * Title: ActStampaRichiestaAccertaPericoloSociale
 * </p>
 * <p>
 * Description: Stampa Richiesta al MDS di Accertamento pericolosità sociale (MIS. SIC.)
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActStampaRichiestaAccertaPericoloSociale extends ActionSiap implements ICostantiMisuraSicurezza,
...
//			lIdPos = getRequestStringParameter("IdPosizioneGiuridica");
		...
		// controllo se trattasi di procedimento di misura FUORI SENTENZA
		ISentenza lCtrlS = SIEPLookupRemote.getSentenzaRemote();
//		SentenzaModel SenMod = null;
		/*SenMod = */lCtrlS.ExRicercaSentenzaByKey(lFascicoloModel.getSenIdSentenza());
//		Boolean FuoriSentenza = false;
//		if (SenMod != null && SenMod.getIdSentenza() != null) {
//			if (SenMod.getCodTipoProvvedimento().compareTo("02") == 0
//					|| SenMod.getCodTipoProvvedimento().compareTo("03") == 0) {
//				FuoriSentenza = true;
//			}
//
//		}
...
//		String lMotivo = lEventoModel.getCodMotivo();
		...
		if (lCod.equals("2110"))
			lEveMod.setNomeTemplate("SIEP_MS_001");
		else if (lCod.equals("2114"))
			lEveMod.setNomeTemplate("SIEP_MS_002");
		else
