 ...
 *
 * <p>
 * Title: ActInserisciOrdinediConsegna
 * </p>
 * <p>
 * Description: Classe per Inserimento Ordine di Consegna del provvedimento SIEP
 * </p>
 * <p>
 * dopo Decisione del UDS sulla Misura di Sicurezza e sulla pericolosità sociale
 * </p>
 * <p>
 ...
 * @author AMBROSINO
 */
public class ActInserisciOrdinediConsegna extends ActionSiap implements ICostantiMisuraSicurezza,
...
//		String codidMis = getRequestStringParameter(ICostantiMisuraSicurezza.CAMPO_ID_MISURA_SICUREZZA);
		...
		lEve.getEvento().setCodMotivo("1126");
		...
		if (lDestinatario_C != null) {
			...
			ComuneModel lComModel = new ComuneModel(getCodComuneByDescrFlagVal(lSedeDestinatario_C));
			lAutMod.setCodSede(lComModel.getCodComune());
			lAutMod.setCodOperatoreInserimento(lCodiceOperatore);
			lAutMod.setCodUfficioInserimento(lCodiceUfficio);
			lAutMod.setDataInserimento(DateUtils.getSysDate());
		...
		// Destinatari UDS (Revisione del 24/11/2014)
		...
		// Notofica Istituto di detenzione
...
//									getCodComuneByDescr(lSedeDestinatario_avv[lIndNotifiche]));
		...
		// ---> INSERIMENTO ORDINE di CONSEGNA
		...
		lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.siep.misurasicurezza.action.ActLoadDettaglioOrdinediConsegna&"
