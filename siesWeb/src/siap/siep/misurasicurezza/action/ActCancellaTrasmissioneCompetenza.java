...
/***
 * Action per l cancellazione fisica dei dati del Provvedimento di Trasmissione
 * per competenza prima della validazione
 * 
 * @author d.fiorletta
 *
 */
public class ActCancellaTrasmissioneCompetenza extends ActionSiap
