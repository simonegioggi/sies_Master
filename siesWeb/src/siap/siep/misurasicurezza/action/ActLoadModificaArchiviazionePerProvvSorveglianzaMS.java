...
/**
 * <p>
 * Title: ActLoadModificaArchiviazionePerProvvSorveglianzaMS
 * </p>
 * <p>
 * Description: classe per Load Modifica dei Provvedimenti
 * </p>
 * <p>
 * di Archiviazione per decisione della Sorveglianza (Definizione MIS. SIC.)
 * </p>
 * <p>
...
public class ActLoadModificaArchiviazionePerProvvSorveglianzaMS extends ActionSiap implements
	...
	public String processRequest() throws F3BException {
		...
		if (lArcMod != null && lArcMod.getIdArchiviazione() != null) {
			if (lArcMod.getCodTipoAutoritaEmittente() != null) {
				lAutoritaSORV.setSelected(lArcMod.getCodTipoAutoritaEmittente());
			}
		}
		...
		return PG_MODIFICA_ARCHIVIAZIONE_SORVEGLIANZA;
