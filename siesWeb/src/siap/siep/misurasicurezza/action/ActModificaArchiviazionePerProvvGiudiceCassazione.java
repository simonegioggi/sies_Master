 ...
 * *
 * <p>
 * Title: ActModificaArchiviazionePerProvvGiudiceCassazione
 * </p>
 * <p>
 * Description: classe per la Modifica del Provvedimenti
 * </p>
 * <p>
 * di Archiviazione per decisione del Giudice / Cassazione
 * </p>
 * <p>
 ...
 *
 */
public class ActModificaArchiviazionePerProvvGiudiceCassazione extends ActNotificheMS implements
...
//		FascicoloSiepModel lFascicoloModel = (FascicoloSiepModel) getSessionAttribute("fascicolo");
		...
		// = = EVENTO : VIENE MODIFICATO CON 'Update'
		...
		// = = NOTIFICHE (Tutte) : VENGONO CANCELLATE E RISCRITTE EX-NOVO ('Delete' e poi 'Insert')
		...
		// = = ARCHIVIAZIONE : VIENE MODIFICATA CON 'Update'
		...
		// LogF3B.getLogger()
		// siesLogger.debug("--XX--1 ActModificaArchiviazionePerProvvGiudiceCassazione - DescAutoEmi = "+getRequestStringParameter("DescTipoAutoritaEmittente"));
		// // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		// siesLogger.debug("--XX--1 ActModificaArchiviazionePerProvvGiudiceCassazione - DescProvv = "+getRequestStringParameter("DescTipoProvvArc"));
