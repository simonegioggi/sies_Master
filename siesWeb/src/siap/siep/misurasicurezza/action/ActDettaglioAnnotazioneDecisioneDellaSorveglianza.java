...
/**
 * <p>
 * Title: ActDettaglioAnnotazioneDecisioneDellaSorveglianza
 * </p>
 * <p>
 * Description: Classe Action per il dettaglio dell' Inserimento del provvedimento
 * </p>
 * <p>
 * di Annotazione della Decisione della Sorveglianza
 * </p>
 * <p>
...
public class ActDettaglioAnnotazioneDecisioneDellaSorveglianza extends ActSIESDettaglioProvvedimento
	...
	public String processRequest() throws F3BException {
		...
		if(vectFasIV.size() > 0 && Provvedimenti.isEmpty()){
			Provvedimenti = lPAMCtrl.ExRicercaProvvedimentoEventoByFascicoloSiep(fasSiefascCollegato);
		}
		// MEV_39 ***** fine ******
...
*/
		...
		while (Itx.hasNext()) {
			ProvvModel = (ProvvedimentoEventoTenoreFascicoloSiusModel) Itx.next();
			if (ProvvModel.getEvento().getIdEvento().equals(lEveMod.getEvento().getEveIdEvento())) {
				break;
			}
		}
        */
