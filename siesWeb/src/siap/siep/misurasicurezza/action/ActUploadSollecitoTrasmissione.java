...
public class ActUploadSollecitoTrasmissione extends ActionSiap implements ICostantiMisuraSicurezza
{
  public String processRequest() throws Exception
  {
    ...
    if(isRequestChecked( ICostantiEvento.CAMPO_VALIDA) )
    {
      ...
      lCtrlMisSic.ExUpdateValidaSollecitoEsito(lEveModel,lFascMod);
    }
    else
    {
