...
public class ActRicercaFascicoloPerSoggettoCodCui extends ActionSiapMinor implements ICostantiSoggetto {
...
//	}
	...
	private String standardRequest(boolean fromDetail) throws F3BException {
		...
		// String tipoRicerche = "";
		// tipoRicerche = getRequestStringParameter(tipoRicerche);
		...
		if (strAncheAlias != null) {
			...
			lReturnPage = ICostantiFascicoloSiep.PG_LOAD_RICERCAFASCICOLOSOGGETTI_SIEP_PER_SOGGETTO_COD_CUI;
		...
		String lAzione = "siap.siep.fascicolo.action.ActRicercaFascicoloPerSoggettoCodCui";
