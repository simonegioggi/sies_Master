...
/**
 * <p>Title: ActModificaFascicolo</p>
 * <p>Description: Azione di Modifica del Fascicolo</p>
...
public class ActModificaFascicolo extends ActionSiap implements ICostantiFascicoloSiep {
	...
	public void defaultProcessRequest() throws Exception {
		...
		// lFasMod.setDataArrivoSentenza( getRequestDateParameter( CAMPO_ANNO_ARRIVO_SENTENZA,CAMPO_MESE_ARRIVO_SENTENZA,CAMPO_GIORNO_ARRIVO_SENTENZA) );
		...
		// lFasMod.setDataArchiviazione( getRequestDateParameter( CAMPO_ANNO_ARCHIVIAZIONE,CAMPO_MESE_ARCHIVIAZIONE,CAMPO_GIORNO_ARCHIVIAZIONE) );
		...
		// lFasMod.setDataUnione( getRequestDateParameter( CAMPO_ANNO_UNIONE, CAMPO_MESE_UNIONE, CAMPO_GIORNO_UNIONE ) );
