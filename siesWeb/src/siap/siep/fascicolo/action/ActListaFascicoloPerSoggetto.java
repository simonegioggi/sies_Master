 ...
 * </p>
 */
public class ActListaFascicoloPerSoggetto extends ActionSiapMinor implements ICostantiFascicoloSiep {
	...
	public String processRequest() throws F3BException {
		...
		String campoDet = "";
		if (!this.isRequestParameterNullObj("campoDet")) {
			campoDet = this.getRequestStringParameter("campoDet");
		}
