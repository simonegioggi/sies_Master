	...
	private String setCondizione(SoggettoModel aSm) {
		...
		if (aSm.getIdSoggetto().doubleValue() == 0) {
			...
			if (   !(aSm.getCognome().equals(""))
				|| !(aSm.getNome().equals(""))
				|| !(aSm.getCodComuneNascita().equals(""))
				|| !(aSm.getPaternita().equals(""))
				|| !(aSm.getNomeMadre().equals(""))
				|| !(aSm.getCognomeMadre().equals(""))
				|| !(aSm.getCodStatoNascita().equals(""))
				|| aSm.getDataNascita() != null
			   ) 
			{
				isSoloCodAfis = false;
			}
