...
/**
 * MEV_2023-13: aggiunta classe DAO
 * Title: RateizzazionePPDAO
 * Description: Classe DAO che rappresenta la tabella RATEIZZAZIONE_PP
 *
 * @version 1.0
 */
public class RateizzazionePPDAO extends SIAPTableDAO {
	...
	// ============================================================================
	public BigDecimal getIdRateizzazionePP() throws DAOException {
		return getBigDecimal("ID_RATEIZZAZIONE_PP");
	}

	public BigDecimal getImportoDaPagare() throws DAOException {
		return getBigDecimal("IMPORTO_DA_PAGARE");
	}
	...
	public BigDecimal getNumeroRate() throws DAOException {
		return getBigDecimal("NUMERO_RATE");
	}
	...
	public BigDecimal getScadenzaGiorni() throws DAOException {
		return getBigDecimal("SCADENZA_GIORNI");
	}

	public BigDecimal getProgressivoRata() throws DAOException {
		return getBigDecimal("PROGRESSIVO_RATA");
	}
	...
	// ============================================================================
	public void setIdRateizzazionePP(BigDecimal aValore) {
		setBigDecimal("ID_RATEIZZAZIONE_PP", aValore);
	}

	public void setImportoDaPagare(BigDecimal aValore) {
		setBigDecimal("IMPORTO_DA_PAGARE", aValore);
	}
	...
	public void setNumeroRate(BigDecimal aValore) {
		setBigDecimal("NUMERO_RATE", aValore);
	}
	...
	public void setScadenzaGiorni(BigDecimal aValore) {
		setBigDecimal("SCADENZA_GIORNI", aValore);
	}

	public void setProgressivoRata(BigDecimal aValore) {
		setBigDecimal("PROGRESSIVO_RATA", aValore);
	}
