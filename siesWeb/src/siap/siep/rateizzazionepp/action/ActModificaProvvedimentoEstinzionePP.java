...
public class ActModificaProvvedimentoEstinzionePP extends ActionSiap implements ICostantiRateizzazionePP {
	...
	public String processRequest() throws Exception {
		...
		EventoNotificaModel enmRet = irpp.exModificaProvvedimentoEstinzionePP(enm, arrayIdRate, amm);
