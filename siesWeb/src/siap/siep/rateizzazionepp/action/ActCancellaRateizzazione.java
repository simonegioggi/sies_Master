...
public class ActCancellaRateizzazione extends ActionSiap 
    implements ICostantiRateizzazionePP 
{
    ...
    {        
        ...
        siesLogger.debug("Sono in cancellazione delle rateizzazioni per il fascicolo "+lFascMod.getIdFascicoloSiep());
        ...
        lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
                + "=siap.siep.penacomplessiva.action.ActLoadDettaglioPenaComplessiva&ChiaveFascicolo="+lFascMod.getIdFascicoloSiep();
        return lPage;
    }
}
