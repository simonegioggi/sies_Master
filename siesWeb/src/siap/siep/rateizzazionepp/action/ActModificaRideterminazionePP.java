...
public class ActModificaRideterminazionePP extends ActionSiap implements ICostantiRateizzazionePP {
	...
	public String processRequest() throws Exception {
		...
		EventoNotificaModel enmRet = irpp.exModificaRideterminazionePP(enm, arrayIdRate, amm);
