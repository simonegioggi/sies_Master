...
/**
 * Classe Action per l'inserimento della rideterminazione della pena pecuniaria
 *
 * @author sgioggi
 * @since MEV_2023-33
 * @version 1.0
...
public class ActInserisciRideterminazionePP extends ActionSiap implements ICostantiRateizzazionePP {
	...
	protected EventoModel getEventoRideterminazionePP(BigDecimal idFascicoloSiep) throws F3BException {
		...
		em.setCodMotivo("1307"); // Motivo Evento = 'Rideterminazione della Pena Pecuniaria
		...
		// info per il log
		siesLogger.info("getEventoRideterminazionePP(): fine");
	...
	protected NotificaModel[] getNotificheRideterminazionePP() throws F3BException {
		...
		// info per il log
		siesLogger.info("getNotificheRideterminazionePP(): fine");
