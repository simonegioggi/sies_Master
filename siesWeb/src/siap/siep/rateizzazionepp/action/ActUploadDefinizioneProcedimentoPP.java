...
/**
 * Classe per fare upload della Definizione Procedimento Pena Pecuniaria
 *
 * @author sgioggi
 * @since MEV_2023-33
 * @version 1.0
 */
public class ActUploadDefinizioneProcedimentoPP extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			irpp.exUpdateDefinizioneProcedimentoPP(em);
