...
/**
 * Classe per fare upload dell'Avviso Mancato Pagamento
 *
 * @author sgioggi
 * @since MEV_2023-33
 * @version 1.0
 */
public class ActUploadAvvisoMancatoPagamento extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			irpp.exUpdateAvvisoMancatoPagamento(em);
