...
* <p>Description: Classe Action per l'inserimento di Pena Accessoria</p>
...
public class ActInserisciPenaAccessoria extends ActionSiap implements ICostantiPenaAccessoria
{
  ...
  public String processRequest() throws Exception
 {
	...
	BigDecimal lIdFascicoloSiep = ((FascicoloSiepModel) getSessionAttribute("fascicolo")).getIdFascicoloSiep();
    ...
    return paginaDestinazione("siap.siep.cumulo.action.ActLoadDettaglioApplicazioneBenefici");
  ...
  protected PenaAccessoriaModel letturaDatiPenaAccesoria(BigDecimal aIdFascicoloSiep) throws Exception
  {
	    ...
	    if (isRequestParameterNullObj(CAMPO_COD_TIPO_PENA_ACCESSORIA_NUOVO) )
	      ...
	      mCodTipoPenaAccessoriaNuovo = getRequestStringParameter(CAMPO_COD_TIPO_PENA_ACCESSORIA_NUOVO).toUpperCase();
	    ...
	    lPenMod.setDataFineValidita( getRequestDateParameter( CAMPO_ANNO_DATA_FINEVALIDITA,CAMPO_MESE_DATA_FINEVALIDITA,CAMPO_GIORNO_DATA_FINEVALIDITA) );
	    ...
	    lPenMod.setDataOrdinanzaGE( getRequestDateParameter( CAMPO_ANNO_DATA_ORDINANZA_GE, CAMPO_MESE_DATA_ORDINANZA_GE, CAMPO_GIORNO_DATA_ORDINANZA_GE) );
	    ...
	    lPenMod.setDataOrdinanzaPA( getRequestDateParameter( CAMPO_ANNO_DATA_ORDINANZA_PA, CAMPO_MESE_DATA_ORDINANZA_PA, CAMPO_GIORNO_DATA_ORDINANZA_PA) );
	    ...
	    lPenMod.setDataSentenzaRevoca( getRequestDateParameter( CAMPO_ANNO_DATA_SENTENZA_REVOCA, CAMPO_MESE_DATA_SENTENZA_REVOCA, CAMPO_GIORNO_DATA_SENTENZA_REVOCA) );
   ...
   * @throws Exception
   */
  protected PenaAccessoriaModel letturaDatiPenaAccesoriaSostitutiva(BigDecimal aIdFascicoloSiep) throws Exception
  {
	  ...
	  if(mCodTipoPenaAccessoriaNuovo.compareTo("-")!=0 )
	  {
		  ...
		  lPenModNew.setDataOrdinanzaGE( getRequestDateParameter( CAMPO_ANNO_DATA_ORDINANZA_PA, CAMPO_MESE_DATA_ORDINANZA_PA, CAMPO_GIORNO_DATA_ORDINANZA_PA) );
		  ...
		  lPenModNew.setFasSieIdFascicoloSiep(((FascicoloSiepModel)getSessionAttribute("fascicolo")).getIdFascicoloSiep());
		  ...
		  if( !isRequestParameterNullObj(CAMPO_FLAG_CONDONATA) && getRequestStringParameter( CAMPO_FLAG_CONDONATA).compareTo("T")==0 )
		  {
		  ...
		  String lDescrComuneGE = getRequestStringParameter(CAMPO_COD_LUOGO_UFFICIO_ORDINANZA_PA).toUpperCase();
		  ...
		  if( !isRequestParameterNullObj(CAMPO_COD_TIPO_COMUNICAZIONE) && getRequestStringParameter( CAMPO_COD_TIPO_COMUNICAZIONE).compareTo("03")==0 )
		  {
			  lPenModNew.setDataOrdinanzaPA( getRequestDateParameter( CAMPO_ANNO_DATA_ORDINANZA_PA, CAMPO_MESE_DATA_ORDINANZA_PA, CAMPO_GIORNO_DATA_ORDINANZA_PA) );
  ...
  protected String paginaDestinazione( String aNomeAction)
  {
	  ...
	  if(mCodTipoPenaAccessoriaNuovo.compareTo("-")!=0 )
	  {
		  setRequestAttribute(IWebConstants.MESSAGE_TEXT, "Inserita Pena Accessoria Sostitutiva : Completare le modifiche necessarie.");
		  //Prepara la "pagina" di destinazione
