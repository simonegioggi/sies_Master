...
/**
 * Title: CumuloSqlDAO Description: Classe SqlDAO che rappresenta la tabella Cumulo
 *
 * @version 1.0
 */
public class CumuloSqlDAO extends SqlDAO {
	...
	/**
	 * Imposta la condizione di ricerca per cumuli <b>non validati</b> e per data inserimento ascendente (dal
	 * meno recente)
	 *
	 * @param aFascId
	 */
	...
	/**
	 * Affettua la ricerca dell'ultimo cumulo <b>VALIDATO</b> inserito prima della data specificata. Se non
	 * viene specificata una data in input viene ricercato l'ultimo cumulo in assoluto.???????????
	 *
	 * @param aIdFascicolo
	 * @param aDataIns
	 * @throws DAOException
	...
	public void ricercaUltimoCumuloByDataIns(BigDecimal aIdFascicolo, Date aDataIns) throws DAOException {
		...
		lSql += " AND FLAG_VALIDATO = 'S' ";
		lSql += " AND CUMULO.DATA_INSERIMENTO < to_date ('"
	...
	protected String getSqlQuery() {
		...
		lStatement += " SELECT " + " ID_CUMULO, " + " ID_FASCICOLO_SIEP_CUMULATO, "
				+ " CHIAVE_ANNO_FAS_CUMULATO, " + " CHIAVE_PROGR_FAS_CUMULATO, "
				+ " COD_TIPO_UFFICIO_FAS_CUMULATO, " + " COD_LUOGO_UFFICIO_FAS_CUMULATO, "
				+ " COD_UFFICIO_FAS_CUMULATO, " + " COD_TIPO_CUMULO, " + " DATA_RICHIESTA_FASCICOLO, "
				+ " DATA_PERVENIMENTO_FASCICOLO, " + " DATA_CUMULO, " + " COD_MOTIVO_SOSPENSIONE_CUMULO, "
				+ " DATA_SOSPENSIONE_CUMULO, " + " ISTR_ID_ISTRUTTORIA_CUMULO, "
				+ " CUMULO.NOTE NOTE_CUMULO, " + " CUMULO.COD_OPERATORE_INSERIMENTO OPERATORE_INSERIMENTO, "
				...
				+ " CUMULO.COD_UFFICIO_AGGIORNAMENTO UFFICIO_AGGIORNAMENTO, " + " FAS_SIE_ID_FASCICOLO_SIEP, "
