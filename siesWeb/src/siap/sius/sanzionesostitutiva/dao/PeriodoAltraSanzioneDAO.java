...
/**
 * <p>
 * Title: PeriodoAltraSanzioneDAO
 * </p>
 * <p>
 * Description: Classe DAO che rappresenta la tabella PeriodoAltraSanzione
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class PeriodoAltraSanzioneDAO extends TableDAO {
	 ...
	 *            connessione
	 ****************************************************************************/
	public PeriodoAltraSanzioneDAO(Connection con) {
		super(con);
		setTable("PERIODO_ALTRA_SANZIONE");

		// Settare la Sequence e i campi chiave e commentare il setField del campo chiave
		setSequenceField("ID_PERIODO_ALTRA_SANZIONE", "per_san_seq");

		// setField("ID_PERIODO_ALTRA_SANZIONE", BIG_DECIMAL);
	...
	// ============================================================================
	public BigDecimal getIdPeriodoAltraSanzione() throws DAOException {
		return getBigDecimal("ID_PERIODO_ALTRA_SANZIONE");
	}
	...
	// ============================================================================
	public void setIdPeriodoAltraSanzione(BigDecimal aValore) {
		setBigDecimal("ID_PERIODO_ALTRA_SANZIONE", aValore);
	}
	...
	public GenericModel getModel() throws DAOException {
		return new PeriodoAltraSanzioneModel(getIdPeriodoAltraSanzione(), getDataInizioEsecuzione(),
	 ...
	 * @throws DAOException
	 ****************************************************************************/
	public void setDAOFromModel(PeriodoAltraSanzioneModel aModel) throws DAOException {
		setIdPeriodoAltraSanzione(aModel.getIdPeriodoAltraSanzione());
	...
	public void setDAOFromModelforUpdate(PeriodoAltraSanzioneModel aModel) throws DAOException {
		setDataInizioEsecuzione(aModel.getDataInizioEsecuzione());
		setDataScadenza(aModel.getDataScadenza());
		setIstDetIdIstitutoDetenzione(aModel.getIstDetIdIstitutoDetenzione());
		setMotivazione(aModel.getMotivazione());
		...
		setCondizioneUpdate(aModel.getIdPeriodoAltraSanzione());
	}

	public void setCondizioneUpdate(BigDecimal key) {
		setCondition(" ID_PERIODO_ALTRA_SANZIONE = " + key);
	}
	 ...
	 * @return
	 ****************************************************************************/
	public void setCondizioni(PeriodoAltraSanzioneModel aModel) {
	 ...
	 * @param key
	 ****************************************************************************/
	public void selCondizioneUpdate(BigDecimal aIdPeriodoAltraSanzione) {
		String lCondizioni = new String();
