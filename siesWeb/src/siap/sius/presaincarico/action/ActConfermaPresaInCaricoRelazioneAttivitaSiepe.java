...
public class ActConfermaPresaInCaricoRelazioneAttivitaSiepe extends ActionSiap implements ICostantiJMS {
	...
	public String processRequest() throws Exception {
		...
		lMessage.setCodTipoOperazione(ESITO_TRASFERIMENTO_RELAZIONE_ATTIVITA);
		lMessage.setCodiceUtenteMittente(this.getCodUtenteConnesso());
		...
		lRedirigi.setAction("siap.sius.presaincarico.action.ActDettaglioRelazioneDiAttivitaRicevuta");
		lRedirigi.setParameter(ICostantiPresaincarico.CAMPO_ID_MESSAGGIO, lIdMess.toString());
		String lMessageOut = "";
		setRequestAttribute(IWebConstants.GOTO_PAGE, "" + lRedirigi);
		lMessageOut += " Ricezione Relazione di Attività completata e esito rispedito al Mittente.";
