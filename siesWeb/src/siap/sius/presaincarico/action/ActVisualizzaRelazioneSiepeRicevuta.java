...
/**
 * <p>Title: ActVisualizzaRelazioneSiepeRicevuta</p>
...
{
  /**
   * Azione di Visualizzazione della Rrlazione SIEPE Ricevuta
   * afferente ad una richiesta o attività
   * <p>
  ...
  public String processRequest() throws Exception
   {
     ...
     if(lRelazioneRicevuta.getDocPerTrasferimento()!=null && lRelazioneRicevuta.getDocPerTrasferimento().length >1)
