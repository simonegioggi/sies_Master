...
public class ActConfermaPresaInCaricoRelazioneRichiestaSiepe extends ActionSiap implements ICostantiJMS {
	...
	public String processRequest() throws Exception {
		...
		lMessage.setCodTipoOperazione(ESITO_TRASFERIMENTO_RELAZIONE_RICHIESTA_UEPE);
		lMessage.setCodiceUtenteMittente(this.getCodUtenteConnesso());
		...
		lRedirigi.setAction("siap.sius.presaincarico.action.ActDettaglioRelazioneRichiestaSiepeRicevuta");
		lRedirigi.setParameter(ICostantiPresaincarico.CAMPO_ID_MESSAGGIO, lIdMess.toString());
		String lMessageOut = "";
		setRequestAttribute(IWebConstants.GOTO_PAGE, "" + lRedirigi);
		lMessageOut += " Ricezione della Relazione di Richiesta UEPE completata e l'esito è stato rispedito al Mittente.";
