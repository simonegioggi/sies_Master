...
public class ActDettaglioDecretoRicevuto extends ActionSiap implements ICostantiPresaincarico {

	public String processRequest() throws Exception {

		// Controllo che non si stia lavorando su una entità in modifica ad altri
		LockModel lck = lockIfNotLocked("caricodecreto",
		...
		if (lck != null) {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT,
					"La presa in carico di questo Decreto è in gestione ad un altro utente! <BR>Riprovare più tardi!");
		...
		// Questa classe controlla la presenza (Parsing) dei dati nella tabella MESSAGGIO.
		...
		return PG_DETTAGLIO_DECRETO_RICEVUTO;
	}
