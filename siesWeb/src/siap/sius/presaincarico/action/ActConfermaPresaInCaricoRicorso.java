...
public class ActConfermaPresaInCaricoRicorso extends ActionSiap implements ICostantiJMS
{
  public String processRequest() throws Exception
  {
    ...
    MessaggioModel lMessReturn  = lPres.ExPresaInCaricoRicorso(lMessIns, lMisAlt);
    ...
    lMessage.setCodTipoOperazione(ESITO_TRASFERIMENTO_RICORSO);
    lMessage.setCodiceUtenteMittente(this.getCodUtenteConnesso());
    ...
    SoggettoModel lSoggettoInviato = lPars.getFascicoloGPSius().getFascicoloSiusModel().getSoggetto();
       ...
       lFasSiusInviato  != null )
    {
      ...
      lMessageOut += " Ricezione Ricorso Completata e Esito rispedito al Mittente. \n";
      lMessageOut += " Iscrivere il procedimento Sius!";
    }
    else
    {
      lMessageOut += " Ricezione Ricorso Priva di Procedimento di sorveglianza. \n";
