...
public class ActConfermaPresaInCaricoDecreto extends ActionSiap implements ICostantiJMS
{
  public String processRequest() throws Exception
  {
       ...
       lFasSiusInviato  != null )
    {
      ...
      lMessageOut += " Ricezione Decreto Completata e Esito rispedito al Mittente. \n";
      lMessageOut += " Iscrivere il procedimento Sius!";
    }
    else
    {
      lMessageOut += " Ricezione Decreto Priva di Procedimento di sorveglianza. \n";
