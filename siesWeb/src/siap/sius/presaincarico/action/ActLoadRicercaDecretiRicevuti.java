...
public class ActLoadRicercaDecretiRicevuti extends ActionSiap implements ICostantiPresaincarico
{
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("function_name", "Ricerca Decreti Ricevuti");
    setRequestAttribute("action_name", "siap.sius.presaincarico.action.ActRicercaProvvedimentiRicevuti");
    setRequestAttribute("tipo_provvedimento", ICostantiJMS.TRASFERIMENTO_DECRETO);
