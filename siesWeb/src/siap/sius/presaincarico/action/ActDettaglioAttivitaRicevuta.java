...
/**
 * <p>
 * Title: ActDettaglioAttivitaRicevuta
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * @version 1.0
 */
public class ActDettaglioAttivitaRicevuta extends ActionSiap implements ICostantiPresaincarico {
	...
	public String processRequest() throws Exception {
		...
		if (lck != null) {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT,
					"La presa in carico di questa Attività è in gestione ad un altro utente! <BR>Riprovare più tardi!");
