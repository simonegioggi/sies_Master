...
public class ActInserisciDecretoIrreperibilità extends ActionSius implements ICostantiDepositoDecreto {
	...
	public String processRequest() throws Exception {
		...
		// STUB 20/04/2004 lGPTenoreModel.setTenori( this.parseOggettiTenori( lCodOggetti, lDescOggetti,
		// lCodMagistrato ) );
		...
		lGPTenoreModel.setTenori(this.parseOggettiTenori(lCodOggetti, lDescOggetti, lCodMagistrato));
		...
		lDepDecrModel.setCodTipoDecreto("02");
		...
		lDepDecrEveModel = lDepDecrCtrl.ExInserisciDecretoIrreperibilità(lGPTenoreModel, lDepDecrEveModel);
		...
		// setRequestAttribute( "depositoDecretoMotivazioni",lMotMod );
		// setRequestAttribute( "tenori", (Vector) lGPTenoreModel.getTenori() );

		// STUB 05/12/2003 effettuo la ricerca sul deposito decreto
		...
		setRequestAttribute("idEvento", lDepDecrEveModel.getEvento().getIdEvento());
