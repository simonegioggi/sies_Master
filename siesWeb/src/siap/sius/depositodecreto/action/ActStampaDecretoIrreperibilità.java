...
public class ActStampaDecretoIrreperibilità extends ActionSiap
implements ICostantiDepositoDecreto
{
	/**
  * Azione di Stampa dell'decreto d'irreperibilità.
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    lEveMod.setNomeTemplate(TEMPLATE_DECRETO_IRREPERIBILITA);
    lEveMod.getEvento().setTemIdTemplate(TEMPLATE_DECRETO_IRREPERIBILITA);
