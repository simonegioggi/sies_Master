...
public class ActStampaDecretoIncompetenza extends ActionSiap
implements ICostantiDepositoDecreto
{
	/**
  * Azione di Stampa dell'decreto d'incompetenza.
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    lEveMod.setNomeTemplate(TEMPLATE_DECRETO_INCOMPETENZA);
    //lEveMod.getEvento().setTemIdTemplate(TEMPLATE_DECRETO_INCOMPETENZA);
    lEveMod.getEvento().setTemIdTemplate(getRequestStringParameter(ICostantiTemplate.CAMPO_ID_TEMPLATE));
