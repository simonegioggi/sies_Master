 ...
 * @author Gioggi
 */
public class ActStampaConfermaDecisioneMagistratoRelatore extends ActionSiap implements ICostantiDepositoDecreto {
	...
	public String processRequest() throws Exception {
		...
		enm.getEvento().setTemIdTemplate(TEMPLATE_DECRETO_CONFERMA_DECISIONE_MAGISTRATO_RELATORE);
		enm.setNomeTemplate(TEMPLATE_DECRETO_CONFERMA_DECISIONE_MAGISTRATO_RELATORE);
