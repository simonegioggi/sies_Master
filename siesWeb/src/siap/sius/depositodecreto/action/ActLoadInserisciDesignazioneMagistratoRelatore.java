 ...
 * @author Gioggi
 */
public class ActLoadInserisciDesignazioneMagistratoRelatore extends ActRicercaFSPuntuale
	...
	public String processRequest() throws Exception {
		...
		String retPage = ICostantiDepositoDecreto.PG_LOAD_INSERISCI_DESIGNAZIONE_MAGISTRATO_RELATORE;
		...
		if (idd.ExVerificaEsistenzaDepositoDecretoByIdGenProcCodTipoDec(idGP,
			...
			if (rpu.verificaEsistenzaProv() && "0271".equals(codEsito))
