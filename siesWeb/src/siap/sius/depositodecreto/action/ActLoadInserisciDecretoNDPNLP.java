...
/**
 * <p>
 * Title: ActLoadInserisciDecretoNDPNLP
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di ActLoadInserisciDecretoNDPNLP
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadInserisciDecretoNDPNLP extends ActRicercaFSPuntuale implements ICostantiDepositoDecreto {
	...
	public String processRequest() throws Exception {
		...
		String lRetPage = ICostantiDepositoDecreto.PG_LOAD_INSERISCI_DECRETO_NDP_NLP;
		...
		// Verifica esistenza di un deposito decreto per il fasciclo sius selezionato e
		// tipo decreto.
		if (lDepDecrCtrl.ExVerificaEsistenzaDepositoDecretoByIdGenProcCodTipoDec(lIdGenProc, NDP_NLP)) {
			...
			lPage.setAction("siap.sius.depositodecreto.action.ActLoadDettaglioDecretoNDPNLP");
