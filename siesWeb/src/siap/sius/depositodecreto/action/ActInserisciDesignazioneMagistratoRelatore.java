...
public class ActInserisciDesignazioneMagistratoRelatore extends ActionSius
		implements ICostantiDepositoDecreto {

	/**
	 * MEV_2019-09: aggiunta action di inserimento dati
	 *
	 * @author Gioggi
	 */
	...
	public String processRequest() throws Exception {
		...
		// TenoreModel[] tmArray = parseOggettiTenori(codOggetti, descOggetti, codDettaglioOggetti, "0610",
		// codMagistrato);
