...
/**
* <p>Title: DepositoDecretoDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella DepositoDecreto</p>
...
public class DepositoDecretoDAO extends SIAPTableDAO
{
  ...
  * <p>
  * @param aConn connessione come parametro.
  */
...
//DL 92 2014 Violazione CEDU 
  ...
  // METODI GET()
  //
  public BigDecimal 		 getIdDepositoDecreto()           throws DAOException	 { return getBigDecimal("ID_DEPOSITO_DECRETO"); }
  public BigDecimal 		 getAnnoS72() 		                throws DAOException	 { return getBigDecimal("ANNO_S72"); }
  public BigDecimal 		 getNumS72() 		                  throws DAOException	 { return getBigDecimal("NUM_S72"); }
  public String 				 getCodTipoDecreto() 		          throws DAOException	 { return getString("COD_TIPO_DECRETO"); }
...
// nuovi campi Luigi 27-01-2004
  public String 				 getCodTdsComp() 		throws DAOException	 { return getString("COD_TDS_COMP"); }
  public String 				 getIstDetIdIstitutoDetenzione() 		throws DAOException	 { return getString("IST_DET_ID_ISTITUTO_DETENZIONE"); }
  public String 				 getStatusPersona() 		throws DAOException	 { return getString("STATUS_PERSONA"); }
  public String 				 getTotOreRaggiungimento() 		throws DAOException	 { return getString("TOT_ORE_RAGGIUNGIMENTO"); }
  public String 				 getAnnoProcRevocato() 		throws DAOException	 { return getString("ANNO_PROC_REVOCATO"); }
  public String 				 getProgrProcRevocato() 		throws DAOException	 { return getString("PROGR_PROC_REVOCATO"); }
  public String 				 getUfficioProcRevocato() 		throws DAOException	 { return getString("UFFICIO_PROC_REVOCATO"); }
...
// 07/2014
  public BigDecimal		getNumeroGiorniRevocaLA()	throws DAOException	{return getBigDecimal("NUM_GIORNI_REVOCA_LA");}
//DL 92 2014 Violazione CEDU 
  public BigDecimal		getNumeroGiorniRiduzionePena()	throws DAOException	{return getBigDecimal("NUM_GIORNI_RIDUZIONE_PENA");}
  public BigDecimal		getSommaRisarcimentoDanni()		throws DAOException	{return getBigDecimal("SOMMA_RISARC_DANNI");}
  ...
  // METODI SET()
  //
  public void  	 setIdDepositoDecreto(BigDecimal aValore ) 	    { setBigDecimal("ID_DEPOSITO_DECRETO", aValore); }
  public void  	 setAnnoS72(BigDecimal aValore ) 			          { setBigDecimal("ANNO_S72", aValore); }
  public void  	 setNumS72(BigDecimal aValore ) 			          { setBigDecimal("NUM_S72", aValore); }
  public void  	 setCodTipoDecreto(String aValore ) 			      { setString("COD_TIPO_DECRETO", aValore); }
  ...
  public void  	 setAltriDestinatari(String aValore ) 			    { setString("ALTRI_DESTINATARI", aValore); }
  public void  	 setDataParerePg(Date aValore ) 			          { setDate("DATA_PARERE_PG", aValore); }
  public void  	 setCodTipoParerePg(String aValore ) 			      { setString("COD_TIPO_PARERE_PG", aValore); }
  public void  	 setDataRicorsoImpugnazione(Date aValore ) 		  { setDate("DATA_RICORSO_IMPUGNAZIONE", aValore); }
  public void  	 setDataInvioAttiImpugnazione(Date aValore )    { setDate("DATA_INVIO_ATTI_IMPUGNAZIONE", aValore); }
  public void  	 setDataSentenzaImpugnazione(Date aValore ) 		{ setDate("DATA_SENTENZA_IMPUGNAZIONE", aValore); }
  public void  	 setTenoreSentenzaImpugnazione(String aValore ) { setString("TENORE_SENTENZA_IMPUGNAZIONE", aValore); }
  ...
  public void  	 setSentenzeRiferimento(String aValore ) 			       { setString("SENTENZE_RIFERIMENTO", aValore); }
  public void  	 setIdEventoGenerato(BigDecimal aValore )       { setBigDecimal("ID_EVENTO_GENERATO", aValore); }
  // nuovi campi Luigi 17-11-2003
  public void  	 setCodUfficioComp(String aValore ) 			          { setString("COD_UFFICIO_COMP", aValore); }
  public void  	 setCodProcuraEsecuzione(String aValore ) 			    { setString("COD_PROCURA_ESECUZIONE", aValore); }
  public void  	 setLuogoSvolgimentoProva(String aValore ) 			    { setString("LUOGO_SVOLGIMENTO_PROVA", aValore); }
// nuovi campi Luigi 27-01-2004
  public void  	 setCodTdsComp(String aValore ) 			 { setString("COD_TDS_COMP", aValore); }
  public void  	 setIstDetIdIstitutoDetenzione(String aValore ) 			 { setString("IST_DET_ID_ISTITUTO_DETENZIONE", aValore); }
  public void  	 setStatusPersona(String aValore ) 			 { setString("STATUS_PERSONA", aValore); }
  public void  	 setTotOreRaggiungimento(String aValore ) 			 { setString("TOT_ORE_RAGGIUNGIMENTO", aValore); }
  public void  	 setAnnoProcRevocato(String aValore ) 			 { setString("ANNO_PROC_REVOCATO", aValore); }
  public void  	 setProgrProcRevocato(String aValore ) 			 { setString("PROGR_PROC_REVOCATO", aValore); }
  public void  	 setUfficioProcRevocato(String aValore ) 			 { setString("UFFICIO_PROC_REVOCATO", aValore); }
...
//07/2014
  public void	setNumeroGiorniRevocaLA(BigDecimal aValore)		{setBigDecimal("NUM_GIORNI_REVOCA_LA", aValore); }
//DL 92 2014 Violazione CEDU 
  public void	setNumeroGiorniRiduzionePena(BigDecimal aValore)	{setBigDecimal("NUM_GIORNI_RIDUZIONE_PENA", aValore); }
  public void	setSommaRisarcimentoDanni(BigDecimal aValore)		{setBigDecimal("SOMMA_RISARC_DANNI", aValore); }
  ...
  */
  ...
  {
    return new DepositoDecretoModel(
              ...
              getStatusPersona() ,
              getTotOreRaggiungimento() ,
              getAnnoProcRevocato() ,
              getProgrProcRevocato() ,
              getUfficioProcRevocato(),
              "" ,
			  ...
			  "" ,
			  getNumeroGiorniRevocaLA(),
			  //DL 92 2014 Violazione CEDU
			  getNumeroGiorniRiduzionePena(),
			  getSommaRisarcimentoDanni(),
			  // 02/2015 Mis.Sic.
			  getFlagElaborato()
            );
  }
...
//DL 92 2014 Violazione CEDU 
  ...
  /**
  * Imposta il DAO con i dati del model passato come argomento, per
  * la fase di update.
  * <p>
  * @param aModel model dei dati da impostare nel DAO.
  * @throws DAOException propaga errore di eccezione.
...
//DL 92 2014 Violazione CEDU 
  ...
  */
   ...
   * del model DepositoDecretoModel passato.
   * @param aModel
   */
