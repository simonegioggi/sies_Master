...
/**
 * <p>Title: FascicoloSiusSqlDAO</p>
 * <p>Description: Classe SqlDAO che rappresenta la tabella FascicoloSius</p>
...
public class FascicoloGPSqlDAO extends SIAPSqlDAO {
	...
	protected String getFascicoloSqlQuery() {
		...
		lStatement += " FASC.FAS_SIE_ID_FASCICOLO_SIEP, FASC.FAS_SIU_ID_FASCICOLO_SIUS, FASC.ID_FASCICOLO_SIUS_ORIGINE, FASC.SOG_ID_SOGGETTO, FASC.DATA_DEFINIZIONE, FASC.NUMERO_FASCICOLI_UNIFICATI, ";
		...
		lStatement += " FASIEP.CHIAVE_ANNO CHIAVE_ANNO_SIEP, FASIEP.CHIAVE_PROGR CHIAVE_PROGR_SIEP, FASIEP.CHIAVE_UFFICIO CHIAVE_UFFICIO_SIEP ";
		lStatement += " ,DESCR_TIPO_UFF.RV_LOW_VALUE COD_TIPO_UFFICIO, ";
		lStatement += " FASC.CERTIFICATO_PENALE, FASC.VISIBILITA_EX_MINORENNE, "; // MEV10-s3: aggiunto
																					// recupero nuovo campo in
																					// tabella
		...
		lStatement += " CG_REF_CODES POS_GIURIDICA, UFFICIO UFF, COMUNE DESCR_COM_UFF, COMUNE DESCR_COM_MIT, FASCICOLO_SIEP FASIEP  ";
