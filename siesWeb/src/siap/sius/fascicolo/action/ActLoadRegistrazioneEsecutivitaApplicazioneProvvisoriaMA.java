...
public class ActLoadRegistrazioneEsecutivitaApplicazioneProvvisoriaMA extends ActionSius
	...
	public String processRequest() throws Exception {
		...
		if (fgpm.getTenori() == null || fgpm.getTenori().length == 0) {
			throw new SIUSException(SIUSException.USER_MESSAGE,
					"Esecutivita' Ordinanza Applicazione M.A. DL 123/2018 non consentita con campo Oggetto vuoto!");
		}
	 ...
	 * la Esecutivita' Ordinanza Applicazione M.A. DL 123/2018 del procedimento.
	 *
	 * @param fgpm
