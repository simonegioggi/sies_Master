...
/**
 * ActInsFascicoloDaSoggettoUDSManuale - Classe Azione di inserimento del Fascicolo SIUS da Soggetto
 */
public class ActInsFascicoloDaSoggettoUDSManuale extends ActionSiap implements ICostantiFascicoloSius {
	...
	public String processRequest() throws Exception {
		...
		// Anno impostato nella form
		lFasGPMod.getFascicoloSiusModel().setChiaveAnno(getRequestBigDecimalParameter(CAMPO_CHIAVE_ANNO));
		// Progressivo impostato nella form
		lFasGPMod.getFascicoloSiusModel().setChiaveProgr(getRequestBigDecimalParameter(CAMPO_CHIAVE_PROGR));
