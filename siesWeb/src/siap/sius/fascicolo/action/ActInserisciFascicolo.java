 ...
 * <p>Description: Classe Azione di inserimento del Fascicolo SIUS
 * </p>
...
public class ActInserisciFascicolo extends ActionSiap implements ICostantiFascicoloSius
{
  public String processRequest() throws Exception
  {
    ...
    lFasGPMod.getFascicoloSiusModel().setSoggetto(lFasSiepMod.getSoggetto());    //Soggetto recuperato dal Fascicolo SIEP in sessione
    ...
    if ((getRequestStringParameter(CAMPO_DESCR_SEDE_MITTENTE)).equalsIgnoreCase(""))
      lFasGPMod.getGeneraleProcedimentoModel().setCodSedeMittente(super.getCodComuneByDescr("-").getCodComune()) ;
    else
    ...
    lFasGPMod.getGeneraleProcedimentoModel().setCodUfficioInserimento(lUtenteMod.getUfficioUtente().getCodUfficio()); //Codice dell'ufficio dell'operatore che inserisce
