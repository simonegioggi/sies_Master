...
/**
 * ActInserisciFascicoloUDSManuale - Classe Azione di inserimento del Fascicolo SIUS per UDS
 *
 * @version 1.0
 */
public class ActInserisciFascicoloUDSManuale extends ActionSiap implements ICostantiFascicoloSius {
	...
	public String processRequest() throws Exception {
		...
		if (getRequestBigDecimalParameter(CAMPO_CHIAVE_ANNO_S22) != null
			...
			// String lCodContenuto = ((getRequestStringParameter(CAMPO_COD_TIPO_REGISTRO).compareTo("S22") ==
			// 0) ? "U004"
			// : "U019");
