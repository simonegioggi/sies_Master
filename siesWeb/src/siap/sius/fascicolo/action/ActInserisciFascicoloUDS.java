...
/**
 * <p>Title: ActInserisciFascicoloUDS</p>
	...
	public String processRequest() throws Exception {
		...
		if ((getRequestBigDecimalParameter(CAMPO_CHIAVE_ANNO_S22) != null)
			...
			String lCodContenuto = ((getRequestStringParameter(CAMPO_COD_TIPO_REGISTRO).compareTo("S22") == 0) ? "U004"
					: "U019");
			if (getRequestStringParameter(CAMPO_COD_TIPO_REGISTRO).compareTo("S09") == 0)
				lCodContenuto = "U024";
			...
			if (getRequestStringParameter(CAMPO_DESCR_SEDE_MITTENTE) != "") {
				aCodUfficioMittente = getCodUfficioByCodTipoUfficioDescrComune(
						DecodificheUtils.getCodebyDesc(DecodificheManager.getInstance().getTipoUfficio(),
								aDescrUfficioMittente), getRequestStringParameter(CAMPO_DESCR_SEDE_MITTENTE));
			}
