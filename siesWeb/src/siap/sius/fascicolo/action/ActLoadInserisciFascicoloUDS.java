...
public class ActLoadInserisciFascicoloUDS extends ActionSiap implements ICostantiFascicoloSius {
	...
	public String processRequest() throws Exception {
		...
		// MERGE v10 COLLAUDO: modifica estrazione contenuti
		...
		// STUB 28/04/2007 Differenziato filtro sui contenuti per "S09"
		if (idFascicoloSius != null && idFascicoloSius.length() > 1 && lFasGPMod
		...
		// 5/7/2006 - Modifica per evitare di sporcare le combo della posizione giuridica
		...
		// Attenzione: se il luogo detenzione e' per la causa attuale, viene valorizzato idLuogoDetenzione;
		// se il luogo detenzione e' per altra causa, viene valorizzato idAltraCausa.
		...
		// Impostazione della modalita' - IU = Inserimento Fascicolo per UDS.
