 ...
 * @version 1.0
 */
public class ActRicercaSoggettiConProcDiEsecuzione extends ActionSiusMinor implements ICostantiFascicoloSius {
...
//				(UtenteModel) getSessionAttribute(ICostantiSecurity.SESSION_UTENTE_CONNESSO));
		...
		lReturnPage = ICostantiFascicoloSius.PG_RICERCA_SOGGETTICONPROCDIESECUZIONE;
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
