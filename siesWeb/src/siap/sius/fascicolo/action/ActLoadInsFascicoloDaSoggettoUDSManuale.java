...
public class ActLoadInsFascicoloDaSoggettoUDSManuale extends ActionSiap implements ICostantiFascicoloSius {

	@SuppressWarnings("rawtypes")
	public String processRequest() throws Exception {

		// Gestione Iscrizione Procedimento di esecuzione da soggetto.
		...
		FascicoloGPModel lFasGPMod = new FascicoloGPModel(); // 01/08/2007
		...
		// Se si deve iscrivere un procedimento normale o di EMA padre, punto a
		...
		if (idFascicoloSius != null && idFascicoloSius.length() > 1) {
			...
			return PG_LOAD_INSERISCIFASCICOLODASOGGETTOUDSMANUALE;
	}
