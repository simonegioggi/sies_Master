 ...
 * @version 1.0
 */
public class ActRicercaSoggettiConProcDiEsecuzioneMS extends ActionSiusMinor implements
	...
	public String processRequest() throws Exception {
		...
		lReturnPage = ICostantiFascicoloSius.PG_RICERCA_SOGGETTICONPROCDIESECUZIONEMS;
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
