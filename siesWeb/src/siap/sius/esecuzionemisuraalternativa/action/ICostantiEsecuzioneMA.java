...
/**
* <p>Title: ICostantiEsecuzioneMA</p>
* <p>Description: Classe di costanti di Esecuzione Misure Alternative</p>
...
public interface ICostantiEsecuzioneMA
{
  ...
  public static final String PG_BUTTONS_EMA = IWebConstants.ROOT_DIR + "files/siap/sius/esecuzionemisuraalternativa/buttonsEMA.jsp";
  public static final String PG_LOAD_RICERCA_ESECUZIONE_MA = IWebConstants.ROOT_DIR + "files/siap/sius/esecuzionemisuraalternativa/LoadRicercaEsecuzioneMA.jsp";
  public static final String PG_RICERCA_ESECUZIONE_MA = IWebConstants.ROOT_DIR + "files/siap/sius/esecuzionemisuraalternativa/RicercaEsecuzioneMA.jsp";
  public static final String PG_DETTAGLIO_ESECUZIONE_MA = IWebConstants.ROOT_DIR + "files/siap/sius/esecuzionemisuraalternativa/DettaglioEsecuzioneMA.jsp";
  public static final String PG_LOAD_MODIFICA_ESECUZIONE_MA = IWebConstants.ROOT_DIR + "files/siap/sius/esecuzionemisuraalternativa/LoadModificaEsecuzioneMA.jsp";
}