...
/**
 * ICostantiEsecuzioneMA - Classe di costanti di Esecuzione Misure Alternative
 *
 * @version 1.0
 */
public interface ICostantiEsecuzioneMA {

	public static final String CAMPO_ID_ESECUZIONE_MA = "IdEsecuzioneMA";
	...
	public static final String PG_BUTTONS_EMA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/buttonsEMA.jsp";
	public static final String PG_LOAD_RICERCA_ESECUZIONE_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/LoadRicercaEsecuzioneMA.jsp";
	public static final String PG_RICERCA_ESECUZIONE_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/RicercaEsecuzioneMA.jsp";
	public static final String PG_DETTAGLIO_ESECUZIONE_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/DettaglioEsecuzioneMA.jsp";
	public static final String PG_LOAD_MODIFICA_ESECUZIONE_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/LoadModificaEsecuzioneMA.jsp";

	// MEV_2025-48: aggiunte pagine per Scadenzario monitoraggio misure alternative espiate
	public static final String PG_LOAD_RICERCA_DATA_SCADENZA_PROCEDIMENTI_ESECUZIONE_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/LoadRicercaDataScadenzaProcedimentiEsecuzioneMA.jsp";
	public static final String PG_RICERCA_DATA_SCADENZA_PROC_ESEC_MA = IWebConstants.ROOT_DIR
			+ "files/siap/sius/esecuzionemisuraalternativa/RicercaDataScadenzaProcEsecMA.jsp";
