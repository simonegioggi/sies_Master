...
/**
 * <p>
 * Title: EsecuzioneMisuraAlternativaSqlDAO
 * </p>
 * <p>
 * Description: Classe SqlDAO che rappresenta la tabella EsecuzioneMisuraAlternativa
 * </p>
 * <p>
...
public class EsecuzioneMisuraAlternativaSqlDAO extends SIAPSqlDAO {
	...
	protected String getSqlQuery() {
		...
		lStatement += " LEFT OUTER JOIN CG_REF_CODES DESCR_TIPO_MISURA ON (EMA.COD_TIPO_MISURA=DESCR_TIPO_MISURA.RV_LOW_VALUE AND DESCR_TIPO_MISURA.RV_DOMAIN = 'MOTIVO_PROVVEDIMENTO')";
	...
	protected String getEsecuzioneMisuraAlternativa() {
		...
		lStatement += "SELECT EMA.ID_ESECUZIONE_MISURA_ALTERNATI, EMA.ANNO_S07, EMA.PROGR_S07, EMA.DATA_ORDINANZA, EMA.COD_AUTORITA_EMITT_ORD, UFFICIO_AUT.COD_TIPO_UFFICIO COD_TIPO_AUTORITA_EMITT_ORD,";
		...
		lStatement += " EMA.COD_TIPO_AUTORITA_EMITT_ORD, EMA.COD_LUOGO_AUTORITA_EMITT_ORD, EMA.COD_TIPO_MISURA, EMA.DATA_INIZIO_MISURA, EMA.DATA_TERMINE_INIZIALE,";
		lStatement += " EMA.DATA_TERMINE_ATTUALE, EMA.DATA_DECLARATORIA_EP, EMA.DATA_TX_ATTI_EST_PENA, EMA.DEP_DEC_ID_DEPOSITO_DECRETO, EMA.DEP_OPID_DEPOSITO_ORDINANZA_PC,";
		lStatement += " EMA.NOTE, EMA.COD_OPERATORE_INSERIMENTO, EMA.DATA_INSERIMENTO, EMA.COD_UFFICIO_INSERIMENTO, EMA.COD_OPERATORE_AGGIORNAMENTO,";
		lStatement += " EMA.DATA_AGGIORNAMENTO, EMA.COD_UFFICIO_AGGIORNAMENTO, EMA.GEN_PRID_GENERALE_PROCEDIMENTO, DESCR_MISURA_ALTERNATIVA.RV_MEANING DESCR_MISURA_ALTERNATIVA,";
		...
		lStatement += " GP.ANNO_S1 ANNO_S1, GP.PROGR_S1 PROGR_S1, NVL(EMA.LUOGO_ESECUZIONE_MISURA, '') LUOGO_ESECUZIONE_MISURA, FASC.ID_FASCICOLO_SIUS_ORIGINE ID_FASCICOLO_SIUS_ORIGINE ";
	...
	protected String getDettaglioEsecuzioneMA(BigDecimal aEseMAKey, String lUfficioUtenteConnesso) {
		...
		lStatement += " NVL(EMA.LUOGO_ESECUZIONE_MISURA, '') LUOGO_ESECUZIONE_MISURA, FASC.ID_FASCICOLO_SIUS_ORIGINE ID_FASCICOLO_SIUS_ORIGINE ";
		lStatement += "FROM ESECUZIONE_MISURA_ALTERNATIVA EMA, FASCICOLO_SIUS FASC, SOGGETTO  SOGG, GENERALE_PROCEDIMENTO GP, CG_REF_CODES DESCR_OGGETTO_PROCEDIMENTO,";
	...
	protected String getFascicoliConProvvedimentiDellaMisura(BigDecimal aEseMAKey,
		...
		lStatement += " GP.COD_OGGETTO_PROCEDIMENTO COD_OGGETTO_PROCEDIMENTO, GP.DATA_CAMERA_CONSIGLIO DATA_CAMERA_CONSIGLIO, NVL(GP.COD_AUTORITA_DELEGATA, '-') COD_AUTORITA_DELEGATA, NVL(GP.DESCR_MITTENTE, '-') DESCR_MITTENTE, DESCR_MISURA_ALTERNATIVA.RV_MEANING DESCR_MISURA_ALTERNATIVA, ";
		...
		lStatement += " FROM ESECUZIONE_MISURA_ALTERNATIVA EMA, GENERALE_PROCEDIMENTO GP_PADRE, GENERALE_PROCEDIMENTO GP, FASCICOLO_SIUS FASC_PADRE, FASCICOLO_SIUS FASC, SOGGETTO  SOGG, CG_REF_CODES DESCR_TIPO_PROCEDIMENTO, ";
		lStatement += " UFFICIO UFF, COMUNE DESCR_COM_UFF, COMUNE DESCR_COM_NASCITA, EVENTO EV,CG_REF_CODES DESCR_ESITO_PROVVEDIMENTO, ";
		lStatement += " CG_REF_CODES DESCR_MOTIVO_PROVVEDIMENTO, CG_REF_CODES DESCR_COD_PROCEDIMENTO, CG_REF_CODES DESCR_MISURA_ALTERNATIVA, DEPOSITO_DECRETO DD ";
		...
		lStatement += " AND FASC_FIGLIO.ID_FASCICOLO_SIUS_ORIGINE(+) = FASC.ID_FASCICOLO_SIUS"; // STUB
																								// 26/10/2005
																								// Rework EMA.
		return lStatement;
	}
	...
	protected String getFascicoliSenzaProvvedimentiDellaMisura(BigDecimal aEseMAKey,
		...
		lStatement += " NVL(GP.COD_AUTORITA_DELEGATA, '-') COD_AUTORITA_DELEGATA, NVL(GP.DESCR_MITTENTE, '-') DESCR_MITTENTE, DESCR_MISURA_ALTERNATIVA.RV_MEANING DESCR_MISURA_ALTERNATIVA, ";
		...
		lStatement += ",0 NUM_FIGLI, null ID_FASCICOLO_SIUS_FIGLIO, null ID_FASCICOLO_SIUS_ORIGINE "; // STUB
																										// 02/11/2005
																										// Rework
																										// EMA.
		lStatement += "FROM ESECUZIONE_MISURA_ALTERNATIVA EMA, GENERALE_PROCEDIMENTO GP_PADRE, GENERALE_PROCEDIMENTO GP, FASCICOLO_SIUS FASC_PADRE, FASCICOLO_SIUS FASC, ";
		lStatement += " SOGGETTO  SOGG, UFFICIO UFF, COMUNE DESCR_COM_UFF, CG_REF_CODES DESCR_COD_PROCEDIMENTO, CG_REF_CODES DESCR_MISURA_ALTERNATIVA ";
		lStatement += " WHERE EMA.ID_ESECUZIONE_MISURA_ALTERNATI = '" + aEseMAKey + "' ";
		lStatement += " AND EMA.GEN_PRID_GENERALE_PROCEDIMENTO = GP_PADRE.ID_GENERALE_PROCEDIMENTO ";
		lStatement += " AND FASC_PADRE.ID_FASCICOLO_SIUS = GP_PADRE.FAS_SIU_ID_FASCICOLO_SIUS ";
		lStatement += " AND FASC.ID_FASCICOLO_SIUS = GP.FAS_SIU_ID_FASCICOLO_SIUS ";
	...
	protected String getFascicoliFigliSenzaProvvedimenti(BigDecimal aIdFascicolo,
		...
		lStatement += " '-' COD_STATO_FASCICOLO, FASC.COD_STATO_FASCICOLO DESCR_STATO_FASCICOLO, null DATA_RICHIESTA, GP.ID_GENERALE_PROCEDIMENTO ID_GENERALE_PROCEDIMENTO, GP.ANNO_S1, GP.PROGR_S1, ";
		lStatement += " '-' DESCR_PROVVEDIMENTO, '-'  DESCR_DEFINIZIONE, DESCR_COD_PROCEDIMENTO.RV_MEANING DESCR_COD_PROCEDIMENTO, ";
		lStatement += " NVL(EMA.LUOGO_ESECUZIONE_MISURA, '') LUOGO_ESECUZIONE_MISURA, FASC_FIGLIO.ID_FASCICOLO_SIUS_ORIGINE ID_FASCICOLO_SIUS_ORIGINE ";
		lStatement += "FROM ESECUZIONE_MISURA_ALTERNATIVA EMA, GENERALE_PROCEDIMENTO GP_PADRE, GENERALE_PROCEDIMENTO GP, FASCICOLO_SIUS FASC_PADRE, FASCICOLO_SIUS FASC, ";
		lStatement += " SOGGETTO  SOGG, UFFICIO UFF, COMUNE DESCR_COM_UFF, CG_REF_CODES DESCR_COD_PROCEDIMENTO, CG_REF_CODES DESCR_MISURA_ALTERNATIVA ";
		lStatement += " WHERE EMA.GEN_PRID_GENERALE_PROCEDIMENTO = GP_PADRE.ID_GENERALE_PROCEDIMENTO ";
		lStatement += " AND GP_PADRE.FAS_SIU_ID_FASCICOLO_SIUS = '" + aIdFascicolo + "' ";
	...
	protected String getFascicoliCorrelatiConProvvedimentiDellaMisura(BigDecimal aIdFascicoloEMA,
		...
		lStatement += " DESCR_TIPO_PROCEDIMENTO.RV_MEANING DESCR_TIPO_PROCEDIMENTO, DESCR_COM_UFF.DESCRIZIONE DESCR_COMUNE_UFFICIO,";
		lStatement += " DESCR_COM_NASCITA.DESCRIZIONE DESCR_COMUNE_NASCITA, DESCR_COM_NASCITA.COD_PROVINCIA COD_PROVINCIA_NASCITA,";
		lStatement += " GP_FIGLIO.COD_OGGETTO_PROCEDIMENTO COD_OGGETTO_PROCEDIMENTO, GP_FIGLIO.DATA_CAMERA_CONSIGLIO DATA_CAMERA_CONSIGLIO, NVL(GP_FIGLIO.COD_AUTORITA_DELEGATA, '-') COD_AUTORITA_DELEGATA, NVL(GP_FIGLIO.DESCR_MITTENTE, '-') DESCR_MITTENTE, '-' DESCR_MISURA_ALTERNATIVA, ";
