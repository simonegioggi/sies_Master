...
/**
* <p>Title: EsecuzioneMisuraAlternativaModel</p>
* <p>Description: Classe Model che rappresenta il EsecuzioneMisuraAlternativa</p>
...
public class EsecuzioneMisuraAlternativaModel extends GenericModel {

	/**
	* 
	*/
	private static final long serialVersionUID = -1264502668913260494L;

	private BigDecimal mIdEsecuzioneMisuraAlternati;
	...
	private Date mDataDeclaratoriaEp;
	private Date mDataTxAttiEstPena;
	...
	private String mLuogoEsecuzioneMisura; // STUB 23/11/2004

	// COSTRUTTORE DI DEFAULT
	public EsecuzioneMisuraAlternativaModel() {
		this.mIdEsecuzioneMisuraAlternati = null;
		this.mAnnoS07 = null;
		this.mProgrS07 = null;
		...
		this.mDataDeclaratoriaEp = null;
		this.mDataTxAttiEstPena = null;
	...
	public EsecuzioneMisuraAlternativaModel(EsecuzioneMisuraAlternativaModel aModel) {
		this.mIdEsecuzioneMisuraAlternati = aModel.mIdEsecuzioneMisuraAlternati;
		...
		this.mDataDeclaratoriaEp = aModel.mDataDeclaratoriaEp;
		this.mDataTxAttiEstPena = aModel.mDataTxAttiEstPena;
	...
	// COSTRUTTORE MODEL
	public EsecuzioneMisuraAlternativaModel(BigDecimal aIdEsecuzioneMisuraAlternati, BigDecimal aAnnoS07,
			...
			Date aDataTermineAttuale, Date aDataDeclaratoriaEp, Date aDataTxAttiEstPena,
			BigDecimal aDepDecIdDepositoDecreto, BigDecimal aDepOpidDepositoOrdinanzaPc, String aNote,
			...
			BigDecimal aGenPridGeneraleProcedimento, String aLuogoEsecuzioneMisura) {
		this.mIdEsecuzioneMisuraAlternati = aIdEsecuzioneMisuraAlternati;
		...
		this.mDataDeclaratoriaEp = aDataDeclaratoriaEp;
		this.mDataTxAttiEstPena = aDataTxAttiEstPena;
	...
	public BigDecimal getIdEsecuzioneMisuraAlternati() {
		return mIdEsecuzioneMisuraAlternati;
	}
	...
	public Date getDataDeclaratoriaEp() {
		return mDataDeclaratoriaEp;
	}

	public Date getDataTxAttiEstPena() {
		return mDataTxAttiEstPena;
	}
	...
	public void setIdEsecuzioneMisuraAlternati(BigDecimal aValore) {
		mIdEsecuzioneMisuraAlternati = aValore;
	}
	...
	public void setDataDeclaratoriaEp(Date aValore) {
		mDataDeclaratoriaEp = aValore;
	}

	public void setDataTxAttiEstPena(Date aValore) {
		mDataTxAttiEstPena = aValore;
	}
	...
	public String toString() {
		...
		lStr = "" + mIdEsecuzioneMisuraAlternati + " - " + mAnnoS07 + " - " + mProgrS07 + " - "
				...
				+ mDataTermineAttuale + " - " + mDataDeclaratoriaEp + " - " + mDataTxAttiEstPena + " - "
				...
				+ mGenPridGeneraleProcedimento + " - " + mLuogoEsecuzioneMisura;
