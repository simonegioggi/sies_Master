package siap.sius.documentoallegato.model;
...
/**
 * Model rappresentativo dell'entità omonima nel Modello Dati del DB. Viene usato per contenere stampe
 * aggiuntive collegate a Provvedimenti SIUS come ad esempio la Stampa del Deposito o il Foglio Complementare.
 * 
 * @author Lesposito
 *
 */
public class DocumentoAllegatoModel extends GenericModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7825314275600998993L;
	...
	// COSTRUTTORE MODEL
	public DocumentoAllegatoModel(BigDecimal aIdDocumentoAllegato, Date aDataEmissione,
			String aCodTipoDocumento, String aDescrTipoDocumento, BigDecimal aNumeroProgressivo,
			...
			String aTemIdTemplate, BigDecimal aAnnoFoglioComplementare, BigDecimal aProgrFoglioComplementare,
			Date aDataTrasmissione, Date aDataAnnullamento, String mMotivoAnnullamento,
			String aComuneSedeGiudiziaria, String aCodMotivazioneNonInvio, String aDescrMotivazioneNonInvio,
			String aDescrizioneNonInvio, Date aDataUltInvio, Date aDataInsMan)
	...
	// METODI GET()
	//
	public BigDecimal getIdDocumentoAllegato() {
		return mIdDocumentoAllegato;
	}
	...
	public String getCodTipoDocumento() {
		return mCodTipoDocumento;
	}

	public String getDescrTipoDocumento() {
		return mDescrTipoDocumento;
	}

	public BigDecimal getNumeroProgressivo() {
		return mNumeroProgressivo;
	}
	...
	public BigDecimal getAnnoFoglioComplementare() {
		return mAnnoFoglioComplementare;
	}

	public BigDecimal getProgrFoglioComplementare() {
		return mProgrFoglioComplementare;
	}
	...
	public String getComuneSedeGiudiziaria() {
		return mComuneSedeGiudiziaria;
	}

	public String getCodMotivazioneNonInvio() {
		return mCodMotivazioneNonInvio;
	}

	public String getDescrMotivazioneNonInvio() {
		return mDescrMotivazioneNonInvio;
	}

	public String getDescrizioneNonInvio() {
		return mDescrizioneNonInvio;
	}

	public Date getDataUltInvio() {
		return mDataUltInvio;
	}

	public Date getDataInsMan() {
		return mDataInsMan;
	}
	...
	public void setCodTipoDocumento(String aValore) {
		mCodTipoDocumento = aValore;
	}

	public void setDescrTipoDocumento(String aValore) {
		mDescrTipoDocumento = aValore;
	}

	public void setNumeroProgressivo(BigDecimal aValore) {
		mNumeroProgressivo = aValore;
	}
	...
	public void setAnnoFoglioComplementare(BigDecimal aValore) {
		mAnnoFoglioComplementare = aValore;
	}

	public void setProgrFoglioComplementare(BigDecimal aValore) {
		mProgrFoglioComplementare = aValore;
	}
	...
	public void setMotivoAnnullamento(String aValore) {
		mMotivoAnnullamento = aValore;
	}

	public void setComuneSedeGiudiziaria(String aValore) {
		mComuneSedeGiudiziaria = aValore;
	}

	public void setCodMotivazioneNonInvio(String aValore) {
		mCodMotivazioneNonInvio = aValore;
	}

	public void setDescrMotivazioneNonInvio(String aValore) {
		mDescrMotivazioneNonInvio = aValore;
	}

	public void setDescrizioneNonInvio(String aValore) {
		mDescrizioneNonInvio = aValore;
	}

	public void setDataUltInvio(Date aValore) {
		mDataUltInvio = aValore;
	}
