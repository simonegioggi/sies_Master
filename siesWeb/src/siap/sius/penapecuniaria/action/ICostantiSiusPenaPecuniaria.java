...
public interface ICostantiSiusPenaPecuniaria extends ICostantiPenaPecuniaria
{
  ...
  //========================================== 
  public static final String PG_RICERCA_SIUS_RICHIESTACONVERSIONE  = IWebConstants.ROOT_DIR + "files/siap/sius/penapecuniaria/RicercaSiusRichiestaConversione.jsp";
  public static final String PG_LOAD_DETTAGLIO_RICHIESTA_CONVERSIONE_PP  = IWebConstants.ROOT_DIR + "files/siap/sius/penapecuniaria/DettaglioRichiestaConversionePP.jsp";
  public static final String PG_LOAD_INSERISCI_RICHIESTACONVERSIONE_PP  = IWebConstants.ROOT_DIR + "files/siap/sius/penapecuniaria/LoadInserisciRichiestaConversionePP.jsp";
  public static final String PG_LOAD_MODIFICA_RICHIESTA_CONVERSIONE_PP   = IWebConstants.ROOT_DIR + "files/siap/sius/penapecuniaria/LoadModificaRichiestaConversionePP.jsp";
}