...
public class ActInserisciInfCondEconomiche extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0562"); // CodMotivo - Richiesta Condizioni Economiche
