...
public class ActInserisciInfDSMUOSM extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0564"); // Informazioni DSM/UOSM
		// Template differente nel caso di Remissione Debito
		// if
		// (lFascicoloGPModel.getGeneraleProcedimentoModel().getCodOggettoProcedimento().compareTo("U011")==0)
		// lEveNot.getEvento().setCodMotivo("0586");
		...
		// return super.getPaginaDettaglio( lEveNot.getEvento().getIdEvento());
	}
