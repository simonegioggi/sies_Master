...
public class ActInserisciInformazioniDomicilio extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0590"); // Informazioni Domicilio
