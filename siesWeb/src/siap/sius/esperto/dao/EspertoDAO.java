...
/**
* <p>Title: EspertoDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella Esperto</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class EspertoDAO extends SIAPTableDAO
{
  public EspertoDAO (Connection con)
  {
    super(con);
    setTable("ESPERTO");

    //Settare la Sequence e i campi chiave
    setSequenceField("ID_ESPERTO", "ESP_SEQ");
    setFieldKey("ID_ESPERTO", BIG_DECIMAL);

    setField("ID_ESPERTO", BIG_DECIMAL);
  ...
  public BigDecimal getIdEsperto()                  throws DAOException	 { return getBigDecimal("ID_ESPERTO"); }
  ...
  public void setIdEsperto(BigDecimal aValore)              { setBigDecimal("ID_ESPERTO", aValore); }
  ...
  public void setDAOFromModel(EspertoModel aModel)
  throws DAOException
  {
    setIdEsperto( aModel.getIdEsperto() );
  ...
  public void setDAOFromModelForUpdate(EspertoModel aModel)
  throws DAOException
  {
    //setIdEsperto( aModel.getIdEsperto() );
    setCognome( aModel.getCognome() );
    ...
    setCodUfficioAggiornamento( aModel.getCodUfficioAggiornamento() );
    setCodiceFiscale( aModel.getCodiceFiscale() );
    setCondizioneUpdate(aModel.getIdEsperto());
  }

  public void setCondizione(EspertoModel aModel)
  {
