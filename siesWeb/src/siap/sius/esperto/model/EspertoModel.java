package siap.sius.esperto.model;

/**
* <p>Title: EspertoModel</p>
* <p>Description: Classe Model che rappresenta il Esperto</p>
...
public class EspertoModel extends GenericModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8020632551199091079L;
	...
	public EspertoModel(EspertoModel aModel) {
	...
	// COSTRUTTORE MODEL
	public EspertoModel(BigDecimal aIdEsperto, String aCognome, String aNome, String aIndirizzo,
			...
			String aFlagStato, String aCodOperatoreInserimento, Date aDataInserimento,
