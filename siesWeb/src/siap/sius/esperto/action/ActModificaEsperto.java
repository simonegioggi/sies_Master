...
/**
* <p>Title: ActModificaEsperto</p>
* <p>Description: Classe Action per la modifica di Esperto</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/
public class ActModificaEsperto extends ActionSiap implements ICostantiEsperto
{
	// [FT] - 03/08/2016 - MAC_LOG - Dichiaro un'istanza di Logger per SIESLog
	private static Logger siesLogger = Logger.getLogger(LogF3B.SIES_LOG);
/**
* Azione di Modifica del Esperto.
* <p>
...
*/
  public String processRequest() throws Exception
  {
    ...
    lEspMod.setIdEsperto(getRequestBigDecimalParameter(CAMPO_ID_ESPERTO));
    ...
    lEspMod.setCodOperatoreAggiornamento(getCodUtenteConnesso());
    lEspMod.setCodUfficioAggiornamento(getCodUfficioUtenteConnesso());
    lEspMod.setDataAggiornamento(DateUtils.getSysDate());

    // chiama il controller
    IEsperto lCtrl = SIUSLookupRemote.getEspertoRemote();
    EspertoModel lEspModRet = lCtrl.ExModificaEsperto(lEspMod);
