...
public class ActInserisciEsitoParereInamm extends ActionSiap implements ICostantiProduzioneAtti {
	...
	public String processRequest() throws Exception {
		...
		Date lDataEmissione2 = getRequestDateParameter(CAMPO_ANNO_DATA_EMISSIONE2, CAMPO_MESE_DATA_EMISSIONE2,
		...
		lEveNot.setCodTipoEvento(ICostantiProduzioneAtti.CODTIPOEVENTO);
		...
		lPage.setAction("siap.sius.produzioneatti.action.ActLoadDettaglioEsitoParereInamm");
