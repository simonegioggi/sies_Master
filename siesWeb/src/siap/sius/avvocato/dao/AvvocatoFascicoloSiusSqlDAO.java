...
public class AvvocatoFascicoloSiusSqlDAO extends SIAPSqlDAO {
	...
	private String getSqlQuery() {
		...
		// " COMSEDEFORO.DESCRIZIONE descComuneSedeForo, "
				...
				+ "AVVOCATO_FASCICOLO_SIUS.AVV_ID_AVVOCATO, " + "AVVOCATO_FASCICOLO_SIUS.COD_TIPO_AVVOCATO, "
				...
				+ "AVVOCATO_FASCICOLO_SIUS.NOTE,  " + "AVVOCATO_FASCICOLO_SIUS.COD_TIPO_AUTORITA, "
	...
	public GenericModel getModel() throws DAOException {
		...
		aModel.getAvvocatoFascicoloSiusModel()
				.setCodOperatoreAggiornamento(getString("AVV_FASC_SIUS_COD_OP_AGG"));
		aModel.getAvvocatoFascicoloSiusModel()
				.setCodOperatoreInserimento(getString("AVV_FASC_SIUS_COD_OP_INS"));
		aModel.getAvvocatoFascicoloSiusModel().setCodTipoAvvocato(getString("COD_TIPO_AVVOCATO"));
		aModel.getAvvocatoFascicoloSiusModel()
				.setCodUfficioAggiornamento(getString("AVV_FASC_SIUS_COD_UFF_AGG"));
		aModel.getAvvocatoFascicoloSiusModel()
				.setCodUfficioInserimento(getString("AVV_FASC_SIUS_COD_UFF_INS"));
		...
		aModel.getAvvocatoFascicoloSiusModel()
				.setFasSiuIdFascicoloSius(getBigDecimal("FAS_SIU_ID_FASCICOLO_SIUS"));
