...
/**
 * AvvocatoDAO - Classe DAO che rappresenta la tabella Avvocato
 *
 * @version 1.0
 */
public class AvvocatoDAO extends SIAPTableDAO {
	...
	public GenericModel getModel() throws DAOException {
		...
		return new AvvocatoModel(getIdAvvocato(), getCognome(), getNome(), getForo(),
				...
				// MEV_21
				getIndirizzo(), getTelefono(), getFax(), getEMail(), getCodLuogoNascita(),
				getCodComuneResidenza(), "", "", getDataNascita(), getCodOperatoreInserimento(),
				getDataInserimento(), getCodOperatoreAggiornamento(), getDataAggiornamento(), "",
				getCodUfficioInserimento(), getCodUfficioAggiornamento(), this.getDataSospensione(),
				this.getDataRadiazione(), this.getCodNonAttivita(), this.getCodUffAppartenenza(), getNote(),
				getFlagCancellato(), "", this.getCodiceFiscale(), this.getProvincia(), this.getCap(),
				this.getFlagVisualizza(), this.getIdAvvocatoStandard());
	}
