...
public class ActCancellaAvvocatoFascicoloSius extends ActionSiap implements ICostantiAvvocato
{
  public String processRequest() throws F3BException
  {
    ...
    lAvvMod.setIdAvvocatoFascicoloSius(new BigDecimal(lId));

  //  lAvvMod.setIdAvvocatoFascicoloSius( getRequestBigDecimalParameter( CAMPO_ID_AVVOCATO) );


    // chiama il controller
    //AvvocatoController lCtrl = new AvvocatoController();
    IAvvocato lCtrl = SIUSLookupRemote.getAvvocatoRemote();
    lCtrl.ExCancellaAvvocatoFascicoloSius(lAvvMod);
  ...
  //  lRedirigi.setAction( "siap.sius.avvocato.action.ActLoadInserisciAvvocato" );
      lRedirigi.setAction( "siap.sius.fascicolo.action.ActLoadRicercaFascicoloSius" );
