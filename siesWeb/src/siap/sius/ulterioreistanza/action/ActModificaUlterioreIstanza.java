...
/**
* <p>Title: ActModificaUlterioreIstanza</p>
* <p>Description: Classe Action per la modifica di UlterioreIstanza</p>
...
public class ActModificaUlterioreIstanza extends ActionSius implements ICostantiUlterioreIstanza
{
  ...
  { 
     ...
     FascicoloSiusModel lFascicolo = new FascicoloSiusModel( ( (FascicoloGPModel)getSessionAttribute("fascicoloSiusGP")).getFascicoloSiusModel());
     ...
     // Va alla pagina di dettaglio invocando la corrispondete Action
		 String lPage = "";
		 lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.sius.ulterioreistanza.action.ActLoadDettaglioUlterioreIstanza&"+CAMPO_ID_ULTERIORE_ISTANZA+"="+lUltModRet.getIdUlterioreIstanza().toString();
   ...
   * secondo il Pattern PIPE, e inserire l'elenco dei tenori, opportumante raccolti in 
