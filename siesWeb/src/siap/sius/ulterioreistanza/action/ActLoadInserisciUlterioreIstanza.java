...
/**
* <p>Title: ActLoadInserisciUlterioreIstanza</p>
* <p>Description: Classe Action per la load inserisci di UlterioreIstanza</p>
...
public class ActLoadInserisciUlterioreIstanza extends ActionSius implements ICostantiUlterioreIstanza
{
   ...
   */
   public String processRequest() throws Exception 
   {
     ...
     if( lFasGPMod.getFascicoloSiusModel().getCodStatoFascicolo().compareTo(ICostantiFascicoloSius.COD_DEFINITO)==0 || 
         lFasGPMod.getFascicoloSiusModel().getCodStatoFascicolo().compareTo(ICostantiFascicoloSius.COD_UNIFICATO)==0 ||
         lFasGPMod.getFascicoloSiusModel().getCodStatoFascicolo().compareTo(ICostantiFascicoloSius.COD_EMESSO_PROVVEDIMENTOO)==0 )
        throw new SIUSException( SIUSException.USER_MESSAGE, "L'inserimento di ulteriori istanze " +
     ...
     return PG_LOAD_INSERISCIULTERIOREISTANZA;  //restituisce la jsp di VIEW 
	}
}