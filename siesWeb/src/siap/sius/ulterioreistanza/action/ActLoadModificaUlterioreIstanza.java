...
* <p>Description: Classe Action per la load Modifica di UlterioreIstanza</p>
...
public class ActLoadModificaUlterioreIstanza extends ActionSius implements ICostantiUlterioreIstanza
{
   ...
   */
   public String processRequest() throws F3BException 
   {
     ...
     UlterioreIstanzaModel lUltIstMod = lCtrl.ExRicercaUlterioreIstanzaByKey( getRequestBigDecimalParameter(ICostantiUlterioreIstanza.CAMPO_ID_ULTERIORE_ISTANZA));
     
     // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
     siesLogger.debug(this.getClass().getPackage().getName() + "#### Contenuto di UltIstMod : " + lUltIstMod );
