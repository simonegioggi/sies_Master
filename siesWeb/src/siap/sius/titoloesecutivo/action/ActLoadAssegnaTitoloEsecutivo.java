...
/**
 * <p>
 * Title: ActLoadAssegnaTitoloEsecutivo
 * </p>
 * <p>
 * Description: Classe Action per la LoadAssegnaTitoloEsecutivo
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadAssegnaTitoloEsecutivo extends ActionSius implements ICostantiTitoloEsecutivo,
	...
	public String processRequest() throws Exception {
		...
		/*
		 * STUB 20080122 - Modificata con le istruzioni successive // Se il procedimento è definito non viene
		 * consentita l'operazione.
		 ...
		 * "L'inserimento Titolo Esecutivo Principale non è consentito per i procedimenti definiti!" );
		 */
		...
		// throw new SIUSException( SIUSException.USER_MESSAGE, "L'inserimento Titolo Esecutivo Principale " +
		// "non è consentito per i procedimenti definiti!" );

		// Se il procedimento fa gia riferimento a un titolo esecutivo non viene consentita l'operazione.
		if (lFasGPMod.getFascicoloSiusModel().getFasSieIdFascicoloSiep() != null)
			throw new SIUSException(SIUSException.USER_MESSAGE,
					"Il procedimento fa già riferimento ad un procedimento SIEP !");
