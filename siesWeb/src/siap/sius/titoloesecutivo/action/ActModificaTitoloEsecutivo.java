 ...
 * </p>
 * <p>
 * Description: Classe Action per la ridefinizione del Titolo Esecutivo associato al Fascicolo Sius corrente.
 * </p>
 * <p>
...
public class ActModificaTitoloEsecutivo extends ActionSiap implements ICostantiTitoloEsecutivo,
	...
	/**
	 * Azione di Modifica del Titolo Esecutivo associato al Fascicolo Sius corrente. Il fascicolo SIEP scelto
...
//		UtenteModel lUtenteMod = (UtenteModel) getSessionAttribute(ICostantiSecurity.SESSION_UTENTE_CONNESSO);
		...
		lFasSiepOld = lCtrl.ExRicercaFascicoloByKey(lFasGPMod.getFascicoloSiusModel()
		...
		/*FascicoloGPModel lFasGPModel = */lCtrlTE.ExAssegnaTitoloEsecutivo(lFasGPMod, lFasSiepMod, lFasSiepOld);
