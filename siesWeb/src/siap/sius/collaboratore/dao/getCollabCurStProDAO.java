 ...
 * restituiscono il risultato attraverso un REF CURSOR, poich� tale tipo � gestito solo dai driver Oracle
...
public class getCollabCurStProDAO extends StoreProcedureDAO {
	...
	/**
	 * La funzione � analoga alla GenericDAO.getModels(). Chiama la execute() per eseguuire la stored
	 * procedure di ricerca che � stata impostata dal costruttore; effettua un casting del ResouseSet ad
