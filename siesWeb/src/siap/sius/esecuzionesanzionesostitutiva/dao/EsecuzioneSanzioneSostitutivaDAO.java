...
/**
 * EsecuzioneSanzioneSostitutivaDAO - Classe DAO che rappresenta la tabella EsecuzioneSanzioneSostitutiva
 *
 * @version 1.0
 */
public class EsecuzioneSanzioneSostitutivaDAO extends TableDAO {
	...
	public BigDecimal getIdEsecuzioneSanzioneSost() throws DAOException {
		return getBigDecimal("ID_ESECUZIONE_SANZIONE_SOST");
	}

	public BigDecimal getAnnoS07() throws DAOException {
		return getBigDecimal("ANNO_S07");
	}

	public BigDecimal getProgrS07() throws DAOException {
		return getBigDecimal("PROGR_S07");
	}

	public Date getDataOrdinanza() throws DAOException {
		return getDate("DATA_ORDINANZA");
	}

	public String getCodAutoritaEmittOrd() throws DAOException {
		return getString("COD_AUTORITA_EMITT_ORD");
	}

	public String getCodTipoAutoritaEmittOrd() throws DAOException {
		return getString("COD_TIPO_AUTORITA_EMITT_ORD");
	}

	public String getCodLuogoAutoritaEmittOrd() throws DAOException {
		return getString("COD_LUOGO_AUTORITA_EMITT_ORD");
	}
	...
	public Date getDataInizioSanzione() throws DAOException {
		return getDate("DATA_INIZIO_SANZIONE");
	}

	public Date getDataTermineIniziale() throws DAOException {
		return getDate("DATA_TERMINE_INIZIALE");
	}

	public Date getDataTermineAttuale() throws DAOException {
		return getDate("DATA_TERMINE_ATTUALE");
	}

	public Date getDataDeclaratoriaESS() throws DAOException {
		return getDate("DATA_DECLARATORIA_ESS");
	}
	...
	public String getLuogoEsecuzioneSanzione() throws DAOException {
		return getString("LUOGO_ESECUZIONE_SANZIONE");
	}

	public BigDecimal getNumGiorniSanzione() throws DAOException {
		return getBigDecimal("NUM_GIORNI_SANZIONE");
	}

	public BigDecimal getNumMesiSanzione() throws DAOException {
		return getBigDecimal("NUM_MESI_SANZIONE");
	}

	public BigDecimal getNumAnniSanzione() throws DAOException {
		return getBigDecimal("NUM_ANNI_SANZIONE");
	}
	...
	public void setDataInizioSanzione(Date aValore) {
		setDate("DATA_INIZIO_SANZIONE", aValore);
	}

	public void setDataTermineIniziale(Date aValore) {
		setDate("DATA_TERMINE_INIZIALE", aValore);
	}

	public void setDataTermineAttuale(Date aValore) {
		setDate("DATA_TERMINE_ATTUALE", aValore);
	}

	public void setDataDeclaratoriaESS(Date aValore) {
		setDate("DATA_DECLARATORIA_ESS", aValore);
	}
	...
	public void setLuogoEsecuzioneSanzione(String aValore) {
		setString("LUOGO_ESECUZIONE_SANZIONE", aValore);
	}

	public void setNumGiorniSanzione(BigDecimal aValore) {
		setBigDecimal("NUM_GIORNI_SANZIONE", aValore);
	}

	public void setNumMesiSanzione(BigDecimal aValore) {
		setBigDecimal("NUM_MESI_SANZIONE", aValore);
	}

	public void setNumAnniSanzione(BigDecimal aValore) {
		setBigDecimal("NUM_ANNI_SANZIONE", aValore);
	}

	public GenericModel getModel() throws DAOException {

		return new EsecuzioneSanzioneSostitutivaModel(getIdEsecuzioneSanzioneSost(), getAnnoS07(),
				getProgrS07(), getDataOrdinanza(), getCodAutoritaEmittOrd(), "", getCodTipoAutoritaEmittOrd(),
				"", getCodLuogoAutoritaEmittOrd(), "", getCodTipoSanzione(), "", getDataInizioSanzione(),
				getDataTermineIniziale(), getDataTermineAttuale(), getDataDeclaratoriaESS(),
				getDepDecIdDepositoDecreto(), getDepOpidDepositoOrdinanzaPc(), getNote(),
				...
				getGenPridGeneraleProcedimento(), getLuogoEsecuzioneSanzione(), getNumGiorniSanzione(),
				getNumMesiSanzione(), getNumAnniSanzione());
	}
	...
	public void setDAOFromModelForUpdate(EsecuzioneSanzioneSostitutivaModel aModel) throws DAOException {
		...
		setNumMesiSanzione(aModel.getNumMesiSanzione());
		setNumGiorniSanzione(aModel.getNumGiorniSanzione());
		// MEV_2023-35: aggiunta impostazione di variabile
		if (Utils.isPresent(aModel.getCodTipoSanzione()))
			setCodTipoSanzione(aModel.getCodTipoSanzione());
	...
	public void setDAOFromModelForUpdatebyFascicolo(EsecuzioneSanzioneSostitutivaModel aModel)
			throws DAOException {
