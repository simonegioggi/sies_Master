...
/**
 * ActAnnullaProvvedimento - Effettua l'annullamento logico del Provvedimento e l'inserimento della
 * Motivazione in CAMPO_NOTA.
 *
 * @version 1.0
 */
public class ActAnnullaProvvedimento extends ActionSiap implements ICostantiProvvedimento {
	...
	public String processRequest() throws Exception {
		...
		// 19/05/2008 Diversificazione del messaggio in caso di presenza Periodo Altra Sanzione o Periodo
		// Altra Misura
		if (mPerAlSanz != null && mPerAlSanz.getIdPeriodoAltraSanzione() != null) {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT,
					"Provvedimento Annullato! <br><br> Attenzione: esistenza di periodo MISURA SICUREZZA! <br> Verificare durata MISURA con la specifica funzione!");
		} else {
