...
/**
 * <p>
 * Title: ActDettaglioNotificheEvento
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActDettaglioNotificheEvento extends ActionSiap implements ICostantiProvvedimento {
	...
	public String processRequest() throws F3BException {
		...
		// 5. Procura della Repubblica presso il tribunale dei Minorenni (PMM) per (TDSM - UDSM)
		...
		while (i.hasNext()) {
			...
			if (nm.getSogIdSoggetto() != null || nm.getAvvIdAvvocatoFascicoloSius() != null)
				...
				v.add(nm);
					...
					&& "C".equals(nm.getCodTipoNotifica()) && !("per l'esecuzione".equals(nm.getNote())))
				v.add(nm);
