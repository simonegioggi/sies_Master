...
/**
* <p>Title: ScadenzarioSiusDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella ScadenzarioSius</p>
...
public class ScadenzarioSiusDAO extends TableDAO
{
  ...
  // METODI GET()
  //
  public BigDecimal 		 getIdScadenzarioSius() 		throws DAOException	 { return getBigDecimal("ID_SCADENZARIO_SIUS"); }
  ...
  // METODI SET()
  //
  public void  	 setIdScadenzarioSius(BigDecimal aValore ) 			 { setBigDecimal("ID_SCADENZARIO_SIUS", aValore); }
  ...
  {
    return new ScadenzarioSiusModel(
         getIdScadenzarioSius() ,
