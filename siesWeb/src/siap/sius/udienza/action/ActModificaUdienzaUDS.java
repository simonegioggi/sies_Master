...
public class ActModificaUdienzaUDS extends ActionSiap implements ICostantiUdienza
{
/**
...
//	 lUdiMod.setCodIdEsperto2( getRequestBigDecimalParameter( CAMPO_COD_ID_ESPERTO_2) );
     ...
     lUdiMod.setDataAggiornamento(DateUtils.getSysDate());
		 ...
		 UdienzaModel llUdiModRet = lCtrl.ExModificaUdienzaUDS(lUdiMod);

		 setRequestAttribute("modalita", "M");
		 setRequestAttribute("udienza", llUdiModRet);

		 String lPage = "";
		 lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD + "=siap.sius.udienza.action.ActLoadDettaglioUdienzaUDS&"+CAMPO_ID_UDIENZA+"="+llUdiModRet.getIdUdienza().toString();
		 return lPage;
	 }
