...
public class ActCancellaUdienzaUDS extends ActionSiap implements ICostantiUdienza
{
  /**
  ...
  public String processRequest() throws F3BException
  {
    ...
    lRedirigi.setAction( "siap.sius.udienza.action.ActLoadRicercaUdienzaUDS" );
