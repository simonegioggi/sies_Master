...
public class ActLoadFSPRinvioUdienza extends ActLoadRicercaFSPuntuale
implements ICostantiUdienza
{
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("functionName", "Rinvio Udienza");
    setRequestAttribute("nextAction", "siap.sius.udienza.action.ActLoadRinvioUdienza");
