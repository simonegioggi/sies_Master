 ...
 * @version 1.0
 */
public class ActStampaVerbaleRinvioUdienza extends ActionSiap
implements ICostantiUdienza
{
  public String processRequest() throws Exception
  {
    ...
    ByteArrayOutputStream lReport = lCtrl.ExStampaVerbaleUdienza( lEvento, lUfficio, super.getUtenteConnesso() );
