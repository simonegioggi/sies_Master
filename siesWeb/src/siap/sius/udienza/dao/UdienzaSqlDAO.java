 ...
 * </p>
 * <p>
 * Description: Classe SqlDAO che rappresenta la tabella Udienza
 * </p>
 * <p>
...
public class UdienzaSqlDAO extends SIAPSqlDAO {
	 ...
	 *
	 * @param con
	 *            Connection Connessione al dbase.
	 */
	...
	/**
	 * Metodo che inposta lo statement per la ricerca di una udienza i parametri di filtro vengono impostati
	 * nel model passato come argomento
	 * <p>
	 *
	 * @param aModel
	 *            UdienzaModel istanza dell'oggetto.
	 * @throws DAOException
	 *             Propaga errore di eccezione.
	 */
	public void ricercaUdienza(UdienzaModel aModel) throws DAOException {
	...
	/**
	 * Metodo che imposta lo statement per la ricerca Udienza utilizzando come filtro i parametri passati come
	 * argomento, opportunamente incapsulati nell'oggetto UdeinzaModel.
	 * <p>
	 *
	 * @param aModel
	 *            UdienzaModel istanza udienza model.
	 * @throws DAOException
	 *             Propaga errore di eccezione.
	 */
	public void ricercaUdienzaGenerale(UdienzaModel aModel) throws DAOException {
		String lSql = getSqlQuery();
	...
	//
	/**
	 * Metodo che imposta lo statement per la ricerca udienza per l'UDS ( Ufficio di Sorveglianza ).
	 * <p>
	 *
	 * @param aModel
	 *            UdienzaModel Istanza UdienzaModel
	 * @throws DAOException
	 *             Propaga errore di eccezione.
	 */
	public void ricercaUdienzaUDS(UdienzaModel aModel) throws DAOException {
	 ...
	 *
	 * @param aModel
	 *            UdienzaModel Istanza oggetto UdienzaModel
	 * @param aGeneraleProcedimento
	 *            GeneraleProcedimentoModel Istanza oggetto GeneraleProcedimentoModel
	 * @throws DAOException
	 *             Propaga errore di eccezione.
	 */
	 ...
	 * @param aModel
	 *            UdienzaModel Istanza UdienzaModel.
	 * @param aGeneraleProcedeimento
	 *            GeneraleProcedimentoModel Istanza GeneraleProcedimentoModel.
	 * @throws DAOException
	 *             Propaga errore di eccezione.
	 */
	 ...
	 *             Propaga errore di eccezione.
	 */
	public void ricercaUdienzaByDate(String aKey, String aCodUfficio) throws DAOException {
	 ...
	 *             Propaga errore di eccezione.
	 */
	public void ricercaUdienzaByKey(BigDecimal aKey) throws DAOException {
		String lSql = getSqlQuery();
	...
	protected String getSqlQueryNuoveUdienze(GeneraleProcedimentoModel aGeneraleProcedimento) {
		...
		lSelect += "   where   GP.ID_GENERALE_PROCEDIMENTO ="
	...
	protected String getSqlQuery() {
		...
		// MEV_6: aggiunte condizioni di join tra le tabelle UDIENZA e MAGISTRATO
		lSelect += " AND GIU1.COD_UFFICIO_APPARTENENZA(+) = UDI.COD_UFFICIO_APPARTENENZA";
		lSelect += " AND GIU2.COD_UFFICIO_APPARTENENZA(+) = UDI.COD_UFFICIO_APPARTENENZA";
		lSelect += " AND PROC.COD_UFFICIO_APPARTENENZA(+) = UDI.COD_UFFICIO_APPARTENENZA";
	...
	protected String getSqlQueryUDS() {
		...
		lSelect += " AND UDI.COD_PG = PROC.COD_MAGISTRATO";
		lSelect += " AND PRES.COD_UFFICIO_APPARTENENZA(+) = UDI.COD_UFFICIO_APPARTENENZA";
		// MEV_6: aggiunta condizione di join tra le tabelle UDIENZA e MAGISTRATO
		lSelect += " AND PROC.COD_UFFICIO_APPARTENENZA(+) = UDI.COD_UFFICIO_APPARTENENZA";
		lSelect += " AND UDI.COD_ID_ASSISTENTE = ASS.ID_ASSISTENTE_GIUDIZIARIO";
	 ...
	 * @return ritorna la stringa query sql.
	 */
	protected String getSqlQueryUdienzePrecedenti(UdienzaModel aModel,
			GeneraleProcedimentoModel aGeneraleProcedimento) {
		String lSelect = new String("");
		...
		lSelect += " AND UDI.DATA_UDIENZA < to_date("
	...
	/**
	 * Metodod che ritorna il model ( UdienzaModel ) con i dati prelevati dal DBase.
	 * <p>
	 *
	 ...
	 * @throws DAOException
	 */
	public void ricercaDattaglioUdienzaByKey(BigDecimal aKey) throws DAOException {
		String lSelect = new String();
	 ...
	 * @throws DAOException
	 */
	public void ricercaDattaglioUdienzaByKeyUDS(BigDecimal aKey) throws DAOException {
		String lSelect = new String();
	...
	public String setCondizione(UdienzaModel aModel) {
		...
		if (aModel.getDataUdienza() != null)
			lCondizioni += " AND UDI.DATA_UDIENZA >= TO_DATE("
					+ DateUtils.getDateToString(aModel.getDataUdienza(), "yyyyMMdd") + ",'YYYYMMDD' )";
		...
		if (aModel.getCodIdEsperto1() != null && aModel.getCodIdEsperto1().toString().length() > 4)
			lCondizioni += " AND UDI.COD_ID_ESPERTO_1 = " + aModel.getCodIdEsperto1();
		if (aModel.getCodIdEsperto2() != null && aModel.getCodIdEsperto2().toString().length() > 4)
			lCondizioni += " AND UDI.COD_ID_ESPERTO_2 = " + aModel.getCodIdEsperto2();
		if (aModel.getCodIdAssistente() != null && aModel.getCodIdAssistente().toString().length() > 4)
	...
	public String setCondizioneNuoveUdienze(UdienzaModel aModel) {
		...
		// boolean lInserito = false;
		if (aModel.getDataUdienza() != null)
			lCondizioni += " AND TO_CHAR(UDI.DATA_UDIENZA,'yyyyMMdd') > "
					+ DateUtils.getDateToString(aModel.getDataUdienza(), "yyyyMMdd");
		if (aModel.getCodUfficioAppartenenza() != null)
			lCondizioni += " AND UDI.COD_UFFICIO_APPARTENENZA = '" + aModel.getCodUfficioAppartenenza() + "'";
	...
	/**
	 * Metodo che ritorna il tipo di ordinamanto desiderato ossia orderby per DATA-COLLEGIO ( Condizione di
	 * default ) oppure COLLEGIO-DATA. Il Tipo di ordinamento viene impostato, utilizzando il metodo
	 * <code> getMessage() </code> ereditato da GenericModel. Quindi se il valore di getMessage non è
	 * valorizzato imposta la condizione di ordinamanto di default (DATA-COLLEGIO)
	 * <p>
	 * Mappatura dei codici : -> D-C ( Ordinamento per Data Udienza e Collegio ) default -> C-D ( Ordinamento
	 * per Collegio e Data Udienza )
	 * <p>
	 *
	 * @param aModel
	 *            UdienzaModel Istanza dell' oggetto UdienzaModel
