...
public class ActInserisciOrdinanzaRevocaLA extends ActInserisciOrdinanzaUDS implements
...
//		PeriodoClass[] periodi = null;
		...
		if (!isRequestParameterNullObj(CAMPO_FLAG_ESITO_REVOCA_LA_PM_ACCOLTO)) {
			// Controlla e imposta il flag
			if (getRequestStringParameter(CAMPO_FLAG_ESITO_REVOCA_LA_PM_ACCOLTO).compareTo("S") == 0)
				flagConcesso = "S";
		}
...
//		PeriodoClass[] periodi_spe = null;
		...
		if (getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE) != null) {
			if (getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE).intValue() > 0) {
				SommatotLS = getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_SPE)
						.intValue();
			}
		}
		...
		if (!isRequestParameterNullObj(CAMPO_FLAG_ESITO_REVOCA_LA_SPE_PM_ACCOLTO)) {
			// Controlla e imposta il flag
			if (getRequestStringParameter(CAMPO_FLAG_ESITO_REVOCA_LA_SPE_PM_ACCOLTO).compareTo("S") == 0)
				flagConcesso_spe = "S";
		}
...
//		PeriodoClass[] periodi_int = null;
		...
		if (getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT) != null) {
			if (getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT).intValue() > 0) {
				SommatotLI = getRequestBigDecimalParameter(ICostantiDepositoOrdinanzaPc.CAMPO_NUM_GIORNI_LIBANTICIPATA_INT)
						.intValue();
			}
		}
		...
		if (!isRequestParameterNullObj(CAMPO_FLAG_ESITO_REVOCA_LA_INT_PM_ACCOLTO)) {
			// Controlla e imposta il flag
			if (getRequestStringParameter(CAMPO_FLAG_ESITO_REVOCA_LA_INT_PM_ACCOLTO).compareTo("S") == 0)
				flagConcesso_int = "S";
		}
		...
		// +aOrdEveTenGP.getOrdinanza().getDescrUfficioMagistratoComp());
		//
