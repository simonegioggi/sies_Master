...
public class ActLoadModificaMagistratoOrdinanza extends ActionSiap implements ICostantiDepositoOrdinanzaPc {
	...
	public String processRequest() throws Exception {
	    ...
	    return PG_LOAD_MODIFICA_MAGISTRATO_ORDINANZA;
	}
}