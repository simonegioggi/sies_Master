...
//			EsecuzioneMisuraSicurezzaModel aEMSRideterminate = new EsecuzioneMisuraSicurezzaModel();
		...
		if (   mOrdEveTenPreMod != null && mOrdEveTenPreMod.getOrdinanza() != null
		    && MISURA_ALTERNATIVA_AMMISSIONE_PROVVISORIA.equals(mOrdEveTenPreMod.getOrdinanza().getCodTipoOrdinanza())
		   ) 
		{
			...
			tempaletRicerca.setCodOggettoProcedimento(mFasGPMod.getGeneraleProcedimentoModel().getCodOggettoProcedimento());
			tempaletRicerca.setFlagTemplate("1"); // presente solo per le provvisorie che hanno gli stessi codice dalle ordinarie
