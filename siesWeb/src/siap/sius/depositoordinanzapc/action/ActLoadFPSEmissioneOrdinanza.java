...
public class ActLoadFPSEmissioneOrdinanza extends ActLoadRicercaFSPuntuale
implements ICostantiDepositoOrdinanzaPc
{
	public String processRequest() throws Exception
	{
		...
		setRequestAttribute("nextAction", "siap.sius.depositoordinanzapc.action.ActLoadEmissioneOrdinanza");
