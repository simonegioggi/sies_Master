...
/**
* <p>Title: ActCancellaRimessioneAtti</p>
* <p>Description: Classe Action per cancellare l'emissione
* di un'ordinanza di rimessione atti </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActCancellaRimessioneAtti extends ActionSiap implements ICostantiDepositoOrdinanzaPc
{
  public String processRequest() throws Exception
  {
    ...
    lDepOrd = lCtrl.ExRicercaDepositoOrdinanzaPcByEvento(getRequestBigDecimalParameter(ICostantiEvento.CAMPO_ID_EVENTO));
    if (lDepOrd == null)
    ...
    // Cancellazione
    lCtrl.ExCancellaRimessioneAtti(lDepOrd);
