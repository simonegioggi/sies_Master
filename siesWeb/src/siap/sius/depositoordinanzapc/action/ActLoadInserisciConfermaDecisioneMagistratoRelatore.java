...
public class ActLoadInserisciConfermaDecisioneMagistratoRelatore extends ActRicercaFSPuntuale
	...
	public String processRequest() throws Exception {
		...
		// Devono esistere 1) ordinanza applicazione MA DL 123/2018, 2) data esecutività e 3) data udienza
		...
		// c.p.p.) - Applica ex art. 678 comma 1 ter cpp
		...
		if (!existOrdinanzaApplicazioneProvvisoria)
			throw new SIUSException(SIUSException.USER_MESSAGE,
					"Operazione consentita solo se sul Procedimento sia stata emessa un'ordinanza di "
							+ "Applicazione M.A. DL 123/2018 con esito 'Applica ex art. 678 comma 1 ter cpp' "
		...
		// cerco i tenori dell'ordinanza di applicazione M.A. DL 123/2018
		...
		if (dimFinale == 0)
			throw new SIUSException(SIUSException.USER_MESSAGE,
					"Esito 'Applica ex art. 678 comma 1 ter cpp' assente!");
