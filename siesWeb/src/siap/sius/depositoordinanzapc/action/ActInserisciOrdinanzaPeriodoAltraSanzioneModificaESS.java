...
/**
 * ActInserisciOrdinanzaPeriodoAltraSanzioneModificaESS - Classe Action per l'inserimento dell'Emissione di
 * una Ordinanza, di un Periodo Altra Sanzione e modifica Esecuzione Sanzione Sostitutiva
 *
 * @version 1.0
 */
public class ActInserisciOrdinanzaPeriodoAltraSanzioneModificaESS extends ActInserisciOrdinanzaUDS
	...
	public OrdinanzaEventoTenoriGProcModel inserimento(OrdinanzaEventoTenoriGProcModel aOrdEveTenGP)
		...
		// Richiama la funzione di "util" per Inserire Periodo Altra Sanzione e Modifica Esecuzione Sanzione
		// Sostitutiva
		...
		lModRet = IDepOrdCtrl.ExInserisciOrdinanzaPeriodoAltraSanzioneModificaESS(aOrdEveTenGP, lPASMod,
				lEssM);
