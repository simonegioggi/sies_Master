...
/**
* <p>Title: DepositoOrdinanzaPcDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella DepositoOrdinanzaPc</p>
...
public class DepositoOrdinanzaPcDAO extends SIAPTableDAO
{
  ...
  // METODI GET()
  //
  public BigDecimal      getIdDepositoOrdinanzaPc()     throws DAOException  { return getBigDecimal("ID_DEPOSITO_ORDINANZA_PC"); }
  public BigDecimal      getAnnoS3()    throws DAOException  { return getBigDecimal("ANNO_S3"); }
  public BigDecimal      getNumS3()     throws DAOException  { return getBigDecimal("NUM_S3"); }
  ...
  public Date            getDataCameraConsiglio()     throws DAOException  { return getDate("DATA_CAMERA_CONSIGLIO"); }
  ...
  public BigDecimal      getIdCssaComp()    throws DAOException  { return getBigDecimal("ID_CSSA_COMP"); }
  public BigDecimal      getCodUssm()    throws DAOException  { return getBigDecimal("COD_USSM"); }
  public String          getCodUfficioMagistratoComp()    throws DAOException  { return getString("COD_UFFICIO_MAGISTRATO_COMP"); }
  public String          getLuogoSvolgimentoProva()     throws DAOException  { return getString("LUOGO_SVOLGIMENTO_PROVA"); }
  public String          getServizioTerapeuticoComp()     throws DAOException  { return getString("SERVIZIO_TERAPEUTICO_COMP"); }
  public BigDecimal      getNumGiorniDetenzioneDom()    throws DAOException  { return getBigDecimal("NUM_GIORNI_DETENZIONE_DOM"); }
  public BigDecimal      getNumMesiDetenzioneDom()    throws DAOException  { return getBigDecimal("NUM_MESI_DETENZIONE_DOM"); }
  public BigDecimal      getNumAnniDetenzioneDom()    throws DAOException  { return getBigDecimal("NUM_ANNI_DETENZIONE_DOM"); }
  public BigDecimal      getNumGiorniPermessoAccordati()    throws DAOException  { return getBigDecimal("NUM_GIORNI_PERMESSO_ACCORDATI"); }
  public BigDecimal      getNumGiorniRiduzionePena()    throws DAOException  { return getBigDecimal("NUM_GIORNI_RIDUZIONE_PENA"); }
  public BigDecimal      getNumGiorniRiduzioneUsufruiti()     throws DAOException  { return getBigDecimal("NUM_GIORNI_RIDUZIONE_USUFRUITI"); }
  public String          getCodUffTdsConcessoRiduzione()     throws DAOException  { return getString("COD_UFF_TDS_CONCESSO_RIDUZIONE"); }
  ...
  public String          getCodTipoOrdinanza()     throws DAOException  { return getString("COD_TIPO_ORDINANZA"); }
  // Nuovi campi 9-6-2004
  ...
  public Date       getDataInizioPeriodo()    throws DAOException  { return getDate("DATA_INIZIO_PERIODO"); }
  public String     getFlagEsistenzaReatoostativo()     throws DAOException  { return getString("FLAG_ESISTENZA_REATOOSTATIVO"); }
  public String     getFlagEspiazioneReatoostativo()    throws DAOException  { return getString("FLAG_ESPIAZIONE_REATOOSTATIVO"); }
  public String     getAutoritaVigilante()    throws DAOException  { return getString("AUTORITA_VIGILANTE"); }
  public Date       getDataTrasmissione()     throws DAOException  { return getDate("DATA_TRASMISSIONE"); }
  public Date             getDataCompFoglioComplementare()          throws DAOException  { return getDate("DATA_COMP_FOGLIO_COMPLEMENTARE"); }
  public BigDecimal      getNumGiorniArrestoRev()     throws DAOException  { return getBigDecimal("NUM_GIORNI_ARRESTO_REV"); }
  public BigDecimal      getNumMesiArrestoRev()     throws DAOException  { return getBigDecimal("NUM_MESI_ARRESTO_REV"); }
  public BigDecimal      getNumAnniArrestoRev()     throws DAOException  { return getBigDecimal("NUM_ANNI_ARRESTO_REV"); }
  public String getUlterioreDescrizione() throws DAOException { return getString("ULTERIORE_DESCRIZIONE"); }
  // Nuovi campi per Sospensione Sanzioni Sostitutive
  public Date           getDataSospensioneSS()    throws DAOException   { return getDate("DATA_SOSPENSIONE_SS"); }
  public BigDecimal       getGiorniRecuperoSS()   throws DAOException   { return getBigDecimal("GIORNI_RECUPERO_SS"); }
  public String         getFlagRecuperoSS()     throws DAOException   { return getString("FLAG_RECUPERO_SS"); }
  public Date           getDataScadenzaSospensioneSS()  throws DAOException { return getDate("DATA_SCADENZA_SOSPENSIONE_SS"); }
  public BigDecimal       getSospensioneGGSS()      throws DAOException { return getBigDecimal("SOSPENSIONE_GG"); }
  public BigDecimal       getSospensioneMMSS()      throws DAOException { return getBigDecimal("SOSPENSIONE_MM"); }
  public BigDecimal       getSospensioneAASS()      throws DAOException { return getBigDecimal("SOSPENSIONE_AA"); }

  public String         getFlagNominaComActa()  throws DAOException   { return getString("FLAG_NOMINA_COMM_ACTA"); }
  public String         getDescrCommActa()      throws DAOException   { return getString("DESCR_COMM_ACTA"); }

  //20140603 - P.M. ( SIUS - implemntazione per il D.L. 146 )  
  public String	 getCodTipoControlloEsecuzione() throws DAOException { return getString("TIPO_CONTROLLO_ESECUZIONE"); }
  // 10102014 - DL 92 2014 Violazione CEDU
  public BigDecimal	getSommaRisarcimento()	throws DAOException		{return getBigDecimal("SOMMA_RISARC_DANNI"); }
  
  
  //INIZIO: MEV_9 (D.lgs. 123/2018)
  public String	 getCkAttiPresidente()  throws DAOException { return getString("CK_ATTI_PRESIDENTE"); }
  public String	 getNoteAtti()          throws DAOException { return getString("NOTE_ATTI"); }
  public String	 getProcuraCompetente() throws DAOException { return getString("PROCURA_COMPETENTE"); }
  //FINE: MEV_9
  
  //
  // METODI SET()
  //
  public void    setIdDepositoOrdinanzaPc(BigDecimal aValore )       { setBigDecimal("ID_DEPOSITO_ORDINANZA_PC", aValore); }
  public void    setAnnoS3(BigDecimal aValore )        { setBigDecimal("ANNO_S3", aValore); }
  public void    setNumS3(BigDecimal aValore )       { setBigDecimal("NUM_S3", aValore); }
  public void    setOggettoProcedimento(String aValore )       { setString("OGGETTO_PROCEDIMENTO", aValore); }
  public void    setDataUdienza(Date aValore )       { setDate("DATA_UDIENZA", aValore); }
  public void    setDataCameraConsiglio(Date aValore )       { setDate("DATA_CAMERA_CONSIGLIO", aValore); }
  public void    setDataDeposito(Date aValore )        { setDate("DATA_DEPOSITO", aValore); }
  public void    setCodNaturaProvvedimento(String aValore )        { setString("COD_NATURA_PROVVEDIMENTO", aValore); }
  public void    setIdCssaComp(BigDecimal aValore )        { setBigDecimal("ID_CSSA_COMP", aValore); }
  public void    setCodUssm(BigDecimal aValore )        { setBigDecimal("COD_USSM", aValore); }
  public void    setCodUfficioMagistratoComp(String aValore )        { setString("COD_UFFICIO_MAGISTRATO_COMP", aValore); }
  public void    setLuogoSvolgimentoProva(String aValore )       { setString("LUOGO_SVOLGIMENTO_PROVA", aValore); }
  public void    setServizioTerapeuticoComp(String aValore )       { setString("SERVIZIO_TERAPEUTICO_COMP", aValore); }
  public void    setNumGiorniDetenzioneDom(BigDecimal aValore )        { setBigDecimal("NUM_GIORNI_DETENZIONE_DOM", aValore); }
  public void    setNumMesiDetenzioneDom(BigDecimal aValore )        { setBigDecimal("NUM_MESI_DETENZIONE_DOM", aValore); }
  public void    setNumAnniDetenzioneDom(BigDecimal aValore )        { setBigDecimal("NUM_ANNI_DETENZIONE_DOM", aValore); }
  public void    setNumGiorniPermessoAccordati(BigDecimal aValore )        { setBigDecimal("NUM_GIORNI_PERMESSO_ACCORDATI", aValore); }
  public void    setNumGiorniRiduzionePena(BigDecimal aValore )        { setBigDecimal("NUM_GIORNI_RIDUZIONE_PENA", aValore); }
  public void    setNumGiorniRiduzioneUsufruiti(BigDecimal aValore )       { setBigDecimal("NUM_GIORNI_RIDUZIONE_USUFRUITI", aValore); }
  public void    setCodUffTdsConcessoRiduzione(String aValore )        { setString("COD_UFF_TDS_CONCESSO_RIDUZIONE", aValore); }
  ...
  public void    setCodTipoOrdinanza(String aValore )        { setString("COD_TIPO_ORDINANZA", aValore); }
  // Nuovi campi 9-6-2004
  ...
  public void    setDataInizioPeriodo(Date aValore )       { setDate("DATA_INIZIO_PERIODO", aValore); }
  public void    setFlagEsistenzaReatoostativo(String aValore )   { setString("FLAG_ESISTENZA_REATOOSTATIVO", aValore); }
  public void    setFlagEspiazioneReatoostativo(String aValore )  { setString("FLAG_ESPIAZIONE_REATOOSTATIVO", aValore); }
  public void    setAutoritaVigilante(String aValore )       { setString("AUTORITA_VIGILANTE", aValore); }
  public void    setDataTrasmissione(Date aValore )        { setDate("DATA_TRASMISSIONE", aValore); }
  public void    setDataCompFoglioComplementare(Date aValore )            { setDate("DATA_COMP_FOGLIO_COMPLEMENTARE", aValore); }
  public void    setNumGiorniArrestoRev(BigDecimal aValore )       { setBigDecimal("NUM_GIORNI_ARRESTO_REV", aValore); }
  public void    setNumMesiArrestoRev(BigDecimal aValore )       { setBigDecimal("NUM_MESI_ARRESTO_REV", aValore); }
  public void    setNumAnniArrestoRev(BigDecimal aValore )       { setBigDecimal("NUM_ANNI_ARRESTO_REV", aValore); }
  public void    setUlterioreDescrizione(String aValore) { setString("ULTERIORE_DESCRIZIONE", aValore); }
  // Nuovi campi per Sospensione Sanzioni Sostitutive
  public void    setDataSospensioneSS(Date aValore)       { setDate("DATA_SOSPENSIONE_SS", aValore); }
  public void  setGiorniRecuperoSS(BigDecimal aValore)    { setBigDecimal("GIORNI_RECUPERO_SS", aValore); }
  public void    setFlagRecuperoSS(String aValore)        { setString("FLAG_RECUPERO_SS", aValore); }
  public void    setDataScadenzaSospensioneSS(Date aValore)   { setDate("DATA_SCADENZA_SOSPENSIONE_SS", aValore); }
  public void  setSospensioneGGSS(BigDecimal aValore)     { setBigDecimal("SOSPENSIONE_GG", aValore); }
  public void  setSospensioneMMSS(BigDecimal aValore)     { setBigDecimal("SOSPENSIONE_MM", aValore); }
  public void  setSospensioneAASS(BigDecimal aValore)     { setBigDecimal("SOSPENSIONE_AA", aValore); }

  public void    setFlagNominaComActa (String aValore)    { setString("FLAG_NOMINA_COMM_ACTA", aValore); }
  public void    setDescrCommActa     (String aValore)    { setString("DESCR_COMM_ACTA", aValore); }

  //20140603 - P.M. ( SIUS - Implementazione per il D.L. 146 )
  public void setCodTipoControlloEsecuzione(String aValore) { setString("TIPO_CONTROLLO_ESECUZIONE", aValore); }
// 10102014 - DL 92 2014 Violazione CEDU
  public void setSommaRisarcimento(BigDecimal aValore)	{ setBigDecimal("SOMMA_RISARC_DANNI", aValore); }

  
  //INIZIO: MEV_9 (D.lgs. 123/2018)
  public void setCkAttiPresidente  (String aValore) {  setString("CK_ATTI_PRESIDENTE",aValore); }
  public void setNoteAtti          (String aValore) {  setString("NOTE_ATTI",aValore); }
  public void setProcuraCompetente (String aValore) {  setString("PROCURA_COMPETENTE",aValore); }
  //FINE: MEV_9
  
  public GenericModel getModel() throws DAOException
  {
    return new DepositoOrdinanzaPcModel(
       getIdDepositoOrdinanzaPc() ,
       getAnnoS3() ,
       getNumS3() ,
       getOggettoProcedimento() ,
       getDataUdienza() ,
       getDataCameraConsiglio() ,
       getDataDeposito() ,
       ...
       getServizioTerapeuticoComp() ,
       getNumGiorniDetenzioneDom() ,
       getNumMesiDetenzioneDom() ,
       getNumAnniDetenzioneDom() ,
       getNumGiorniPermessoAccordati() ,
       getNumGiorniRiduzionePena() ,
       getNumGiorniRiduzioneUsufruiti() ,
       ...
       getFlagEsistenzaReatoostativo() ,
       getFlagEspiazioneReatoostativo() ,
       getAutoritaVigilante() ,
       getDataTrasmissione(),
       getDataCompFoglioComplementare(),
       getNumGiorniArrestoRev() ,
       getNumMesiArrestoRev() ,
       getNumAnniArrestoRev(),
...
// 10102014 - DL 92 2014 Violazione CEDU 
  ...
  * del model DepositoOrdinanzaPcModel passato.
  * @param aModel
  */
