...
/**
* <p>Title: IspEstrazioneOggettiTribDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella IspEstrazioneOggettiTrib</p>
...
public class IspEstrazioneOggettiTribDAO extends TableDAO 
{
  ...
  //
			...
			public Date 			getTenDataIns() 		throws DAOException	 { return getDate("TEN_DATA_INS"); } 
			...
			public String 			getDefinito() 		throws DAOException	 { return getString("DEFINITO"); } 
  ...
  //
			...
			public void  	 setTenDataIns(Date aValore ) 			 { setDate("TEN_DATA_INS", aValore); } 
			...
			public void  	 setDefinito(String aValore ) 			 { setString("DEFINITO", aValore); } 


	public GenericModel getModel() throws DAOException
  			 { 
 				 return new IspEstrazioneOggettiModel(  
								 ...
								 decodificaEsitoStatistica(getCodEsitoStatistica()),
								 getDataDeposito() , 
								 getDefinito()  
								);
	...
	/**
	 * Imposta la condizione per l'estrazione delle occorrenze per un insieme di oggetti.
	 * l'eknco degli oggetti sono separati da ",". 
	 * <p>
	 * @param aModel
	 */
	...
	public void setCondizioneTenDataFineCancellati(String lCodUfficio, String lCodMagistrato, Date lDataIni, Date lDataFine)
	{
		String lCondizioni = ""; 
