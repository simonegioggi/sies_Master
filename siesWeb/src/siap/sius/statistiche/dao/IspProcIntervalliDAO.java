...
/**
* <p>Title: IspProcIntervalliDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella IspProcIntervalli</p>
...
public class IspProcIntervalliDAO extends TableDAO 
{
  ...
  //
			...
			public BigDecimal 		 getFasSiuChiaveAnno() 		throws DAOException	 { return getBigDecimal("FAS_SIU_CHIAVE_ANNO"); } 
			public String 				 getFasSiuChiaveUfficio() 		throws DAOException	 { return getString("FAS_SIU_CHIAVE_UFFICIO"); } 
			public BigDecimal 		 getFasSiuChiaveProgr() 		throws DAOException	 { return getBigDecimal("FAS_SIU_CHIAVE_PROGR"); } 
			public String 				 getFasSiuCodStatoFascicolo() 		throws DAOException	 { return getString("FAS_SIU_COD_STATO_FASCICOLO"); } 
			public Date 					 getFasSiuDataIscrizione() 		throws DAOException	 { return getDate("FAS_SIU_DATA_ISCRIZIONE"); } 
			public Date 					 getFasSiuDataDefinizione() 		throws DAOException	 { return getDate("FAS_SIU_DATA_DEFINIZIONE"); } 
			...
			public Date 					 getTenData() 		throws DAOException	 { return getDate("TEN_DATA"); } 
			public Date 					 getTenDataFine() 		throws DAOException	 { return getDate("TEN_DATA_FINE"); } 
			public String 				 getCodEsitoStatistica() 		throws DAOException	 { return getString("COD_ESITO_STATISTICA"); } 
			...
			public Date 					 getDataPrimaUdienza() 		throws DAOException	 { return getDate("DATA_PRIMA_UDIENZA"); } 
			public Date 					 getDataUltimaUdienza() 		throws DAOException	 { return getDate("DATA_ULTIMA_UDIENZA"); } 
			...
			public BigDecimal 		 getTempoDecisioneDeposito() 		throws DAOException	 { return getBigDecimal("TEMPO_DECISIONE_DEPOSITO"); } 
			public BigDecimal 		 getTepoRicezioneFissazione1() 		throws DAOException	 { return getBigDecimal("TEPO_RICEZIONE_FISSAZIONE1"); } 
			public BigDecimal 		 getTempoFissazione2Deposito() 		throws DAOException	 { return getBigDecimal("TEMPO_FISSAZIONE2_DEPOSITO"); } 
			public BigDecimal 		 getTempoRicezioneDeposito() 		throws DAOException	 { return getBigDecimal("TEMPO_RICEZIONE_DEPOSITO"); } 
  ...
  //
			...
			public void  	 setFasSiuChiaveAnno(BigDecimal aValore ) 			 { setBigDecimal("FAS_SIU_CHIAVE_ANNO", aValore); } 
			public void  	 setFasSiuChiaveUfficio(String aValore ) 			 { setString("FAS_SIU_CHIAVE_UFFICIO", aValore); } 
			public void  	 setFasSiuChiaveProgr(BigDecimal aValore ) 			 { setBigDecimal("FAS_SIU_CHIAVE_PROGR", aValore); } 
			public void  	 setFasSiuCodStatoFascicolo(String aValore ) 			 { setString("FAS_SIU_COD_STATO_FASCICOLO", aValore); } 
			public void  	 setFasSiuDataIscrizione(Date aValore ) 			 { setDate("FAS_SIU_DATA_ISCRIZIONE", aValore); } 
			public void  	 setFasSiuDataDefinizione(Date aValore ) 			 { setDate("FAS_SIU_DATA_DEFINIZIONE", aValore); } 
			...
			public void  	 setTenData(Date aValore ) 			 { setDate("TEN_DATA", aValore); } 
			public void  	 setTenDataFine(Date aValore ) 			 { setDate("TEN_DATA_FINE", aValore); } 
			public void  	 setCodEsitoStatistica(String aValore ) 			 { setString("COD_ESITO_STATISTICA", aValore); } 
			...
			public void  	 setDataPrimaUdienza(Date aValore ) 			 { setDate("DATA_PRIMA_UDIENZA", aValore); } 
			public void  	 setDataUltimaUdienza(Date aValore ) 			 { setDate("DATA_ULTIMA_UDIENZA", aValore); } 
			...
			public void  	 setTempoDecisioneDeposito(BigDecimal aValore ) 			 { setBigDecimal("TEMPO_DECISIONE_DEPOSITO", aValore); } 
			public void  	 setTepoRicezioneFissazione1(BigDecimal aValore ) 			 { setBigDecimal("TEPO_RICEZIONE_FISSAZIONE1", aValore); } 
	...
	public GenericModel getModel() throws DAOException
  			 { 
 				 return new IspProcIntervalliModel(  
								 ...
								 getFasSiuChiaveProgr() , 
								 getFasSiuCodStatoFascicolo() , 
								 getFasSiuDataIscrizione() , 
								 getFasSiuDataDefinizione() , 
								 getCodOggettoTenore() , 
							   ...
							   //DecodificheUtils.getDescbyCode(DecodificheManager.getInstance().getEsitoProvvedimento(), getCodEsitoTenore()),
								 ...
								 getTenData() , 
								 getTenDataFine() , 
								 getCodEsitoStatistica() , 
								 "",
								 getDescContenutoStatis() , 
								 getDataRicezione() , 
								 getDataPrimaUdienza() , 
								 getDataUltimaUdienza() , 
								 getDataDecisione() , 
								 getDataDeposito() , 
								 getTempoDecisioneDeposito() , 
								 getTepoRicezioneFissazione1() , 
								 getTempoFissazione2Deposito() , 
...
*/
	...
	/**
	 * 20131124 - gestione di eventuale ordinamento .... ( tbv )
	 * <p>
	 * @param aModel
	 */
