 ...
 * rappresentate dall'Ancestor anche la tabella DEPOSITO_SENTENZA.
 * </p>
 * *
 * <p>
...
public class EveFasGepSogSenSqlDAO extends EveFasGepSogSqlDAO {
	// [FT] - 03/08/2016 - MAC_LOG - Dichiaro un'istanza di Logger per SIESLog
	private static Logger siesLogger = Logger.getLogger(LogF3B.SIES_LOG);
	public EveFasGepSogSenSqlDAO(Connection con) {
		super(con);
	}
	...
	protected String getSqlQuery() {
		String lStatement = getSqlQuerySelect() + ", " + getSqlQueryDepositoSentenza() + ", "
				+ getSqlQueryEsperto() + getSqlQueryFromJoinDepOrd() + getSqlQueryJoin("01");
	...
	public GenericModel getModel() throws DAOException {
		...
		EveFasGepSogProvModel lModel = new EveFasGepSogProvModel(lAncestorModel, getDepositoSentenzaModel());
		return lModel;
	};

	private DepositoSentenzaModel getDepositoSentenzaModel() throws DAOException {
		// Lettura dei campi dalla tabella DEPOSITO_SENTENZA

		DepositoSentenzaModel lOrdinanza = new DepositoSentenzaModel();
		lOrdinanza.setIdDepositoSentenza(getBigDecimal("ID_DEPOSITO_SENTENZA"));
		lOrdinanza.setAnnoSentenza(getBigDecimal("ANNO_SENTENZA"));
		lOrdinanza.setNumSentenza(getBigDecimal("NUM_SENTENZA"));
	...
	protected String getSqlQueryDepositoSentenza() {
		...
		lStatement += " DO.ID_DEPOSITO_SENTENZA, " + "DO.COD_MAGISTRATO, " + "DO.ANNO_SENTENZA, "
				+ "DO.NUM_SENTENZA, " + "DO.DATA_DEPOSITO ";
		// "DO.TIPO_CONTROLLO_ESECUZIONE ";
		return lStatement;
	}

	private String setOrderbyAnnoNum() {
		String lStatement = " ORDER BY  ANNO_SENTENZA ASC, NUM_SENTENZA ASC";
		return lStatement;
	}
	...
	protected String setCondizioniOrdinanza(RicercaOrdinanzaModel aModel) {
		...
		// aModel.getTipiControlliEsecuzione()[0] != null && aModel.getTipiControlliEsecuzione()[1] != null) {
