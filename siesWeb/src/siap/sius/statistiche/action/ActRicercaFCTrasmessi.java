...
/**
 * <p>
 * Title: ActRicercaFCTrasmessi
 * </p>
 * <p>
 * Description: Classe Action per la ricerca Fogli Complemenatri Trasmessi
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActRicercaFCTrasmessi extends ActionSiap implements ICostantiStatistiche {
	...
	public String processRequest() throws Exception {
		...
		String lReturnPage = PG_ELENCO_FOGLI_COMPLEMENTARI;
	...
	private void letturaFiltro() throws Exception {
		...
		// Lettura del tipo di Intervallo di Rcerca
	...
	private void letturaDate() throws Exception {
		...
		if (mRicercaModel.isRicercaXDateEmissione()) {
