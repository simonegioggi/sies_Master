...
import siap.sius.statistiche.util.excel.ProcAggregatiPerProcuraMittenteExcel;
import f3b.log.LogF3B;
import f3b.web.IWebConstants;


public class ActRicercaProcAggregatiPerProcuraMittenteExcel extends ActionSiap implements 
    ...
    public String processRequest() throws Exception {
        ...
        lDataIniziale = getRequestDateParameter(CAMPO_ANNO_INIZIALE, CAMPO_MESE_INIZIALE, CAMPO_GIORNO_INIZIALE);
        ...
        lFileOut = lStatis.creaExcelProcProcuraMittente(lRicercaModel);
        */
        
        ProcAggregatiPerProcuraMittenteExcel lExcel = new ProcAggregatiPerProcuraMittenteExcel();
        lFileOut = lExcel.creaExcelProcProcuraMittente(lRicercaModel);
