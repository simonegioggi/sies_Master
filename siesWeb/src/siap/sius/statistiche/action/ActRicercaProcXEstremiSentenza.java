...
/**
 * <p>
 * Title: ActRicercaProcXEstremiSentenza
 * </p>
 * <p>
 * Description: Classe Action per la ricerca di EstremiSentenza da Anno, Num e codice Ufficio di Inserimento
 * </p>
 * 
 * @version 1.0
 */
public class ActRicercaProcXEstremiSentenza extends ActionSiap implements ICostantiStatistiche {
	...
	public String processRequest() throws Exception {
		...
		if (!isRequestParameterNullObj("Stampa")) {
			...
			// pagina risultato.
			// Nello stesso model viene valorizzata la descrizione di calcoli statistici sulla ricerca
			// effettuata.
