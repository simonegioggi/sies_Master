...
/**
 * <p>
 * Title: ActRicercaFCDaTrasmettere
 * </p>
 * <p>
 * Description: Classe Action per la ricerca Fogli Complementari non ancora trasmessi; cioè tutte le ordinanze
 * per cui è necessaria la creazione e la trasmissione dei Fogli Complementari, per cui esiste un codice
 * univoco (oggetto, motivo ed esito) che la identifica ma che, per la quale, tale operazione ancora non è
 * avvenuta.
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActRicercaFCDaTrasmettere extends ActionSiap implements ICostantiStatistiche {
	...
	public String processRequest() throws Exception {
		...
		String lReturnPage = PG_ELENCO_FC_DA_TRASMETTERE;
	...
	private void letturaFiltro() throws Exception {
		...
		String lModalitàRicera = getRequestStringParameter(CAMPO_MODALITA_RICERCA);
		if (lModalitàRicera != null && lModalitàRicera.trim().length() > 0)
			mRicercaModel.setModalitaRicerca(lModalitàRicera);
