...
public class ActRicercaFSPModelliSentenza extends ActRicercaFSPuntuale
	implements ICostantiDepositoSentenza
{
  public String processRequest() throws Exception
  {
    ...
    // Esegue controllo che il controllo della Data Camera di consiglio
    // venga eseguito solo per TDS.
    ...
    return PG_ELENCOSTAMPEMODELLISENTENZA;
  }
}
