...
* di una Sentenza di rimessione atti </p>
* <p>Company: Engineering S.p.A.</p>
* @version 1.0
*/
public class ActCancellaRimessioneAtti extends ActionSiap implements ICostantiDepositoSentenza
{
  public String processRequest() throws Exception
  {
    ...
    // Cancellazione
    lCtrl.ExCancellaRimessioneAtti(lDepSen);
   ...
   nextAct = "siap.sius.depositosentenza.action.ActLoadFSPRimessioneAtti";
