 ...
 * @version 1.0
 */
public class ActStampaModRiabilitazione extends ActionSiap implements ICostantiDepositoSentenza
{
  ...
  public String processRequest() throws Exception
  {
    ...
    lEveMod.setNomeTemplate(TEMPLATE_MOD_SENTENZA_RIABILITAZIONE);
