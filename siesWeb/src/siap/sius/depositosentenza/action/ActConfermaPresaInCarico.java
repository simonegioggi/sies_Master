 ...
 * <p>Description: Prende in Carico la Sentenza</p>
 */
public class ActConfermaPresaInCarico extends ActionSiap implements ICostantiJMS
{
  public String processRequest() throws Exception
  {
    ...
    LockModel lck =
    lockIfNotLocked("caricosentenza", getRequestStringParameter(ICostantiMessaggio.CAMPO_ID_MESSAGGIO), getCodUtenteConnesso());
    if (lck != null)
    {
      setRequestAttribute (IWebConstants.MESSAGE_TEXT, "La presa in carico di questa sentenza è in gestione ad un altro utente! <BR>Riprovare più tardi!");
...
//    {
    ...
    */
      ...
      MessaggioModel lMessReturn  = lPres.ExPresaInCaricoSentenza(lMessIns, lMisAlt);
...
//    }
    ...
    lMessage.setCodTipoOperazione(ESITO_TRASFERIMENTO_SENTENZA);
    lMessage.setCodiceUtenteMittente(this.getCodUtenteConnesso());
    ...
    setRequestAttribute(IWebConstants.MESSAGE_TEXT, "Ricezione Sentenza Completata e Esito rispedito al Mittente!");
   ...
   //----------------------------------------------------------------------------/
    ...
    lRedirigi.setAction("siap.sius.depositosentenza.action.ActListaSentenzaRicevute&FlagConfermaPresaInCarico=s");
