...
public class GeneraleProcedimentoDAO extends SIAPTableDAO
{
  ...
  public BigDecimal getIdGeneraleProcedimento() 	  throws DAOException	 { return getBigDecimal("ID_GENERALE_PROCEDIMENTO"); }
  public BigDecimal getAnnoS1() 		                throws DAOException	 { return getBigDecimal("ANNO_S1"); }
  public BigDecimal getProgrS1() 		                throws DAOException	 { return getBigDecimal("PROGR_S1"); }
  public String 	  getCodTipoRegistro() 		        throws DAOException	 { return getString("COD_TIPO_REGISTRO"); }
  ...
  public String 	  getDescrRichiestaDelegazione() 	throws DAOException	 { return getString("DESCR_RICHIESTA_DELEGAZIONE"); }
  public String 	  getCodAutoritaDelegata() 	      throws DAOException	 { return getString("COD_AUTORITA_DELEGATA"); }
  public Date 		  getDataRestituzDelegazione() 	  throws DAOException	 { return getDate("DATA_RESTITUZ_DELEGAZIONE"); }
  public Date 		  getDataRicorsoImpugn() 		      throws DAOException	 { return getDate("DATA_RICORSO_IMPUGN"); }
  public Date 		  getDataInvioAttiImpugn() 	      throws DAOException	 { return getDate("DATA_INVIO_ATTI_IMPUGN"); }
  public Date 		  getDataInvioEsecuzProvvisoria() throws DAOException	 { return getDate("DATA_INVIO_ESECUZ_PROVVISORIA"); }
  public Date 		  getDataInvioEsecuzOrdinaria() 	throws DAOException	 { return getDate("DATA_INVIO_ESECUZ_ORDINARIA"); }
  public Date 		  getDataCompilazComplementare() 	throws DAOException	 { return getDate("DATA_COMPILAZ_COMPLEMENTARE"); }
  public String 	  getCodTipoFoglioComplementare() throws DAOException	 { return getString("COD_TIPO_FOGLIO_COMPLEMENTARE"); }
  ...
  public String 	  getDescrTipoAtto() 	            throws DAOException	 { return getString("DESCR_TIPO_ATTO"); }
  public String 	  getCodSedeMittente() 	          throws DAOException	 { return getString("COD_SEDE_MITTENTE"); }
  public String 	  getDescrSedeMittente() 	        throws DAOException	 { return getString("DESCR_SEDE_MITTENTE"); }
  public String 	  getCodTipoMittenteAtto()        throws DAOException	 { return getString("COD_TIPO_MITTENTE_ATTO"); }
  public String 	  getDescrTipoMittenteAtto()      throws DAOException	 { return getString("DESCR_TIPO_MITTENTE_ATTO"); }
  public BigDecimal	  getIdFascicoloSius()            throws DAOException	 { return getBigDecimal("FAS_SIU_ID_FASCICOLO_SIUS"); }
  public String 	  getSezione() 		                throws DAOException	 { return getString("SEZIONE"); }
  public Date    	  getDataFinePena() 		          throws DAOException	 { return getDate("DATA_FINE_PENA"); }
  public String 	  getCodPosGiuridica()	          throws DAOException	 { return getString("COD_POSIZIONE_GIURIDICA"); }
  public String 	  getDescrPosGiuridica()	        throws DAOException	 { return getString("DESCR_POSIZIONE_GIURIDICA"); }
  ...
  // METODI SET()
  //
  public void setIdGeneraleProcedimento(BigDecimal aValore )  { setBigDecimal("ID_GENERALE_PROCEDIMENTO", aValore); }
  public void setAnnoS1(BigDecimal aValore ) 			            { setBigDecimal("ANNO_S1", aValore); }
  public void setProgrS1(BigDecimal aValore ) 			          { setBigDecimal("PROGR_S1", aValore); }
  public void setCodTipoRegistro(String aValore ) 		        { setString("COD_TIPO_REGISTRO", aValore); }
  ...
  public void setDescrRichiestaDelegazione(String aValore ) 	{ setString("DESCR_RICHIESTA_DELEGAZIONE", aValore); }
  public void setCodAutoritaDelegata(String aValore ) 		    { setString("COD_AUTORITA_DELEGATA", aValore); }
  public void setDataRestituzDelegazione(Date aValore ) 	    { setDate("DATA_RESTITUZ_DELEGAZIONE", aValore); }
  public void setDataRicorsoImpugn(Date aValore ) 		        { setDate("DATA_RICORSO_IMPUGN", aValore); }
  public void setDataInvioAttiImpugn(Date aValore ) 		      { setDate("DATA_INVIO_ATTI_IMPUGN", aValore); }
  public void setDataInvioEsecuzProvvisoria(Date aValore ) 	  { setDate("DATA_INVIO_ESECUZ_PROVVISORIA", aValore); }
  public void setDataInvioEsecuzOrdinaria(Date aValore ) 	    { setDate("DATA_INVIO_ESECUZ_ORDINARIA", aValore); }
  public void setDataCompilazComplementare(Date aValore ) 	  { setDate("DATA_COMPILAZ_COMPLEMENTARE", aValore); }
  public void setCodTipoFoglioComplementare(String aValore ) 	{ setString("COD_TIPO_FOGLIO_COMPLEMENTARE", aValore); }
  ...
  public void setDescrTipoAtto(String aValore )               { setString("DESCR_TIPO_ATTO", aValore); }
  public void setCodSedeMittente(String aValore )             { setString("COD_SEDE_MITTENTE", aValore); }
  public void setDescrSedeMittente(String aValore )           { setString("DESCR_SEDE_MITTENTE", aValore); }
  public void setCodTipoMittenteAtto(String aValore )         { setString("COD_TIPO_MITTENTE_ATTO", aValore); }
  public void setDescrTipoMittenteAtto(String aValore )       { setString("DESCR_TIPO_MITTENTE_ATTO", aValore); }
  public void setIdFascicoloSius(BigDecimal aValore )         { setBigDecimal("FAS_SIU_ID_FASCICOLO_SIUS", aValore); }
  public void setSezione(String aValore )                     { setString("SEZIONE", aValore); }
  public void setDataFinePena(Date aValore )                  { setDate("DATA_FINE_PENA", aValore); }
  public void setCodPosGiuridica(String aValore )             { setString("COD_POSIZIONE_GIURIDICA", aValore); }
  public void setDescrPosGiuridica(String aValore )           { setString("DESCR_POSIZIONE_GIURIDICA", aValore); }
  ...
  {
    return new GeneraleProcedimentoModel(getIdGeneraleProcedimento() ,
                                         getAnnoS1() ,
                                         getProgrS1() ,
                                         getCodTipoRegistro() ,
                                         "",
                                         ...
                                         getDescrRichiestaDelegazione() ,
                                         getCodAutoritaDelegata() ,
                                         "",
                                         getDataRestituzDelegazione() ,
                                         getDataRicorsoImpugn() ,
                                         getDataInvioAttiImpugn() ,
                                         getDataInvioEsecuzProvvisoria() ,
                                         getDataInvioEsecuzOrdinaria() ,
                                         getDataCompilazComplementare() ,
                                         getCodTipoFoglioComplementare() ,
                                         "",
                                         getDataAnnotazione() ,
                                         getAnnotazione() ,
                                         getTipoDefinizione() ,
                                         ...
                                         getDescrTipoAtto(),
                                         getCodSedeMittente(),
                                         getDescrSedeMittente(),
                                         getCodTipoMittenteAtto(),
                                         getDescrTipoMittenteAtto(),
                                         getIdFascicoloSius(),
                                         getSezione(),
                                         getDataFinePena(),
                                         getCodPosGiuridica(),
                                         getDescrPosGiuridica(),
                                         getUdiIdUdienza(),
                                         "",
                                         "",
                                         getDescrMittente(),
 ...
 public void  setDAOFromModelForUpdateParziale(GeneraleProcedimentoModel aModel) throws DAOException
  ...
  /**
   * Verifica se esiste un record che abbia a fronte di un idGeneraleProcedimento con l'id udienza
   * passata anch'essa come parametro.
   * <p>
   * @param aIdGenProc valore id generale procedimento.
   * @param aIdUdi valore id udienza.
