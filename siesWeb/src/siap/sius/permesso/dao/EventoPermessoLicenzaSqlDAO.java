...
/**
* <p>Title: EventoPermessoLicenzaSqlDAO</p>
* <p>Description: Classe SqlDAO che rappresenta la tabella EventoPermessoLicenza</p>
...
public class EventoPermessoLicenzaSqlDAO extends SqlDAO 
{
   ...
   */
   ...
   {      
     ...
     lStatement += " SELECT " +
                     ...
                     " COD_TIPO_EVENTO, " +
                     " TE.RV_MEANING AS DESCR_TIPO_EVENTO, " +
                     " DATA_SEGNALAZIONE, " + 
                     " DESCR_EVENTO, " +
                     " MITTENTE_SEGNALAZIONE, " + 
                     " COD_TIPO_CONSEGUENZA, " +
                     " TC.RV_MEANING AS DESCR_TIPO_CONSEGUENZA, " +
                     " DESCR_CONSEGUENZE, " +
  ...
  //
   ...
   /*
   public String  setCondizione(EventoPermessoLicenzaModel aModel)
   {
