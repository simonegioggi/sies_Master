...
public class PermessoSqlDAO extends SIAPSqlDAO {
	...
	protected String getPermessoLicenzaSqlQuery() {
		...
		String lQuery = "SELECT DD.ID_DEPOSITO_DECRETO, DD.DATA_DEPOSITO,"
				...
				+ ", LL.COD_MOTIVO_DETENZIONE, MD.RV_MEANING DESCR_MOTIVO_DETENZIONE"
				+ " FROM LICENZA_LIBANTICIPATA LL"
				+ " INNER JOIN EVENTO EV ON EV.ID_EVENTO = LL.EVE_ID_EVENTO"
				...
				+ " AND NVL(EV.COD_MOTIVO, '-') = MOTIVO_PROVVEDIMENTO.RV_LOW_VALUE"
				// MEV_2025-48: aggiunto campo in estrazione
				+ " left outer JOIN CG_REF_CODES MD ON MD.RV_LOW_VALUE = COD_MOTIVO_DETENZIONE"
				+ " AND MD.RV_DOMAIN = 'MOTIVO_DETENZIONE' WHERE";
		return lQuery;
	}
	...
	public String setGroupBy() {
		...
		return " GROUP BY DD.ID_DEPOSITO_DECRETO, DD.DATA_DEPOSITO, SG.NOME, SG.COGNOME,"
				...
				+ " LL.COD_MOTIVO_DETENZIONE, MD.RV_MEANING," // MEV_2025-48: aggiunti campi in estrazione
	...
	public GenericModel getDepositoDecretoMotivazioniLicenzaModel() throws DAOException {
		...
		// MEV_2025-48: estratto nuovi campi
		lDepDecrMotLic.getLicenza().setCodMotivoDetenzione(getString("COD_MOTIVO_DETENZIONE"));
		lDepDecrMotLic.getLicenza().setDescrMotivoDetenzione(getString("DESCR_MOTIVO_DETENZIONE"));
	...
	public GenericModel getProvvedimentoPermessoLicenzaModel() throws DAOException {
		...
		lModel.getLicenza().setDescrMotivoDetenzione(getString("DESCR_MOTIVO_DETENZIONE"));
