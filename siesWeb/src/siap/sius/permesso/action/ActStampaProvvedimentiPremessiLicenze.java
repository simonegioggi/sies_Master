...
/**
 * <p>Title: ActStampaProvvedimentiPremessiLicenze </p>
 * <p>Description: Classe Azione responsabile della richiesta stampa
 *  elenco provvedimenti permessi o licenza.
 * </p>
 ...
 * @version 1.0
 */
public class ActStampaProvvedimentiPremessiLicenze extends ActionSius
implements ICostantiPermesso
{
  ...
  public String processRequest() throws Exception
  {
    ...
    Date lDataIniziale = 
      super.getRequestDateParameter( ICostantiDepositoDecreto.CAMPO_ANNO_DATA_DEPOSITO_INIZIALE,
                                     ICostantiDepositoDecreto.CAMPO_MESE_DATA_DEPOSITO_INIZIALE,
                                     ICostantiDepositoDecreto.CAMPO_GIORNO_DATA_DEPOSITO_INIZIALE ); 
    
    Date lDataFinale = 
      super.getRequestDateParameter( ICostantiDepositoDecreto.CAMPO_ANNO_DATA_DEPOSITO_FINALE,
                                     ICostantiDepositoDecreto.CAMPO_MESE_DATA_DEPOSITO_FINALE,
                                     ICostantiDepositoDecreto.CAMPO_GIORNO_DATA_DEPOSITO_FINALE );
    
    String lTipoRicerca =
      super.getRequestStringParameter( "tipoRicerca" );
    
    
    CriteriRicercaProvPermessiLicenzeModel lCriteri = 
      new CriteriRicercaProvPermessiLicenzeModel(); 
