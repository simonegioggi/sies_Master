...
/**
 * <p>Title: ActModificaEventoPermessoLicenza</p>
 * <p>Description: Classe Action per la Modifica Evento Permesso</p> 
 */
public class ActModificaEventoPermessoLicenza extends ActionSius
implements ICostantiEventoPermessoLicenza
{
  ...
  {    
    ...
    lModelEPL.setIdEventoPermessoLicenza( getRequestBigDecimalParameter( CAMPO_ID_EVENTO_PERMESSO_LICENZA ) );
    lModelEPL.setLicIdLicenzaLibAnticipata( getRequestBigDecimalParameter( CAMPO_LIC_ID_LICENZA_LIBANTICIPATA ) );
    lModelEPL.setCodOperatoreAggiornamento(super.getCodUtenteConnesso());
    lModelEPL.setCodUfficioAggiornamento(super.getCodUfficioUtenteConnesso());
    lModelEPL.setDataAggiornamento( DateUtils.getSysDate() );
    ...
    lCtrlEPL.ExModificaEventoPermessoLicenza( lModelEPL );    
