...
public class ActLoadDettaglioEsecuzionePermesso extends ActRicercaFSPuntuale
	...
	public String processRequest() throws Exception {
		...
		DepositoDecretoMotivazioniLicenzaModel lPermDepDecr = lCtrlPerm
				.ExRicercaPermessoDepositato(lIDFasSius);

		if (lPermDepDecr == null)
			throw new F3BException(F3BException.USER_MESSAGE,
					"Per il Procedimento indicato non risulta depositato un decreto "
							+ "di concessione permesso.\n" + "Operazione non consentita.");

		String lCodUfficioIns = lPermDepDecr.getLicenza().getCodUfficioInserimento();

		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug(">>>> lCodUfficioIns : " + lCodUfficioIns);
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug(">>>> getCodUfficioUtenteConnesso() : " + getCodUfficioUtenteConnesso());
