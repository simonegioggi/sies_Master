 ...
 * </p>
 * <p>
 * Description: Ricerca dei Procedimenti relativi a licenze (rispondenti ai parametri selezionati) del
...
public class ActRicercaLicenzeDelSoggetto extends ActionSiap implements ICostantiFascicoloSius {
	...
	public String processRequest() throws Exception {
		...
		String codLicenza = getRequestStringParameter("hcodLicenza");
		String descrLicenza = getRequestStringParameter("hdescrLicenza");
		...
		Vector lLicenzeSoggetto = lPermCtrl.ExRicercaLicenzeDelSoggetto(lSogMod, ufUtConnesso, ufOTribunale,
				codDistretto, lIncludeRigettati, codLicenza,
		...
		if (lLicenzeSoggetto != null) {
			SoggettoModel lSoggetto = ((LicenzaModel) lLicenzeSoggetto.get(0)).getSoggetto();
		...
		setRequestAttribute("codLicenza", codLicenza);
		setRequestAttribute("descrLicenza", descrLicenza);
		...
		setRequestAttribute("licenze", lLicenzeSoggetto);

		lReturnPage = ICostantiPermesso.PG_RICERCA_LICENZEDELSOGGETTO;
