...
/**
 * <p>Title: ActModificaEsitoPermessoLicenza</p>
 * <p>Description: Classe Action per la Modifica Esito Permesso</p> 
 */
...
implements ICostantiPermesso,ICostantiLicenzaLibanticipata
{
  ...
  {    
    ...
    LicenzaLibAnticipataModel lLic = 
      lCtrlLicPerLibAnt.ExRicercaLicenzaLibanticipataByKey( getRequestBigDecimalParameter(CAMPO_ID_LICENZA_LIBANTICIPATA) );
    ...
    lLic.setDataAnnotazioneEsito( getRequestDateParameter( CAMPO_ANNO_DATA_ANNOTAZIONE_ESITO,
                                                           CAMPO_MESE_DATA_ANNOTAZIONE_ESITO,
                                                           CAMPO_GIORNO_DATA_ANNOTAZIONE_ESITO ) );
