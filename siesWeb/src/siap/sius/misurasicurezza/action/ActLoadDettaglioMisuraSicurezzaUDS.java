...
/**
* <p>Title: ActLoadDettaglioMisuraSicurezzaUDS</p>
...
public class ActLoadDettaglioMisuraSicurezzaUDS extends ActionSius implements ICostantiSiusMisuraSicurezza {
	/*****************************************************************************
	...
	public String processRequest() throws Exception {
		...
		PeriodoAltraMisuraModel lPerMod = lCtrl.ExRicercaMisuraSicurezzaByIdEvento(lIdEvento);
		...
		if (lPerMod == null) {
			...
			// TODO carmela
			// commentata riga successiva per presenza errore quando si preme su OK (non viene visualizzata
			// nessuna pagina)
			// setRequestAttribute(IWebConstants.GOTO_PAGE, IWebConstants.ROOT_DIR);
			setRequestAttribute(IWebConstants.GOTO_PAGE, null);
