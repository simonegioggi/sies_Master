...
public class ActLoadRichiestaProgrammaProtezioneNN extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAPROGRAMMAPROTEZIONENN; // restituisce la jsp di VIEW
	}
