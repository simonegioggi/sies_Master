...
public class ActInserisciInformazioniSuSemilibero extends ActInserisciRicAtti implements
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0537");
		...
		for (int x = 0; x < lSize; x++) {
			if (!"-".equals(lDestinatari[x]) && !"".equals(lSedi[x])) {
