...
public class ActLoadRichiestaInformLibCondizGDF extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		setRequestAttribute("codTipoUfficioS", "32");
		setRequestAttribute("descTipoUfficioS", DecodificheUtils.getDescbyCode(lCol, "32"));

		return PG_LOAD_RICHIESTAINFORMLIBCONDIZGDF; // restituisce la jsp di VIEW
	}
