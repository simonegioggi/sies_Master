...
/**
 * <p>Title: ActInserisciSanzSostSottoposizioneCassazione </p>
 ...
 * @version 1.0
 */
public class ActInserisciSanzSostSottoposizioneCassazione
extends ActInserisciSanzSostDocumentiIstruttori implements ICostantiRichiestaAtti
{
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    lEveNot.getEvento().setCodMotivo("0575"); // CodMotivo - Risottoposizione a seguito sospensione 
    // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
