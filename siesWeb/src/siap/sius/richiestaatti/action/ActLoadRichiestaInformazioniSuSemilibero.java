...
public class ActLoadRichiestaInformazioniSuSemilibero extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAINFORMAZIONISUSEMILIBERO; // restituisce la jsp di VIEW
	}
}