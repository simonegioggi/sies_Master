...
public class ActLoadRichiestaCarteggioDAP41bis extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		setRequestAttribute("codTipoUfficioS", "27");
		setRequestAttribute("descTipoUfficioS", DecodificheUtils.getDescbyCode(lCol, "27"));

		return PG_LOAD_RICHIESTACARTEGGIODAP41BIS; // restituisce la jsp di VIEW
	}
