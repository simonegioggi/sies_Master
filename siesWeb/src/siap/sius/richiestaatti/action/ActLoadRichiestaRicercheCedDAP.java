...
public class ActLoadRichiestaRicercheCedDAP extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTARICERCHECEDDAP; // restituisce la jsp di VIEW
	}
