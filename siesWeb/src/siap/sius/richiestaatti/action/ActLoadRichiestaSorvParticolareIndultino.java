...
public class ActLoadRichiestaSorvParticolareIndultino extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		Option lOption2 = new Option(lTipoIstituto, 35);
		...
		setRequestAttribute("TipiIstituti1", "" + lOption2);
		setRequestAttribute("TipiIstituti2", "" + lOption2);

		return PG_LOAD_RICHIESTASORVPARTICOLAREINDULTINO; // restituisce la jsp di VIEW
	}
