...
public class ActLoadRichiestaRelazioneSintesi extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTARELAZIONESINTESI; // restituisce la jsp di VIEW
	}
