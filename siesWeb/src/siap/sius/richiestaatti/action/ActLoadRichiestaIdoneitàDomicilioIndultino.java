...
public class ActLoadRichiestaIdoneit‡DomicilioIndultino extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAIDONEITADOMICILIOINDULTINO; // restituisce la jsp di VIEW
	}
