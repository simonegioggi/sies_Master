...
/**
 * <p>Title: ActLoadRichiestaSanzSostRelazioneAndamentoSanzione </p>
 ...
 * @version 1.0
 */
public class ActLoadRichiestaSanzSostRelazioneAndamentoSanzione 
extends ActLoadRichiestaSanzSostDocumentiIstruttori
{
  ...
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("Azione","siap.sius.richiestaatti.action.ActInserisciSanzSostRelazioneAndamentoSanzione");
    setRequestAttribute("Funzione","Relazione Andamento Sanzione");
    // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
