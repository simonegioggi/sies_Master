...
public class ActInserisciInformDetEstero extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0553");
		...
		for (int x = 0; x < lSize; x++) {
			if (!lDestinatari[x].equals("-") && !lSedi[x].equals("")) {
				...
				if (x == 0)
					...
					lCodSede = getCodComuneByDescrFlagVal(lSedi[x]).getCodComune();
