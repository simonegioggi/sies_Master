...
public class ActLoadRichiestaPSDomiciliariInCorso extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAPSDOMICILIARIINCORSO; // restituisce la jsp di VIEW
	}
