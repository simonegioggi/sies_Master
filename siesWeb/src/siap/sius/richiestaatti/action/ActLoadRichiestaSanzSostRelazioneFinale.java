 ...
 * @version 1.0
 */
public class ActLoadRichiestaSanzSostRelazioneFinale extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		// ( DESTINATARIO 1 - 2 ) Tipi Autorità Filtrati
		...
		return PG_LOAD_RICHIESTASANZSOSTRELAZIONEFINALE; // restituisce la jsp di VIEW
	}
