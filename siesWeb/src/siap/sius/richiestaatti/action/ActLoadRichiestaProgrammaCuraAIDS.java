...
public class ActLoadRichiestaProgrammaCuraAIDS extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAPROGRAMMACURAAIDS; // restituisce la jsp di VIEW
	}
