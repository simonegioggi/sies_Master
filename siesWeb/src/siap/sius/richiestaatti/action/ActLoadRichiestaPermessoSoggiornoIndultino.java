...
public class ActLoadRichiestaPermessoSoggiornoIndultino extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		setRequestAttribute("codTipoUfficioS", "20");
		setRequestAttribute("descTipoUfficioS", DecodificheUtils.getDescbyCode(lCol, "20"));

		return PG_LOAD_RICHIESTAPERMESSOSOGGIORNOINDULTINO; // restituisce la jsp di VIEW
	}
