...
public class ActInserisciDAPCartellaBiografica extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		String[] lCodTipoUfficioDest = getRequestStringParameters(CAMPO_COD_DESTINATARIO);
		...
		lEveNot.getEvento().setCodMotivo("0540");
		...
		// String lCodComuneSede = getCodComuneByDescr( lSedi ).getCodComune();
		...
		lAutorita.setCodTipoAutorita(lCodTipoUfficioDest[0]);
