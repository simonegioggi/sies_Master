...
public class ActLoadRichiestaInformDiffEsPenaArt146c2 extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		String[] lStringFilter = { "-", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11",
				"12", "13", "14", "15", "16", "17", "18", "27", "41", "44", "45", "46", "47", "48", "50",
				"51" };
		...
		lOption = new Option(lCol, "34");
		// lOption.setFilter(lStringFilter);
		setRequestAttribute("TipiIstituti2", "" + lOption);

		return PG_LOAD_RICHIESTAINFORMDIFFESPENAART146C2; // restituisce la jsp di VIEW
	}
