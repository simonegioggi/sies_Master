...
public class ActInserisciParerePMRidetermPena extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0546");
		...
		for (int x = 0; x < lSize; x++) {
			if (!lDestinatari[x].equals("-") && !lSedi[x].equals("")) {
				...
				String lCodUfficioDest = getCodUfficioByCodTipoUfficioDescrComune(lDestinatari[x], lSedi[x]);
