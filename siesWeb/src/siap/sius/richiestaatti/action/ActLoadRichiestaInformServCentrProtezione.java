...
public class ActLoadRichiestaInformServCentrProtezione extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		// Imposta la sede fissa a ROMA
		String lSede = "ROMA";

		setRequestAttribute("codTipoUfficioS", "33");
		setRequestAttribute("descTipoUfficioS", DecodificheUtils.getDescbyCode(lCol, "33"));
		setRequestAttribute("sedeProcura", lSede);

		return PG_LOAD_RICHIESTAINFORMSERVCENTRPROTEZIONE; // restituisce la jsp di VIEW
	}
