...
public class ActInserisciPSPerArt47Ter5030Ter extends ActInserisciRicAtti implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0560");
		// Template differente nel caso di Remissione Debito
		if (lFascicoloGPModel.getGeneraleProcedimentoModel().getCodOggettoProcedimento()
				.compareTo("U011") == 0)
