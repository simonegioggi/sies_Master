...
public class ActLoadRichiestaInformazioni656c10AD extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAINFORMAZIONI656C10AD; // restituisce la jsp di VIEW
	}
