 ...
 * @version 1.0
 */
public class ActLoadInserisciAccordiLavSostitutivo extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		 ...
		 */
		// String[] lFiltro = {"-" ,"92","59","60","61","28","58","19","72","73",
		// "74","70","71","64","66","67","93","69","68","20","26"};

		String[] FiltroTipo1 = { "-", "22" };
		...
		// ( DESTINATARIO 2 ) Elenco di tutte le autorità
		lOption = new Option(lElencoTipiAutorita);
		...
		return PG_LOAD_RICHIESTALAVOROSOSTITUTIVO; // restituisce la jsp di VIEW
	}
