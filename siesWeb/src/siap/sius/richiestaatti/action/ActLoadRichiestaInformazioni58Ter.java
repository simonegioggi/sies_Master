...
public class ActLoadRichiestaInformazioni58Ter extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		return PG_LOAD_RICHIESTAINFORMAZIONI58TER; // restituisce la jsp di VIEW
	}
