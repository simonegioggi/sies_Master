...
*/
public class ActLoadFSPMisureSicurezza extends ActLoadRicercaFSPuntuale
implements ICostantiRichiestaAtti
{
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("functionName", "Richiesta Atti per Misure Sicurezza");
    setRequestAttribute("nextAction", "siap.sius.richiestaatti.action.ActRicercaFSPMisureSicurezza");
