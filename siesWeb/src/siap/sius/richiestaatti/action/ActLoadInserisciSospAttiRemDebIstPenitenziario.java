 ...
 * @version 1.0
 */
public class ActLoadInserisciSospAttiRemDebIstPenitenziario extends ActionSiap
implements ICostantiRichiestaAtti
{
  ...
  public String processRequest() throws Exception
  {
    ...
    return PG_LOAD_RICHIESTASOSPATTIREMDEBISTITUTOPENITENZIARIO; //restituisce la jsp di VIEW
  }
}