 ...
 * @version 1.0
 */
public class ActLoadInserisciSospAttiRemDebUffRecuperoCrediti extends ActionSiap
	...
	public String processRequest() throws Exception {
		...
		String[] FiltroTipo1 = { "-", "GP", "DIB", "DIBM", "CAP", "TRIBSD" };
		...
		Collection lElencoTipiUfficio = DecodificheManager.getInstance().getTipoUfficio();

		Option lOptionUff = new Option(lElencoTipiUfficio);

		// ( DESTINATARIO ) Uffici Recupero Crediti
		lOptionUff = new Option(lElencoTipiUfficio);
		lOptionUff.setFilter(FiltroTipo1);
		setRequestAttribute("ElencoTipiUfficio", "" + lOptionUff); // Imposta il valore in request.
		...
		return PG_LOAD_RICHIESTASOSPATTIREMDEBUFFRECUPEROCREDITI; // restituisce la jsp di VIEW
	}
