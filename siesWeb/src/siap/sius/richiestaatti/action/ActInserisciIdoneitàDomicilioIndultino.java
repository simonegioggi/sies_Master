...
public class ActInserisciIdoneit‡DomicilioIndultino extends ActInserisciRicAtti
	...
	public String processRequest() throws Exception {
		...
		lEveNot.getEvento().setCodMotivo("0549");
		...
		for (int x = 0; x < lSize; x++) {
			if (!lDestinatari[x].equals("-") && !lSedi[x].equals("")) {
				...
				// Aggiunge il model Autorit‡ Esterna alla Notifica
