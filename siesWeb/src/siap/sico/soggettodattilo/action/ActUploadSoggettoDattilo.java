...
/**
 * ActUploadSoggettoDattilo - Classe Action per l'upload di SoggettoDattilo
 *
 * @version 1.0
 */
public class ActUploadSoggettoDattilo extends ActionSiap implements ICostantiSoggettoDattilo {
	...
	public String processRequest() throws Exception {
		...
		if (codUfficio != null && !codUfficio.equals("") && lFasc != null
				&& lFasc.getCodUfficioInserimento() != null) {
			if (!codUfficio.equals(lFasc.getCodUfficioInserimento())) {
				setRequestAttribute(IWebConstants.MESSAGE_TEXT,
						"Non è possibile procedere con l'inserimento. Fascicolo appartenente ad altro ufficio.");
			} else {
			...
			setRequestAttribute(IWebConstants.MESSAGE_TEXT,
					"Non è possibile procedere con l'inserimento. Ricercare prima il Fascicolo al quale si vuole allegare il documento.");
		}
