...
public class ActRicercaMag extends ActionSiap implements ICostantiMagistrato {
	...
	public String processRequest() throws F3BException {
		...
		try {
			lVect = lCtrl.ExRicercaMagistratoByCognome(lCognome, lUffAppa);
		} catch (Exception e) {
		}
