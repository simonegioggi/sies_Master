...
/**
 * <p>
 * Title: ActRicercaMagistratiUfficio
 * </p>
 * <p>
...
public class ActRicercaMagistratiUfficio extends ActionSiap implements ICostantiMagistrato {

	/**
	 * Ricerca tutti i magistrati per l'ufficio passato in input, anche quelli non più validi.
	 */
	public String processRequest() throws F3BException {
		...
		Vector lVect = lCtrl.ExRicercaMagistratoByCognomeUfficio(lCognome, lUffAppa);

		setRequestAttribute("formname", getRequestStringParameter("formname"));
		setRequestAttribute("codnum", getRequestStringParameter("codnum"));
		setRequestAttribute("magistrati", lVect);

		return PG_LISTA_MAGISTRATI_UFFICIO;
	}
