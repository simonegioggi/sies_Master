...
/**
* <p>Title: ActLoadCancellaCertificatoOmonimiNsc</p>
* <p>Description: Classe Action per la load cancella di CertificatoOmonimiNsc</p>
...
public class ActLoadCancellaCertificatoOmonimiNsc extends ActionSiap implements ICostantiCertificatoOmonimiNsc
{
 /*****************************************************************************
  ...
  *****************************************************************************/
  public String processRequest() throws F3BException {
    ...
    return PG_LOAD_CANCELLACERTIFICATOOMONIMINSC;
  }
}