...
/**
* <p>Title: MisuraAlternativaDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella MisuraAlternativa</p>
...
public class MisuraAlternativaDAO extends TableDAO
{
  ...
  // METODI GET()
  //
  public BigDecimal getIdMisuraAlternativa() 		throws DAOException	        { return getBigDecimal("ID_MISURA_ALTERNATIVA"); }
  public String 		getCodTipoDecisione() 		throws DAOException	          { return getString("COD_TIPO_DECISIONE"); }
  public String 		getCodNaturaDecisione() 		throws DAOException	        { return getString("COD_NATURA_DECISIONE"); }
  ...
  public String 		getDescrLuogoProva() 		throws DAOException	            { return getString("DESCR_LUOGO_PROVA"); }
  ...
  public String 		getChiaveUfficioFascicoloSius() 		throws DAOException	{ return getString("CHIAVE_UFFICIO_FASCICOLO_SIUS"); }
  ...
  public String 		getCodTipoUfficioScarcerazione() 		throws DAOException	{ return getString("COD_TIPO_UFFICIO_SCARCERAZIONE"); }
  public String     getFlagUfficioInserimento() throws DAOException	        { return getString("FLAG_UFFICIO_INSERIMENTO"); }
  ...
  public String     getFlagPeriodoEspiato()          throws  DAOException   { return getString("FLAG_PERIODO_ESPIATO");}

  public BigDecimal getAnnoAltroTitolo()            throws DAOException     { return getBigDecimal("ANNO_ALTRO_TITOLO");}
  public String     getNumAltroTitolo()             throws DAOException     { return getString("NUM_ALTRO_TITOLO");}
  public Date       getDataAltroTitolo()            throws DAOException     { return getDate("DATA_ALTRO_TITOLO"); }
  public String     getCodLuogoAltroTitolo()        throws DAOException     { return getString("COD_LUOGO_ALTRO_TITOLO");}
  public String     getCodAutoritaAltroTitolo()     throws DAOException     { return getString("COD_AUTORITA_ALTRO_TITOLO");}


  public Date       getDataScadenzaProroga()        throws DAOException     { return getDate("DATA_SCADENZA_PROROGA"); }
  ...
  public String     getFlagSituazione()             throws DAOException     { return getString("FLAG_SITUAZIONE");}
  
  public String      getCodTipoDecisioneMaAt()                throws DAOException {return getString("COD_TIPO_DECISIONE_MA_AT") ;}
  public String      getCodTipoMisuraMaAt()                   throws DAOException {return getString("COD_TIPO_MISURA_MA_AT") ;}
  public Date        getDataDecisioneMaAt()                   throws DAOException {return getDate("DATA_DECISIONE_MA_AT") ;}
  public BigDecimal  getChiaveAnnoFascicoloSiusMaAt()         throws DAOException {return getBigDecimal("CHIAVE_ANNO_FAS_SIUS_MA_AT") ;}
  public BigDecimal  getChiaveProgrFascicoloSiusMaAt()        throws DAOException {return getBigDecimal("CHIAVE_PROGR_FAS_SIUS_MA_AT") ;}
  public String      getChiaveUfficioFascicoloSiusMaAt()      throws DAOException {return getString("CHIAVE_UFF_FAS_SIUS_MA_AT") ;}
  public BigDecimal  getAnnoRegistroMaAt()                    throws DAOException {return getBigDecimal("ANNO_REGISTRO_MA_AT") ;}
  public BigDecimal  getNumeroRegistroMaAt()                  throws DAOException {return getBigDecimal("NUMERO_REGISTRO_MA_AT") ;}
  public BigDecimal  getFlFormaMisura()                  throws DAOException {return getBigDecimal("FL_FORMA_MISURA") ;}
  public String      getDescrizioneComunita()                  throws DAOException {return getString("DESCRIZIONE_COMUNITA") ;}
  
  // MEV_9
  public Date 			getDataEsecutivita() 		throws DAOException	            { return getDate("DATA_ESECUTIVITA"); }
  
  //
  // METODI SET()
  //
  public void  	 setIdMisuraAlternativa(BigDecimal aValore ) 			   { setBigDecimal("ID_MISURA_ALTERNATIVA", aValore); }
  public void  	 setCodTipoDecisione(String aValore ) 			         { setString("COD_TIPO_DECISIONE", aValore); }
  public void  	 setCodNaturaDecisione(String aValore ) 			       { setString("COD_NATURA_DECISIONE", aValore); }
  ...
  public void  	 setDescrLuogoProva(String aValore ) 			           { setString("DESCR_LUOGO_PROVA", aValore); }
  ...
  public void  	 setChiaveUfficioFascicoloSius(String aValore ) 		 { setString("CHIAVE_UFFICIO_FASCICOLO_SIUS", aValore); }
  ...
  public void	 setCodTipoUfficioScarcerazione(String aValore)      { setString("COD_TIPO_UFFICIO_SCARCERAZIONE", aValore);}
  public void    setFlagUfficioInserimento(String aValore)           { setString("FLAG_UFFICIO_INSERIMENTO",aValore); }
  ...
  public void    setFlagPeriodoEspiato(String aValore)               { setString("FLAG_PERIODO_ESPIATO",aValore);}

  public void    setAnnoAltroTitolo(BigDecimal aValore)              { setBigDecimal("ANNO_ALTRO_TITOLO", aValore);}
  public void    setNumAltroTitolo(String aValore)                   { setString("NUM_ALTRO_TITOLO", aValore);}
  public void    setDataAltroTitolo(Date aValore)                    { setDate("DATA_ALTRO_TITOLO", aValore); }
  public void    setCodLuogoAltroTitolo(String aValore)              { setString("COD_LUOGO_ALTRO_TITOLO", aValore);}
  public void    setCodAutoritaAltroTitolo(String aValore)           { setString("COD_AUTORITA_ALTRO_TITOLO", aValore);}

  public void    setDataScadenzaProroga(Date aValore)                { setDate("DATA_SCADENZA_PROROGA", aValore); }
  ...
  public void    setFlagSituazione(String aValore)                   { setString("FLAG_SITUAZIONE", aValore);}


  public void  setCodTipoDecisioneMaAt(String aValore)                { setString("COD_TIPO_DECISIONE_MA_AT",aValore);}
  public void  setCodTipoMisuraMaAt(String aValore)                   { setString("COD_TIPO_MISURA_MA_AT",aValore);}
  public void  setDataDecisioneMaAt(Date aValore)                     { setDate("DATA_DECISIONE_MA_AT",aValore);}
  public void  setChiaveAnnoFascicoloSiusMaAt(BigDecimal aValore)     { setBigDecimal("CHIAVE_ANNO_FAS_SIUS_MA_AT",aValore);}
  public void  setChiaveProgrFascicoloSiusMaAt(BigDecimal aValore)    { setBigDecimal("CHIAVE_PROGR_FAS_SIUS_MA_AT",aValore);}
  public void  setChiaveUfficioFascicoloSiusMaAt(String aValore)      { setString("CHIAVE_UFF_FAS_SIUS_MA_AT",aValore);}
  public void  setAnnoRegistroMaAt(BigDecimal aValore)                { setBigDecimal("ANNO_REGISTRO_MA_AT",aValore);}
  public void  setNumeroRegistroMaAt(BigDecimal aValore)              { setBigDecimal("NUMERO_REGISTRO_MA_AT",aValore);}
  public void  setFlFormaMisura(BigDecimal aValore)                   { setBigDecimal("FL_FORMA_MISURA",aValore);}
  public void  setDescrizioneComunita (String aValore)                { setString("DESCRIZIONE_COMUNITA",aValore);}
  
  // MEV_9
  public void setDataEsecutivita(Date aValore) 		{ setDate("DATA_ESECUTIVITA",aValore);}
  
  
	public GenericModel getModel() throws DAOException
  {
    return new MisuraAlternativaModel(
                                        getIdMisuraAlternativa() ,
                                        getCodTipoDecisione() ,
                                        "",
                                        ...
                                        getCodTipoUfficioScarcerazione(),
                                        getFlagUfficioInserimento(),
                                        ...
                                        getDataInizioRevoca(),
                                        getFlagPeriodoEspiato(),
                                        getAnnoAltroTitolo(),
                                        getNumAltroTitolo(),
                                        getDataAltroTitolo(),
                                        getCodLuogoAltroTitolo(),
                                        getCodAutoritaAltroTitolo(),
                                        getDataScadenzaProroga(),
                                        getFlagDecisioneTribunale(),
                                        getCodTdsCompetente(),
                                        getFlagSituazione(),
                                        "",
                                        "",
                                        getCodTipoDecisioneMaAt(),
                                        "",
                                        getCodTipoMisuraMaAt(),
                                        "",
                                        getDataDecisioneMaAt(),
                                        getChiaveAnnoFascicoloSiusMaAt(),
                                        getChiaveProgrFascicoloSiusMaAt(),
                                        getChiaveUfficioFascicoloSiusMaAt(),
                                        "",
                                        getAnnoRegistroMaAt(),
                                        getNumeroRegistroMaAt(),
                                        this.getFlFormaMisura(),
                                        this.getDescrizioneComunita(),
                                        getDataEsecutivita() //MEV_9
                                      );
  }
   ...
   * MISURA_ALTERNATIVA legata all'Evento specificato dal suo ID.
   * @param aIdEvento
   * @return
   * @throws DAOException
   */
