...
public class MisuraAlternativaModel extends GenericModel {
  ...
  //COSTRUTTORE MODEL
	public MisuraAlternativaModel(
                                 BigDecimal	 aIdMisuraAlternativa,
                                 String	 aCodTipoDecisione,
                                 String	 aDescrTipoDecisione,
                                 String	 aCodNaturaDecisione,
                                 String	 aDescrNaturaDecisione,
                                 String	 aCodTipoMisura,
                                 String	 aDescrTipoMisura,
                                 Date	 aDataDecisione,
                                 String	 aCodMagistrato,
                                 String	 aDescrMagistrato,
                                 String	 aCodUfficioSorveglianza,
                                 String	 aDescrUfficioSorveglianza,
                                 BigDecimal	 aCssIdCssa,
                                 String	 aDescrLuogoProva,
                                 BigDecimal	 aNumAnniMisura,
                                 BigDecimal	 aNumMesiMisura,
                                 BigDecimal	 aNumGiorniMisura,
                                 Date	 aDataInizioMisura,
                                 Date	 aDataFineMisura,
                                 BigDecimal	 aChiaveAnnoFascicoloSius,
                                 String	 aChiaveUfficioFascicoloSius,
                                 BigDecimal	 aChiaveProgrFascicoloSius,
                                 BigDecimal	 aAnnoRegistro,
                                 BigDecimal	 aNumeroRegistro,
                                 ...
                                 String aNote,
                                 Date aDataScarcerazione,
                                 Date aDataIngressoIstituto,
                                 String aCodTipoUfficioScarcerazione,
                                 String aFlagUfficioInserimento,
                                 BigDecimal aNumAnniRevocaReclusione,
                                 BigDecimal aNumMesiRevocaReclusione,
                                 BigDecimal aNumGiorniRevocaReclusione,
                                 BigDecimal aNumAnniRevocaArresto,
                                 BigDecimal aNumMesiRevocaArresto,
                                 BigDecimal aNumGiorniRevocaArresto,
                                 Date aDataInizioRevoca,
                                 String aFlagPeriodoEspiato,
                                 BigDecimal aAnnoAltroTitolo,
                                 String aNumAltroTitolo,
                                 Date   aDataAltroTitolo,
                                 String aCodLuogoAltroTitolo,
                                 String aCodAutoritaAltroTitolo,
                                 Date aDataScadenzaProroga,
                                 String aFlagDecisioneTribunale,
                                 String aCodTdsCompetente,
                                 String aFlagSituazione,
                                 String aDescTdsCompetente,
                                 String aDescSedeTdsCompetente,
                                 String      aCodTipoDecisioneMaAt,
                                 String      aDescrTipoDecisioneMaAt,
                                 String      aCodTipoMisuraMaAt,
                                 String      aDescrTipoMisuraMaAt,
                                 Date        aDataDecisioneMaAt,
                                 BigDecimal  aChiaveAnnoFascicoloSiusMaAt,
                                 BigDecimal  aChiaveProgrFascicoloSiusMaAt,
                                 String      aChiaveUfficioFascicoloSiusMaAt,
                                 String      aDescrChiaveUfficioFascicoloSiusMaAt,
  ...
  public BigDecimal getIdMisuraAlternativa() 			      { return mIdMisuraAlternativa; }
  public String 		getCodTipoDecisione() 			        { return mCodTipoDecisione; }
  public String 		getDescrTipoDecisione() 			      { return mDescrTipoDecisione; }
  public String 		getCodNaturaDecisione() 			      { return mCodNaturaDecisione; }
  public String 		getDescrNaturaDecisione() 			    { return mDescrNaturaDecisione; }
  public String 		getCodTipoMisura() 			            { return mCodTipoMisura; }
  public String 		getDescrTipoMisura() 			          { return mDescrTipoMisura; }
  public Date 			getDataDecisione() 			            { return mDataDecisione; }
  public String 		getCodMagistrato() 			            { return mCodMagistrato; }
  public String 		getDescrMagistrato() 			          { return mDescrMagistrato; }
  public String 		getCodUfficioSorveglianza() 			  { return mCodUfficioSorveglianza; }
  public String 		getDescrUfficioSorveglianza() 			{ return mDescrUfficioSorveglianza; }
  public BigDecimal getCssIdCssa() 			                { return mCssIdCssa; }
  public String 		getDescrLuogoProva() 			          { return mDescrLuogoProva; }
  public BigDecimal getNumAnniMisura() 			            { return mNumAnniMisura; }
  public BigDecimal getNumMesiMisura() 			            { return mNumMesiMisura; }
  public BigDecimal getNumGiorniMisura() 			          { return mNumGiorniMisura; }
  public Date 			getDataInizioMisura() 			        { return mDataInizioMisura; }
  public Date 			getDataFineMisura() 			          { return mDataFineMisura; }
  public Date 			getDataFineMisuraPiuUno() 			    { return mDataFineMisuraPiuUno; }

  public BigDecimal getChiaveAnnoFascicoloSius() 			  { return mChiaveAnnoFascicoloSius; }
  public String 		getChiaveUfficioFascicoloSius() 		{ return mChiaveUfficioFascicoloSius; }
  public BigDecimal getChiaveProgrFascicoloSius() 			{ return mChiaveProgrFascicoloSius; }
  public BigDecimal getAnnoRegistro() 			            { return mAnnoRegistro; }
  public BigDecimal getNumeroRegistro() 			          { return mNumeroRegistro; }
  ...
  public Date 			getDataScarcerazione() 			        { return mDataScarcerazione; }
  public Date       getDataIngressoIstituto()           { return mDataIngressoIstituto; }
  public String     getStringaReclusione()              { return mStringaReclusione; }
  public String     getMisuraAlternativaCorrente()      { return mMisuraAlternativaCorrente; }
  public String     getCodTipoUfficioScarcerazione()      { return mCodTipoUfficioScarcerazione; }
  public String     getDescrChiaveUfficioFascicoloSius()      { return mDescrChiaveUfficioFascicoloSius; }
  public String     getFlagUfficioInserimento()         { return mFlagUfficioInserimento; }

  public BigDecimal getNumAnniRevocaReclusione()        { return mNumAnniRevocaReclusione; }
  public BigDecimal getNumMesiRevocaReclusione()        { return mNumMesiRevocaReclusione; }
  public BigDecimal getNumGiorniRevocaReclusione()      { return mNumGiorniRevocaReclusione; }
  public BigDecimal getNumAnniRevocaArresto()           { return mNumAnniRevocaArresto; }
  public BigDecimal getNumMesiRevocaArresto()           { return mNumMesiRevocaArresto; }
  public BigDecimal getNumGiorniRevocaArresto()         { return mNumGiorniRevocaArresto; }
  public Date       getDataInizioRevoca()               { return mDataInizioRevoca; }
  public String     getFlagPeriodoEspiato()             { return mFlagPeriodoEspiato;}

  public BigDecimal getAnnoAltroTitolo()                { return mAnnoAltroTitolo;}
  public String     getNumAltroTitolo()                 { return mNumAltroTitolo;}
  public Date       getDataAltroTitolo()                { return mDataAltroTitolo;}
  public String     getCodLuogoAltroTitolo()            { return mCodLuogoAltroTitolo;}
  public String     getCodAutoritaAltroTitolo()         { return mCodAutoritaAltroTitolo;}

  public String     getDescLuogoAltroTitolo()          { return mDescLuogoAltroTitolo;}
  public String     getDescAutoritaAltroTitolo()       { return mDescAutoritaAltroTitolo;}

  public String     getFlagCheck()                      { return mFlagCheck; }
  public String     getStringaRevocaReclusione()         { return mStringaRevocaReclusione; }
  public String     getStringaRevocaArresto()            { return mStringaRevocaArresto; }
  public String     getStringaMisura()                    { return mStringaMisura; }

  public String     getLegge()            { return mLegge; }

  public Date       getDataScadenzaProroga()           { return mDataScadenzaProroga;}
  public String     getFlagDecisioneTribunale()        { return mFlagDecisioneTribunale;}
  public String     getCodTdsCompetente()              { return mCodTdsCompetente;}
  public String     getFlagSituazione()                { return mFlagSituazione;}
  public String     getDescTdsCompetente()             { return mDescTdsCompetente;}
  public String     getDescSedeTdsCompetente()         { return mDescSedeTdsCompetente;}

  public String      getCodTipoDecisioneMaAt()                {return mCodTipoDecisioneMaAt ;}
  public String      getDescrTipoDecisioneMaAt()              {return mDescrTipoDecisioneMaAt ;}
  public String      getCodTipoMisuraMaAt()                   {return mCodTipoMisuraMaAt ;}
  public String      getDescrTipoMisuraMaAt()                 {return mDescrTipoMisuraMaAt ;}
  public Date        getDataDecisioneMaAt()                   {return mDataDecisioneMaAt ;}
  public BigDecimal  getChiaveAnnoFascicoloSiusMaAt()         {return mChiaveAnnoFascicoloSiusMaAt ;}
  public BigDecimal  getChiaveProgrFascicoloSiusMaAt()        {return mChiaveProgrFascicoloSiusMaAt ;}
  public String      getChiaveUfficioFascicoloSiusMaAt()      {return mChiaveUfficioFascicoloSiusMaAt ;}
  public String      getDescrChiaveUfficioFascicoloSiusMaAt() {return mDescrChiaveUfficioFascicoloSiusMaAt ;}
  public BigDecimal  getAnnoRegistroMaAt()                    {return mAnnoRegistroMaAt ;}
  ...
  public void setIdMisuraAlternativa(BigDecimal aValore ) 			  { mIdMisuraAlternativa = aValore; }
  public void setCodTipoDecisione(String aValore ) 			          { mCodTipoDecisione = aValore; }
  public void setDescrTipoDecisione(String aValore ) 			        { mDescrTipoDecisione = aValore; }
  public void setCodNaturaDecisione(String aValore ) 			        { mCodNaturaDecisione = aValore; }
  public void setDescrNaturaDecisione(String aValore ) 			      { mDescrNaturaDecisione = aValore; }
  public void setCodTipoMisura(String aValore ) 			            { mCodTipoMisura = aValore; }
  public void setDescrTipoMisura(String aValore ) 			          { mDescrTipoMisura = aValore; }
  public void setDataDecisione(Date aValore ) 			              { mDataDecisione = aValore; }
  public void setCodMagistrato(String aValore ) 			            { mCodMagistrato = aValore; }
  public void setDescrMagistrato(String aValore ) 			          { mDescrMagistrato = aValore; }
  public void setCodUfficioSorveglianza(String aValore ) 			    { mCodUfficioSorveglianza = aValore; }
  public void setDescrUfficioSorveglianza(String aValore ) 			  { mDescrUfficioSorveglianza = aValore; }
  public void setCssIdCssa(BigDecimal aValore ) 			            { mCssIdCssa = aValore; }
  public void setDescrLuogoProva(String aValore ) 			          { mDescrLuogoProva = aValore; }
  public void setNumAnniMisura(BigDecimal aValore ) 			        { mNumAnniMisura = aValore; }
  public void setNumMesiMisura(BigDecimal aValore ) 			        { mNumMesiMisura = aValore; }
  public void setNumGiorniMisura(BigDecimal aValore ) 			      { mNumGiorniMisura = aValore; }
  public void setDataInizioMisura(Date aValore ) 			            { mDataInizioMisura = aValore; }
  ...
  public void setChiaveAnnoFascicoloSius(BigDecimal aValore ) 		{ mChiaveAnnoFascicoloSius = aValore; }
  public void setChiaveUfficioFascicoloSius(String aValore ) 			{ mChiaveUfficioFascicoloSius = aValore; }
  public void setChiaveProgrFascicoloSius(BigDecimal aValore ) 		{ mChiaveProgrFascicoloSius = aValore; }
  public void setAnnoRegistro(BigDecimal aValore ) 			          { mAnnoRegistro = aValore; }
  public void setNumeroRegistro(BigDecimal aValore ) 			        { mNumeroRegistro = aValore; }
  ...
  public void setFasSieIdFascicoloSiep(BigDecimal aValore ) 			{ mFasSieIdFascicoloSiep = aValore; }
  public void setEveIdEvento(BigDecimal aValore ) 			          { mEveIdEvento = aValore; }
  public void setNote(String aValore ) 			                      { mNote = aValore; }
  public void setDataScarcerazione(Date aValore) 			            { mDataScarcerazione = aValore; }
  public void setDataIngressoIstituto(Date aValore)               { mDataIngressoIstituto = aValore; }
  public void setStringaReclusione(String aValore)                { mStringaReclusione = aValore; }
  public void setStringaRevocaReclusione(String aValore)          { mStringaRevocaReclusione = aValore; }
  public void setStringaRevocaArresto(String aValore)             { mStringaRevocaArresto = aValore; }
  public void setStringaMisura(String aValore)                    { mStringaMisura = aValore; }

  public void setMisuraAlternativaCorrente(String aValore)        { mMisuraAlternativaCorrente = aValore; }
  public void setCodTipoUfficioScarcerazione(String aValore)      { mCodTipoUfficioScarcerazione = aValore; }
  public void setDescrChiaveUfficioFascicoloSius(String aValore)  { mDescrChiaveUfficioFascicoloSius = aValore; }
  public void setFlagUfficioInserimento(String aValore)           { mFlagUfficioInserimento = aValore; }
  public void setNumAnniRevocaReclusione(BigDecimal aValore)      { mNumAnniRevocaReclusione = aValore;}
  public void setNumMesiRevocaReclusione(BigDecimal aValore)      { mNumMesiRevocaReclusione = aValore; }
  public void setNumGiorniRevocaReclusione(BigDecimal aValore)    { mNumGiorniRevocaReclusione = aValore;}
  public void setNumAnniRevocaArresto(BigDecimal aValore)         { mNumAnniRevocaArresto = aValore;}
  public void setNumMesiRevocaArresto(BigDecimal aValore)         { mNumMesiRevocaArresto = aValore;}
  public void setNumGiorniRevocaArresto(BigDecimal aValore)       { mNumGiorniRevocaArresto = aValore;}
  public void setDataInizioRevoca(Date aValore)                   { mDataInizioRevoca = aValore;}
  public void setFlagPeriodoEspiato(String aValore)               { mFlagPeriodoEspiato = aValore;}
  public void setAnnoAltroTitolo(BigDecimal aValore)              { mAnnoAltroTitolo = aValore;}
  public void setNumAltroTitolo(String aValore)                   { mNumAltroTitolo = aValore;}
  public void setDataAltroTitolo(Date aValore)                    { mDataAltroTitolo = aValore;}
  public void setCodLuogoAltroTitolo(String aValore)              { mCodLuogoAltroTitolo = aValore;}
  public void setCodAutoritaAltroTitolo(String aValore)           { mCodAutoritaAltroTitolo = aValore;}

  public void setDescLuogoAltroTitolo(String aValore)          { mDescLuogoAltroTitolo = aValore;}
  public void setDescAutoritaAltroTitolo(String aValore)       { mDescAutoritaAltroTitolo = aValore;}

  public void setFlagCheck(String aValore)                        { mFlagCheck = aValore; }
  public void setLegge(String aValore)                       { mLegge = aValore; }


  public void setDataScadenzaProroga(Date aValore)             { mDataScadenzaProroga = aValore;}
  public void setFlagDecisioneTribunale(String aValore)        { mFlagDecisioneTribunale = aValore;}
  public void setCodTdsCompetente(String aValore)              { mCodTdsCompetente = aValore;}
  public void setFlagSituazione(String aValore)                { mFlagSituazione = aValore;}
  public void setDescTdsCompetente (String aValore)            { mDescTdsCompetente = aValore;}
  public void setDescSedeTdsCompetente (String aValore)        { mDescSedeTdsCompetente = aValore;}

  public void  setCodTipoDecisioneMaAt(String aValore)                { mCodTipoDecisioneMaAt  = aValore;}
  public void  setDescrTipoDecisioneMaAt(String aValore)              { mDescrTipoDecisioneMaAt  = aValore;}
  public void  setCodTipoMisuraMaAt(String aValore)                   { mCodTipoMisuraMaAt  = aValore;}
  public void  setDescrTipoMisuraMaAt(String aValore)                 { mDescrTipoMisuraMaAt  = aValore;}
  public void  setDataDecisioneMaAt(Date aValore)                     { mDataDecisioneMaAt  = aValore;}
  public void  setChiaveAnnoFascicoloSiusMaAt(BigDecimal aValore)     { mChiaveAnnoFascicoloSiusMaAt  = aValore;}
  public void  setChiaveProgrFascicoloSiusMaAt(BigDecimal aValore)    { mChiaveProgrFascicoloSiusMaAt  = aValore;}
  public void  setChiaveUfficioFascicoloSiusMaAt(String aValore)      { mChiaveUfficioFascicoloSiusMaAt  = aValore;}
  public void  setDescrChiaveUfficioFascicoloSiusMaAt(String aValore) { mDescrChiaveUfficioFascicoloSiusMaAt  = aValore;}
  public void  setAnnoRegistroMaAt(BigDecimal aValore)                { mAnnoRegistroMaAt  = aValore;}
   ...
   */
    ...
    public String toString()  {
      ...
      lStr = "MisuraAlternativaModel:\n" +
             ...
             "[ mNote                        = "+mNote+" ]\n"+
             "[ mDataScarcerazione           = "+mDataScarcerazione+" ]\n"+
  ...
  public String toString2()
    ...
    lStr = "" +
            mIdMisuraAlternativa +" - " +
            mCodTipoDecisione +" - " +
            mDescrTipoDecisione +" - " +
            mCodNaturaDecisione +" - " +
            mDescrNaturaDecisione +" - " +
            mCodTipoMisura +" - " +
            mDescrTipoMisura +" - " +
            mDataDecisione +" - " +
            mCodMagistrato +" - " +
            mDescrMagistrato +" - " +
            mCodUfficioSorveglianza +" - " +
            mDescrUfficioSorveglianza +" - " +
            mCssIdCssa +" - " +
            mDescrLuogoProva +" - " +
            mNumAnniMisura +" - " +
            mNumMesiMisura +" - " +
            ...
            mDataInizioMisura +" - " +
            mDataFineMisura +" - " +
            mChiaveAnnoFascicoloSius +" - " +
            mChiaveUfficioFascicoloSius +" - " +
            mChiaveProgrFascicoloSius +" - " +
            mAnnoRegistro +" - " +
            mNumeroRegistro +" - " +
            ...
            mNote +" - " +
            mDataScarcerazione +" - "+
            mDataIngressoIstituto +" - "+
            mCodTipoUfficioScarcerazione +" - "+
            mDescrChiaveUfficioFascicoloSius +" - "+
            mFlagUfficioInserimento  +" - "+
            mNumAnniRevocaReclusione   +" - "+
            mNumMesiRevocaReclusione   +" - "+
            mNumGiorniRevocaReclusione  +" - "+
            mNumAnniRevocaArresto  +" - "+
            mNumMesiRevocaArresto  +" - "+
            mNumGiorniRevocaArresto  +" - "+
            mDataInizioRevoca  +" - "+
            mFlagPeriodoEspiato +" - "+
            mAnnoAltroTitolo +" - "+
            mNumAltroTitolo +" - "+
            mDataAltroTitolo +" - "+
            mCodLuogoAltroTitolo +" - "+
            mCodAutoritaAltroTitolo +" - "+
            mDescLuogoAltroTitolo +" - "+
            mDescAutoritaAltroTitolo +" - "+
            mFlagCheck +" - "+
            mDataScadenzaProroga +" - "+
            mFlagDecisioneTribunale +" - "+
            mCodTdsCompetente +" - "+
            mFlagSituazione +" - "+
            mDescTdsCompetente +" - "+
            mDescSedeTdsCompetente;
  ...
  /**
   * calcolaStringaMisura per la Stampa in cui serve la stringa
   * composta di anni mesi giorni
   * @return
   */
...
/**
 * calcolaStringaArresto per la Stampa in cui serve la stringa
 * composta di anni mesi giorni
 * @return
 */
