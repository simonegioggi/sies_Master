...
/**
* <p>Title: HelponlineSqlDAO</p>
* <p>Description: Classe SqlDAO che rappresenta la tabella Helponline</p>
...
public class HelponlineSqlDAO extends SqlDAO {
  /***************************************************************************** 
   * Costruttore  
   * @param con 
   ****************************************************************************/ 
  public HelponlineSqlDAO (Connection con) {
    super(con);
  }
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void getCountHelponline(HelponlineModel aModel) throws DAOException {
    // Costruisce lo statement da eseguire 
    String lStatement ="SELECT COUNT(*) HowManyRecords FROM HELPONLINE ";
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void ricercaHelponlinePaged(HelponlineModel aModel, int aPage) throws DAOException { 
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void ricercaHelponline( HelponlineModel  aModel)  throws DAOException {
   ...
   * @throws DAOException 
   ****************************************************************************/ 
  public void ricercaHelponlineByKey( BigDecimal aFunIDFunzione) throws DAOException {
    // Recupera la select...from 
    String lSql = getSqlQuery();

    // Aggiunge le where condition per chiave 
    lSql += " WHERE " + setCondizioniByKey( aFunIDFunzione);
  ...
  public GenericModel  getModel() throws DAOException {
     HelponlineModel aModel = new  HelponlineModel(); 

    //Inserire le opportune set delle descrizioni!
    aModel.setFunIdFunzione ( getBigDecimal ("FUN_ID_FUNZIONE") ); 
    aModel.setNomePagina    ( getString     ("NOME_PAGINA"    ) ); 
   ...
   * @return 
   ****************************************************************************/ 
  public String setCondizioni(HelponlineModel aModel) {
   ...
   * @return 
   ****************************************************************************/ 
  public String setCondizioniByKey( BigDecimal aFunIDFunzione) {
    String lCondizioni = new String();
