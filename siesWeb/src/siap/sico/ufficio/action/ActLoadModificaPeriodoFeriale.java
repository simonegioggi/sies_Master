...
/**
 * <p>
 * Title: ActLoadModificaPeriodoFeriale
 * </p>
 * <p>
 * Description: Classe Action per la load modifica del peridodo feriale
 * </p>
 * <p>
...
public class ActLoadModificaPeriodoFeriale extends ActionSiap
	...
	public String processRequest() throws F3BException {
		...
		if (lParMod == null) {
			throw new F3BException(F3BException.USER_MESSAGE,
					"Per l'ufficio non esiste un periodo feriale personalizzato, utilizzare la funzione di inserimento.");
		}
