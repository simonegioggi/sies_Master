...
public class ActLoadListaUfficiPerTipo extends ActionSiap implements ICostantiUfficio {
	...
	public String processRequest() throws F3BException {
		...
		String lFlagAccorp = null;
		if (!isRequestParameterNullObj(CAMPO_FLAG_ACCORP))
			lFlagAccorp = getRequestStringParameter(CAMPO_FLAG_ACCORP);

		IUfficio lCtrl = SICOLookupRemote.getUfficioRemote();
		Vector lListaUffici = lCtrl.ListaUfficiPerTipo(lCodTipoUfficio, lFlagAccorp);
