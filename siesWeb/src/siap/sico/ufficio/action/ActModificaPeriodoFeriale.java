...
/**
* <p>Title: ActModificaPeriodoFeriale</p>
* <p>Description: Classe Action per la load inserisci di modifica peridodo feriale</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public class ActModificaPeriodoFeriale extends ActionSiap 
                                       implements ICostantiUfficio, ICostantiParametro
{
  public String processRequest() throws F3BException
  {
    ...
    lParMod.setCodOperatoreAggiornamento(this.getCodUtenteConnesso());
    lParMod.setCodUfficioAggiormanento(this.getCodUfficioUtenteConnesso());
...
*/
    ...
    lParMod = lCtrlPar.ExModificaParametro(lParMod);
    ...
    return ""+lRedirigi; //PG_LOAD_DETTALGIO_PERIODO_FERIALE;
  }
}
