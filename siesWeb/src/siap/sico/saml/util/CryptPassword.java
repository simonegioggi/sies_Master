...
/**
 * CryptPassword - Classe di Utilita' per criptare la pwd del keystore e del certificato. La pwd criptata
 * generata deve essere memorizzata nel file di configurazione nsc.properties. Viene stampata a video.
 *
...
public class CryptPassword {
	...
	// SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("SHA-1");
	...
	// Cipher cipher = Cipher.getInstance("SHA-1"); // cipher is not thread safe
	...
	// Cipher cipherDec = Cipher.getInstance("SHA-1");// cipher is not thread safe
