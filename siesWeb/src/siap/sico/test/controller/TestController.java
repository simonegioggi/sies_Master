	...
	private TreeModel prelevaDati(TestModel lTest, UtenteModel aUtente, UfficioModel aUfficio)
		...
		if (lTest.getBDI() != null) {
			...
			while (lItx.hasNext()) {
				...
				// Ticket 20210507017 - veniva sovreascritto il codice BDI del singleton con la COnnection string 
				// corrompendo il contenuto del singleton. Commentato il vecchio codice e corretto.				
