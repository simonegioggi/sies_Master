...
/**
 * <p>
 * Title: LicenzaLibanticipataSqlDAO
 * </p>
 * <p>
 * Description: Classe SqlDAO che rappresenta la tabella LicenzaLibanticipata
 * </p>
 * <p>
...
public class LicenzaLibanticipataSqlDAO extends SqlDAO {
	...
	public void ricercaLicenzaLibanticipataUltimaByIDFascicoloSIEP(BigDecimal aFascID) {
		...
		lSql += " AND ID_LICENZA_LIBANTICIPATA=(SELECT MAX(ID_LICENZA_LIBANTICIPATA) FROM LICENZA_LIBANTICIPATA WHERE FAS_SIE_ID_FASCICOLO_SIEP="
				+ aFascID + ")";
		setStatement(lSql);
	}
	...
	public void ricercaLicenzaLibanticipataConcesseByIDFascicoloSIEP(BigDecimal aFascID,
		...
		if (aDL92 == null)
			...
			lSql += " AND (COD_TIPO_LICENZA = 'LA' or COD_TIPO_LICENZA = 'EP' or COD_TIPO_LICENZA = 'PP' or COD_TIPO_LICENZA = 'RD')";
		...
		lSql += " AND (FLAG_ELABORATO != 'A' OR FLAG_ELABORATO IS NULL)"; // Non considera legate ad Eventi
																			// annullati (tale flag viene
																			// settato lato SIUS)
	...
	public void ricercaLicenzaLibanticipataByIDFascicoloSIEPNew(BigDecimal aFascID, Date aDataDal,
		...
		lStatement += " SELECT " + "LA.ID_LICENZA_LIBANTICIPATA, " + "LA.COD_TIPO_LICENZA, "
				...
				+ "UFF_TIPO_EMI.RV_LOW_VALUE COD_TIPO_UFFICIO_EMITTENTE, " + "LA.DATA_EMISSIONE_ORDINANZA " + // 20/06/2008
																												// aggiunta
																												// campi.
				", LA.GIORNI_SCOMPUTATI, LA.NUMERO_ORE_NO_FRUITE, LA.NUMERO_GIORNI_NO_FRUITI, LA.COD_ESITO, LA.DATA_ANNOTAZIONE_ESITO, LA.ANNOTAZIONE,"
		...
		lStatement += " WHERE (TIPO_LICENZA.RV_DOMAIN  = 'TIPO_LICENZA' AND NVL(LA.COD_TIPO_LICENZA,'01') = TIPO_LICENZA.RV_LOW_VALUE) ";
		lStatement += " AND (STATO_PERMESSO.RV_DOMAIN  = 'STATO_PERMESSO' AND NVL(LA.COD_STATO_PERMESSO,'99') = STATO_PERMESSO.RV_LOW_VALUE) ";
		lStatement += " AND (NVL(LA.COD_LUOGO_EMITTENTE, '-') = LUOGO_EMITTENTE.COD_COMUNE )";
		lStatement += " AND UFF_EMI.COD_UFFICIO = LA.COD_UFFICIO_EMITTENTE AND UFF_TIPO_EMI.RV_DOMAIN = 'TIPO_UFFICIO' ";
		...
		lStatement += " AND (LA.COD_TIPO_LICENZA = 'LA' or LA.COD_TIPO_LICENZA = 'EP' or LA.COD_TIPO_LICENZA = 'PP' )";

		lStatement += " AND (LA.FLAG_ELABORATO != 'A' OR LA.FLAG_ELABORATO IS NULL)"; // Non considera quelle
																						// legate ad Eventi
																						// annullati (tale
																						// flag viene settato
																						// lato SIUS)
		 ...
		 * ; // Reclamo su Liberazione Anticipata lStatement += "      ) "; // Aggiungo la select che filtra
		 * solo le ordinanze collegate a provvedimenti // di comunicazione (01-12-0923) o ordine di
		 * scarcerazione (01-09-0081) emessi // in fase di acquisizione dell'ordinanza di concessione LA e
		 * validati, // eventualmente nel periodo specificato in input lStatement +=
		 * "     and evento.ID_EVENTO in ( select evento.EVE_ID_EVENTO "; lStatement +=
		 * "                                 from evento "; lStatement +=
		 * "                                where evento.FAS_SIE_ID_FASCICOLO_SIEP = "+aFascID; // lStatement
		 * += "                                  and evento.FLAG_DOCUMENTO_REGISTRATO = 'S' "; if
		 * (aDataDal!=null){ lStatement +=
		 ...
		 * (ordinanza), ma la LA e' direttamente collegata // al provvedimento di Cumulo lStatement +=
		 * "OR (evento.COD_TIPO_EVENTO='01' AND evento.COD_TIPO_PROVVEDIMENTO = '04' AND evento.COD_MOTIVO in('0222','0223','0224','0277') "
	...
	public void ricercaLAComputabiliByIdFascicoloDataValidazione(BigDecimal aFascID, Date aDataDal,
		...
		// "TIPO_LICENZA.RV_MEANING DESCR_TIPO_LICENZA, "+
				...
				// MEV10-s3: aggiunto campo in estrazione
				+ "null COD_TIPO_UFFICIO_EMITTENTE, " + "LA.DATA_EMISSIONE_ORDINANZA " + // 20/06/2008
																							// aggiunta campi.
				", LA.GIORNI_SCOMPUTATI, LA.NUMERO_ORE_NO_FRUITE, LA.NUMERO_GIORNI_NO_FRUITI, LA.COD_ESITO, LA.DATA_ANNOTAZIONE_ESITO, LA.ANNOTAZIONE, "
				+ "LA.NUMERO_GIORNI, " + "LA.NUMERO_MESI, LA.SOMMA_RISARC_DANNI ";
		lStatement += " FROM LICENZA_LIBANTICIPATA LA, EVENTO ";
		...
		lStatement += " AND (    LA.FLAG_CONCESSO = 'C'"
				+ "      OR (la.flag_concesso = 'R' AND la.cod_operatore_inserimento LIKE '%res%') " + // considero
																										// solo
																										// le
																										// revoche
																										// res
		...
		lStatement += " AND (   LA.COD_TIPO_LICENZA = 'LA' "
				+ " OR LA.COD_TIPO_LICENZA = 'EP' OR LA.COD_TIPO_LICENZA = 'PP' " + // Anna per scomputo
																					// permesso
	...
	protected String getCondizioniLA(BigDecimal aFascID, Date aDataDal, Date aDataAl,
		...
		lStatement += "      ("; // 11a
		lStatement += "           ("; // 111a
		lStatement += "                (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '2130') "; // UDS
		lStatement += "        	   or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '0076') "; // TDS
		lStatement += "            or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '2135' and EVENTO.COD_OPERATORE_INSERIMENTO like '%res%') "; // Revoca
																																																	// RES
		lStatement += "            or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '0113') "; // Concessione
																																				// su
																																				// Reclamo
																																				// (MEV
																																				// A8RR083)
		lStatement += "            or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '2131') "; // LA
																																				// Speciale
		lStatement += "            or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '03' and EVENTO.COD_MOTIVO = '2132') "; // Integrazione
																																				// LA
		...
		lStatement += "            or  (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO in ('02','03') and EVENTO.COD_MOTIVO = '2790' or EVENTO.COD_MOTIVO = '9027') ";
		lStatement += "           ) "; // 111b
		...
		lStatement += "                                		     (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '12' and EVENTO.COD_MOTIVO = '0923') "; // comunicazione
																																											// -
																																											// Concessione
																																											// Liberazione
																																											// Anticipata
																																											...
																																											// condannato
																																											// Libero
		lStatement += "                                       or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '12' and EVENTO.COD_MOTIVO = '0922') "; // comunicazione
																																											// -
																																											// Concessione
																																											// Liberazione
																																											// Anticipata
																																											...
																																											// in
																																											// Ergastolo
		lStatement += "                                       or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '09' and EVENTO.COD_MOTIVO = '0081') "; // ordine
																																											// di
																																											// scarcerazione
																																											// -
																																											// Nuova
																																											...
																																											// condannato
																																											// detenuto
		lStatement += "                                       or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '09' and EVENTO.COD_MOTIVO = '0083') "; // ordine
																																											// di
																																											// scarcerazione
																																											// -
																																											// Nuova
																																											...
																																											// misura
																																											// alternativa
		lStatement += "                                       or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '09' and EVENTO.COD_MOTIVO = '0028'  "; // ordine
																																											// di
																																											// scarcerazione
																																											// -
																																											// Revoca
		...
		// Rimedi Risarcitori DL 02 Decreto e Ordinanza cod 2790 aggiunto il 10/2014
		// Ticket#20190805017 aggiungo i codici '9032','9033','9034' nella 'IN' seguente, relativi al Reclamo Rimedi Risarcitori DL n. 92
		lStatement += "                                       or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO in ('09','12') and EVENTO.COD_MOTIVO in ('5491','5492','5493','5494','5495', '9032','9033','9034', '9154', '9254') ) ";
		lStatement += "                                      )"; // 1121b
		lStatement += "           )"; // 112b
		...
		lStatement += "               (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '25' and EVENTO.COD_MOTIVO = '0995') ";
		lStatement += " 	  			 or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '25' and EVENTO.COD_MOTIVO = '1008') "; // new
		// 07/2014 REVOCA LA
		// Rideterminazione della pena a seguito di scomputo di permesso
		lStatement += "            or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '25' and EVENTO.COD_MOTIVO = '0958') ";
		// Rideterminazione fine pena a seguito accoglimento reclamo scomputo permesso
		lStatement += " 	   			 or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '25' and EVENTO.COD_MOTIVO = '0994') ";
		// ==========================================================================
		...
		// ==========================================================================
		lStatement += "		   			  or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '04' and EVENTO.COD_MOTIVO in('0222','0223','0224','0277')) ";
		// MEV26 Nuovo Cumulo
		...
		// ==========================================================================
		lStatement += "		   			  or (EVENTO.COD_TIPO_EVENTO='01' and EVENTO.COD_TIPO_PROVVEDIMENTO = '04' and EVENTO.COD_MOTIVO = '0925') ";
		lStatement += "      	  )"; // 121b
	...
	protected String getSqlQuery() {
		...
		lStatement += " SELECT " + "ID_LICENZA_LIBANTICIPATA, " + "COD_TIPO_LICENZA, "
				...
				// MEV10-s3: aggiunto campo in estrazione
				"UFF_TIPO_EMI.RV_LOW_VALUE COD_TIPO_UFFICIO_EMITTENTE, " + "DATA_EMISSIONE_ORDINANZA " + // 20/06/2008
																											// aggiunta
																											// campi.
				", GIORNI_SCOMPUTATI, NUMERO_ORE_NO_FRUITE, NUMERO_GIORNI_NO_FRUITI, COD_ESITO, DATA_ANNOTAZIONE_ESITO, ANNOTAZIONE"
				+ ", NUMERO_MESI, SOMMA_RISARC_DANNI ";

		lStatement += " FROM LICENZA_LIBANTICIPATA, CG_REF_CODES TIPO_LICENZA, CG_REF_CODES STATO_PERMESSO, ";
		lStatement += " COMUNE LUOGO_EMITTENTE, UFFICIO UFF_EMI, CG_REF_CODES UFF_TIPO_EMI";
		lStatement += " WHERE (TIPO_LICENZA.RV_DOMAIN  = 'TIPO_LICENZA' AND NVL(COD_TIPO_LICENZA,'01') = TIPO_LICENZA.RV_LOW_VALUE) ";
		lStatement += " AND (STATO_PERMESSO.RV_DOMAIN  = 'STATO_PERMESSO' AND NVL(COD_STATO_PERMESSO,'99') = STATO_PERMESSO.RV_LOW_VALUE) ";
	...
	protected String getSqlEventoQuery() {
		...
		lStatement += " SELECT " + "ID_LICENZA_LIBANTICIPATA, " + "COD_TIPO_LICENZA, "
				...
				+ "UFF_TIPO_EMI.RV_LOW_VALUE COD_TIPO_UFFICIO_EMITTENTE, " + "DATA_EMISSIONE_ORDINANZA" + // 20/06/2008
																											// aggiunta
																											// campi.
				", GIORNI_SCOMPUTATI, NUMERO_ORE_NO_FRUITE, NUMERO_GIORNI_NO_FRUITI, LIC.COD_ESITO, LIC.DATA_ANNOTAZIONE_ESITO, LIC.ANNOTAZIONE,"
				+ "NUMERO_MESI ";
		lStatement += " FROM LICENZA_LIBANTICIPATA LIC, EVENTO, CG_REF_CODES TIPO_LICENZA, CG_REF_CODES STATO_PERMESSO, ";
		lStatement += " COMUNE LUOGO_EMITTENTE, UFFICIO UFF_EMI, CG_REF_CODES UFF_TIPO_EMI";
		lStatement += " WHERE (TIPO_LICENZA.RV_DOMAIN  = 'TIPO_LICENZA' AND NVL(COD_TIPO_LICENZA,'01') = TIPO_LICENZA.RV_LOW_VALUE) ";
		lStatement += " AND (STATO_PERMESSO.RV_DOMAIN  = 'STATO_PERMESSO' AND NVL(COD_STATO_PERMESSO,'99') = STATO_PERMESSO.RV_LOW_VALUE) ";
		lStatement += " AND (NVL(LIC.COD_LUOGO_EMITTENTE, '-') = LUOGO_EMITTENTE.COD_COMUNE )";
		lStatement += " AND UFF_EMI.COD_UFFICIO = LIC.COD_UFFICIO_EMITTENTE AND UFF_TIPO_EMI.RV_DOMAIN = 'TIPO_UFFICIO' ";
		lStatement += " AND UFF_TIPO_EMI.RV_LOW_VALUE = UFF_EMI.COD_TIPO_UFFICIO";
