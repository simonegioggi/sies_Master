...
/**
 * LicenzaLibanticipataDAO - Classe DAO che rappresenta la tabella LicenzaLibanticipata
 *
 * @version 1.0
 */
public class LicenzaLibanticipataDAO extends TableDAO {
	...
	public LicenzaLibanticipataDAO(Connection con) {
		...
		setField("COD_MOTIVO_DETENZIONE", STRING);
	}
	...
	public BigDecimal getIdLicenzaLibanticipata() throws DAOException {
		return getBigDecimal("ID_LICENZA_LIBANTICIPATA");
	}

	public String getCodTipoLicenza() throws DAOException {
		return getString("COD_TIPO_LICENZA");
	}

	public BigDecimal getNumeroGiorni() throws DAOException {
		return getBigDecimal("NUMERO_GIORNI");
	}
	...
	public Date getDataDetenzRifDa() throws DAOException {
		return getDate("DATA_DETENZ_RIF_DA");
	}

	public Date getDataDetenzRifA() throws DAOException {
		return getDate("DATA_DETENZ_RIF_A");
	}

	public String getFlagInfrazioneObblighi() throws DAOException {
		return getString("FLAG_INFRAZIONE_OBBLIGHI");
	}

	public Date getDataInfrazioneObblighi() throws DAOException {
		return getDate("DATA_INFRAZIONE_OBBLIGHI");
	}

	public String getDescrInfrazioneObblighi() throws DAOException {
		return getString("DESCR_INFRAZIONE_OBBLIGHI");
	}

	public String getFlagScomputo() throws DAOException {
		return getString("FLAG_SCOMPUTO");
	}
	...
	public String getFlagConcesso() throws DAOException {
		return getString("FLAG_CONCESSO");
	}
	...
	public String getFlagScorta() throws DAOException {
		return getString("FLAG_SCORTA");
	}

	public String getCodStatoPermesso() throws DAOException {
		return getString("COD_STATO_PERMESSO");
	}

	public String getDescrStatoPermesso() throws DAOException {
		return getString("DESCR_STATO_PERMESSO");
	}

	public BigDecimal getNumeroOre() throws DAOException {
		return getBigDecimal("NUMERO_ORE");
	}
	...
	public BigDecimal getAnnoOrdinanza() throws DAOException {
		return getBigDecimal("ANNO_ORDINANZA");
	}

	public BigDecimal getNumeroOrdinanza() throws DAOException {
		return getBigDecimal("NUMERO_ORDINANZA");
	}
	...
	public String getCodTipoUfficioEmittente() throws DAOException {
		return getString("COD_TIPO_UFFICIO_EMITTENTE");
	}

	public Date getDataEmissioneOrdinanza() throws DAOException {
		return getDate("DATA_EMISSIONE_ORDINANZA");
	}

	public String getGiorniScomputati() throws DAOException {
		return getString("GIORNI_SCOMPUTATI");
	}

	public BigDecimal getNumeroGiorniNoFruiti() throws DAOException {
		return getBigDecimal("NUMERO_GIORNI_NO_FRUITI");
	}

	public BigDecimal getNumeroOreNoFruite() throws DAOException {
		return getBigDecimal("NUMERO_ORE_NO_FRUITE");
	}
	...
	public Date getDataAnnotazioneEsito() throws DAOException {
		return getDate("DATA_ANNOTAZIONE_ESITO");
	}
	...
	public BigDecimal getNumeroMesi() throws DAOException {
		return getBigDecimal("NUMERO_MESI");
	}

	public BigDecimal getSommaRisarcDanni() throws DAOException {
		return getBigDecimal("SOMMA_RISARC_DANNI");
	}

	// MEV_2025-48: aggiunta nuova sezione - codice motivo detenzione
	public String getCodMotivoDetenzione() throws DAOException {
		return getString("COD_MOTIVO_DETENZIONE");
	}
	...
	public void setIdLicenzaLibanticipata(BigDecimal aValore) {
		setBigDecimal("ID_LICENZA_LIBANTICIPATA", aValore);
	}

	public void setCodTipoLicenza(String aValore) {
		setString("COD_TIPO_LICENZA", aValore);
	}

	public void setNumeroGiorni(BigDecimal aValore) {
		setBigDecimal("NUMERO_GIORNI", aValore);
	}
	...
	public void setFlagConcesso(String aValore) {
		setString("FLAG_CONCESSO", aValore);
	}
	...
	public void setAnnoOrdinanza(BigDecimal aValore) {
		setBigDecimal("ANNO_ORDINANZA", aValore);
	}

	public void setNumeroOrdinanza(BigDecimal aValore) {
		setBigDecimal("NUMERO_ORDINANZA", aValore);
	}

	public void setNumeroMesi(BigDecimal aValore) {
		setBigDecimal("NUMERO_MESI", aValore);
	}
	...
	public void setDataEmissioneOrdinanza(Date aValore) {
		setDate("DATA_EMISSIONE_ORDINANZA", aValore);
	}

	public void setGiorniScomputati(String aValore) {
		setString("GIORNI_SCOMPUTATI", aValore);
	}

	public void setNumeroGiorniNoFruiti(BigDecimal aValore) {
		setBigDecimal("NUMERO_GIORNI_NO_FRUITI", aValore);
	}

	public void setNumeroOreNoFruite(BigDecimal aValore) {
		setBigDecimal("NUMERO_ORE_NO_FRUITE", aValore);
	}
	...
	public void setDataAnnotazioneEsito(Date aValore) {
		setDate("DATA_ANNOTAZIONE_ESITO", aValore);
	}
	...
	// MEV_2025-48: aggiunta nuova sezione - codice motivo detenzione
	public void setCodMotivoDetenzione(String aValore) {
		setString("COD_MOTIVO_DETENZIONE", aValore);
	}

	public GenericModel getModel() throws DAOException {

		return new LicenzaLibAnticipataModel(getIdLicenzaLibanticipata(), getCodTipoLicenza(), "",
				getNumeroGiorni(), getDataInizio(), getOraInizio(), getDataFine(), getOraFine(),
				getLuogoSvolgimentoProva(), getDataDetenzRifDa(), getDataDetenzRifA(),
				getFlagInfrazioneObblighi(), getDataInfrazioneObblighi(), getDescrInfrazioneObblighi(),
				getFlagScomputo(), getCodOperatoreInserimento(), getDataInserimento(),
				getCodUfficioInserimento(), "", getCodOperatoreAggiornamento(), getDataAggiornamento(),
				getCodUfficioAggiornamento(), "", getFasSiuIdFascicoloSius(), getEveIdEvento(),
				getFasSieIdFascicoloSiep(), getFlagConcesso(), getFlagElaborato(), getFlagScorta(),
				getCodStatoPermesso(), getDescrStatoPermesso(), getNumeroOre(), getAnnoSius(),
				getNumeroSius(), getAnnoOrdinanza(), getNumeroOrdinanza(), getCodUfficioEmittente(), "",
				getCodLuogoEmittente(), "",
				// MEV10-s3: aggiunta variabile
				getCodTipoUfficioEmittente(), getDataEmissioneOrdinanza(), getGiorniScomputati(),
				getCodEsito(), "", getDataAnnotazioneEsito(), getAnnotazione(), getNumeroGiorniNoFruiti(),
				getNumeroOreNoFruite(), getNumeroMesi(), getSommaRisarcDanni(),
				// MEV_2025-48: aggiunta nuova sezione - codice motivo detenzione
				getCodMotivoDetenzione());
	}
	...
	public void setDAOFromModel(LicenzaLibAnticipataModel aModel) throws DAOException {
		...
		// MEV_2025-48: aggiunta nuova sezione - codice motivo detenzione
		setCodMotivoDetenzione(aModel.getCodMotivoDetenzione());
	}
	...
	public void setDAOFromModelForUpdateIdFascicoloSiep(LicenzaLibAnticipataModel aModel)
			throws DAOException {
	...
	public void setDAOFromOrdinanzaForUpdate(DepositoOrdinanzaPcModel aModel, BigDecimal aIdFascicoloSiep)
			throws DAOException {
	...
	// Update LicenzaLibAnticipata va aggiornata per FAS_SIE_ID_FASCICOLO_SIEP.
	public void setDAOFromDecretoForUpdate(DepositoDecretoModel aModel, BigDecimal aIdFascicoloSiep)
			throws DAOException {
