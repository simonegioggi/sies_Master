 ...
 *
 * <p>
 * Title: ActInserisciComunicazioneReclamoRimediRisarcitori
 * </p>
 * <p>
...
public class ActInserisciComunicazioneReclamoRimediRisarcitori extends ActionSiap
	...
	public String processRequest() throws F3BException {
		...
		if ("S".equals(getRequestStringParameter("isErgastolo"))) {
			lEveModel.setCodMotivo("9033"); // Concessione Reclamo Risarcimento Danni D.L. 92/2014 -
											// Condannato in Ergastolo
		} else if ("S".equals(getRequestStringParameter("isLibero"))) {
			lEveModel.setCodMotivo("9032"); // Concessione Reclamo Risarcimento Danni D.L. 92/2014 -
											// Condannato Libero
		} else {
			lEveModel.setCodMotivo("9034"); // Concessione Reclamo Risarcimento Danni D.L. 92/2014 -
											// Condannato già Scarcerato
		}
...
//						getCodComuneByDescr(lSedeAutoritaEsternaAvvocato[lIndex]));
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.sico.libertaanticipata.action.ActDettaglioComunicazioneReclamoRimediRisarcitori&"
