...
/**
 * <p>
 * Title: ActUploadComunicazioneRimediRisarcitori
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * @since 10/2014
 */
public class ActUploadComunicazioneRimediRisarcitori extends ActionSiap implements ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		if (isRequestChecked(ICostantiEvento.CAMPO_VALIDA)) {
			...
			lCtrlLib.ExUpdateValidaComunicazioneRimediRisarcitori(lModel);
		} else {
