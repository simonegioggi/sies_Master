 ...
 * @since
 */
public class ActInserisciReclamoRimediRisarcitori extends ActionSiap implements ICostantiLibertaAnticipata
{
  ...
  public String processRequest() throws Exception
  {
    ...
    // Recupero l'EVENTO
	// Questo parametro è valorizzato solo nel caso in cui è stato selezionato un Provvedimnto
	// di Sorveglianza dalla lista (pop-up), in caso contrario bisogna procedere con l'insrimento
	// dei dati.
    ...
    } // end if (lIdEvento != null)
    
    String lPage = "";

    lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD 
         + "=siap.sico.libertaanticipata.action.ActDettaglioReclamoRimediRisarcitori&"+ICostantiEvento.CAMPO_ID_EVENTO+"="+lIdEvento;
  ...
  private EventoModel generaEvento (String aEsitoTenore, DatiOperazioneModel aDatiOperazione) throws F3BException
  {
    ...
    // MERGE v10: modificato codice motivo per il reclamo
    lEvento.setCodMotivo("9027");  // 9027 = Riduzione pena da espiare/risarcimento del danno(Reclamo art. 35 ter O.P.)
