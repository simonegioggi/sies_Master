...
/**
* <p>Title: ResidenzaSqlDAO</p>
* <p>Description: Classe SqlDAO che rappresenta la tabella Residenza</p>
...
public class ResidenzaSqlDAO extends SIAPSqlDAO
{
 ...
 public void ricercaResidenzaByFascicoloXStampa(BigDecimal aKeyFascicolo) throws DAOException
  ...
  public void ricercaResidenzaByProcedimentoSius(BigDecimal aKeyFascicolo, char aTipoResidenza) throws DAOException
  {
    String lStatement = getSqlStringRelazioneSius();
  ...
  public void ricercaResidenzaByProcedimentoSige(BigDecimal aKeyFascicolo, char aTipoResidenza) throws DAOException
  {
    String lStatement = getSqlStringRelazioneSige();
  ...
  public void ricercaResidenzaUltimaByProcedimentoSius(BigDecimal aKeyFascicolo, char aTipoResidenza) throws DAOException
  {
    String lStatement = getSqlStringRelazioneSius();
  ...
  public void ricercaResidenzaUltimaByProcedimentoSige(BigDecimal aKeyFascicolo, char aTipoResidenza) throws DAOException
  {
    String lStatement = getSqlStringRelazioneSige();
  ...
  public void ricercaResidenzaFascicoloSiepByIdResidenzaIdFascicolo(BigDecimal aKeyResidenza,BigDecimal aKeyFascicolo) throws DAOException
 {
 ...
 public void ricercaResidenzaFascicoloSiusByIdResidenzaIdFascicolo(BigDecimal aKeyResidenza,BigDecimal aKeyFascicolo) throws DAOException
  {
  ...
  public String getSqlStringRelazioneSiep() throws DAOException
  {
    String lStatement = "SELECT" +
                        " ID_RESIDENZA,"+
                        " COD_STATO,"+
                        " DESCR_STATO.RV_MEANING DESCR_STATO,"+
                        " RESIDENZA.COD_PROVINCIA,"+
                        " DESCR_PROVINCIA.RV_MEANING DESCR_PROVINCIA,"+
                        " RESIDENZA.COD_COMUNE,"+
                        " COMUNE.DESCRIZIONE DESCR_COMUNE,"+
                        " RESIDENZA.CAP,"+
                        " INDIRIZZO,"+
                        " COD_TIPO_RESIDENZA,"+
                        " DESC_COMUNE_ESTERO,"+
                        " DESCR_TIPO_RESIDENZA.RV_MEANING DESCR_TIPO_RESIDENZA,"+
                        " RESIDENZA.COD_OPERATORE_INSERIMENTO,"+
                        " RESIDENZA.DATA_INSERIMENTO,"+
                        " RESIDENZA.COD_UFFICIO_INSERIMENTO,"+
                        " RESIDENZA.COD_OPERATORE_AGGIORNAMENTO,"+
                        " RESIDENZA.DATA_AGGIORNAMENTO,"+
                        " RESIDENZA.COD_UFFICIO_AGGIORNAMENTO,"+
                        " RESIDENZA.SOG_ID_SOGGETTO,"+
                        " RESIDENZA_FASCICOLO_SIEP.DATA_INIZIO_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIEP.DATA_FINE_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIEP.RES_ID_RESIDENZA,"+
                        " RESIDENZA_FASCICOLO_SIEP.FAS_SIE_ID_FASCICOLO_SIEP,"+
    			        " RESIDENZA.FLG_DOM_AVV," +
  ...
  public String getSqlStringRelazioneSius() throws DAOException
  {
    String lStatement = "SELECT" +
                        ...
                        " RESIDENZA.COD_UFFICIO_AGGIORNAMENTO,"+
                        " RESIDENZA.SOG_ID_SOGGETTO,"+
                        " RESIDENZA_FASCICOLO_SIUS.DATA_INIZIO_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIUS.DATA_FINE_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIUS.FAS_SIU_ID_FASCICOLO_SIUS,"+
                        " RESIDENZA.FLG_DOM_AVV," +
    			        " RESIDENZA.ID_PARTE_UDIENZA," +
                        " RESIDENZA.FLG_DOMICILIO_DIFENSORE";
  ...
  public String getSqlStringRelazioneSige() throws DAOException
  {
    String lStatement = "SELECT" +
                        ...
                        " RESIDENZA.COD_UFFICIO_AGGIORNAMENTO,"+
                        " RESIDENZA.SOG_ID_SOGGETTO,"+
                        " RESIDENZA_FASCICOLO_SIGE.DATA_INIZIO_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIGE.DATA_FINE_VALIDITA,"+
                        " RESIDENZA_FASCICOLO_SIGE.FAS_SIGE_ID_FASCICOLO_SIGE,"+
                        " RESIDENZA.FLG_DOM_AVV," +
    			        " RESIDENZA.ID_PARTE_UDIENZA," +
                        " RESIDENZA.FLG_DOMICILIO_DIFENSORE";
  ...
  public void ricercaMaxIdResidenzaPerIdSoggetto(BigDecimal aIdSoggetto, String aTipoResidenza) throws DAOException
  {
  ...
  public String setCondizioneResODomCorrenteByIdFascicolo(String aTipoResidenza, BigDecimal aIdSoggetto)
  {
    ...
    lCondizioni = " (SELECT MAX(ID_RESIDENZA) FROM RESIDENZA WHERE COD_TIPO_RESIDENZA = '"+aTipoResidenza+"' AND SOG_ID_SOGGETTO = "+aIdSoggetto+")";
...
/*
      if( (aModel.getFasSieIdFascicoloSiep() != null) && (aModel.getFasSieIdFascicoloSiep().intValue() != 0) )
      {
        lCondizioni += " AND FAS_SIE_ID_FASCICOLO_SIEP = "+ aModel.getFasSieIdFascicoloSiep();
      }
      if( (aModel.getFasSiuIdFascicoloSius() != null) && (aModel.getFasSiuIdFascicoloSius().intValue() != 0) )
      {
...
*/
  ...
  /**
* <p>Description: Metodo di ricerca, restituisce il numero di occorrenze
* nella tabella RESIDENZA_FASCICOLO_SIUS relative ad una Residenza specifica.
* </p>
* @param  BigDecimal aIdResidenza : Identificativo Residenza
* @return int : numero occorrenze.
* @throws DAOException
*/

  public int getNumOccorrenze(BigDecimal aIdResidenza)
    throws DAOException
  {
    BigDecimal lCount = null;
    int retNum = -1;

    String lStatement = "select count(*) as COUNT from RESIDENZA_FASCICOLO_SIUS  where RES_ID_RESIDENZA = " + aIdResidenza;
  ...
  */
  ...
  public int getNumOccorrenzeResSIGE(BigDecimal aIdResidenza)
  throws DAOException
  {
	  BigDecimal lCount = null;
      int retNum = -1;

      String lStatement = "select count(*) as COUNT from RESIDENZA_FASCICOLO_SIGE  where RES_ID_RESIDENZA = " + aIdResidenza;
  ...
  public String setCondizioneSige(ResidenzaModel aModel, BigDecimal idSoggettoSiep)
  {
    ...
    lCondizioni += " AND (SOG_ID_SOGGETTO = "+ aModel.getSogIdSoggetto() + " OR SOG_ID_SOGGETTO = " + idSoggettoSiep + ")";
