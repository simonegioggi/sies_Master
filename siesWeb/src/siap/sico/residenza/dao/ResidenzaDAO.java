...
/**
* <p>Title: ResidenzaDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella Residenza</p>
...
public class ResidenzaDAO extends SIAPTableDAO
{
  ...
  public BigDecimal     getIdResidenza() 				throws DAOException	    { return getBigDecimal("ID_RESIDENZA"); }
  public String 		getCodStato() 					throws DAOException	    { return getString("COD_STATO"); }
  ...
  public String 		getCodTipoResidenza() 			throws DAOException	    { return getString("COD_TIPO_RESIDENZA"); }
  ...
  public String 		getDescComuneEstero() 			throws DAOException	    { return getString("DESC_COMUNE_ESTERO"); }
  public String 		getFlgDomAvv() 					throws DAOException	    { return getString("FLG_DOM_AVV"); }
  public BigDecimal     getIdParteUdienza() 			throws DAOException	    { return getBigDecimal("ID_PARTE_UDIENZA"); }
  public String 		getFlgDomicilioDifensore() 		throws DAOException	    { return getString("FLG_DOMICILIO_DIFENSORE"); }
  
  //
  // METODI SET()
  //

  public void setIdResidenza(BigDecimal aValore ) 			      { setBigDecimal("ID_RESIDENZA", aValore); }
  public void setCodStato(String aValore ) 			              { setString("COD_STATO", aValore); }
  ...
  public void setCodTipoResidenza(String aValore ) 			      { setString("COD_TIPO_RESIDENZA", aValore); }
  ...
  public void setDescComuneEstero(String aValore ) 		          { setString("DESC_COMUNE_ESTERO", aValore); }
  public void setSogIdSoggetto(BigDecimal aValore ) 			  { setBigDecimal("SOG_ID_SOGGETTO", aValore); }
  public void setFlgDomAvv(String aValore ) 			          { setString("FLG_DOM_AVV", aValore); }
  public void setIdParteUdienza(BigDecimal aValore ) 			  { setBigDecimal("ID_PARTE_UDIENZA", aValore); }
  public void setFlgDomicilioDifensore(String aValore ) 		  { setString("FLG_DOMICILIO_DIFENSORE", aValore); }
  
  public GenericModel getModel() throws DAOException
  {
    return new ResidenzaModel(
                               getIdResidenza() ,
                               getCodStato() ,
                               "",
                               getCodProvincia() ,
...
/*
  public void selAttiviNonAssociatiPerIdSoggetto(BigDecimal aIdSoggetto)
  {
    String lCondizioni = " SOG_ID_SOGGETTO = " + aIdSoggetto;
    lCondizioni += " AND FAS_SIE_ID_FASCICOLO_SIEP IS NULL";
    lCondizioni += " AND DATA_FINE_VALIDITA IS NULL";
...
*/
  ...
  // ******* ORDER BY ****************
	...
	{
	    setCondition(" ID_RESIDENZA IN ( select distinct RES_ID_RESIDENZA from  RESIDENZA_FASCICOLO_SIGE where FAS_SIGE_ID_FASCICOLO_SIGE = " + aIdFasSige   + " )" );
	}
