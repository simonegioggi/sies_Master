 ...
 * @version 1.0
 */
public class ActLoadDettaglioSoggettoCodCui extends ActionSiap implements ICostantiSoggetto {
	...
	public String processRequest() throws Exception {
		...
		FascicoloSigeEstesoModel lFascEsteso = new FascicoloSigeEstesoModel();
		setSessionAttribute("FascicoloSigeEsteso", lFascEsteso);
		...
		return PG_LOAD_DETTAGLIOSOGGETTO_COD_CUI;
