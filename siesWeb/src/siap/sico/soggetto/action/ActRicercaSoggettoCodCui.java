...
/**
 * <p>
 * Title: ActRicercaSoggettoCodCui
 * </p>
 * <p>
 * Description: Ricerca del soggetto per Codice Cui
 * </p>
 */
@SuppressWarnings("rawtypes")
public class ActRicercaSoggettoCodCui extends ActionSiapMinor implements ICostantiSoggetto {

	public String processRequest() throws Exception {

		String codCui = "";
		codCui = getRequestStringParameter(CAMPO_COD_AFIS);
		...
		// lComMod = new
		// ComuneModel(getDatiComuneByCodDescrFlagVal(getRequestStringParameter(ICostantiComune.CAMPO_COD_COMUNE_REALE),
		// getRequestStringParameter(CAMPO_COD_COMUNE_NASCITA)));
		// } else {
		// // altrimenti dalla sola descrizione (rischio omonimi)
		// lComMod = new
		// ComuneModel(getDatiComuneByDescrOmonimiaFlagVal(getRequestStringParameter(CAMPO_COD_COMUNE_NASCITA)));
		// }
		//
		...
		// * Vengono cercati solo i soggetti appartenenti all'ufficio dell'utente *
		...
		// Prima conto il numero totale dei soggetti, usando il vector lSoggettiFasc2,
		...
		// e nella ricerca passo il parametro nteger.parseInt(lPagina) per la paginazione 20 per volta
		...
		// lSoggettiFasc = lFascSogCtrl.ExRicercaSoggettoCodCuiPerDistrettoProgFasc(lSogMod,
		// getCodDistrettoUtenteConnesso(), Integer.parseInt(lPagina), checkMinori());

		// Bottone di Ritorno
		// setLinkRitorno();
		this.gestioneRitornoCodCui();
		...
		if (lSoggettiFasc.size() == 1) {
			...
			lReturnPage = PG_RICERCASOGGETTO_COD_CUI;

			// Non serve più perchè il bottone di ritornoin maniera standard ! Luigi
