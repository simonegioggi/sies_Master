...
/**
 * <p>
 * Title: ICostantiUtente
 * </p>
 * <p>
 * Description: Classe di costanti di Utente
 * </p>
 * <p>
...
public interface ICostantiUtente extends ICostanti {
	...
	public static final String PG_LOAD_RICERCAUTENTE = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadRicercaUtente.jsp";
	public static final String PG_LOAD_DETTAGLIOUTENTE = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadDettaglioUtente.jsp";
	public static final String PG_RICERCAUTENTE = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/RicercaUtente.jsp";
	public static final String PG_LISTAUTENTI = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/ListaUtenti.jsp";
	public static final String PG_LOAD_INSERISCIUTENTE = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadInserisciUtente.jsp";
	public static final String PG_LOAD_MODIFICAUTENTE = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadModificaUtente.jsp";
	public static final String PG_LOAD_MODIFICAPWD = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadModificaPassword.jsp";
	public static final String PG_LOAD_RICERCA_UTENTE_ATTIVO = IWebConstants.ROOT_DIR
			+ "files/siap/sico/utente/LoadRicercaUtenteAttivo.jsp";
