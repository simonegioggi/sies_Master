...
public class ActVediSessioneSIGE extends ActionSiap {
	...
	public String processRequest() throws F3BException {
		...
		String lPage = "/jsp/files/siap/sige/sessione/VediStatoSessione.jsp";
		...
		// Controllo degli attributi in sessione
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug(" ##-- Attributi in Sessione --##");
		String lNome = null;
