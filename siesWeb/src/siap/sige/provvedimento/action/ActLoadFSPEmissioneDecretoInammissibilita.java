...
public class ActLoadFSPEmissioneDecretoInammissibilita extends ActLoadRicercaFSigePuntuale
	implements ICostantiProvvedimentoSige
{
	public String processRequest() throws Exception
	{
		...
		setRequestAttribute("nextAction", "siap.sige.provvedimento.action.ActLoadEmissioneDecretoInammissibilita");
