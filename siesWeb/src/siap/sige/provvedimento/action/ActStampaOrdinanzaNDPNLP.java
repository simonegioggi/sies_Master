...
public class ActStampaOrdinanzaNDPNLP extends ActionSige implements ICostantiProvvedimentoSige
{

	/**
  * Azione di Stampa dell'Ordinanza di NDP/NLP
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    if(!isRequestParameterNullObj(ICostantiTemplate.CAMPO_ID_TEMPLATE))
    	...
    	lEveMod.setTemIdTemplate("SIGE_OR_006") ;
