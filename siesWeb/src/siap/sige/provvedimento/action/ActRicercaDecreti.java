 ...
 * @version 1.0
 */
public class ActRicercaDecreti extends ActionSige implements ICostantiProvvedimentoSige {
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActRicercaDecreti : inizio");
		...
		lVect = mCtrl.ExRicercaProvvSigePerIdFasSigeTipiProvv(lIdFascicolo, TIPI_PROVVEDIMENTI_DECRETI);
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActRicercaDecreti: fine");
