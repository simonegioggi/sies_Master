...
/**
 * <p>
 * Title: ActLoadEmissioneOrdinanzaNDPNLP
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di ActLoadEmissioneOrdinanzaNDPNLP
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadEmissioneOrdinanzaNDPNLP extends ActRicercaFSigePuntuale
	...
	public String processRequest() throws Exception {
		...
		if (lProvvedimento != null) {
			...
			if (lProvvedimento.getProvvedimento() != null
				...
				throw new SIGEException(SIGEException.USER_MESSAGE,
						"Impossibile emettere Ordinanza di NDP/NLP! E' stato già emesso un Provvedimento di tipo definitorio!");
			}
		}
		...
		// In caso di esistenza di Ordinanza di NDP/NLP non annullata, oppure;
		// In caso di esistenza di Ordinanza di NDP/NLP svalidata, si accede al suo Dettaglio.
		// Altrimenti si può emettere un'altra Ordinanza di NDP/NLP.
		if (lProvvedimento != null && lProvvedimento.getProvvedimento() != null
			...
			// Prepara la pagina di destinazione, il Dettaglio Ordinanza di NDP/NLP.
			RedirectTo lPage = new RedirectTo();
			lPage.setPage(IWebConstants.PG_MAIN);

			lPage.setAction("siap.sige.provvedimento.action.ActDettaglioOrdinanzaNDPNLP");
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActLoadEmissioneOrdinanzaNDPNLP: -> page: " + lRetPage);
