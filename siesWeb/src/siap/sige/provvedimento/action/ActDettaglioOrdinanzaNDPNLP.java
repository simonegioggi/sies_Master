...
/**
 * <p>
 * Title: ActDettaglioOrdinanzaNDPNLP
 * </p>
 * <p>
 * Description: Classe Action per il Dettaglio Ordinanza NDP/NLP
 * </p>
 * <p>
...
public class ActDettaglioOrdinanzaNDPNLP extends ActLoadEmissioneOrdinanzaNDPNLP implements
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioOrdinanzaNDPNLP: inizio");
		...
		String lRetPage = PG_DETTAGLIO_ORDINANZA_NDPNLP;
		...
		lTempRic.setCodTipoProvvedimentoSige(ICostantiProvvedimentoSige.COD_ORDINANZA_NDPNLP);
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioOrdinanzaNDPNLP: -> page: " + lRetPage);
