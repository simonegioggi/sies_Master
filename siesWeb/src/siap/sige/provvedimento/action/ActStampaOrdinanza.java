...
public class ActStampaOrdinanza extends ActionSige implements ICostantiProvvedimentoSige
{
  ...
  */
  public String processRequest() throws Exception
  {
      ...
      siesLogger.debug("ActStampaOrdinanza : Inizio");
    ...
    if(lEveMod.getTemIdTemplate() == null || lEveMod.getTemIdTemplate().trim().length()<1)
    {
    	if(!isRequestParameterNullObj(ICostantiTemplate.CAMPO_ID_TEMPLATE))
    		...
    		lEveMod.setTemIdTemplate("SIGE_OR_001") ;
        // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    ...
    //lProEveMod.setNomeTemplate("SIGE_OR_001");
   ...
   if (lReport != null)
    ...
    // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    siesLogger.debug("ActStampaOrdinanza : Fine");
