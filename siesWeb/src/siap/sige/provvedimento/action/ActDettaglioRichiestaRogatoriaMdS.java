...
public class ActDettaglioRichiestaRogatoriaMdS extends ActLoadEmissioneOrdinanzaIncompetenza
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioRichiestaRogatoriaMdS: inizio");
		...
		// String lRetPage = PG_DETTAGLIO_RICHIESTA_ROGATORIA_MdS;
		...
		lTempRic.setCodTipoProvvedimentoSige("08");
		...
		return ICostantiRichiestaAtti.PG_DETTAGLIO_RICHIESTA_ROGATORIA_MdS;
	}
