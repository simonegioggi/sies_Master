...
public class ActLoadFsRicercaUnificazioni extends ActLoadRicercaFSigePuntuale
	implements ICostantiProvvedimentoSige
{
  public String processRequest() throws Exception
  {
    //super.processRequest(); //Processo la request della ActLoadRicercaFSPuntuale.
    setRequestAttribute("nextAction", "siap.sige.provvedimento.action.ActRicercaFSigeUnificazioni" );
