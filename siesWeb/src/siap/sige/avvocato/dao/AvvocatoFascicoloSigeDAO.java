...
/**
* <p>Title: AvvocatoFascicoloSigeDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella AvvocatoFascicoloSige</p>
* <p>Copyright: Copyright (c) 2008</p>
* <p>Company: Eutelia</p>
* @version 1.0
*/

public class AvvocatoFascicoloSigeDAO extends SIAPTableDAO
{
	public AvvocatoFascicoloSigeDAO (Connection con)
	{
    super(con);
    setTable("AVVOCATO_FASCICOLO_SIGE");

    //Settare la Sequence e i campi chiave
    setSequenceField("ID_AVVOCATO_FASCICOLO_SIGE", "AVV_FAS_SIGE_SEQ");

    setField("ID_AVVOCATO_FASCICOLO_SIGE", BIG_DECIMAL);
  ...
  public BigDecimal 		 getIdAvvocatoFascicoloSige() 	throws DAOException	{ return getBigDecimal("ID_AVVOCATO_FASCICOLO_SIGE"); }
  ...
  public void  	 setIdAvvocatoFascicoloSige(BigDecimal aValore )    { setBigDecimal("ID_AVVOCATO_FASCICOLO_SIge", aValore); }
  ...
  {
    return new AvvocatoFascicoloSigeModel(
                    getIdAvvocatoFascicoloSige() ,
								    getCodTipoAvvocato() ,
								    "",
    ...
    public void setDAOFromModel(AvvocatoFascicoloSigeModel aModel)
    throws DAOException
    {
      setIdAvvocatoFascicoloSige( aModel.getIdAvvocatoFascicoloSige() );
    ...
    public void setDAOFromModelForUpdate(AvvocatoFascicoloSigeModel aModel)
    throws DAOException
    {
      setIdAvvocatoFascicoloSige( aModel.getIdAvvocatoFascicoloSige() );
      setCodTipoAvvocato( aModel.getCodTipoAvvocato() );
  ...
  // 02/11/2006 MAC x Deassegnazione e Sostituzione Avvocati SIGE.
  public void setDAOFromModelForUpdateIdAvvocatoIdFascicolo(AvvocatoFascicoloSigeModel aModel) throws DAOException
  {
    setDataFineValidita(aModel.getDataFineValidita());
    setCodOperatoreAggiornamento(aModel.getCodOperatoreAggiornamento());
    setDataAggiornamento(aModel.getDataAggiornamento());

    selCondizioneUpdateAvvIdAvvFasIdFas(aModel.getAvvIdAvvocato(), aModel.getFasSigeIdFascicoloSige());
  }

  public void selCondizioneUpdateAvvIdAvvFasIdFas(BigDecimal IdAvv, BigDecimal IdFas)
  {
    setCondition(" AVV_ID_AVVOCATO = " + IdAvv +" AND FAS_SIGE_ID_FASCICOLO_SIGE = " + IdFas );
  }

  public void setCondizioneUpdateFascSige(BigDecimal key)
  {
      setCondition(" ID_AVVOCATO_FASCICOLO_SIGE = " + key );
  }


  public void setCondizione(AvvocatoFascicoloSigeModel aModel)
  {
