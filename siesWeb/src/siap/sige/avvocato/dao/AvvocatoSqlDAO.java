...
public class AvvocatoSqlDAO extends SIAPSqlDAO
{
  ...
  public void ricercaAvvocato( AvvocatoModel  aModel,AvvocatoFascicoloSigeModel aFModel)	 throws DAOException
  {
  ...
  public void ricercaAvvocatoSiep( AvvocatoModel  aModel, BigDecimal iKey)	 throws DAOException
  {
    ...
    lStatement += " SELECT " +
                  "AVV.ID_AVVOCATO ID_AVVOCATO, "+
                  "AVV.COGNOME COGNOME, "+
                  "AVV.NOME NOME, "+
                  "AVV.FORO FORO, "+
                  "AVV.INDIRIZZO INDIRIZZO, "+
                  "AVV.TELEFONO TELEFONO, "+
                  "AVV.FAX  FAX, "+
                  "AVV.E_MAIL E_MAIL, "+
                  "COD_FISCALE," +
                  "PROVINCIA," +
 ...
 */
  ...
  public void ricercaAvvocatoSige( AvvocatoFascicoloSigeModel  aModel)	 throws DAOException
  {
    ...
    lStatement += " SELECT " +
                  "AFS.ID_AVVOCATO_FASCICOLO_SIGE ID_AVVOCATO, "+
                  "AVV.COGNOME COGNOME, "+
                  "AVV.NOME NOME, "+
                  "AVV.FORO FORO, "+
                  "AVV.INDIRIZZO INDIRIZZO, "+
  ...
  public void ricercaAvvocatoAttualeFascicolo( AvvocatoModel  aModel,AvvocatoFascicoloSigeModel aFModel)	 throws DAOException
  {
    String lStatement = new String("");
...
;
  ...
  public GenericModel getModelSiep() throws DAOException
  {
	 ...
	 * 
	 * metodo introdotto per problematica inviata tramite email Maffucci/Alfieri del 02/01/2018 (errore prototipo PALERMO)
	 * 
	 * @param idFascSige
	 * @return
	 */
  ...
  private String setCondizione(AvvocatoModel aModel, boolean lInserito) {
		...
		if (aModel.getForo() != null && aModel.getForo() != "") {
			if (lInserito) 	lCondizioni += " AND ";
			lCondizioni += " FORO LIKE '"
					+ StringUtils.convertSqlString(aModel.getForo()
							.toUpperCase()) + "%'";
		}
