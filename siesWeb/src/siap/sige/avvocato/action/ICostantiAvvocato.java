...
public interface ICostantiAvvocato
{
	 ...
	 public static final String PG_LOAD_RICERCAAVVOCATO	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/LoadRicercaAvvocato.jsp";
	 public static final String PG_LOAD_RICERCAAVVOCATO_SIEP = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/LoadRicercaAvvocatoSiep.jsp";
	 public static final String PG_RICERCAAVVOCATO	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/RicercaAvvocato.jsp";
	 public static final String PG_RICERCAAVVOCATOSIEP	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/RicercaAvvocatoSiep.jsp";
	 public static final String PG_LOAD_INSERISCIAVVOCATO	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/LoadInserisciAvvocato.jsp";
     public static final String PG_DETTAGLIO_AVVOCATO_SENTENZA = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/DettaglioAvvocatoSentenza.jsp";
     public static final String PG_RICERCAAVVOCATOBREVE	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/RicercaAvvocatoBreve.jsp";
     public static final String PG_LOAD_RICERCAAVVOCATOBREVE	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/LoadRicercaAvvocatoBreve.jsp";
     ...
     public static final String PG_SOSTITUZIONE_AVVOCATO = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/SostituzioneDifensore.jsp";
     public static final String PG_ASSEGNA_INSERISCI_AVVOCATO	= IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/AssegnazioneElencoAvvocati.jsp";
     ...
     public static final String PG_DETTAGLIO_AVVOCATO_FASCICOLO_SIGE = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/DettaglioAvvocatoFascicoloSige.jsp";
     ...
     public static final String PG_FILTRAAVV = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/FiltraAvv.jsp";
     public static final String PG_FILTRAAVVSIEP = IWebConstants.ROOT_DIR + "files/siap/sige/avvocato/FiltraAvvSiep.jsp";
