...
/**
 * ICostantiImpugnazione - Classe di costanti di Impugnazione Sige
 *
 * @version 1.0
 */
public interface ICostantiImpugnazioneSige {
	...
	public static final String PG_LOAD_DETTAGLIOPROCEDIMENTOSIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/fascicolo/SintesiProcedimentoSige.jsp";
	public static final String PG_DETTAGLIOIMPUGNAZIONESIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/DettaglioImpugnazioneSige.jsp";
	public static final String PG_ELENCOPROVVEDIMENTISIGEXIMPUGNAZIONE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/ElencoProvvedimentiSigeXImpugnazione.jsp";
	public static final String PG_GRIGLIA_GESTIONE_IMPUGNAZIONI = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/GrigliaGestioneImpugnazioni.jsp";
	public static final String PG_BUTTONS_RICERCA_PROVVEDIMENTI_SIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/buttonsProvvedimentoSige.jsp";
	public static final String PG_BUTTONS_ELENCOIMPUGNAZIONISIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/buttonsElencoImpugnazioniSige.jsp";
	public static final String PG_LOAD_INSERISCIIMPUGNAZIONESIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadInserisciImpugnazioneSige.jsp";
	public static final String PG_LOAD_INSERISCI_ESITO_IMPUGNAZIONESIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadInserisciEsitoImpugnazioneSige.jsp";
	public static final String PG_LOAD_MODIFICAIMPUGNAZIONESIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadModificaImpugnazioneSige.jsp";
	public static final String PG_LOAD_ANNULLAMENTO_IMPUGNAZIONESIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadAnnullamentoImpugnazioneSige.jsp";
	public static final String PG_LISTA_ANNULLATE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/ListaAnnullate.jsp";
	public static final String PG_ELENCOIMPUGNAZIONISIGE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/ElencoImpugnazioniSige.jsp";
	public static final String PG_ELENCOIMPUGNAZIONISIGEPROVVEDIMENTO = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/ElencoImpugnazioniSigeProvvedimento.jsp";
	public static final String PG_LOAD_TRASMISSIONE_IMPUGNAZIONE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadTrasmissioneImpugnazioneSige.jsp";
	public static final String PG_LOAD_RICORSO_CONVERTITO = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/LoadModificaRicorsoConvertito.jsp";
	public static final String PG_LOAD_DESTINATARI = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/Destinatari.jsp";
	public static final String PG_LOAD_DESTINATARI_OPPOSIZIONE = IWebConstants.ROOT_DIR
			+ "files/siap/sige/impugnazione/DestinatariOpposizione.jsp";
	...
	public static final String COD_ESITO_DICHIARA_INAMMISSIBILE_IL_RICORSO = "04";
	...
	public static final String COD_ESITO_DICHIARA_INCOMPETENZA = "09";
	...
	public static final String COD_ESITO_DICHIARA_INAMMISSIBILE = "13";
	...
	public static final short SHORT_COD_ESITO_DICHIARA_INAMMISSIBILE_IL_RICORSO = 4;
	...
	public static final short SHORT_COD_ESITO_DICHIARA_INCOMPETENZA = 9;
	...
	public static final short SHORT_COD_ESITO_DICHIARA_INAMMISSIBILE = 13;
