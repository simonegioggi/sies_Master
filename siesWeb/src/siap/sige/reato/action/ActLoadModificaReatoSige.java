...
/**
 * ActLoadModificaReato - Classe Action per la load modifica di Reato
 *
 * @version 1.0
 */
public class ActLoadModificaReatoSige extends ActionSige implements ICostantiReato {
	...
	public String processRequest() throws Exception {
		...
		lOption = new Option(DecodificheManager.getInstance().getPeriodoConsumazione(),
				lMod.getCodPeriodoConsumazione());
		...
		return ICostantiReato.PG_LOAD_MODIFICAREATO;
	}
