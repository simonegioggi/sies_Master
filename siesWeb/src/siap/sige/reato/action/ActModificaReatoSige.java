...
/**
 * <p>Title: ActModificaReatoSige</p>
* <p>Description: Classe Action per di Reato.
*  </p>
*  L'action specializza   siap.siep.reato.action.ActModificaReato  
*  poichè la form di input utilizzata è la stessa; 
*  questa action utilizza la funzione letturaDati(...) ereditata che valorizza i reati da inserire.
