...
public interface ICostantiScadenzarioSige
{
  public static final String CAMPO_ID_SCADENZARIO_SIGE = "IdScadenzarioSige";
  ...
  public static final String PG_LOAD_RICERCASCADENZARIOSIGE	= IWebConstants.ROOT_DIR + "files/siap/sige/scadenzario/LoadRicercaScadenzarioSige.jsp";
  public static final String PG_LOAD_DETTAGLIOSCADENZARIOSIGE	= IWebConstants.ROOT_DIR + "files/siap/sige/scadenzario/DettaglioScadenzarioSige.jsp";
  public static final String PG_RICERCASCADENZARIOSIGE	= IWebConstants.ROOT_DIR + "files/siap/sige/scadenzario/RicercaScadenzarioSige.jsp";
