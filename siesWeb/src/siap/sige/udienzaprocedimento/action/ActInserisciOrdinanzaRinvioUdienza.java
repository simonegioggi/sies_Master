...
/**
 * ActInserisciOrdinanzaRinvioUdienza - Classe Action per l'inserimento dell'Ordinanza Rinvio Udienza
 *
 * @version 1.0
 */
public class ActInserisciOrdinanzaRinvioUdienza extends ActInserisciRinvioUdienza
	...
	public String processRequest() throws Exception {
		...
		mActionRet = "siap.sige.udienzaprocedimento.action.ActLoadDettaglioOrdinanzaRinvioUdienza";

		BigDecimal idAula = null;
		try {
			idAula = super.getRequestBigDecimalParameter(ICostantiAula.CAMPO_ID_AULA);
		} catch (Exception e) {
			siesLogger.info(e.getMessage() + ": ERRORE GESTITO!");
		}
		if (idAula != null) {
