 ...
 * </p>
 * <p>
 * Description: Classe Controller per RichiestaAtti
 * </p>
 * <p>
...
public class RichiestaAttiSigeController extends GenericController implements IRichiestaAttiSige {
	...
	public DocumentoAllegatoModel ExInserisciSollecito(EventoNotificaModel aEveNot,
			...
			FascicoloSigeEstesoModel lFasEsteso) throws F3BException {
	 ...
	 * @throws F3BException
	 */
	public ByteArrayOutputStream ExStampaRichiestaAtti(EventoModel lEvento, BigDecimal aIdFascicolo,
		...
		TreeModel lTree = lCtrlSta.ExPrelevaDatiStampa(lEvento.getIdEvento(), aIdFascicolo, aTipoDati,
				aTipoStampa, lTipoUfficio);
	 ...
	 * @throws F3BException
	 */
	public ProvvedimentoSigeModel ExInserisciRichiestaParereProv(EventoNotificaModel aEvento,
			MotivazioneProvvedimentoSigeModel[] aMotivazioniDecreto,
			ProvvedimentoSigeModel lProvvedimentoSigeModel) throws F3BException {
	...
	public void ExInserisciMotivazioniDecreto(MotivazioneProvvedimentoSigeModel[] aMotivazioniDecreto,
	...
	/*
	 * @see
	 * siap.sige.richiestaatti.controller.IRichiestaAttiSige#ExStampaSollecitiSige(siap.sico.evento.model.
	 * EventoModel, java.math.BigDecimal, java.lang.String, siap.sico.utente.model.UtenteModel)
	 */
	public ByteArrayOutputStream ExStampaSollecitiSige(EventoModel lEvento, BigDecimal aIdFascicolo,
			String lTipoUfficio, UtenteModel aUtenteModel) throws F3BException {
	...
	@Override
	public DocumentoAllegatoModel ExModificaSollecito(DocumentoAllegatoModel aDocAllegato)
			throws F3BException {
