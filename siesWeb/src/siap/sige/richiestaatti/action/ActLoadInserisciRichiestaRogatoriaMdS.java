...
/**
 * <p>
 * Title: ActLoadInserisciRischiestaRogatoriaMdS
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di ActLoadInserisciRichiestaRogatoriaMdS
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadInserisciRichiestaRogatoriaMdS extends ActRicercaFSigePuntuale
	...
	public String processRequest() throws Exception {
		...
		if (lProvvedimento != null) {
			if (lProvvedimento.getProvvedimento() != null
				...
				throw new SIGEException(SIGEException.USER_MESSAGE,
						"Impossibile emettere Rogatoria MdS! è stato già emesso un Provvedimento di tipo definitorio!");
			}
		}
		...
		if (lProvvedimento != null && lProvvedimento.getProvvedimento() != null
			...
			lPage.setAction("siap.sige.provvedimento.action.ActDettaglioRichiestaRogatoriaMdS");
			...
			// "GIP", "GIPM", "GP", "GUP", "GUPM", "GUPMI", "PT", "TRIBSD", "CAPSM", "TMI", "DIB", "DIBM"} );
			// //solo le Autorità Emittenti.

			// String[] lFiltro = {"-", "UDS"};

			// Collection lElencoTipiAutorita = DecodificheManager.getInstance().getTipoUfficioS();
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActLoadInserisciRichiestaRogatoriaMdS: -> page: " + lRetPage);
