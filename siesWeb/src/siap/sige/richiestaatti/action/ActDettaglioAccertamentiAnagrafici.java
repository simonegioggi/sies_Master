...
/**
 * <p>
 * Title: ActDettaglioAccertamentiAnagrafici
 * </p>
 * <p>
 * Description: Classe Action per la load dettaglio Richiesta Anagrafica Cittadini
 * </p>
 * <p>
...
public class ActDettaglioAccertamentiAnagrafici extends ActSIESDettaglioProvvedimento {
	...
	public String processRequest() throws Exception {
		...
		if (lEveMod.getEvento().getTemIdTemplate() == null) {
			...
			// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
			// LogF3B.getLogger()
			siesLogger.debug(">>> Il Template è : " + lOptionTemp.toString());

			setRequestAttribute(ICostantiTemplate.CAMPO_COMBO_TEMPLATE, lOptionTemp.toString());
		}

		return ICostantiRichiestaAtti.PG_DETTAGLIO_ACCERTAMENTIANAGRAFICI;
	}
