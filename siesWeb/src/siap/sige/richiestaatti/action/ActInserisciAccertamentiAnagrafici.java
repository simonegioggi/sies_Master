 ...
 * @version 1.0
 */
public class ActInserisciAccertamentiAnagrafici extends ActionSiap implements ICostantiIstruttoria {
	...
	public String processRequest() throws Exception {
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.sige.richiestaatti.action.ActDettaglioAccertamentiAnagrafici&"
