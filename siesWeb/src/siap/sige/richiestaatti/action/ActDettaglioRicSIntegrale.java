...
public class ActDettaglioRicSIntegrale extends ActSIESDettaglioProvvedimento {
	...
	public String processRequest() throws Exception {
		...
		// setRequestAttribute("IdEvento", lProvEvento.getEvento().getIdEvento() );
		...
		// lEveMod = lCtrl.ExRicercaEventoNotificaByKey(lProvEvento.getEvento().getIdEvento());
		...
		return ICostantiRichiestaAtti.PG_DETTAGLIO_ESTRATTO_SENTENZA_INTEGRALE;
	}
