 ...
 * @version 1.0
 */
public class ActLoadInserisciRichiestaFascicoloPenale extends ActionSiap implements ICostantiRichiestaAtti {
	...
	public String processRequest() throws Exception {
		...
		setRequestAttribute("procura", "" + lOption);

		// Riempimento seconda ComboBoX
		// 25/06/2010 Sostituzione Elenco Autorità Emittenti
		// Option lOption1 = new Option(DecodificheManager.getInstance().getTipoUfficioS());
		Option lOption1 = new Option(DecodificheManager.getInstance().getTipoAutoritaEmittente());
		setRequestAttribute("autorita", "" + lOption1);

		return PG_LOAD_RICHIESTA_FASCICOLOPENALE;
	}
