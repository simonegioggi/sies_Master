...
/**
 * <p>Title: ActInserisciRicSIntegrale</p>
 * <p>Description: ActInserisciRicSIntegrale</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
  * @version 1.0
 */
public class ActInserisciRicSIntegrale extends ActionSiap implements ICostantiIstruttoria
{
	...
	public String processRequest() throws Exception
 {
		...
		String lTestoNote = getRequestStringParameter(ICostantiIstruttoria.ESTREMI_SENTENZA) + " "
				+ getRequestStringParameter(ICostantiIstruttoria.NUMERO_COPIE) + " " + lTipoDoc;

		// super.getRequest().setAttribute("TIPO_DOC", lTipoDoc);
		// super.getRequest().setAttribute("NUMERO_COPIE",
		// getRequestBigDecimalParameter(ICostantiIstruttoria.NUMERO_COPIE));
		// super.getRequest().setAttribute("ESTREMI_SENTENZA",
		// getRequestBigDecimalParameter(ICostantiIstruttoria.ESTREMI_SENTENZA));
		...
		// lProvvedimentoSigeModel.setIdEventoGenerato(lRetModel.getEvento().getEveIdEvento());
		// ProvvedimentoSigeEventoModel lProvEveModel = new ProvvedimentoSigeEventoModel();
		// lProvEveModel.setProvvedimento(lProvvedimentoSigeModel);

		// Chiamata al Controller per gli inserimenti.
		// lProvEveModel = lProvCtrl.ExInserisciProvvedimento(lProvvedimentoSigeModel.getFasIdFascicoloSige(),
		// lProvEveModel, lTenori);
		// ProvvedimentoSigeEventoModel lProvEveModel = new ProvvedimentoSigeEventoModel();
		ProvvedimentoSigeModel lRetModel = lProvCtrl.ExInserisciEventoNotificaProv(lEve,
				lProvvedimentoSigeModel);

		// String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD +
		// "=siap.sige.richiestaatti.action.ActDettaglioRicSIntegrale&" +
		// ICostantiEvento.CAMPO_ID_EVENTO + "=" +
		// lRetModel.getIdEventoGenerato() + "&modalita=I";
