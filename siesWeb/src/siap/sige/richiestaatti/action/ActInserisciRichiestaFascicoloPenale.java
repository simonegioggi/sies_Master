...
/**
 * <p>
 * Title: ActInserisciRichiestaFascicoloPenale
 * </p>
 * <p>
 * Description: ActInserisciRichiestaFascicoloPenale
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActInserisciRichiestaFascicoloPenale extends ActionSiap implements ICostantiIstruttoria {
	...
	public String processRequest() throws Exception {
		...
		lEve.getEvento().setCodMotivo("0702"); // 0702
		...
		for (int x = 0; x < lSize; x++) {
			if (!lDestinatari[x].equals("-") && !lSedi[x].equals("")) {
				lCodice = getCodUfficioByCodTipoUfficioDescrComune(lDestinatari[x], lSedi[x]);
			}
		}
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.sige.richiestaatti.action.ActDettaglioRichiestaFascicoloPenale&"
