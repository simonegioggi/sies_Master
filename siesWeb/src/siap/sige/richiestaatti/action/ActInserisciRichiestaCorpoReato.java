 ...
 * @version 1.0
 */
public class ActInserisciRichiestaCorpoReato extends ActionSiap implements ICostantiIstruttoria {
	...
	public String processRequest() throws Exception {
		...
		lEve.getEvento().setCodMotivo("0706"); // 0706
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.sige.richiestaatti.action.ActDettaglioRichiestaCorpoReato&"
