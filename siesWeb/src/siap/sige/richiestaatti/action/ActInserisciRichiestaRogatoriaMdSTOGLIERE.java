...
/**
 * <p>
 * Title: ActInserisciRichiestaPM
 * </p>
 * <p>
 * Description: ActInserisciRichiestaPM
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActInserisciRichiestaRogatoriaMdSTOGLIERE extends ActionSiap implements ICostantiIstruttoria {
	...
	public String processRequest() throws Exception {
		...
		lEve.getEvento().setCodMotivo("0707"); // 0707
		...
		lEve.getEvento().setDataRichiesta(lDataRichiesta);
		// ANGELA 03.2010
		lEve.getEvento()
		...
		// String lCodice =
		// getCodUfficioByCodTipoUfficioDescrComune(getRequestStringParameter(ICostantiIstruttoria.AUTORITA_DESTINATARIO),getRequestStringParameter(ICostantiIstruttoria.SEDE_AUTORITA_DESTINATARIO)
		// );
		...
		String lTestoNote = getRequestStringParameter(ICostantiIstruttoria.TIPO_DOCUMENTO);
		...
		String lPage = IWebConstants.PG_MAIN + "?" + IWebConstants.ACTION_FIELD
				+ "=siap.sige.provvedimento.action.ActDettaglioRichiestaRogatoriaMdS&"
