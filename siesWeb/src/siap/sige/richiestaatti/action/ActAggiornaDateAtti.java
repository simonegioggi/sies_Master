...
public class ActAggiornaDateAtti extends ActRicercaStatoAtti
{
  public String processRequest() throws Exception
  {
    ...
    RedirectTo lRetPage = new RedirectTo();
    lRetPage.setPage(IWebConstants.PG_MAIN);
    lRetPage.setAction("siap.sige.richiestaatti.action.ActRicercaStatoAtti");
    lRetPage.setParameter("noQuery", "true");
    ...
    lPage = lRetPage.toString();
    setRequestAttribute("modalita", "M");
    setFunctionsAvailableToRequest("siap.sige.richiestaatti.action.ActRicercaStatoAtti");
    return lPage;
  }
}