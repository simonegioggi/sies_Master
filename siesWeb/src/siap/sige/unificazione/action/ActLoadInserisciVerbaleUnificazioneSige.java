...
/**
* <p>Title: ActLoadInserisciVerbaleUnificazioneSige</p>
* <p>Description: Classe Action per la loadInserisciVerbaleUnificazioneSige</p>
* <p>Copyright: Copyright (c) 2004</p>
* <p>Company: Bull S.p.A.</p>
* @version 1.0
*/

public class ActLoadInserisciVerbaleUnificazioneSige extends ActionSiap implements ICostantiVerbaleUnificazioneSige
{
  public String processRequest() throws Exception
  {
	    ...
	    //FascicoloSigeEstesoModel lFasDaUnificare = lCtrl.ExVerificaFascicoloSigePerUnificazione(getRequestStringParameter( CAMPO_ANNO_DA_UNIF), getRequestStringParameter( CAMPO_NUMERO_DA_UNIF), 
	    //																						lUtenteMod.getUfficioUtente().getCodUfficio(), ICostantiDecretoUnificazioneSige.RUOLO_FASCICOLO_DA_UNIFICARE );
	    //FascicoloSigeEstesoModel lFasUnificante  = lCtrl.ExVerificaFascicoloSigePerUnificazione(getRequestStringParameter( CAMPO_ANNO_UNIFICANTE), getRequestStringParameter( CAMPO_NUMERO_UNIFICANTE), 
	    //																						lUtenteMod.getUfficioUtente().getCodUfficio(), ICostantiDecretoUnificazioneSige.RUOLO_FASCICOLO_UNIFICANTE );
	    ...
	    //return PG_LOAD_INSERISCIVERBALEUNIFICAZIONESIGE; //restituisce la jsp di VIEW
	    return PG_LOAD_INSERISCIVERBALEUNIFICAZIONESIGE_FASCIOLO_UNIFICANTE;
  }
}