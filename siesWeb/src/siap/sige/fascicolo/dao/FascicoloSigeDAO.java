...
/**
 * Title: FascicoloSigeDAO
 * Description: Classe DAO che rappresenta la tabella FascicoloSige
 *
 * @version 5.0
 */
...
public class FascicoloSigeDAO extends TableDAO {
	...
	// METODI GET()
	//
	public BigDecimal getIdFascicoloSige() throws DAOException {
		return getBigDecimal("ID_FASCICOLO_SIGE");
	}
	...
	public BigDecimal getSenIdSentenzaCumulo() throws DAOException {
		return getBigDecimal("SEN_ID_SENTENZA_CUMULO");
	}

	public BigDecimal getIdSezione() throws DAOException {
	...
	public String getCodTipoGiudizio() throws DAOException {
		return getString("COD_TIPO_GIUDIZIO");
	}
	...
	public BigDecimal getRicIdRichiestaSige() throws DAOException {
		return getBigDecimal("RIC_ID_RICHIESTA_SIGE");
	}
	...
	public String getCodPosizioneGiuridica() throws DAOException {
	...
	public String getCodTipoDefinizione() throws DAOException {
		return getString("COD_TIPO_DEFINIZIONE");
	}
	...
	public BigDecimal getFasSigIdFascicoloSige() throws DAOException {
		return getBigDecimal("FAS_SIG_ID_FASCICOLO_SIGE");
	} // 26/07/2010
	...
	public BigDecimal getIdFascicoloSigeOrigine() throws DAOException {
		return getBigDecimal("ID_FASCICOLO_SIGE_ORIGINE");
	}

	public BigDecimal getIdEventoProvvCumulo() throws DAOException {
		return getBigDecimal("ID_EVENTO_PROVV_CUMULO");
	}
	...
	public void setIdFascicoloSige(BigDecimal aValore) {
		setBigDecimal("ID_FASCICOLO_SIGE", aValore);
	}
	...
	public void setSenIdSentenzaCumulo(BigDecimal aValore) {
		setBigDecimal("SEN_ID_SENTENZA_CUMULO", aValore);
	}
	...
	public void setCodTipoGiudizio(String aValore) {
		setString("COD_TIPO_GIUDIZIO", aValore);
	}
	...
	public void setRicIdRichiestaSige(BigDecimal aValore) {
		setBigDecimal("RIC_ID_RICHIESTA_SIGE", aValore);
	}
	...
	public void setCodTipoDefinizione(String aValore) {
		setString("COD_TIPO_DEFINIZIONE", aValore);
	}
	...
	public void setFasSigIdFascicoloSige(BigDecimal aValore) {
		setBigDecimal("FAS_SIG_ID_FASCICOLO_SIGE", aValore);
	} // 26/07/2010
	...
	public void setIdFascicoloSigeOrigine(BigDecimal aValore) {
		setBigDecimal("ID_FASCICOLO_SIGE_ORIGINE", aValore);
	}

	public void setIdEventoProvvCumulo(BigDecimal aValore) {
		setBigDecimal("ID_EVENTO_PROVV_CUMULO", aValore);
	}

	public GenericModel getModel() throws DAOException {

		return new FascicoloSigeModel(getIdFascicoloSige(), getSogIdSoggetto(), getChiaveAnno(), null, null,
				getChiaveUfficio(), "", getChiaveProgr(), null, null, getSenIdSentenzaCumulo(),
				getIdSezione(), "", getCodStatoFascicolo(), "", getCodTipoGiudizio(), "", getDataIscrizione(),
				null, null, getDataDefinizione(), getRicIdRichiestaSige(), getCodOperatoreInserimento(),
				getCodUfficioInserimento(), "", getDataInserimento(), getCodOperatoreAggiornamento(),
				getCodUfficioAggiornamento(), "", getDataAggiornamento(), getNote(),
				getCodPosizioneGiuridica(), "", getDataFinePena(), getCodTipoDefinizione(), "",
				getDescrDefinizione(), "", "", getFasSigIdFascicoloSige(), getNumeroFascicoliUnificati(),
				getChiaveProgrOrig(), getIdFascicoloSigeOrigine(), getIdEventoProvvCumulo(), "", "");
	}
	...
	public void setCondizioneByIdSentenza(BigDecimal aIdSentenza) {
		...
		setCondition(
				" ID_FASCICOLO_SIGE IN (SELECT DISTINCT FAS_ID_FASCICOLO_SIGE FROM FAS_SIGE_SENTENZA WHERE SEN_ID_SENTENZA =  "
						+ aIdSentenza + " ) ");
	}
	...
	public void setCondizioneByIdFasSiepCodUfficio(BigDecimal aIdFasSiep, String aCodUfficio) {
		...
		setCondition(" FAS_SIE_ID_FASCICOLO_SIEP  =  " + aIdFasSiep
	...
	public void setCondizioneUpdateStatoFascicolo(BigDecimal key, String aCodStato) {
		...
		// in caso di piu' stati fascicolo
		// setCondition(" ID_FASCICOLO_SIGE = " + key + " AND COD_STATO_FASCICOLO in (" + aCodStato + ")");
	}

	public void setDAOFromModelForAssegnaTitoloEsecutivo(FascicoloSigeEstesoModel aFascicoloSigeEsteso)
			throws DAOException {
	...
	public void setDAOFromModelForAggiornaStatoDataDefinizioneFascicoloOrigine(FascicoloSigeModel aModel)
			throws DAOException {
