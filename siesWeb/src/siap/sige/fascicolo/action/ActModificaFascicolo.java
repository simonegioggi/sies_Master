 ...
 * <p>Description: Classe Azione di inserimento del Fascicolo SIGE
 * </p>
...
public class ActModificaFascicolo extends ActInserisciFascicolo implements ICostantiFascicoloSige
{
  ...
  public String processRequest() throws Exception
  {
	   ...
	   // Controllo Dati
	   if (lFascicoloEsteso.getFascicoloSige() == null || lFascicoloEsteso.getFascicoloSige().getIdFascicoloSige() == null)
		      throw new F3BException(F3BException.USER_MESSAGE, "ID Procedimento SIGE assente !!");
	   if (lFascicoloEsteso.getFascicoloSige() == null || lFascicoloEsteso.getFascicoloSige().getRicIdRichiestaSige() == null)
	  ...
	  lRedirigi.setParameter(CAMPO_ID_FASCICOLO_SIGE,(lIdFascicoloSige != null ?  lIdFascicoloSige.toString() : ""));
