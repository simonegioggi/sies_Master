...
/**
 * <p>
 * Title: ActLoadInserisciFascicoloSige
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di FascicoloSige
 * </p>
 * <p>
...
public class ActLoadInserisciFascicoloManuale extends ActionSige implements ICostantiFascicoloSige {
	...
	protected void preparaRequest(BigDecimal aIdFasSiep) throws Exception {
		...
		if (lDettaglio != null && lDettaglio.getPenaResidua() != null
				&& lDettaglio.getPenaResidua().getDataFine() != null
				&& lDettaglio.getPenaResidua().getFlagValidato() != null
		...
		lMagistratiOpt = new Option(
				lMagCtrl.ExElencoCbxMagistratiByCodUfficio(getCodUfficioUtenteConnesso()));
