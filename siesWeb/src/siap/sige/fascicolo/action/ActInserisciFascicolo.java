...
public class ActInserisciFascicolo extends ActionSige implements ICostantiFascicoloSige {
	...
	public String processRequest() throws Exception {
		...
		mFascicolo = lCtrl.ExInserisciFascicoloSige(mFascicolo, mRichiesta, mMagAssegnatario, lDetenzione);
	...
	protected FascicoloSigeModel leggiDatiFascicolo() throws Exception {
		...
		if (!isRequestParameterNullObj(CAMPO_IS_FASCICOLO_COLLEGATO_RICORSO)
			...
			lFascicolo.setCodStatoFascicolo("02");
			// La Data Definizione deve essere impostata sul Fascicolo di Origine
			// lFascicolo.setDataDefinizione(getRequestDateParameter(CAMPO_ANNO_DECISIONE_RICORSO_COLLEGATO,
			// CAMPO_MESE_DECISIONE_RICORSO_COLLEGATO, CAMPO_GIORNO_DECISIONE_RICORSO_COLLEGATO));
			lFascicolo.setDataDefinizioneOrigine(getRequestDateParameter(
