...
/**
* <p>Title: ActCancellaResidenzaFascicoloSige</p>
* <p>Description: Classe Action per la cancellazione di Residenza Fascicolo SIGE</p>
* <p>Copyright: Copyright (c) 2008</p>
* <p>Company: </p>
* @version 1.0
*/

public class ActCancellaResidenzaFascicoloSige extends ActionSiap implements ICostantiFascicoloSige
{
  public String processRequest() throws Exception
  {
    ...
    lCtrl.ExCancellaResidenzaProcedimentoSige(getRequestBigDecimalParameter(ICostantiResidenza.CAMPO_ID_RESIDENZA),lIdFascicoloSige);
