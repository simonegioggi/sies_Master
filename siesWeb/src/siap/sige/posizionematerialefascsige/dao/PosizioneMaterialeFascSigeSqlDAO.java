...
import f3b.model.GenericModel;
  ...
  /**
   * <p>Title: PosizioneMaterialeFascSigeSqlDAO</p>
   * <p>Description: Classe SqlDAO che rappresenta la tabella PosizioneMaterialeFascSige</p>
   * <p>Copyright: Copyright (c) 2002</p>
   * <p>Company: Engineering</p>
   * @version 1.0
  */
  public class PosizioneMaterialeFascSigeSqlDAO extends SqlDAO
  {
    public PosizioneMaterialeFascSigeSqlDAO(Connection con)
    {
      super(con);
    }
    ...
    DAOException
    {
      ...
      lSql += "  WHERE FAS_SIGE_ID_FASCICOLO_SIGE = " + aIdFascicolo;
    ...
    protected String getSqlQuery()
    {
      ...
      lStatement += " FROM POSIZIONE_MATERIALE_FASC_SIGE PF";
  ...
  {
    PosizioneMaterialeFascModel aModel = new PosizioneMaterialeFascModel(PosizioneMaterialeFascModel.POSIZIONE_MATERIALE_FASCICOLO_SIGE);
    ...
    aModel.setFasSieIdFascicoloSiep (getBigDecimal("FAS_SIGE_ID_FASCICOLO_SIGE"));
  ...
  public String setCondizione(PosizioneMaterialeFascModel aModel)
  {
    ...
    if (aModel.getFasSieIdFascicoloSiep() != null )
    {
      ...
      lInserito = true;
      lCondizioni += " FAS_SIGE_ID_FASCICOLO_SIGE = " + aModel.getFasSieIdFascicoloSiep();
    }
