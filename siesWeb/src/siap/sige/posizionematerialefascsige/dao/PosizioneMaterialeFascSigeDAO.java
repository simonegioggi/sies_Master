package siap.sige.posizionematerialefascsige.dao;
...
import f3b.model.GenericModel;
  ...
  /**
   * <p>Title: PosizioneMaterialeFascSigeDAO</p>
   * <p>Description: Classe DAO che rappresenta la tabella PosizioneMaterialeFascSige</p>
   * <p>Copyright: Copyright (c) 2002</p>
   * <p>Company: Engineering</p>
   * @version 1.0
  */
  public class PosizioneMaterialeFascSigeDAO extends TableDAO
  {
    public PosizioneMaterialeFascSigeDAO(Connection con)
    {
      super(con);
      setTable("POSIZIONE_MATERIALE_FASC_SIGE");
    ...
    public BigDecimal getFasSigeIdFascicoloSige() throws DAOException
    {
      return getBigDecimal("FAS_SIGE_ID_FASCICOLO_SIGE");
    }
    ...
    {
      setBigDecimal("FAS_SIGE_ID_FASCICOLO_SIGE", aValore);
    }
    ...
    public void setDAOFromModel(PosizioneMaterialeFascModel aModel) throws DAOException
    {
      ...
      setFasSigeIdFascicoloSige(aModel.getFasSieIdFascicoloSiep());
    ...
    /**
     * La funzione prepara la condizione per individuare univocamente l'occorenza attiva per uno specifico Fascicolo SIGE.
     * @param key
     */
    public void setCondizioneUpdate(BigDecimal key)
    {
        setCondition(" DATA_FINE IS NULL AND FAS_SIGE_ID_FASCICOLO_SIGE = " + key );
    }


    /**
     * La funzione prepara la condizione per individuare univocamente l'ultima occorrenza chiusa nella tabella FAS_SIGE_ID_FASCICOLO_SIGE da riattivare.
     ...
     * @param key: ID Fascicolo SIGE.
     */
    public void setCondizioneRiattivazione(BigDecimal key)
    {
        setCondition(" FAS_SIGE_ID_FASCICOLO_SIGE = " + key + " AND DATA_AGGIORNAMENTO = (SELECT MAX(DATA_AGGIORNAMENTO) FROM POSIZIONE_MATERIALE_FASC_SIGE WHERE FAS_SIGE_ID_FASCICOLO_SIGE = " + key + ")");
    }
