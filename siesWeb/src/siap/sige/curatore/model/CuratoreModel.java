package siap.sige.curatore.model;

/**
* <p>Title: CuratoreModel</p>
* <p>Description: Classe Model che rappresenta il Curatore</p>
...
public class CuratoreModel extends GenericModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4582692118215703413L;

	private BigDecimal mIdCuratore;
	...
	public CuratoreModel() {
		this.mIdCuratore = null;
		this.mCognome = "";
		this.mNome = "";
		this.mIndirizzo = "";
		this.mTelefono = "";
	...
	public CuratoreModel(CuratoreModel aModel) {
		this.mIdCuratore = aModel.mIdCuratore;
		...
		this.mDescrFlagStato = aModel.mDescrFlagStato;
	...
	// COSTRUTTORE MODEL
	public CuratoreModel(BigDecimal aIdCuratore, String aCognome, String aNome, String aIndirizzo,
			String aTelefono, String aCodUfficioAppartenenza, String aDescrUfficioAppartenenza, String aEmail,
			String aFax, String aCellulare, Date aDataInizioValidita, Date aDataFineValidita,
			String aFlagStato, String aDescrFlagStato, String aCodOperatoreInserimento, Date aDataInserimento,
			...
			String aCodiceFiscale) {
		this.mIdCuratore = aIdCuratore;
	...
	// METODI GET()
	//
	public BigDecimal getIdCuratore() {
		return mIdCuratore;
	}
	...
	// METODI SET()
	//
	public void setIdCuratore(BigDecimal aValore) {
		mIdCuratore = aValore;
	}
