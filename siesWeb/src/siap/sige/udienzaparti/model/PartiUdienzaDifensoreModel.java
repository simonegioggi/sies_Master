...
/**
* <p>Title: PartiUdienzaDifensoreModel</p>
* <p>Description: Classe Model che rappresenta l'associazione tra le parti di una udienza e il difensore</p>
* <p>Copyright: Copyright (c) 2008</p>
* <p>Company: Engineering S.p.A.</p>
* @version 1.0
*/
public class PartiUdienzaDifensoreModel extends GenericModel
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -4524842884998605321L;
	private BigDecimal  mIdAvvocatoParteUdienza;
	...
	// parametro utilizzato per gestire il flag SNT
	// (Sistema Notifiche Telematiche)
	private boolean mFlagSNT = false;
	
	//COSTRUTTORE DI DEFAULT
	public PartiUdienzaDifensoreModel ()
	{
		this.mIdAvvocatoParteUdienza = null;
	...
	public PartiUdienzaDifensoreModel ( PartiUdienzaDifensoreModel aModel )
	{
		this.mIdAvvocatoParteUdienza = aModel.mIdAvvocatoParteUdienza;
	...
	//COSTRUTTORE MODEL
  	public PartiUdienzaDifensoreModel ( 
						  			BigDecimal  aIdAvvocatoParteUdienza,
						  			String	  	aCodTipoAvvocato,
						  			Date 		aDataInizioValidita,
						  			Date 		aDataFineValidita,
						  			String	  	aCodMotivoDesignazione,
						  			String	  	aCodTipoAutorita,
						  			String	  	aSedeTipoAutorita,
						  			String	  	aIndirizzoTipoAutorita,
						  			...
						  			BigDecimal  aAvvIdAvvocato,
						  			BigDecimal  aSoggIdSoggetto,
						  	        String 	    aIstDetIdIstitutoDetenzione,
						  	        String 		aNote,
						  	        String 		aCodTipoAutoritaDif,
						  	        String 		aSedeAutoritaDif,
						  	        String 		aDescrMotivoDesignazione,
						  	        String 		aDescrTipoAutorita,
						  	        String 		aDescrTipoAutoritaDif,
						  	        String 		aComuneTipoAutorita,
						  	        String 		aComuneTipoAutoritaDif )
  	{
		this.mIdAvvocatoParteUdienza = aIdAvvocatoParteUdienza;
  	...
  	// METODI GET()
  	//
  	public BigDecimal getIdAvvocatoParteUdienza() 	  	{ return mIdAvvocatoParteUdienza; }
  	public String     getCodTipoAvvocato() 			  	{ return mCodTipoAvvocato; }
  	public Date 	  getDataInizioValidita() 		  	{ return mDataInizioValidita; }
  	public Date 	  getDataFineValidita() 		  	{ return mDataFineValidita; }
  	public String 	  getCodMotivoDesignazione() 	  	{ return mCodMotivoDesignazione; }
  	public String 	  getCodTipoAutorita()  		  	{ return mCodTipoAutorita; }
  	public String 	  getSedeTipoAutorita() 		  	{ return mSedeTipoAutorita; }
  	public String 	  getIndirizzoTipoAutorita() 	  	{ return mIndirizzoTipoAutorita; }
	...
	public String 	  getCodUfficioAggiornamento()    	{ return mCodUfficioAggiornamento; }
  	public BigDecimal getAvvIdAvvocato() 	  		  	{ return mAvvIdAvvocato; }
  	public BigDecimal getSoggIdSoggetto() 	  		  	{ return mSoggIdSoggetto; }
    public String 	  getIstDetIdIstitutoDetenzione() 	{ return mIstDetIdIstitutoDetenzione; }
    public String 	  getNote() 			 		  	{ return mNote; }
    public String 	  getCodTipoAutoritaDif() 		  	{ return mCodTipoAutoritaDif; }
    public String 	  getSedeAutoritaDif() 			  	{ return mSedeAutoritaDif; }
    public String 	  getDescrMotivoDesignazione() 	  	{ return mDescrMotivoDesignazione; }
    public String 	  getDescrTipoAutorita() 		  	{ return mDescrTipoAutorita; }
    public String 	  getDescrTipoAutoritaDif() 	  	{ return mDescrTipoAutoritaDif; }
    public String 	  getComuneTipoAutorita() 		  	{ return mComuneTipoAutorita; }
    public String 	  getComuneTipoAutoritaDif() 	 	{ return mComuneTipoAutoritaDif; }
    public String 	  getNomeCognomeAvvocato () {return this.mAvvocato.getNome() + " " +this.mAvvocato.getCognome(); };
    public String 	  getForo () {return this.mAvvocato.getForo(); };
    
  	public AvvocatoModel getAvvocato()               	{ return mAvvocato; }
  	public NotificaModel getNotifica()               	{ return mNotifica; }
  	
  	public boolean isFlagSNT()                          { return mFlagSNT; }
  	
	//
	// METODI SET()
	//
  	public void   setIdAvvocatoParteUdienza(BigDecimal aValore) 	{ mIdAvvocatoParteUdienza = aValore; }
  	public void   setCodTipoAvvocato(String aValore) 		    	{ mCodTipoAvvocato = aValore; }
  	public void   setDataInizioValidita(Date aValore)		   		{ mDataInizioValidita = aValore; }
  	public void   setDataFineValidita(Date aValore)		   	    	{ mDataFineValidita = aValore; }
  	public void   setCodMotivoDesignazione(String aValore)  		{ mCodMotivoDesignazione = aValore; }
  	public void   setCodTipoAutorita(String aValore)        		{ mCodTipoAutorita = aValore; }
  	public void   setSedeTipoAutorita(String aValore)       		{ mSedeTipoAutorita = aValore; }
  	public void   setIndirizzoTipoAutorita(String aValore)  		{ mIndirizzoTipoAutorita = aValore; }
	...
	public void   setAvvIdAvvocato(BigDecimal aValore) 				{ mAvvIdAvvocato = aValore; }
	public void   setSoggIdSoggetto(BigDecimal aValore) 			{ mSoggIdSoggetto = aValore; }
    public void   setIstDetIdIstitutoDetenzione(String aValore) 	{ mIstDetIdIstitutoDetenzione = aValore; }
    public void   setNote(String aValore) 			 				{ mNote = aValore; }
    public void   setCodTipoAutoritaDif(String aValore) 			{ mCodTipoAutoritaDif = aValore; }
    public void   setSedeAutoritaDif(String aValore) 				{ mSedeAutoritaDif = aValore; }
    public void   setDescrMotivoDesignazione(String aValore) 	 	{ mDescrMotivoDesignazione = aValore; }
    public void   setDescrTipoAutorita(String aValore) 			 	{ mDescrTipoAutorita = aValore; }
    public void   setDescrTipoAutoritaDif(String aValore) 		 	{ mDescrTipoAutoritaDif = aValore;}
    public void   setComuneTipoAutorita(String aValore) 			{ mComuneTipoAutorita = aValore; }
    public void   setComuneTipoAutoritaDif(String aValore) 		 	{ mComuneTipoAutoritaDif = aValore;}

	public void   setAvvocato(AvvocatoModel aValore)            	{ mAvvocato = aValore; }
	public void   setNotifica(NotificaModel aValore)            	{ mNotifica = aValore; }

	public void   setFlagSNT(boolean flagSNT)                       { mFlagSNT = flagSNT; }
