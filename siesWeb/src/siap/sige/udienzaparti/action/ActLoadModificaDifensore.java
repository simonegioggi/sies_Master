 ...
 * <p>Description: Classe Action per la load Modifica Difensore associato alla Parte</p>
...
public class ActLoadModificaDifensore extends ActionSige implements ICostantiPartiUdienza, ICostantiEvento {
	...
	public String processRequest() throws Exception {
		...
		Vector <PartiUdienzaDifensoreModel>lDifensori = lCtrl.ExRicercaDifensoreByIdSoggetto(new BigDecimal(lIdSoggetto));
		...
		if (notificaSoggetto != null && notificaSoggetto.getAutoritaEsterna() != null && notificaSoggetto.getAutoritaEsterna().getIdAutoritaEsterna() != null) {
			lOptionAut = new Option(DecodificheUtils.getDecodesWithoutCode(DecodificheManager.getInstance().getTipoAutorita(), "-"), notificaSoggetto.getAutoritaEsterna().getCodTipoAutorita().toString());
		} else {
