...
/**
 * <p>
 * Title: ActDettaglioNominaPeriti
 * </p>
 * <p>
 * Description: Classe Action per il Dettaglio Nomina Periti
 * </p>
 * <p>
...
public class ActDettaglioNominaPeriti extends ActionSige implements ICostantiProvvedimentoSige {

	// [FT] - 03/08/2016 - MAC_LOG - Dichiaro un'istanza di Logger per SIESLog
	private static Logger siesLogger = Logger.getLogger(LogF3B.SIES_LOG);

	protected ProvvedimentoSigeEventoModel lProvEvento = null;

	public String processRequest() throws Exception {

		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioNominaPeriti: inizio");
		...
		lProvEvento = lCtrlProv.ExRicercaProvvedimentoById(lIdProvvedimento);
		...
		lTempRic.setCodTipoProvvedimentoSige("13");
		lTempRic.setCodTipoProvvedimentoSige(ICostantiProvvedimentoSige.COD_NOMINA_PERITI);
		...
		return ICostantiProvvInterlocutoriSige.PG_DETTAGLIO_NOMINA_PERITI;
	}
