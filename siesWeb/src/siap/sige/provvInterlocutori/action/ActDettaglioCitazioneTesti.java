...
public class ActDettaglioCitazioneTesti extends ActLoadCitazioneTesti implements ICostantiProvvedimentoSige {
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioCitazioneTesti: inizio");
		...
		lTempRic.setCodTipoProvvedimentoSige(ICostantiProvvedimentoSige.COD_CITAZIONE_TESTI);
		...
		return ICostantiProvvInterlocutoriSige.PG_DETTAGLIO_CITAZIONE_TESTI;
	}
