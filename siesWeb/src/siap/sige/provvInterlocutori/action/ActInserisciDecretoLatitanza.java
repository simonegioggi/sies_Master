...
public class ActInserisciDecretoLatitanza extends ActionSige implements ICostantiProvvInterlocutoriSige,
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActInserisciDecretoLatitanza: inizio");
		...
		// 04/12/2010 Impostazione COD_ESITO_DICHIARA_LATITANZA.
		if (lTenori != null)
			for (int i = 0; i < lTenori.size(); i++) {
				// Valorizzazione dell'Esito Automatico previsto per tale Ordinanza
				((TenoreSigeModel) lTenori.get(i)).setCodEsitoSige(COD_ESITO_DICHIARA_LATITANZA);
			}
		...
		lProvModel.setCodTipoProvvedimentoSige("09");
		...
		lOption.setFilter(new String[] { "-", "CAP", "CAS", "CASAP", "CAPMI", "CAPMID", "CSS", "GIPMI",
				...
				"PM", "PGCAP" }); // solo le Autorità Emittenti.
