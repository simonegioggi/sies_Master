...
public class ActInserisciCitazioneTesti extends ActionSige implements ICostantiProvvInterlocutoriSige,
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActInserisciDecretoCitazioneTesti: inizio");
		...
		// 04/12/2010 Impostazione COD_ESITO_CITAZIONE_TESTI.
		if (lTenori != null)
			for (int i = 0; i < lTenori.size(); i++) {
				// Valorizzazione dell'Esito Automatico previsto per tale Ordinanza
				((TenoreSigeModel) lTenori.get(i)).setCodEsitoSige(COD_ESITO_CITAZIONE_TESTI);
			}
		...
		lProvModel.setCodTipoProvvedimentoSige("17");
