 ...
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di ActLoadInserisciCitazioneTesti
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadInserisciCitazioneTesti extends ActRicercaFSigePuntuale
	...
	public String processRequest() throws Exception {
		...
		if (lProvvedimento != null && lProvvedimento.getProvvedimento() != null
			...
			lPage.setAction("siap.sige.provvInterlocutori.action.ActDettaglioCitazioneTesti");
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActLoadInserisciCitazioneTesti: -> page: " + lRetPage);
