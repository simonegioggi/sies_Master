...
/**
 * <p>
 * Title: ActDettaglioDecretoIrreperibilita
 * </p>
 * <p>
 * Description: Classe Action per il Dettaglio Decreto Latitanza
 * </p>
 * <p>
...
public class ActDettaglioDecretoIrreperibilita extends ActionSige implements ICostantiProvvedimentoSige {
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActDettaglioDecretoIrreperibilita: inizio");
		...
		lTempRic.setCodTipoProvvedimentoSige(ICostantiProvvedimentoSige.COD_DECRETO_IRREPERIBILITA);
		...
		// 20190520 [SG]: rimosso parametro di passaggio
		...
		/*
		 * IEvento lCtrl = SICOLookupRemote.getEventoRemote(); lEveMod =
		 * lCtrl.ExRicercaEventoNotificaByKey(lProvEvento.getEventoNotifica().getEvento().getIdEvento());
		 * 
		 * INotifica lCtrlNot = SIEPLookupRemote.getNotificaRemote(); Vector lNots =
		 * lCtrlNot.ExRicercaNotificaByKeyEvento(lProvEvento.getEventoNotifica().getEvento().getIdEvento());
		...
		/*
		 * String lUfficio = lEveMod.getNotifiche()[0].getUffCodUfficio(); UfficioModel lUffMod = new
		 * UfficioModel();
		 * 
		 * if (lUfficio!=null) { IUfficio lUff = SICOLookupRemote.getUfficioRemote(); lUffMod =
		 * lUff.getUfficioByKey(lEveMod.getNotifiche()[0].getUffCodUfficio().toUpperCase()); }
		...
		return ICostantiProvvInterlocutoriSige.PG_DETTAGLIO_DECRETO_IRREPERIBILITA;
	}
