...
public class ActStampaDecretoIrreperibilita extends ActionSige implements ICostantiProvvedimentoSige
{

	/**
  * Azione di Stampa del Decreto di Latitanza
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    if(!isRequestParameterNullObj(ICostantiTemplate.CAMPO_ID_TEMPLATE))
    	...
    	lEveMod.setTemIdTemplate("SIGE_DE_006") ;
