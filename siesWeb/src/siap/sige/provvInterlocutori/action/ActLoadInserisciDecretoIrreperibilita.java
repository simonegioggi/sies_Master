...
/**
 * <p>
 * Title: ActLoadInserisciDecretoIrreperibilita
 * </p>
 * <p>
 * Description: Classe Action per la load inserisci di ActLoadInserisciDecretoIrreperibilita
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadInserisciDecretoIrreperibilita extends ActRicercaFSigePuntuale
	...
	public String processRequest() throws Exception {
		...
		// LogF3B.getLogger()
		siesLogger.debug("ActLoadInserisciDecretoIrreperibilita: inizio");

		// Attivazione punto di Ritorno
		setLinkRitorno();

		// Impostazione della pagina di view in caso di assenza provvedimento definitorio.
		String lRetPage = PG_LOAD_DECRETO_IRREPERIBILITA;
		...
		if (lProvvedimento != null) {
			if (lProvvedimento.getProvvedimento() != null
				...
				throw new SIGEException(SIGEException.USER_MESSAGE,
						"Impossibile emettere il Decreto di Irreperibilita! è stato già emesso un Provvedimento di tipo definitorio!");
			}
		}
		...
		if (lProvvedimento != null && lProvvedimento.getProvvedimento() != null
			...
			// Prepara la pagina di destinazione, il Dettaglio Decreto Irreperibilità.
			RedirectTo lPage = new RedirectTo();
			lPage.setPage(IWebConstants.PG_MAIN);

			lPage.setAction("siap.sige.provvInterlocutori.action.ActDettaglioDecretoIrreperibilita");
		...
		// [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di
		// LogF3B.getLogger()
		siesLogger.debug("ActLoadInserisciDecretoIrreperibilita: -> page: " + lRetPage);
