...
/**
 * <p>
 * Title: ActModificaOggettoRichiesta
 * </p>
 * <p>
 * Description: Classe Action per la modifica
 * </p>
 ...
 * @version 1.0
 */
public class ActModificaOggettoRichiesta extends ActAggiornaTenoriSige implements ICostantiTenoreSige {
	...
	public String processRequest() throws Exception {
		...
		caricaTenori(mIdRichiesta, lCodOggetto, lIdSentenza, lIdReati, "M", codContenuto, codContenutoOld);

		// Ritorno al punto di partenza
		String lRetPage = ritornoDopoCancellazione("Modifica effettuata correttamente.", null);
		return lRetPage;
	}
