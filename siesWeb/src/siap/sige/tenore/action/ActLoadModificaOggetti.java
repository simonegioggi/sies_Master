...
public class ActLoadModificaOggetti extends ActionSige implements ICostantiTenoreSige {

	public String processRequest() throws Exception {

		// Elenco dei TenoriEstesoModel
		Vector tenori = null;
		// Devono essere nella session
		if (this.getSession().getAttribute("tenori") != null) {
			tenori = (Vector) this.getSession().getAttribute("tenori");
		}
		setRequestAttribute("tenori", tenori);

		// 20190508 [SG]: aggiunta gestione contenuto
		...
		Iterator iterTenori = tenori.iterator();
