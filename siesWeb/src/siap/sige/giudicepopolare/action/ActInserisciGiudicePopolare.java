...
/**
* <p>Title: ActInserisciGiudicePopolare</p>
* <p>Description: Classe Action per l'inserimento del GiudicePopolare</p>
* <p>Copyright: Copyright (c) 2008</p>
* <p>Company: Eutelia</p>
* @version 1.0
*/
public class ActInserisciGiudicePopolare extends ActionSiap 
implements ICostantiGiudicePopolare
{
	// [FT] - 03/08/2016 - MAC_LOG - Dichiaro un'istanza di Logger per SIESLog
	private static Logger siesLogger = Logger.getLogger(LogF3B.SIES_LOG);
  /**
  * Effettua Inserimento del GiudicePopolare.
  * <p>
  ...
  */
  public String processRequest() throws Exception
  {
    ...
    lGiuPopMod.setDataNascita( getRequestDateParameter(CAMPO_ANNO_DATA_NASCITA,
    ...
    lGiuPopMod.setCodOperatoreInserimento(getCodUtenteConnesso());
    lGiuPopMod.setCodUfficioInserimento(getCodUfficioUtenteConnesso());
    lGiuPopMod.setDataInserimento(DateUtils.getSysDate());
    ...
    lGiuPopMod.setDataFineValidita(getRequestDateParameter(CAMPO_ANNO_DATA_FINE_VALIDITA,
    ...
    GiudicePopolareModel lGiuPopModRet = lCtrl.ExInserisciGiudicePopolare(lGiuPopMod);		 // Setta la risposta nella request

    setRequestAttribute("giudicepopolare", lGiuPopModRet);
