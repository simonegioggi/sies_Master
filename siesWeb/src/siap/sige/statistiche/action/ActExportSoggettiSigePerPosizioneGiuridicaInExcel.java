...
/**
 * MEV_65: aggiunta classe Action per la visualizzazione del foglio excel con i Soggetti SIGE per posizione
 * giuridica.
 * 
 * @author Gioggi
 * @version 1.0
 */
public class ActExportSoggettiSigePerPosizioneGiuridicaInExcel extends ActionSige {
	...
	public String processRequest() throws Exception {
		...
		RicercaFascicoloSigeModel rfsm = (RicercaFascicoloSigeModel) getSessionAttribute("model");
		...
		Vector<FascicoloSigeEstesoModel> v = ifs.ExRicercaSoggettiSigePerPosizioneGiuridica(rfsm, 0);
		...
		HSSFWorkbook excel = sc.getReportSoggettiSigePerPosizioneGiuridica(rfsm, v,
