	...
	private String getQueryFcTrasmessi (RicercaFogliCompModel filtroModel) {
		...
		if (filtroModel.getDataEmissioneIniziale() != null) {
			if (filtroModel.getDataEmissioneFinale() == null) {
			    ...
			    sql += " and b.data_emissione between TO_DATE(" + DateUtils.getDateToString( filtroModel.getDataEmissioneIniziale(), "yyyyMMdd" ) + ",'YYYYMMDD' ) and TO_DATE(" + DateUtils.getDateToString( filtroModel.getDataEmissioneFinale(), "yyyyMMdd" ) + ",'YYYYMMDD' )";
			}
		}
