...
/**
* <p>Title: DocumentoAllegatoDAO</p>
* <p>Description: Classe DAO che rappresenta la tabella DocumentoAllegato</p>
...
public class DocumentoAllegatoDAO extends TableDAO
{
  ...
  // METODI GET()
  //
  public BigDecimal 		   getIdDocumentoAllegato() 	  throws DAOException	 { return getBigDecimal("ID_DOCUMENTO_ALLEGATO"); }
  public Date 				   getDataEmissione() 		      throws DAOException	 { return getDate("DATA_EMISSIONE"); }
  public String 			   getCodTipoDocumento() 		  throws DAOException	 { return getString("COD_TIPO_DOCUMENTO"); }
  public BigDecimal 		   getNumeroProgressivo() 		  throws DAOException	 { return getBigDecimal("NUMERO_PROGRESSIVO"); }
  ...
  public BigDecimal 		   getAnnoFoglioComplementare()   throws DAOException	 { return getBigDecimal("ANNO_FOGLIO_COMPLEMENTARE"); }
  public BigDecimal 		   getProgrFoglioComplementare()  throws DAOException	 { return getBigDecimal("PROGR_FOGLIO_COMPLEMENTARE"); }
  ...
  public String 		       getComuneSedeGiudiziaria() 	  throws DAOException	 { return getString("COMUNE_SEDE_GIUDIZIARIA"); } 
  public String 		       getCodMotivazioneNonInvio() 	  throws DAOException	 { return getString("CODI_MOTIVAZIONE_NON_INVIO"); }
  public String 		       getDescrizioneNonInvio() 	  throws DAOException	 { return getString("DESCRIZIONE_NON_INVIO"); }
  public Date 			       getDataUltInvio() 		      throws DAOException	 { return getDate("DATA_ULT_INVIO"); }
  public Date 			       getDataInsMan() 		          throws DAOException	 { return getDate("DATA_INS_MAN"); }
  
  //
  // METODI SET()
  //
  public void  	 setIdDocumentoAllegato(BigDecimal aValore ) 	  { setBigDecimal("ID_DOCUMENTO_ALLEGATO", aValore); }
  public void  	 setDataEmissione(Date aValore ) 			      { setDate("DATA_EMISSIONE", aValore); }
  public void  	 setCodTipoDocumento(String aValore ) 			  { setString("COD_TIPO_DOCUMENTO", aValore); }
  public void  	 setNumeroProgressivo(BigDecimal aValore ) 		  { setBigDecimal("NUMERO_PROGRESSIVO", aValore); }
  ...
  public void  	 setAnnoFoglioComplementare(BigDecimal aValore )  { setBigDecimal("ANNO_FOGLIO_COMPLEMENTARE", aValore); }
  public void  	 setProgrFoglioComplementare(BigDecimal aValore ) { setBigDecimal("PROGR_FOGLIO_COMPLEMENTARE", aValore); }
  ...
  public void  	 setComuneSedeGiudiziaria(String aValore ) 		  { setString("COMUNE_SEDE_GIUDIZIARIA", aValore); } 
  public void  	 setCodMotivazioneNonInvio(String aValore ) 	  { setString("CODI_MOTIVAZIONE_NON_INVIO", aValore); }
  public void  	 setDescrizioneNonInvio(String aValore ) 	      { setString("DESCRIZIONE_NON_INVIO", aValore); }
  public void  	 setDataUltInvio(Date aValore ) 			      { setDate("DATA_ULT_INVIO", aValore); }
  public void  	 setDataInsMan(Date aValore ) 			          { setDate("DATA_INS_MAN", aValore); }
   ...
   * del model DocumentoAllegatoModel passato.
   * @param aModel
   */
   public void setCondizione(DocumentoAllegatoModel aModel)
   {
     ...
     if (aModel != null)
     {
     	...
     	if (aModel.getComuneSedeGiudiziaria()!= null && aModel.getComuneSedeGiudiziaria().trim().length() > 0 )
  ...
  public void setCondizioneDeleteSollecito (BigDecimal idDocumentoAllegato) {
	  setCondition (" ID_DOCUMENTO_ALLEGATO = " + idDocumentoAllegato + " and COD_TIPO_DOCUMENTO = '05'");
  }
