...
/**
* <p>Title: ICostantiRegeSoggetto</p>
* <p>Description: Classe di costanti di RegeSoggetto</p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/

public interface ICostantiRegeSoggetto
{
		 public static final String CAMPO_ID_FILE = "IdFile";
		 public static final String CAMPO_FLAG_TIPO_SOGG = "FlagTipoSogg";
		 ...
		 public static final String CAMPO_DENO_SOGG = "DenoSogg";
		 public static final String CAMPO_RAGI_SOGG = "RagiSogg";
		 public static final String CAMPO_NOME_RAPP_LEGA = "NomeRappLega";
		 ...
		 public static final String PG_LOAD_RICERCAREGESOGGETTO	= IWebConstants.ROOT_DIR + "files/siap/regesies/regesoggetto/LoadRicercaRegeSoggetto.jsp";
		 public static final String PG_LOAD_DETTAGLIOREGESOGGETTO	= IWebConstants.ROOT_DIR + "files/siap/regesies/regesoggetto/DettaglioRegeSoggetto.jsp";
		 public static final String PG_RICERCAREGESOGGETTO	= IWebConstants.ROOT_DIR + "files/siap/regesies/regesoggetto/RicercaRegeSoggetto.jsp";
		 public static final String PG_MODIFICAREGESOGGETTO	= IWebConstants.ROOT_DIR + "files/siap/regesies/regesoggetto/ModificaRegeSoggetto.jsp";
}