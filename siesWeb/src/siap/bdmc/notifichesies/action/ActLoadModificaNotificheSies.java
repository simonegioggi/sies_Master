...
/**
 * <p>
 * Title: ActLoadModificaNotificheSies
 * </p>
 * <p>
 * Description: Classe Action per la load modifica di NotificheSies
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadModificaNotificheSies extends ActionSiap implements ICostantiNotificheSies {
	...
	public String processRequest() throws F3BException {
		...
		// ==========================================
		logger.info("Recupero i dati del record da modificare: " + lIdNotificheSies);
		INotificheSies lCtrl = BDMCLookupRemote.getNotificheSiesRemote();
		NotificheSiesModel lNotificheSies = lCtrl.ExRicercaNotificheSiesById(lIdNotificheSies);

		// ===========================================================
		// Restituisce la msg se i dati non sono stati recuperati.
		// ===========================================================
		if (lNotificheSies == null) {
		...
		// ====================================================
		logger.debug("Dati Record: " + lNotificheSies);
		setRequestAttribute("notifichesies", lNotificheSies);
		...
		// ==========================================================================
		logger.debug("return: " + PG_LOAD_INSERISCINOTIFICHESIES);
		return PG_LOAD_INSERISCINOTIFICHESIES;
	}
