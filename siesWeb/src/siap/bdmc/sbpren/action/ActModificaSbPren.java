...
/**
 * <p>
 * Title: ActModificaSbPren
 * </p>
 * <p>
 * Description: Classe Action per la modifica di SbPren
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActModificaSbPren extends ActionSiap implements ICostantiSbPren {

	/*****************************************************************************
	 * Azione di Modifica del SbPren
	 * 
	...
	public String processRequest() throws F3BException {
		...
		lCtrl.ExModificaSbPren(lSbPMod);
		...
		lPage += "&" + CAMPO_ID_PREN + "=" + lSbPMod.getIdPren().toString();
