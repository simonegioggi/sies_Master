...
/**
 * <p>
 * Title: ActLoadModificaSbPren
 * </p>
 * <p>
 * Description: Classe Action per la load modifica di SbPren
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadModificaSbPren extends ActionSiap implements ICostantiSbPren {
	...
	public String processRequest() throws F3BException {
		...
		SbPrenModel lSbPren = lCtrl.ExRicercaSbPrenById(lIdPren);
		...
		// ====================================================
		logger.debug("Dati Record: " + lSbPren);
		setRequestAttribute("sbpren", lSbPren);
		...
		// ==========================================================================
		logger.debug("return: " + PG_LOAD_INSERISCISBPREN);
