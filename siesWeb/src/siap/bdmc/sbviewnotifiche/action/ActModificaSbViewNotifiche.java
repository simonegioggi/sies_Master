...
/**
 * <p>
 * Title: ActModificaSbViewNotifiche
 * </p>
 * <p>
 * Description: Classe Action per la modifica di SbViewNotifiche
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActModificaSbViewNotifiche extends ActionSiap implements ICostantiSbViewNotifiche {

	/*****************************************************************************
	 * Azione di Modifica del SbViewNotifiche
	 * 
	...
	public String processRequest() throws F3BException {
		...
		lCtrl.ExModificaSbViewNotifiche(lSbVMod);
		...
		lPage += "&" + CAMPO_PROG_NOTI + "=" + lSbVMod.getProgNoti().toString();
