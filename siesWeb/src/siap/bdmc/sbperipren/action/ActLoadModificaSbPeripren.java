...
/**
 * <p>
 * Title: ActLoadModificaSbPeripren
 * </p>
 * <p>
 * Description: Classe Action per la load modifica di SbPeripren
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActLoadModificaSbPeripren extends ActionSiap implements ICostantiSbPeripren {
	...
	public String processRequest() throws F3BException {
		...
		// ==========================================
		logger.info("Recupero i dati del record da modificare: " + lProgPeriPres);
		ISbPeripren lCtrl = BDMCLookupRemote.getSbPeriprenRemote();
		SbPeriprenModel lSbPeripren = lCtrl.ExRicercaSbPeriprenById(lProgPeriPres);
		...
		// ====================================================
		logger.debug("Dati Record: " + lSbPeripren);
		setRequestAttribute("sbperipren", lSbPeripren);
		...
		// ==========================================================================
		logger.debug("return: " + PG_LOAD_INSERISCISBPERIPREN);
		return PG_LOAD_INSERISCISBPERIPREN;
	}
