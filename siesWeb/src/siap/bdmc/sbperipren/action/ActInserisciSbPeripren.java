...
/**
 * <p>
 * Title: ActInserisciSbPeripren
 * </p>
 * <p>
 * Description: Classe Action per l'inserimento di SbPeripren
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class ActInserisciSbPeripren extends ActionSiap implements ICostantiSbPeripren {

	/*****************************************************************************
	 * Azione di Inserimento del SbPeripren
	 * 
	...
	public String processRequest() throws F3BException {
		...
		SbPeriprenModel lSbPRetMod = new SbPeriprenModel();
		lSbPRetMod = lCtrl.ExInserisciSbPeripren(lSbPMod);
		...
		lPage += "&" + CAMPO_PROG_PERI_PRES + "=" + lSbPRetMod.getProgPeriPres().toString();
