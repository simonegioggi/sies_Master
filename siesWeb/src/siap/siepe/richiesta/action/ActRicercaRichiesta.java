 ...
 * @version 1.0
 */
public class ActRicercaRichiesta extends ActRicercaFasSiepePuntuale implements ICostantiRichiesta {
	...
	public String processRequest() throws Exception {
		...
		// Istanzia il Model per i criteri di ricerca
