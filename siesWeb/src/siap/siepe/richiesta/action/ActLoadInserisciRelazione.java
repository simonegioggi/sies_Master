...
* <p>Description: Classe Action per l'inserimento di una Relazione.
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: Bull</p>
* @version 1.0
*/
public class ActLoadInserisciRelazione extends ActLoadDettaglioRichiesta
{
  ...
  public String processRequest() throws Exception
  {
    ...
    String lPage = super.processRequest(); // Si richiama il Dettaglio
