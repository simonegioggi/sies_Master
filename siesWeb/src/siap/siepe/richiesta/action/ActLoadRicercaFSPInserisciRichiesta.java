...
public class ActLoadRicercaFSPInserisciRichiesta extends ActLoadRicercaFasSiepePuntuale
implements ICostantiRichiesta
{
  public String processRequest() throws Exception
  {
    ...
    setRequestAttribute("functionName", "Inserimento Richiesta");
    setRequestAttribute("nextAction", "siap.siepe.richiesta.action.ActLoadInserisciRichiesta");
