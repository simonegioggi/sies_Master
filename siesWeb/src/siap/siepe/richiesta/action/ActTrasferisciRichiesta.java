 ...
 * @version 1.0
 */
public class ActTrasferisciRichiesta extends ActionSiap implements ICostantiJMS {
	...
	public String processRequest() throws Exception {
		...
		BigDecimal lIdRichiesta = getRequestBigDecimalParameter(ICostantiRichiesta.CAMPO_ID_RICHIESTA);
...
//		boolean inviato = false; // flag di controllo invio messaggio.
		...
		MessaggioModel lMessage = lCtrlMess.getMessageForRichiesta(lIdRichiesta, lFascicoloEsteso,
				lUfficioDestinatario);
		...
		lMessage.setCodTipoOperazione(TRASFERIMENTO_RICHIESTA_UEPE);
...
//		inviato = true;
		...
		String lPage = ritornoDopoCancellazione(
				"La trasmissione della Richiesta è stata sottoposta al sistema!", null);
