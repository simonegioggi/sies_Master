...
public class ActDettaglioRelazioneAttivitaRicevuta extends ActionSiap 
implements ICostantiRicezioneAtti
{
  ...
  public String processRequest() throws Exception
  {
    ...
    */
    ...
    // Recupero della Relazione Attivita dal Parser 
    RelazioneModel lRelazione = new RelazioneModel();
    if (lParser.getAttivita().getRelazioni()!= null && lParser.getAttivita().getRelazioni().length > 0)
      lRelazione = lParser.getAttivita().getRelazioni()[0];
    else
      throw new SIEPEException( SIEPEException.USER_MESSAGE, "Errore nella Ricezione della Relazione di Attivita UEPE Trasmessa. " );
    ...
    //setRequestAttribute("sentenza", lSentenza);
    setRequestAttribute( "attivita", lAttivita );
    setRequestAttribute( "relazione", lRelazione );
