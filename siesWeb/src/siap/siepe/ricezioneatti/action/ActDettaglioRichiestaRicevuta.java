...
/**
 * <p>Title: ActDettaglioRichiestaRicevuta</p>
 * <p>Description: Classe Action per la load dettaglio della richiesta UEPE ricevuta.</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: Bull</p>
 * @version 1.0
 */
public class ActDettaglioRichiestaRicevuta extends ActionSiap 
implements ICostantiRicezioneAtti
{
  ...
  public String processRequest() throws Exception
  {
    ...
    */
    ...
    // Recupero della Richiesta UEPE dal Parser 
    ...
    this.setRequestAttribute( "richiesta", lRichiesta );

    // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    siesLogger.debug( getClass().getName() + ".processRequest: fine" );
    
    return PG_DETTAGLIO_RICHIESTA_RICEVUTA;
  }
}