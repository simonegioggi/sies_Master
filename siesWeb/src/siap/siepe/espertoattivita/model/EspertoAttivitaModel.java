...
/**
* <p>Title: EspertoAttivitaModel</p>
* <p>Description: Classe Model che rappresenta il EspertoAttivita</p>
...
public class EspertoAttivitaModel extends GenericModel {

	/**
	* 
	*/
	private static final long serialVersionUID = 4238211242774820248L;
	...
	public EspertoAttivitaModel(EspertoAttivitaModel aModel) {
	...
	// COSTRUTTORE MODEL
	public EspertoAttivitaModel(Date aDataInizio, Date aDataFine, String aCodOperatoreInserimento,
			...
			String aDescrUfficioAggiornamento, BigDecimal aEspIdEsperto, BigDecimal aAttIdAttivita) {
	...
	public String toString() {
		...
		lStr = "" + mDataInizio + " - " + mDataFine + " - " + mCodOperatoreInserimento + " - "
				...
				+ " - " + mDescrUfficioAggiornamento + " - " + mEspIdEsperto + " - " + mAttIdAttivita;
