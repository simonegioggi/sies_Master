...
public class ActUploadDocument extends siap.sico.evento.action.ActUploadDocument {
	...
	// variabile IAttivita utilizzato per accedere alla tabella ATTIVITA
	...
	/**
	 * La funzione ridefinisce la stessa del super. Esegue l'Update della tabella ATTIVITA con o senza
	 * l'inserimento del documento di upload nel BLOB.
	 *
	 * @param aId
	 * @throws Exception
	 */
	...
	/**
	 * La funzione ridefinisce la stessa del super. Funzione di utilità. Viene richiamata per controllare
	 * l'esistenza del documento nel BLOB della tabella ATTIVITA. Se tale documento non esiste viene lanciata
	 * un'eccezione.
	 *
	 * @param aId
	 * @throws Exception
