...
/**
* <p>Title: ActLoadTrasferisciAttivita</p>
* <p>Description: Classe Action per il caricamento dela form per il trasferimento Attivita</p>
...
public class ActLoadTrasferisciAttivita extends ActLoadDettaglioAttivita
{
  ...
  public String processRequest() throws Exception
  {
   ...
   // Imposta Modalità.
    ...
    // [FT] - 03/08/2016 - MAC_LOG - Utilizzo la variabile di istanza siesLogger al posto di LogF3B.getLogger()
    siesLogger.debug(this.getClass().getPackage().getName() + "." + this.getClass().getName() + ".processRequest(): fine");
