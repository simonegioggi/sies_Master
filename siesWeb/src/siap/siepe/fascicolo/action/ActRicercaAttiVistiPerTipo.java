...
import siap.siepe.ricezioneatti.action.ICostantiRicezioneAtti;
import siap.siepe.ricezioneatti.model.RicercaMessaggioModel;

/**
 * <p>
 * Title: ActRicercaAttiVistiPerTipo
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * @version 1.0
 */
public class ActRicercaAttiVistiPerTipo extends ActionSiap
	...
	public String processRequest() throws Exception {
		...
		Vector lVect = lCrtl.ExRicercaMessaggioRichiestaPerTipoeDate(this.getCodUfficioUtenteConnesso(),
				lCodTipoOperazione, lDataInizioTrasmissioneAtti, lDataFineTrasmissioneAtti, lIncludeVisto);

		this.setLinkRitorno();

		lRicModel.setDataIniziale(lDataInizioTrasmissioneAtti);
		lRicModel.setDataFinale(lDataFineTrasmissioneAtti);
		lRicModel.setFlagVisto(lIncludeVisto);
