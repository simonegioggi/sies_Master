...
/**
 * SIES FASE 2 - Servizio di caricamento dei dati necessari per effettuare la richiesta
 *
...
public class LoadService {
	...
	// MEV 35253
	public LoadService(String idEvento, String action, String idUtente, String userAdn) {
		this.idEvento = idEvento;
	...
	/**
	 * Verifica che l'utente sia abilitato al trasferimento MEV 35253
	 *
	 ...
	 * @throws LoadException
	 */
	private void loadDettagliProvvedimentoEsecutivo(Provvedimento provvedimento, SiesDAO dao, String idEvento,
	...
	private List<TitoloGiudiziario> loadTitoloGiudiziario(String idEvento) throws LoadException {
		 ...
		 * logger.error("Provvedimenti principali associati non trovati"); throw new
		 * LoadException("Provvedimenti principali associati non trovati"); }
		 */
	 ...
	 * @throws LoadException
	 */
	private void loadDatiTribunaleSorveglianza(Provvedimento provvedimento, SiesDAO dao, String idEvento)
			throws LoadException {
		...
		// Mapping per l'invio dei dati
		it.mig.sies.type.esecuzione_NEW.DatiTribunaleSorveglianza datiTribunaleSorveglianzaRequest = Mapper
				.map(datiTribunaleSorveglianza, dettagliFascicolo);
	 ...
	 * @throws LoadException
	 */
	private void loadDatiUfficioSorveglianza(Provvedimento provvedimento, SiesDAO dao, String idEvento)
			throws LoadException {
		...
		it.mig.sies.model.DettagliFascicolo dettagliFascicolo = dao.loadDettagliFascicolo(idEvento);
		// Mapping per l'invio dei dati
		it.mig.sies.type.esecuzione_NEW.DatiUfficioSorveglianza datiUfficioSorveglianzaRequest = Mapper
				.map(datiUfficioSorveglianza, dettagliFascicolo);
